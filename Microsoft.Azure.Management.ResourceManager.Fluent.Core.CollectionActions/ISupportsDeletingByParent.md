<Type Name="ISupportsDeletingByParent" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsDeletingByParent">
  ...
  <Members>
    <Member MemberName="DeleteByParent">
      ...
      <Docs>
        <param name="groupName">Die Gruppe der Ressource gehört.</param>
    ...
    <Member MemberName="DeleteByParentAsync">
      ...
      <Docs>
        ...
        <summary>
            Löschen Sie eine Ressource asynchron von Azure, die durch den Namen und die Ressourcengruppe identifiziert wird.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Observable-Objekt für die Anforderung.</return>
      </Docs>
    </Member>
  </Members>
</Type>