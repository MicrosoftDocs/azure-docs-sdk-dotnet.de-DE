<Type Name="ISupportsBatchDeletion" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsBatchDeletion">
  ...
  <Docs>
    <summary>
            Bietet Zugriff auf mehrere Ressourcen von Azure, identifizieren sie anhand der ID gelöscht.
            (Beachten Sie, dass diese Schnittstelle keine Implementierung durch Benutzercode vorgesehen ist.).
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="DeleteByIds">
      ...
      <Docs>
        <param name="ids">Ressourcen-IDs der Ressourcen gelöscht werden soll.</param>
        <summary>
    ...
    <Member MemberName="DeleteByIdsAsync">
      ...
      <Docs>
        ...
        <summary>
            Löscht die angegebenen Ressourcen von Azure, asynchron und parallel.
            </summary>
        <returns>To be added.</returns>
        <remarks>
            (Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).
            </remarks>
        <return>Observable-Objekt aus der alle erfolgreich gelöschten Ressourcen angezeigt werden kann.</return>
      </Docs>
    </Member>
    <Member MemberName="DeleteByIdsAsync">
