<Type Name="ISupportsDeletingById" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsDeletingById">
  ...
  <Members>
    <Member MemberName="DeleteById">
      ...
      <Docs>
        <param name="id">ID der Ressourcen-ID der Ressource löschen</param>
        <summary>
            Löscht eine Ressource von Azure, die Ressourcen-ID identifiziert wird
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
