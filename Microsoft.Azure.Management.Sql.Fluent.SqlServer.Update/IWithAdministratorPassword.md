<Type Name="IWithAdministratorPassword" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlServer.Update.IWithAdministratorPassword">
  ...
  <Docs>
    <summary>
            Ein SQL Server-Definition Einstellung Admin-Benutzerkennwort.
            </summary>
  ...
  <Members>
    <Member MemberName="WithAdministratorPassword">
      ...
      <Docs>
        <param name="administratorLoginPassword">Kennwort für das Administratorkonto.</param>
        <summary>
            Legt fest, der Administrator Anmeldekennwort.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Nächste Stufe des Updates.</return>
      </Docs>
    </Member>
  </Members>
</Type>