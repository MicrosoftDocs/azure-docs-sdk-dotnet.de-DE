<Type Name="IWithIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.PublicIPAddress.Definition.IWithIPAddress">
  ...
  <Docs>
    <summary>
            Eine öffentliche IP-adressendefinition ermöglicht die IP-Zuordnungsmethode (statisch oder dynamisch) festgelegt.
            </summary>
    ...
    <Member MemberName="WithStaticIP">
      ...
      <Docs>
        <summary>
            ...
            Verwenden Sie PublicIPAddress.ipAddress(), nachdem die öffentliche IP-Adresse erstellt wird, um die tatsächliche IP-Adresse für diese Ressource zugeordnet werden, von Azure zu erhalten.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
