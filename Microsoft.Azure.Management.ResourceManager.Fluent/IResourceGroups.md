<Type Name="IResourceGroups" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.IResourceGroups">
  ...
  <Docs>
    <summary>
            Einstiegspunkt für einen Resource-Group-Verwaltungs-API.
            </summary>
  ...
  <Members>
    <Member MemberName="CheckExistence">
      ...
      <Docs>
        <param name="name">Der Name der Ressourcengruppe, um zu überprüfen. Der Name ist Groß-/Kleinschreibung beachten</param>
        <summary>
            Überprüft, ob eine Ressourcengruppe vorhanden ist.
            </summary>
        <returns>"true", wenn die Ressourcengruppe vorhanden ist; "false" andernfalls</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
