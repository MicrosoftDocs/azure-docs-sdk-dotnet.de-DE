<Type Name="MetricDefinition" FullName="Microsoft.Azure.Management.Monitor.Models.MetricDefinition">
  ...
  <Docs>
    <summary>
            Anhand der metrischen definitionsklasse gibt die Metadaten für eine Metrik an.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="isDimensionRequired">Kennzeichen Sie, um anzugeben, ob die Dimension erforderlich ist.</param>
        <param name="resourceId">Der Ressourcenbezeichner der Ressource, die die Metrik ausgegeben.</param>
        <param name="name">der Name und der Anzeigename der Metrik, d. h. es ist eine lokalisierbare Zeichenfolge.</param>
        ...
        <param name="primaryAggregationType">der primäre Aggregation Typwert, der definiert, wie Sie die Werte für die Anzeige zu verwenden. Folgende Werte sind möglich: 'None', 'Average', 'Count', "Minimum", "Maximum", "Total"</param>
        <param name="metricAvailabilities">die Auflistung von welchen Intervallen Aggregation abzufragenden verfügbar sind.</param>
        <param name="id">Der Ressourcenbezeichner der metrischen Definition.</param>
        <param name="dimensions">der Name und der Anzeigename der Dimension, d. h. es ist eine lokalisierbare Zeichenfolge.</param>
        <summary>
            Initialisiert eine neue Instanz der MetricDefinition-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Dimensions">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest, den Namen und den Anzeigenamen der Dimension, d. h. es ist eine lokalisierbare Zeichenfolge.
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Ressourcenbezeichner des anhand der metrischen Definition.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDimensionRequired">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Kennzeichen, das angibt, ob die Dimension erforderlich ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MetricAvailabilities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Auflistung der welche Aggregation Intervalle verfügbar sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest, der Name und der Anzeigename der Metrik, d. h. es ist eine lokalisierbare Zeichenfolge.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryAggregationType">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest den primären Aggregation Typwert, der definiert, wie Sie die Werte für die Anzeige zu verwenden. Folgende Werte sind möglich: 'None', 'Average', 'Count', "Minimum", "Maximum", "Total"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Ressourcenbezeichner der Ressource, die die Metrik ausgegeben.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
