<Type Name="SenderAuthorization" FullName="Microsoft.Azure.Management.Monitor.Models.SenderAuthorization">
  ...
  <Docs>
    <summary>
            die Autorisierung verwendet wird, indem der Benutzer, der den Vorgang ausgeführt hat, die auf dieses Ereignis geführt haben. Dadurch erfasst die RBAC-Eigenschaften des Ereignisses.
            Dazu gehören in der Regel die 'Action', 'Rolle' und 'Bereich'
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SenderAuthorization-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="action">die zulässigen Aktionen. Z. B.: microsoft.support/supporttickets/write</param>
        <param name="role">die Rolle des Benutzers. Z. B.: Abonnementadministrator</param>
    ...
    <Member MemberName="Action">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die zulässigen Aktionen. Z. B.: microsoft.support/supporttickets/write
            </summary>
    ...
    <Member MemberName="Role">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Rolle des Benutzers fest. Z. B.: Abonnementadministrator
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
