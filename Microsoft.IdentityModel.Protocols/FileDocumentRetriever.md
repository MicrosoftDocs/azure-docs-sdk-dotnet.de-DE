<Type Name="FileDocumentRetriever" FullName="Microsoft.IdentityModel.Protocols.FileDocumentRetriever">
  ...
  <Docs>
    <summary>
            Eine lokale Datei vom Datenträger gelesen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.IdentityModel.Protocols.FileDocumentRetriever" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetDocumentAsync">
      ...
      <Docs>
        <param name="address">Den vollqualifizierten Pfad zu einer Datei.</param>
        <param name="cancel">
          <see cref="T:System.Threading.CancellationToken" />nicht verwendet.</param>
        <summary>
            Liest ein Dokument mit <see cref="T:System.IO.FileStream" />.
            </summary>
        <returns>UTF8 Decodierung von Bytes in der Datei.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">Wenn die Adresse Null oder leer ist.</exception>
        <exception cref="T:System.IO.IOException">mit der inneren Ausnahme, die die ursprüngliche Ausnahme enthält.</exception>
      </Docs>
    </Member>
  </Members>
</Type>