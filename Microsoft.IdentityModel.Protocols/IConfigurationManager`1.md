<Type Name="IConfigurationManager&lt;T&gt;" FullName="Microsoft.IdentityModel.Protocols.IConfigurationManager&lt;T&gt;">
  ...
  <Docs>
    ...
    <summary>
            Schnittstelle, die ein Modell zum Abrufen von Konfigurationsdaten definiert.
            </summary>
  ...
  <Members>
    <Member MemberName="GetConfigurationAsync">
      ...
      <Docs>
        ...
        <summary>
            Abrufen der aktuellen Konfigurations aktualisieren und/oder Zwischenspeichern nach Bedarf.
            Wenn die Konfiguration nicht abgerufen werden kann, statt Null zurückgegeben wird, ist diese Methode löst.
            </summary>
        <returns>
    ...
    <Member MemberName="RequestRefresh">
      ...
      <Docs>
        <summary>
            Geben Sie an, dass die Konfiguration möglicherweise veraltete (wie durch wegen eines Fehlers beim Verarbeiten von eingehender Tokens angegeben).
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
