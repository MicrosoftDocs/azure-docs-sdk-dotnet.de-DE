<Type Name="RawCertificateData" FullName="Microsoft.Azure.Management.RecoveryServices.Models.RawCertificateData">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="authType">Gibt den Authentifizierungstyp an. Folgende Werte sind möglich: "Ungültig", "ACS", "AAD", "AccessControlService", "AzureActiveDirectory"</param>
    ...
    <Member MemberName="AuthType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt den Authentifizierungstyp an. Folgende Werte sind möglich: "Ungültig", "ACS", "AAD", "AccessControlService", "AzureActiveDirectory"
            </summary>
