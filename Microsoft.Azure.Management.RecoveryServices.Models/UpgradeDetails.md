<Type Name="UpgradeDetails" FullName="Microsoft.Azure.Management.RecoveryServices.Models.UpgradeDetails">
  ...
  <Docs>
    <summary>
            Details zum Aktualisieren von Tresor.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der UpgradeDetails-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="operationId">Die ID der Upgradevorgang Tresor.</param>
        <param name="startTimeUtc">UTC-Zeit, an dem der Aktualisierungsvorgang gestartet wurde.</param>
        <param name="lastUpdatedTimeUtc">UTC-Zeit, an dem der Upgradevorgang-Status zuletzt aktualisiert wurde.</param>
        <param name="endTimeUtc">UTC-Zeit, an dem der Upgradevorgang beendet wurde.</param>
        <param name="status">Status des Upgradevorgangs Tresor angibt.
            Folgende Werte sind möglich: "Unbekannt", "InProgress", "Upgrade", "Fehler"</param>
        <param name="message">Die Nachricht an den Benutzer, die mit Informationen über den Upgradevorgang.</param>
        <param name="triggerType">Die Art der Tresor anfertigen ausgelöst wurde. Folgende Werte sind möglich: "UserTriggered", "ForcedUpgrade"</param>
        <param name="upgradedResourceId">Ressourcen-ID des aktualisierten Tresors.</param>
        <param name="previousResourceId">Ressourcen-ID des Tresors vor dem Upgrade.</param>
        <summary>
            Initialisiert eine neue Instanz der UpgradeDetails-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EndTimeUtc">
      ...
      <Docs>
        <summary>
            Ruft die UTC-Zeit, an dem der Upgradevorgang beendet wurde.
            </summary>
    ...
    <Member MemberName="LastUpdatedTimeUtc">
      ...
      <Docs>
        <summary>
            Ruft die UTC-Zeit, an dem der Upgradevorgang-Status zuletzt aktualisiert wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft die Nachricht an die Benutzer mit Informationen über den Upgradevorgang ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            Ruft die ID der Upgradevorgang Tresor ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PreviousResourceId">
      ...
      <Docs>
        <summary>
            Ruft die Ressourcen-ID der vor dem Upgrade Tresor ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTimeUtc">
      ...
      <Docs>
        <summary>
            Ruft die UTC-Zeit, an dem der Aktualisierungsvorgang gestartet wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft die Status der Upgradevorgang Tresor ab. Folgende Werte sind möglich: "Unbekannt", "InProgress", "Upgrade", "Fehler"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TriggerType">
      ...
      <Docs>
        <summary>
            Ruft ab, wie, die der Tresor anfertigen ausgelöst wurde. Folgende Werte sind möglich: "UserTriggered", "ForcedUpgrade"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpgradedResourceId">
      ...
      <Docs>
        <summary>
            Ruft die Ressourcen-ID des aktualisierten Tresors ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
