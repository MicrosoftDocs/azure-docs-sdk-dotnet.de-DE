<Type Name="IWithUpdateDomainCount" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithUpdateDomainCount">
  ...
  <Docs>
    <summary>
            Die Stufe der Verfügbarkeit festgelegt Definition ermöglicht die Anzahl der Updates angeben.
            </summary>
  ...
  <Members>
    <Member MemberName="WithUpdateDomainCount">
      ...
      <Docs>
        <param name="updateDomainCount">Anzahl der Domäne zu aktualisieren.</param>
        <summary>
            Gibt die Anzahl der Updates Domäne für die verfügbarkeitsgruppe an.
            </summary>
