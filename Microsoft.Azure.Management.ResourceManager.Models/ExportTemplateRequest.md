<Type Name="ExportTemplateRequest" FullName="Microsoft.Azure.Management.ResourceManager.Models.ExportTemplateRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ExportTemplateRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resources">Die Ressourcen-IDs. Derzeit ist die einzige unterstützte Zeichenfolge "*" (alle Ressourcen). Zukünftige Updates unterstützt bestimmte Ressourcen zu exportieren.</param>
    ...
    <Member MemberName="Resources">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Ressourcen-IDs. Derzeit ist die einzige unterstützte Zeichenfolge "*" (alle Ressourcen). Zukünftige Updates unterstützt bestimmte Ressourcen zu exportieren.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
