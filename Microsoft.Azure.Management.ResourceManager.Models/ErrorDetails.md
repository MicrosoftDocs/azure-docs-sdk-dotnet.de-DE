<Type Name="ErrorDetails" FullName="Microsoft.Azure.Management.ResourceManager.Models.ErrorDetails">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">Zu einem Server definierten Satz von Fehlercodes.</param>
        <param name="message">Eine lesbare Darstellung des Fehlers.</param>
        <param name="target">(Optional) Das Ziel des Fehlers.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse ErrorDetails an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, zu einem Server definierten Satz von Fehlercodes.
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine lesbare Darstellung des Fehlers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest (Optional) das Ziel des Fehlers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
