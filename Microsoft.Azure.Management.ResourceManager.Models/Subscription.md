<Type Name="Subscription" FullName="Microsoft.Azure.Management.ResourceManager.Models.Subscription">
  ...
  <Docs>
    <summary>
            -Abonnementinformationen ausgetauscht.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Subscription-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Die vollqualifizierte ID für das Abonnement. Beispielsweise /subscriptions/00000000-0000-0000-0000-000000000000.</param>
        <param name="subscriptionId">Die Abonnement-ID.</param>
        <param name="displayName">Der Anzeigename des Abonnements.</param>
        <param name="state">Der Status des Abonnements. Mögliche Werte sind aktiviert, Warned PastDue, deaktiviert und gelöscht. Folgende Werte sind möglich: "Enabled", "Eine Warnung", "PastDue", "Deaktiviert", "Deleted"</param>
        <param name="subscriptionPolicies">Die Abonnement-Richtlinien.</param>
        <param name="authorizationSource">Die Quelle der Autorisierung der Anforderung. Gültige Werte sind eine oder mehrere Kombinationen von Legacy-Modul, RoleBased, Bypassed, Direct und Verwaltung. Z. B. "Legacy, RoleBased".</param>
        <summary>
            Initialisiert eine neue Instanz der Subscription-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AuthorizationSource">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Quelle der Autorisierung der Anforderung fest. Gültige Werte sind eine oder mehrere Kombinationen von Legacy-Modul, RoleBased, Bypassed, Direct und Verwaltung. Z. B. "Legacy, RoleBased".
            </summary>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            Ruft den Anzeigenamen des Abonnements ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft die vollqualifizierte ID für das Abonnement ab. Beispielsweise /subscriptions/00000000-0000-0000-0000-000000000000.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft den Status des Abonnements ab. Mögliche Werte sind aktiviert, Warned PastDue, deaktiviert und gelöscht. Folgende Werte sind möglich: "Enabled", "Eine Warnung", "PastDue", "Deaktiviert", "Deleted"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionPolicies">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Richtlinien Abonnement fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
