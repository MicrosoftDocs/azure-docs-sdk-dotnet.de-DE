<Type Name="DeploymentPropertiesExtended" FullName="Microsoft.Azure.Management.ResourceManager.Models.DeploymentPropertiesExtended">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eb5a9-101">Bereitstellungseigenschaften mit zusätzlichen Details.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-101">Deployment properties with additional details.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-102">Initialisiert eine neue Instanz der DeploymentPropertiesExtended-Klasse.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-102">Initializes a new instance of the DeploymentPropertiesExtended class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provisioningState"><span data-ttu-id="eb5a9-103">Der Status der Bereitstellung.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-103">The state of the provisioning.</span></span></param>
        <param name="correlationId"><span data-ttu-id="eb5a9-104">Die Korrelations-ID der Bereitstellung.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-104">The correlation ID of the deployment.</span></span></param>
        <param name="timestamp"><span data-ttu-id="eb5a9-105">Der Zeitstempel der vorlagenbereitstellung.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-105">The timestamp of the template deployment.</span></span></param>
        <param name="outputs"><span data-ttu-id="eb5a9-106">Schlüssel/Wert-Paaren, die Deploymentoutput darstellen.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-106">Key/value pairs that represent deploymentoutput.</span></span></param>
        <param name="providers"><span data-ttu-id="eb5a9-107">Die Liste der für die Bereitstellung erforderlichen Ressourcenanbieter.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-107">The list of resource providers needed for the deployment.</span></span></param>
        <param name="dependencies"><span data-ttu-id="eb5a9-108">Die Liste der bereitstellungsabhängigkeiten.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-108">The list of deployment dependencies.</span></span></param>
        <param name="template"><span data-ttu-id="eb5a9-109">Der Inhalt der Vorlage.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-109">The template content.</span></span> <span data-ttu-id="eb5a9-110">Verwenden Sie nur eine Kopie der Vorlagen oder den TemplateLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-110">Use only one of Template or TemplateLink.</span></span></param>
        <param name="templateLink"><span data-ttu-id="eb5a9-111">Der URI, der auf die Vorlage verweist.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-111">The URI referencing the template.</span></span> <span data-ttu-id="eb5a9-112">Verwenden Sie nur eine Kopie der Vorlagen oder den TemplateLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-112">Use only one of Template or TemplateLink.</span></span></param>
        <param name="parameters"><span data-ttu-id="eb5a9-113">Deployment-Parameter.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-113">Deployment parameters.</span></span> <span data-ttu-id="eb5a9-114">Verwenden Sie nur eine Kopie der Parameter oder den ParametersLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-114">Use only one of Parameters or ParametersLink.</span></span></param>
        <param name="parametersLink"><span data-ttu-id="eb5a9-115">Der URI, verweisen auf die Parameter.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-115">The URI referencing the parameters.</span></span>
            <span data-ttu-id="eb5a9-116">Verwenden Sie nur eine Kopie der Parameter oder den ParametersLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-116">Use only one of Parameters or ParametersLink.</span></span></param>
        <param name="mode"><span data-ttu-id="eb5a9-117">Der Bereitstellungsmodus.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-117">The deployment mode.</span></span> <span data-ttu-id="eb5a9-118">Mögliche Werte sind inkrementelle und vollständige.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-118">Possible values are Incremental and Complete.</span></span> <span data-ttu-id="eb5a9-119">Folgende Werte sind möglich: "Inkrementell", "Abgeschlossen"</span><span class="sxs-lookup"><span data-stu-id="eb5a9-119">Possible values include: 'Incremental', 'Complete'</span></span></param>
        <param name="debugSetting"><span data-ttu-id="eb5a9-120">Die Debugeinstellung der Bereitstellung.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-120">The debug setting of the deployment.</span></span></param>
        <summary>
            <span data-ttu-id="eb5a9-121">Initialisiert eine neue Instanz der DeploymentPropertiesExtended-Klasse.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-121">Initializes a new instance of the DeploymentPropertiesExtended class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CorrelationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-122">Ruft die Korrelations-ID der Bereitstellung ab.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-122">Gets the correlation ID of the deployment.</span></span>
            </summary>
    ...
    <Member MemberName="DebugSetting">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-123">Ermittelt oder definiert das Debug-Einstellung der Bereitstellung.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-123">Gets or sets the debug setting of the deployment.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dependencies">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-124">Ruft ab oder legt die Liste der bereitstellungsabhängigkeiten fest.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-124">Gets or sets the list of deployment dependencies.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-125">Ruft ab oder legt den Bereitstellungsmodus.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-125">Gets or sets the deployment mode.</span></span> <span data-ttu-id="eb5a9-126">Mögliche Werte sind inkrementelle und vollständige.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-126">Possible values are Incremental and Complete.</span></span> <span data-ttu-id="eb5a9-127">Folgende Werte sind möglich: "Inkrementell", "Abgeschlossen"</span><span class="sxs-lookup"><span data-stu-id="eb5a9-127">Possible values include: 'Incremental', 'Complete'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Outputs">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-128">Ruft ab, oder legt ihn fest Schlüssel/Wert-Paaren, die Deploymentoutput darstellen.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-128">Gets or sets key/value pairs that represent deploymentoutput.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-129">Ruft ab oder legt die Bereitstellungsparameter.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-129">Gets or sets deployment parameters.</span></span> <span data-ttu-id="eb5a9-130">Verwenden Sie nur eine Kopie der Parameter oder den ParametersLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-130">Use only one of Parameters or ParametersLink.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ParametersLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-131">Ruft ab oder legt den URI verweisen auf die Parameter fest.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-131">Gets or sets the URI referencing the parameters.</span></span> <span data-ttu-id="eb5a9-132">Verwenden Sie nur eine Kopie der Parameter oder den ParametersLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-132">Use only one of Parameters or ParametersLink.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Providers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-133">Ruft ab oder legt die Liste der für die Bereitstellung erforderlichen Ressourcenanbieter.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-133">Gets or sets the list of resource providers needed for the deployment.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-134">Ruft den Status der Bereitstellung ab.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-134">Gets the state of the provisioning.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Template">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-135">Ruft ab oder legt den Vorlageninhalt.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-135">Gets or sets the template content.</span></span> <span data-ttu-id="eb5a9-136">Verwenden Sie nur eine Kopie der Vorlagen oder den TemplateLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-136">Use only one of Template or TemplateLink.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TemplateLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-137">Ruft ab oder legt den URI, der auf die Vorlage verweist.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-137">Gets or sets the URI referencing the template.</span></span> <span data-ttu-id="eb5a9-138">Verwenden Sie nur eine Kopie der Vorlagen oder den TemplateLink.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-138">Use only one of Template or TemplateLink.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-139">Ruft den Zeitstempel der vorlagenbereitstellung ab.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-139">Gets the timestamp of the template deployment.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb5a9-140">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="eb5a9-140">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="eb5a9-141">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="eb5a9-141">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
