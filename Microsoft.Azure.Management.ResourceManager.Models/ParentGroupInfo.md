<Type Name="ParentGroupInfo" FullName="Microsoft.Azure.Management.ResourceManager.Models.ParentGroupInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ParentGroupInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="parentId">Die ID der übergeordneten Verwaltungsgruppe. Beispiel:
    ...
    <Member MemberName="ParentId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID der übergeordneten Verwaltungsgruppe fest. Beispiel:
