<Type Name="ErrorResponse" FullName="Microsoft.Azure.Management.ResourceManager.Models.ErrorResponse">
  ...
  <Docs>
    <summary>
            Fehler Search Response – gibt an, dass ARM nicht die eingehende Anforderung verarbeitet wurde. Der Grund ist in der Fehlermeldung angegeben.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="httpStatus">HTTP-Statuscode.</param>
        <param name="errorCode">Fehlercode</param>
        <param name="errorMessage">Die Fehlermeldung, der angibt, warum der Vorgang fehlgeschlagen ist.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse ErrorResponse an.
            </summary>
        <remarks>To be added.</remarks>
