<Type Name="ResourceLinkFilter" FullName="Microsoft.Azure.Management.ResourceManager.Models.ResourceLinkFilter">
  ...
  <Docs>
    <summary>
            Filter für Ressource verknüpfen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ResourceLinkFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetId">Die ID der Zielressource.</param>
        <summary>
            Initialisiert eine neue Instanz der ResourceLinkFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TargetId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID der Zielressource fest.
            </summary>
