<Type Name="IAvailabilitySet" FullName="Microsoft.Azure.Management.Compute.Fluent.IAvailabilitySet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a4b3f-101">Eine unveränderliche clientseitige Darstellung einer Azure-verfügbarkeitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-101">An immutable client-side representation of an Azure availability set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="FaultDomainCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4b3f-102">Ruft die Anzahl der Fehlerdomänen für diese verfügbarkeitsgruppe an.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-102">Gets the fault domain count of this availability set.</span></span>
            </summary>
    ...
    <Member MemberName="ListVirtualMachineSizes">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a4b3f-103">Die Größe der virtuellen Computer in der verfügbarkeitsgruppe unterstützt.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-103">The virtual machine sizes supported in the availability set.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4b3f-104">Ruft den verfügbarkeitssatz SKU.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-104">Gets the availability set SKU.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Statuses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4b3f-105">Ruft den Status der vorhandenen virtuellen Computer in der verfügbarkeitsgruppe auf.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-105">Gets the statuses of the existing virtual machines in the availability set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdateDomainCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4b3f-106">Ruft die Anzahl der Updates Domäne für diese verfügbarkeitsgruppe ab.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-106">Gets the update domain count of this availability set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualMachineIds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4b3f-107">Ruft die Ressourcen-IDs der virtuellen Computer in der verfügbarkeitsgruppe auf.</span><span class="sxs-lookup"><span data-stu-id="a4b3f-107">Gets the resource IDs of the virtual machines in the availability set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
