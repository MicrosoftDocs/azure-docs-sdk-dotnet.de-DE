  ...
  <Members>
    ...
    <Member MemberName="ListAllAsync">
      ...
      <Docs>
        ...
        <summary>
            Ruft eine Liste aller VM-Skalierungsgruppen für das Abonnement unabhängig von der zugehörigen Ressourcengruppe ab. Verwenden Sie "NextLink"-Eigenschaft in der Antwort, um die nächste Seite der VM-Skalierungsgruppen abzurufen. Dazu, bis die "NextLink" nicht null, wenn die VM-Skalierungsgruppen abzurufen ist.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
