  ...
  <Members>
    ...
    <Member MemberName="ListNextWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Ruft die Liste der Bilder in das Abonnement ab. Verwenden Sie "NextLink"-Eigenschaft in der Antwort, um die nächste Seite der Bilder zu erhalten. Tun Sie dies aus, bis die "NextLink" nicht null, um alle Images abzurufen ist.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
