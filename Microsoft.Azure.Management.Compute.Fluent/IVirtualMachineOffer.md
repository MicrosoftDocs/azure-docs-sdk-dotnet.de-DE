<Type Name="IVirtualMachineOffer" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineOffer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dfb56-101">Stellt ein VM-Image-Angebot.</span><span class="sxs-lookup"><span data-stu-id="dfb56-101">Represents a virtual machine image offer.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Publisher">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dfb56-102">Ruft den Herausgeber der dieses VM-Image-Angebot.</span><span class="sxs-lookup"><span data-stu-id="dfb56-102">Gets the publisher of this virtual machine image offer.</span></span>
            </summary>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dfb56-103">Ruft die Region, in dem dieses VM-Image-Angebot verfügbar ist.</span><span class="sxs-lookup"><span data-stu-id="dfb56-103">Gets the region where this virtual machine image offer is available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Skus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dfb56-104">Ruft Abbild eines virtuellen Computers SKUs in dieses Angebot verfügbar.</span><span class="sxs-lookup"><span data-stu-id="dfb56-104">Gets virtual machine image SKUs available in this offer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
