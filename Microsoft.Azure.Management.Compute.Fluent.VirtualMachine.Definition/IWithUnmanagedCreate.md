<Type Name="IWithUnmanagedCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithUnmanagedCreate">
  ...
  <Docs>
    <summary>
            Die Phase einer virtuellen Maschine-Definition enthält alle minimale erforderlichen Eingaben für den virtuellen Computer erstellt werden und optional zugelassen wird, nicht verwalteten Datenträger und die Einstellungen speziell für nicht verwalteten Betriebssystemdatenträger angegeben werden.
            </summary>
  ...
  <Members>
    <Member MemberName="WithOSDiskVhdLocation">
      ...
      <Docs>
        <param name="containerName">Der Name des Containers in das ausgewählte Speicherkonto an.</param>
        <param name="vhdName">der Name für den Betriebssystem-Datenträger VHD.</param>
        <summary>
            Gibt den Namen der VHD-Datei ein Betriebssystem-Datenträger und den übergeordneten Container.
            </summary>
