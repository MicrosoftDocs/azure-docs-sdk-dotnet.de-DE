<Type Name="IWithWindowsCreateManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithWindowsCreateManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            Die Phase der Definition des Windows-VM ermöglicht, nicht verwalteten Datenträger zu aktivieren oder die Definition des virtuellen Computers mit verwalteten Datenträger nur fortgesetzt werden.
            </summary>
  ...
  <Members>
    <Member MemberName="WithUnmanagedDisks">
      ...
      <Docs>
        <summary>
            Nicht verwaltete Datenträger-Unterstützung auf diesem virtuellen Computer ermöglicht.
            </summary>
