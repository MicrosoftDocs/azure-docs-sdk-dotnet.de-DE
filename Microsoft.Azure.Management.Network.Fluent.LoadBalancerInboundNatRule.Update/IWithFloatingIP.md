<Type Name="IWithFloatingIP" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IWithFloatingIP">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e567-101">Die Phase eines eingehenden NAT-Regel-Updates zulassen, um anzugeben, ob die floating-IP aktiviert werden soll.</span><span class="sxs-lookup"><span data-stu-id="7e567-101">The stage of an inbound NAT rule update allowing to specify whether floating IP should be enabled.</span></span>
            </summary>
