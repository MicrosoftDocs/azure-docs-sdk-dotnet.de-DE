<Type Name="IWithProtocol" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IWithProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="21aa6-101">Die Phase einer eingehenden NAT Regel Update ermöglichen an das Transportprotokoll für die Regel angewendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="21aa6-101">The stage of an inbound NAT rule update allowing to specify the transport protocol for the rule to apply to.</span></span>
            </summary>
