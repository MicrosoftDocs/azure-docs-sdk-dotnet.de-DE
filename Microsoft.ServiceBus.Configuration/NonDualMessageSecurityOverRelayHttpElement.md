<Type Name="NonDualMessageSecurityOverRelayHttpElement" FullName="Microsoft.ServiceBus.Configuration.NonDualMessageSecurityOverRelayHttpElement">
  ...
  <Interfaces />
  <Docs>
    <summary>Stellt die Konfigurationseinstellungen für die Sicherheit einer Meldung dar, die mithilfe von HTTP für Nicht-Duplex-Dienstverträge gesendet wurde. Diese Klasse kann nicht vererbt werden.</summary>
  ...
  <Members>
    ...
    <Member MemberName="EstablishSecurityContext">
      ...
      <Docs>
        <summary>Ruft ab oder legt einen XML-Wert, der definiert, ob ein Sicherheitskontext eingerichtet wurde.</summary>
        <value>"true", wenn der Kontext hergestellt wird; andernfalls "false".</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
