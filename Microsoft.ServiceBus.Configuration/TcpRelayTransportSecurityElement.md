<Type Name="TcpRelayTransportSecurityElement" FullName="Microsoft.ServiceBus.Configuration.TcpRelayTransportSecurityElement">
  ...
  <Interfaces />
  <Docs>
    <summary>Stellt ein Konfigurationselement, das die Sicherheit für einen TCP-Transport-Dienst über die Azure Service Bus-Relay konfiguriert.</summary>
  ...
  <Members>
    ...
    <Member MemberName="ProtectionLevel">
      ...
      <Docs>
        <summary>Ruft ab, oder legt ihn fest einen XML-Wert, die die Transport-Sicherheitsstufe für eine TCP-Relay enthält.</summary>
        <value>Gibt eine <see cref="T:System.Net.Security.ProtectionLevel" /> , enthält die transportsicherheitsebene. Der Standardwert ist EncryptAndSign.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
