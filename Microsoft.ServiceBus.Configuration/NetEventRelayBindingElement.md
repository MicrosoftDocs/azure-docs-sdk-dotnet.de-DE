<Type Name="NetEventRelayBindingElement" FullName="Microsoft.ServiceBus.Configuration.NetEventRelayBindingElement">
  ...
  <Interfaces />
  <Docs>
    <summary>Ein Konfigurationselement, das Konfigurationseinstellungen für beschreibt die <see cref="T:Microsoft.ServiceBus.NetEventRelayBinding" />.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Configuration.NetEventRelayBindingElement" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Bindung, die in der Konfiguration festgelegt werden.</param>
        <summary>Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ServiceBus.Configuration.NetEventRelayBindingElement" /> -Klasse unter Verwendung des angegebenen Namens.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BindingElementType">
      ...
      <Docs>
        ...
        <value>Gibt eine <see cref="T:System.Type" /> , enthält den Bindungstyp, ist der Typ des <see cref="T:Microsoft.ServiceBus.NetEventRelayBinding" />.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InitializeFrom">
      ...
      <Docs>
        <param name="binding"> Die Bindung so kopieren Sie die Einstellungen aus.</param>
        <summary>Initialisiert den Inhalt dieses Konfigurationselements XML aus den Eigenschaftswerten einer angegebenen Bindung.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MaxBufferSize">
      ...
      <Docs>
        <summary>Ruft ab oder legt die maximale Größe des Puffers zum Speichern von Nachrichten im Arbeitsspeicher in Bytes.</summary>
    ...
    <Member MemberName="MaxConnections">
      ...
      <Docs>
        <summary>Ruft ab oder legt die maximale Anzahl an Verbindungen, für die nachfolgende Wiederverwendung auf dem Client gepoolt werden sollen und die maximale Anzahl zulässiger Verbindungen mit ausstehende Übermittlung auf dem Server sein.</summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>Ruft eine Auflistung ab, die enthält Objekte, die Attribute werden können oder Konfiguration-Element für dieses bindungskonfigurationselement.</summary>
    ...
    <Member MemberName="ReaderQuotas">
      ...
      <Docs>
        <summary>Ruft ab oder legt ein XML-Element, das die Beschränkungen der Komplexität von SOAP-Meldungen enthält, die von mit dieser Bindung konfigurierten Endpunkten verarbeitet werden können.</summary>
        <value>Gibt eine <see cref="T:Microsoft.ServiceBus.Configuration.XmlDictionaryReaderQuotasElement" /> , das die komplexitätseinschränkungen für SOAP-Nachrichten angibt.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Security">
      ...
      <Docs>
        <summary>Ruft ein Konfigurationselement, das die Sicherheitsoptionen für eine Azure-Servicebus netevent-RelayBindung enthält.</summary>
        <value>Gibt eine <see cref="T:Microsoft.ServiceBus.Configuration.NetOnewayRelaySecurityElement" /> , beschreibt die Sicherheitsoptionen. Der Standardwert ist Transport.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
