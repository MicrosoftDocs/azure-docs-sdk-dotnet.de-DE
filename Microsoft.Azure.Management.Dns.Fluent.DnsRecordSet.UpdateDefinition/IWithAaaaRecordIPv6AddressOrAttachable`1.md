<Type Name="IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithAaaaRecordIPv6AddressOrAttachable`1" />
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="a5bc9-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="a5bc9-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="a5bc9-102">Die Phase der AAAA-Eintrag festgelegt Definition zulassen Hinzufügen zusätzlicher A-Datensätze oder anfügen, mit dem übergeordneten Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a5bc9-102">The stage of the AAAA record set definition allowing to add additional A records or attach the record set to the parent.</span></span>
            </summary>
