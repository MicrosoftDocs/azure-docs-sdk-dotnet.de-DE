  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="linkedService">
            Verknüpften Dienst der Ressourcendefinition.
            </param>
        <param name="ifMatch">
            ETag der Entität LinkedService.  Sollte nur angegeben werden, für das Update, für die vorhandene Entität übereinstimmen oder können werden * für unbedingtes Update.
            </param>
        <summary>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        ...
        <summary>
            Löscht einen verknüpften Dienst an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
