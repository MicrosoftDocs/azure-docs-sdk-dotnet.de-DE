<Type Name="PipelinesOperationsExtensions" FullName="Microsoft.Azure.Management.DataFactory.PipelinesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für PipelinesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="pipeline">
            Pipeline in der Ressourcendefinition.
            </param>
        <param name="ifMatch">
            ETag der Entität Pipeline.  Sollte nur angegeben werden, für das Update, für die vorhandene Entität übereinstimmen oder können werden * für unbedingtes Update.
            </param>
        <summary>
    ...
    <Member MemberName="CreateRun">
      ...
      <Docs>
        ...
        <param name="parameters">
            Führen Sie die Parameter der Pipeline.
            </param>
        <summary>
