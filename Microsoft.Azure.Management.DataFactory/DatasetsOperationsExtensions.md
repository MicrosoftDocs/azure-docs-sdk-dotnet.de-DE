<Type Name="DatasetsOperationsExtensions" FullName="Microsoft.Azure.Management.DataFactory.DatasetsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für DatasetsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="dataset">
            Definition der Datasets-Ressource.
            </param>
        <param name="ifMatch">
            ETag der Entität Dataset.  Sollte nur angegeben werden, für das Update, für die vorhandene Entität übereinstimmen oder können werden * für unbedingtes Update.
            </param>
        <summary>
            Erstellt oder aktualisiert ein Dataset.
            </summary>
