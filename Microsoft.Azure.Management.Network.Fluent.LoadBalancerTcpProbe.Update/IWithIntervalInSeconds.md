<Type Name="IWithIntervalInSeconds" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerTcpProbe.Update.IWithIntervalInSeconds">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aa865-101">Die Phase des TCP-Prüfpunkt aktualisieren, sodass so ändern Sie das Testintervall an.</span><span class="sxs-lookup"><span data-stu-id="aa865-101">The stage of the TCP probe update allowing to modify the probe interval.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithIntervalInSeconds">
      ...
      <Docs>
        <param name="seconds"><span data-ttu-id="aa865-102">Anzahl der Sekunden.</span><span class="sxs-lookup"><span data-stu-id="aa865-102">Number of seconds.</span></span></param>
        <summary>
            <span data-ttu-id="aa865-103">Gibt das Intervall zwischen Prüfpunkten in Sekunden an.</span><span class="sxs-lookup"><span data-stu-id="aa865-103">Specifies the interval between probes, in seconds.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="aa865-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="aa865-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>