<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Batch.Fluent.Application.Definition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    ...
    <summary>
            Der abschließenden Phase der Anwendungsdefinition.
            Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die Anwendungsdefinition an der Definition des übergeordneten Batch-Konto angefügt werden kann.
            </summary>
  ...
  <Members>
    <Member MemberName="WithAllowUpdates">
      ...
      <Docs>
        ...
        <summary>
            Die Phase der Definition eines Batch-Anwendung ermöglicht die automatische Anwendung von Updates.
            </summary>
    ...
    <Member MemberName="WithDisplayName">
      ...
      <Docs>
        ...
        <summary>
            Gibt einen Anzeigenamen für die Batch-Anwendung an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
