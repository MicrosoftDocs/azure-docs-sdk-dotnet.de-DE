<Type Name="IUpdateARecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateARecordSet.IUpdateARecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="edf72-101">Rahmen eines A-Eintrags für die gesamte Festlegung Update als Teil der übergeordneten DNS-Zone aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="edf72-101">The entirety of an A record set update as a part of parent DNS zone update.</span></span>
            </summary>
