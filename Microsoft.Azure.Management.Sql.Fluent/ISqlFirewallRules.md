<Type Name="ISqlFirewallRules" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlFirewallRules">
  ...
  <Docs>
    <summary>
            Einstiegspunkt für einen SQL-FirewallRule-Verwaltungs-API.
            </summary>
  ...
  <Members>
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        ...
        <summary>
            Ruft die SQL-Datenbank basierend auf den SQL Server-Instanz und den FirewallRule Namen ab.
            </summary>
    ...
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        ...
        <param name="name">der Name der SQL-Datenbank.</param>
        <summary>
            Ruft die SQL-Datenbank basierend auf der Name der Ressourcengruppe, SQL Server-Name und FirewallRule Namen ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Eine unveränderliche Darstellung der SQL-Datenbank.</return>
