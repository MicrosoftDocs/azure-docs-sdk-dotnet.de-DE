  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="containerSettings">Die Einstellungen für den Container an, unter dem die Startaufgabe ausgeführt wird.</param>
    ...
    <Member MemberName="ContainerSettings">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Einstellungen für den Container an, unter dem die Startaufgabe ausgeführt wird.
            </summary>
        <value>To be added.</value>
        <remarks>
