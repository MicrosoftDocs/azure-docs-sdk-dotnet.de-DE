<Type Name="JobScheduleState" FullName="Microsoft.Azure.Batch.Protocol.Models.JobScheduleState">
  ...
  <Docs>
    <summary>
            Definiert Werte für JobScheduleState an.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Deleting">
      ...
      <Docs>
        <summary>
            Der Benutzer fordert, dass der Zeitplan gelöscht werden, aber der Delete-Vorgang wird noch ausgeführt. Der Planer keine neuen Aufträge für diesen Zeitplan nicht initiiert wird und alle vorhandenen Aufträge und Aufgaben unter den Zeitplan, einschließlich alle aktiven Auftrag gelöscht. Der Zeitplan wird gelöscht werden, wenn alle Aufträge und Aufgaben der Zeitplan gelöscht wurden.
            </summary>
      </Docs>
    </Member>
