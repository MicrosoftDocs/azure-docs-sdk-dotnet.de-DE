<Type Name="OutputFileUploadOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.OutputFileUploadOptions">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OutputFileUploadOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="uploadCondition">Die Bedingungen, unter denen die Datei oder eine Gruppe von Dateien taskausgabe, sollte hochgeladen werden.</param>
        <summary>
            Initialisiert eine neue Instanz der OutputFileUploadOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="UploadCondition">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Bedingungen, unter dem Ausgabedatei für des Tasks oder Satz von Dateien hochgeladen werden soll.
            </summary>
        <value>To be added.</value>
        <remarks>
            Der Standardwert ist TaskCompletion. Folgende Werte sind möglich: "TaskSuccess", "AufgabeFehler", "TaskCompletion"
            </remarks>
      </Docs>
    </Member>
