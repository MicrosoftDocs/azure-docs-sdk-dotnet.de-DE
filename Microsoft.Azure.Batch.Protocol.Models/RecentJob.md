<Type Name="RecentJob" FullName="Microsoft.Azure.Batch.Protocol.Models.RecentJob">
  ...
  <Docs>
    <summary>
            Informationen zu den letzten Auftrag unter der Auftragszeitplan ausgeführt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RecentJob-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Die ID des Auftrags.</param>
