<Type Name="ApplicationSummary" FullName="Microsoft.Azure.Batch.Protocol.Models.ApplicationSummary">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44791-101">Enthält Informationen zu einer Anwendung in einem Azure Batch-Konto an.</span><span class="sxs-lookup"><span data-stu-id="44791-101">Contains information about an application in an Azure Batch account.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44791-102">Initialisiert eine neue Instanz der ApplicationSummary-Klasse.</span><span class="sxs-lookup"><span data-stu-id="44791-102">Initializes a new instance of the ApplicationSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="44791-103">Eine Zeichenfolge, die die Anwendung im Konto eindeutig identifiziert.</span><span class="sxs-lookup"><span data-stu-id="44791-103">A string that uniquely identifies the application within the account.</span></span></param>
        <param name="displayName"><span data-ttu-id="44791-104">Der Anzeigename für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="44791-104">The display name for the application.</span></span></param>
        <param name="versions"><span data-ttu-id="44791-105">Die Liste der verfügbaren Versionen der Anwendung.</span><span class="sxs-lookup"><span data-stu-id="44791-105">The list of available versions of the application.</span></span></param>
        <summary>
            <span data-ttu-id="44791-106">Initialisiert eine neue Instanz der ApplicationSummary-Klasse.</span><span class="sxs-lookup"><span data-stu-id="44791-106">Initializes a new instance of the ApplicationSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44791-107">Ruft ab oder legt den Anzeigenamen für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="44791-107">Gets or sets the display name for the application.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44791-108">Ruft ab oder legt eine Zeichenfolge, die die Anwendung im Konto eindeutig identifiziert.</span><span class="sxs-lookup"><span data-stu-id="44791-108">Gets or sets a string that uniquely identifies the application within the account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44791-109">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="44791-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="44791-110">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="44791-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="Versions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44791-111">Ruft ab oder legt die Liste der verfügbaren Versionen der Anwendung.</span><span class="sxs-lookup"><span data-stu-id="44791-111">Gets or sets the list of available versions of the application.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
