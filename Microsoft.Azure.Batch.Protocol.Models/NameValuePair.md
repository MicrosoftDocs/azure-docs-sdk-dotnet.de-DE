<Type Name="NameValuePair" FullName="Microsoft.Azure.Batch.Protocol.Models.NameValuePair">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name im Name-Wert-Paar.</param>
        <param name="value">Der Wert im Name-Wert-Paar.</param>
        <summary>
            Initialisiert eine neue Instanz der NameValuePair-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen im Name-Wert-Paar.
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Wert im Name-Wert-Paar.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
