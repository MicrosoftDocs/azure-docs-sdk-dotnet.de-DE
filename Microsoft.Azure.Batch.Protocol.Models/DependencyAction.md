<Type Name="DependencyAction" FullName="Microsoft.Azure.Batch.Protocol.Models.DependencyAction">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e42c2-101">Definiert Werte für die Aktion Abhängigkeit an.</span><span class="sxs-lookup"><span data-stu-id="e42c2-101">Defines values for DependencyAction.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Block">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e42c2-102">Blockieren Sie Abhängigkeiten für den Task.</span><span class="sxs-lookup"><span data-stu-id="e42c2-102">Block the task's dependencies.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Satisfy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e42c2-103">Der Task Abhängigkeiten zu erfüllen.</span><span class="sxs-lookup"><span data-stu-id="e42c2-103">Satisfy the task's dependencies.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
