<Type Name="AllocationState" FullName="Microsoft.Azure.Batch.Protocol.Models.AllocationState">
  ...
  <Docs>
    <summary>
            Definiert Werte für AllocationState an.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Steady">
      ...
      <Docs>
        <summary>
            Der Pool ist keine Größe. Es sind keine Änderungen auf die Anzahl der Knoten im Pool ausgeführt. Ein Pool geht in diesen Zustand, bei der Erstellung und wenn für den Pool so ändern Sie die Anzahl der Knoten keine Vorgänge ausgeführt werden.
            </summary>
      </Docs>
    </Member>
