<Type Name="ComputeNodeEndpointConfiguration" FullName="Microsoft.Azure.Batch.Protocol.Models.ComputeNodeEndpointConfiguration">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ComputeNodeEndpointConfiguration-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="inboundEndpoints">Die Liste der eingehenden Endpunkte, die auf den Computeknoten zugegriffen werden kann.</param>
        <summary>
            Initialisiert eine neue Instanz der ComputeNodeEndpointConfiguration-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="InboundEndpoints">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der eingehenden Endpunkte, die auf den Computeknoten zugegriffen werden kann.
            </summary>
