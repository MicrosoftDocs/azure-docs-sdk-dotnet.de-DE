<Type Name="TaskInformation" FullName="Microsoft.Azure.Batch.Protocol.Models.TaskInformation">
  ...
  <Docs>
    <summary>
            Informationen zu einer Aufgabe, die auf einem Serverknoten ausgeführt wird.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse TaskInformation an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="taskState">Der aktuelle Status der Aufgabe.</param>
        <param name="taskUrl">Die URL der Aufgabe.</param>
        <param name="jobId">Die ID des Auftrags, zu dem die Aufgabe gehört.</param>
        <param name="taskId">Die ID des Tasks.</param>
        <param name="subtaskId">Die ID der Teilvorgang, wenn die Aufgabe einen Vorgang mit mehreren Instanzen.</param>
    ...
    <Member MemberName="JobId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID des Auftrags, zu dem die Aufgabe gehört.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubtaskId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID für die Unteraufgaben fest, wenn der Task eine Aufgabe mit mehreren Instanzen ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
