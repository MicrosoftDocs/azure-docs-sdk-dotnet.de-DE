<Type Name="NodeRebootParameter" FullName="Microsoft.Azure.Batch.Protocol.Models.NodeRebootParameter">
  ...
  <Docs>
    <summary>
            Optionen für einen Serverknoten neu zu starten.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der NodeRebootParameter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nodeRebootOption">Wann Serverknoten neu starten, und was mit den derzeit ausgeführten Tasks geschehen.</param>
        <summary>
            Initialisiert eine neue Instanz der NodeRebootParameter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NodeRebootOption">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest, wann der Serverknoten neu starten, und was mit den derzeit ausgeführten Tasks geschehen.
            </summary>
