<Type Name="UsageStatistics" FullName="Microsoft.Azure.Batch.Protocol.Models.UsageStatistics">
  ...
  <Docs>
    <summary>
            Statistik zu Verwendungsinformationen Anwendungspool.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der UsageStatistics-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="dedicatedCoreTime">Berechnen Sie der aggregierte wanduhrzeit für die dedizierte Knoten Kerne, die Teil des Pools wird.</param>
        <summary>
            Initialisiert eine neue Instanz der UsageStatistics-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DedicatedCoreTime">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der aggregierten wanduhrzeit der dedizierten Compute Knoten Kerne, die Teil des Pools wird.
            </summary>
