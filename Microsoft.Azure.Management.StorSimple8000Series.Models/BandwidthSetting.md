<Type Name="BandwidthSetting" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.BandwidthSetting">
  ...
  <Docs>
    <summary>
            Die Einstellung für die Bandbreite.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="schedules">Die Zeitpläne.</param>
        ...
        <param name="volumeCount">Die Anzahl der Volumes, die die Einstellung für die Bandbreite verwendet wird.</param>
        <summary>
            Initialisiert eine neue Instanz der BandwidthSetting-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Schedules">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeitpläne.
            </summary>
    ...
    <Member MemberName="VolumeCount">
      ...
      <Docs>
        <summary>
            Ruft die Anzahl der Volumes, die die Einstellung für die Bandbreite verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
