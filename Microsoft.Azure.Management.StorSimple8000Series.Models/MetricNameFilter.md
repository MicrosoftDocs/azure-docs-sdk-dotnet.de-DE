<Type Name="MetricNameFilter" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MetricNameFilter">
  ...
  <Docs>
    <summary>
            Der metrikname-Filter, Angeben des Namens der Metrik auf gefiltert werden sollen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der MetricNameFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">Gibt den metrischen Namen auf gefiltert werden sollen.
            Z. B. CloudStorageUsed. Gültige Werte sind diejenigen, die in das Feld "Name" im Aufruf ListMetricDefinitions zurückgegeben. Für diese Eigenschaft wird nur "Gleichheitsoperator" unterstützt.</param>
        <summary>
            Initialisiert eine neue Instanz der MetricNameFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt den metrischen Namen auf gefiltert werden sollen. Z. B. CloudStorageUsed. Gültige Werte sind diejenigen, die in das Feld "Name" im Aufruf ListMetricDefinitions zurückgegeben. Für diese Eigenschaft wird nur "Gleichheitsoperator" unterstützt.
            </summary>
