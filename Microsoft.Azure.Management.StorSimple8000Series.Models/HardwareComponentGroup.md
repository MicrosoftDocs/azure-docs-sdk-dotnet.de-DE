<Type Name="HardwareComponentGroup" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.HardwareComponentGroup">
  ...
  <Docs>
    <summary>
            Der Komponentengruppe der Hardware.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der HardwareComponentGroup-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="displayName">Der Anzeigename der Komponentengruppe der Hardware.</param>
        <param name="lastUpdatedTime">Das letzte Mal aktualisiert.</param>
        <param name="components">Die Liste der Hardwarekomponenten.</param>
    ...
    <Member MemberName="Components">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Hardwarekomponenten.
            </summary>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt dem Anzeigenamen die Komponentengruppe der Hardware.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastUpdatedTime">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeit der letzten Aktualisierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
