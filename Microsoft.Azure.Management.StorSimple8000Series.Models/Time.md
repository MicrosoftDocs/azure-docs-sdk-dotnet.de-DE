<Type Name="Time" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.Time">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="hours">Die Stunde.</param>
        <param name="minutes">Die Minute.</param>
        <param name="seconds">Die zweite.</param>
        <summary>
            Initialisiert eine neue Instanz der Time-Klasse.
            </summary>
        <remarks>To be added.</remarks>
