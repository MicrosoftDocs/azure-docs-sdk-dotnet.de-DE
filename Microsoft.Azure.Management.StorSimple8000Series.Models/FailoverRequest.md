<Type Name="FailoverRequest" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.FailoverRequest">
  ...
  <Docs>
    <summary>
            Das Anforderungsobjekt bei auslösen, wenn einen Failover der volumecontainer über eine Quellgerät auf einem Zielgerät.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FailoverRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetDeviceId">Die ARM-Pfad-ID des Geräts, der als Ziel für das Failover fungiert.</param>
        <param name="volumeContainers">Die Liste der Path-IDs der volumecontainer, der auf dem Zielgerät Failover werden muss.</param>
        <summary>
            Initialisiert eine neue Instanz der FailoverRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TargetDeviceId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ARM-Pfad-ID des Geräts, der als Ziel für das Failover fungiert.
            </summary>
    ...
    <Member MemberName="VolumeContainers">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Path-IDs der volumecontainer, der auf dem Zielgerät Failover werden muss.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
