<Type Name="MetricAvailablity" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MetricAvailablity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der MetricAvailablity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeGrain">Das aggregationsintervall für die Metrik.</param>
        <param name="retention">die Beibehaltungsdauer für die Metrik auf der angegebenen timegrain-Wert.</param>
        <summary>
            Initialisiert eine neue Instanz der MetricAvailablity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Retention">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen die Beibehaltungsdauer für die Metrik auf der angegebenen timegrain-Wert.
            </summary>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest aggregationsintervalls für die Metrik.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
