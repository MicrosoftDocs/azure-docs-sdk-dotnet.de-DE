<Type Name="BackupElement" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.BackupElement">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BackupElement-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="elementId">Die Pfad-ID, den backup-Element eindeutig identifiziert.</param>
        <param name="elementName">Der Name der backup-Element.</param>
        <param name="elementType">Der hierarchische Typ der backup-Element.</param>
        <param name="sizeInBytes">Die Größe in Bytes.</param>
        <param name="volumeName">Der Name des Volumes.</param>
        <param name="volumeContainerId">Die Pfad-ID des volumecontainers.</param>
        <param name="volumeType">Der Volumetyp. Folgende Werte sind möglich: "Mehrstufigen", "Archivierung", "LocallyPinned"</param>
        <summary>
            Initialisiert eine neue Instanz der BackupElement-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ElementId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Pfad-ID, den backup-Element eindeutig identifiziert.
            </summary>
    ...
    <Member MemberName="ElementName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der backup-Element.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ElementType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest die hierarchische der backup-Element.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VolumeContainerId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Pfad-ID des Volume-Container.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VolumeName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Volumes.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VolumeType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt des Volumetyps. Folgende Werte sind möglich: "Mehrstufigen", "Archivierung", "LocallyPinned"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
