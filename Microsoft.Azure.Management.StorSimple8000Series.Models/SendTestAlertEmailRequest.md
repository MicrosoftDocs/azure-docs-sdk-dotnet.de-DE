<Type Name="SendTestAlertEmailRequest" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.SendTestAlertEmailRequest">
  ...
  <Docs>
    <summary>
            Die Anforderung zum Test warnungsbenachrichtigung per e-Mail senden
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SendTestAlertEmailRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="emailList">Die Liste der e-Mail-IDs der Test-warnungsbenachrichtigung per e-Mail senden</param>
        <summary>
            Initialisiert eine neue Instanz der SendTestAlertEmailRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EmailList">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der e-Mail-IDs der Test-warnungsbenachrichtigung per e-Mail senden
            </summary>
