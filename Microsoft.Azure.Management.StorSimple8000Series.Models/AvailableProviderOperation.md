<Type Name="AvailableProviderOperation" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.AvailableProviderOperation">
  ...
  <Docs>
    <summary>
            Stellt die verfügbaren Anbieter-Vorgang dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AvailableProviderOperation-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Vorgangs für ein bestimmtes Objekt ausgeführt wird. Das Namensformat: "{ResourceProviderNamespace} / {ResourceType} / {Lesen | Schreiben | Löschen | Aktion}".
            Beispiel: Microsoft.StorSimple/managers/devices/volumeContainers/read Microsoft.StorSimple/managers/devices/alerts/clearAlerts/action</param>
        <param name="display">Enthält die lokalisierten Anzeigeinformationen für diese bestimmten Vorgang/Aktion an.</param>
        <param name="origin">Der vorgesehene Executor des Vorgangs; Steuert die Anzeige des Vorgangs in der RBAC-UX und die Überwachungsprotokolle UX. Standardwert ist "User System"</param>
        <param name="properties">Für zukünftige Verwendung reserviert.</param>
        <summary>
            Initialisiert eine neue Instanz der AvailableProviderOperation-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt enthält die lokalisierten Anzeigeinformationen für diese bestimmten Vorgang/Aktion.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Vorgangs für ein bestimmtes Objekt ausgeführt wird. Das Namensformat: "{ResourceProviderNamespace} / {ResourceType} / {Lesen | Schreiben | Löschen | Aktion}".
            Beispiel: Microsoft.StorSimple/managers/devices/volumeContainers/read Microsoft.StorSimple/managers/devices/alerts/clearAlerts/action
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt für die zukünftige Verwendung reserviert.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
