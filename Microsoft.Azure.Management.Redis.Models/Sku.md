<Type Name="Sku" FullName="Microsoft.Azure.Management.Redis.Models.Sku">
  ...
  <Docs>
    <summary>
            So erstellen Sie Redis-Vorgang angegebenen SKU-Parameter.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Typ des Redis-Cache bereitstellen. Gültige Werte: (Basic, Standard, Premium). Folgende Werte sind möglich: "Basic", "Standard", "Premium"</param>
        <param name="family">Die SKU-Familie verwenden. Gültige Werte: (C, P).
            (C = Basic-/Standard, P = Premium). Folgende Werte sind möglich: "C", "P"</param>
        <param name="capacity">Die Größe des Redis-Caches bereitstellen. Gültige Werte: für C (Basic-/Standard) der Produktfamilie (0, 1, 2, 3, 4, 5, 6), P (Premium) Familie (1, 2, 3, 4).</param>
        <summary>
            Initialisiert eine neue Instanz der Sku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Größe des Redis-Cache bereitstellen. Gültige Werte: für C (Basic-/Standard) der Produktfamilie (0, 1, 2, 3, 4, 5, 6), P (Premium) Familie (1, 2, 3, 4).
            </summary>
    ...
    <Member MemberName="Family">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen die SKU-Familie verwenden. Gültige Werte: (C, P). (C = Basic-/Standard, P = Premium). Folgende Werte sind möglich: "C", "P"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Typ des Redis-Caches bereitstellen. Gültige Werte: (Basic, Standard, Premium). Folgende Werte sind möglich: "Basic", "Standard", "Premium"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
