<Type Name="RedisFirewallRule" FullName="Microsoft.Azure.Management.Redis.Models.RedisFirewallRule">
  ...
  <Docs>
    <summary>
            Eine Firewallregel für einen Redis Cache verfügt über einen Namen, und beschreibt einen zusammenhängenden Bereich von IP-Adressen zulässig, um eine Verbindung herstellen
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RedisFirewallRule-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startIP">niedrigste IP-Adresse im Bereich enthalten</param>
        <param name="endIP">höchste IP-Adresse im Bereich enthalten</param>
    ...
    <Member MemberName="EndIP">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die höchste IP-Adresse im Bereich enthalten
            </summary>
    ...
    <Member MemberName="StartIP">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die niedrigste IP-Adresse im Bereich enthalten
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
