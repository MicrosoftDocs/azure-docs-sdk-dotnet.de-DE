<Type Name="Operation" FullName="Microsoft.Azure.Management.Redis.Models.Operation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="52d36-101">REST-API-Vorgang</span><span class="sxs-lookup"><span data-stu-id="52d36-101">REST API operation</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52d36-102">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="52d36-102">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="52d36-103">Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="52d36-103">Operation name: {provider}/{resource}/{operation}</span></span></param>
        <param name="display"><span data-ttu-id="52d36-104">Das Objekt, das den Vorgang beschreibt.</span><span class="sxs-lookup"><span data-stu-id="52d36-104">The object that describes the operation.</span></span></param>
        <summary>
            <span data-ttu-id="52d36-105">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="52d36-105">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52d36-106">Ruft ab oder legt das Objekt, das den Vorgang beschreibt.</span><span class="sxs-lookup"><span data-stu-id="52d36-106">Gets or sets the object that describes the operation.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52d36-107">Ruft ab oder legt ihn fest Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="52d36-107">Gets or sets operation name: {provider}/{resource}/{operation}</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
