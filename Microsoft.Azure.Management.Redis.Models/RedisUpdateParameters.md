<Type Name="RedisUpdateParameters" FullName="Microsoft.Azure.Management.Redis.Models.RedisUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4719d-101">Parameter für den Redis-Update zur Verfügung gestellt.</span><span class="sxs-lookup"><span data-stu-id="4719d-101">Parameters supplied to the Update Redis operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-102">Initialisiert eine neue Instanz der RedisUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4719d-102">Initializes a new instance of the RedisUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="redisConfiguration"><span data-ttu-id="4719d-103">Alle Redis-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="4719d-103">All Redis Settings.</span></span> <span data-ttu-id="4719d-104">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="4719d-104">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span></param>
        <param name="enableNonSslPort"><span data-ttu-id="4719d-105">Gibt an, ob die nicht-Ssl-Redis-Server (6379) port aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="4719d-105">Specifies whether the non-ssl Redis server port (6379) is enabled.</span></span></param>
        <param name="tenantSettings"><span data-ttu-id="4719d-106">Ein Wörterbuch von mandanteneinstellungen</span><span class="sxs-lookup"><span data-stu-id="4719d-106">A dictionary of tenant settings</span></span></param>
        <param name="shardCount"><span data-ttu-id="4719d-107">Die Anzahl der Shards auf eine Premium-Cache-Cluster erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="4719d-107">The number of shards to be created on a Premium Cluster Cache.</span></span></param>
        <param name="sku"><span data-ttu-id="4719d-108">Die SKU des Redis-Caches bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="4719d-108">The SKU of the Redis cache to deploy.</span></span></param>
        <param name="tags"><span data-ttu-id="4719d-109">Ressourcentags.</span><span class="sxs-lookup"><span data-stu-id="4719d-109">Resource tags.</span></span></param>
        <summary>
            <span data-ttu-id="4719d-110">Initialisiert eine neue Instanz der RedisUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4719d-110">Initializes a new instance of the RedisUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EnableNonSslPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-111">Ruft ab oder legt ihn fest, gibt Sie an, ob die nicht-Ssl-Redis-Server (6379) port aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="4719d-111">Gets or sets specifies whether the non-ssl Redis server port (6379) is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="RedisConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-112">Ruft ab oder legt alle Redis-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="4719d-112">Gets or sets all Redis Settings.</span></span> <span data-ttu-id="4719d-113">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="4719d-113">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ShardCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-114">Ruft ab oder legt die Anzahl der Shards auf eine Premium-Cache-Cluster erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="4719d-114">Gets or sets the number of shards to be created on a Premium Cluster Cache.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-115">Ruft ab oder legt die SKU des Redis-Caches zum Bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="4719d-115">Gets or sets the SKU of the Redis cache to deploy.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-116">Ermittelt oder Ressourcen-Tags definiert.</span><span class="sxs-lookup"><span data-stu-id="4719d-116">Gets or sets resource tags.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TenantSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-117">Ruft ab oder legt ein Wörterbuch von Mandanten Einstellungen</span><span class="sxs-lookup"><span data-stu-id="4719d-117">Gets or sets a dictionary of tenant settings</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4719d-118">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="4719d-118">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="4719d-119">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="4719d-119">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
