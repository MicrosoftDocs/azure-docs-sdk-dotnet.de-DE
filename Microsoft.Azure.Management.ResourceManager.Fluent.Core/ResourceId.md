<Type Name="ResourceId" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ResourceId">
  ...
  <Docs>
    <summary>
             <span data-ttu-id="2cb28-101">Instanziieren Sie selbst über eine Ressourcen-Id und Ressourceninformationen wie Abonnement, "ResourceGroup", Ressourcenname erteilen Sie einfachen Zugriff.</span><span class="sxs-lookup"><span data-stu-id="2cb28-101">Instantiate itself from a resource id, and give easy access to resource information like subscription, resourceGroup, resource name.</span></span>
             </summary>
  ...
  <Members>
    <Member MemberName="FromString">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="2cb28-102">der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-102">of the resource.</span></span></param>
        <summary>
             <span data-ttu-id="2cb28-103">Gibt analysiert ResourceId-Objekt für einen bestimmten Ressourcen-Id an.</span><span class="sxs-lookup"><span data-stu-id="2cb28-103">Returns parsed ResourceId object for a given resource id.</span></span>
             </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-104">ResourceId-Objekt</span><span class="sxs-lookup"><span data-stu-id="2cb28-104">ResourceId object</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="FullResourceType">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-105">vollständige Typ der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-105">Full type of the resource.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="Id">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-106">Die Id der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-106">The id of the resource.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-107">Der Name der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-107">Name of the resource.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="Parent">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-108">übergeordnete Ressourcen-Id der Ressource an, wenn vorhanden, andernfalls null.</span><span class="sxs-lookup"><span data-stu-id="2cb28-108">Parent resource id of the resource if any, otherwise null.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ProviderNamespace">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-109">Der Name des Anbieters.</span><span class="sxs-lookup"><span data-stu-id="2cb28-109">Name of the provider.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ResourceGroupName">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-110">Der Ressourcengruppenname der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-110">Resource group name of the resource.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ResourceType">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-111">Der Typ der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-111">Type of the resource.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2cb28-112">Abonnement-Id der Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb28-112">Subscription id of the resource.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>