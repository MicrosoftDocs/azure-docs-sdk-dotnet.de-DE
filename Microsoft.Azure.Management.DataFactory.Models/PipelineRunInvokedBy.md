<Type Name="PipelineRunInvokedBy" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunInvokedBy">
  ...
  <Docs>
    <summary>
            Bietet Entitätsname und Id, die die Pipeline ausführen gestartet.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PipelineRunInvokedBy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Entität, die die Pipeline ausführen gestartet.</param>
        <param name="id">Die ID der Entität, die die Ausführung gestartet.</param>
        <summary>
            Initialisiert eine neue Instanz der PipelineRunInvokedBy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft die ID der Entität, die die Ausführung gestartet.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft die Namen der Entität, die die Ausführung der Pipeline gestartet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
