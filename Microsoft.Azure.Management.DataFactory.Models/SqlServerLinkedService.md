<Type Name="SqlServerLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlServerLinkedService">
  ...
  <Docs>
    <summary>
            SQL Server verknüpften Dienst an.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SqlServerLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="userName">Der lokale Windows-Authentifizierung Benutzername. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Das Kennwort der lokalen Windows-Authentifizierung.</param>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das lokale Windows-Authentifizierungskennwort.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen des lokalen Windows-Authentifizierung.
