<Type Name="CassandraSource" FullName="Microsoft.Azure.Management.DataFactory.Models.CassandraSource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CassandraSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="query">Datenbankabfrage. Sollte es sich um eine SQL-92-Ausdruck oder einen Befehl für Cassandra Query Language (CQL) sein. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="consistencyLevel">Die konsistenzebene gibt an, wie viele Cassandra-Server auf eine leseanforderung reagieren müssen, bevor Daten an die Clientanwendung zurückgegeben. Cassandra überprüft die angegebene Anzahl von Cassandra-Servern für Daten, die leseanforderung zu erfüllen. Dabei muss es sich um eine der CassandraSourceReadConsistencyLevels sein. Der Standardwert ist "1". Es wird die Groß-/Kleinschreibung. Folgende Werte sind möglich: "Alle", "EACH_QUORUM", "QUORUM", 'LOCAL_QUORUM', 'ONE', "2", "Drei", "LOCAL_ONE", "Seriell", "LOCAL_SERIAL"</param>
        <summary>
            Initialisiert eine neue Instanz der CassandraSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConsistencyLevel">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die konsistenzebene gibt an, wie viele Cassandra-Server auf eine leseanforderung reagieren müssen, bevor Daten an die Clientanwendung zurückgegeben. Cassandra überprüft die angegebene Anzahl von Cassandra-Servern für Daten, die leseanforderung zu erfüllen. Dabei muss es sich um eine der CassandraSourceReadConsistencyLevels sein. Der Standardwert ist "1". Es wird die Groß-/Kleinschreibung. Folgende Werte sind möglich: "Alle", "EACH_QUORUM", "QUORUM", 'LOCAL_QUORUM', 'ONE', "2", "Drei", "LOCAL_ONE", "Seriell", "LOCAL_SERIAL"
            </summary>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt die Datenbankabfrage fest. Sollte es sich um eine SQL-92-Ausdruck oder einen Befehl für Cassandra Query Language (CQL) sein. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
