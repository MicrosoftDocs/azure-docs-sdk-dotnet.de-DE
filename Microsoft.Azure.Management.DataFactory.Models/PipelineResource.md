<Type Name="PipelineResource" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineResource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PipelineResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="description">Die Beschreibung der Pipeline.</param>
        <param name="activities">Liste der Aktivitäten in der Pipeline.</param>
        <param name="parameters">Liste der Parameter für die Pipeline.</param>
        <param name="concurrency">Die maximale Anzahl von gleichzeitigen Ausführungen für die Pipeline.</param>
        <summary>
            Initialisiert eine neue Instanz der PipelineResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Activities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Aktivitäten in Pipeline fest.
            </summary>
    ...
    <Member MemberName="Concurrency">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Anzahl von gleichzeitigen Ausführungen für die Pipeline.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Beschreibung der Pipeline.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Parameter für die Pipeline.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
