<Type Name="SapBWLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SapBWLinkedService">
  ...
  <Docs>
    <summary>
            SAP Business Warehouse verknüpfte Dienst.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SapBWLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="server">Der Hostname der SAP BW-Instanz. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="systemNumber">Systemnummer von BW-System. (In der Regel eine zweistellige Dezimalzahl als Zeichenfolge dargestellt.) Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="clientId">Client-ID des Clients auf dem BW-System.
            (In der Regel eine dreistellige Dezimalzahl als Zeichenfolge dargestellt) Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="userName">Der Benutzername, der Zugriff auf den SAP BW-Server. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Kennwort zum Zugriff auf den SAP BW-Server.</param>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Client-ID des Clients auf dem BW-System. (In der Regel eine dreistellige Dezimalzahl als Zeichenfolge dargestellt) Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort zum Zugriff auf den SAP BW-Server.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Server">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Hostname der SAP BW-Instanz. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SystemNumber">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Systemnummer von BW-System. (In der Regel eine zweistellige Dezimalzahl als Zeichenfolge dargestellt.) Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Benutzername, der Zugriff auf den SAP BW-Server. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
