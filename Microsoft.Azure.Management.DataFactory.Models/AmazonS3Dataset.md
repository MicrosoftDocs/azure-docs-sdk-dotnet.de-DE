<Type Name="AmazonS3Dataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AmazonS3Dataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AmazonS3Dataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="bucketName">Der Name des Amazon-S3-Buckets. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="key">Der Schlüssel des Objekts Amazon S3. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="prefix">Der präfixfilter für den Objektnamen S3.
            Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="version">Die Version für das S3-Objekt. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="format">Das Format der Dateien.</param>
        <param name="compression">Die datenkomprimierungsmethode für das Amazon S3-Objekt verwendet wird.</param>
        <summary>
            Initialisiert eine neue Instanz der AmazonS3Dataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BucketName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Amazon-S3-Buckets. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="Compression">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die datenkomprimierungsmethode für das Amazon S3-Objekt verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Schlüssel des Amazon-S3-Objekts fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Prefix">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der präfixfilter für den Objektnamen S3. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version für das Objekt S3. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
