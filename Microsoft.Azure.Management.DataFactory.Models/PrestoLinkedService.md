<Type Name="PrestoLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.PrestoLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PrestoLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">IP-Adresse oder Hostname des Presto-Servers. (z.B. 192.168.222.160)</param>
        <param name="serverVersion">Die Version des Presto-Servers. (z.B. 0.148-t)</param>
        <param name="catalog">Der Katalogkontext für alle Anforderungen an den Server.</param>
        <param name="authenticationType">Der Authentifizierungsmechanismus, der für die Verbindung mit dem Presto-Server verwendet werden soll. Folgende Werte sind möglich: "Anonymous", "LDAP"</param>
        ...
        <param name="port">Der TCP-Port, den der Presto-Server verwendet, um auf Clientverbindungen zu lauschen. Der Standardwert ist 8080.</param>
        <param name="username">Der Benutzername, der für die Verbindung mit dem Presto-Server verwendet werden soll.</param>
        ...
        <param name="timeZoneID">Die lokale Zeitzone, die von der Verbindung verwendet wird. Gültige Werte für diese Option sind in der Zeitzonendatenbank der IANA angegeben. Der Standardwert ist die Zeitzone des Systems.</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Authentifizierungsmechanismus verwendet, um mit dem Komma Server verbinden. Folgende Werte sind möglich: "Anonymous", "LDAP"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Catalog">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Katalogkontext für alle Anforderungen für den Server.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die IP-Adresse oder den Hostnamen den Namen des Servers ein Komma.
            (z.B. 192.168.222.160)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den TCP-Port, den der Komma Server verwendet wird, um Clientverbindungen. Der Standardwert ist 8080.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version des Servers ein Komma. (z.B. 0.148-t)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeZoneID">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen die lokalen Zeitzone von der Verbindung verwendet. Gültige Werte für diese Option sind in der Zeitzonendatenbank der IANA angegeben. Der Standardwert ist die Zeitzone des Systems.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen, die zur Verbindung mit dem Komma Server fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
