<Type Name="AzureDataLakeAnalyticsLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureDataLakeAnalyticsLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureDataLakeAnalyticsLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accountName">Der Name des Azure Data Lake Analytics-Konto. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="servicePrincipalId">Die ID der Anwendung, die zum Authentifizieren beim Azure Data Lake Analytics-Konto verwendet werden soll. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="servicePrincipalKey">Der Schlüssel der Anwendung zum Authentifizieren beim Azure Data Lake Analytics-Konto verwendet werden soll.</param>
        <param name="subscriptionId">Data Lake Analytics-Konto Abonnement-ID (falls abweichend vom Data Factory-Konto). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="resourceGroupName">Data Lake Analytics-Konto Ressourcengruppenname (falls abweichend vom Data Factory-Konto). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="dataLakeAnalyticsUri">Azure Data Lake Analytics-URI-Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="AccountName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Azure Data Lake Analytics-Konto fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="DataLakeAnalyticsUri">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Azure Data Lake Analytics-URI-Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGroupName">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert Data Lake Analytics-Konto Ressourcengruppenname (falls abweichend vom Data Factory-Konto). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServicePrincipalId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID der Anwendung verwendet zum Authentifizieren beim Azure Data Lake Analytics-Konto fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServicePrincipalKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Schlüssel der Anwendung verwendet zum Authentifizieren beim Azure Data Lake Analytics-Konto fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Data Lake Analytics-Konto-Abonnement-ID (falls abweichend vom Data Factory-Konto). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
