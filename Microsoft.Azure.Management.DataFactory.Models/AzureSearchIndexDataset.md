<Type Name="AzureSearchIndexDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSearchIndexDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureSearchIndexDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="indexName">Der Name der Azure Search-Index. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="IndexName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Azure Search-Index. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
