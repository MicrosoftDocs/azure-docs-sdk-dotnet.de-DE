<Type Name="SalesforceLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SalesforceLinkedService">
  ...
  <Docs>
    <summary>
            Verknüpften Dienst für Salesforce.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SalesforceLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="environmentUrl">Die URL des Salesforce-Instanz.
            Der Standardwert ist "https://login.salesforce.com". Geben Sie zum Kopieren von Daten vom Sandkasten "https://test.salesforce.com" ein. Kopieren Sie Daten von benutzerdefinierten Domäne Geben Sie an, z. B. "https://[domain].my.salesforce.com". Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="username">Der Benutzername für die Standardauthentifizierung der Salesforce-Instanz. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Das Kennwort für die Standardauthentifizierung der Salesforce-Instanz.</param>
        <param name="securityToken">Das Sicherheitstoken ist erforderlich, für den Remotezugriff von Salesforce-Instanz.</param>
    ...
    <Member MemberName="EnvironmentUrl">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die URL des Salesforce-Instanz. Der Standardwert ist "https://login.salesforce.com". Geben Sie zum Kopieren von Daten vom Sandkasten "https://test.salesforce.com" ein. Kopieren Sie Daten von benutzerdefinierten Domäne Geben Sie an, z. B. "https://[domain].my.salesforce.com". Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für die Standardauthentifizierung der Salesforce-Instanz.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecurityToken">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest, muss das Sicherheitstoken für den Remotezugriff von Salesforce-Instanz.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen für die Standardauthentifizierung der Salesforce-Instanz. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
