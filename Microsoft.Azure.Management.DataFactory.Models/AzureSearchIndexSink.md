<Type Name="AzureSearchIndexSink" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSearchIndexSink">
  ...
  <Docs>
    <summary>
            Kopieren-Aktivität Azure Search-Index Senke.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureSearchIndexSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="writeBehavior">Geben Sie das Write-Verhalten, wenn Upserting in Azure Search-Index Dokumente. Folgende Werte sind möglich: "Merge", "Hochladen"</param>
        <summary>
            Initialisiert eine neue Instanz der AzureSearchIndexSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest geben das Write-Verhalten auf, wenn Upserting in Azure Search-Index Dokumente. Folgende Werte sind möglich: "Merge", "Hochladen"
            </summary>
