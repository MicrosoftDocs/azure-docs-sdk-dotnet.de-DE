<Type Name="ScheduleTriggerRecurrence" FullName="Microsoft.Azure.Management.DataFactory.Models.ScheduleTriggerRecurrence">
  ...
  <Docs>
    <summary>
            Die Wiederholung des Workflow-Trigger.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ScheduleTriggerRecurrence-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="frequency">Die Häufigkeit. Folgende Werte sind möglich: "NotSpecified" "", "Minute", 'Hour', 'Day', 'Week', 'Month', 'Year'</param>
        <param name="interval">Das Intervall.</param>
        <param name="startTime">Die Startzeit.</param>
        <param name="endTime">Die Endzeit.</param>
        <param name="timeZone">Die Zeitzone.</param>
        <param name="schedule">Die Wiederholung des Zeitplans.</param>
        <summary>
            Initialisiert eine neue Instanz der ScheduleTriggerRecurrence-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Frequency">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Häufigkeit fest. Folgende Werte sind möglich: "NotSpecified" "", "Minute", 'Hour', 'Day', 'Week', 'Month', 'Year'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Schedule">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Wiederholung des Zeitplans.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeZone">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeitzone.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
