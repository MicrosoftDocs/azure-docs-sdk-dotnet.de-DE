<Type Name="RetryPolicy" FullName="Microsoft.Azure.Management.DataFactory.Models.RetryPolicy">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="count">Maximale Wiederholungsversuche gewöhnliche. Der Standardwert ist 0.
            Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimale:
            0.</param>
        <param name="intervalInSeconds">Intervall zwischen Wiederholungsversuchen in Sekunden. Standardwert ist 30.</param>
        <summary>
            Initialisiert eine neue Instanz der RetryPolicy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IntervalInSeconds">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Intervall zwischen Wiederholungsversuchen in Sekunden fest. Standardwert ist 30.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
