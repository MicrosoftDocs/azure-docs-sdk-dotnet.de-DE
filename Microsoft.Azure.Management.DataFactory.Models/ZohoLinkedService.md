<Type Name="ZohoLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ZohoLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ZohoLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Der Endpunkt des Zoho-Servers. (d. h. crm.zoho.com/crm/private)</param>
        ...
        <param name="accessToken">Das Zugriffstoken für die Zoho-Authentifizierung.</param>
    ...
    <Member MemberName="AccessToken">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Zugriffstoken für die Authentifizierung von Zoho.
            </summary>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Endpunkt des Servers Zoho. (d. h. crm.zoho.com/crm/private)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
