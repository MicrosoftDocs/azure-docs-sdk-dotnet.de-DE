<Type Name="AzureSqlDWTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSqlDWTableDataset">
  ...
  <Docs>
    <summary>
            Die Azure SQL Data Warehouse-Dataset.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureSqlDWTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Der Tabellenname des Azure SQL Data Warehouse. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Tabellennamen von Azure SQL Data Warehouse. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
