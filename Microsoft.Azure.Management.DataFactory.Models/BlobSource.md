<Type Name="BlobSource" FullName="Microsoft.Azure.Management.DataFactory.Models.BlobSource">
  ...
  <Docs>
    <summary>
            Ein Azure-Blob-Quelle kopieren Aktivität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BlobSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="treatEmptyAsNull">Behandeln Sie als null, leer. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <param name="skipHeaderLineCount">Anzahl der Kopfzeilen aus jedes Blob zu überspringen. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).</param>
    ...
    <Member MemberName="SkipHeaderLineCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der Kopfzeilen aus jedes Blob zu überspringen. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TreatEmptyAsNull">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt behandeln leere als null. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
