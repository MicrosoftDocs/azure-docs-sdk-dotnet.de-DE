<Type Name="IfConditionActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.IfConditionActivity">
  ...
  <Docs>
    <summary>
            Diese Aktivität wertet einen booleschen Ausdruck und führt Aktivitäten unter der IfTrueActivities-Eigenschaft oder die IfFalseActivities Eigenschaft abhängig vom Ergebnis des Ausdrucks.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der IfConditionActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="expression">Ein Ausdruck, der in einen booleschen Wert ausgewertet wird. Hiermit wird den Block von Aktivitäten (IfTrueActivities oder IfFalseActivities) zu bestimmen, die ausgeführt wird.</param>
        ...
        <param name="ifTrueActivities">Liste der Aktivitäten ausführt, wenn der Ausdruck ausgewertet wird auf "true". Dies ist eine optionale Eigenschaft, und wenn nicht angegeben ist, wird die Aktivität beendet, ohne Eingreifen.</param>
        <param name="ifFalseActivities">Liste der Aktivitäten ausführt, wenn der Ausdruck auf "false" ausgewertet wird. Dies ist eine optionale Eigenschaft, und wenn nicht angegeben ist, wird die Aktivität beendet, ohne Eingreifen.</param>
        <summary>
            Initialisiert eine neue Instanz der IfConditionActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Expression">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Ausdruck, der ausgewertet wird, würde in einen booleschen Wert. Hiermit wird den Block von Aktivitäten (IfTrueActivities oder IfFalseActivities) zu bestimmen, die ausgeführt wird.
            </summary>
    ...
    <Member MemberName="IfFalseActivities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Aktivitäten ausführt, wenn der Ausdruck auf "false" ausgewertet wird. Dies ist eine optionale Eigenschaft, und wenn nicht angegeben ist, wird die Aktivität beendet, ohne Eingreifen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IfTrueActivities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Aktivitäten ausführt, wenn der Ausdruck ausgewertet wird auf "true". Dies ist eine optionale Eigenschaft, und wenn nicht angegeben ist, wird die Aktivität beendet, ohne Eingreifen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
