<Type Name="SapHanaLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SapHanaLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SapHanaLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="server">Hostname der SAP HANA-Server. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="authenticationType">Der Authentifizierungstyp für die Verbindung mit dem SAP HANA-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Windows"</param>
        <param name="userName">Der Benutzername, der Zugriff auf den SAP HANA-Server.
            Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Kennwort zum Zugriff auf den SAP HANA-Server.</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Authentifizierungstyp an, für die Verbindung mit dem SAP HANA-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Windows"
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für den SAP HANA-Serverzugriff.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Server">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Hostnamen des SAP HANA-Server. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Benutzername, der Zugriff auf den SAP HANA-Server. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
