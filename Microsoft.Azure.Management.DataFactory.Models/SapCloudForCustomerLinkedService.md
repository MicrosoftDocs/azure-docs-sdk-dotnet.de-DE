<Type Name="SapCloudForCustomerLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SapCloudForCustomerLinkedService">
  ...
  <Docs>
    <summary>
            Verknüpften Dienst für die SAP-Cloud für Kunden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SapCloudForCustomerLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">Die URL des SAP-Cloud für Kunden OData-API. Z. B. "[https://[tenantname].crm.ondemand.com/sap/c4c/odata/v1]". Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="encryptedCredential">Die verschlüsselten Anmeldeinformationen für die Authentifizierung verwendet. Anmeldeinformationen werden verschlüsselt, mit dem Integration Runtime Anmeldeinformations-Manager. EncryptedCredential oder Benutzername/Kennwort muss angegeben werden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <summary>
            Initialisiert eine neue Instanz der SapCloudForCustomerLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            ...
            Anmeldeinformationen werden verschlüsselt, mit dem Integration Runtime Anmeldeinformations-Manager. EncryptedCredential oder Benutzername/Kennwort muss angegeben werden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die URL des SAP-Cloud für die Customer-OData-API. Z. B. "[https://[tenantname].crm.ondemand.com/sap/c4c/odata/v1]". Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen für die Standardauthentifizierung. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
