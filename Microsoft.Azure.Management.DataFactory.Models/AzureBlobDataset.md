<Type Name="AzureBlobDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureBlobDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureBlobDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="folderPath">Der Pfad des Azure Blob-Speicher. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="tableRootLocation">Der Stamm der Blob-Pfad. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="fileName">Der Name des Azure-Blob. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="format">Das Format des Azure Blob-Speicher.</param>
        <param name="compression">Die datenkomprimierungsmethode für den Blob-Speicher verwendet.</param>
        <summary>
            Initialisiert eine neue Instanz der AzureBlobDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Compression">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die datenkomprimierungsmethode für den Blob-Speicher verwendet.
            </summary>
    ...
    <Member MemberName="FileName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Azure-Blob fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FolderPath">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pfad des Azure Blob-Speicher. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Format des Azure-Blob-Speichers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TableRootLocation">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Stamm des Blob-Pfad. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
