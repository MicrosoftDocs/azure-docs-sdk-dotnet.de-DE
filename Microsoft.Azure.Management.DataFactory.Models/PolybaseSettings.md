<Type Name="PolybaseSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.PolybaseSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PolybaseSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="rejectType">Lehnen Sie Typ an ab. Folgende Werte sind möglich: "value", "Percentage"</param>
        <param name="rejectValue">Gibt den Wert oder den Prozentsatz der Zeilen, die zurückgewiesen werden kann, bevor die Abfrage fehlschlägt. Typ: Nummer (oder Ausdruck mit ResultType-Anzahl), minimum: 0.</param>
        <param name="rejectSampleValue">Bestimmt die Anzahl der Zeilen abrufen, bevor die PolyBase berechnet den Prozentsatz der abgelehnten Zeilen neu versucht. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.</param>
        <param name="useTypeDefault">Gibt an, wie fehlende Werte in durch Trennzeichen getrennten Textdateien verarbeitet werden sollen, wenn PolyBase Daten aus der Textdatei abruft. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <summary>
            Initialisiert eine neue Instanz der PolybaseSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RejectSampleValue">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt bestimmt die Anzahl der Zeilen abrufen, bevor die PolyBase berechnet den Prozentsatz der abgelehnten Zeilen neu versucht.
            Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RejectType">
      ...
      <Docs>
        <summary>
            Lehnen Typ, ruft ab oder legt ihn fest. Folgende Werte sind möglich: "value", "Percentage"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RejectValue">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt den Wert oder den Prozentsatz der Zeilen, die zurückgewiesen werden kann, bevor die Abfrage fehlschlägt. Typ: Nummer (oder Ausdruck mit ResultType-Anzahl), minimum: 0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UseTypeDefault">
      ...
      <Docs>
        <summary>
            Gibt an, wie fehlende Werte in einer durch Trennzeichen getrennten Textdateien behandelt wird, wenn PolyBase Daten aus der Textdatei abruft Ruft ab oder legt ihn fest. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
