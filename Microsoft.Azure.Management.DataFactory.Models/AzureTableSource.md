<Type Name="AzureTableSource" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureTableSource">
  ...
  <Docs>
    <summary>
            Ein Azure-Tabelle als Quelle kopieren-Aktivität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureTableSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="azureTableSourceQuery">Azure Table-Quelle-Abfrage. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="azureTableSourceIgnoreTableNotFound">Azure Tabellenquelle ignorieren Tabelle wurde nicht gefunden. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <summary>
            Initialisiert eine neue Instanz der AzureTableSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AzureTableSourceIgnoreTableNotFound">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Azure-Tabelle Quelle ignorieren Tabelle wurde nicht gefunden. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
    ...
    <Member MemberName="AzureTableSourceQuery">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Azure Table-Quelle-Abfrage. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
