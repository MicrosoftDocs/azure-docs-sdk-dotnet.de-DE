<Type Name="DistcpSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.DistcpSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DistcpSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceManagerEndpoint">Gibt die Yarn ResourceManager-Endpunkt. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="tempScriptPath">Gibt einen vorhandenen Ordnerpfad, die zum Speichern von temporären Distcp Befehlsskript verwendet werden soll. Die Skriptdatei wird von ADF generiert und nach Abschluss des Kopierauftrags entfernt. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="distcpOptions">Gibt die Distcp-Optionen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <summary>
            Initialisiert eine neue Instanz der DistcpSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DistcpOptions">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt die Distcp-Optionen an. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="ResourceManagerEndpoint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest gibt die Yarn ResourceManager-Endpunkt auf. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TempScriptPath">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt einen vorhandenen Ordnerpfad, die zum Speichern von temporären Distcp Befehlsskript verwendet werden soll. Die Skriptdatei wird von ADF generiert und nach Abschluss des Kopierauftrags entfernt. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
