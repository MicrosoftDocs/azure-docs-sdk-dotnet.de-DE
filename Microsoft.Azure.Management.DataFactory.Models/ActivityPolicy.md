<Type Name="ActivityPolicy" FullName="Microsoft.Azure.Management.DataFactory.Models.ActivityPolicy">
  ...
  <Docs>
    <summary>
            Die Ausführungsrichtlinie für eine Aktivität.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="timeout">Gibt das Zeitlimit für die Ausführung der Aktivität an. Der Standardtimeout beträgt 7 Tage. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).</param>
        <param name="retry">Maximale Wiederholungsversuche gewöhnliche. Der Standardwert ist 0.
            Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimale:
            0.</param>
        <param name="retryIntervalInSeconds">Intervall zwischen den Wiederholungsversuchen beim Senden (in Sekunden). Der Standardwert ist 30 Sekunden.</param>
        <summary>
            Initialisiert eine neue Instanz der ActivityPolicy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Retry">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest normale maximale Anzahl von Wiederholungsversuchen. Der Standardwert ist 0. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetryIntervalInSeconds">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Intervall zwischen den Wiederholungsversuchen beim Senden (in Sekunden) fest. Der Standardwert ist 30 Sekunden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timeout">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt das Timeout für die Aktivität ausgeführt. Der Standardtimeout beträgt 7 Tage. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
