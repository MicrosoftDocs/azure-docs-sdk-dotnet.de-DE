<Type Name="DatasetGZipCompression" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetGZipCompression">
  ...
  <Docs>
    <summary>
            Die GZip-Komprimierung-Methode für ein Dataset verwendet.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DatasetGZipCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="level">Die Ebene des GZip-Komprimierung. Folgende Werte sind möglich: "Optimal", "Fastest"</param>
        <summary>
            Initialisiert eine neue Instanz der DatasetGZipCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die GZip-Komprimierungsebene. Folgende Werte sind möglich: "Optimal", "Fastest"
            </summary>
