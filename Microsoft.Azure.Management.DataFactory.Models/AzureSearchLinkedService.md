<Type Name="AzureSearchLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSearchLinkedService">
  ...
  <Docs>
    <summary>
            Verknüpften Dienst für Windows Azure-Suchdienst.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureSearchLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">URL für Azure Search-Dienst. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="key">Admin Key für Azure Search-Dienst</param>
    ...
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Admin Schlüssel für Azure Search-Dienst
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die URL für Azure Search-Dienst fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
