<Type Name="TriggerRun" FullName="Microsoft.Azure.Management.DataFactory.Models.TriggerRun">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TriggerRun-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="triggerRunId">Trigger Id ausgeführt wird.</param>
        <param name="triggerName">Triggername.</param>
        <param name="triggerType">Triggertyp.</param>
        <param name="triggerRunTimestamp">Startzeit der Trigger ausgeführt.</param>
        <param name="status">Trigger, der Status der Ausführung. Folgende Werte sind möglich: "Erfolgreich abgeschlossen", "Fehlgeschlagen", "Inprogress"</param>
        <param name="message">Trigger-Fehlermeldung.</param>
        <param name="properties">Liste von Eigenschaftennamen und-Wert im Zusammenhang mit der Trigger ausgeführt. Name-Wert-Paar hängt Typ des Triggers ab.</param>
        <param name="triggeredPipelines">Liste der pipelinenamen, und führen Sie die Id, die ausgelöst wird, durch den Trigger ausgeführt.</param>
        <summary>
            Initialisiert eine neue Instanz der TriggerRun-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft die Liste der Eigenschaftennamen und-Wert im Zusammenhang mit der Trigger ausgeführt. Name-Wert-Paar hängt Typ des Triggers ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft auslösen Ausführungsstatus. Folgende Werte sind möglich: "Erfolgreich abgeschlossen", "Fehlgeschlagen", "Inprogress"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TriggeredPipelines">
      ...
      <Docs>
        <summary>
            Ruft die Liste der pipelinenamen und Testlauf-Id ausgelöst durch den Trigger ausgeführt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TriggerRunTimestamp">
      ...
      <Docs>
        <summary>
            Ruft auslösen zur Startzeit an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
