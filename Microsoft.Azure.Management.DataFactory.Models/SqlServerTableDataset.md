<Type Name="SqlServerTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlServerTableDataset">
  ...
  <Docs>
    <summary>
            Das Dataset mit einer lokalen SQL Server.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SqlServerTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Der Tabellenname des SQL Server-Datasets.
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest der Tabellenname des SQL Server-Datasets. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
