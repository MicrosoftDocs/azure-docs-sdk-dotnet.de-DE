<Type Name="ServiceNowLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ServiceNowLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ServiceNowLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Der Endpunkt des ServiceNow-Servers. (d. h. ServiceNowData.com)</param>
        <param name="authenticationType">Der zu verwendende Authentifizierungstyp.
            Folgende Werte sind möglich: "Basic", "OAuth2"</param>
        ...
        <param name="username">Der Benutzername, der für die Verbindung mit dem ServiceNow-Server für die Authentifizierung „Basic“ und „OAuth2“ verwendet wird.</param>
        <param name="password">Das Kennwort für den Benutzernamen für die Authentifizierung „Basic“ und „OAuth2“.</param>
        <param name="clientId">Die Client-Id für die Authentifizierung von OAuth2.</param>
        <param name="clientSecret">Der geheime Clientschlüssel für die Authentifizierung „OAuth2“.</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den zu verwendenden Authentifizierungstyp. Folgende Werte sind möglich: "Basic", "OAuth2"
            </summary>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Client-Id für die Authentifizierung von OAuth2.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClientSecret">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der geheime Clientschlüssel für die Authentifizierung von OAuth2.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert den Endpunkt des ServiceNow-Servers. (d. h. ServiceNowData.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für den Benutzernamen für Standard- und OAuth2-Authentifizierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen für die Verbindung mit dem Server ServiceNow für Standard- und OAuth2-Authentifizierung verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
