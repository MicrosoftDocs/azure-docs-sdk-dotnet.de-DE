<Type Name="SqlSink" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlSink">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SqlSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sqlWriterStoredProcedureName">Name der SQL Writer-gespeicherte Prozedur. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="sqlWriterTableType">SQL Writer-Tabellentyp. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="preCopyScript">Vor dem Kopieren der SQL-Skript. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="storedProcedureParameters">SQL Parameter der gespeicherten Prozeduren.</param>
        <summary>
            Initialisiert eine neue Instanz der SqlSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PreCopyScript">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest SQL vor dem Kopieren-Skript. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="SqlWriterStoredProcedureName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Name für die gespeicherte Prozedur von SQL Writer. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SqlWriterTableType">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der SQL Writer-Tabellentyp. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StoredProcedureParameters">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Parameter der gespeicherten SQL-Prozeduren.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
