<Type Name="UntilActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.UntilActivity">
  ...
  <Docs>
    <summary>
            Diese Aktivität führt interne Aktivitäten aus, bis auf der angegebene booleschen Ausdruck führt auf "true" oder das Timeout erreicht ist, welcher Wert liegt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der UntilActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="expression">Ein Ausdruck, der in einen booleschen Wert ausgewertet wird. Die Schleife wird fortgesetzt, bis dieser Ausdruck zu True ausgewertet wird.</param>
        <param name="activities">Liste der Aktivitäten, ausgeführt werden.</param>
        ...
        <param name="timeout">Gibt das Zeitlimit für die Ausführung der Aktivität an. Ist kein Wert angegeben, nimmt er den Wert des TimeSpan.FromDays(7) also 1 Woche als Standard. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).</param>
        <summary>
            Initialisiert eine neue Instanz der UntilActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Activities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der auszuführenden Aktivitäten.
            </summary>
    ...
    <Member MemberName="Expression">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Ausdruck, der ausgewertet wird, würde in einen booleschen Wert. Die Schleife wird fortgesetzt, bis dieser Ausdruck zu True ausgewertet wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timeout">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt das Timeout für die Aktivität ausgeführt. Ist kein Wert angegeben, nimmt er den Wert des TimeSpan.FromDays(7) also 1 Woche als Standard. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])). Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
