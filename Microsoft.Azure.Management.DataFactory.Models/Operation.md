<Type Name="Operation" FullName="Microsoft.Azure.Management.DataFactory.Models.Operation">
  ...
  <Docs>
    <summary>
            Definition des Azure Data Factory-API-Vorgang.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">Metadaten, die dem Vorgang zugeordnet werden.</param>
        <param name="serviceSpecification">Details zu einem Dienstvorgang.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Vorgang an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Metadaten, die dem Vorgang zugeordnet.
            </summary>
    ...
    <Member MemberName="ServiceSpecification">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Details zu einem Dienstvorgang.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
