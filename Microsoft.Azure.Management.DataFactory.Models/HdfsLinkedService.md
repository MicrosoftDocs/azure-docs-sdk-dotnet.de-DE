<Type Name="HdfsLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.HdfsLinkedService">
  ...
  <Docs>
    <summary>
            Verknüpfter Dienst für Hadoop Distributed Datei System (HDFS).
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der HdfsLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">Die URL der HDFS-service-Endpunkt, z. B. 50070/Webhdfs/v1. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="authenticationType">Typ der Authentifizierung, die zur Verbindung mit der HDFS. Mögliche Werte sind: anonyme und Windows.
        ...
        <param name="userName">Der Benutzername für die Windows-Authentifizierung. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Das Kennwort für die Windows-Authentifizierung.</param>
        <summary>
            Initialisiert eine neue Instanz der HdfsLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest zur Verbindung mit der HDFS verwendete Authentifizierungstyp.
            Mögliche Werte sind: anonyme und Windows. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für Windows-Authentifizierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die URL des HDFS-Endpunkts, z. B. 50070/Webhdfs/v1 fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Benutzername für die Windows-Authentifizierung. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
