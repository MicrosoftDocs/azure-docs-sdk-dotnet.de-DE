<Type Name="HttpSource" FullName="Microsoft.Azure.Management.DataFactory.Models.HttpSource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der HttpSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="httpRequestTimeout">Gibt das Timeout für einen HTTP-Client HTTP-Antwort vom HTTP-Server abgerufen. Der Standardwert entspricht System.Net.HttpWebRequest.Timeout. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).</param>
        <summary>
            Initialisiert eine neue Instanz der HttpSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HttpRequestTimeout">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt das Timeout für einen HTTP-Client HTTP-Antwort vom HTTP-Server abgerufen. Der Standardwert entspricht System.Net.HttpWebRequest.Timeout. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).
            </summary>
