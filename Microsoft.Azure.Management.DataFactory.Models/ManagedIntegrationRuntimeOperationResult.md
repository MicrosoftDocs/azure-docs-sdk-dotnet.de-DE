<Type Name="ManagedIntegrationRuntimeOperationResult" FullName="Microsoft.Azure.Management.DataFactory.Models.ManagedIntegrationRuntimeOperationResult">
  ...
  <Docs>
    <summary>
            Eigenschaften des verwalteten Integration Runtime vorgangsergebnis.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ManagedIntegrationRuntimeOperationResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">Der Vorgangstyp. Konnte werden starten oder beenden.</param>
        <param name="startTime">Die Startzeit des Vorgangs.</param>
        <param name="result">Das Ergebnis des Vorgangs.</param>
        <param name="errorCode">Der Fehlercode.</param>
        <param name="parameters">Fehler Laufzeitparameter verwaltete Integration.</param>
        <param name="activityId">Die Aktivitäts-Id für die vorgangsanforderung.</param>
        <summary>
            Initialisiert eine neue Instanz der ManagedIntegrationRuntimeOperationResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ActivityId">
      ...
      <Docs>
        <summary>
            Ruft die Aktivitäts-Id für die vorgangsanforderung ab.
            </summary>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            Ruft verwaltet Integration Laufzeitparameter-Fehler.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Ruft den Vorgangstyp ab. Konnte werden starten oder beenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
