<Type Name="PhoenixLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.PhoenixLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PhoenixLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">IP-Adresse oder Hostname des Phoenix-Servers. (z.B. 192.168.222.160)</param>
        <param name="authenticationType">Der Authentifizierungsmechanismus, der für die Verbindung mit dem Phoenix-Server verwendet werden soll. Folgende Werte sind möglich: "Anonymous", "UsernameAndPassword", "WindowsAzureHDInsightService"</param>
        ...
        <param name="port">Der TCP-Port, den der Phoenix-Server verwendet, um auf Clientverbindungen zu lauschen. Der Standardwert ist 8765.</param>
        <param name="httpPath">Die Teil-URL, die dem Phoenix-Server entspricht. (d. h. /gateway/sandbox/phoenix/version). Der Standardwert ist Hbasephoenix auf, wenn WindowsAzureHDInsightService verwenden.</param>
        <param name="username">Der Benutzername, der für die Verbindung mit dem Phoenix-Server verwendet werden soll.</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest zur Verbindung mit dem Server Phoenix Authentifizierungsmechanismus. Folgende Werte sind möglich: "Anonymous", "UsernameAndPassword", "WindowsAzureHDInsightService"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die IP-Adresse oder den Hostnamen der Name des Servers Phoenix.
            (z.B. 192.168.222.160)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HttpPath">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest mit dem Server Phoenix entsprechende partielle URL.
            (d. h. /gateway/sandbox/phoenix/version). Der Standardwert ist Hbasephoenix auf, wenn WindowsAzureHDInsightService verwenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den TCP-Port, den die Phoenix-Server verwendet, um Clientverbindungen. Der Standardwert ist 8765.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen für die Verbindung mit dem Server Phoenix verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
