<Type Name="OdbcSink" FullName="Microsoft.Azure.Management.DataFactory.Models.OdbcSink">
  ...
  <Docs>
    <summary>
            Eine kopieren-Aktivität-ODBC-Senke.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OdbcSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="preCopyScript">Eine Abfrage, die vor dem Starten der Kopiervorgang ausgeführt werden soll. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <summary>
            Initialisiert eine neue Instanz der OdbcSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PreCopyScript">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Abfrage, die vor dem Starten der Kopiervorgang ausgeführt. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
