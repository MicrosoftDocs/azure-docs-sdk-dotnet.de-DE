<Type Name="AzureSqlTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSqlTableDataset">
  ...
  <Docs>
    <summary>
            Das Dataset für den Azure SQL Server-Datenbank.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureSqlTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Der Tabellenname der Azure SQL-Datenbank.
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Tabellennamen der Azure SQL-Datenbank fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
