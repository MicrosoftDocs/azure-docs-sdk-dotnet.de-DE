<Type Name="ParameterSpecification" FullName="Microsoft.Azure.Management.DataFactory.Models.ParameterSpecification">
  ...
  <Docs>
    <summary>
            Die Definition eines einzelnen Parameters für eine Entität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ParameterSpecification-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">Der Parametertyp. Folgende Werte sind möglich: "Object", "String", "Int", "Float", "Bool", "Array"</param>
        <param name="defaultValue">Der Standardwert des Parameters.</param>
        <summary>
            Initialisiert eine neue Instanz der ParameterSpecification-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DefaultValue">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Standardwert des Parameters.
            </summary>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Parameter. Folgende Werte sind möglich: "Object", "String", "Int", "Float", "Bool", "Array"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
