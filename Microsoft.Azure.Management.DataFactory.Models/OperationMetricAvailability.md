<Type Name="OperationMetricAvailability" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationMetricAvailability">
  ...
  <Docs>
    <summary>
            Definiert, wie oft Daten für eine Metrik verfügbar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OperationMetricAvailability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeGrain">Die Granularität für die Metrik.</param>
        <param name="blobDuration">Das BLOB im kundenspeicherkonto pro Stunde erstellt.</param>
        <summary>
            Initialisiert eine neue Instanz der OperationMetricAvailability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BlobDuration">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Blob im kundenspeicherkonto pro Stunde erstellt.
            </summary>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Granularität für die Metrik.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
