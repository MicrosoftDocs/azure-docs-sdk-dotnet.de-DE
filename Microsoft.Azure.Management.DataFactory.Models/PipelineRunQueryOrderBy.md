<Type Name="PipelineRunQueryOrderBy" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunQueryOrderBy">
  ...
  <Docs>
    <summary>
            Ein Objekt, geben Sie die Reihenfolge von Optionen für das Angebot Pipeline ausgeführt wird.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PipelineRunQueryOrderBy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="orderBy">Name des Parameters für die Order by-verwendet werden soll.
            Folgende Werte sind möglich: "RunStart", "RunEnd"</param>
        <param name="order">Die Sortierreihenfolge des Parameters. Folgende Werte sind möglich: "ASC", "DESC"</param>
        <summary>
            Initialisiert eine neue Instanz der PipelineRunQueryOrderBy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Order">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, die Sortierreihenfolge des Parameters. Folgende Werte sind möglich: "ASC", "DESC"
            </summary>
    ...
    <Member MemberName="OrderBy">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Parametername für Order by-verwendet werden soll. Folgende Werte sind möglich: "RunStart", "RunEnd"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
