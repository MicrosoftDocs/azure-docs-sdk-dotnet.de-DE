<Type Name="AzureStorageLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureStorageLinkedService">
  ...
  <Docs>
    <summary>
            Das Speicherkonto verknüpften Diensts.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureStorageLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="connectionString">Verbindungszeichenfolge. Es handelt sich gegenseitig ausschließende mit SasUri-Eigenschaft.</param>
        <param name="sasUri">SAS-URI des Azure-Speicherressource. Es handelt sich gegenseitig ausschließende mit ConnectionString-Eigenschaft.</param>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Verbindungszeichenfolge fest. Es handelt sich gegenseitig ausschließende mit SasUri-Eigenschaft.
            </summary>
    ...
    <Member MemberName="SasUri">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt SAS-URI der Azure-Speicherressource. Es handelt sich gegenseitig ausschließende mit ConnectionString-Eigenschaft.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
