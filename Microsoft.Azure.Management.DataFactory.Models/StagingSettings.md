<Type Name="StagingSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.StagingSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der StagingSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName">Dienstverweis Staging verknüpft.</param>
        ...
        <param name="path">Der Pfad zum Speicher für die vorläufigen Daten speichern. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="enableCompression">Gibt an, ob Komprimierung beim Kopieren von Daten über eine vorläufige Staging. Der Standardwert ist „false“. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <summary>
            Initialisiert eine neue Instanz der StagingSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EnableCompression">
      ...
      <Docs>
        <summary>
            Gibt an, ob Komprimierung verwenden, beim Kopieren von Daten über eine vorläufige Staging, ruft ab oder legt ihn fest. Der Standardwert ist „false“. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LinkedServiceName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, staging verknüpften Dienstverweis.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pfad zum Speicher für das Speichern der vorläufigen Daten fest.
