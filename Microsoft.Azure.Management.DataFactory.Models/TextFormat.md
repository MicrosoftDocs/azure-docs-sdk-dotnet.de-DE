<Type Name="TextFormat" FullName="Microsoft.Azure.Management.DataFactory.Models.TextFormat">
  ...
  <Docs>
    <summary>
            Die Daten im Text-Format gespeichert.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse TextFormat an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="columnDelimiter">Das Spaltentrennzeichen an. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="rowDelimiter">Das Zeilentrennzeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="escapeChar">Das Escapezeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="quoteChar">Das Anführungszeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="nullValue">Die Zeichenfolge null-Wert. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="encodingName">Der Codepagename der bevorzugten Codierung. Wenn Miss, der Standardwert ist, es sei denn, die BOM kennzeichnet eine andere Unicode-Codierung der ΓÇ £Utf-8ΓÇ ¥. Verweisen auf die ΓÇ £NameΓÇ ¥-Spalte der Tabelle in den folgenden Link, um die unterstützten Werte festgelegt: https://msdn.microsoft.com/library/system.text.encoding.aspx. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="treatEmptyAsNull">Leere Werte in der Textdatei als null behandelt. Der Standardwert lautet „true“. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <param name="skipLineCount">Die Anzahl der Zeilen/Zeilen beim Analysieren von Textdateien übersprungen werden soll. Der Standardwert ist 0. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).</param>
        <param name="firstRowAsHeader">Wenn als Eingabe verwendet wird, behandeln Sie die erste Zeile der Daten als Header. Wenn Sie als Ausgabe verwendet wird, schreibt die Header in die Ausgabe als die erste Zeile der Daten. Der Standardwert ist „false“.
    ...
    <Member MemberName="ColumnDelimiter">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Spaltentrennzeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="EncodingName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Codepagename der bevorzugten Codierung. Wenn Miss, der Standardwert ist, es sei denn, die BOM kennzeichnet eine andere Unicode-Codierung der ΓÇ £Utf-8ΓÇ ¥. Verweisen auf die ΓÇ £NameΓÇ ¥-Spalte der Tabelle in den folgenden Link, um die unterstützten Werte festgelegt: https://msdn.microsoft.com/library/system.text.encoding.aspx. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EscapeChar">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Escape-Zeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FirstRowAsHeader">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, wenn Sie als Eingabe, behandeln die erste Datenzeile als Header verwendet. Wenn Sie als Ausgabe verwendet wird, schreibt die Header in die Ausgabe als die erste Zeile der Daten. Der Standardwert ist „false“. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NullValue">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeichenfolge null-Wert. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QuoteChar">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Anführungszeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RowDelimiter">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Zeilentrennzeichen. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SkipLineCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der Zeilen/Zeilen übersprungen werden soll, beim Analysieren von Textdateien. Der Standardwert ist 0. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TreatEmptyAsNull">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest leere Werte in der Textdatei, die als Null behandelt werden.
            Der Standardwert lautet „true“. Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
