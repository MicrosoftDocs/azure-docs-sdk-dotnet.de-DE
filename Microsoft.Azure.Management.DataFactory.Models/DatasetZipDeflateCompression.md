<Type Name="DatasetZipDeflateCompression" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetZipDeflateCompression">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DatasetZipDeflateCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="level">Die Komprimierungsebene ZipDeflate Folgende Werte sind möglich: "Optimal", "Fastest"</param>
        <summary>
            Initialisiert eine neue Instanz der DatasetZipDeflateCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert die Komprimierungsebene ZipDeflate. Folgende Werte sind möglich: "Optimal", "Fastest"
            </summary>
