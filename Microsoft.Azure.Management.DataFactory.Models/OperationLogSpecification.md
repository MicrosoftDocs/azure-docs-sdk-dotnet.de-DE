<Type Name="OperationLogSpecification" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationLogSpecification">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="28cdb-101">Details zu einem Vorgang im Zusammenhang mit der Protokolle.</span><span class="sxs-lookup"><span data-stu-id="28cdb-101">Details about an operation related to logs.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28cdb-102">Initialisiert eine neue Instanz der OperationLogSpecification-Klasse.</span><span class="sxs-lookup"><span data-stu-id="28cdb-102">Initializes a new instance of the OperationLogSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="28cdb-103">Der Name der Kategorie Protokoll.</span><span class="sxs-lookup"><span data-stu-id="28cdb-103">The name of the log category.</span></span></param>
        <param name="displayName"><span data-ttu-id="28cdb-104">Lokalisierten Anzeigenamen.</span><span class="sxs-lookup"><span data-stu-id="28cdb-104">Localized display name.</span></span></param>
        <param name="blobDuration"><span data-ttu-id="28cdb-105">BLOBs im kundenspeicherkonto pro Stunde erstellt.</span><span class="sxs-lookup"><span data-stu-id="28cdb-105">Blobs created in the customer storage account, per hour.</span></span></param>
        <summary>
            <span data-ttu-id="28cdb-106">Initialisiert eine neue Instanz der OperationLogSpecification-Klasse.</span><span class="sxs-lookup"><span data-stu-id="28cdb-106">Initializes a new instance of the OperationLogSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BlobDuration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28cdb-107">Ruft ab oder legt die Blobs im kundenspeicherkonto pro Stunde erstellt.</span><span class="sxs-lookup"><span data-stu-id="28cdb-107">Gets or sets blobs created in the customer storage account, per hour.</span></span>
            </summary>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28cdb-108">Ruft ab oder legt die lokalisierten Anzeigenamen.</span><span class="sxs-lookup"><span data-stu-id="28cdb-108">Gets or sets localized display name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28cdb-109">Ruft ab oder legt den Namen der Kategorie Protokoll fest.</span><span class="sxs-lookup"><span data-stu-id="28cdb-109">Gets or sets the name of the log category.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
