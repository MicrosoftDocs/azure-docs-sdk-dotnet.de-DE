<Type Name="AzureTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureTableDataset">
  ...
  <Docs>
    <summary>
            Das Azure Table Storage-Dataset.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Der Tabellenname der Azure-Tabellenspeicher.
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Tabellennamen der Azure-Tabellenspeicher. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
