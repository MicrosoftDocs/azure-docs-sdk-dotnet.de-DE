<Type Name="HttpLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.HttpLinkedService">
  ...
  <Docs>
    <summary>
            Verknüpften Dienst für eine HTTP-Datenquelle.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der HttpLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">Die Basis-URL des HTTP-Endpunkts, z. B. http://www.microsoft.com. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="authenticationType">Der Authentifizierungstyp für die Verbindung mit dem HTTP-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Anonymous", "Digest", "Windows", "ClientCertificate"</param>
        <param name="userName">Der Benutzername für die Standard-, Digest- oder Windows-Authentifizierung. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Kennwort für Basic, Digest, Windows oder ClientCertificate mit EmbeddedCertData Authentifizierung.</param>
        <param name="embeddedCertData">Base64-codierte Zertifikatdaten für ClientCertificate-Authentifizierung. Für die lokale Kopie mit ClientCertificate-Authentifizierung sollte "CertThumbprint" gelöscht oder EmbeddedCertData/Kennwort angegeben werden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="certThumbprint">Fingerabdruck des Zertifikats für ClientCertificate-Authentifizierung. Nur gültig für die lokale Kopie.
            Für die lokale Kopie mit ClientCertificate-Authentifizierung sollte "CertThumbprint" gelöscht oder EmbeddedCertData/Kennwort angegeben werden.
        ...
        <param name="enableServerCertificateValidation">Bei "true", überprüfen Sie das HTTPS-Server SSL-Zertifikat. Standardwert ist "true". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <summary>
            Initialisiert eine neue Instanz der HttpLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Authentifizierungstyp an, für die Verbindung mit dem HTTP-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Anonymous", "Digest", "Windows", "ClientCertificate"
            </summary>
    ...
    <Member MemberName="CertThumbprint">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Fingerabdruck des Zertifikats für ClientCertificate-Authentifizierung. Nur gültig für die lokale Kopie. Für die lokale Kopie mit ClientCertificate-Authentifizierung sollte "CertThumbprint" gelöscht oder EmbeddedCertData/Kennwort angegeben werden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EmbeddedCertData">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die base64-codierten Zertifikatdaten für ClientCertificate-Authentifizierung. Für die lokale Kopie mit ClientCertificate-Authentifizierung sollte "CertThumbprint" gelöscht oder EmbeddedCertData/Kennwort angegeben werden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableServerCertificateValidation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob der Wert true ist, überprüfen das HTTPS-Server SSL-Zertifikat.
            Standardwert ist "true". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für Basic, Digest, Windows oder ClientCertificate mit EmbeddedCertData Authentifizierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die base-URL des HTTP-Endpunkts, z. B. http://www.microsoft.com. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Benutzername für die Standard-, Digest- oder Windows-Authentifizierung. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
