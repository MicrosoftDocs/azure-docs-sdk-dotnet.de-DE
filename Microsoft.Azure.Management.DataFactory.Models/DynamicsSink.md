<Type Name="DynamicsSink" FullName="Microsoft.Azure.Management.DataFactory.Models.DynamicsSink">
  ...
  <Docs>
    <summary>
            Eine Kopie sink Aktivität Dynamics.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DynamicsSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="ignoreNullValues">Ignoriert das Flag, der angibt, gibt an, ob null-Werte aus dem Eingabedataset (außer Schlüsselfelder) während des Schreibvorgangs. Die Standardeinstellung ist "false". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <summary>
            Initialisiert eine neue Instanz der DynamicsSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IgnoreNullValues">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Flag, der angibt, gibt an, ob ignorieren null-Werte aus dem Eingabedataset (außer Schlüsselfelder) während der Schreibvorgang. Die Standardeinstellung ist "false". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
    ...
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            Das Schreibverhalten für den Vorgang.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
