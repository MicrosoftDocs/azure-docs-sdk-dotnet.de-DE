<Type Name="SqlServerStoredProcedureActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlServerStoredProcedureActivity">
  ...
  <Docs>
    <summary>
            Gespeicherte SQL-Prozedur Aktivitätstyp.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SqlServerStoredProcedureActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="storedProcedureName">Name der gespeicherten Prozedur. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="StoredProcedureName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Name der gespeicherten Prozedur. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
