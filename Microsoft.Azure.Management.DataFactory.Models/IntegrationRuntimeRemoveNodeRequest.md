<Type Name="IntegrationRuntimeRemoveNodeRequest" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeRemoveNodeRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="492cc-101">Anforderung zum Entfernen eines Knotens.</span><span class="sxs-lookup"><span data-stu-id="492cc-101">Request to remove a node.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="492cc-102">Initialisiert eine neue Instanz der IntegrationRuntimeRemoveNodeRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="492cc-102">Initializes a new instance of the IntegrationRuntimeRemoveNodeRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="492cc-103">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="492cc-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="nodeName"><span data-ttu-id="492cc-104">Der Name des Knotens entfernt werden soll.</span><span class="sxs-lookup"><span data-stu-id="492cc-104">The name of the node to be removed.</span></span></param>
        <summary>
            <span data-ttu-id="492cc-105">Initialisiert eine neue Instanz der IntegrationRuntimeRemoveNodeRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="492cc-105">Initializes a new instance of the IntegrationRuntimeRemoveNodeRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AdditionalProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="492cc-106">Ruft ab oder legt ihn fest, die nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="492cc-106">Gets or sets unmatched properties from the message are deserialized this collection</span></span>
            </summary>
    ...
    <Member MemberName="NodeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="492cc-107">Ruft ab oder legt den Namen des Knotens entfernt werden soll.</span><span class="sxs-lookup"><span data-stu-id="492cc-107">Gets or sets the name of the node to be removed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
