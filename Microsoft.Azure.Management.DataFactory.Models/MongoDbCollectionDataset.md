<Type Name="MongoDbCollectionDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.MongoDbCollectionDataset">
  ...
  <Docs>
    <summary>
            Das Dataset des MongoDB-Datenbank.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der MongoDbCollectionDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="collectionName">Der Tabellenname der MongoDB-Datenbank. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="CollectionName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Tabellennamen der MongoDB-Datenbank fest. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
