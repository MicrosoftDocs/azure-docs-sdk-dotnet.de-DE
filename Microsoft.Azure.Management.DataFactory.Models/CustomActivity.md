<Type Name="CustomActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.CustomActivity">
  ...
  <Docs>
    <summary>
            Typ der benutzerdefinierten Aktivität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CustomActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="command">Befehl für die benutzerdefinierte Aktivität Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="resourceLinkedService">Dienstverweis der verknüpften Ressource.</param>
        <param name="folderPath">Ordnerpfad für die Ressource Dateien Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="referenceObjects">Reference-Objekte</param>
        <param name="extendedProperties">Benutzerdefinierter Eigenschaftenbehälter. Es gibt keine Einschränkung für den Schlüssel oder Werte, die verwendet werden können. Der Benutzer angegeben, dass die benutzerdefinierte Aktivität hat die volle Verantwortung zu nutzen und interpretieren den Inhalt definiert.</param>
        <summary>
            Initialisiert eine neue Instanz der CustomActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Command">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest-Befehl für die benutzerdefinierte Aktivität Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="ExtendedProperties">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest definierten Eigenschaftenbehälter für Benutzer. Es gibt keine Einschränkung für den Schlüssel oder Werte, die verwendet werden können. Der Benutzer angegeben, dass die benutzerdefinierte Aktivität hat die volle Verantwortung zu nutzen und interpretieren den Inhalt definiert.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FolderPath">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Ordnerpfad für Ressourcendateien Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReferenceObjects">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Verweisobjekte
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceLinkedService">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Dienstverweis Ressource verknüpft.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
