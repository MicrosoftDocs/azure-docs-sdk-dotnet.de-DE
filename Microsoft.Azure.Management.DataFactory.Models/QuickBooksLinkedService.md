<Type Name="QuickBooksLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.QuickBooksLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der QuickBooksLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Der Endpunkt des QuickBooks-Servers. (d. h. quickbooks.api.intuit.com)</param>
        <param name="companyId">Die Unternehmens-ID des zu autorisierenden QuickBooks-Unternehmens.</param>
        ...
        <param name="accessToken">Das Zugriffstoken für die Authentifizierung mit OAuth 1.0.</param>
        <param name="accessTokenSecret">Das Zugriffstokengeheimnis für die Authentifizierung mit OAuth 1.0.</param>
    ...
    <Member MemberName="AccessToken">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Zugriffstoken für die Authentifizierung mit OAuth 1.0.
            </summary>
    ...
    <Member MemberName="AccessTokenSecret">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Access-token-Schlüssel für die Authentifizierung mit OAuth 1.0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CompanyId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Unternehmens-ID des Unternehmens QuickBooks autorisieren.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Endpunkt des Servers QuickBooks. (d. h. quickbooks.api.intuit.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
