<Type Name="WebLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.WebLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WebLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="typeProperties">Die Web-Eigenschaften des verknüpften Diensts.</param>
    ...
    <Member MemberName="TypeProperties">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Webdiensteigenschaften verknüpft.
            </summary>
