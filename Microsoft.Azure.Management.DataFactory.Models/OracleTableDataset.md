<Type Name="OracleTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.OracleTableDataset">
  ...
  <Docs>
    <summary>
            Das Dataset der lokalen Oracle-Datenbank.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OracleTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Der Tabellenname der lokalen Oracle-Datenbank. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Tabellennamen der lokalen Oracle-Datenbank fest.
