<Type Name="DatasetDeflateCompression" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetDeflateCompression">
  ...
  <Docs>
    <summary>
            Die Deflate-Komprimierung-Methode für ein Dataset verwendet.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DatasetDeflateCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="level">Die Ebene des Deflate-Komprimierung. Folgende Werte sind möglich: "Optimal", "Fastest"</param>
        <summary>
            Initialisiert eine neue Instanz der DatasetDeflateCompression-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Deflate-Komprimierungsebene. Folgende Werte sind möglich: "Optimal", "Fastest"
            </summary>
