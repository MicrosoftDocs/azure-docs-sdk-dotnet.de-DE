<Type Name="ActivityDependency" FullName="Microsoft.Azure.Management.DataFactory.Models.ActivityDependency">
  ...
  <Docs>
    <summary>
            Abhängigkeitsinformationen Aktivität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ActivityDependency-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="activity">Der Name der Aktivität.</param>
        <param name="dependencyConditions">Match-Bedingung für die Abhängigkeit.</param>
    ...
    <Member MemberName="Activity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Name der Aktivität.
            </summary>
    ...
    <Member MemberName="DependencyConditions">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Übereinstimmungsbedingung für die Abhängigkeit.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
