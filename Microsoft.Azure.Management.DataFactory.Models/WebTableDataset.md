<Type Name="WebTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.WebTableDataset">
  ...
  <Docs>
    <summary>
            Das Dataset verweist auf eine HTML-Tabelle in der Webseite.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WebTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="index">Der nullbasierte Index der Tabelle auf der Webseite. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.</param>
        ...
        <param name="path">Die relative URL zur Webseite aus dem verknüpften Dienst-URL. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <summary>
            Initialisiert eine neue Instanz der WebTableDataset-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Index">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den nullbasierten Index der Tabelle auf der Webseite.
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die relative URL zur Webseite aus dem verknüpften Dienst-URL. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
