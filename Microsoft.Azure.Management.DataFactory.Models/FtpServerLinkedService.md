<Type Name="FtpServerLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.FtpServerLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FtpServerLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Der Hostname des FTP-Servers. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        ...
        <param name="port">Der TCP-Portnummer, die der FTP-Server verwendet, um für Verbindungen mit Clients zu lauschen. Standardwert ist 21. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.</param>
        <param name="authenticationType">Der Authentifizierungstyp für die Verbindung mit dem FTP-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Anonymous"</param>
        <param name="userName">Der Benutzername, der FTP-Server anmelden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="password">Kennwort für den FTP-Server anmelden.</param>
        ...
        <param name="enableSsl">Bei "true", verbinden Sie mit dem FTP-Server über SSL/TLS-Kanal. Standardwert ist "true". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).</param>
        <param name="enableServerCertificateValidation">Überprüfen Sie das FTP-Server SSL-Zertifikat, bei "true", wenn die Verbindung über SSL/TLS-Kanal.
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Authentifizierungstyp an, für die Verbindung mit dem FTP-Server verwendet werden. Folgende Werte sind möglich: "Basic", "Anonymous"
            </summary>
    ...
    <Member MemberName="EnableServerCertificateValidation">
      ...
      <Docs>
        <summary>
            Der FTP-Server SSL-Zertifikat zu überprüfen Ruft ab oder legt fest, ob "true", wenn die Verbindung über SSL/TLS-Kanal. Standardwert ist "true". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableSsl">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob "true" Verbinden mit dem FTP-Server über SSL/TLS-Kanal. Standardwert ist "true". Typ: Boolesch (oder einen Ausdruck mit ResultType boolean).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Hostnamen des FTP-Servers. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort auf den FTP-Server anmelden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest die TCP-Portnummer, die der FTP-Server verwendet, um für Verbindungen mit Clients zu lauschen. Standardwert ist 21. Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element), minimum: 0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Benutzername, der den FTP-Server anmelden. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
