<Type Name="AzureKeyVaultSecretReference" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureKeyVaultSecretReference">
  ...
  <Docs>
    <summary>
            Azure Key Vault geheimen Verweis.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureKeyVaultSecretReference-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="store">Azure Key Vault verknüpft Dienstverweis.</param>
        <param name="secretName">Der Name des geheimen Schlüssels im Azure Key Vault.
            Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <param name="secretVersion">Die Version des geheimen Schlüssels im Azure Key Vault. Der Standardwert ist die neueste Version des geheimen Schlüssels. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</param>
        <summary>
            Initialisiert eine neue Instanz der AzureKeyVaultSecretReference-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SecretName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des geheimen Schlüssels im Azure Key Vault. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
    ...
    <Member MemberName="SecretVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version des geheimen Schlüssels im Azure Key Vault. Der Standardwert ist die neueste Version des geheimen Schlüssels. Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Store">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen des Dienstverweises Azure Key Vault verknüpft.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
