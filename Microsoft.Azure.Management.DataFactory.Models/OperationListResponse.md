<Type Name="OperationListResponse" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationListResponse">
  ...
  <Docs>
    <summary>
            Eine Liste der Vorgänge, die vom Data Factory-Dienst ausgeführt werden können.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OperationListResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">Liste der Data Factory-Vorgänge, die vom Data Factory-Ressourcenanbieter unterstützt.</param>
        <param name="nextLink">Der Link zur nächsten Seite der Ergebnisse, wenn keine weiteren Ergebnisse vorhanden sind.</param>
        <summary>
            Initialisiert eine neue Instanz der OperationListResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Link zur nächsten Seite der Ergebnisse, wenn keine weiteren Ergebnisse vorhanden sind.
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Data Factory-Vorgänge, die vom Data Factory-Ressourcenanbieter unterstützt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
