<Type Name="EloquaLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.EloquaLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der EloquaLinkedService-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Der Endpunkt des Eloqua-Servers. (d. h. eloqua.example.com)</param>
        <param name="username">Der Sitename und den Benutzernamen Ihres Kontos Eloqua in der Form: Sitename/Benutzername. (d. h. Eloqua/Alice)</param>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Endpunkt des Servers Eloqua. (d. h. eloqua.example.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Standortnamen und den Benutzernamen Ihres Kontos Eloqua in der Form: Sitename/Benutzername. (d. h. Eloqua/Alice)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
