<Type Name="WebActivityAuthentication" FullName="Microsoft.Azure.Management.DataFactory.Models.WebActivityAuthentication">
  ...
  <Docs>
    <summary>
            Authentifizierungseigenschaften für Web-Aktivität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WebActivityAuthentication-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">Aktivität Webauthentifizierung (Basic/ClientCertificate)</param>
        <param name="pfx">Base64-codierte Inhalt einer PFX-Datei.</param>
        <param name="username">Web Aktivität-Authentication-Benutzername für die Standardauthentifizierung.</param>
        <param name="password">Kennwort für die PFX-Datei oder die Standardauthentifizierung.</param>
        <summary>
            Initialisiert eine neue Instanz der WebActivityAuthentication-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort für die PFX-Datei oder die Standardauthentifizierung.
            </summary>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest (Basic/ClientCertificate) Webauthentifizierung Aktivität
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest-Aktivität Authentifizierung webbenutzernamen für die Standardauthentifizierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
