<Type Name="StandardRelayBindingImporter" FullName="Microsoft.ServiceBus.Description.StandardRelayBindingImporter">
  ...
  <Docs>
    <summary>WSDL-Verträgen und Richtlinienassertionen in Azure Service Bus-standardbindungen zugeordnet.</summary>
  ...
  <Members>
    ...
    <Member MemberName="BeforeImport">
      ...
      <Docs>
        <param name="wsdlDocuments">Beschreibt den Dienst.</param>
        <param name="xmlSchemas">Beschreibt die <paramref name="wsdlDocuments" />.</param>
        <param name="policy">Den Richtlinienelementen.</param>
        <summary>Wird vor dem Importieren der Metadatendokumente aufgerufen, die mit der Standardbindung verknüpft sind.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ImportContract">
      ...
      <Docs>
        <param name="importer"> Die WSDL-Importer zum Importieren und Auflösen von WSDL-Metadaten.</param>
        <param name="context"> Stellt den Kontext für die Konvertierung von WSDL zur Beschreibung Diensts bereit.</param>
        <summary>Importiert WSDL-Vertragsinformationen für standardbindungen.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ImportEndpoint">
      ...
      <Docs>
        <param name="importer"> Die WSDL-Importer zum Importieren und Auflösen von WSDL-Metadaten.</param>
        <param name="endpointContext"> Der Kontext für die Konvertierung.</param>
        <summary>Wird in die Beschreibung des Diensts in WSDL definierte Endpunkten zugeordnet.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
