<Type Name="MessageSender" FullName="Microsoft.ServiceBus.Messaging.MessageSender">
  ...
  <Interfaces />
  <Docs>
    <summary> Die MessageSender-Klasse wird zum Senden von Nachrichten vom Service Bus verwendet. </summary>
  ...
  <Members>
    <Member MemberName="BatchFlushInterval">
      ...
      <Docs>
        ...
        <value>Eine batchleerungsintervall. Der Standardwert ist 20 ms.</value>
        <remarks>To be added.</remarks>
        <exception cref="T:System.OperationCanceledException">Wird ausgelöst, wenn die <see cref="T:Microsoft.ServiceBus.Messaging.MessageSender" /> befindet sich im closing, closed oder fehlerhaften Status.</exception>
      </Docs>
    </Member>
    ...
    <Member MemberName="OnBeginCancelScheduledMessage">
      ...
      <Docs>
        <param name="trackingContext">Der Nachverfolgungskontext verwenden.</param>
        <param name="sequenceNumbers">Sequenznummer der Nachricht abgebrochen.</param>
        <param name="timeout">Ein Client Side-Timeoutwert für den Vorgang. Der Vorgang abgebrochen werden soll, oder "Abbrechen", wenn die Dauer dieses Zeitlimit überschritten.</param>
        <param name="callback">Der Benutzerrückruf, aufgerufen werden soll, wenn der Vorgang abgeschlossen ist.</param>
        <param name="state">Der Status bei Abschluss des Vorgangs an den Rückruf übergeben werden.</param>
        <summary>
            Konkrete Implementierungen überschreiben (falls erforderlich) dadurch was erfolgen soll, um geplante sendet "Abbrechen"
            </summary>
        <returns>eine <see cref="T:System.IAsyncResult" /> für den Vorgang.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginScheduleMessage">
      ...
      <Docs>
        <param name="trackingContext">Der Nachverfolgungskontext verwenden.</param>
        <param name="messages">Nachrichten geplant werden.</param>
        <param name="timeout">Ein Client Side-Timeoutwert für den Vorgang. Der Vorgang abgebrochen werden soll, oder "Abbrechen", wenn die Dauer dieses Zeitlimit überschritten.</param>
        <param name="callback">Der Benutzerrückruf, aufgerufen werden soll, wenn der Vorgang abgeschlossen ist.</param>
        <param name="state">Der Status bei Abschluss des Vorgangs an den Rückruf übergeben werden.</param>
        <summary>
            Dies ermöglicht es sich um konkrete Implementierungen überschreiben (falls erforderlich) sendet was erfolgen soll, wenn Sie planen
            </summary>
        <returns>eine <see cref="T:System.IAsyncResult" /> für den Vorgang.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OnBeginSend">
      ...
      <Docs>
        ...
        <summary>Führt die Begin-Sendeaktion an. Diese Methode ist für die interne Verwendung vorgesehen und kann nicht vom Benutzer in eine konkrete Klasse implementiert werden.</summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginSendEventData">
      ...
      <Docs>
        ...
        <param name="callback"></param>
        <param name="state"></param>
        <summary>Führt die Begin Sendeaktion-Ereignis. Diese Methode ist für die interne Verwendung vorgesehen und kann nicht vom Benutzer in eine konkrete Klasse implementiert werden.</summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndCancelScheduledMessage">
      ...
      <Docs>
        ...
        <summary>Löst ein Ereignis aus, wenn den Abbruch der geplanten Nachricht beendet.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndScheduleMessage">
      ...
      <Docs>
        <param name="result">Das Ergebnis des Vorgangs.</param>
        <summary>Löst ein Ereignis aus, wenn den Zeitplan für die Nachricht beendet.</summary>
    ...
    <Member MemberName="OnEndSend">
      ...
      <Docs>
        ...
        <summary>Führt die Sendeaktion Ende an. Diese Methode ist für die interne Verwendung vorgesehen und kann nicht vom Benutzer in eine konkrete Klasse implementiert werden.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndSendEventData">
      ...
      <Docs>
        <param name="result">Das Ergebnis des Vorgangs.</param>
        <summary>Führt End Sendeaktion-Ereignis. Diese Methode ist für die interne Verwendung vorgesehen und kann nicht vom Benutzer in eine konkrete Klasse implementiert werden.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnSend">
      ...
      <Docs>
        ...
        <param name="messages">Eine Liste der <see cref="T:Microsoft.ServiceBus.Messaging.BrokeredMessage" /> gesendet werden.</param>
        <param name="timeout">Ein Client Side-Timeoutwert für den Vorgang. Der Vorgang abgebrochen werden soll, oder "Abbrechen", wenn die Dauer dieses Zeitlimit überschritten.
            </param>
        <summary>
            Konkrete Implementierungen überschreiben (falls erforderlich) dadurch was geschehen soll, Versand <paramref name="messages" /> auf synchrone Weise.
            </summary>
        <remarks>
          <para>In der Regel das Timeout stammen aus <see cref="P:Microsoft.ServiceBus.Messaging.MessagingFactorySettings.OperationTimeout" />.</para>
          <para>OnSend gleich <c>dies. OnEndSend (diese. OnBeginSend ("Nachrichten", "Timeout", "Null", "Null")); </c>.</para>
        </remarks>
      </Docs>
    </Member>
    <Member MemberName="Path">
      ...
      <Docs>
        ...
        <value>Der Pfad der Warteschlange bzw. Thema relativ zu den <see cref="T:Microsoft.ServiceBus.Messaging.MessagingFactory" /> Basisadresse.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Send">
      ...
      <Docs>
        <param name="message">Die vermittelte Nachricht zu senden.</param>
        <summary>Sendet den angegebene vermittelte Nachricht.</summary>
        <remarks>To be added.</remarks>
        ...
        <exception cref="T:System.ArgumentException">Wird ausgelöst, wenn <paramref name="message" /> ist null.</exception>
      </Docs>
    </Member>
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="message">Die vermittelte Nachricht zu senden.</param>
        <summary>Asynchron sendet die angegebene vermittelte Nachricht.</summary>
