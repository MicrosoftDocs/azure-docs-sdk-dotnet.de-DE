<Type Name="EventHubSender" FullName="Microsoft.ServiceBus.Messaging.EventHubSender">
  ...
  <Interfaces />
  <Docs>
    <summary>Eine Clientklasse, die in der Send-Vorgänge für einen Event Hub verwendet wird.
            Stellt eine logische Sender-Verbindung zu einer bestimmten Event Hub-Partition.</summary>
  ...
  <Members>
    ...
    <Member MemberName="CreateFromConnectionString">
      ...
      <Docs>
        ...
        <summary>
            Erstellt eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Messaging.EventHubSender" /> unter Verwendung der angegebenen Verbindungszeichenfolge.
            Sollte verwendet werden, senden, verwenden eine "ConnectionString" mit SharedAcessSignature und Verleger.
            </summary>
        <returns>Der erstellte<see cref="T:Microsoft.ServiceBus.Messaging.EventHubSender" /></returns>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        ...
        <value>Der Event Hub-Pfad.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Send">
      ...
      <Docs>
        ...
        <summary>Sendet Ereignisdaten an die logischen Partition durch dargestellt <see cref="P:Microsoft.ServiceBus.Messaging.EventHubSender.PartitionId" />.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="data">Der zu sendende <see cref="T:Microsoft.ServiceBus.Messaging.EventData" />.</param>
        <summary>Asynchrone Version von <see cref="M:Microsoft.ServiceBus.Messaging.EventHubSender.Send(Microsoft.ServiceBus.Messaging.EventData)" />.</summary>
    ...
    <Member MemberName="SendBatch">
      ...
      <Docs>
        ...
        <summary>Sendet einen Batch von Ereignisdaten in der logischen Partition durch dargestellt <see cref="P:Microsoft.ServiceBus.Messaging.EventHubSender.PartitionId" />.</summary>
        <remarks>Benutzer sollten sicherstellen, dass die Summe serialisierte Größe des <paramref name="eventDataList" /> sollte die maximale Größe der Datenübertragung ein Ereignis, also 256 k standardmäßig sein.</remarks>
    ...
    <Member MemberName="SendBatchAsync">
      ...
      <Docs>
        <param name="eventDataList">Ein IEnumerable-Objekt, das mit Daten von Ereignisinstanzen ist.</param>
        <summary>Sendet asynchron einen Batch von Ereignisdaten in der logischen Partition durch dargestellt <see cref="P:Microsoft.ServiceBus.Messaging.EventHubSender.PartitionId" />.</summary>
