<Type Name="ReceiveMode" FullName="Microsoft.ServiceBus.Messaging.ReceiveMode">
  ...
  <Docs>
    <summary>Listet die Werte für den Empfangsmodus an. Der Standardwert lautet <see cref="F:Microsoft.ServiceBus.Messaging.ReceiveMode.PeekLock" />.</summary>
  ...
  <Members>
    <Member MemberName="PeekLock">
      ...
      <Docs>
        <summary>Gibt an, die PeekLock-Empfangsmodus. Dies ist der Standardwert für <see cref="T:Microsoft.ServiceBus.Messaging.ReceiveMode" />.</summary>
      </Docs>
    </Member>
    <Member MemberName="ReceiveAndDelete">
      ...
      <Docs>
        <summary>Gibt an, die ReceiveAndDelete-Empfangsmodus.</summary>
      </Docs>
    </Member>
  </Members>
</Type>