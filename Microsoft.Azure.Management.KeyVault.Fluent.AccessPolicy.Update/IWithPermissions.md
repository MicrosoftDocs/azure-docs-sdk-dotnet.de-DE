<Type Name="IWithPermissions" FullName="Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.Update.IWithPermissions">
  ...
  <Docs>
    <summary>
            Die Zugriffsrichtlinie aktualisieren Stufe ermöglicht Berechtigungen hinzugefügt oder entfernt werden soll.
            </summary>
  ...
  <Members>
    <Member MemberName="AllowKeyAllPermissions">
      ...
      <Docs>
        <summary>
            Ermöglichen Sie alle Berechtigungen für die AD-Identität zu Zugriffstasten.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AllowKeyPermissions">
      ...
      <Docs>
        <param name="permissions">Berechtigungen, die die Liste der Berechtigungen gewährt.</param>
        <summary>
            Lassen Sie eine Liste der Berechtigungen für die AD-Identität zu Zugriffstasten.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AllowSecretAllPermissions">
      ...
      <Docs>
        <summary>
            Ermöglichen Sie alle Berechtigungen für die AD-Identität auf geheime Schlüssel zugreifen.
            </summary>
    ...
    <Member MemberName="AllowSecretPermissions">
      ...
      <Docs>
        <param name="permissions">Berechtigungen, die die Liste der Berechtigungen gewährt.</param>
        <summary>
            Lassen Sie eine Liste der Berechtigungen für die AD-Identität geheime Schlüssel zugreifen.
            </summary>
        <returns>die nächste Phase der Richtliniendefinition Zugriff</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowKeyAllPermissions">
      ...
      <Docs>
        <summary>
            Heben Sie alle Berechtigungen für die AD-Identität zu Zugriffstasten.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowKeyPermissions">
      ...
      <Docs>
        <param name="permissions">Berechtigungen der Liste der Berechtigungen widerrufen</param>
        <summary>
            Eine Liste der Berechtigungen für die AD-Identität zu Zugriffstasten zu widerrufen.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowSecretAllPermissions">
      ...
      <Docs>
        <summary>
            Heben Sie alle Berechtigungen für die AD-Identität auf geheime Schlüssel zugreifen.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowSecretPermissions">
      ...
      <Docs>
        <param name="permissions">Berechtigungen der Liste der Berechtigungen widerrufen</param>
        <summary>
            Eine Liste der Berechtigungen für die AD-Identität auf geheime Schlüssel zu widerrufen.
            </summary>
        <returns>die nächste Phase der Access-richtlinienaktualisierung</returns>
        <remarks>To be added.</remarks>
      </Docs>
