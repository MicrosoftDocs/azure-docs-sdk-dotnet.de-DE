<Type Name="RecommendedDatabaseProperties" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RecommendedDatabaseProperties">
  ...
  <Docs>
    <summary>
            Stellt die Eigenschaften einer empfohlene Azure SQL-Datenbank aktualisiert wird.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RecommendedDatabaseProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der zu aktualisierenden Azure SQL-Datenbank.</param>
        <param name="targetEdition">Die Zieledition für die Azure SQL-Datenbank aktualisiert wird. Folgende Werte sind möglich: "Basic", "Standard", "Premium", "Frei", "Stretch", "Data Warehouse"</param>
        <param name="targetServiceLevelObjective">Das Ziel-SLO für die Azure SQL-Datenbank aktualisiert wird.</param>
        <summary>
            Initialisiert eine neue Instanz der RecommendedDatabaseProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der zu aktualisierenden Azure SQL-Datenbank fest.
            </summary>
    ...
    <Member MemberName="TargetEdition">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen die Zieledition für die Azure SQL-Datenbank aktualisiert wird. Folgende Werte sind möglich: "Basic", "Standard", "Premium", "Frei", "Stretch", "Data Warehouse"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetServiceLevelObjective">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Ziel-SLO für die Azure SQL-Datenbank, die zu aktualisierenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
