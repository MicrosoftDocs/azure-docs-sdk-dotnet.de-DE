<Type Name="UpgradeRecommendedElasticPoolProperties" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.UpgradeRecommendedElasticPoolProperties">
  ...
  <Docs>
    <summary>
            Stellt die Eigenschaften eines Azure SQL empfohlen elastische Pools aktualisiert wird.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der UpgradeRecommendedElasticPoolProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Azure SQL empfohlen elastischen Pools aktualisiert wird.</param>
        <param name="edition">Die Zieledition für die Azure SQL empfohlen elastischen Pool aktualisiert werden soll. Folgende Werte sind möglich: "Basic", "Standard", "Premium"</param>
        <param name="dtu">Die DTU-Garantie für die Azure SQL empfohlen elastischen Pool aktualisiert werden soll.</param>
        <param name="storageMb">Die Speicherobergrenze in MB für den Azure SQL empfohlen elastischen Pool aktualisiert wird.</param>
        <param name="databaseDtuMin">Die DTU-Garantie für die Datenbank für den Azure SQL empfohlen elastischen Pool aktualisiert wird.</param>
        <param name="databaseDtuMax">Die DTU-Obergrenze für die Datenbank für den Azure SQL empfohlen elastischen Pool aktualisiert werden soll.</param>
        <param name="databaseCollection">Die Liste der Datenbanknamen in der Azure SQL empfohlen elastischen Pool zu aktualisierenden zu versetzen.</param>
        <param name="includeAllDatabases">Ruft ab oder legt fest, ob alle Datenbanken in der Azure SQL empfohlen elastischen Pool zu versetzen aktualisiert wird.</param>
        <summary>
            Initialisiert eine neue Instanz der UpgradeRecommendedElasticPoolProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DatabaseCollection">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Datenbanknamen in der Azure SQL empfohlen elastischen Pool zu aktualisierenden zu versetzen.
            </summary>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die DTU-Obergrenze für die Datenbank für den Azure SQL empfohlen elastischen Pool aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert die DTU-Garantie für die Datenbank für den Azure SQL empfohlen elastischen Pool aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert die DTU-Garantie für die Azure SQL empfohlen elastischen Pool aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert die Zieledition für die Azure SQL empfohlen elastischen Pool aktualisiert wird. Folgende Werte sind möglich: "Basic", "Standard", "Premium"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IncludeAllDatabases">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob alle Datenbanken in der Azure SQL empfohlen elastischen Pool zu versetzen aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Azure SQL empfohlen elastischen Pools aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageMb">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Speicherobergrenze in MB für den Azure SQL empfohlen elastischen Pool aktualisiert wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
