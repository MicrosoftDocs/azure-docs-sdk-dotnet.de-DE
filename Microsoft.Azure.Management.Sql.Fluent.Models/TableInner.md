<Type Name="TableInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.TableInner">
  ...
  <Docs>
    <summary>
            Stellt eine Azure SQL-Datenbanktabelle dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TableInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableType">Der Typ der Azure SQL-Datenbanktabelle.
            Folgende Werte sind möglich: "BaseTable", "Anzeigen"</param>
        <param name="columns">Die Spalten aus dieser Tabelle.</param>
        <param name="recommendedIndexes">Die empfohlenen Indizes für diese Tabelle.</param>
        <summary>
            Initialisiert eine neue Instanz der TableInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Columns">
      ...
      <Docs>
        <summary>
            Ruft die Spalten aus dieser Tabelle ab.
            </summary>
    ...
    <Member MemberName="RecommendedIndexes">
      ...
      <Docs>
        <summary>
            Ruft die empfohlenen Indizes für diese Tabelle.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TableType">
      ...
      <Docs>
        <summary>
            Ruft den Typ der Azure SQL-Datenbanktabelle. Folgende Werte sind möglich: "BaseTable", "Anzeigen"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
