<Type Name="ReplicationLinkInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ReplicationLinkInner">
  ...
  <Docs>
    <summary>
            Stellt eine Azure SQL-datenbankreplikationslink dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ReplicationLinkInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="partnerServer">Der Name des Azure SQL Servers mit den Partner Azure SQL-Datenbank.</param>
        <param name="partnerDatabase">Der Name des Partners Azure SQL-Datenbank.</param>
        <param name="partnerLocation">Die Azure-Region des Partners Azure SQL-Datenbank.</param>
        <param name="role">Die Rolle der Azure SQL-Datenbank in den Replikationslink. Folgende Werte sind möglich: 'Primary', 'Sekundären', "NonReadableSecondary", "Source", "Kopieren"</param>
        <param name="partnerRole">Die Rolle des Partners Azure SQL-Datenbank in den Replikationslink. Folgende Werte sind möglich: 'Primary', 'Sekundären', "NonReadableSecondary", "Source", "Kopieren"</param>
        <param name="startTime">Die Startzeit für den Replikationslink (ISO8601-Format).</param>
    ...
    <Member MemberName="PartnerDatabase">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Partners Azure SQL-Datenbank ab.
            </summary>
    ...
    <Member MemberName="PartnerLocation">
      ...
      <Docs>
        <summary>
            Ruft die Azure-Region des Partners Azure SQL-Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartnerRole">
      ...
      <Docs>
        <summary>
            Ruft die Rolle des Partners Azure SQL-Datenbank in den Replikationslink ab. Folgende Werte sind möglich: 'Primary', 'Sekundären', "NonReadableSecondary", "Source", "Kopieren"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartnerServer">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Azure SQL Servers mit den Partner Azure SQL-Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Role">
      ...
      <Docs>
        <summary>
            Ruft die Rolle der Azure SQL-Datenbank in den Replikationslink ab.
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            Ruft die Startzeit für den Replikationslink (ISO8601-Format).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
