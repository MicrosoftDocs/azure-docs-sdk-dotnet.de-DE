<Type Name="DatabaseInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.DatabaseInner">
  ...
  <Docs>
    <summary>
            Stellt eine Azure SQL-Datenbank dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DatabaseInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="collation">Die Sortierung der Azure SQL-Datenbank.</param>
        <param name="creationDate">Das Erstellungsdatum der Azure SQL-Datenbank (ISO8601-Format).</param>
        <param name="containmentState">Der Status der Kapselung der Azure SQL-Datenbank.</param>
        <param name="currentServiceObjectiveId">Die aktuelle Service Level Objective-ID der Azure SQL-Datenbank. Dies ist die ID des SLO an, die derzeit aktiv ist.</param>
        <param name="databaseId">Die ID der Azure SQL-Datenbank.</param>
        <param name="earliestRestoreDate">Der Zeitraum für die Wiederherstellung Startdatum der Azure SQL-Datenbank. Auf diese Weise werden das Startdatum und die Uhrzeit, wann für die Wiederherstellung für diese Azure SQL-Datenbank (ISO8601-Format) verfügbar ist.</param>
        <param name="createMode">Gibt den Typ des zu erstellenden Datenbank an.
            Folgende Werte sind möglich: 'Kopieren', 'Default', 'NonReadableSecondary', "OnlineSecondary", 'PointInTimeRestore', 'Wiederherstellen', 'Wiederherstellen'</param>
        <param name="sourceDatabaseId">Bedingte. Gibt die Ressourcen-ID der Quelldatenbank an. Wenn CreateMode nicht auf den Standardwert festgelegt ist, muss dieser Wert angegeben werden. Der Name der Quelldatenbank muss identisch sein. Hinweis: Sortierung, Edition und MaxSizeBytes müssen identisch sein, während die Verbindung aktiv ist. Für diese Parameter angegebenen Werte werden ignoriert.</param>
        <param name="edition">Die Edition der Azure SQL-Datenbank. Die DatabaseEditions-Enumeration enthält alle gültigen Editionen.
            Folgende Werte sind möglich: 'Web', ' Business', 'Basic', 'Standard', "Premium", "Frei", "Stretch", "Data Warehouse"</param>
        <param name="maxSizeBytes">Die maximale Größe der Azure SQL-Datenbank in Bytes ausgedrückt. Hinweis: Nur die folgenden Größen werden unterstützt (zusätzlich zu den Einschränkungen, die auf den einzelnen Editionen platziert wird): {100 MB | 500 MB | 1 GB | 5 GB | 10 GB | 20 GB | 30 GB... 150 GB | 200 GB...
            500 GB}</param>
        <param name="requestedServiceObjectiveId">Die konfigurierten Service Level Objective-ID. der Azure SQL-Datenbank Dies ist der Servicelevel-Zielpunkt, die gerade auf die Azure SQL-Datenbank angewendet wird. Nachdem erfolgreich aktualisiert wurde, wird es den Wert der Eigenschaft CurrentServiceObjectiveId überein.</param>
        <param name="requestedServiceObjectiveName">Der Name der konfigurierten Servicelevel-Zielpunkt der Azure SQL-Datenbank. Dies ist der Servicelevel-Zielpunkt, die gerade auf die Azure SQL-Datenbank angewendet wird. Nachdem erfolgreich aktualisiert, wird es den Wert der Eigenschaft ServiceLevelObjective überein. Folgende Werte sind möglich: "Basic", "S0", "S1", "S2", "S3", "P1", "P2", "P3"</param>
        <param name="serviceLevelObjective">Die aktuelle SLO der Azure SQL-Datenbank. Folgende Werte sind möglich: "Basic", "S0", "S1", "S2", "S3", "P1", "P2", "P3"</param>
        <param name="status">Der Status der Azure SQL-Datenbank.</param>
        <param name="elasticPoolName">Der Name des elastischen Pools für Azure SQL wird die Datenbank.</param>
        ...
        <param name="upgradeHint">Der Upgrade-Hinweis für diese Datenbank.</param>
        <param name="schemas">Die Schemas aus dieser Datenbank.</param>
    ...
    <Member MemberName="Collation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Sortierung der Azure SQL-Datenbank.
            </summary>
    ...
    <Member MemberName="ContainmentState">
      ...
      <Docs>
        <summary>
            Ruft die Containment-Zustand der Azure SQL-Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreateMode">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt den Typ des zu erstellenden Datenbank an. Folgende Werte sind möglich: 'Kopieren', 'Default', 'NonReadableSecondary', "OnlineSecondary", 'PointInTimeRestore', 'Wiederherstellen', 'Wiederherstellen'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            Ruft das Erstellungsdatum der Azure SQL-Datenbank (ISO8601-Format).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CurrentServiceObjectiveId">
      ...
      <Docs>
        <summary>
            Ruft die aktuellen Service Level Objective-ID der Azure SQL-Datenbank. Dies ist die ID des SLO an, die derzeit aktiv ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EarliestRestoreDate">
      ...
      <Docs>
        <summary>
            Ruft den Zeitraum Startdatum Wiederherstellung der Azure SQL-Datenbank ab. Auf diese Weise werden das Startdatum und die Uhrzeit, wann für die Wiederherstellung für diese Azure SQL-Datenbank (ISO8601-Format) verfügbar ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Edition der Azure SQL-Datenbank. Die DatabaseEditions-Enumeration enthält alle gültigen Editionen.
            Folgende Werte sind möglich: 'Web', ' Business', 'Basic', 'Standard', "Premium", "Frei", "Stretch", "Data Warehouse"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ElasticPoolName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der den elastischen Pool SQL Azure in die Datenbank ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxSizeBytes">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Größe der Azure SQL-Datenbank in Bytes ausgedrückt. Hinweis: Nur die folgenden Größen werden unterstützt (zusätzlich zu den Einschränkungen, die auf den einzelnen Editionen platziert wird): {100 MB | 500 MB | 1 GB | 5 GB | 10 GB | 20 GB | 30 GB... 150 GB | 200 GB... 500 GB}
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjectiveId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die konfigurierten Service Level Ziel-ID der Azure SQL-Datenbank. Dies ist der Servicelevel-Zielpunkt, die gerade auf die Azure SQL-Datenbank angewendet wird. Nachdem erfolgreich aktualisiert wurde, wird es den Wert der Eigenschaft CurrentServiceObjectiveId überein.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjectiveName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen für die konfigurierten Servicelevel-Zielpunkt der Azure SQL-Datenbank. Dies ist der Servicelevel-Zielpunkt, die gerade auf die Azure SQL-Datenbank angewendet wird. Nachdem erfolgreich aktualisiert, wird es den Wert der Eigenschaft ServiceLevelObjective überein. Folgende Werte sind möglich: "Basic", "S0", "S1", "S2", "S3", "P1", "P2", "P3"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Schemas">
      ...
      <Docs>
        <summary>
            Ruft die Schemas aus dieser Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceLevelObjective">
      ...
      <Docs>
        <summary>
            Ruft das aktuelle SLO der Azure SQL-Datenbank ab.
    ...
    <Member MemberName="SourceDatabaseId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie bedingte fest. Gibt die Ressourcen-ID der Quelldatenbank an. Wenn CreateMode nicht auf den Standardwert festgelegt ist, muss dieser Wert angegeben werden. Der Name der Quelldatenbank muss identisch sein.
            Hinweis: Sortierung, Edition und MaxSizeBytes müssen identisch sein, während die Verbindung aktiv ist. Für diese Parameter angegebenen Werte werden ignoriert.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpgradeHint">
      ...
      <Docs>
        <summary>
            Ruft den Upgrade-Hinweis für diese Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
