<Type Name="RestorePointInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RestorePointInner">
  ...
  <Docs>
    <summary>
            Wiederherstellungspunkt für einen Azure SQL-Datenbank darstellen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RestorePointInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="restorePointType">Die Restore-Point-Typ des Wiederherstellungspunkts für Azure SQL-Datenbank. Folgende Werte sind möglich: "Diskret", "CONTINUOUS"</param>
        <param name="restorePointCreationDate">Stellen Sie Punkt-Erstellungszeit (ISO8601-Format) wieder her. Aufgefüllt, wenn RestorePointType = FORTLAUFEND.
            Andernfalls NULL.</param>
        <param name="earliestRestoreDate">Frühestes Wiederherstellungszeit (ISO8601-Format). Aufgefüllt, wenn RestorePointType = diskrete Werte. Andernfalls NULL.</param>
        <summary>
            Initialisiert eine neue Instanz der RestorePointInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EarliestRestoreDate">
      ...
      <Docs>
        <summary>
            Ruft Wiederherstellungszeit frühesten (ISO8601-Format). Aufgefüllt, wenn RestorePointType = diskrete Werte. Andernfalls NULL.
            </summary>
    ...
    <Member MemberName="RestorePointCreationDate">
      ...
      <Docs>
        <summary>
            Ruft Restore Point-Erstellungszeit (ISO8601-Format). Aufgefüllt, wenn RestorePointType = FORTLAUFEND. Andernfalls NULL.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RestorePointType">
      ...
      <Docs>
        <summary>
            Ruft den Typ des Restore-Punkts des Wiederherstellungspunkts für Azure SQL-Datenbank ab. Folgende Werte sind möglich: "Diskret", "CONTINUOUS"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
