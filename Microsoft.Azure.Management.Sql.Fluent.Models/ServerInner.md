<Type Name="ServerInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ServerInner">
  ...
  <Docs>
    <summary>
            Stellt eine Azure SQL-Server dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ServerInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="version">Die Version des Servers. Folgende Werte sind möglich: "2.0", "12.0"</param>
        <param name="administratorLogin">Administratorbenutzername für den Server. Kann nur angegeben werden, wenn der Server erstellt wird (und für die Erstellung erforderlich ist).</param>
    ...
    <Member MemberName="AdministratorLogin">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Administratorbenutzername für den Server. Kann nur angegeben werden, wenn der Server erstellt wird (und für die Erstellung erforderlich ist).
            </summary>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version des Servers. Folgende Werte sind möglich: "2.0", "12.0"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
