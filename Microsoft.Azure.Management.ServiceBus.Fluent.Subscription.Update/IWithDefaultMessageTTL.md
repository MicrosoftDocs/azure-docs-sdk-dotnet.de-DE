<Type Name="IWithDefaultMessageTTL" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Update.IWithDefaultMessageTTL">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="17287-101">Die Phase der Abonnementdefinition taktmonitoren Standardgültigkeitsdauer für Nachrichten definieren.</span><span class="sxs-lookup"><span data-stu-id="17287-101">The stage of the subscription definition allowing to define default TTL for messages.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDefaultMessageTTL">
      ...
      <Docs>
        <param name="ttl"><span data-ttu-id="17287-102">Zeit zum live-Dauer.</span><span class="sxs-lookup"><span data-stu-id="17287-102">Time to live duration.</span></span></param>
        <summary>
            <span data-ttu-id="17287-103">Gibt den Zeitraum, nach dem die Nachricht abläuft.</span><span class="sxs-lookup"><span data-stu-id="17287-103">Specifies the duration after which the message expires.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="17287-104">Die nächste Phase der Update-Abonnement.</span><span class="sxs-lookup"><span data-stu-id="17287-104">The next stage of subscription update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>