<Type Name="IWithDeleteOnIdle" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Update.IWithDeleteOnIdle">
  ...
  <Docs>
    <summary>
            Die Phase der Abonnement Definition ermöglicht automatische definieren löschen Verhalten.
            </summary>
  ...
  <Members>
    <Member MemberName="WithDeleteOnIdleDurationInMinutes">
      ...
      <Docs>
        ...
        <summary>
            Das im Leerlauf Intervall, nach dem das Abonnement automatisch gelöscht wird.
            </summary>
