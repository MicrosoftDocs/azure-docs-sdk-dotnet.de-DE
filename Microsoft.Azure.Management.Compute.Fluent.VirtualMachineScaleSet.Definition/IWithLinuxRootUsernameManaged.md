<Type Name="IWithLinuxRootUsernameManaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithLinuxRootUsernameManaged">
  ...
  <Docs>
    <summary>
            Die Phase der Linux-VM-Skalierungsgruppe festgelegt Definition ermöglicht SSH-Root-Benutzernamen angeben.
            </summary>
  ...
  <Members>
    <Member MemberName="WithRootUsername">
      ...
      <Docs>
        <param name="rootUserName">Ein Stamm-Benutzername, befolgen die erforderlichen Benennungskonventionen für Linux-Benutzernamen.</param>
        <summary>
            Gibt die SSH-Root-Benutzername für den virtuellen Linux-Computer an.
            </summary>
