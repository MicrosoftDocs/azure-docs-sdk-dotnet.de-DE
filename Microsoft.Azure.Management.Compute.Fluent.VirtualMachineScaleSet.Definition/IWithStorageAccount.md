<Type Name="IWithStorageAccount" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithStorageAccount">
  ...
  <Docs>
    <summary>
            Die Phase der VM-Skalierungsgruppe festgelegt Definition ermöglicht wird, um das Speicherkonto anzugeben.
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingStorageAccount">
      ...
      <Docs>
        ...
        <summary>
            Gibt ein vorhandenes Speicherkonto für den Datenträger Betriebssystem und die virtuellen Festplatten der virtuellen Computer in der Menge der Skala an.
            </summary>
    ...
    <Member MemberName="WithNewStorageAccount">
      ...
      <Docs>
        <param name="creatable">Die speicherkontendefinition in einer erstellbaren Stufe.</param>
        <summary>
            Gibt ein neues Speicherkonto für den Datenträger Betriebssystem und die virtuellen Festplatten der virtuellen Computer in der Menge der Skala an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Die nächste Stufe in der Definition.</return>
