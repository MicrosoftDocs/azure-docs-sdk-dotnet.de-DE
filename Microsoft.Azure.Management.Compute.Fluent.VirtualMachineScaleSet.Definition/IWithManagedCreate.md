<Type Name="IWithManagedCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithManagedCreate">
  ...
  <Docs>
    <summary>
            Die Phase der Definition enthält alle minimale erforderlichen Eingaben für die VM-Skalierungsgruppe erstellt werden und optional verwaltete Datenträger spezifische Einstellungen angegeben werden können.
            </summary>
