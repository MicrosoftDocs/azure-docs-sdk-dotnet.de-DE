<Type Name="IWithUnmanagedCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithUnmanagedCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b41ee-101">Die Phase der Definition enthält alle minimale erforderlichen Eingaben für die VM-Skala festgelegt erstellt werden und optional auch nicht verwaltete Datenträger spezifische Einstellungen angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="b41ee-101">The stage of the definition which contains all the minimum required inputs for the VM scale set to be created and optionally allow unmanaged data disks specific settings to be specified.</span></span>
            </summary>
