<Type Name="IWithManagedDiskOptionals" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithManagedDiskOptionals">
  ...
  <Docs>
    <summary>
            Die Optionals gilt nur für verwaltete Datenträger.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WithOSDiskStorageAccountType">
      ...
      <Docs>
        <param name="accountType">Der speicherkontotyp.</param>
        <summary>
            Gibt den Typ des Speicher-Konto für verwaltete BS-Datenträger.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Die Phase, die Definition des erstellbar virtuellen Computer darstellt.</return>
