<Type Name="VirtualMachineScaleSetUpdateVMProfile" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetUpdateVMProfile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdateVMProfile-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="osProfile">Die VM-Skalierungsgruppe Betriebssystemprofil.</param>
        <param name="storageProfile">Die VM-Skalierungsgruppe Speicherprofil.</param>
        <param name="networkProfile">Die VM-Skalierungsgruppe Netzwerkprofil.</param>
        <param name="diagnosticsProfile">Die VM-Skalierungsgruppe Diagnose-Profil.</param>
        <param name="extensionProfile">Die VM-Skalierungsgruppe Erweiterung Profil.</param>
    ...
    <Member MemberName="DiagnosticsProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt legen die VM-Skalierungsgruppe Diagnose Profil fest.
            </summary>
    ...
    <Member MemberName="ExtensionProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt legen die VM-Skalierungsgruppe Erweiterung Profil fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest VM-Skalierungsgruppe Netzwerkprofil.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest VM-Skalierungsgruppe Betriebssystemprofil.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest VM-Skalierungsgruppe Speicherprofil.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
