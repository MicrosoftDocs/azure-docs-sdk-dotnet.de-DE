<Type Name="ImageDiskReference" FullName="Microsoft.Azure.Management.Compute.Models.ImageDiskReference">
  ...
  <Docs>
    <summary>
            Zum Erstellen des Datenträgers Quellbilds.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ImageDiskReference-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Ein relativer Uri ist eine Plattform Imgage Repository oder Benutzer Bildverweis enthält.</param>
        <param name="lun">Wenn der Datenträger von Datenträger ein Image erstellt wird, ist dies ein Index, der die Datenträger für Daten in das zu verwendende Bild angibt. Für Betriebssystem-Datenträgern ist dieses Feld null.</param>
        <summary>
            Initialisiert eine neue Instanz der ImageDiskReference-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen relativen Uri handelt, die eine Plattform Imgage Repository oder Benutzer Bildverweis enthält.
            </summary>
    ...
    <Member MemberName="Lun">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob die Datenträger aus dem Datenträger ein Image erstellt wird, ist dies ein Index, der die Datenträger für Daten in das zu verwendende Bild angibt. Für Betriebssystem-Datenträgern ist dieses Feld null.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
