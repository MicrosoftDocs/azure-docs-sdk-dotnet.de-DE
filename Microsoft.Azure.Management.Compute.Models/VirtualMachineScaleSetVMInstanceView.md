<Type Name="VirtualMachineScaleSetVMInstanceView" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetVMInstanceView">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetVMInstanceView-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="vmHealth">Der Integritätsstatus für den virtuellen Computer.</param>
        <param name="bootDiagnostics">Startdiagnoseeinstellungen ist eine Debugfunktion Dadurch haben Sie die Konsolenausgabe und Screenshot für die Diagnose von VM-Status anzeigen. &lt;Brasilien&gt;&lt;Br&gt; für virtuelle Linux-Computer, können Sie einfach die Ausgabe des Protokolls Konsole anzeigen.
            &lt;Brasilien&gt;&lt;Br&gt; für Windows- und Linux-VMs Azure können Sie auch einen Screenshot des virtuellen Computers von der Hypervisor anzuzeigen.</param>
    ...
    <Member MemberName="BootDiagnostics">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert Startabbilder-Diagnose ist eine Debugfunktion Dadurch haben Sie die Konsolenausgabe und Screenshot für die Diagnose von VM-Status anzeigen.
            &amp;Lt; Br&amp;Gt;&amp; Lt; Br&amp;Gt; Für virtuelle Linux-Computer, können Sie einfach die Ausgabe des Protokolls Konsole anzeigen.
            &amp;Lt; Br&amp;Gt;&amp; Lt; Br&amp;Gt; Für Windows- und Linux-VMs kann Azure Sie auch einen Screenshot des virtuellen Computers von der Hypervisor anzuzeigen.
            </summary>
    ...
    <Member MemberName="VmHealth">
      ...
      <Docs>
        <summary>
            Ruft den Integritätsstatus für den virtuellen Computer an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
