<Type Name="DataDiskImage" FullName="Microsoft.Azure.Management.Compute.Models.DataDiskImage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c8d08-101">Enthält Informationen zu Images den Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="c8d08-101">Contains the data disk images information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d08-102">Initialisiert eine neue Instanz der DataDiskImage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c8d08-102">Initializes a new instance of the DataDiskImage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lun"><span data-ttu-id="c8d08-103">Gibt die logische Gerätenummer des Datenträgers an.</span><span class="sxs-lookup"><span data-stu-id="c8d08-103">Specifies the logical unit number of the data disk.</span></span> <span data-ttu-id="c8d08-104">Dieser Wert wird verwendet, um die Datenträger für Daten innerhalb des virtuellen Computers zu identifizieren und muss daher für jede an einen virtuellen Computer angefügten Datenträger eindeutig sein.</span><span class="sxs-lookup"><span data-stu-id="c8d08-104">This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM.</span></span></param>
        <summary>
            <span data-ttu-id="c8d08-105">Initialisiert eine neue Instanz der DataDiskImage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c8d08-105">Initializes a new instance of the DataDiskImage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Lun">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d08-106">Ruft gibt die logische Gerätenummer des Datenträgers an.</span><span class="sxs-lookup"><span data-stu-id="c8d08-106">Gets specifies the logical unit number of the data disk.</span></span> <span data-ttu-id="c8d08-107">Dieser Wert wird verwendet, um die Datenträger für Daten innerhalb des virtuellen Computers zu identifizieren und muss daher für jede an einen virtuellen Computer angefügten Datenträger eindeutig sein.</span><span class="sxs-lookup"><span data-stu-id="c8d08-107">This value is used to identify data disks within the VM and therefore must be unique for each data disk attached to a VM.</span></span>
            </summary>
