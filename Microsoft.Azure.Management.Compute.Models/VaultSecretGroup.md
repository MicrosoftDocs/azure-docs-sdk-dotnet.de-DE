<Type Name="VaultSecretGroup" FullName="Microsoft.Azure.Management.Compute.Models.VaultSecretGroup">
  ...
  <Docs>
    <summary>
            Beschreibt einen Satz von Zertifikaten, die alle im selben Schlüsseltresor befinden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VaultSecretGroup-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sourceVault">Die relative URL des Tresors Schlüssel, die alle Zertifikate in VaultCertificates enthält.</param>
        <param name="vaultCertificates">Die Liste der schlüsseltresor-Verweise in SourceVault die Zertifikate enthalten.</param>
        <summary>
            Initialisiert eine neue Instanz der VaultSecretGroup-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SourceVault">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die relative URL des Schlüsseltresor, die alle Zertifikate in VaultCertificates enthält.
            </summary>
    ...
    <Member MemberName="VaultCertificates">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der schlüsseltresor Verweise in SourceVault die Zertifikate enthalten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
