<Type Name="VirtualMachineScaleSetNetworkConfigurationDnsSettings" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetNetworkConfigurationDnsSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetNetworkConfigurationDnsSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dnsServers">Liste der IP-Adressen von DNS-Server</param>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetNetworkConfigurationDnsSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DnsServers">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der IP-Adressen von DNS-Server
            </summary>
