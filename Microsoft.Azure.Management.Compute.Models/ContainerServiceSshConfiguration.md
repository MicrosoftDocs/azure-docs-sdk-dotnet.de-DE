<Type Name="ContainerServiceSshConfiguration" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceSshConfiguration">
  ...
  <Docs>
    <summary>
            SSH-Konfiguration für virtuelle Linux-basierte Computer in Azure ausgeführt wird.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceSshConfiguration-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="publicKeys">die Liste der öffentlichen SSH-Schlüssel zur Authentifizierung beim virtuellen Linux-basierten Computern verwendet.</param>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceSshConfiguration-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PublicKeys">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der öffentlichen SSH-Schlüssel zur Authentifizierung beim virtuellen Linux-basierten Computern verwendet.
            </summary>
