<Type Name="ResourceSkuLocationInfo" FullName="Microsoft.Azure.Management.Compute.Models.ResourceSkuLocationInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ResourceSkuLocationInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location">Speicherort der SKU</param>
        <param name="zones">Liste der Verfügbarkeit von Zonen, in denen die SKU unterstützt wird.</param>
        <summary>
            Initialisiert eine neue Instanz der ResourceSkuLocationInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Zones">
      ...
      <Docs>
        <summary>
            Ruft die Liste der Verfügbarkeit Zonen, in denen die SKU unterstützt wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
