<Type Name="ResourceSkuLocationInfo" FullName="Microsoft.Azure.Management.Compute.Models.ResourceSkuLocationInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff318-101">Initialisiert eine neue Instanz der ResourceSkuLocationInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ff318-101">Initializes a new instance of the ResourceSkuLocationInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="ff318-102">Speicherort der SKU</span><span class="sxs-lookup"><span data-stu-id="ff318-102">Location of the SKU</span></span></param>
        <param name="zones"><span data-ttu-id="ff318-103">Liste der Verfügbarkeit von Zonen, in denen die SKU unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="ff318-103">List of availability zones where the SKU is supported.</span></span></param>
        <summary>
            <span data-ttu-id="ff318-104">Initialisiert eine neue Instanz der ResourceSkuLocationInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ff318-104">Initializes a new instance of the ResourceSkuLocationInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff318-105">Ruft die Position der SKU ab</span><span class="sxs-lookup"><span data-stu-id="ff318-105">Gets location of the SKU</span></span>
            </summary>
    ...
    <Member MemberName="Zones">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff318-106">Ruft die Liste der Verfügbarkeit Zonen, in denen die SKU unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="ff318-106">Gets list of availability zones where the SKU is supported.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
