<Type Name="DiskSku" FullName="Microsoft.Azure.Management.Compute.Models.DiskSku">
  ...
  <Docs>
    <summary>
            Der Datenträger und Snapshots Sku-Name. Standard_LRS oder "premium_lrs" möglich.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DiskSku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Die Sku-Name. Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Sku-Namen. Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""
            </summary>
