<Type Name="VirtualMachineInstanceView" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineInstanceView">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="platformUpdateDomain">Gibt die updatedomäne des virtuellen Computers an.</param>
        <param name="platformFaultDomain">Gibt die Fehlerdomäne des virtuellen Computers an.</param>
        ...
        <param name="maintenanceRedeployStatus">Der Vorgang zur Wartung Status auf dem virtuellen Computer.</param>
        <param name="disks">Die Datenträgerinformationen für virtuelle Computer.</param>
    ...
    <Member MemberName="MaintenanceRedeployStatus">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Vorgangsstatus für die Wartung auf dem virtuellen Computer.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
