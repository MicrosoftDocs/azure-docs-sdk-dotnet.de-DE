<Type Name="ContainerServiceOrchestratorProfile" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceOrchestratorProfile">
  ...
  <Docs>
    <summary>
            Profil für den Container-Orchestrator-Dienst.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceOrchestratorProfile-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="orchestratorType">Die Orchestrator zum Verwalten von Clusterressourcen für Container-Dienst. Gültige Werte sind Punktschwarms, DCOS und Benutzerdefiniert. Folgende Werte sind möglich: "Containerhostclustern", "DCOS", "Benutzerdefiniert", "Kubernetes"</param>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceOrchestratorProfile-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OrchestratorType">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Orchestrator zum Verwalten von Clusterressourcen für Container-Dienst. Gültige Werte sind Punktschwarms, DCOS und Benutzerdefiniert.
            Folgende Werte sind möglich: "Containerhostclustern", "DCOS", "Benutzerdefiniert", "Kubernetes"
            </summary>
