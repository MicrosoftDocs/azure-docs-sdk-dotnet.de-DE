<Type Name="DiskEncryptionSettings" FullName="Microsoft.Azure.Management.Compute.Models.DiskEncryptionSettings">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="diskEncryptionKey">Gibt den Speicherort des Verschlüsselungsschlüssels Datenträger, die einen Key Vault geheimen Schlüssel ist.</param>
        <param name="keyEncryptionKey">Gibt den Speicherort des Verschlüsselungsschlüssels für die Schlüssel im Schlüsseltresor.</param>
    ...
    <Member MemberName="DiskEncryptionKey">
      ...
      <Docs>
        <summary>
            Gibt den Speicherort des Verschlüsselungsschlüssels Datenträger, die einen Key Vault geheimen Schlüssel ist, ruft ab oder legt ihn fest.
            </summary>
    ...
    <Member MemberName="KeyEncryptionKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest gibt den Speicherort des Verschlüsselungsschlüssels für die Schlüssel im Schlüsseltresor.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
