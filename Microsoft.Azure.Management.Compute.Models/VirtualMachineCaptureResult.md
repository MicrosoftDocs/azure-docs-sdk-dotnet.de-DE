<Type Name="VirtualMachineCaptureResult" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineCaptureResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="527f0-101">Ressourcen-Id.</span><span class="sxs-lookup"><span data-stu-id="527f0-101">Resource Id.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="527f0-102">Initialisiert eine neue Instanz der VirtualMachineCaptureResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="527f0-102">Initializes a new instance of the VirtualMachineCaptureResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="527f0-103">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="527f0-103">Resource Id</span></span></param>
        <param name="output"><span data-ttu-id="527f0-104">Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="527f0-104">Operation output data (raw JSON)</span></span></param>
        <summary>
            <span data-ttu-id="527f0-105">Initialisiert eine neue Instanz der VirtualMachineCaptureResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="527f0-105">Initializes a new instance of the VirtualMachineCaptureResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Output">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="527f0-106">Ruft ab oder legt ihn fest Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="527f0-106">Gets or sets operation output data (raw JSON)</span></span>
            </summary>
