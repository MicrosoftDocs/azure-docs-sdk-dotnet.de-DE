<Type Name="CreationData" FullName="Microsoft.Azure.Management.Compute.Models.CreationData">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="createOption">Listet die möglichen Quellen der Erstellung des Datenträgers. Folgende Werte sind möglich: "Leer", "Anfügen", "FromImage", "Import", "Kopieren"</param>
        ...
        <param name="sourceUri">Wenn CreateOption importieren, ist dies der URI des Blob in einen verwalteten Datenträger importiert werden sollen.</param>
        <param name="sourceResourceId">Wenn CreateOption Kopie ist, ist dies die ARM-Id der Quellmomentaufnahme oder des Datenträgers an.</param>
        <summary>
            Initialisiert eine neue Instanz der CreationData-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CreateOption">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt dies Listet die möglichen Quellen der Erstellung des Datenträgers. Folgende Werte sind möglich: "Leer", "Anfügen", "FromImage", "Import", "Kopieren"
            </summary>
    ...
    <Member MemberName="SourceResourceId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob CreateOption Kopie ist dies ist die ARM-Id der Quellmomentaufnahme oder des Datenträgers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SourceUri">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob CreateOption Import ist, ist dies der URI des Blob in einen verwalteten Datenträger importiert werden sollen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
