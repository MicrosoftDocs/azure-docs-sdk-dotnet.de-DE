  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="osDisk">Gibt Informationen über die Betriebssystem-Datenträger, die von den virtuellen Computern in der Menge der Skala verwendet.
            &lt;Brasilien&gt;&lt;Br&gt; Weitere Informationen zu Datenträgern finden Sie unter [zu Datenträgern und virtuellen Festplatten für virtuelle Computer in Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).</param>
        <param name="dataDisks">Gibt die Parameter, die verwendet werden, um die Datenträger mit den virtuellen Computern in der Menge Skalierung hinzufügen.
            &lt;Brasilien&gt;&lt;Br&gt; Weitere Informationen zu Datenträgern finden Sie unter [zu Datenträgern und virtuellen Festplatten für virtuelle Computer in Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).</param>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetStorageProfile-Klasse.
            </summary>
    ...
    <Member MemberName="DataDisks">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt die Parameter, die verwendet werden, um die Datenträger mit den virtuellen Computern in der Menge Skalierung hinzufügen.
            &amp;Lt; Br&amp;Gt;&amp; Lt; Br&amp;Gt; Weitere Informationen zu Datenträgern finden Sie unter [zu Datenträgern und virtuellen Festplatten für virtuelle Computer in Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
            </summary>
    ...
    <Member MemberName="OsDisk">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt Informationen zum Betriebssystem-Datenträger, die von den virtuellen Computern in der Menge der Skala verwendet.
            &amp;Lt; Br&amp;Gt;&amp; Lt; Br&amp;Gt; Weitere Informationen zu Datenträgern finden Sie unter [zu Datenträgern und virtuellen Festplatten für virtuelle Computer in Azure](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
