<Type Name="VirtualMachineScaleSetNetworkConfiguration" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetNetworkConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="db4bd-101">Beschreibt die Netzwerkkonfigurationen für eine virtuelle Maschine Skalierung Satz Netzwerk des Profils.</span><span class="sxs-lookup"><span data-stu-id="db4bd-101">Describes a virtual machine scale set network profile's network configurations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-102">Initialisiert eine neue Instanz der VirtualMachineScaleSetNetworkConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="db4bd-102">Initializes a new instance of the VirtualMachineScaleSetNetworkConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="db4bd-103">Der Name des Netzwerk-Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="db4bd-103">The network configuration name.</span></span></param>
        <param name="ipConfigurations"><span data-ttu-id="db4bd-104">Gibt die IP-Konfigurationen der Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="db4bd-104">Specifies the IP configurations of the network interface.</span></span></param>
        <param name="id"><span data-ttu-id="db4bd-105">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="db4bd-105">Resource Id</span></span></param>
        <param name="primary"><span data-ttu-id="db4bd-106">Gibt die primäre Netzwerkschnittstelle an, für den Fall, dass der virtuelle Computer mehr als 1 Netzwerkschnittstelle hat.</span><span class="sxs-lookup"><span data-stu-id="db4bd-106">Specifies the primary network interface in case the virtual machine has more than 1 network interface.</span></span></param>
        <param name="enableAcceleratedNetworking"><span data-ttu-id="db4bd-107">Gibt an, ob die Netzwerkschnittstelle Networking-fähigen beschleunigt wird.</span><span class="sxs-lookup"><span data-stu-id="db4bd-107">Specifies whether the network interface is accelerated networking-enabled.</span></span></param>
        <param name="networkSecurityGroup"><span data-ttu-id="db4bd-108">Die Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="db4bd-108">The network security group.</span></span></param>
        <param name="dnsSettings"><span data-ttu-id="db4bd-109">Die DNS-Einstellungen für die Netzwerkschnittstellen verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="db4bd-109">The dns settings to be applied on the network interfaces.</span></span></param>
        <summary>
            <span data-ttu-id="db4bd-110">Initialisiert eine neue Instanz der VirtualMachineScaleSetNetworkConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="db4bd-110">Initializes a new instance of the VirtualMachineScaleSetNetworkConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DnsSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-111">Ruft ab oder legt die DNS-Einstellungen für die Netzwerkschnittstellen verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="db4bd-111">Gets or sets the dns settings to be applied on the network interfaces.</span></span>
            </summary>
    ...
    <Member MemberName="EnableAcceleratedNetworking">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-112">Ruft ab oder legt ihn fest gibt an, ob die Netzwerkschnittstelle Networking-fähigen beschleunigt wird.</span><span class="sxs-lookup"><span data-stu-id="db4bd-112">Gets or sets specifies whether the network interface is accelerated networking-enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-113">Gibt an die IP-Konfiguration der Netzwerkschnittstelle, ruft ab oder legt ihn fest.</span><span class="sxs-lookup"><span data-stu-id="db4bd-113">Gets or sets specifies the IP configurations of the network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-114">Ruft ab oder legt den Netzwerknamen für die Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="db4bd-114">Gets or sets the network configuration name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroup">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-115">Ruft ab oder legt die Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="db4bd-115">Gets or sets the network security group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Primary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-116">Ruft ab oder legt gibt die primäre Netzwerkschnittstelle für den Fall, dass der virtuelle Computer mehr als 1 Netzwerkschnittstelle hat.</span><span class="sxs-lookup"><span data-stu-id="db4bd-116">Gets or sets specifies the primary network interface in case the virtual machine has more than 1 network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4bd-117">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="db4bd-117">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="db4bd-118">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="db4bd-118">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
