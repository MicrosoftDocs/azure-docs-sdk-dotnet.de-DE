<Type Name="Snapshot" FullName="Microsoft.Azure.Management.Compute.Models.Snapshot">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="48e55-101">Ressource "Snapshot".</span><span class="sxs-lookup"><span data-stu-id="48e55-101">Snapshot resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-102">Initialisiert eine neue Instanz der Momentaufnahme-Klasse.</span><span class="sxs-lookup"><span data-stu-id="48e55-102">Initializes a new instance of the Snapshot class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="48e55-103">Speicherort von Ressourcen</span><span class="sxs-lookup"><span data-stu-id="48e55-103">Resource location</span></span></param>
        <param name="creationData"><span data-ttu-id="48e55-104">Datenträger-Quellinformationen.</span><span class="sxs-lookup"><span data-stu-id="48e55-104">Disk source information.</span></span> <span data-ttu-id="48e55-105">CreationData Informationen kann nicht geändert werden, nachdem der Datenträger erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="48e55-105">CreationData information cannot be changed after the disk has been created.</span></span></param>
        <param name="id"><span data-ttu-id="48e55-106">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="48e55-106">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="48e55-107">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="48e55-107">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="48e55-108">Ressourcentyp</span><span class="sxs-lookup"><span data-stu-id="48e55-108">Resource type</span></span></param>
        <param name="tags"><span data-ttu-id="48e55-109">Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="48e55-109">Resource tags</span></span></param>
        <param name="managedBy"><span data-ttu-id="48e55-110">Nicht verwendet.</span><span class="sxs-lookup"><span data-stu-id="48e55-110">Unused.</span></span> <span data-ttu-id="48e55-111">Immer Null.</span><span class="sxs-lookup"><span data-stu-id="48e55-111">Always Null.</span></span></param>
        <param name="sku">To be added.</param>
        <param name="timeCreated"><span data-ttu-id="48e55-112">Die Zeit, wenn der Datenträger erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="48e55-112">The time when the disk was created.</span></span></param>
        <param name="osType"><span data-ttu-id="48e55-113">Der Typ des Betriebssystems.</span><span class="sxs-lookup"><span data-stu-id="48e55-113">The Operating System type.</span></span> <span data-ttu-id="48e55-114">Folgende Werte sind möglich: "Windows", "Linux"</span><span class="sxs-lookup"><span data-stu-id="48e55-114">Possible values include: 'Windows', 'Linux'</span></span></param>
        <param name="diskSizeGB"><span data-ttu-id="48e55-115">Wenn creationData.createOption leer ist, wird dieses Feld ist obligatorisch, und darauf, dass die Größe der virtuellen Festplatte zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="48e55-115">If creationData.createOption is Empty, this field is mandatory and it indicates the size of the VHD to create.</span></span> <span data-ttu-id="48e55-116">Wenn dieses Feld nach Updates oder Erstellung mit anderen Optionen vorhanden ist, gibt es eine Größe an.</span><span class="sxs-lookup"><span data-stu-id="48e55-116">If this field is present for updates or creation with other options, it indicates a resize.</span></span> <span data-ttu-id="48e55-117">Ändert die Größe sind nur zulässig, wenn der Datenträger nicht an einen ausgeführten virtuellen Computer angefügt ist und nur Sie den Datenträger vergrößern kann.</span><span class="sxs-lookup"><span data-stu-id="48e55-117">Resizes are only allowed if the disk is not attached to a running VM, and can only increase the disk's size.</span></span></param>
        <param name="encryptionSettings"><span data-ttu-id="48e55-118">Verschlüsselungseinstellungen für Datenträger oder einer Momentaufnahme</span><span class="sxs-lookup"><span data-stu-id="48e55-118">Encryption settings for disk or snapshot</span></span></param>
        <param name="provisioningState"><span data-ttu-id="48e55-119">Der Datenträger, der Bereitstellungsstatus.</span><span class="sxs-lookup"><span data-stu-id="48e55-119">The disk provisioning state.</span></span></param>
        <summary>
            <span data-ttu-id="48e55-120">Initialisiert eine neue Instanz der Momentaufnahme-Klasse.</span><span class="sxs-lookup"><span data-stu-id="48e55-120">Initializes a new instance of the Snapshot class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreationData">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-121">Ruft ab, oder legt ihn fest Datenträger Quellinformationen.</span><span class="sxs-lookup"><span data-stu-id="48e55-121">Gets or sets disk source information.</span></span> <span data-ttu-id="48e55-122">CreationData Informationen kann nicht geändert werden, nachdem der Datenträger erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="48e55-122">CreationData information cannot be changed after the disk has been created.</span></span>
            </summary>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-123">Ruft ab oder legt fest, ob creationData.createOption leer ist, dieses Feld ist obligatorisch und gibt die Größe der virtuellen Festplatte erstellen an.</span><span class="sxs-lookup"><span data-stu-id="48e55-123">Gets or sets if creationData.createOption is Empty, this field is mandatory and it indicates the size of the VHD to create.</span></span> <span data-ttu-id="48e55-124">Wenn dieses Feld nach Updates oder Erstellung mit anderen Optionen vorhanden ist, gibt es eine Größe an.</span><span class="sxs-lookup"><span data-stu-id="48e55-124">If this field is present for updates or creation with other options, it indicates a resize.</span></span> <span data-ttu-id="48e55-125">Ändert die Größe sind nur zulässig, wenn der Datenträger nicht an einen ausgeführten virtuellen Computer angefügt ist und nur Sie den Datenträger vergrößern kann.</span><span class="sxs-lookup"><span data-stu-id="48e55-125">Resizes are only allowed if the disk is not attached to a running VM, and can only increase the disk's size.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EncryptionSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-126">Ruft ab oder legt ihn fest verschlüsselungseinstellungen für Datenträger oder einer Momentaufnahme</span><span class="sxs-lookup"><span data-stu-id="48e55-126">Gets or sets encryption settings for disk or snapshot</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedBy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-127">Ruft einen nicht verwendeten ab.</span><span class="sxs-lookup"><span data-stu-id="48e55-127">Gets unused.</span></span> <span data-ttu-id="48e55-128">Immer Null.</span><span class="sxs-lookup"><span data-stu-id="48e55-128">Always Null.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-129">Ruft ab oder legt den Betriebssystemtyp.</span><span class="sxs-lookup"><span data-stu-id="48e55-129">Gets or sets the Operating System type.</span></span> <span data-ttu-id="48e55-130">Folgende Werte sind möglich: "Windows", "Linux"</span><span class="sxs-lookup"><span data-stu-id="48e55-130">Possible values include: 'Windows', 'Linux'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-131">Ruft den Bereitstellungsstatus Datenträger ab.</span><span class="sxs-lookup"><span data-stu-id="48e55-131">Gets the disk provisioning state.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeCreated">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-132">Ruft die Uhrzeit der Erstellung des Datenträgers ab.</span><span class="sxs-lookup"><span data-stu-id="48e55-132">Gets the time when the disk was created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48e55-133">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="48e55-133">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="48e55-134">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="48e55-134">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
