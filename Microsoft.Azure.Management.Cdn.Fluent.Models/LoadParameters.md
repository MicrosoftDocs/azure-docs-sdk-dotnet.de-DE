<Type Name="LoadParameters" FullName="Microsoft.Azure.Management.Cdn.Fluent.Models.LoadParameters">
  ...
  <Docs>
    <summary>
            Parameter für das Laden von Inhalt erforderlich.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der LoadParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="contentPaths">Der Pfad zum Inhalt geladen werden soll.
            Pfad muss sich auf eine relative Datei-URL des Ursprungs.</param>
        <summary>
            Initialisiert eine neue Instanz der LoadParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ContentPaths">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pfad fest, auf die Inhalte geladen werden soll. Pfad muss sich auf eine relative Datei-URL des Ursprungs.
            </summary>
