<Type Name="PurgeParameters" FullName="Microsoft.Azure.Management.Cdn.Fluent.Models.PurgeParameters">
  ...
  <Docs>
    <summary>
            Für inhaltsbereinigung erforderliche Parameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PurgeParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="contentPaths">Der Pfad zum Inhalt gelöscht werden.
            Hierbei kann es sich um einen Dateipfad oder ein Platzhalter-Verzeichnis beschreiben.</param>
        <summary>
            Initialisiert eine neue Instanz der PurgeParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ContentPaths">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pfad zum Inhalt gelöscht werden. Hierbei kann es sich um einen Dateipfad oder ein Platzhalter-Verzeichnis beschreiben.
            </summary>
