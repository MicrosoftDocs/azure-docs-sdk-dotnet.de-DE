<Type Name="OriginInner" FullName="Microsoft.Azure.Management.Cdn.Fluent.Models.OriginInner">
  ...
  <Docs>
    <summary>
            CDN Ursprung ist die Quelle des Inhalts über CDN übermittelt werden. Bei edgeknoten, die von einem Endpunkt dargestellt nicht den angeforderten Inhalt zwischengespeichert haben, versuchen sie es aus einer oder mehreren der konfigurierten Ursprünge abzurufen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OriginInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="hostName">Die Adresse des Ursprungs. Domänennamen, IPv4-Adressen und IPv6-Adressen werden unterstützt.</param>
        <param name="location">To be added.</param>
        <param name="id">To be added.</param>
        <param name="name">To be added.</param>
        <param name="type">To be added.</param>
        <param name="tags">To be added.</param>
        <param name="httpPort">Der Wert des HTTP-Port. Muss zwischen 1 und 65535 liegen.</param>
        <param name="httpsPort">Der Wert der Https-Port. Muss zwischen 1 und 65535 liegen.</param>
        <param name="resourceState">Den Ressourcenstatus des Ursprungs. Folgende Werte sind möglich: 'Erstellen', 'Active', 'Löschen'</param>
        <param name="provisioningState">Der Bereitstellungsstatus des Ursprungs.</param>
        <summary>
            Initialisiert eine neue Instanz der OriginInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Adresse des Ursprungs. Domänennamen, IPv4-Adressen und IPv6-Adressen werden unterstützt.
            </summary>
    ...
    <Member MemberName="HttpPort">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Wert des HTTP-Port. Muss liegen zwischen 1 und
            65535.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HttpsPort">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Wert für die Https-Port. Muss liegen zwischen 1 und
            65535.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Status des Ursprungs ruft bereitgestellt werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceState">
      ...
      <Docs>
        <summary>
            Ruft den Ursprung Ressourcenstatus ab. Folgende Werte sind möglich: 'Erstellen', 'Active', 'Löschen'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
