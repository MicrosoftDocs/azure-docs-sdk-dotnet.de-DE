<Type Name="Status" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.Status">
  ...
  <Docs>
    <summary>
            Der Status der Azure-Ressource zu dem Zeitpunkt, der Vorgang aufgerufen wurde.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="displayStatus">Die kurzen Bezeichnung für den Status.</param>
        <param name="message">Die ausführliche Meldung für den Status, einschließlich Warnungen und Fehlermeldungen.</param>
        <param name="timestamp">Der Zeitstempel für den aktuellen Wert der Status geändert wurde.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Status an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DisplayStatus">
      ...
      <Docs>
        <summary>
            Ruft die kurze Bezeichnung für den Status ab.
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft die detaillierte Meldung für den Status, einschließlich Warnungen und Fehlermeldungen an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            Ruft den Zeitstempel ab, wenn der Status auf den aktuellen Wert geändert wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
