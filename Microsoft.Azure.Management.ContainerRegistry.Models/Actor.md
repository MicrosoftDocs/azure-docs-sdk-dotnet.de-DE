<Type Name="Actor" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.Actor">
  ...
  <Docs>
    <summary>
            Der Agent, der das Ereignis initiiert. Bei den meisten Fällen kann dies aus dem Autorisierungskontext der Anforderung handeln.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Akteur-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Betreff oder der Benutzername, den Anforderungskontext, der das Ereignis generiert hat zugeordnet.</param>
        <summary>
            Initialisiert eine neue Instanz der Akteur-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, den Betreff oder den Benutzernamen mit den Anforderungskontext, der das Ereignis generiert hat.
            </summary>
