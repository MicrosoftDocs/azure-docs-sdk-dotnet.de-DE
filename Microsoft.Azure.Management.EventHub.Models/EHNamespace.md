<Type Name="EHNamespace" FullName="Microsoft.Azure.Management.EventHub.Models.EHNamespace">
  ...
  <Docs>
    <summary>
            Einzelnes Namespace-Element in der Liste "oder" Get-Vorgang
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der EHNamespace-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sku">Eigenschaften der Sku-Ressource</param>
        <param name="provisioningState">Der Bereitstellungsstatus der der Namespace.</param>
        <param name="createdAt">Der Zeitpunkt, zu dem Namespace erstellt wurde.</param>
        <param name="updatedAt">Der Zeitpunkt, zu dem Namespace aktualisiert wurde.</param>
        <param name="serviceBusEndpoint">Der Endpunkt, den Sie verwenden können, um Service Bus-Vorgänge auszuführen.</param>
        <param name="metricId">Der Bezeichner für die Azure Insights Metriken.</param>
        <param name="isAutoInflateEnabled">Ein Wert, der angibt, ob AutoInflate für Eventhub-Namespace aktiviert ist.</param>
        <param name="maximumThroughputUnits">Die Obergrenze der durchsatzeinheiten, wenn die AutoInflate aktiviert ist, sollten innerhalb von 0 bis 20 durchsatzeinheiten Wert sein. ("0", wenn AutoInflateEnabled = "true")</param>
        <summary>
            Initialisiert eine neue Instanz der EHNamespace-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary>
            Ruft den Zeitpunkt der Erstellung der Namespace ab.
            </summary>
    ...
    <Member MemberName="IsAutoInflateEnabled">
      ...
      <Docs>
        <summary>
            Wert abgerufen oder festgelegt, der angibt, ob AutoInflate für Eventhub-Namespace aktiviert ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaximumThroughputUnits">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen oberen Grenzwert der durchsatzeinheiten, wenn die AutoInflate aktiviert ist, muss Wert innerhalb von 0 bis 20 durchsatzeinheiten. ("0", wenn AutoInflateEnabled = "true")
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Status der der Namespace ruft bereitgestellt werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Eigenschaften Sku-Ressource
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdatedAt">
      ...
      <Docs>
        <summary>
            Ruft die Zeit ab, an die den Namespace aktualisiert wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
