<Type Name="Sku" FullName="Microsoft.Azure.Management.EventHub.Models.Sku">
  ...
  <Docs>
    <summary>
            SKU-Parameter angegeben wird, um den Vorgang zum Erstellen von namespace
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name dieser SKU. Folgende Werte sind möglich: "Basic", "Standard"</param>
        <param name="tier">Die abrechnungsebene dieser bestimmten SKU.
            Folgende Werte sind möglich: "Basic", "Standard"</param>
        <param name="capacity">Die Ereignis-Hub-durchsatzeinheiten, der Wert muss 0 bis 20 durchsatzeinheiten.</param>
        <summary>
            Initialisiert eine neue Instanz der Sku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Event Hubs-durchsatzeinheiten Wert muss 0 bis 20 durchsatzeinheiten.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen dieser SKU fest. Folgende Werte sind möglich: "Basic", "Standard"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die abrechnungsebene dieser bestimmten SKU. Folgende Werte sind möglich: "Basic", "Standard"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
