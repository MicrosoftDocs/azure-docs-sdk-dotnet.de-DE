  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sizeLimitInBytes">Das Fenster der Größe definiert, die Menge der Daten in Ihren Event Hub vor einem Vorgang Capture aufgebaut, Wert muss zwischen zu 524288000 10485760 bytes</param>
    ...
    <Member MemberName="SizeLimitInBytes">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Fenstergröße aufgebaut Datenmenge in Ihren Event Hub vor einem Capture-Vorgang definiert, sollte Wert zwischen zu 524288000 10485760 Bytes sein.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
