<Type Name="ServicePlacementRequireDomainDistributionPolicyDescription" FullName="System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription">
  ...
  <Docs>
    <summary>
      <para>Gibt die Platzierungsrichtlinie gibt an, dass zwei Replikate aus der gleichen Partition nie in derselben Domäne Fehler oder Upgrade platziert werden soll.  
            Dies ist zwar nicht häufig können sie den Dienst zu einem erhöhten Risiko gleichzeitiger Ausfälle aufgrund von nicht geplanter Ausfälle oder andere Fälle von nachfolgenden/gleichzeitigen Fehlern verfügbar machen. Beispielsweise sollten Sie einen Fall, in dem anderen Rechenzentrum, mit der ein Replikat pro Standort Replikate bereitgestellt werden. Wenn eines der Datencentern offline geschaltet wird, normalerweise wird das Replikat, das in diesem Datencenter platziert wurde in eine der verbleibenden Datencentern gepackt. Diese Richtlinie sollte festgelegt werden, wenn dies nicht erwünscht ist.</para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <para>Initialisiert eine neue Instanz der <see cref="T:System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription" />-Klasse.</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
          <para> 
            Eine Zeichenfolgendarstellung der RequiredDomainDistribution Platzierung Dienstrichtlinie in Form 'RequiredDomainDistribution, DomainName' zurückgeben. 
            </para>
        </summary>
        <returns>
