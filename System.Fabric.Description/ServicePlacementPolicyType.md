<Type Name="ServicePlacementPolicyType" FullName="System.Fabric.Description.ServicePlacementPolicyType">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="56dbc-101">Gibt den Typ der spezifischen <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" />.</span><span class="sxs-lookup"><span data-stu-id="56dbc-101">Indicates the type of the specific <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" />.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="56dbc-102">Ungültige Platzierung Richtlinientyp.</span><span class="sxs-lookup"><span data-stu-id="56dbc-102">Invalid placement policy type.</span></span> <span data-ttu-id="56dbc-103">Gibt an, dass der Typ der angegebenen Richtlinie unbekannt oder ungültig war.</span><span class="sxs-lookup"><span data-stu-id="56dbc-103">Indicates that the type of the policy specified was unknown or invalid.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="InvalidDomain">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="56dbc-104">Gibt an, dass die <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> ist eine <see cref="T:System.Fabric.Description.ServicePlacementInvalidDomainPolicyDescription" />, was bedeutet, dass auf einen bestimmten Fehler oder upgradedomäne für die Platzierung von diesem Dienst verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="56dbc-104">Indicates that the <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> is a <see cref="T:System.Fabric.Description.ServicePlacementInvalidDomainPolicyDescription" />, which indicates that a particular fault or upgrade domain cannot be used for placement of this service.</span></span></para>
        </summary>
      </Docs>
    </Member>
    ...
    <Member MemberName="PreferPrimaryDomain">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="56dbc-105">Gibt an, dass die <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> ist eine <see cref="T:System.Fabric.Description.ServicePlacementPreferPrimaryDomainPolicyDescription" />, was bedeutet, dass nach Möglichkeit das primäre Replikat für die Partitionen des Diensts in einer bestimmten Domäne zur Optimierung gespeichert werden.</span><span class="sxs-lookup"><span data-stu-id="56dbc-105">Indicates that the <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> is a <see cref="T:System.Fabric.Description.ServicePlacementPreferPrimaryDomainPolicyDescription" />, which indicates that if possible the Primary replica for the partitions of the service should be located in a particular domain as an optimization.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RequireDomain">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="56dbc-106">Gibt an, dass die <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> ist eine <see cref="T:System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription" /> gibt an, dass die Replikate des Diensts in einer bestimmten Domäne platziert werden müssen.</span><span class="sxs-lookup"><span data-stu-id="56dbc-106">Indicates that the <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> is a <see cref="T:System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription" /> indicating that the replicas of the service must be placed in a specific domain.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RequireDomainDistribution">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="56dbc-107">Gibt an, dass die <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> ist eine <see cref="T:System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription" />, gibt an, dass das System Platzierung von zwei Replikate aus der gleichen Partition in der gleichen Domäne zu einem beliebigen Zeitpunkt verweigert wird.</span><span class="sxs-lookup"><span data-stu-id="56dbc-107">Indicates that the <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> is a <see cref="T:System.Fabric.Description.ServicePlacementRequireDomainDistributionPolicyDescription" />, indicating that the system will disallow placement of any two replicas from the same partition in the same domain at any time.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
