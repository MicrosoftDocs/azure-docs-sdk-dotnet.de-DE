<Type Name="IProtectionPolicyOperationStatusesOperations" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.IProtectionPolicyOperationStatusesOperations">
  ...
  <Docs>
    <summary>
            ProtectionPolicyOperationStatusesOperations-Vorgänge.
            </summary>
  ...
  <Members>
    <Member MemberName="GetWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Stellt den Status der asynchronen Vorgänge, z. B. Sicherung, Wiederherstellung bereit. Der Status kann in Bearbeitung, abgeschlossen oder fehlerhaft sein. Sie können der Vorgangsstatus-Enumeration für alle möglichen Status eines Vorgangs verweisen. Einige Vorgänge Aufträge erstellt werden. Diese Methode gibt die Liste der Aufträge Vorgang zugeordnet.
            </summary>
