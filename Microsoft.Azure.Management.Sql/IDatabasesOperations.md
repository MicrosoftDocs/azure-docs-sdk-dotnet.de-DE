  ...
  <Members>
    ...
    <Member MemberName="GetWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="expand">
            Eine durch Trennzeichen getrennte Liste von untergeordneten Objekten in der Antwort zu erweitern.
            Möglichen Eigenschaften: ServiceTierAdvisors TransparentDataEncryption.
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
