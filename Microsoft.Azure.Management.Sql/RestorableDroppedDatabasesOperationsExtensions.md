<Type Name="RestorableDroppedDatabasesOperationsExtensions" FullName="Microsoft.Azure.Management.Sql.RestorableDroppedDatabasesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für RestorableDroppedDatabasesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="restorableDroppededDatabaseId">
            Die Id der gelöschten Datenbank in Form von DatabaseName deletionTimeInFileTimeFormat
            </param>
        <summary>
            Ruft eine gelöschte Datenbank, die wiederhergestellt werden können
            </summary>
    ...
    <Member MemberName="ListByServer">
      ...
      <Docs>
        ...
        <summary>
            Ruft eine Liste der gelöschten Datenbanken, die wiederhergestellt werden können
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
