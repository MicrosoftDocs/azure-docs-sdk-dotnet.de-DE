<Type Name="ServerAzureADAdministratorsOperationsExtensions" FullName="Microsoft.Azure.Management.Sql.ServerAzureADAdministratorsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für ServerAzureADAdministratorsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="properties">
            Die erforderlichen Parameter zum Erstellen oder aktualisieren eine Active Directory-Administrator.
            </param>
        <summary>
            Ein neuer Server Active Directory-Administrator erstellt oder aktualisiert einen vorhandenen Server Active Directory-Administrator.
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <summary>
            Löscht einen vorhandenen Server Active Directory-Administrator.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByServer">
      ...
      <Docs>
        ...
        <summary>
            Gibt eine Liste von Server-Administratoren.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
