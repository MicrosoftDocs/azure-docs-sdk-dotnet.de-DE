<Type Name="IElasticPoolsOperations" FullName="Microsoft.Azure.Management.Sql.IElasticPoolsOperations">
  ...
  <Docs>
    <summary>
            ElasticPoolsOperations-Vorgänge.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            Der Name des elastischen Pools verarbeitet werden sollen (aktualisiert oder erstellt wurde).
            </param>
    ...
    <Member MemberName="BeginUpdateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            Der Name des elastischen Pools aktualisiert werden.
            </param>
        <param name="parameters">
            Die erforderlichen Parameter für einen elastischen Pool aktualisieren.
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
        ...
        <summary>
            Aktualisiert einen vorhandenen Pool für elastische Datenbanken
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
    ...
    <Member MemberName="DeleteWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            Der Name des elastischen Pools gelöscht werden soll.
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
        ...
        <summary>
            Löscht den Pool für elastische Datenbanken.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
    ...
    <Member MemberName="ListMetricDefinitionsWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Gibt elastischen Pool metrikdefinitionen zurück.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
    ...
    <Member MemberName="ListMetricsWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Gibt Metriken für elastischen Pool zurück.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
