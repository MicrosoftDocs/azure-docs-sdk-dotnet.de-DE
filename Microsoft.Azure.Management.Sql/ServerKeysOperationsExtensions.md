<Type Name="ServerKeysOperationsExtensions" FullName="Microsoft.Azure.Management.Sql.ServerKeysOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für ServerKeysOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="keyName">
            Der Name des Schlüssels für Server verarbeitet werden sollen (aktualisiert oder erstellt wurde). Der Schlüsselname ist erforderlich, im Format "Vault_key_version" sein. Beispielsweise ist die KeyId https://YourVaultName.vault.azure.net/keys/YourKeyName/01234567890123456789012345678901, klicken Sie dann der Server-Schlüsselnamen formatiert werden sollen als: YourVaultName_YourKeyName_01234567890123456789012345678901
            </param>
        <param name="parameters">
            Der angeforderte Server Schlüsselressourcen-Zustand.
            </param>
        <summary>
            Erstellt oder aktualisiert ein Serverschlüssel.
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <param name="keyName">
            Der Name des Schlüssels für den Server gelöscht werden soll.
            </param>
        <summary>
            Löscht den Schlüssel des Servers mit dem angegebenen Namen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="keyName">
            Der Name des Schlüssels für Server abgerufen werden sollen.
            </param>
        <summary>
            Ruft ein Serverschlüssel.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByServer">
      ...
      <Docs>
        ...
        <summary>
            Ruft eine Liste der Serverschlüssel.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
