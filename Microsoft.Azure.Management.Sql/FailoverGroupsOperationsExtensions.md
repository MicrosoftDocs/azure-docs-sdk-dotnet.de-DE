<Type Name="FailoverGroupsOperationsExtensions" FullName="Microsoft.Azure.Management.Sql.FailoverGroupsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für FailoverGroupsOperations.
            </summary>
    ...
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="serverName">
            Der Name des Servers mit der Gruppe "Failover".
            </param>
        <param name="failoverGroupName">
            Der Name der Gruppe "Failover".
            </param>
        <param name="parameters">
            Die Parameter für den Failover-Gruppe.
            </param>
        <summary>
            Erstellt oder aktualisiert eine Failover-Gruppe.
            </summary>
