  ...
  <Members>
    ...
    <Member MemberName="CheckNameAvailabilityMethodAsync">
      ...
      <Docs>
        ...
        <param name="name">
            Der Name, überprüfen Sie die Verfügbarkeit der Namespace-Namen und den Namespacenamen können nur Buchstaben, Zahlen und Bindestriche enthalten. Der Namespace muss mit einem Buchstaben beginnen und mit einem Buchstaben oder einer Ziffer enden.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
    ...
    <Member MemberName="UpdateAsync">
      ...
      <Docs>
        ...
        <summary>
            Aktualisiert einen Dienstnamespace an. Nach der Erstellung ist das ressourcenmanifest des Namespaces unveränderlich. Dieser Vorgang ist Idempotent.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
