<Type Name="SearchIndexClient" FullName="Microsoft.Azure.Search.SearchIndexClient">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="searchServiceName">Erforderlich. Der Name des Azure-Suchdienst.</param>
        <param name="indexName">Erforderlich. Der Name der Azure Search-Index.</param>
        <param name="credentials">Erforderlich. Die Anmeldeinformationen zur Authentifizierung beim Azure-Suchdienst.
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="handlers">
            Optional. Der Satz von Handler zum Einfügen in die HTTP-Client-Pipeline delegieren.
            </param>
        <summary>
            Initialisiert eine neue Instanz der SearchIndexClient-Klasse.
            </summary>
