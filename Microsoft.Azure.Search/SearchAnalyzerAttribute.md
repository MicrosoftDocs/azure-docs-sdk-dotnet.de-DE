<Type Name="SearchAnalyzerAttribute" FullName="Microsoft.Azure.Search.SearchAnalyzerAttribute">
  ...
  <Docs>
    <summary>
            Gibt an, dass die <see cref="T:Microsoft.Azure.Search.Models.Field" /> von generierten <see cref="T:Microsoft.Azure.Search.FieldBuilder" /> für das Ziel aufweisen seine <see cref="P:Microsoft.Azure.Search.Models.Field.SearchAnalyzer" /> -Eigenschaft auf den angegebenen Analyzer festgelegt.
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="analyzerName">
            Der Name des Analyzers. Verwenden Sie einen Namen im <see cref="T:Microsoft.Azure.Search.Models.AnalyzerName.AsString" /> oder den Namen einer benutzerdefinierten Analyzer.
            </param>
        <summary>
            Gibt an, dass der angegebene Analyzer verwendet werden soll.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
