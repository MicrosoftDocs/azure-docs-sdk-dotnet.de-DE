<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="f6161-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="f6161-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="f6161-102">Die Gesamtheit der Netzwerk-IP-Konfiguration Schnittstellendefinition.</span><span class="sxs-lookup"><span data-stu-id="f6161-102">The entirety of the network interface IP configuration definition.</span></span>
            </summary>
