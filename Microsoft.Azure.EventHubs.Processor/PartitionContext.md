<Type Name="PartitionContext" FullName="Microsoft.Azure.EventHubs.Processor.PartitionContext">
  ...
  <Docs>
    <summary>
            Kapselt Informationen, die im Zusammenhang mit einer Event Hubs-Partition verwendeten <see cref="T:Microsoft.Azure.EventHubs.Processor.IEventProcessor" />.
            </summary>
  ...
  <Members>
    <Member MemberName="CheckpointAsync">
      ...
      <Docs>
        <summary>
            Schreibt den aktuellen Offset und SequenceNumber auf den Prüfpunkt Store über die Checkpoint-Manager.
            </summary>
    ...
    <Member MemberName="CheckpointAsync">
      ...
      <Docs>
        <param name="eventData">Eine empfangene EventData mit gültigen Offset und einer sequenceNumber</param>
        <summary>
            Speichert den Offset und SequenceNumber aus der angegebenen empfangenen EventData-Instanz, und klicken Sie dann diese Werte in den Prüfpunkt Store über die Checkpoint-Manager schreibt.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">Wenn EventData festgelegten null ist.</exception>
        <exception cref="T:System.ArgumentOutOfRangeException">Wenn die SequenceNumber kleiner als der letzte Wert des geprüften ist</exception>
      </Docs>
    </Member>
    <Member MemberName="ConsumerGroupName">
      ...
      <Docs>
        <summary>
            Ruft den Namen der Gruppe "Consumer".
            </summary>
    ...
    <Member MemberName="Owner">
      ...
      <Docs>
        <summary>
            Ruft den Host-Besitzer für die Partition ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RuntimeInformation">
      ...
      <Docs>
        <summary>
            ...
            Um die Einstellung zu aktivieren, finden Sie unter<see cref="P:Microsoft.Azure.EventHubs.Processor.EventProcessorOptions.EnableReceiverRuntimeMetric" /></summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            Stellt den Kontext der Partition in der folgenden format:"PartitionContext({EventHubPath}/{ConsumerGroupName}/{PartitionId}/{SequenceNumber})"
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
