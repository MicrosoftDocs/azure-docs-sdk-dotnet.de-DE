<Type Name="IUsagesOperations" FullName="Microsoft.Azure.Management.RecoveryServices.IUsagesOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="12065-101">UsagesOperations-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="12065-101">UsagesOperations operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListByVaultsWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="resourceGroupName">
            <span data-ttu-id="12065-102">Der Name der Ressourcengruppe, in dem die Recovery-Tresor Services, ist vorhanden.</span><span class="sxs-lookup"><span data-stu-id="12065-102">The name of the resource group where the recovery services vault is present.</span></span>
            </param>
        <param name="vaultName">
            <span data-ttu-id="12065-103">Der Name des Recovery Services-Tresor.</span><span class="sxs-lookup"><span data-stu-id="12065-103">The name of the recovery services vault.</span></span>
            </param>
        <param name="customHeaders">
            <span data-ttu-id="12065-104">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="12065-104">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="12065-105">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="12065-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="12065-106">Dadurch wird die Verwendung des Tresors.</span><span class="sxs-lookup"><span data-stu-id="12065-106">Fetches the usages of the vault.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
            <span data-ttu-id="12065-107">Wird ausgelöst, wenn der Vorgang einen ungültigen Statuscode zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="12065-107">Thrown when the operation returned an invalid status code</span></span>
            </exception>
        <exception cref="T:Microsoft.Rest.SerializationException">
            <span data-ttu-id="12065-108">Wird ausgelöst, wenn nicht die Antwort zu deserialisieren.</span><span class="sxs-lookup"><span data-stu-id="12065-108">Thrown when unable to deserialize the response</span></span>
            </exception>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="12065-109">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="12065-109">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
