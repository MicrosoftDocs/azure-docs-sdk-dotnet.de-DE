<Type Name="MultiShardDataReader" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardDataReader">
  ...
  <Members>
    ...
    <Member MemberName="ExecutionPolicy">
      ...
      <Docs>
        <summary>
            Ruft die Ausführungsrichtlinie, die zum Ausführen von Befehlen verwendet werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetSqlByte">
      ...
      <Docs>
        <param name="ordinal">Die nullbasierte Ordnungszahl der Spalte.</param>
        <summary>
            Ruft den Wert der angegebenen Spalte als ein Value ab.
            </summary>
    ...
    <Member MemberName="GetSqlChars">
      ...
      <Docs>
        ...
        <returns>Der Wert der Spalte als SqlChars zurück.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsDBNullAsync">
      ...
      <Docs>
        ...
        <returns>"True", wenn der Wert der angegebenen Spalte DBNull andernfalls "false" entspricht.</returns>
        <remarks />
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="ordinal">Die nullbasierte Ordnungszahl der Spalte.</param>
        <summary>
            Ruft den Wert der angegebenen Spalte im systemeigenen Format als eine Instanz des Objekts ab.
            </summary>
        <value>Der Wert der angegebenen Spalte.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
    ...
    <Member MemberName="MultiShardExceptions">
      ...
      <Docs>
        <summary>
            Ruft die Auflistung der Ausnahmen, die bei der Verarbeitung des Befehls über die Shards hinweg aufgetreten.
            Die Auflistung wird aufgefüllt, wenn <see cref="F:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardExecutionPolicy.PartialResults" /> als für den Befehl die Ausführungsrichtlinie ausgewählt ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadAsync">
      ...
      <Docs>
        ...
        <summary>
             Eine asynchrone Version der lesen, die die MultiShardDataReader auf den nächsten Datensatz wechselt.
    ...
    <Member MemberName="VisibleFieldCount">
      ...
      <Docs>
        <summary>
            Ruft die Anzahl der Felder in der MultiShardDataReader, die nicht ausgeblendet sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
