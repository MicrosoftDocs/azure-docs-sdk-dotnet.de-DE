<Type Name="ICNameRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.ICNameRecordSet">
  ...
  <Docs>
    <summary>
            Eine unveränderliche clientseitige Darstellung eines Datensatzes CNAME (kanonischer Name), die in Azure DNS-Zone festgelegt werden.
            </summary>
  ...
  <Members>
    <Member MemberName="CanonicalName">
      ...
      <Docs>
        <summary>
            Ruft den kanonischen Namen (ohne einen abschließenden Punkt) von den CName-Eintrag in diesen Datensatz ab.
            </summary>
