<Type Name="INSRecordSets" FullName="Microsoft.Azure.Management.Dns.Fluent.INSRecordSets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dffad-101">Einstiegspunkt für Namenservereintrag legt in einer Azure-DNS-Zone.</span><span class="sxs-lookup"><span data-stu-id="dffad-101">Entry point to NS record sets in an Azure DNS zone.</span></span>
            </summary>
