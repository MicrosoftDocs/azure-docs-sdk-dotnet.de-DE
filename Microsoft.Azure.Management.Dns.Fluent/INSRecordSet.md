<Type Name="INSRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.INSRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1707e-101">Eine unveränderliche clientseitige Darstellung ein Namenservereintrag (Namenserver), die in Azure DNS-Zone festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="1707e-101">An immutable client-side representation of an NS (name server) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="NameServers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1707e-102">Ruft die Namen Servernamen NS (Namenserver) Datensätze in diesen Datensatz ab.</span><span class="sxs-lookup"><span data-stu-id="1707e-102">Gets the name server names of NS (name server) records in this record set.</span></span>
            </summary>
