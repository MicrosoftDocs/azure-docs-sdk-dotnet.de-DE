  ...
  <Members>
    <Member MemberName="BeginCreateWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="resourceGroupName">
            Der Name der Ressource gruppieren, zu dem die Ressource gehört, oder erstellt
            </param>
    ...
    <Member MemberName="BeginUpdateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Die Parameter enthält den Eigenschaftswert und den Eigenschaftennamen, die beim Aktualisieren der Clusterkonfiguration verwendet
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
    ...
    <Member MemberName="GetWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Abrufen von Cluster-Ressourcen
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.ServiceFabric.Models.ErrorModelException">
    ...
    <Member MemberName="ListByResourceGroupNextWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Liste Ressource durch Clusterressourcengruppe
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
