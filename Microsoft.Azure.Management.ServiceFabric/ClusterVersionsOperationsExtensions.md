<Type Name="ClusterVersionsOperationsExtensions" FullName="Microsoft.Azure.Management.ServiceFabric.ClusterVersionsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für ClusterVersionsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <param name="location">
            Der Speicherort für die Cluster-Code-Versionen, unterscheidet sich dies von Cluster-Speicherort
            </param>
        <param name="environment">
            Cluster-Betriebssystem, der Standardwert bedeutet alle. Folgende Werte sind möglich: "Default", "Windows", "Linux"
            </param>
        <summary>
            Auflisten von Cluster Codeversionen nach Standort
            </summary>
