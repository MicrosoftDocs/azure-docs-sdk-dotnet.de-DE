<Type Name="DeleteShareSnapshotsOption" FullName="Microsoft.WindowsAzure.Storage.File.DeleteShareSnapshotsOption">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4709c-101">Vorgang zum Löschen des Satz von Optionen zu beschreiben.</span><span class="sxs-lookup"><span data-stu-id="4709c-101">The set of options describing delete operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="IncludeSnapshots">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4709c-102">Löschen Sie die Freigabe und die zugehörigen Momentaufnahmen.</span><span class="sxs-lookup"><span data-stu-id="4709c-102">Delete the share and its snapshots.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4709c-103">Löschen Sie nur die Freigabe ein.</span><span class="sxs-lookup"><span data-stu-id="4709c-103">Delete the share only.</span></span> <span data-ttu-id="4709c-104">Wenn die Freigabe über Momentaufnahmen verfügt, führt diese Option einen Fehler aus dem Dienst.</span><span class="sxs-lookup"><span data-stu-id="4709c-104">If the share has snapshots, this option will result in an error from the service.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
