<Type Name="JobBasePropertiesConstraints" FullName="Microsoft.Azure.Management.BatchAI.Models.JobBasePropertiesConstraints">
  ...
  <Docs>
    <summary>
            Einschränkungen, die dem Auftrag zugeordnet werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der JobBasePropertiesConstraints-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="maxWallClockTime">Max. Zeitpunkt, zu der Auftrag ausgeführt werden kann.</param>
        <summary>
            Initialisiert eine neue Instanz der JobBasePropertiesConstraints-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MaxWallClockTime">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest max Mal, wenn der Auftrag ausgeführt werden kann.
            </summary>
