  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="operation">Der Vorgangstyp.</param>
        <param name="resource">Der Ressourcentyp, auf dem der Vorgang ausgeführt wird.</param>
        <param name="description">Der angezeigte Name des Vorgangs</param>
        <summary>
            Initialisiert eine neue Instanz der OperationDisplay-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Vorgangstyp.
            </summary>
        <value>To be added.</value>
        <remarks>
            Zum Beispiel: Lesen, schreiben, löschen oder -ListKeys-Aktion
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Anzeigename des Ressourcenanbieters.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Ressourcentyp, auf dem der Vorgang ausgeführt wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
