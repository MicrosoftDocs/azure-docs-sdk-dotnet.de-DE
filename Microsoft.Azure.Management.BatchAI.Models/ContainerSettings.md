<Type Name="ContainerSettings" FullName="Microsoft.Azure.Management.BatchAI.Models.ContainerSettings">
  ...
  <Docs>
    <summary>
            Einstellungen für den Container heruntergeladen werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ContainerSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="imageSourceRegistry">Die Registrierung zum Herunterladen des Containers aus.</param>
        <summary>
            Initialisiert eine neue Instanz der ContainerSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ImageSourceRegistry">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Registrierung zum Herunterladen des Containers aus.
            </summary>
