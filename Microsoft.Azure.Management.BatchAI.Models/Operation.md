<Type Name="Operation" FullName="Microsoft.Azure.Management.BatchAI.Models.Operation">
  ...
  <Docs>
    <summary>
            Eine REST-API-Vorgang
            </summary>
    <remarks>
            Details eines REST-API-Vorgangs
            </remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">Das Objekt, das den Vorgang beschreibt.</param>
        <param name="origin">Der vorgesehene Executor des Vorgangs.</param>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Objekt, das den Vorgang beschreibt.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>
            Dies ist das Format {Anbieter} / {Resource} / {Operation}
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Origin">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den gewünschten Executor des Vorgangs.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
