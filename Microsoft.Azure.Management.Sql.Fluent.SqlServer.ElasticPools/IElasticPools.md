<Type Name="IElasticPools" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlServer.ElasticPools.IElasticPools">
  ...
  <Docs>
    <summary>
            Der Einstiegspunkt für ElasticPools auf dem SQL Server zugreifen.
            </summary>
  ...
  <Members>
    <Member MemberName="Define">
      ...
      <Docs>
        ...
        <summary>
            Erstellt einen neuen elastischen Pool in SQL Server.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt eine Stufe aus, um die Argumente des elastischen Pools angeben.</return>
      </Docs>
    </Member>
    <Member MemberName="Delete">
      ...
      <Docs>
        <param name="elasticPoolName">Der Name des elastischen Pools gelöscht.</param>
        <summary>
            Löschen Sie die angegebenen elastischen Pool auf dem Server.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="elasticPoolName">Der Name des elastischen Pools abgerufen.</param>
        <summary>
            Ruft einen bestimmten elastischen Pool ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt den elastischen Pool mit SQL Server zurück.</return>
      </Docs>
    </Member>
    <Member MemberName="List">
      ...
      <Docs>
        <summary>
            Gibt die elastische Pools für den Server zurück.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Liste der elastische Pools für den Server.</return>
      </Docs>
    </Member>
  </Members>
</Type>