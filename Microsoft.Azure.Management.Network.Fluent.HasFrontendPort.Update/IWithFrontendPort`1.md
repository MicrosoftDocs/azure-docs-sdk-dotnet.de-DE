<Type Name="IWithFrontendPort&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasFrontendPort.Update.IWithFrontendPort&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="1a307-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="1a307-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="1a307-102">Die Phase eines Updates an den Front-End-Port zulassen.</span><span class="sxs-lookup"><span data-stu-id="1a307-102">The stage of an update allowing to specify the frontend port.</span></span>
            </summary>
