<Type Name="AdlsFileAlreadyExistsException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsFileAlreadyExistsException">
  ...
  <Docs>
    <summary>
            Eine WebHDFS-Ausnahme ausgelöst, der angibt, die Datei oder der Ordner bereits vorhanden ist. Wird ausgelöst, wenn ein Antwortcode 403-Fehler (Unzulässige).
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AdlsFileAlreadyExistsException-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
