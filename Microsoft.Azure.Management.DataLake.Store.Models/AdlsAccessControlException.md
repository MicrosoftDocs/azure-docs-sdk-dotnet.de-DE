<Type Name="AdlsAccessControlException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsAccessControlException">
  ...
  <Docs>
    <summary>
            Eine WebHDFS-Ausnahme ausgelöst, der angibt, dass der Zugriff aufgrund unzureichender Berechtigungen verweigert wird. Wird ausgelöst, wenn ein Antwortcode 403-Fehler (Unzulässige).
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AdlsAccessControlException-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
