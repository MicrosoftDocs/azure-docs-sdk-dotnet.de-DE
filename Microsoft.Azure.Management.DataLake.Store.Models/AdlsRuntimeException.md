<Type Name="AdlsRuntimeException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsRuntimeException">
  ...
  <Docs>
    <summary>
            Eine WebHDFS-Ausnahme ausgelöst, wenn ein unerwarteter Fehler während eines Vorgangs auftritt. Wird ausgelöst, wenn ein Antwortcode Fehler 500 (Interner Serverfehler).
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AdlsRuntimeException-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
