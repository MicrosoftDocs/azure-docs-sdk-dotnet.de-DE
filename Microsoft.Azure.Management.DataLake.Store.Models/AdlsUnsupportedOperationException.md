<Type Name="AdlsUnsupportedOperationException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsUnsupportedOperationException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="26cd1-101">Eine WebHDFS-Ausnahme ausgelöst, der angibt, dass der angeforderte Vorgang nicht unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="26cd1-101">A WebHDFS exception thrown indicating that the requested operation is not supported.</span></span> <span data-ttu-id="26cd1-102">Wird ausgelöst, wenn Antwort Fehlercode 400 (Ungültige Anforderung).</span><span class="sxs-lookup"><span data-stu-id="26cd1-102">Thrown when a 400 error response code is returned (bad request).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="26cd1-103">Initialisiert eine neue Instanz der AdlsUnsupportedOperationException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="26cd1-103">Initializes a new instance of the AdlsUnsupportedOperationException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="javaClassName"><span data-ttu-id="26cd1-104">Das vollständige Paket Klassenname für die Ausnahme ausgelöst wird, z. B. "java.lang.IllegalArgumentException".</span><span class="sxs-lookup"><span data-stu-id="26cd1-104">the full class package name for the exception thrown, such as 'java.lang.IllegalArgumentException'.</span></span></param>
        <param name="message"><span data-ttu-id="26cd1-105">die die ausgelöste Ausnahme, z. B. zugeordnete Meldung ' Ungültiger Wert für Webhdfs-Parameter "Berechtigung":... ".</span><span class="sxs-lookup"><span data-stu-id="26cd1-105">the message associated with the exception that was thrown, such as 'Invalid value for webhdfs parameter "permission":...'.</span></span></param>
        <summary>
            <span data-ttu-id="26cd1-106">Initialisiert eine neue Instanz der AdlsUnsupportedOperationException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="26cd1-106">Initializes a new instance of the AdlsUnsupportedOperationException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
