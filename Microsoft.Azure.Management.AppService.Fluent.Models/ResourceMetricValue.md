<Type Name="ResourceMetricValue" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ResourceMetricValue">
  ...
  <Docs>
    <summary>
            Der Wert der ressourcenmetriken.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ResourceMetricValue-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timestamp">Timestamp-Wert.</param>
        <param name="average">Wert Durchschnitt.</param>
        <param name="minimum">Wert von Minimum.</param>
        <param name="maximum">Wert maximal.</param>
        <param name="total">Gesamtwert.</param>
        <param name="count">Count-Wert.</param>
    ...
    <Member MemberName="Average">
      ...
      <Docs>
        <summary>
            Ruft die durchschnittlichen Wert.
            </summary>
