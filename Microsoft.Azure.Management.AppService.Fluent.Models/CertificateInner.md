<Type Name="CertificateInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.CertificateInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d5b2d-101">SSL-Zertifikat für eine app.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-101">SSL certificate for an app.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-102">Initialisiert eine neue Instanz der CertificateInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-102">Initializes a new instance of the CertificateInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="CerBlob">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-103">Ruft ab oder legt ihn fest rohbytes der CER-Datei</span><span class="sxs-lookup"><span data-stu-id="d5b2d-103">Gets or sets raw bytes of .cer file</span></span>
            </summary>
    ...
    <Member MemberName="ExpirationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-104">Ruft das Zertifikat Expriration Datum.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-104">Gets certificate expriration date.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FriendlyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-105">Ruft die Anzeigenamen des Zertifikats ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-105">Gets friendly name of the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostingEnvironmentProfile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-106">Ruft die Spezifikation für die App Service-Umgebung für das Zertifikat zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-106">Gets specification for the App Service Environment to use for the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostNames">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-107">Ruft ab, oder legt ihn fest Hostnamen das Zertifikat gilt.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-107">Gets or sets host names the certificate applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IssueDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-108">Ruft das Zertifikatsproblem Datum ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-108">Gets certificate issue Date.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Issuer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-109">Ruft die Zertifikataussteller an.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-109">Gets certificate issuer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyVaultId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-110">Ruft ab oder legt ihn fest Key Vault Csm-Ressourcen-ID</span><span class="sxs-lookup"><span data-stu-id="d5b2d-110">Gets or sets key Vault Csm resource Id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyVaultSecretName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-111">Ruft ab, oder legt ihn fest Tresor geheimen Schlüsselnamen.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-111">Gets or sets key Vault secret name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyVaultSecretStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-112">Ruft den Status des Schlüsseltresors für den geheimen ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-112">Gets status of the Key Vault secret.</span></span> <span data-ttu-id="d5b2d-113">Folgende Werte sind möglich: "Initialisiert", "WaitingOnCertificateOrder", "Erfolgreich abgeschlossen", "CertificateOrderFailed", "OperationNotPermittedOnKeyVault", "AzureServiceUnauthorizedToAccessKeyVault", "KeyVaultDoesNotExist", " KeyVaultSecretDoesNotExist ", '" UnknownError "', 'ExternalPrivateKey', 'Unbekannt'</span><span class="sxs-lookup"><span data-stu-id="d5b2d-113">Possible values include: 'Initialized', 'WaitingOnCertificateOrder', 'Succeeded', 'CertificateOrderFailed', 'OperationNotPermittedOnKeyVault', 'AzureServiceUnauthorizedToAccessKeyVault', 'KeyVaultDoesNotExist', 'KeyVaultSecretDoesNotExist', 'UnknownError', 'ExternalPrivateKey', 'Unknown'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-114">Ruft ab, oder legt ihn fest Zertifikatskennwort.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-114">Gets or sets certificate password.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PfxBlob">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-115">Ruft ab, oder legt die Pfx-Blob fest.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-115">Gets or sets pfx blob.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicKeyHash">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-116">Ruft Hash für öffentliche Schlüssel ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-116">Gets public key hash.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SelfLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-117">Ruft die Self-Link.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-117">Gets self link.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerFarmId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-118">Ruft ab oder legt ihn fest des zugehörigen App Service-Plans, formatiert als Ressourcen-ID: "/ subscriptions/{subscriptionID}/resourceGroups/{groupName}/providers/Microsoft.Web/serverfarms/{appServicePlanName}".</span><span class="sxs-lookup"><span data-stu-id="d5b2d-118">Gets or sets resource ID of the associated App Service plan, formatted as: "/subscriptions/{subscriptionID}/resourceGroups/{groupName}/providers/Microsoft.Web/serverfarms/{appServicePlanName}".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SiteName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-119">Ruft die app-Namen ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-119">Gets app name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubjectName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-120">Ruft der Antragstellername des Zertifikats ab.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-120">Gets subject name of the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-121">Ruft die Zertifikatfingerabdruck an.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-121">Gets certificate thumbprint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Valid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5b2d-122">Ruft das Zertifikat ist gültig.</span><span class="sxs-lookup"><span data-stu-id="d5b2d-122">Gets is the certificate valid?.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
