<Type Name="BackupRequestInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.BackupRequestInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="650e3-101">Beschreibung des eine Sicherung in der gesucht werden soll.</span><span class="sxs-lookup"><span data-stu-id="650e3-101">Description of a backup which will be performed.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-102">Initialisiert eine neue Instanz der BackupRequestInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="650e3-102">Initializes a new instance of the BackupRequestInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BackupRequestName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-103">Ruft ab oder legt den Namen des Sicherungssatzes fest.</span><span class="sxs-lookup"><span data-stu-id="650e3-103">Gets or sets name of the backup.</span></span>
            </summary>
    ...
    <Member MemberName="BackupRequestType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-104">Ruft ab oder legt den Sicherungstyp.</span><span class="sxs-lookup"><span data-stu-id="650e3-104">Gets or sets type of the backup.</span></span> <span data-ttu-id="650e3-105">Folgende Werte sind möglich: "Default", "Klonen", "Verschieben"</span><span class="sxs-lookup"><span data-stu-id="650e3-105">Possible values include: 'Default', 'Clone', 'Relocation'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BackupSchedule">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-106">Ruft ab oder legt Zeitplan für die Sicherung fest, wenn sie in regelmäßigen Abständen ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="650e3-106">Gets or sets schedule for the backup if it is executed periodically.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Databases">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-107">Ruft ab, oder legt ihn fest in der Sicherung enthaltenen Datenbanken.</span><span class="sxs-lookup"><span data-stu-id="650e3-107">Gets or sets databases included in the backup.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-108">Ruft ab oder legt ihn fest "true", wenn Sie der Sicherungszeitplan aktiviert ist (muss enthalten in diesem Fall), "false", wenn Sie der Sicherungszeitplan deaktiviert werden soll.</span><span class="sxs-lookup"><span data-stu-id="650e3-108">Gets or sets true if the backup schedule is enabled (must be included in that case), false if the backup schedule should be disabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageAccountUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-109">Ruft ab oder legt die SAS-URL auf den Container fest.</span><span class="sxs-lookup"><span data-stu-id="650e3-109">Gets or sets SAS URL to the container.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="650e3-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="650e3-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="650e3-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="650e3-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
