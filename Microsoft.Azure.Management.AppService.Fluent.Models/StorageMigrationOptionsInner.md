<Type Name="StorageMigrationOptionsInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.StorageMigrationOptionsInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ff178-101">Optionen für die Migration von app-Inhalten.</span><span class="sxs-lookup"><span data-stu-id="ff178-101">Options for app content migration.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff178-102">Initialisiert eine neue Instanz der StorageMigrationOptionsInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ff178-102">Initializes a new instance of the StorageMigrationOptionsInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AzurefilesConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff178-103">Ruft ab oder legt migrieren Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="ff178-103">Gets or sets azureFiles connection string.</span></span>
            </summary>
    ...
    <Member MemberName="AzurefilesShare">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff178-104">Ruft ab, oder legt ihn fest migrieren freigeben.</span><span class="sxs-lookup"><span data-stu-id="ff178-104">Gets or sets azureFiles share.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BlockWriteAccessToSite">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff178-105">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn die app, nur während des Kopiervorgangs gelesen wurde, andernfalls werden soll &amp;Lt; Code&amp;Gt "false"&amp;Lt; /code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="ff178-105">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if the app should be read only during copy operation; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SwitchSiteAfterMigration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff178-106">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn die app soll, mehr ist, andernfalls umgeschaltet werden &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="ff178-106">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt;if the app should be switched over; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
