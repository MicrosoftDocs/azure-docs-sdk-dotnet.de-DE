<Type Name="CsmMoveResourceEnvelopeInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.CsmMoveResourceEnvelopeInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b1d76-101">Objekt mit einer Liste der Ressourcen, die verschoben werden müssen und die Ressourcengruppe, sollten sie in verschoben werden.</span><span class="sxs-lookup"><span data-stu-id="b1d76-101">Object with a list of the resources that need to be moved and the resource group they should be moved to.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b1d76-102">Initialisiert eine neue Instanz der CsmMoveResourceEnvelopeInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b1d76-102">Initializes a new instance of the CsmMoveResourceEnvelopeInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="b1d76-103">Initialisiert eine neue Instanz der CsmMoveResourceEnvelopeInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b1d76-103">Initializes a new instance of the CsmMoveResourceEnvelopeInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b1d76-104">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="b1d76-104">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b1d76-105">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="b1d76-105">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
