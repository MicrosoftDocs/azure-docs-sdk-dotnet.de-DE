<Type Name="VnetGatewayInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.VnetGatewayInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3a1d0-101">Der Vertrag für den Virtuellenetzwerk-Gateway.</span><span class="sxs-lookup"><span data-stu-id="3a1d0-101">The Virtual Network gateway contract.</span></span> <span data-ttu-id="3a1d0-102">Hiermit wird das Virtuellenetzwerk-Gateway-Zugriff auf die VPN-Clientpaket zu gewähren.</span><span class="sxs-lookup"><span data-stu-id="3a1d0-102">This is used to give the Virtual Network gateway access to the VPN package.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a1d0-103">Initialisiert eine neue Instanz der VnetGatewayInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3a1d0-103">Initializes a new instance of the VnetGatewayInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="VnetName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a1d0-104">Ruft ab oder legt den Namen des virtuellen Netzwerks fest.</span><span class="sxs-lookup"><span data-stu-id="3a1d0-104">Gets or sets the Virtual Network name.</span></span>
            </summary>
    ...
    <Member MemberName="VpnPackageUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a1d0-105">Ruft ab oder legt den URI, in denen das VPN-Paket heruntergeladen werden kann.</span><span class="sxs-lookup"><span data-stu-id="3a1d0-105">Gets or sets the URI where the VPN package can be downloaded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
