<Type Name="ErrorEntity" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ErrorEntity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="64abc-101">Text der Fehlerantwort zurückgegeben von der API.</span><span class="sxs-lookup"><span data-stu-id="64abc-101">Body of the error response returned from the API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-102">Initialisiert eine neue Instanz der ErrorEntity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="64abc-102">Initializes a new instance of the ErrorEntity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-103">Ermittelt oder definiert grundlegende Fehlercode.</span><span class="sxs-lookup"><span data-stu-id="64abc-103">Gets or sets basic error code.</span></span>
            </summary>
    ...
    <Member MemberName="ExtendedCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-104">Ruft ab oder legt ihn fest Fehler.</span><span class="sxs-lookup"><span data-stu-id="64abc-104">Gets or sets type of error.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InnerErrors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-105">Ruft ab oder legt den interne Fehlern.</span><span class="sxs-lookup"><span data-stu-id="64abc-105">Gets or sets inner errors.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-106">Ruft ab oder legt alle Details des Fehlers.</span><span class="sxs-lookup"><span data-stu-id="64abc-106">Gets or sets any details of the error.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MessageTemplate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-107">Ruft ab, oder legt ihn fest Nachrichtenvorlage.</span><span class="sxs-lookup"><span data-stu-id="64abc-107">Gets or sets message template.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="64abc-108">Ruft ab oder legt Parameter für die Vorlage fest.</span><span class="sxs-lookup"><span data-stu-id="64abc-108">Gets or sets parameters for the template.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
