<Type Name="DeletedSiteInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.DeletedSiteInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DeletedSiteInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="deletedTimestamp">Zeit in UTC, wann die app gelöscht wurde.</param>
        ...
        <param name="premiumAppDeployed">Gibt an, ob die app als Premium-app bereitgestellt wurde.</param>
        ...
        <param name="microService">Micro-Dienste wie z. B. apps, die Logik-apps.</param>
        <param name="gatewaySiteName">Name des Gateway-app, die der app zugeordnet haben.</param>
        ...
        <param name="outboundIpAddresses">Liste der IP-Adressen, die die app für ausgehende Verbindungen (z. B. Datenbankzugriff) verwendet.
    ...
    <Member MemberName="DeletedTimestamp">
      ...
      <Docs>
        <summary>
            Ruft Uhrzeit (UTC) ab, wenn die app gelöscht wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GatewaySiteName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Name des Gateway-app, die der app zugeordnet haben.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MicroService">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest micro-Dienste wie apps Logik-apps.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutboundIpAddresses">
      ...
      <Docs>
        <summary>
            Ruft die Liste der IP-Adressen, die die app für ausgehende Verbindungen (z. B. Datenbankzugriff) verwendet. Schreibgeschützt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PremiumAppDeployed">
      ...
      <Docs>
        <summary>
            Ruft gibt an, ob die app als Premium-app bereitgestellt wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
