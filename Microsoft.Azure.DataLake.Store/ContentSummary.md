<Type Name="ContentSummary" FullName="Microsoft.Azure.DataLake.Store.ContentSummary">
  ...
  <Docs>
    <summary>
            Kapselt Verzeichnisanzahl gesamt, Anzahl der Dateien, verbrauchte Speicherplatz
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="directoryCnt">Verzeichnisanzahl</param>
        <param name="fileCnt">Dateianzahl</param>
        <param name="length">Größe</param>
        <param name="spaceConsumed">Gesamtgröße</param>
        <summary>
            Erstellt die Instanz des contentsummary
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Length">
      ...
      <Docs>
        <summary>
            Größe der Auslagerungsdatei insgesamt
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SpaceConsumed">
      ...
      <Docs>
        <summary>
            Insgesamt belegten Speicherplatz
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
