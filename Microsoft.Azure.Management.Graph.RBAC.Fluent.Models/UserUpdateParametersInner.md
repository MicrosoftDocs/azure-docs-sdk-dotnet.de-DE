<Type Name="UserUpdateParametersInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.UserUpdateParametersInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b87d5-101">Anforderungsparameter für die Aktualisierung kein vorhandenes Geschäfts- oder Schul-Benutzerkonto.</span><span class="sxs-lookup"><span data-stu-id="b87d5-101">Request parameters for updating an existing work or school account user.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-102">Initialisiert eine neue Instanz der UserUpdateParametersInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b87d5-102">Initializes a new instance of the UserUpdateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AccountEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-103">Ruft ab oder legt fest, ob das Konto aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="b87d5-103">Gets or sets whether the account is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-104">Ruft ab oder legt den Anzeigenamen des Benutzers.</span><span class="sxs-lookup"><span data-stu-id="b87d5-104">Gets or sets the display name of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MailNickname">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-105">Ruft ab oder legt die e-Mail-Alias für den Benutzer.</span><span class="sxs-lookup"><span data-stu-id="b87d5-105">Gets or sets the mail alias for the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PasswordProfile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-106">Ruft ab oder legt das kennwortprofil des Benutzers fest.</span><span class="sxs-lookup"><span data-stu-id="b87d5-106">Gets or sets the password profile of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b87d5-107">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="b87d5-107">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b87d5-108">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="b87d5-108">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
