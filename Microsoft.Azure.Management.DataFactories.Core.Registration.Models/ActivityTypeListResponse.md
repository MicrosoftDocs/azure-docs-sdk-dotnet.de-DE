<Type Name="ActivityTypeListResponse" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ActivityTypeListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ac6af-101">Die Liste ActivityType Operation-Antwort.</span><span class="sxs-lookup"><span data-stu-id="ac6af-101">The List ActivityType operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ac6af-102">Initialisiert eine neue Instanz der ActivityTypeListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ac6af-102">Initializes a new instance of the ActivityTypeListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="ac6af-103">Initialisiert eine neue Instanz der ActivityTypeListResponse-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="ac6af-103">Initializes a new instance of the ActivityTypeListResponse class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivityTypes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ac6af-104">Optional.</span><span class="sxs-lookup"><span data-stu-id="ac6af-104">Optional.</span></span> <span data-ttu-id="ac6af-105">Alle Definitionen mit ActivityType für einen bestimmten RegistrationScope.</span><span class="sxs-lookup"><span data-stu-id="ac6af-105">All the ActivityType definitions for a particular RegistrationScope.</span></span>
            </summary>
    ...
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ac6af-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="ac6af-106">Required.</span></span> <span data-ttu-id="ac6af-107">Der Link (Url) auf die nächste Seite der Ergebnisse.</span><span class="sxs-lookup"><span data-stu-id="ac6af-107">The link (url) to the next page of results.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
