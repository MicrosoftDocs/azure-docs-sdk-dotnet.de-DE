<Type Name="ComputeTransport" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ComputeTransport">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="51d8b-101">Die Protokolldefinition für die Kommunikation mit einem ComputeType.</span><span class="sxs-lookup"><span data-stu-id="51d8b-101">The protocol definition for communication with a ComputeType.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="51d8b-102">Initialisiert eine neue Instanz der ComputeTransport-Klasse.</span><span class="sxs-lookup"><span data-stu-id="51d8b-102">Initializes a new instance of the ComputeTransport class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TransportProtocolVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="51d8b-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="51d8b-103">Optional.</span></span> <span data-ttu-id="51d8b-104">Die Version des das Transportprotokoll für die Kommunikation zwischen ADF und Proxydienst Ressource "Compute" des Benutzers.</span><span class="sxs-lookup"><span data-stu-id="51d8b-104">The version of the transport protocol for communication between ADF and the user's compute resource proxy service.</span></span>
            </summary>
