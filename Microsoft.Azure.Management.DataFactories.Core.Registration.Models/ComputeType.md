<Type Name="ComputeType" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ComputeType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1d891-101">Eine ComputeType ist ein benutzerdefiniertes Compute/verknüpften Dienst die registriert und verwendet, um die Pipeline Aktivitäten ausgeführt werden können.</span><span class="sxs-lookup"><span data-stu-id="1d891-101">A ComputeType is a user-defined Compute/Linked Service type which can be registered and used to run Pipeline activities.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d891-102">Initialisiert eine neue Instanz der ComputeType-Klasse.</span><span class="sxs-lookup"><span data-stu-id="1d891-102">Initializes a new instance of the ComputeType class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="1d891-103">Initialisiert eine neue Instanz der ComputeType-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="1d891-103">Initializes a new instance of the ComputeType class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d891-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="1d891-104">Required.</span></span> <span data-ttu-id="1d891-105">Typnamen zu berechnen.</span><span class="sxs-lookup"><span data-stu-id="1d891-105">Compute type name.</span></span>
            </summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d891-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="1d891-106">Required.</span></span> <span data-ttu-id="1d891-107">Typeigenschaften zu berechnen.</span><span class="sxs-lookup"><span data-stu-id="1d891-107">Compute type properties.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
