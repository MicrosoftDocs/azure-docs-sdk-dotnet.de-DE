<Type Name="CheckNameAvailabilityResponse" FullName="Microsoft.Azure.Management.NotificationHubs.Models.CheckNameAvailabilityResponse">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nameAvailable">Überprüft, ob der Name des Namespaces verfügbar ist.</param>
        <param name="reason">Gibt die Ursache, aufgrund, die Name des Namespaces nicht verfügbar ist</param>
        <param name="message">Die Nachricht wird zurückgegeben, wenn für die Verfügbarkeit des Namespacenamens überprüfen</param>
        <summary>
            Initialisiert eine neue Instanz der CheckNameAvailabilityResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Nachricht zurückgegeben, wenn für die Verfügbarkeit des Namespacenamens überprüfen
            </summary>
    ...
    <Member MemberName="NameAvailable">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt überprüft, wenn der Name des Namespaces verfügbar ist
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Reason">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Zustände die Ursache, aufgrund, die Name des Namespaces nicht verfügbar ist
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
