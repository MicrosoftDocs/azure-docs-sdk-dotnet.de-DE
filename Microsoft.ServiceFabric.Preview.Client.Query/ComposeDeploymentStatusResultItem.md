<Type Name="ComposeDeploymentStatusResultItem" FullName="Microsoft.ServiceFabric.Preview.Client.Query.ComposeDeploymentStatusResultItem">
  ...
  <Docs>
    <summary>
      <para>Beschreibt verfassen Status Ergebnis Bereitstellungselement die durch Bereitstellungsname, Anwendungsname, Bereitstellungsstatus verfassen und Statusdetails gekennzeichnet sind.</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="ComposeDeploymentStatus">
      ...
      <Docs>
        <summary>
          <para>Ruft den Status der Bereitstellung als Compose <see cref="P:Microsoft.ServiceFabric.Preview.Client.Query.ComposeDeploymentStatusResultItem.ComposeDeploymentStatus" />.</para>
        </summary>
        <value>
          <para>Der Status der Bereitstellung verfassen.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="StatusDetails">
      ...
      <Docs>
        <summary>
          <para>Ruft die Statusdetails verfassen Bereitstellung einschließlich der Fehlermeldung. </para>
        </summary>
        <value>
          <para>Die Statusdetails bilden, Bereitstellung, einschließlich der Fehlermeldung.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
