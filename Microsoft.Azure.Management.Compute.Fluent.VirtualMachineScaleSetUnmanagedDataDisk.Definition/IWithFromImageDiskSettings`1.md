<Type Name="IWithFromImageDiskSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetUnmanagedDataDisk.Definition.IWithFromImageDiskSettings&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="202a6-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="202a6-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="202a6-102">Die Stufe, die ermöglicht konfigurieren Sie den nicht verwalteten auf, die basierend auf einem Bild.</span><span class="sxs-lookup"><span data-stu-id="202a6-102">The stage that allows configure the unmanaged disk based on an image.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="202a6-103">der Datenträger, die caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="202a6-103">The disk caching type.</span></span> <span data-ttu-id="202a6-104">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite".</span><span class="sxs-lookup"><span data-stu-id="202a6-104">Possible values include: 'None', 'ReadOnly', 'ReadWrite'.</span></span></param>
        <summary>
            <span data-ttu-id="202a6-105">Gibt an, welche Zwischenspeichern für den nicht verwalteten Datenträger.</span><span class="sxs-lookup"><span data-stu-id="202a6-105">Specifies the caching type for the unmanaged data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="202a6-106">Die nächste Phase der Definition von nicht verwalteten Daten-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="202a6-106">The next stage of unmanaged data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithSizeInGB">
      ...
      <Docs>
        <param name="sizeInGB"><span data-ttu-id="202a6-107">Die Größe des Datenträgers in GB.</span><span class="sxs-lookup"><span data-stu-id="202a6-107">The disk size in GB.</span></span></param>
        <summary>
            <span data-ttu-id="202a6-108">Gibt die Größe in GB, die der nicht verwalteten Datenträger muss geändert werden.</span><span class="sxs-lookup"><span data-stu-id="202a6-108">Specifies the size in GB the unmanaged disk needs to be resized.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="202a6-109">Die nächste Phase der Definition von nicht verwalteten Daten-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="202a6-109">The next stage of unmanaged data disk definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>