<Type Name="AzureSearchIndexDataset" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f48e8-101">Ein Index in einem Azure Search-Dienst.</span><span class="sxs-lookup"><span data-stu-id="f48e8-101">An Index in an Azure Search service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f48e8-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexDataset" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f48e8-102">Initializes a new instance of the <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexDataset" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="f48e8-103">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexDataset" /> Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="f48e8-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexDataset" /> class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f48e8-104">Der Name der Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="f48e8-104">The name of the Azure Search Index.</span></span>
            </summary>
