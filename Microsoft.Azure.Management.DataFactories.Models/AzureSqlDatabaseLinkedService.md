<Type Name="AzureSqlDatabaseLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSqlDatabaseLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="99819-101">Windows Azure SQL-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="99819-101">Windows Azure SQL database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99819-102">Initialisiert eine neue Instanz der AzureSqlLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="99819-102">Initializes a new instance of the AzureSqlLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="99819-103">Initialisiert eine neue Instanz der AzureSqlLinkedService-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="99819-103">Initializes a new instance of the AzureSqlLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99819-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="99819-104">Required.</span></span> <span data-ttu-id="99819-105">Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="99819-105">The connection string.</span></span>
            </summary>
