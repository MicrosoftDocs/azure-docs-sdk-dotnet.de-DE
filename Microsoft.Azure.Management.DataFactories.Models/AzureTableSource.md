<Type Name="AzureTableSource" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureTableSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d6eb5-101">Ein Azure-Tabelle als Quelle kopieren Aktivität.</span><span class="sxs-lookup"><span data-stu-id="d6eb5-101">A copy activity Azure table source.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="AzureTableSourceIgnoreTableNotFound">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6eb5-102">Azure-Tabelle als Quelle ignorieren Tabelle wurde nicht gefunden.</span><span class="sxs-lookup"><span data-stu-id="d6eb5-102">Azure table source ignore table not found.</span></span>
            </summary>
    ...
    <Member MemberName="AzureTableSourceQuery">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6eb5-103">Quellabfrage Azure-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="d6eb5-103">Azure table source query.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
