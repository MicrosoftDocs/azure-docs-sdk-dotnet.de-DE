<Type Name="SqlDWSink" FullName="Microsoft.Azure.Management.DataFactories.Models.SqlDWSink">
  ...
  <Docs>
    <summary>
            Eine kopieren-Aktivität für die SQL Data warehouse-Senke.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SqlDWSink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            Initialisiert eine neue Instanz der SqlDWSink-Klasse mit erforderlichen Argumenten.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AllowPolyBase">
      ...
      <Docs>
        <summary>
            Optional. Bei "true", verwenden Sie PolyBase, um die Daten an SQL Data Warehouse kopiert, wenn alle folgenden Kriterien erfüllt sind:
            1. Quelle verknüpfte Dienst muss <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureStorageLinkedService" />.
            2. Quell-Dataset muss <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureBlobDataset" />.
            3. Format des Quell-Dataset muss <see cref="T:Microsoft.Azure.Management.DataFactories.Models.TextFormat" />.
            5. EncodingName des Quell-Dataset-Format muss "Utf-8".
            6. RowDelimiter des Quell-Dataset-Format muss "\n".
            7. NullValue des Quell-Dataset-Format muss <see cref="F:System.String.Empty" />.
            8. Die Komprimierung von Quell-Dataset unterstützt nur <see cref="T:Microsoft.Azure.Management.DataFactories.Models.GZipCompression" /> und <see cref="T:Microsoft.Azure.Management.DataFactories.Models.DeflateCompression" />.
            9. Quelle muss <see cref="T:Microsoft.Azure.Management.DataFactories.Models.BlobSource" />.
    ...
    <Member MemberName="PolyBaseSettings">
      ...
      <Docs>
        <summary>
            Optional. Gibt PolyBase-bezogenen Einstellungen, wenn AllowPolyBase "true" ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
