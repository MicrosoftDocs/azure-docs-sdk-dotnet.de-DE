<Type Name="AzureSearchIndexSink" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexSink">
  ...
  <Docs>
    <summary>
            Eine kopieren-Aktivität eine Ereignissenke für einen Azure Search-Index.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            Optional. Gibt an, wie für Upsert-Dokumenten in einen Azure Search-Index.
            Muss einer der <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexWriteBehavior" />. Der Standardwert ist "Merge", wenn kein Wert angegeben wird.
            </summary>
