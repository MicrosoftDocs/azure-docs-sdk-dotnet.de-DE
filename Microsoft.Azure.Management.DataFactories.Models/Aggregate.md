<Type Name="Aggregate" FullName="Microsoft.Azure.Management.DataFactories.Models.Aggregate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="73a62-101">Der aggregierte Parameter mit der Count-Wert für das Objekt.</span><span class="sxs-lookup"><span data-stu-id="73a62-101">The aggregated parameter with the count value for it.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="73a62-102">Initialisiert eine neue Instanz der Aggregatklasse an.</span><span class="sxs-lookup"><span data-stu-id="73a62-102">Initializes a new instance of the Aggregate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="73a62-103">Initialisiert eine neue Instanz der Aggregatklasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="73a62-103">Initializes a new instance of the Aggregate class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="73a62-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="73a62-104">Required.</span></span> <span data-ttu-id="73a62-105">Der aggregierte Wert.</span><span class="sxs-lookup"><span data-stu-id="73a62-105">The aggregated value.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="73a62-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="73a62-106">Required.</span></span> <span data-ttu-id="73a62-107">Aktivität Fenster den Wert des Parameters, dem das Count-aggregate angehört.</span><span class="sxs-lookup"><span data-stu-id="73a62-107">The activity window parameter's value that the aggregate count belongs to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
