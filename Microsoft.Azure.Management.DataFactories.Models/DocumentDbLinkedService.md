<Type Name="DocumentDbLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.DocumentDbLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="da09d-101">Windows Azure-Dokumentdatenbank.</span><span class="sxs-lookup"><span data-stu-id="da09d-101">Windows Azure Document Database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="da09d-102">Initialisiert eine neue Instanz der Klasse "documentdblinkedservice".</span><span class="sxs-lookup"><span data-stu-id="da09d-102">Initializes a new instance of the DocumentDbLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="da09d-103">Initialisiert eine neue Instanz der Klasse "documentdblinkedservice" mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="da09d-103">Initializes a new instance of the DocumentDbLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="da09d-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="da09d-104">Required.</span></span> <span data-ttu-id="da09d-105">Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="da09d-105">The connection string.</span></span>
            </summary>
