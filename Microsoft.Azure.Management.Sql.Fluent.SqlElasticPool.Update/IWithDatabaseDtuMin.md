<Type Name="IWithDatabaseDtuMin" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Update.IWithDatabaseDtuMin">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="587ba-101">Die Definition der elastischen Pool für SQL die minimale DTU für die Datenbank festlegen.</span><span class="sxs-lookup"><span data-stu-id="587ba-101">The SQL Elastic Pool definition to set the minimum DTU for database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDatabaseDtuMin">
      ...
      <Docs>
        <param name="databaseDtuMin"><span data-ttu-id="587ba-102">Minimale DTU für alle SQL Azure-Datenbanken.</span><span class="sxs-lookup"><span data-stu-id="587ba-102">Minimum DTU for all SQL Azure databases.</span></span></param>
        <summary>
            <span data-ttu-id="587ba-103">Legt die minimale DTU, die alle SQL Azure-Datenbanken garantiert werden kann.</span><span class="sxs-lookup"><span data-stu-id="587ba-103">Sets the minimum DTU all SQL Azure Databases are guaranteed.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="587ba-104">Die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="587ba-104">The next stage of definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>