<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bf9ff-101">Die Vorlage für einen Aktualisierungsvorgang SQLElasticPool, mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="bf9ff-101">The template for a SQLElasticPool update operation, containing all the settings that can be modified.</span></span>
            </summary>
