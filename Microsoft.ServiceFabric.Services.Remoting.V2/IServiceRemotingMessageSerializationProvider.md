<Type Name="IServiceRemotingMessageSerializationProvider" FullName="Microsoft.ServiceFabric.Services.Remoting.V2.IServiceRemotingMessageSerializationProvider">
  ...
  <Docs>
    <summary>
            Definiert die Schnittstelle, die für das Bereitstellen von benutzerdefinierten Serialisierung für die Anforderung Remoting implementiert werden muss.
            </summary>
  ...
  <Members>
    <Member MemberName="CreateMessageBodyFactory">
      ...
      <Docs>
        <summary>
            Erstellen Sie eine IServiceRemotingMessageBodyFactory zum Erstellen von Anforderung und den Antworttext, Remoting verwendet.
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreateRequestMessageSerializer">
      ...
      <Docs>
        ...
        <summary>
            IServiceRemotingRequestMessageBodySerializer erstellt für eine ServiceInterface.
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreateResponseMessageSerializer">
      ...
      <Docs>
        ...
        <summary>
             IServiceRemotingResponseMessageBodySerializer erstellt für eine ServiceInterface.
             </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
