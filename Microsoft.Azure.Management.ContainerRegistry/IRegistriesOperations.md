  ...
  <Members>
    ...
    <Member MemberName="CheckNameAvailabilityWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Überprüft, ob der Containername für die Registrierung für die Verwendung verfügbar ist.
            Der Name darf nur alphanumerische Zeichen, global eindeutig sein, und zwischen 5 und 50 Zeichen lang sein.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
