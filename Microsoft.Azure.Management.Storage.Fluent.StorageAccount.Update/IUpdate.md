<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fc1c3-101">Die Vorlage für eine Speicher-Konto-Updatevorgang, enthält alle Einstellungen, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="fc1c3-101">The template for a storage account update operation, containing all the settings that can be modified.</span></span>
            </summary>
