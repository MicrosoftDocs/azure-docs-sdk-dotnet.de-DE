<Type Name="AmqpTransportSettings" FullName="Microsoft.ServiceBus.Messaging.Amqp.AmqpTransportSettings">
  ...
  <Interfaces />
  <Docs>
    <summary>Stellt für das Advanced Message Queuing Protocol-Transport dar.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Messaging.Amqp.AmqpTransportSettings" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BatchFlushInterval">
      ...
      <Docs>
        <summary>Ruft ab, oder legt ihn fest batchleerungsintervall, der dem Transport zugeordnet.</summary>
        <value>Die batchleerungsintervall dem Transport zugeordnet ist.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="EnableLinkRedirect">
      ...
      <Docs>
        <summary> Ruft ab oder legt einen Wert, der angibt, ob dieser Transport an die Back-End-Server-umgeleitet werden kann. </summary>
        <value> "true", wenn dieser Transport Umleitung, die vom Server zugelassen teilnehmen möchte. </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MaxFrameSize">
      ...
      <Docs>
        <summary>Ruft ab oder legt die maximale Größe fest.</summary>
        <value>Die maximale Größe.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UseSslStreamSecurity">
      ...
      <Docs>
        <summary>Ruft einen Wert, der angibt, ob die SSL-Datenstroms ein benutzerdefiniertes Bindungselement verwendet.</summary>
        <value>"true", wenn die SSL-Datenstroms ein benutzerdefiniertes Bindungselement verwendet; andernfalls "false".</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
