<Type Name="IDomainLegalAgreement" FullName="Microsoft.Azure.Management.AppService.Fluent.IDomainLegalAgreement">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1d52e-101">Eine unveränderliche clientseitige Darstellung einer Azure-Domäne rechtsgültigen Vertrag.</span><span class="sxs-lookup"><span data-stu-id="1d52e-101">An immutable client-side representation of an Azure domain legal agreement.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="1d52e-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="1d52e-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="AgreementKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d52e-103">Ruft den eindeutigen Bezeichner für den Vertrag ab.</span><span class="sxs-lookup"><span data-stu-id="1d52e-103">Gets unique identifier for the agreement.</span></span>
            </summary>
    ...
    <Member MemberName="Content">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d52e-104">Ruft die Vertragsdetails ab.</span><span class="sxs-lookup"><span data-stu-id="1d52e-104">Gets agreement details.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Title">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d52e-105">Ruft Vereinbarung Titel ab.</span><span class="sxs-lookup"><span data-stu-id="1d52e-105">Gets agreement title.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1d52e-106">Ruft Url ab, in dem eine Kopie der Vertragsdetails gehostet wird.</span><span class="sxs-lookup"><span data-stu-id="1d52e-106">Gets url where a copy of the agreement details is hosted.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
