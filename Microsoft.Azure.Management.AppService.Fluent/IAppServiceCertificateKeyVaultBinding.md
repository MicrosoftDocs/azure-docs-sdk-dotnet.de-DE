<Type Name="IAppServiceCertificateKeyVaultBinding" FullName="Microsoft.Azure.Management.AppService.Fluent.IAppServiceCertificateKeyVaultBinding">
  ...
  <Docs>
    <summary>
            Eine unveränderliche clientseitige Darstellung einer Azure App Service-Key Vault-Bindung.
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="KeyVaultId">
      ...
      <Docs>
        <summary>
            Ruft die schlüsseltresor-Ressourcen-ID
            </summary>
    ...
    <Member MemberName="KeyVaultSecretName">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Key Vault-geheimen Schlüssels ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Ruft den Status des Schlüsseltresors für den geheimen ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
