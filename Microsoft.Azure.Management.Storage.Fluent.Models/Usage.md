<Type Name="Usage" FullName="Microsoft.Azure.Management.Storage.Fluent.Models.Usage">
  ...
  <Docs>
    <summary>
            Beschreibt die Ressourcenverwendung für Speicher.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="unit">Ruft die Maßeinheit ab. Folgende Werte sind möglich: "Count", "Byte", "Sekunden", "Prozent", "CountsPerSecond", "BytesPerSecond"</param>
        <param name="currentValue">Ruft die aktuelle Anzahl der zugeordneten Ressourcen im Abonnement.</param>
        <param name="limit">Ruft die maximale Anzahl der Ressourcen, die im Abonnement zugeordnet werden kann.</param>
        <param name="name">Ruft den Namen des Typs der Nutzung ab.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Verwendung an.
            </summary>
        <remarks>To be added.</remarks>
