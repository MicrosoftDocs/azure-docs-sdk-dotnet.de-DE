<Type Name="IRedisCache" FullName="Microsoft.Azure.Management.Redis.Fluent.IRedisCache">
  ...
  <Docs>
    <summary>
            Eine unveränderliche clientseitige Darstellung eines Azure-Redis-Cache.
            </summary>
  ...
  <Members>
    <Member MemberName="AsPremium">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>Macht die Funktionen, die nur für Premium Sku-Redis-Cache-Instanzen verfügbar.</return>
      </Docs>
    </Member>
    <Member MemberName="GetKeys">
      ...
      <Docs>
        <summary>
            Ruft einen Redis Cache-Zugriffsschlüssel ab. Dieser Vorgang erfordert, über die Schreibberechtigung für die Cache-Ressource.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPremium">
      ...
      <Docs>
        <summary>
            Ruft "Wahr" zurückgegeben, wenn aktuelle Redis-Cache-Instanz Premium Sku aufweist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NonSslPort">
      ...
      <Docs>
        <summary>
            Ruft "true", wenn nicht SSL-Port aktiviert, andernfalls false ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RedisConfiguration">
      ...
      <Docs>
        <summary>
            Ruft den Wert der Redis-Konfiguration.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RedisVersion">
      ...
      <Docs>
        <summary>
            Ruft den Wert der Redis-Version.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RefreshKeys">
      ...
      <Docs>
        <summary>
            Rufen Sie die auf dem neuesten Stand Zugriffsschlüssel für Redis-Cache von Azure ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Der Zugriffsschlüssel für Redis-Cache.</return>
      </Docs>
    </Member>
    <Member MemberName="RegenerateKey">
      ...
      <Docs>
        <param name="keyType">Schlüsseltyp erneut generiert.</param>
        <summary>
            Generiert die Zugriffsschlüssel für Redis-Cache.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Die generierten Zugriffsschlüssel für Redis-Cache.</return>
      </Docs>
    </Member>
