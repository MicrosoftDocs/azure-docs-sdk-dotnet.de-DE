<Type Name="JobResource" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.JobResource">
  ...
  <Docs>
    <summary>
            Die Ressourcen für den Data Lake Analytics-Auftrag.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="resourcePath">der Pfad zur Ressource.</param>
        <param name="type">der Ressourcentyp des Auftrags. Folgende Werte sind möglich: "VertexResource", "JobManagerResource", "StatisticsResource", "VertexResourceInUserFolder", "JobManagerResourceInUserFolder", "StatisticsResourceInUserFolder"</param>
        <summary>
            Initialisiert eine neue Instanz der JobResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ResourcePath">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pfad für die Ressource fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die migrationsauftragart "Ressource". Folgende Werte sind möglich: "VertexResource", "JobManagerResource", "StatisticsResource", "VertexResourceInUserFolder", "JobManagerResourceInUserFolder", "StatisticsResourceInUserFolder"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
