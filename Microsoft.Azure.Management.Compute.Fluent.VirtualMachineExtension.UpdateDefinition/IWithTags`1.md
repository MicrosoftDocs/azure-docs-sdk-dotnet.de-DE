<Type Name="IWithTags&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithTags&lt;ParentT&gt;">
  ...
  <Docs>
    ...
    <summary>
            Die Phase der Definition des VM-Erweiterung an den RFID-Transponder zulassen.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WithTags">
      ...
      <Docs>
        <param name="tags">RFID-Transponder, die Ressource zugeordnet werden soll.</param>
        <summary>
            Gibt Tags für die Ressource an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
