<Type Name="IWithType&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithType&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="bfeff-101">Die Phase des übergeordneten Updates wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="bfeff-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="bfeff-102">Die Phase der Definition des VM-Erweiterung zur Angabe des Image des virtuellen Computers-Erweiterung ermöglicht diese Erweiterung basiert.</span><span class="sxs-lookup"><span data-stu-id="bfeff-102">The stage of the virtual machine extension definition allowing to specify the type of the virtual machine extension image this extension is based on.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithType">
      ...
      <Docs>
        <param name="extensionImageTypeName"><span data-ttu-id="bfeff-103">Der Name des Bilds.</span><span class="sxs-lookup"><span data-stu-id="bfeff-103">The image type name.</span></span></param>
        <summary>
            <span data-ttu-id="bfeff-104">Gibt den Typ der Erweiterung-Image des virtuellen Computers.</span><span class="sxs-lookup"><span data-stu-id="bfeff-104">Specifies the type of the virtual machine extension image.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="bfeff-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="bfeff-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>