<Type Name="UploadDirectoryOptions" FullName="Microsoft.WindowsAzure.Storage.DataMovement.UploadDirectoryOptions">
  ...
  <Docs>
    <summary>
            Stellt eine Reihe von Optionen, die für den Upload Verzeichnisoperation angegeben werden können
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="BlobType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Ziel-Blob. Diese Option wird wirksam, nur, wenn Sie in den Azure-Blob-Speicher hochladen.
            Wenn der Blob-Typ nicht angegeben ist, wird die Datensicherungsdateien verwendet.
            </summary>
    ...
    <Member MemberName="FollowSymlink">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob Symlinked Verzeichnisse folgen. Diese Option funktioniert nur in Unix/Linux-Plattformen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
