<Type Name="TransferSkippedException" FullName="Microsoft.WindowsAzure.Storage.DataMovement.TransferSkippedException">
  ...
  <Docs>
    <summary>
            Ausnahmen ausgelöst, wenn die Übertragung überspringt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.WindowsAzure.Storage.DataMovement.TransferSkippedException" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="errorMessage">Die Meldung, in der der Fehler beschrieben wird.</param>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.WindowsAzure.Storage.DataMovement.TransferSkippedException" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="errorMessage">Ausnahmemeldung.</param>
