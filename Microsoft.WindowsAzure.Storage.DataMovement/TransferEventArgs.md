<Type Name="TransferEventArgs" FullName="Microsoft.WindowsAzure.Storage.DataMovement.TransferEventArgs">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="source">Instanz-Darstellung der Übertragung Quellspeicherort.</param>
        <param name="destination">Instanz-Darstellung der Zielspeicherort für die Übertragung.</param>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.WindowsAzure.Storage.DataMovement.TransferEventArgs" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Destination">
      ...
      <Docs>
        <summary>
            Ruft die Instanz-Darstellung der Übertragung ab, das Zielspeicherort.
            </summary>
    ...
    <Member MemberName="Exception">
      ...
      <Docs>
        <summary>
            Ruft die Ausnahme ab, wenn die Übertragung ist fehlgeschlagen, oder null, wenn die Übertragung erfolgreich ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Source">
      ...
      <Docs>
        <summary>
            Ruft die Instanz-Darstellung der Übertragung Quellspeicherort ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
