<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityRule.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="1251f-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="1251f-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="1251f-102">Die Gesamtheit der Netzwerk-Sicherheitsgruppen-Regeldefinition.</span><span class="sxs-lookup"><span data-stu-id="1251f-102">The entirety of a network security rule definition.</span></span>
            </summary>
