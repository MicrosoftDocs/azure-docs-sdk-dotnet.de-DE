<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityRule.Definition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="32b0a-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="32b0a-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="32b0a-102">Die erste Phase des eine sicherheitsregeldefinition.</span><span class="sxs-lookup"><span data-stu-id="32b0a-102">The first stage of a security rule definition.</span></span>
            </summary>
