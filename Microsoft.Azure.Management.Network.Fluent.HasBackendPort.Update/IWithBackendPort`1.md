<Type Name="IWithBackendPort&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasBackendPort.Update.IWithBackendPort&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="2fb66-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="2fb66-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="2fb66-102">Die Phase eines Updates zulassen an um den Back-End-Port zu ändern.</span><span class="sxs-lookup"><span data-stu-id="2fb66-102">The stage of an update allowing to modify the backend port.</span></span>
            </summary>
