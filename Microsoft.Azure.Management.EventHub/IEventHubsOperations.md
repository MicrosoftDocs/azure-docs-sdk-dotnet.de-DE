<Type Name="IEventHubsOperations" FullName="Microsoft.Azure.Management.EventHub.IEventHubsOperations">
  ...
  <Members>
    ...
    <Member MemberName="CreateOrUpdateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Parameter zum Erstellen einer Event Hub-Ressource angegeben.
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
        ...
        <summary>
            Erstellt oder aktualisiert einen neuen Event Hub als eine geschachtelte Ressource in einem Namespace.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
    ...
    <Member MemberName="DeleteAuthorizationRuleWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Löscht einen Event Hub-AuthorizationRule an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
    ...
    <Member MemberName="DeleteWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Löscht einen Event Hub aus der angegebenen Namespace und der Gruppe an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
    ...
    <Member MemberName="GetWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Ruft eine Beschreibung des Event Hubs für den angegebenen Event Hub ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
    ...
    <Member MemberName="ListByNamespaceNextWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Ruft alle Event Hubs in einem Namespace.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
    ...
    <Member MemberName="RegenerateKeysWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Parameter, die zum erneuten Generieren der AuthorizationRule-Schlüssel (PrimaryKey/SecondaryKey) angegeben werden.
            </param>
        <param name="customHeaders">
            Die Header, die hinzugefügt werden auf Anforderung.
            </param>
        ...
        <summary>
            Generiert einen neuen ACS und SAS-Verbindungszeichenfolgen für den Event Hub.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Azure.Management.EventHub.Models.ErrorResponseException">
