<Type Name="PigJobSubmissionParameters" FullName="Microsoft.Azure.Management.HDInsight.Job.Models.PigJobSubmissionParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a8fb0-101">Parameter, die die Definition der HDInsight-Pig-Auftrag angeben.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-101">Parameters specifying the HDInsight Pig job definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-102">Initialisiert eine neue Instanz der PigJobSubmissionParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-102">Initializes a new instance of the PigJobSubmissionParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Arguments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-103">Optional.</span></span> <span data-ttu-id="a8fb0-104">Ruft die Argumente für die JobDetails ab.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-104">Gets the arguments for the jobDetails.</span></span>
            </summary>
    ...
    <Member MemberName="File">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-105">Optional.</span></span> <span data-ttu-id="a8fb0-106">Ermittelt oder definiert die Abfragedatei auf Pig-Auftrag verwenden.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-106">Gets or sets the query file to use for a Pig job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Files">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-107">Optional.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-107">Optional.</span></span> <span data-ttu-id="a8fb0-108">Abrufen oder Festlegen der Dateien auf dem Cluster kopiert werden sollen.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-108">Gets or sets the files to be copied to the cluster.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-109">Optional.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-109">Optional.</span></span> <span data-ttu-id="a8fb0-110">Ruft ab oder legt die Abfrage für ein Pig-Auftrags verwendet.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-110">Gets or sets the query to use for a Pig job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StatusDir">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8fb0-111">Optional.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-111">Optional.</span></span> <span data-ttu-id="a8fb0-112">Status-Verzeichnis, in dem standardspeicherkonto zum Speichern von Auftrag Dateien "stderr", "stdout" und beenden.</span><span class="sxs-lookup"><span data-stu-id="a8fb0-112">Status directory in the default storage account to store job files stderr, stdout and exit.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
