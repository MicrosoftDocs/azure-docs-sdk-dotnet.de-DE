<Type Name="IWithCreateAndApplication" FullName="Microsoft.Azure.Management.Batch.Fluent.BatchAccount.Definition.IWithCreateAndApplication">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="19618-101">Die Phase der Definition eines Batch-Konto ermöglicht das Hinzufügen einer Batch-Anwendung oder der Batch-Konto erstellen.</span><span class="sxs-lookup"><span data-stu-id="19618-101">The stage of a Batch account definition allowing the adding of a Batch application or creating the Batch account.</span></span>
            </summary>
