<Type Name="IKey" FullName="Microsoft.Azure.KeyVault.Core.IKey">
  ...
  <Docs>
    <summary>
            Eine Schnittstelle für Schlüssel
            </summary>
  ...
  <Members>
    <Member MemberName="DecryptAsync">
      ...
      <Docs>
        <param name="ciphertext">Der Verschlüsselungstext entschlüsselt</param>
        <param name="iv">Der Initialisierungsvektor</param>
        <param name="authenticationData">Die Authentifizierungsdaten</param>
        <param name="authenticationTag">To be added.</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Entschlüsselt den angegebenen Verschlüsselungstext.
            </summary>
        <returns>Nur-text</returns>
        <remarks>Wenn kein Algorithmus angegeben ist, sollte eine Implementierung der Standardalgorithmus verwenden.
            Nicht alle Algorithmen erfordern oder alle Parameter zu unterstützen.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultEncryptionAlgorithm">
      ...
      <Docs>
        <summary>
            Der standardmäßige Verschlüsselungsalgorithmus für diesen Schlüssel
            </summary>
    ...
    <Member MemberName="DefaultKeyWrapAlgorithm">
      ...
      <Docs>
        <summary>
            Der Standardschlüssel wrap-Algorithmus für diesen Schlüssel
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultSignatureAlgorithm">
      ...
      <Docs>
        <summary>
            Der Standardalgorithmus für die Signatur für diesen Schlüssel
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EncryptAsync">
      ...
      <Docs>
        <param name="plaintext">Der Klartext verschlüsselt</param>
        <param name="iv">Der Initialisierungsvektor</param>
        <param name="authenticationData">Die Authentifizierungsdaten</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Verschlüsselt den angegebenen nur-Text.
            </summary>
        <returns>Ein Tupel bestehend aus verschlüsseltem Text, der authentifizierungstag (falls zutreffend), der verwendete Algorithmus</returns>
        <remarks>Wenn der Algorithmus nicht angegeben wird, sollte eine Implementierung der Standardalgorithmus verwenden.
            Nicht alle Algorithyms erfordern oder alle Parameter zu unterstützen.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="SignAsync">
      ...
      <Docs>
        <param name="digest">Der Digest anmelden</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Registriert den angegebenen Hashwert.
            </summary>
        <returns>Ein Tupel bestehend aus der Signatur und den verwendeten Algorithmus</returns>
        <remarks>Wenn der Algorithmus nicht angegeben wird, sollte eine Implementierung der Standardalgorithmus verwenden.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UnwrapKeyAsync">
      ...
      <Docs>
        <param name="encryptedKey">Das verschlüsselte Schlüsselmaterial</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Entschlüsselt den angegebenen Schlüsselmaterials.
            </summary>
        <returns>Das entschlüsselte Schlüsselmaterial</returns>
        <remarks>Wenn der Algorithmus nicht angegeben wird, sollte eine Implementierung der Standardalgorithmus verwenden.</remarks>
      </Docs>
    </Member>
    <Member MemberName="VerifyAsync">
      ...
      <Docs>
        <param name="digest">Der digest</param>
        <param name="signature">der Wert der Signatur</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Überprüft den Wert der angegebenen Signatur
            </summary>
        <returns>Einen booleschen Wert, der angibt, ob die Signatur wurde erfolgreich überprüft wurde</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WrapKeyAsync">
      ...
      <Docs>
        <param name="key">Das Schlüsselmaterial verschlüsseln</param>
        <param name="algorithm">Zu verwendenden Algorithmus an</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Verschlüsselt den angegebenen Schlüsselmaterials.
            </summary>
        <returns>Ein Tupel bestehend aus den verschlüsselten Schlüssel und den verwendeten Algorithmus</returns>
        <remarks>Wenn der Algorithmus nicht angegeben wird, sollte eine Implementierung der Standardalgorithmus verwenden.</remarks>
      </Docs>
    </Member>
  </Members>
