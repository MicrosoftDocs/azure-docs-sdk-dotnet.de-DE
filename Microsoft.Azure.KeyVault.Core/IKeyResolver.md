<Type Name="IKeyResolver" FullName="Microsoft.Azure.KeyVault.Core.IKeyResolver">
  ...
  <Docs>
    <summary>
            Eine Schnittstelle für wichtige Konfliktlöser.
            </summary>
  ...
  <Members>
    <Member MemberName="ResolveKeyAsync">
      ...
      <Docs>
        <param name="kid">Der Schlüsselbezeichner aufgelöst</param>
        <param name="token">Abbruchtoken</param>
        <summary>
            Stellt eine Implementierung IKey für den angegebenen Schlüsselbezeichner.
            </summary>
        <returns>Der aufgelöste IKey Implementierung oder null</returns>
        <remarks>Implementierungen sollten überprüfen, das Format "Kid", um sicherzustellen, dass er erkannt wird. NULL, anstatt eine Ausnahme sollte für unbekannte Schlüsselbezeichner zum Aktivieren der Verkettung der wichtigsten Konfliktlöser zurückgegeben werden.</remarks>
      </Docs>
    </Member>
  </Members>
</Type>