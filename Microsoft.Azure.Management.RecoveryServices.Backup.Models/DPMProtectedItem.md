<Type Name="DPMProtectedItem" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.DPMProtectedItem">
  ...
  <Docs>
    <summary>
            Weitere Informationen zu Backup Modul bestimmte Sichern des Elements.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DPMProtectedItem-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="friendlyName">Anzeigename des verwalteten Elements</param>
        <param name="backupEngineName">Backup-Schutz von diesem Element für die Sicherung Verwaltungsserver</param>
        <param name="protectionState">Der Schutzstatus für die Backupengine.
            Folgende Werte sind möglich: "Ungültig", 'IRPending', 'Protected', 'ProtectionError', "ProtectionStopped", "ProtectionPaused"</param>
        <param name="isScheduledForDeferredDelete">Zum Überprüfen, ob das Sichern des Elements für das verzögerte löschen geplant ist</param>
        <param name="extendedInfo">Erweiterte Informationen für das Sichern des Elements.</param>
        <summary>
            Initialisiert eine neue Instanz der DPMProtectedItem-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BackupEngineName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest backup Management-Server schützen dieses Element für die Sicherung
            </summary>
    ...
    <Member MemberName="ExtendedInfo">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der erweiterten Informationen für das Sichern des Elements.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FriendlyName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest angezeigten Namen des verwalteten Elements
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsScheduledForDeferredDelete">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt zum Überprüfen, ob das Sichern des Elements für das verzögerte löschen geplant ist
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectionState">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest-Schutzstatus für die Backupengine. Folgende Werte sind möglich: "Ungültig", 'IRPending', 'Protected', 'ProtectionError', "ProtectionStopped", "ProtectionPaused"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
