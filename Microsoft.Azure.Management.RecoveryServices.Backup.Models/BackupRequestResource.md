<Type Name="BackupRequestResource" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BackupRequestResource">
  ...
  <Docs>
    <summary>
            Die Basisklasse für die Anforderung für die Sicherung. Spezifische backup-Anforderungen werden von dieser Klasse abgeleitet.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BackupRequestResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="properties">BackupRequestResource-Eigenschaften</param>
        <summary>
            Initialisiert eine neue Instanz der BackupRequestResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest BackupRequestResource-Eigenschaften
            </summary>
