<Type Name="AzureIaaSVMProtectedItemExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureIaaSVMProtectedItemExtendedInfo">
  ...
  <Docs>
    <summary>
            Weitere Informationen zu bestimmten Azure-IaaS-VM Sichern des Elements.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureIaaSVMProtectedItemExtendedInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="oldestRecoveryPoint">Die älteste Sicherungskopie für dieses Element für die Sicherung zur Verfügung.</param>
        <param name="recoveryPointCount">Die Anzahl von Sicherungskopien, die für dieses Element für die Sicherung zur Verfügung.</param>
        <param name="policyInconsistent">Gibt an, ob der Richtlinie für das Sichern des Elements zugeordnet inkonsistent ist.</param>
        <summary>
            Initialisiert eine neue Instanz der AzureIaaSVMProtectedItemExtendedInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OldestRecoveryPoint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die älteste Sicherungskopie erstellen, die für dieses Element für die Sicherung.
            </summary>
    ...
    <Member MemberName="PolicyInconsistent">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt an, ob der Richtlinie für das Sichern des Elements zugeordnet inkonsistent ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPointCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl von Sicherungskopien, die für dieses Element für die Sicherung zur Verfügung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
