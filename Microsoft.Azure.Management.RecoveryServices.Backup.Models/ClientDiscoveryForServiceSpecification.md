<Type Name="ClientDiscoveryForServiceSpecification" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.ClientDiscoveryForServiceSpecification">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="033d4-101">-Klasse zur Shoebox-Service-Spezifikation in der Ermittlung der Json-Darstellung.</span><span class="sxs-lookup"><span data-stu-id="033d4-101">Class to represent shoebox service specification in json client discovery.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="033d4-102">Initialisiert eine neue Instanz der ClientDiscoveryForServiceSpecification-Klasse.</span><span class="sxs-lookup"><span data-stu-id="033d4-102">Initializes a new instance of the ClientDiscoveryForServiceSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="logSpecifications"><span data-ttu-id="033d4-103">Liste der Protokoll-Spezifikationen dieses Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="033d4-103">List of log specifications of this operation.</span></span></param>
        <summary>
            <span data-ttu-id="033d4-104">Initialisiert eine neue Instanz der ClientDiscoveryForServiceSpecification-Klasse.</span><span class="sxs-lookup"><span data-stu-id="033d4-104">Initializes a new instance of the ClientDiscoveryForServiceSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LogSpecifications">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="033d4-105">Ruft ab oder legt die Liste der Protokoll-Spezifikationen dieses Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="033d4-105">Gets or sets list of log specifications of this operation.</span></span>
            </summary>
