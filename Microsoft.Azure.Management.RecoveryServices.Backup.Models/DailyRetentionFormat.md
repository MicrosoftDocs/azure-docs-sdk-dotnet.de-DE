<Type Name="DailyRetentionFormat" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.DailyRetentionFormat">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DailyRetentionFormat-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="daysOfTheMonth">Liste der Tage des Monats.</param>
        <summary>
            Initialisiert eine neue Instanz der DailyRetentionFormat-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DaysOfTheMonth">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Tage des Monats.
            </summary>
