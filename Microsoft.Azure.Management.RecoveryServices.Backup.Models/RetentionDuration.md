<Type Name="RetentionDuration" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.RetentionDuration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="df992-101">Die Beibehaltungsdauer.</span><span class="sxs-lookup"><span data-stu-id="df992-101">Retention duration.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="df992-102">Initialisiert eine neue Instanz der RetentionDuration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="df992-102">Initializes a new instance of the RetentionDuration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="count"><span data-ttu-id="df992-103">Die Anzahl der Duration-Typen.</span><span class="sxs-lookup"><span data-stu-id="df992-103">Count of duration types.</span></span> <span data-ttu-id="df992-104">Beibehaltungsdauer wird durch zählen des Dauer-Typs, den Anzahl Zeiten abgerufen.</span><span class="sxs-lookup"><span data-stu-id="df992-104">Retention duration is obtained by the counting the duration type Count times.</span></span>
            <span data-ttu-id="df992-105">Wenn z. B. Count = 3 und DurationType Wochen = Beibehaltungsdauer werden drei Wochen.</span><span class="sxs-lookup"><span data-stu-id="df992-105">For example, when Count = 3 and DurationType = Weeks, retention duration will be three weeks.</span></span></param>
        <param name="durationType"><span data-ttu-id="df992-106">Dauer-Typ der Aufbewahrungsrichtlinie für die Beibehaltungsdauer.</span><span class="sxs-lookup"><span data-stu-id="df992-106">Retention duration type of retention policy.</span></span> <span data-ttu-id="df992-107">Folgende Werte sind möglich: "Ungültig", 'Days', "Wochen", "Monat", "Jahre"</span><span class="sxs-lookup"><span data-stu-id="df992-107">Possible values include: 'Invalid', 'Days', 'Weeks', 'Months', 'Years'</span></span></param>
        <summary>
            <span data-ttu-id="df992-108">Initialisiert eine neue Instanz der RetentionDuration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="df992-108">Initializes a new instance of the RetentionDuration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="df992-109">Ruft ab oder legt die Anzahl der Duration-Typen.</span><span class="sxs-lookup"><span data-stu-id="df992-109">Gets or sets count of duration types.</span></span> <span data-ttu-id="df992-110">Beibehaltungsdauer wird durch zählen des Dauer-Typs, den Anzahl Zeiten abgerufen.</span><span class="sxs-lookup"><span data-stu-id="df992-110">Retention duration is obtained by the counting the duration type Count times.</span></span>
            <span data-ttu-id="df992-111">Wenn z. B. Count = 3 und DurationType Wochen = Beibehaltungsdauer werden drei Wochen.</span><span class="sxs-lookup"><span data-stu-id="df992-111">For example, when Count = 3 and DurationType = Weeks, retention duration will be three weeks.</span></span>
            </summary>
    ...
    <Member MemberName="DurationType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="df992-112">Ruft ab oder legt ihn fest Aufbewahrung Dauer Aufbewahrungsrichtlinie.</span><span class="sxs-lookup"><span data-stu-id="df992-112">Gets or sets retention duration type of retention policy.</span></span> <span data-ttu-id="df992-113">Folgende Werte sind möglich: "Ungültig", 'Days', "Wochen", "Monat", "Jahre"</span><span class="sxs-lookup"><span data-stu-id="df992-113">Possible values include: 'Invalid', 'Days', 'Weeks', 'Months', 'Years'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
