<Type Name="BMSBackupSummariesQueryObject" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BMSBackupSummariesQueryObject">
  ...
  <Docs>
    <summary>
            Abfrageparameter backup Zusammenfassungen abgerufen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BMSBackupSummariesQueryObject-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">Typ der sicherungsverwaltung für diesen Container.
            Folgende Werte sind möglich: "Ungültig", "BackupProtectedItemCountSummary", "BackupProtectionContainerCountSummary"</param>
        <summary>
            Initialisiert eine neue Instanz der BMSBackupSummariesQueryObject-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt backup Verwaltungstyp für diesen Container. Folgende Werte sind möglich: "Ungültig", "BackupProtectedItemCountSummary", "BackupProtectionContainerCountSummary"
            </summary>
