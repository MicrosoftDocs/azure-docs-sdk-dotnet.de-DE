<Type Name="BMSPOQueryObject" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BMSPOQueryObject">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="92bce-101">Filter, Listenelemente, die gesichert werden können.</span><span class="sxs-lookup"><span data-stu-id="92bce-101">Filters to list items that can be backed up.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="92bce-102">Initialisiert eine neue Instanz der BMSPOQueryObject-Klasse.</span><span class="sxs-lookup"><span data-stu-id="92bce-102">Initializes a new instance of the BMSPOQueryObject class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="backupManagementType"><span data-ttu-id="92bce-103">Backup-Management-Typ.</span><span class="sxs-lookup"><span data-stu-id="92bce-103">Backup management type.</span></span> <span data-ttu-id="92bce-104">Folgende Werte sind möglich: "Ungültig", "AzureIaasVM", "MAB", "DPM", "AzureBackupServer", "Azure SQL"</span><span class="sxs-lookup"><span data-stu-id="92bce-104">Possible values include: 'Invalid', 'AzureIaasVM', 'MAB', 'DPM', 'AzureBackupServer', 'AzureSql'</span></span></param>
        <param name="status"><span data-ttu-id="92bce-105">Sicherungsstatus Abfrageparameter.</span><span class="sxs-lookup"><span data-stu-id="92bce-105">Backup status query parameter.</span></span></param>
        <param name="friendlyName"><span data-ttu-id="92bce-106">Der Anzeigename.</span><span class="sxs-lookup"><span data-stu-id="92bce-106">Friendly name.</span></span></param>
        <summary>
            <span data-ttu-id="92bce-107">Initialisiert eine neue Instanz der BMSPOQueryObject-Klasse.</span><span class="sxs-lookup"><span data-stu-id="92bce-107">Initializes a new instance of the BMSPOQueryObject class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BackupManagementType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="92bce-108">Ruft ab oder legt ihn fest sicherungsverwaltung.</span><span class="sxs-lookup"><span data-stu-id="92bce-108">Gets or sets backup management type.</span></span> <span data-ttu-id="92bce-109">Folgende Werte sind möglich: "Ungültig", "AzureIaasVM", "MAB", "DPM", "AzureBackupServer", "Azure SQL"</span><span class="sxs-lookup"><span data-stu-id="92bce-109">Possible values include: 'Invalid', 'AzureIaasVM', 'MAB', 'DPM', 'AzureBackupServer', 'AzureSql'</span></span>
            </summary>
    ...
    <Member MemberName="FriendlyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="92bce-110">Ruft ab, oder legt ihn fest Anzeigename.</span><span class="sxs-lookup"><span data-stu-id="92bce-110">Gets or sets friendly name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="92bce-111">Ruft ab, oder legt ihn fest Sicherungsstatus Abfrageparameter.</span><span class="sxs-lookup"><span data-stu-id="92bce-111">Gets or sets backup status query parameter.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
