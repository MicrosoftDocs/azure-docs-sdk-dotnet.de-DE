<Type Name="VirtualMachineScaleSetOSProfile" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetOSProfile">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="computerNamePrefix">Das Präfix des Computers.</param>
        <param name="adminUsername">Der Benutzername des Administrators.</param>
        <param name="adminPassword">Das Administratorkennwort für die Benutzer.</param>
    ...
    <Member MemberName="AdminPassword">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort des Administratorbenutzers.
            </summary>
    ...
    <Member MemberName="AdminUsername">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Benutzernamen Admin.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ComputerNamePrefix">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das computernamenpräfix.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
