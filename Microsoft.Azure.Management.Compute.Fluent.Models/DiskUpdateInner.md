<Type Name="DiskUpdateInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.DiskUpdateInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cb965-101">Update-Ressource.</span><span class="sxs-lookup"><span data-stu-id="cb965-101">Disk update resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb965-102">Initialisiert eine neue Instanz der DiskUpdateInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cb965-102">Initializes a new instance of the DiskUpdateInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb965-103">Ruft ab oder legt fest, ob creationData.createOption leer ist, dieses Feld ist obligatorisch und gibt die Größe der virtuellen Festplatte erstellen an.</span><span class="sxs-lookup"><span data-stu-id="cb965-103">Gets or sets if creationData.createOption is Empty, this field is mandatory and it indicates the size of the VHD to create.</span></span> <span data-ttu-id="cb965-104">Wenn dieses Feld nach Updates oder Erstellung mit anderen Optionen vorhanden ist, gibt es eine Größe an.</span><span class="sxs-lookup"><span data-stu-id="cb965-104">If this field is present for updates or creation with other options, it indicates a resize.</span></span> <span data-ttu-id="cb965-105">Ändert die Größe sind nur zulässig, wenn der Datenträger nicht an einen ausgeführten virtuellen Computer angefügt ist und nur Sie den Datenträger vergrößern kann.</span><span class="sxs-lookup"><span data-stu-id="cb965-105">Resizes are only allowed if the disk is not attached to a running VM, and can only increase the disk's size.</span></span>
            </summary>
    ...
    <Member MemberName="EncryptionSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb965-106">Ruft ab oder legt ihn fest verschlüsselungseinstellungen für Datenträger oder einer Momentaufnahme</span><span class="sxs-lookup"><span data-stu-id="cb965-106">Gets or sets encryption settings for disk or snapshot</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb965-107">Ruft ab oder legt den Betriebssystemtyp.</span><span class="sxs-lookup"><span data-stu-id="cb965-107">Gets or sets the Operating System type.</span></span> <span data-ttu-id="cb965-108">Folgende Werte sind möglich: "Windows", "Linux"</span><span class="sxs-lookup"><span data-stu-id="cb965-108">Possible values include: 'Windows', 'Linux'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb965-109">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="cb965-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="cb965-110">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="cb965-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
