<Type Name="VirtualMachineScaleSetDataDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetDataDisk">
  ...
  <Docs>
    <summary>
            Beschreibt die Datenträger eines virtuellen Computers Scale Set-Daten.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetDataDisk-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="diskSizeGB">Die anfängliche Festplattengröße in GB für leere Datenträger, und die neue gewünschte Größe für das vorhandene Betriebssystem und die Datenträger.</param>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die anfängliche Festplattengröße in GB für leere Datenträger und die neue gewünschte Größe für das vorhandene Betriebssystem und die Datenträger.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
