<Type Name="VirtualMachineScaleSetVMInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetVMInner">
  ...
  <Docs>
    <summary>
            Beschreibt eine virtuelle Maschine Scale Set virtuelle Maschine an.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineScaleSetVMInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="instanceId">Die VM-Instanz-ID.</param>
        <param name="sku">Die virtuelle Maschine SKU.</param>
        <param name="latestModelApplied">Gibt an, ob das aktuelle Modell mit dem virtuellen Computer angewendet wurde.</param>
        <param name="vmId">Azure VM eindeutige ID.</param>
        <param name="instanceView">Die virtuelle Maschine Instanzansicht.</param>
        <param name="hardwareProfile">Das Hardwareprofil ein.</param>
        <param name="storageProfile">Das Speicherprofil.</param>
        <param name="osProfile">Betriebssystemprofil.</param>
        <param name="networkProfile">Netzwerkprofil.</param>
        <param name="diagnosticsProfile">Das Profil Diagnose.</param>
        <param name="availabilitySet">Der Verweis-Id der verfügbarkeitsgruppe festgelegt, zu dem dieser virtuelle Computer gehört.</param>
        <param name="provisioningState">Der Bereitstellungsstatus, die nur in der Antwort angezeigt wird.</param>
        <param name="licenseType">Der Lizenztyp für eigene schalten ist Lizenz Szenario.</param>
        <param name="plan">Des erwerbsplans bei der Bereitstellung der virtuellen Maschine von VM-Marketplace-Images.</param>
    ...
    <Member MemberName="AvailabilitySet">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Verweis-Id der verfügbarkeitsgruppe, zu dem dieser virtuelle Computer gehört.
            </summary>
    ...
    <Member MemberName="DiagnosticsProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Profil für die Diagnose.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HardwareProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Hardwareprofil ein.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LatestModelApplied">
      ...
      <Docs>
        <summary>
            Ruft gibt an, ob das aktuelle Modell mit dem virtuellen Computer angewendet wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LicenseType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Lizenztyp, die für bringen Sie Ihre eigene Lizenz-Szenario.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Netzwerkprofil.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsProfile">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen des Betriebssystemprofils.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Plan">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen des erwerbsplans, bei der Bereitstellung der virtuellen Maschine von VM-Marketplace-Images.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            Ruft den virtuellen Computer SKU ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageProfile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Speicherprofil.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VmId">
      ...
      <Docs>
        <summary>
            Ruft die Azure VM eindeutige ID.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
