<Type Name="ContainerServiceSshPublicKey" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ContainerServiceSshPublicKey">
  ...
  <Docs>
    <summary>
            Enthält Informationen zu öffentlichen Schlüsseldaten für SSH-Zertifikat.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceSshPublicKey-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyData">Öffentliche Zertifikatschlüssel verwendet, um mit virtuellen Computern über SSH zu authentifizieren. Das Zertifikat muss im PEM-Format mit oder ohne Header.</param>
        <summary>
            Initialisiert eine neue Instanz der ContainerServiceSshPublicKey-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyData">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der öffentliche Schlüssel des Zertifikats für die Authentifizierung bei virtuellen Computern über SSH verwendet. Das Zertifikat muss im PEM-Format mit oder ohne Header.
            </summary>
