<Type Name="VirtualMachineExtensionInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineExtensionInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualMachineExtensionInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="virtualMachineExtensionType">Der Typ des erweiterungshandlers.</param>
        <param name="typeHandlerVersion">Die Version des erweiterungshandlers.</param>
        <param name="autoUpgradeMinorVersion">Gibt an, ob der Erweiterungshandler automatisch Nebenversionen aktualisiert werden soll.</param>
        <param name="settings">Public-Einstellungen für die Erweiterung im JSON-Format.</param>
        <param name="protectedSettings">Geschützte Einstellungen für die Erweiterung im JSON-Format.</param>
    ...
    <Member MemberName="AutoUpgradeMinorVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob der Erweiterungshandler Nebenversionen automatisch aktualisiert werden soll.
            </summary>
    ...
    <Member MemberName="ProtectedSettings">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Json-formatierte Einstellungen für die Erweiterung geschützt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TypeHandlerVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version des erweiterungshandlers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualMachineExtensionType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Typ des erweiterungshandlers fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
