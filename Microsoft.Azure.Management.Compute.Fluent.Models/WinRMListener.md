<Type Name="WinRMListener" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.WinRMListener">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="protocol">Das von der WinRM-Listener verwendete Protokoll.
            HTTP- und Https werden unterstützt. Folgende Werte sind möglich: "Http", "Https"</param>
        <param name="certificateUrl">Die Zertifikat-URL in KMS für Https-Listener. Sollte für HTTP-Listener null sein.</param>
        <summary>
            Initialisiert eine neue Instanz der WinRMListener-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CertificateUrl">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zertifikat-URL in KMS für Https-Listener. Sollte für HTTP-Listener null sein.
            </summary>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das von der WinRM-Listener verwendete Protokoll. HTTP- und Https werden unterstützt. Folgende Werte sind möglich: "Http", "Https"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
