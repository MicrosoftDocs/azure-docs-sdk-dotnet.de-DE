<Type Name="OSDiskImage" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.OSDiskImage">
  ...
  <Docs>
    <summary>
            Enthält die Betriebssystem-Datenträger-Image-Informationen an.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der OSDiskImage-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="operatingSystem">Das Betriebssystem von der OsDiskImage. Folgende Werte sind möglich: "Windows", "Linux"</param>
        <summary>
            Initialisiert eine neue Instanz der OSDiskImage-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OperatingSystem">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen des Betriebssystems die OsDiskImage. Folgende Werte sind möglich: "Windows", "Linux"
            </summary>
