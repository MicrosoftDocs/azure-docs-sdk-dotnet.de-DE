<Type Name="ServiceGroupMemberTypeList" FullName="System.Fabric.Query.ServiceGroupMemberTypeList">
  ...
  <Docs>
    <summary>
            Der Dienst Typliste der Gruppenmitglieder, die die Gruppe Member enthält.
            </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">Der Dienst Gruppe-Elementtyp hinzugefügt werden.</param>
        <summary>
            Fügen Sie den Elementtyp des Dienst-Gruppe hinzu.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
            Deaktivieren Sie den Dienst Gruppe Elementtypen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">Der Dienst Gruppe-Elementtyp, gesucht werden soll.</param>
        <summary>
            Durchsuchen, wenn den Elementtyp des Dienst-Gruppe enthält.
            </summary>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">Der Dienst Gruppe-Elementtyp kopiert werden soll.</param>
        <param name="arrayIndex">Der Index, dem Kopieren begonnen werden soll.</param>
        <summary>
            Kopieren Sie den Elementtyp des Dienst-Gruppe.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            Die Anzahl der Member der Diensttyp-Gruppe.
            </summary>
        <value>Die Anzahl der Member der Diensttyp-Gruppe.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            Rufen Sie den Enumerator des Gruppenmitglieds Dienst Typen.
            </summary>
        <returns>Der Enumerator der Diensttypen enthält Gruppe Mitglied ist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">Der Dienst Gruppe-Elementtyp, gesucht werden soll.</param>
        <summary>
            Suchen Sie nach dem Index des Elements den Diensttyp-Gruppe.
            </summary>
        <returns>Der Index des Elements den Diensttyp-Gruppe.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">Der Index eingefügt werden.</param>
        <param name="item">Der Dienst Gruppe-Elementtyp eingefügt werden.</param>
        <summary>
            Fügen Sie den Elementtyp des Dienst-Gruppe.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">Der Index des Diensttyps Gruppe Member zugegriffen werden.</param>
        <summary>
            Zugriff auf den Dienst Gruppe Elementtyp.
            </summary>
        <value>Der Index des Diensttyps Gruppe Mitglied.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item">Der Dienst Gruppe-Elementtyp entfernt werden soll.</param>
        <summary>
            Entfernen Sie den Elementtyp des Dienst-Gruppe.
            </summary>
    ...
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">Der Index des Diensttyps Gruppe Mitglied entfernt werden soll.</param>
        <summary>
            Elementtyp für Service-Gruppe zu entfernen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
