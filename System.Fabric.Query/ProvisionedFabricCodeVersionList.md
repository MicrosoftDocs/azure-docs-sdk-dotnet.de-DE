<Type Name="ProvisionedFabricCodeVersionList" FullName="System.Fabric.Query.ProvisionedFabricCodeVersionList">
  ...
  <Docs>
    <summary>
      <para>Stellt eine Liste von bereitgestellten Service Fabric-Code-Versionen, die durch den Aufruf abgerufen <see cref="M:System.Fabric.FabricClient.QueryClient.GetProvisionedFabricConfigVersionListAsync" />.</para>
    </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">
          <para>Das Element, das der Liste hinzugefügt werden.</para>
        </param>
        <summary>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <summary>
          <para>Gibt an, ob die Liste ein angegebenes Element enthält.</para>
        </summary>
        <returns>
          <para>
            <languageKeyword>"true"</languageKeyword> enthält die Liste ein angegebenes Element ist, andernfalls <languageKeyword>"false"</languageKeyword>.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">
          <para>Das Array von zu kopierenden Elemente.</para>
        </param>
        <param name="arrayIndex">
          <para>Der Index, in das Array von Elementen kopiert wird.</para>
        </param>
        <summary>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
          <para>Ruft ab oder legt die Anzahl der Elemente in dieser Liste.</para>
        </summary>
        <value>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        ...
        <returns>
          <para>Der Enumerator, der die Liste durchläuft.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">
          <para>Das angegebene Element.</para>
        </param>
        <summary>
    ...
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">
          <para>Der Speicherort, in dem das Element eingefügt wird.</para>
        </param>
        <param name="item">
    ...
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para>Ruft ab oder legt ein Flag, das angibt, ob die Liste schreibgeschützt ist.</para>
        </summary>
        <value>
          <para>
            <languageKeyword>"true"</languageKeyword> Wenn die Liste, andernfalls schreibgeschützt ist <languageKeyword>"false"</languageKeyword>.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">
          <para>Der Index des Elements.</para>
        </param>
        <summary>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <summary>
          <para>Entfernen Sie das angegebene Element aus dieser Liste.</para>
        </summary>
        <returns>
          <para>Die Liste mit dem entfernten Element.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">
          <para>Der Index des zu entfernenden Elements.</para>
        </param>
        <summary>
