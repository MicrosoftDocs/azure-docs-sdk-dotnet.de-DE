<Type Name="ServiceTypeList" FullName="System.Fabric.Query.ServiceTypeList">
  ...
  <Docs>
    <summary>
      <para>Stellt eine Liste der Diensttyp.</para>
    </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        ...
        <summary>
          <para>Fügt am Ende der <see cref="T:System.Fabric.Query.ServiceTypeList" /> ein Objekt hinzu.</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
          <para>Entfernt alle Elemente aus der <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <summary>
          <para>Bestimmt, ob ein Element in der <see cref="T:System.Fabric.Query.ServiceTypeList" />...</para>
        </summary>
        <returns>
          <para>
            <languageKeyword>"true"</languageKeyword> Wenn das Element in der <see cref="T:System.Fabric.Query.ServiceTypeList" />ist, andernfalls <languageKeyword>"false"</languageKeyword>.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">
          <para>Ein Array von Diensttyp.</para>
        </param>
        <param name="arrayIndex">
          <para>Der Index des Arrays.</para>
        </param>
        <summary>
          <para>Kopiert die gesamte <see cref="T:System.Fabric.Query.ServiceTypeList" />-Instanz in ein kompatibles eindimensionales <see cref="T:System.Fabric.Query.ServiceTypeList" />, beginnend am angegebenen Index des Zielarrays.</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
          <para>Ruft ab oder legt die Anzahl der Elemente in der <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </summary>
        <value>
          <para>Die Anzahl der Elemente im <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
          <para>Gibt einen Enumerator für die gesamte <see cref="T:System.Fabric.Query.ServiceTypeList" />...</para>
        </summary>
        <returns>
          <para>Ein Enumerator für die gesamte <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        ...
        <summary>
          <para>Sucht nach dem angegebenen <see cref="T:System.Fabric.Query.ServiceType" /> und gibt den nullbasierten Index des ersten Vorkommens innerhalb der gesamten <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </summary>
        <returns>
          <para>Der nullbasierte Index des ersten Vorkommens innerhalb der gesamten <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        ...
        <param name="item">
          <para>Das einzufügende Element.</para>
        </param>
        <summary>
          <para>Fügt ein Element in der <see cref="T:System.Fabric.Query.ServiceTypeList" /> am angegebenen Index.</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para>Ruft ab oder legt sie fest, ob <see cref="T:System.Fabric.Query.ServiceTypeList" /> ist schreibgeschützt.</para>
        </summary>
        <value>
          <para>
            <languageKeyword>"true"</languageKeyword> Wenn die <see cref="T:System.Fabric.Query.ServiceTypeList" /> schreibgeschützt ist, andernfalls <languageKeyword>"false"</languageKeyword>.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <summary>
          <para>Entfernt das erste Vorkommen eines bestimmten Objekts aus der <see cref="T:System.Fabric.Query.ServiceTypeList" />...</para>
        </summary>
        <returns>
          <para>
            <languageKeyword>"true"</languageKeyword> , wenn das Element vorhanden ist; andernfalls <languageKeyword>"false"</languageKeyword>.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">
          <para>Der Index, wo Sie das Element zu entfernen.</para>
        </param>
        <summary>
          <para>Entfernt das Element am angegebenen Index aus der <see cref="T:System.Fabric.Query.ServiceTypeList" />...</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
          <para>Gibt den Enumerator für die <see cref="T:System.Fabric.Query.ServiceTypeList" />...</para>
        </summary>
        <returns>
          <para>Der Zähler für die <see cref="T:System.Fabric.Query.ServiceTypeList" />.</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
