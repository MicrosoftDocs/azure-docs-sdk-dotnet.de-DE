<Type Name="ServiceKind" FullName="System.Fabric.Query.ServiceKind">
  ...
  <Docs>
    <summary>
      <para>Gibt die Art des Diensts an.</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="Stateful">
      ...
      <Docs>
        <summary>
          <para>Verwendet Service Fabric um den Status vollständig oder teilweise als hochverfügbar und zuverlässig zu machen.</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Stateless">
      ...
      <Docs>
        <summary>
          <para>Service Fabric verwendet nicht den Zustand hochverfügbar oder zuverlässig vornehmen.</para>
        </summary>
      </Docs>
    </Member>
  </Members>
