<Type Name="PagedList&lt;T&gt;" FullName="System.Fabric.Query.PagedList&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T">
      <para>Der Typ des von der Abfrage zurückgegebenen Elementen.</para>
    </typeparam>
    <summary>
      <para>
            Stellt eine ausgelagerte Liste, die eine Liste mit Elementen und ein Fortsetzungstoken enthält.
            </para>
    </summary>
    <remarks>
      <para>Die ausgelagerte Liste wird aus Abfragen abgerufen, denen mehr Ergebnisse als eine Nachricht eingefügt werden kann. Die nächste Ergebnisse können durch Ausführen derselben Abfrage mit dem vorherigen Fortsetzungstoken abgerufen werden.</para>
    </remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="list">
          <para>Die Liste mit Elementen, die zum Erstellen der ausgelagerten Liste verwendet werden soll.</para>
        </param>
        <summary>
          <para>
    ...
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">
          <para>Das Element, das der Liste hinzugefügt werden soll.</para>
        </param>
        <summary>
          <para>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <returns>
          <para>"true", wenn die Liste ein bestimmtes Element enthält; andernfalls "false".</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        <summary>
          <para>
            Das Fortsetzungstoken. Kann von Abfragen verwendet werden, weitere Ergebnisseiten abrufen.
            </para>
        </summary>
        <value>
          <para>Ruft ab oder legt das Fortsetzungstoken.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        ...
        <value>
          <para>Die Anzahl der Elemente in der Liste.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        ...
        <returns>
          <para>Der Enumerator Elemente in dieser Liste. </para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        ...
        <returns>
          <para>Der Index in der Liste für das angegebene Element. </para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">
          <para>Der Index, in dem das Element eingefügt wird.</para>
        </param>
        <param name="item">
    ...
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para>
            Ruft ein Flag, das angibt, ob die Liste geändert werden kann.
            </para>
        </summary>
        <value>
          <para>Ein Flag, der angibt, ob die Liste geändert werden kann.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <returns>
          <para>"true", wenn das Element entfernt wird; andernfalls "false".</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">
          <para>Der Index, in dem das Element entfernt wird.</para>
        </param>
        <summary>
          <para>
