<Type Name="ClientAssertion" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.ClientAssertion">
  ...
  <Docs>
    <summary>
            Den Anmeldeinformationstyp, enthält eine Assertion des Typs "Urn: Ietf:params:oauth:token-Typ: Jwt".
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="assertion">Das Jwt als Anmeldeinformationen verwendet.</param>
        <summary>
            Konstruktor zum Erstellen von Anmeldeinformationen mit einem Jwt-Token als eine base64-codierte Url-Zeichenfolge codiert.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
