<Type Name="DeviceCodeResult" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.DeviceCodeResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46baa-101">Diese Klasse stellt die Antwort vom Dienst beim Gerätecode anfordern.</span><span class="sxs-lookup"><span data-stu-id="46baa-101">This class represents the response from the service when requesting device code.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-102">Der Bezeichner des Gerätecode anfordernde Client.</span><span class="sxs-lookup"><span data-stu-id="46baa-102">Identifier of the client requesting device code.</span></span>
            </summary>
    ...
    <Member MemberName="DeviceCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-103">Gerätecode, die vom Dienst zurückgegeben wurde</span><span class="sxs-lookup"><span data-stu-id="46baa-103">Device code returned by the service</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ExpiresOn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-104">Der Zeitpunkt, wann das Gerätecode ablaufen soll.</span><span class="sxs-lookup"><span data-stu-id="46baa-104">Time when the device code will expire.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Interval">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-105">Intervall für den Abschluss der Authentifizierungsablauf überprüfen abgerufen wird.</span><span class="sxs-lookup"><span data-stu-id="46baa-105">Polling interval time to check for completion of authentication flow.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-106">Benutzer angezeigte Text-Antwort, die für die Anzeige Zweck verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="46baa-106">User friendly text response that can be used for display purpose.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-107">Der Bezeichner der Zielressource, die den Empfänger des Tokens wäre.</span><span class="sxs-lookup"><span data-stu-id="46baa-107">Identifier of the target resource that would be the recipient of the token.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-108">Benutzercode, der vom Dienst zurückgegeben wurde</span><span class="sxs-lookup"><span data-stu-id="46baa-108">User code returned by the service</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VerificationUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46baa-109">Überprüfungs-URL, in denen der Benutzer die Authentifizierung mit dem Gerätecode und den Anmeldeinformationen navigieren muss.</span><span class="sxs-lookup"><span data-stu-id="46baa-109">Verification URL where the user must navigate to authenticate using the device code and credentials.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
