<Type Name="ISecureClientSecret" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.ISecureClientSecret">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="62866-101">Schnittstelle, um für den geheimen Clientschlüssel als SecureString übergeben werden können</span><span class="sxs-lookup"><span data-stu-id="62866-101">Interface to allow for client secret to be passed in as a SecureString</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ApplyTo">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="62866-102">Schreibt SecureString, die dem Wörterbuch.</span><span class="sxs-lookup"><span data-stu-id="62866-102">Writes SecureString to the dictionary.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
