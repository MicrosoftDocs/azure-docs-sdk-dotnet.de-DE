  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="assertion">Die Assertion, die den Benutzer darstellt.</param>
        <param name="assertionType">Der Typ der Assertion, die den Benutzer darstellt.</param>
        <param name="userName">Identität des Benutzertokens ist für angefordert. Dieser Parameter kann NULL sein.</param>
        <summary>
            Konstruktor zum Erstellen von Anmeldeinformationen mit Assertion, AssertionType und Benutzername
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
