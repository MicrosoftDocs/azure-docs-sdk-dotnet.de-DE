<Type Name="IWithAuthorizationRule" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Update.IWithAuthorizationRule">
  ...
  <Docs>
    <summary>
            Die Phase der themadefinition ermöglicht eine Autorisierungsregel für den Zugriff auf das Thema hinzufügen.
            </summary>
  ...
  <Members>
    <Member MemberName="WithNewListenRule">
      ...
      <Docs>
        ...
        <summary>
            Erstellt eine Autorisierungsregel Lauschen für das Thema an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Nächste Stufe des Updates Thema.</return>
      </Docs>
    </Member>
    <Member MemberName="WithNewManageRule">
      ...
      <Docs>
        <param name="name">Name der Regel.</param>
        <summary>
            Erstellt eine Autorisierungsregel verwalten für das Thema an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Nächste Stufe des Updates Thema.</return>
    ...
    <Member MemberName="WithNewSendRule">
      ...
      <Docs>
        <param name="name">Name der Regel.</param>
        <summary>
            Erstellt eine senden-Autorisierungsregel für das Thema an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Nächste Stufe des Updates Thema.</return>
    ...
    <Member MemberName="WithoutAuthorizationRule">
      ...
      <Docs>
        <param name="name">Name der Regel.</param>
        <summary>
            Entfernt eine Autorisierungsregel für das Thema an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Nächste Stufe des Updates Thema.</return>
