<Type Name="ITrafficManagerEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.ITrafficManagerEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ff5d8-101">Eine unveränderliche clientseitige Darstellung einer Azure Traffic Manager-profileendpunkt.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-101">An immutable client-side representation of an Azure traffic manager profile endpoint.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="EndpointType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff5d8-102">Ruft den Endpunkttyp ab.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-102">Gets the endpoint type.</span></span>
            </summary>
    ...
    <Member MemberName="IsEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff5d8-103">Ruft "true", wenn der Endpunkt aktiviert, andernfalls false ist.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-103">Gets true if the endpoint is enabled, false otherwise.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MonitorStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff5d8-104">Ruft die Monitorstatus des Endpunkts ab.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-104">Gets the monitor status of the endpoint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RoutingPriority">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff5d8-105">Ruft die Priorität des Endpunkts der verwendet wird, wenn Traffic Manager-Profil mit Priorität datenverkehrrouting Methode konfiguriert ist.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-105">Gets the priority of the endpoint which is used when traffic manager profile is configured with Priority traffic-routing method.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RoutingWeight">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff5d8-106">Ruft die Gewichtung des Endpunkts der verwendet wird, wenn Traffic Manager-Profil mit gewichteten datenverkehrrouting Methode konfiguriert ist.</span><span class="sxs-lookup"><span data-stu-id="ff5d8-106">Gets the weight of the endpoint which is used when traffic manager profile is configured with Weighted traffic-routing method.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
