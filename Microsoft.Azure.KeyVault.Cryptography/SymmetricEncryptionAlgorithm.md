<Type Name="SymmetricEncryptionAlgorithm" FullName="Microsoft.Azure.KeyVault.Cryptography.SymmetricEncryptionAlgorithm">
  ...
  <Docs>
    <summary>
            Abstrakte symmetrische Verschlüsselung-Algorithmus
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CreateDecryptor">
      ...
      <Docs>
        <param name="key">Das Schlüsselmaterial verwendet werden</param>
        <param name="iv">Der Initialisierungsvektor, der verwendet werden</param>
        <param name="authenticationData">Die Authentifizierungsdaten beim Authentifizieren von Verschlüsselungsalgorithmen verwendet werden (nicht authentifizieren ignoriert Algorithmen)</param>
        <param name="authenticationTag">Zu überprüfen, ob die Authentifizierung Verschlüsselungsalgorithmen mit Tags Authentifizierung (für nicht authentifizieren ignoriert Algorithmen)</param>
        <summary>
            Erstellen Sie eine Entschlüsselungsmethode für den angegebenen Schlüssel
            </summary>
        <returns>Ein ICryptoTransform zum Entschlüsseln von Daten</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateEncryptor">
      ...
      <Docs>
        ...
        <param name="authenticationData">Die Authentifizierungsdaten beim Authentifizieren von Verschlüsselungsalgorithmen verwendet werden (nicht authentifizieren ignoriert Algorithmen)</param>
        <summary>
            Erstellen Sie eine Verschlüsselungsmethode anzugeben, für den angegebenen Schlüssel
            </summary>
        <returns>Ein ICryptoTranform zum Verschlüsseln von Daten</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
