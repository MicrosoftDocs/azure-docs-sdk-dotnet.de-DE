<Type Name="AsymmetricSignatureAlgorithm" FullName="Microsoft.Azure.KeyVault.Cryptography.AsymmetricSignatureAlgorithm">
  ...
  <Docs>
    <summary>
            Abstrakte asymmetrische Signaturalgorithmus
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CreateSignatureTransform">
      ...
      <Docs>
        <param name="key">Der asymmetrische Schlüssel verwenden.</param>
        <summary>
            Erstellt eine Signatur Transformation-Implementierung, die zum Signieren oder überprüfen verwendet werden kann.
            </summary>
        <returns>Eine ISignatureTransform-Implementierung.</returns>
        <remarks>Die Implementierung für die Transformation "Grunde verwendet" angegebenen AsymmetricAlgorithm; Aufrufer sollten Dispose nicht auf die AsymmetricAlgorithm aufrufen, bis zum Abschluss der Transformation Implementierung verwenden.
            </remarks>
      </Docs>
    </Member>
  </Members>
