<Type Name="AsymmetricEncryptionAlgorithm" FullName="Microsoft.Azure.KeyVault.Cryptography.AsymmetricEncryptionAlgorithm">
  ...
  <Docs>
    <summary>
            Abstrakte Verschlüsselungsalgorithmus für asymmetrischen
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CreateDecryptor">
      ...
      <Docs>
        <param name="key">Der Schlüssel zum Erstellen von Entschlüsselungsmethode</param>
        <summary>
            Erstellen Sie eine Entschlüsselungsmethode für den angegebenen Schlüssel
            </summary>
        <returns>Ein ICryptoTransform zum Verschlüsseln von Daten</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateEncryptor">
      ...
      <Docs>
        <param name="key">So erstellen die Verschlüsselung verwendete Schlüssel</param>
        <summary>
