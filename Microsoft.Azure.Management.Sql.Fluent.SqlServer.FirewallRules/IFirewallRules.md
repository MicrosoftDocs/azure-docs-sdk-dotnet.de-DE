<Type Name="IFirewallRules" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlServer.FirewallRules.IFirewallRules">
  ...
  <Docs>
    <summary>
            Der Einstiegspunkt für FirewallRules auf dem SQL Server zugreifen.
            </summary>
  ...
  <Members>
    <Member MemberName="Define">
      ...
      <Docs>
        <param name="firewallRuleName">Der Name der Firewallregel erstellt werden soll.</param>
        <summary>
            Erstellt eine neue Firewallregel in SQL Server.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt eine Stufe aus, um die Argumente der Firewallregel angeben.</return>
      </Docs>
    </Member>
    <Member MemberName="Delete">
      ...
      <Docs>
        <param name="firewallRuleName">Der Name der Firewallregel löschen.</param>
        <summary>
            Löschen Sie die angegebenen Firewallregel auf dem Server.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Observable-Objekt für den Löschvorgang.</return>
      </Docs>
    </Member>
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="firewallRuleName">Der Name der Firewallregel abgerufen.</param>
        <summary>
            Ruft eine bestimmte Firewallregel ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt die SqlFirewall-Regel mit SQL Server zurück.</return>
      </Docs>
    </Member>
    <Member MemberName="List">
      ...
      <Docs>
        <summary>
            Gibt die Firewallregeln für den Server zurück.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Liste von Firewallregeln für den Server.</return>
      </Docs>
    </Member>
  </Members>
</Type>