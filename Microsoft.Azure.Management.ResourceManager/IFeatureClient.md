<Type Name="IFeatureClient" FullName="Microsoft.Azure.Management.ResourceManager.IFeatureClient">
  ...
  <Docs>
    <summary>
            Die Steuerung für die Azure-Featureanzeige (Azure Feature Exposure Control, AFEC) ist ein Mechanismus, mit dem Ressourcenanbieter die Anzeige von Features für Benutzer steuern können. Ressourcenanbieter verwenden diesen Mechanismus in der Regel neue Funktionen vor Verfügbarmachung im allgemeinen öffentlichen/privaten Vorschau bereit.
            Benutzern müssen explizit für AFEC Funktionen für den Zugriff auf solche Funktionen registriert.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            Die API-Version für diesen Vorgang verwenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
