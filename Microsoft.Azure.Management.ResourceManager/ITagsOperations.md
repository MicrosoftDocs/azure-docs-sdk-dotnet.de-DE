  ...
  <Members>
    ...
    <Member MemberName="CreateOrUpdateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>
            Der Tagname darf höchstens 512 Zeichen und Groß-/Kleinschreibung beachtet wird. Von Azure erstellte Tagnamen weisen die Präfixe Microsoft, Azure oder Windows. Sie können keine Tags mit einem dieser Präfixe erstellen.
            </remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
            Wird ausgelöst, wenn der Vorgang einen ungültigen Statuscode zurückgegeben hat.
            </exception>
