<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.UpdateDefinition.IWithAttach&lt;ParentT&gt;">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.UpdateDefinition.IWithAttach`1" />
  ...
  <Docs>
    ...
    <summary>
            Der abschließenden Phase der Definition der Web-app-Authentifizierung.
            Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die Definition der Web-app-Authentifizierung an die übergeordnete Web-app-Update WithAttach.attach() mit angefügt werden kann.
            </summary>
