<Type Name="IWithTokenStore&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.UpdateDefinition.IWithTokenStore&lt;ParentT&gt;">
  ...
  <Docs>
    ...
    <summary>
            Eine Web-app-Authentifizierung Definition ermöglicht Tokenspeichers angegeben werden.
            </summary>
  ...
  <Members>
    <Member MemberName="WithTokenStore">
      ...
      <Docs>
        <param name="enabled">"True", wenn Tokenspeichers aktiviert werden soll.</param>
        <summary>
            Gibt an, ob Tokenspeichers aktiviert werden soll.
            </summary>
