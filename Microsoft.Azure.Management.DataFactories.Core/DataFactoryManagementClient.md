  ...
  <Members>
    ...
    <Member MemberName="Clone">
      ...
      <Docs>
        ...
        <summary>
            Klont Eigenschaften aus der aktuellen Instanz in eine andere DataFactoryManagementClient-Instanz
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetRequestUri">
      ...
      <Docs>
        ...
        <summary>
            Gibt die Url, die der Client Hydra verwenden würden, zum Ausführen des angegebenen RP-Vorgangs (die Anwendung die vertrauenden Seite nicht tatsächlich aufgerufen werden.)
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetResponseBody">
      ...
      <Docs>
        <param name="operation"></param>
        <summary>
            Führt den angegebenen Aufruf an die vertrauende Seite und des Inhalts der Antwort (d. h. unformatierten Json) zurückgibt.
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
