<Type Name="TableOperation" FullName="Microsoft.WindowsAzure.Storage.Table.TableOperation">
  ...
  <Members>
    <Member MemberName="Delete">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> Objekt aus der Tabelle gelöscht werden soll.</param>
        <summary>
            Erstellt einen neuen tabellenvorgang, der die angegebene Entität aus einer Tabelle löscht.
            </summary>
        <returns>Das <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableOperation" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> in die Tabelle einzufügende Objekt.</param>
        <summary>
    ...
    <Member MemberName="InsertOrMerge">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> Objekt eingefügt oder zusammengeführt werden.</param>
        <summary>
    ...
    <Member MemberName="InsertOrReplace">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> Objekt eingefügt oder ersetzt werden.</param>
        <summary>
    ...
    <Member MemberName="Merge">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> Objekt zusammengeführt werden sollen.</param>
        <summary>
    ...
    <Member MemberName="Replace">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> Objekt ersetzt werden.</param>
        <summary>
    ...
    <Member MemberName="RotateEncryptionKey">
      ...
      <Docs>
        <param name="entity">Die <see cref="T:Microsoft.WindowsAzure.Storage.Table.KeyRotationEntity" /> Entität über seine gedreht Schlüssel zu verfügen.  Die Ausgabe eines Aufrufs zu einem Aufruf von "ExecuteQueryForKeyRotation()" muss sein.</param>
        <summary>
