<Type Name="GroupsOperationsExtensions" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.GroupsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für GroupsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="AddMemberAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Die URL des Member-Objekt, z. B. https://graph.windows.net/0b1f9851-1bf0-433f-aec3-cb9272f093dc/directoryObjects/f260bbc4-c254-447b-94cf-293b5ec434dd.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
        <summary>
            Hinzufügen eines Mitglieds zu einer Gruppe an.
            </summary>
    ...
    <Member MemberName="CreateAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Die Parameter für die Gruppe zu erstellen.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
    ...
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <param name="groupObjectId">
            Die Objekt-ID der Gruppe zu löschen.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
        <summary>
            Löschen Sie eine Gruppe aus dem Verzeichnis ein.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetAsync">
      ...
      <Docs>
        ...
        <param name="objectId">
            Die Objekt-ID des Benutzers für die Gruppeninformationen abgerufen werden soll.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
        <summary>
            Ruft Informationen aus dem Verzeichnis zu gruppieren.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetGroupMembersAsync">
      ...
      <Docs>
        ...
        <param name="objectId">
            Die Objekt-ID der Gruppe, deren Mitglieder abgerufen werden soll.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
    ...
    <Member MemberName="GetMemberGroupsAsync">
      ...
      <Docs>
        ...
        <param name="objectId">
            Die Objekt-ID der Gruppe für die Gruppenmitgliedschaft abgerufen werden soll.
            </param>
        <param name="parameters">
            Gruppieren Sie Filterparameter ein.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
        <summary>
            Ruft eine Auflistung der Objekt-IDs der Gruppen, die Mitglied die angegebene Gruppe ist.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsMemberOfAsync">
      ...
      <Docs>
        ...
        <param name="parameters">
            Die Überprüfung der Gruppenmitgliedschaft-Parameter.
            </param>
        <param name="cancellationToken">
            Das Abbruchtoken.
            </param>
        <summary>
            Überprüft, ob der angegebene Benutzer, Gruppe, Kontakt oder Dienstprinzipal direkt oder transitiv Mitglied der angegebenen Gruppe ist.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RemoveMemberAsync">
      ...
      <Docs>
        ...
        <param name="groupObjectId">
            Die Objekt-ID der Gruppe aus dem das Element entfernt werden soll.
            </param>
        ...
        <summary>
            Entfernen eines Mitglieds aus einer Gruppe an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
