<Type Name="AuthorizationManagementClient" FullName="Microsoft.Azure.Management.Authorization.AuthorizationManagementClient">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AuthorizationManagementClient-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Clone">
      ...
      <Docs>
        <param name="client">
            Instanz des AuthorizationManagementClient zum Klonen in
            </param>
        <summary>
            Klont Eigenschaften aus der aktuellen Instanz in eine andere AuthorizationManagementClient-Instanz
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
