<Type Name="GetDevicePublicKeyResponse" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.GetDevicePublicKeyResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der GetDevicePublicKeyResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DevicePublicKey">
      ...
      <Docs>
        <summary>
            Optional. Der öffentliche Schlüssel des Geräts
            </summary>
