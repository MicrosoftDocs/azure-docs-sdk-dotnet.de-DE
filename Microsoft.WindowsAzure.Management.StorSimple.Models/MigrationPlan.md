<Type Name="MigrationPlan" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.MigrationPlan">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6fd09-101">Migration Plan-Klasse</span><span class="sxs-lookup"><span data-stu-id="6fd09-101">Migration plan class</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6fd09-102">Initialisiert eine neue Instanz der MigrationPlan-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6fd09-102">Initializes a new instance of the MigrationPlan class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="6fd09-103">Initialisiert eine neue Instanz der MigrationPlan-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="6fd09-103">Initializes a new instance of the MigrationPlan class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConfigId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6fd09-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="6fd09-104">Required.</span></span> <span data-ttu-id="6fd09-105">Ruft ab oder legt ihn fest übergebene beim Importieren der config-Datei der Konfigurations-ID</span><span class="sxs-lookup"><span data-stu-id="6fd09-105">Gets or sets the config ID passed while importing the config</span></span>
            </summary>
    ...
    <Member MemberName="DeviceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6fd09-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="6fd09-106">Required.</span></span> <span data-ttu-id="6fd09-107">Ruft ab oder legt die Ziel-Gerätename, in dem der Migrationsplan berechnet wird</span><span class="sxs-lookup"><span data-stu-id="6fd09-107">Gets or sets the target devicename where the migration plan is computed</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MigrationPlanInfo">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6fd09-108">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="6fd09-108">Required.</span></span> <span data-ttu-id="6fd09-109">Ruft ab oder legt Liste der Migrationspläne für alle in der importierten Config angegebenen Datencontainer</span><span class="sxs-lookup"><span data-stu-id="6fd09-109">Gets or sets list of migration plans for all data container specified in the config imported</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
