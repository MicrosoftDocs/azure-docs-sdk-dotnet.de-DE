<Type Name="MigrationStatus" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.MigrationStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a10f4-101">Stellt den Migrationsstatus für einen container</span><span class="sxs-lookup"><span data-stu-id="a10f4-101">Represents the migration status for a data container</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a10f4-102">Status Gibt an, dass die Migration von Volume-Container abgeschlossen wurde</span><span class="sxs-lookup"><span data-stu-id="a10f4-102">Status indicates the migration of volume container has completed</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a10f4-103">Status Gibt an, dass die Sicherung volumecontainer fehlgeschlagen ist</span><span class="sxs-lookup"><span data-stu-id="a10f4-103">Status indicates the backup volume container has failed</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="InProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a10f4-104">Status Gibt an, dass die Migration von der Volume-Container ausgeführt wird</span><span class="sxs-lookup"><span data-stu-id="a10f4-104">Status indicates the migration of the volume container is in progress</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NotStarted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a10f4-105">Status Gibt an, dass die Migration von der Volume-Container noch nicht gestartet wurde</span><span class="sxs-lookup"><span data-stu-id="a10f4-105">Status indicates the migration of the volume container has not yet started</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
