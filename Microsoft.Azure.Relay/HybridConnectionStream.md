<Type Name="HybridConnectionStream" FullName="Microsoft.Azure.Relay.HybridConnectionStream">
  ...
  <Docs>
    <summary>
            Ein Datenstrom, der eine verbundene HybridConnection darstellt.  Verwenden sie ebenso wie jeder andere Stream durch das Hinzufügen einer Methode zum Herunterfahren für die Benachrichtigung von der anderen Seite der Verbindung des Herunterfahrens stattfindet.
            </summary>
  ...
  <Members>
    <Member MemberName="CloseAsync">
      ...
      <Docs>
        ...
        <summary>
            Dies schließt <see cref="T:Microsoft.Azure.Relay.HybridConnectionStream" /> -Instanz asynchron mit einem <see cref="T:System.Threading.CancellationToken" />.
            </summary>
    ...
    <Member MemberName="Dispose">
      ...
      <Docs>
        ...
        <summary>
            Dies schließt <see cref="T:Microsoft.Azure.Relay.HybridConnectionStream" /> Instanz.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnCloseAsync">
      ...
      <Docs>
        <param name="cancellationToken">Ein Abbruchtoken, das überwacht werden soll.</param>
        <summary>
            Abgeleitete Klassen implementieren die close-Logik in dieser Methode.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OnShutdownAsync">
      ...
      <Docs>
        <param name="cancellationToken">Ein Abbruchtoken, das überwacht werden soll.</param>
        <summary>
            Abgeleitete Klassen implementieren die Logik zum Herunterfahren bei dieser Methode.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ShutdownAsync">
      ...
      <Docs>
        <param name="cancellationToken">Ein Abbruchtoken, das überwacht werden soll.</param>
        <summary>
            Initiiert einen ordnungsgemäßen Schließen-Prozess heruntergefahren werden über diesen senden <see cref="T:Microsoft.Azure.Relay.HybridConnectionStream" />. So trennen Sie ordnungsgemäß und asynchron ShutdownAsync aufrufen, warten Sie, Lese-/ReadAsync mit 0 Byte lesen abgeschlossen ist, und rufen Sie schließlich Stream.CloseAsync();
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WriteMode">
      ...
      <Docs>
        <summary>
            Legt fest oder ruft die WriteMode für diesen Datenstrom ab. Standardmäßig wird WriteMode.Binary
            </summary>
