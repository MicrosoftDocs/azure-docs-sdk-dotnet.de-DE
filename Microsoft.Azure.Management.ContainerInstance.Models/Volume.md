<Type Name="Volume" FullName="Microsoft.Azure.Management.ContainerInstance.Models.Volume">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Volumes.</param>
        <param name="azureFile">Der Name des Azure-Dateidienst Volumes.</param>
        <param name="emptyDir">Das Volume leeren Verzeichnisses.</param>
        <summary>
            Initialisiert eine neue Instanz der Volume-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AzureFile">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Azure-Dateidienst Volumes fest.
            </summary>
    ...
    <Member MemberName="EmptyDir">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert das leere Verzeichnis Volume.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
