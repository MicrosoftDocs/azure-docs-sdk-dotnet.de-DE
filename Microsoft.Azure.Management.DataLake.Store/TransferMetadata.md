<Type Name="TransferMetadata" FullName="Microsoft.Azure.Management.DataLake.Store.TransferMetadata">
  ...
  <Members>
    ...
    <Member MemberName="EncodingCodePage">
      ...
      <Docs>
        <summary>
            Die CodePage der aktuellen Codierung ruft verwendet wird.
            </summary>
        <value>
             Die CodePage der aktuellen Codierung.
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="FileLength">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, der Länge (in Bytes) der Datei, die übertragen werden.
            </summary>
        <value>
            Die Länge der Datei.
            </value>
    ...
    <Member MemberName="IsBinary">
      ...
      <Docs>
        <summary>
            Ruft einen Wert, der angibt, ob die Übertragungsdatei als Binärdatei sollen oder nicht behandelt werden.
            </summary>
        <value>
    ...
    <Member MemberName="IsDownload">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob diese Instanz ein Download, anstatt eine Übertragung fest.
            </summary>
        <value>
    ...
    <Member MemberName="SegmentCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, dass die Anzahl der Segmente, die diese Datei ist zum Zweck der übertragen sie aufgeteilt.
            </summary>
        <value>
            Die Segmentanzahl.
            </value>
    ...
    <Member MemberName="SegmentLength">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, der Länge (in Bytes) der einzelnen Segmente der Datei (mit Ausnahme der letzten Zeile der geringer sein kann).
            </summary>
        <value>
    ...
    <Member MemberName="Segments">
      ...
      <Docs>
        <summary>
            Ruft einen Zeiger auf ein Array von Segment Metadaten ab. Die Segmente sind nach deren Segment-Anzahl (Reihenfolge) sortiert.
            </summary>
        <value>
            Die Segmente.
            </value>
    ...
    <Member MemberName="SegmentStreamDirectory">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, der Pfad des Verzeichnisses, in dem mittleren Segment Datenströme gespeichert werden.
            </summary>
        <value>
            Der Zielpfad Stream.
            </value>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, des aktuellen Übertragungsstatus für die Übertragung von diesen Dateien fest.
            Dieser Wert wird zum Ordner Übertragung ausgeführt und Fortsetzen von überprüft. Einzelne Dateien verwenden Übertragungen Segment-Status für die Überwachung.
            </summary>
        <value>
            Der Status.
            </value>
    ...
    <Member MemberName="TargetStreamPath">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, des vollständige Stream-Pfads, in dem die Datei übertragen werden sollen.
            </summary>
        <value>
            Der Zielpfad Stream.
            </value>
