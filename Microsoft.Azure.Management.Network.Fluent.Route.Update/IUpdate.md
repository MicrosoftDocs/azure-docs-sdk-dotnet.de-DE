<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.Route.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f12c0-101">Die gesamte ein Route-Update als Teil einer Aktualisierung einer Route.</span><span class="sxs-lookup"><span data-stu-id="f12c0-101">The entirety of a route update as part of a route table update.</span></span>
            </summary>
