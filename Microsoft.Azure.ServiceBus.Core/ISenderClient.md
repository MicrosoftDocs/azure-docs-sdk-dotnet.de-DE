<Type Name="ISenderClient" FullName="Microsoft.Azure.ServiceBus.Core.ISenderClient">
  ...
  <Docs>
    <summary>
            Schnittstelle, die allgemeine Sendefunktionen zwischen verschiedenen Clients definiert.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ScheduleMessageAsync">
      ...
      <Docs>
        ...
        <param name="scheduleEnqueueTimeUtc">Die UTC-Zeit, die die Nachricht zur Verarbeitung verfügbar sein sollen</param>
        <summary>
            Plant eine Meldung auf Service Bus angezeigt werden.
            </summary>
