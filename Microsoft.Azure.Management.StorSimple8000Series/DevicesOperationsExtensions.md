<Type Name="DevicesOperationsExtensions" FullName="Microsoft.Azure.Management.StorSimple8000Series.DevicesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für DevicesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="AuthorizeForServiceEncryptionKeyRollover">
      ...
      <Docs>
        ...
        <summary>
            Das angegebene Gerät für den Dienst Rollover des datenverschlüsselungsschlüssels wird autorisiert.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginConfigure">
      ...
      <Docs>
        ...
        <param name="parameters">
            Die minimale Eigenschaften ein Geräts zu konfigurieren.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Minimale Setup vor der Verwendung des Geräts abzuschließen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginFailover">
      ...
      <Docs>
        ...
        <param name="sourceDeviceName">
            Der Gerätename für die Quelle für den Failover ausgeführt wird.
            </param>
        <param name="parameters">
            FailoverRequest, enthält das Quellgerät und die Liste der volumecontainer Failover ausgeführt werden kann.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Failover einen Satz von volumecontainer aus einem angegebenen Quellgerät auf einem Zielgerät.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginInstallUpdates">
      ...
      <Docs>
        ...
        <summary>
            Heruntergeladen und installiert die Updates auf dem Gerät.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginScanForUpdates">
      ...
      <Docs>
        ...
        <summary>
            Sucht nach Updates auf dem Gerät.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="expand">
            $ Geben erweitern = Details, um weitere Felder, die im Zusammenhang mit dem Gerät oder $ Auffüllen erweitern = Rolloverdetails zusätzliche Felder, die im Zusammenhang mit dem Dienst Rollover des datenverschlüsselungsschlüssels auf Gerät ausgefüllt werden
            </param>
        <summary>
    ...
    <Member MemberName="GetUpdateSummary">
      ...
      <Docs>
        ...
        <summary>
            Gibt das Update des angegebenen Gerätenamens Zusammenfassung.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListFailoverSets">
      ...
      <Docs>
        ...
        <summary>
            Gibt alle failoversätze für ein bestimmtes Gerät und ihre Berechtigung für die Einbeziehung in die ein Failover zurück. Ein failoversatz bezieht sich auf einen Satz von volumecontainer aus, die als einzelne Einheit die Datenintegrität Failover werden müssen.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListFailoverTargets">
      ...
      <Docs>
        ...
        <param name="parameters">
            ListFailoverTargetsRequest mit der Liste der volumecontainer Failover ausgeführt werden kann.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Wenn Sie eine Liste der volumecontainer für Failover von einem Quellgerät ausgeführt werden, gibt diese Methode das Ergebnis Eligibility als failoverziel, für alle Geräte unter dieser Ressource.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Update">
      ...
      <Docs>
        ...
        <param name="parameters">
            Patch für die Darstellung des Geräts.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
