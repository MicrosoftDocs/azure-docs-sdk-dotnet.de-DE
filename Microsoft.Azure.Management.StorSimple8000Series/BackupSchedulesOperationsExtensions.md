<Type Name="BackupSchedulesOperationsExtensions" FullName="Microsoft.Azure.Management.StorSimple8000Series.BackupSchedulesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für BackupSchedulesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="backupScheduleName">
            Der Name des Sicherungszeitplan.
            </param>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <param name="backupScheduleName">
            Der Name der Sicherungszeitplan.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="backupScheduleName">
            Der Name der Sicherungszeitplan abgerufen werden sollen
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Ruft die Eigenschaften des angegebenen Sicherungszeitplan Namens ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByBackupPolicy">
      ...
      <Docs>
        ...
        <summary>
            Ruft alle Sicherungszeitpläne in einer Sicherungsrichtlinie.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
