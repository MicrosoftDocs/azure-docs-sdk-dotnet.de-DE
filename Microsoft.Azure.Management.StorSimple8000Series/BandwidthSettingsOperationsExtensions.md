<Type Name="BandwidthSettingsOperationsExtensions" FullName="Microsoft.Azure.Management.StorSimple8000Series.BandwidthSettingsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für BandwidthSettingsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="bandwidthSettingName">
            Der Name der Einstellung Bandbreite.
            </param>
        <param name="parameters">
            Die bandbreiteneinstellung hinzugefügt oder aktualisiert werden soll.
            </param>
        ...
        <summary>
            Erstellt oder aktualisiert die Einstellung für die Bandbreite
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <param name="bandwidthSettingName">
            Der Name der bandbreiteneinstellung für die.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Löscht die Einstellung für die Bandbreite
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="bandwidthSettingName">
            Der Name der Einstellung für die Bandbreite abgerufen werden sollen.
            </param>
        <param name="resourceGroupName">
            der Name der Ressourcengruppe
            </param>
        ...
        <summary>
            Gibt die Eigenschaften der angegebenen Bandbreite Einstellungsname zurück.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByManager">
      ...
      <Docs>
        ...
        <summary>
            Ruft alle bandbreiteneinstellung in einem Manager ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
