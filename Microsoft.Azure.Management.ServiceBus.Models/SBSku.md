<Type Name="SBSku" FullName="Microsoft.Azure.Management.ServiceBus.Models.SBSku">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SBSku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name dieser SKU. Folgende Werte sind möglich: "Basic", "Standard", "Premium"</param>
        <param name="tier">Die abrechnungsebene dieser bestimmten SKU.
            Folgende Werte sind möglich: "Basic", "Standard", "Premium"</param>
        <param name="capacity">Die angegebene messaging Einheiten für die Ebene.
            Kapazität für Premium-Dienstebene sind 1,2 und 4.</param>
        <summary>
            Initialisiert eine neue Instanz der SBSku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die angegebenen messaging Einheiten für die Ebene. Kapazität für Premium-Dienstebene sind 1,2 und 4.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen dieser SKU fest. Folgende Werte sind möglich: "Basic", "Standard", "Premium"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die abrechnungsebene dieser bestimmten SKU. Folgende Werte sind möglich: "Basic", "Standard", "Premium"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
