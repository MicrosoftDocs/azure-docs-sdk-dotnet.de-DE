<Type Name="SBNamespaceUpdateParameters" FullName="Microsoft.Azure.Management.ServiceBus.Models.SBNamespaceUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="87064-101">Die Beschreibung einer Ressource Namespace.</span><span class="sxs-lookup"><span data-stu-id="87064-101">Description of a namespace resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-102">Initialisiert eine neue Instanz der SBNamespaceUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="87064-102">Initializes a new instance of the SBNamespaceUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="87064-103">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="87064-103">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="87064-104">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="87064-104">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="87064-105">Ressourcentyp</span><span class="sxs-lookup"><span data-stu-id="87064-105">Resource type</span></span></param>
        <param name="location"><span data-ttu-id="87064-106">Speicherort von Ressourcen</span><span class="sxs-lookup"><span data-stu-id="87064-106">Resource location</span></span></param>
        <param name="tags"><span data-ttu-id="87064-107">Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="87064-107">Resource tags</span></span></param>
        <param name="sku"><span data-ttu-id="87064-108">Eigenschaften der Sku</span><span class="sxs-lookup"><span data-stu-id="87064-108">Porperties of Sku</span></span></param>
        <param name="provisioningState"><span data-ttu-id="87064-109">Der Bereitstellungsstatus des Namespaces.</span><span class="sxs-lookup"><span data-stu-id="87064-109">Provisioning state of the namespace.</span></span></param>
        <param name="createdAt"><span data-ttu-id="87064-110">Der Zeitpunkt, zu der Namespace erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="87064-110">The time the namespace was created.</span></span></param>
        <param name="updatedAt"><span data-ttu-id="87064-111">Der Zeitpunkt, zu der Namespace aktualisiert wurde.</span><span class="sxs-lookup"><span data-stu-id="87064-111">The time the namespace was updated.</span></span></param>
        <param name="serviceBusEndpoint"><span data-ttu-id="87064-112">Der Endpunkt, den Sie verwenden können, um Service Bus-Vorgänge auszuführen.</span><span class="sxs-lookup"><span data-stu-id="87064-112">Endpoint you can use to perform Service Bus operations.</span></span></param>
        <param name="metricId"><span data-ttu-id="87064-113">Bezeichner für die Azure Insights-Metriken</span><span class="sxs-lookup"><span data-stu-id="87064-113">Identifier for Azure Insights metrics</span></span></param>
        <summary>
            <span data-ttu-id="87064-114">Initialisiert eine neue Instanz der SBNamespaceUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="87064-114">Initializes a new instance of the SBNamespaceUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-115">Ruft die Zeit ab, an die der Namespace erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="87064-115">Gets the time the namespace was created.</span></span>
            </summary>
    ...
    <Member MemberName="MetricId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-116">Ruft den Bezeichner für Azure Insights-Metriken ab</span><span class="sxs-lookup"><span data-stu-id="87064-116">Gets identifier for Azure Insights metrics</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-117">Status des Namespaces ruft bereitgestellt werden.</span><span class="sxs-lookup"><span data-stu-id="87064-117">Gets provisioning state of the namespace.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceBusEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-118">Ruft die Endpunkt, den Sie verwenden können, um Service Bus-Vorgänge auszuführen.</span><span class="sxs-lookup"><span data-stu-id="87064-118">Gets endpoint you can use to perform Service Bus operations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-119">Ruft ab oder legt die Eigenschaften der Sku</span><span class="sxs-lookup"><span data-stu-id="87064-119">Gets or sets porperties of Sku</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-120">Ruft die Zeit ab, an die der Namespace aktualisiert wurde.</span><span class="sxs-lookup"><span data-stu-id="87064-120">Gets the time the namespace was updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87064-121">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="87064-121">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="87064-122">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="87064-122">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
