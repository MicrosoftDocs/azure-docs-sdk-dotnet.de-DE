<Type Name="CheckNameAvailability" FullName="Microsoft.Azure.Management.ServiceBus.Models.CheckNameAvailability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CheckNameAvailability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name, überprüfen Sie die Verfügbarkeit der Namespace-Namen und den Namespacenamen können nur Buchstaben, Zahlen und Bindestriche enthalten. Der Namespace muss mit einem Buchstaben beginnen und mit einem Buchstaben oder einer Ziffer enden.</param>
        <summary>
            Initialisiert eine neue Instanz der CheckNameAvailability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest, die nur der Name, überprüfen Sie die Verfügbarkeit der Namespace-Name und der Name des Namespaces enthalten können Buchstaben, Zahlen und Unterstriche.
            Der Namespace muss mit einem Buchstaben beginnen und mit einem Buchstaben oder einer Ziffer enden.
            </summary>
