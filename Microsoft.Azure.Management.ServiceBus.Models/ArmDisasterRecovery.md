  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="alternateName">Primäre/sekundäre Eventhub-Namespacenamen, GEO-DR-Pairning gehört</param>
    ...
    <Member MemberName="AlternateName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest primär/Sekundär Eventhub-Namespacenamen, GEO-DR-Pairning gehört
            </summary>
