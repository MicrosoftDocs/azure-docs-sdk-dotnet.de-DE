<Type Name="IotHubNotFoundException" FullName="Microsoft.Azure.Devices.Client.Exceptions.IotHubNotFoundException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="59be0-101">Die Ausnahme, die ausgelöst wird, wenn die IoT Hub-Instanz nicht gefunden wird.</span><span class="sxs-lookup"><span data-stu-id="59be0-101">The exception that is thrown when the IoT hub instance is not found.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="iotHubName"><span data-ttu-id="59be0-102">IoT Hub-Name, der nicht gefunden werden konnte.</span><span class="sxs-lookup"><span data-stu-id="59be0-102">IoT hub name that could not be found.</span></span></param>
        <summary>
            <span data-ttu-id="59be0-103">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Devices.Client.Exceptions.IotHubNotFoundException" /> Klasse bei der die Meldungszeichenfolge, die mit dem Namen der IoT Hub-Instanz, die nicht gefunden werden.</span><span class="sxs-lookup"><span data-stu-id="59be0-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.Devices.Client.Exceptions.IotHubNotFoundException" /> class with the message string containing the name of the IoT hub instance that couldn't be found.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="iotHubName"><span data-ttu-id="59be0-104">IoT Hub-Name, der nicht gefunden werden konnte.</span><span class="sxs-lookup"><span data-stu-id="59be0-104">IoT hub name that could not be found.</span></span></param>
        <param name="trackingId"><span data-ttu-id="59be0-105">Im Bezeichner für die Telemetrie nachverfolgen.</span><span class="sxs-lookup"><span data-stu-id="59be0-105">Tracking identifier for telemetry purposes.</span></span></param>
        <summary>
            <span data-ttu-id="59be0-106">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Devices.Client.Exceptions.IotHubNotFoundException" /> Klasse bei der die Meldungszeichenfolge, die mit dem Namen der IoT Hub-Instanz, die nicht gefunden werden.</span><span class="sxs-lookup"><span data-stu-id="59be0-106">Initializes a new instance of the <see cref="T:Microsoft.Azure.Devices.Client.Exceptions.IotHubNotFoundException" /> class with the message string containing the name of the IoT hub instance that couldn't be found.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
