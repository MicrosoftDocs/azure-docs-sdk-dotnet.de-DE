    ...
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.WindowsAzure.Management.StorSimple.IIscsiConnectionDetailsOperations.
            </param>
        <param name="deviceId">
            Erforderlich. Die Geräte-Id für die der Aufruf erfolgt.
            </param>
        <param name="customRequestHeaders">
            Erforderlich. Die benutzerdefinierte Anforderungsheader Client verwenden kann.
            </param>
