    ...
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.WindowsAzure.Management.StorSimple.IDevicePublicKeyOperations.
            </param>
        <param name="deviceId">
            Erforderlich. Die Geräte-Id, die wir den öffentlichen Schlüssel des Geräts abgerufen müssen.
            </param>
