  ...
  <Members>
    <Member MemberName="BeginCreating">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.WindowsAzure.Management.StorSimple.IServiceConfigurationOperations.
            </param>
        <param name="serviceConfiguration">
            Erforderlich. Parameter für das Erstellen von Speicherkonto beginnen zur Verfügung gestellt.
            </param>
        <param name="customRequestHeaders">
            Erforderlich. Die benutzerdefinierte Anforderungsheader Client verwenden muss.
            </param>
        <summary>
            Der beginnen Erstellen von Speicherkonto-Vorgang erstellt ein neues Speicherkonto in Azure.
            </summary>
        <returns>
    ...
    <Member MemberName="Create">
      ...
      <Docs>
        ...
        <param name="serviceConfiguration">
            Erforderlich. Parameter für das Speicherkonto erstellen zur Verfügung gestellt.
            </param>
        <param name="customRequestHeaders">
            Erforderlich. Die benutzerdefinierte Anforderungsheader Client verwenden muss.
            </param>
