<Type Name="IWithLoadBalancer" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkInterface.Update.IWithLoadBalancer">
  ...
  <Docs>
    <summary>
            Die Phase des Netzwerk-Schnittstelle Updates ermöglicht es einem Lastenausgleichsmodul zugeordnet ist.
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingLoadBalancerBackend">
      ...
      <Docs>
        ...
        <summary>
            Ordnet ein Back-End für einen vorhandenen Load Balancer der Netzwerkschnittstelle primäre IP-Konfiguration zu.
            </summary>
    ...
    <Member MemberName="WithExistingLoadBalancerInboundNatRule">
      ...
      <Docs>
        ...
        <summary>
            Ordnet eine NAT-Regel für einen vorhandenen Load Balancer der Netzwerkschnittstelle primäre IP-Konfiguration zu.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase des Updates.</return>
    ...
    <Member MemberName="WithoutLoadBalancerBackends">
      ...
      <Docs>
        <summary>
            Entfernt alle bestehenden Verknüpfungen mit alle Load Balancer-Back-Ends.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase des Updates.</return>
    ...
    <Member MemberName="WithoutLoadBalancerInboundNatRules">
      ...
      <Docs>
        <summary>
            Entfernt alle bestehenden Verknüpfungen mit allen lastenausgleichsmodulen eingehende NAT-Regeln.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase des Updates.</return>
