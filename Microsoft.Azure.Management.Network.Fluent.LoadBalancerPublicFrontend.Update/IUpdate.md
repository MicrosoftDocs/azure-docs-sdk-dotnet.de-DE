<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerPublicFrontend.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="05e7d-101">Die gesamte eine öffentliche Front-End-Update als Teil eines Internetzugriff Load Balancer-Updates.</span><span class="sxs-lookup"><span data-stu-id="05e7d-101">The entirety of a public frontend update as part of an Internet-facing load balancer update.</span></span>
            </summary>
