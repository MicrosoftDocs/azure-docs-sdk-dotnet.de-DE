<Type Name="MemberAccessNode" FullName="Microsoft.WindowsAzure.MobileServices.Query.MemberAccessNode">
  ...
  <Docs>
    <summary>
            Knoten, die einen Zugriff auf einen Memberwert darstellt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="instance">Die Instanz auf Member zugreifen.</param>
        <param name="memberName">Der Elementname auf.</param>
        <summary>
            Initialisiert eine Instanz von<see cref="T:Microsoft.WindowsAzure.MobileServices.Query.MemberAccessNode" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Instance">
      ...
      <Docs>
        <summary>
            Die Instanz auf Member zugreifen.
            </summary>
    ...
    <Member MemberName="MemberName">
      ...
      <Docs>
        <summary>
            Ruft den Zugriff auf den Elementnamen ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
