<Type Name="FunctionCallNode" FullName="Microsoft.WindowsAzure.MobileServices.Query.FunctionCallNode">
  ...
  <Docs>
    <summary>
            Knoten, der einen Funktionsaufruf darstellt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der aufzurufenden Funktion.</param>
        <param name="arguments">Die Liste der Argumente für diesen Funktionsaufruf.</param>
        <summary>
            Initialisiert eine Instanz von<see cref="T:Microsoft.WindowsAzure.MobileServices.Query.FunctionCallNode" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Arguments">
      ...
      <Docs>
        <summary>
            Ruft die Liste der Argumente für diesen Funktionsaufruf ab.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft den Namen der aufzurufenden Funktion ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
