<Type Name="EdgeNGramTokenFilterV2" FullName="Microsoft.Azure.Search.Models.EdgeNGramTokenFilterV2">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2c983-101">N-gramme richtet, der den angegebenen VM-Größe(n) ab Anfang oder Ende ein Eingabetoken wird generiert.</span><span class="sxs-lookup"><span data-stu-id="2c983-101">Generates n-grams of the given size(s) starting from the front or the back of an input token.</span></span> <span data-ttu-id="2c983-102">Dieser Filter token wird mithilfe von Apache Lucene implementiert.</span><span class="sxs-lookup"><span data-stu-id="2c983-102">This token filter is implemented using Apache Lucene.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c983-103">Initialisiert eine neue Instanz der EdgeNGramTokenFilterV2-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2c983-103">Initializes a new instance of the EdgeNGramTokenFilterV2 class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="2c983-104">Der Name des Filters token.</span><span class="sxs-lookup"><span data-stu-id="2c983-104">The name of the token filter.</span></span> <span data-ttu-id="2c983-105">Es darf nur Buchstaben, Ziffern, Leerzeichen, Bindestriche oder Unterstriche enthalten, beginnen und enden mit alphanumerischen Zeichen enthalten und ist auf 128 Zeichen beschränkt.</span><span class="sxs-lookup"><span data-stu-id="2c983-105">It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters.</span></span></param>
        <param name="minGram"><span data-ttu-id="2c983-106">Die Mindestlänge für die n-gramme.</span><span class="sxs-lookup"><span data-stu-id="2c983-106">The minimum n-gram length.</span></span> <span data-ttu-id="2c983-107">Der Standardwert ist 1.</span><span class="sxs-lookup"><span data-stu-id="2c983-107">Default is 1.</span></span>
            <span data-ttu-id="2c983-108">Höchstwert beträgt 300.</span><span class="sxs-lookup"><span data-stu-id="2c983-108">Maximum is 300.</span></span> <span data-ttu-id="2c983-109">Kleiner als der Wert des MaxGram muss sein.</span><span class="sxs-lookup"><span data-stu-id="2c983-109">Must be less than the value of maxGram.</span></span></param>
        <param name="maxGram"><span data-ttu-id="2c983-110">Die maximale Länge von n-gramme.</span><span class="sxs-lookup"><span data-stu-id="2c983-110">The maximum n-gram length.</span></span> <span data-ttu-id="2c983-111">Standard ist 2.</span><span class="sxs-lookup"><span data-stu-id="2c983-111">Default is 2.</span></span>
            <span data-ttu-id="2c983-112">Höchstwert beträgt 300.</span><span class="sxs-lookup"><span data-stu-id="2c983-112">Maximum is 300.</span></span></param>
        <param name="side"><span data-ttu-id="2c983-113">Gibt an, welche Seite der Eingabe aus der n-gramme generiert werden soll.</span><span class="sxs-lookup"><span data-stu-id="2c983-113">Specifies which side of the input the n-gram should be generated from.</span></span> <span data-ttu-id="2c983-114">Der Standardwert ist "front".</span><span class="sxs-lookup"><span data-stu-id="2c983-114">Default is "front".</span></span> <span data-ttu-id="2c983-115">Folgende Werte sind möglich: "-LEDs des vorderen", "zurück"</span><span class="sxs-lookup"><span data-stu-id="2c983-115">Possible values include: 'front', 'back'</span></span></param>
        <summary>
            <span data-ttu-id="2c983-116">Initialisiert eine neue Instanz der EdgeNGramTokenFilterV2-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2c983-116">Initializes a new instance of the EdgeNGramTokenFilterV2 class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MaxGram">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c983-117">Ruft ab oder legt die maximale Länge von n-gramme.</span><span class="sxs-lookup"><span data-stu-id="2c983-117">Gets or sets the maximum n-gram length.</span></span> <span data-ttu-id="2c983-118">Standard ist 2.</span><span class="sxs-lookup"><span data-stu-id="2c983-118">Default is 2.</span></span> <span data-ttu-id="2c983-119">Maximal:</span><span class="sxs-lookup"><span data-stu-id="2c983-119">Maximum is</span></span>
            300.
            </summary>
    ...
    <Member MemberName="MinGram">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c983-120">Ruft ab oder legt die minimale Länge von n-gramme.</span><span class="sxs-lookup"><span data-stu-id="2c983-120">Gets or sets the minimum n-gram length.</span></span> <span data-ttu-id="2c983-121">Der Standardwert ist 1.</span><span class="sxs-lookup"><span data-stu-id="2c983-121">Default is 1.</span></span> <span data-ttu-id="2c983-122">Maximal:</span><span class="sxs-lookup"><span data-stu-id="2c983-122">Maximum is</span></span>
            300. <span data-ttu-id="2c983-123">Kleiner als der Wert des MaxGram muss sein.</span><span class="sxs-lookup"><span data-stu-id="2c983-123">Must be less than the value of maxGram.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Side">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c983-124">Ruft ab oder legt gibt an, welche Seite der Eingabe aus der n-gramme generiert werden soll.</span><span class="sxs-lookup"><span data-stu-id="2c983-124">Gets or sets specifies which side of the input the n-gram should be generated from.</span></span> <span data-ttu-id="2c983-125">Der Standardwert ist "front".</span><span class="sxs-lookup"><span data-stu-id="2c983-125">Default is "front".</span></span> <span data-ttu-id="2c983-126">Folgende Werte sind möglich: "-LEDs des vorderen", "zurück"</span><span class="sxs-lookup"><span data-stu-id="2c983-126">Possible values include: 'front', 'back'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c983-127">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="2c983-127">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="2c983-128">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="2c983-128">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
