<Type Name="NGramTokenizer" FullName="Microsoft.Azure.Search.Models.NGramTokenizer">
  ...
  <Docs>
    <summary>
            Der zu indizierende der Eingabe in n-Grams der angegebenen Größe. Diese Tokenizer wird mithilfe von Apache Lucene implementiert.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der NGramTokenizer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tokenChars">Zeichenklassen in den Token beibehalten.</param>
        <summary>
            Initialisiert eine neue Instanz der NGramTokenizer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TokenChars">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Zeichenklassen in den Token beibehalten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
