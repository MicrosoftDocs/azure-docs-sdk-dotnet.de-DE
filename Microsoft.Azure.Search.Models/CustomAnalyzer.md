<Type Name="CustomAnalyzer" FullName="Microsoft.Azure.Search.Models.CustomAnalyzer">
  ...
  <Docs>
    <summary>
            Können Sie die Kontrolle über den Prozess der Konvertierung von Text in indizierbaren/durchsuchbaren Token nutzen. Es ist eine benutzerdefinierte Konfiguration besteht aus einer einzelnen vordefinierten Tokenizer und ein oder mehrere Filter.
            Der Tokenizer ist verantwortlich für Zerlegen von Text in Token und die Filter für das Ändern von Tokens ausgegeben, die für den Tokenizer.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CustomAnalyzer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tokenizer">Der Name des tokenizers zum Dividieren von fortlaufenden Textbereich in eine Folge von Token, wie einen Satz in Wörter unterteilt.</param>
        <param name="tokenFilters">Eine Liste von token filtern, die zum herausfiltern oder ändern die Token, die durch einen Tokenizer verwendet werden soll. Sie können beispielsweise einen Filter für Kleinbuchstaben angeben, mit dem alle Zeichen in Kleinbuchstaben konvertiert werden. Die Filter werden in der Reihenfolge ausgeführt, in denen sie aufgelistet sind.</param>
        <param name="charFilters">Eine Liste von Zeichen Filter verwendet, um Eingabetext vorzubereiten, bevor die Verarbeitung durch den Tokenizer. Sie können z. B. bestimmte Zeichen oder Symbole ersetzen. Die Filter werden in der Reihenfolge ausgeführt, in denen sie aufgelistet sind.</param>
        <summary>
            Initialisiert eine neue Instanz der CustomAnalyzer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CharFilters">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste von Zeichen Filtern verwendet, um Eingabetext vorzubereiten, bevor die Verarbeitung durch den Tokenizer. Sie können z. B. bestimmte Zeichen oder Symbole ersetzen. Die Filter werden in der Reihenfolge ausgeführt, in denen sie aufgelistet sind.
            </summary>
    ...
    <Member MemberName="TokenFilters">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste von token filtern, die zum herausfiltern oder ändern die Token, die durch einen Tokenizer verwendet. Sie können beispielsweise einen Filter für Kleinbuchstaben angeben, mit dem alle Zeichen in Kleinbuchstaben konvertiert werden. Die Filter werden in der Reihenfolge ausgeführt, in denen sie aufgelistet sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tokenizer">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des tokenizers zum Dividieren von fortlaufenden Textbereich in eine Folge von Token, wie einen Satz in Wörter unterteilt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
