<Type Name="CorsOptions" FullName="Microsoft.Azure.Search.Models.CorsOptions">
  ...
  <Docs>
    <summary>
            Definiert Optionen steuern Cross-Origin Resource Sharing (CORS) für einen Index an.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CorsOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allowedOrigins">Die Liste der Ursprünge, die aus dem, die JavaScript Code Zugriff auf Ihren Index gewährt wird. :// Können enthalten eine Liste der Hosts im Format {Protokoll} {vollständig-qualified-Domain-Name} [: {Port#}], oder eine einzelne ' *' alle Ursprünge (nicht empfohlen) erlaubt.</param>
        <param name="maxAgeInSeconds">Die Dauer, für die CORS-preflight-Antworten Browser zwischengespeichert werden soll. Der Standardwert ist 5 Minuten.</param>
        <summary>
            Initialisiert eine neue Instanz der CorsOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AllowedOrigins">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Ursprünge, die von denen JavaScript-Code Zugriff auf Ihren Index gewährt wird. :// Können enthalten eine Liste der Hosts im Format {Protokoll} {vollständig-qualified-Domain-Name} [: {Port#}], oder eine einzelne ' *' alle Ursprünge (nicht empfohlen) erlaubt.
            </summary>
    ...
    <Member MemberName="MaxAgeInSeconds">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Dauer für die CORS-preflight-Antworten Browser zwischengespeichert werden soll. Der Standardwert ist 5 Minuten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
