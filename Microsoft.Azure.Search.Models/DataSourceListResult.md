<Type Name="DataSourceListResult" FullName="Microsoft.Azure.Search.Models.DataSourceListResult">
  ...
  <Docs>
    <summary>
            Die Antwort von einer Anforderung zum Auflisten von Datenquellen. Bei erfolgreicher Ausführung umfasst sie die vollständigen Definitionen aller Datenquellen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DataSourceListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dataSources">Die Datenquellen im Suchdienst.</param>
        <summary>
            Initialisiert eine neue Instanz der DataSourceListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DataSources">
      ...
      <Docs>
        <summary>
            Ruft die Datenquellen im Suchdienst ab.
            </summary>
