<Type Name="Indexer" FullName="Microsoft.Azure.Search.Models.Indexer">
  ...
  <Docs>
    <summary>
            Stellt einen Azure Search-Indexer dar.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Indexer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Indexers.</param>
        <param name="dataSourceName">Der Name der Datenquelle, aus der dieser Indexer Daten liest.</param>
        <param name="targetIndexName">Der Name des Indexes, der dieser Indexer Daten schreibt.</param>
        <param name="description">Die Beschreibung des Indexers.</param>
        <param name="schedule">Der Zeitplan für diesen Indexer.</param>
        <param name="parameters">Parameter für die indexerausführung.</param>
        <param name="fieldMappings">Definiert die Zuordnungen zwischen Feldern in der Datenquelle und den entsprechenden Ziel in den Index.</param>
        <param name="isDisabled">Ein Wert, der angibt, ob der Indexer deaktiviert ist. Die Standardeinstellung ist "false".</param>
        <param name="eTag">Das ETag des Indexers.</param>
        <summary>
            Initialisiert eine neue Instanz der Indexer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DataSourceName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Datenquelle, aus der dieser Indexer Daten liest.
            </summary>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Beschreibung des Indexers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das ETag des Indexers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FieldMappings">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest definiert Zuordnungen zwischen Feldern in der Datenquelle und den entsprechenden Ziel im Index.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDisabled">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob der Indexer deaktiviert ist.
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Indexers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Parameter für die indexerausführung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Schedule">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Zeitplan für diesen Indexer.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetIndexName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Indexes, der dieser Indexer Daten schreibt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
