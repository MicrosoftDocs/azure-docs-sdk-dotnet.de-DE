<Type Name="DocumentSuggestResult&lt;T&gt;" FullName="Microsoft.Azure.Search.Models.DocumentSuggestResult&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T">
            <span data-ttu-id="9dd0e-101">Die CLR-Typ, der dem IndexSchema zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="9dd0e-101">The CLR type that maps to the index schema.</span></span> <span data-ttu-id="9dd0e-102">Instanzen dieses Typs können als Dokumente aus dem Index abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="9dd0e-102">Instances of this type can be retrieved as documents from the index.</span></span>
            </typeparam>
    <summary>
            <span data-ttu-id="9dd0e-103">Antwort mit vorschlagsabfrage ergibt sich aus einem Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="9dd0e-103">Response containing suggestion query results from an Azure Search index.</span></span>
            </summary>
