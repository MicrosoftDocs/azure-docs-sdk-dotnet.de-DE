<Type Name="PatternAnalyzer" FullName="Microsoft.Azure.Search.Models.PatternAnalyzer">
  ...
  <Docs>
    <summary>
            ...
            Diese Analyzer wird mithilfe von Apache Lucene implementiert.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der PatternAnalyzer-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="lowerCaseTerms">Ein Wert, der angibt, ob die Begriffe untere-Schreibweise verwendet werden soll. Der Standardwert ist true.</param>
    ...
    <Member MemberName="LowerCaseTerms">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Begriffe untere-Schreibweise verwendet werden soll. Der Standardwert ist true.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
