<Type Name="SnowballTokenFilter" FullName="Microsoft.Azure.Search.Models.SnowballTokenFilter">
  ...
  <Docs>
    <summary>
            Ein Filter, der Wörter, wobei eine wortstammerkennung Snowball generierte resultiert. Dieser Filter token wird mithilfe von Apache Lucene implementiert.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SnowballTokenFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="language">Die zu verwendende Sprache. Folgende Werte sind möglich: "Armenisch", "Baskisch", "Katalanisch", "dänische", "Niederländisch", "english", "Finnisch", "Französisch", "Deutsch", "german2", "Ungarisch", "Italienisch", "Kp", "Lovins',"Norwegisch","Porter","Portugiesisch","Rumänisch","Russisch","Spanisch"," Schwedisch ","Türkisch"</param>
        <summary>
            Initialisiert eine neue Instanz der SnowballTokenFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Language">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die zu verwendende Sprache. Folgende Werte sind möglich: "Armenisch", "Baskisch", "Katalanisch", "dänische", "Niederländisch", "english", "Finnisch", "Französisch", "Deutsch", "german2", "Ungarisch", "Italienisch", "Kp", "Lovins',"Norwegisch","Porter","Portugiesisch","Rumänisch","Russisch","Spanisch"," Schwedisch ","Türkisch"
            </summary>
