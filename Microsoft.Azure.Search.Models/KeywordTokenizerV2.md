<Type Name="KeywordTokenizerV2" FullName="Microsoft.Azure.Search.Models.KeywordTokenizerV2">
  ...
  <Docs>
    <summary>
            Gibt die gesamte Eingabe als einzelnes Token aus. Diese Tokenizer wird mithilfe von Apache Lucene implementiert.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeywordTokenizerV2-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="maxTokenLength">Die maximale Tokenlänge. Standardwert ist
            256. Token, die die maximale Länge überschreiten, werden geteilt. Die maximale Tokenlänge, die verwendet werden kann, beträgt 300 Zeichen.</param>
        <summary>
            Initialisiert eine neue Instanz der KeywordTokenizerV2-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MaxTokenLength">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Tokenlänge. Standardwert ist 256. Token, die die maximale Länge überschreiten, werden geteilt. Die maximale Tokenlänge, die verwendet werden kann, beträgt 300 Zeichen.
            </summary>
