<Type Name="IResourceWithETag" FullName="Microsoft.Azure.Search.Models.IResourceWithETag">
  ...
  <Docs>
    <summary>
             <span data-ttu-id="29821-101">Modellklassen, die diese Schnittstelle implementieren darstellen, Ressourcen, die mit einem ETag-Version auf dem Server beibehalten werden.</span><span class="sxs-lookup"><span data-stu-id="29821-101">Model classes that implement this interface represent resources that are persisted with an ETag version on the server.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29821-102">Ruft den ETag-Wert für die Ressource ab.</span><span class="sxs-lookup"><span data-stu-id="29821-102">Gets the ETag value for the resource.</span></span>
            </summary>
