<Type Name="TextWeights" FullName="Microsoft.Azure.Search.Models.TextWeights">
  ...
  <Docs>
    <summary>
            Gewichtungen definiert für die Übereinstimmungen erhöhen soll in Suchabfragen Bewertung Indexfelder.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TextWeights-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="weights">Das Wörterbuch von Dokument Bewertung zur Verbesserung der pro feldgewichtungen. Die Schlüssel sind die Feldnamen, und die Werte sind die Gewichtungen für jedes Feld.</param>
        <summary>
            Initialisiert eine neue Instanz der TextWeights-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Weights">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert das Wörterbuch der zur Verbesserung der Bewertung Dokument pro feldgewichtungen. Die Schlüssel sind die Feldnamen, und die Werte sind die Gewichtungen für jedes Feld.
            </summary>
