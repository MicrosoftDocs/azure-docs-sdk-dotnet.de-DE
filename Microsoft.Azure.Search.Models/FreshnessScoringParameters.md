<Type Name="FreshnessScoringParameters" FullName="Microsoft.Azure.Search.Models.FreshnessScoringParameters">
  ...
  <Docs>
    <summary>
            Stellt die Parameterwerte in einer Bewertungsfunktion Aktualität.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FreshnessScoringParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="boostingDuration">Der Ablaufzeitraum nach der die Verstärkung für ein bestimmtes Dokument beendet wird.</param>
        <summary>
            Initialisiert eine neue Instanz der FreshnessScoringParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BoostingDuration">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Ablaufzeitraum nach der die Verstärkung für ein bestimmtes Dokument beendet wird.
            </summary>
