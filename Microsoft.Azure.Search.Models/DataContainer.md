<Type Name="DataContainer" FullName="Microsoft.Azure.Search.Models.DataContainer">
  ...
  <Docs>
    <summary>
            Stellt Informationen zur Entität (z. B. Azure SQL-Tabelle oder DocumentDb-Auflistung), die indiziert werden.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Tabelle oder Sicht (für Azure SQL-Datenquelle) oder Auflistung (für eine DocumentDB-Datenquelle), die indiziert werden.</param>
        <param name="query">Eine Abfrage, die auf diesen Datencontainer angewendet wird.
            Die Syntax und die Bedeutung dieses Parameters ist Datenquelle spezifisch.
            Von Azure SQL-Datenquellen unterstützt nicht.</param>
        <summary>
            Initialisiert eine neue Instanz der "DataContainer"-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Tabelle oder Sicht (für Azure SQL-Datenquelle) oder Auflistung (für eine DocumentDB-Datenquelle), die indiziert werden.
            </summary>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Abfrage, die auf diesen Datencontainer angewendet wird. Die Syntax und die Bedeutung dieses Parameters ist Datenquelle spezifisch. Von Azure SQL-Datenquellen unterstützt nicht.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
