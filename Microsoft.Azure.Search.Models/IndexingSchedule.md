<Type Name="IndexingSchedule" FullName="Microsoft.Azure.Search.Models.IndexingSchedule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e7f5-101">Stellt einen Zeitplan für die indexerausführung dar.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-101">Represents a schedule for indexer execution.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7f5-102">Initialisiert eine neue Instanz der "indexingschedule"-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-102">Initializes a new instance of the IndexingSchedule class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="interval"><span data-ttu-id="7e7f5-103">Das Zeitintervall zwischen den indexerausführungen.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-103">The interval of time between indexer executions.</span></span></param>
        <param name="startTime"><span data-ttu-id="7e7f5-104">Die Uhrzeit, nach ein Indexer sollten gestartet, ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-104">The time when an indexer should start running.</span></span></param>
        <summary>
            <span data-ttu-id="7e7f5-105">Initialisiert eine neue Instanz der "indexingschedule"-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-105">Initializes a new instance of the IndexingSchedule class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Interval">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7f5-106">Ruft ab oder legt das Zeitintervall zwischen den indexerausführungen fest.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-106">Gets or sets the interval of time between indexer executions.</span></span>
            </summary>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7f5-107">Ruft ab oder legt die Uhrzeit, nach ein Indexer sollten gestartet, ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-107">Gets or sets the time when an indexer should start running.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7f5-108">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="7e7f5-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="7e7f5-109">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="7e7f5-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
