<Type Name="StopwordsTokenFilter" FullName="Microsoft.Azure.Search.Models.StopwordsTokenFilter">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="571b5-101">Entfernt Stoppwörter einen token Stream heraus.</span><span class="sxs-lookup"><span data-stu-id="571b5-101">Removes stop words from a token stream.</span></span> <span data-ttu-id="571b5-102">Dieser Filter token wird mithilfe von Apache Lucene implementiert.</span><span class="sxs-lookup"><span data-stu-id="571b5-102">This token filter is implemented using Apache Lucene.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-103">Initialisiert eine neue Instanz der StopwordsTokenFilter-Klasse.</span><span class="sxs-lookup"><span data-stu-id="571b5-103">Initializes a new instance of the StopwordsTokenFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="571b5-104">Der Name des Filters token.</span><span class="sxs-lookup"><span data-stu-id="571b5-104">The name of the token filter.</span></span> <span data-ttu-id="571b5-105">Es darf nur Buchstaben, Ziffern, Leerzeichen, Bindestriche oder Unterstriche enthalten, beginnen und enden mit alphanumerischen Zeichen enthalten und ist auf 128 Zeichen beschränkt.</span><span class="sxs-lookup"><span data-stu-id="571b5-105">It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters.</span></span></param>
        <param name="stopwords"><span data-ttu-id="571b5-106">Die Liste von Stoppwörtern.</span><span class="sxs-lookup"><span data-stu-id="571b5-106">The list of stopwords.</span></span> <span data-ttu-id="571b5-107">Diese Eigenschaft und die Stoppwörter List-Eigenschaft können sowohl festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="571b5-107">This property and the stopwords list property cannot both be set.</span></span></param>
        <param name="stopwordsList"><span data-ttu-id="571b5-108">Eine vordefinierte Liste von Stoppwörtern verwenden.</span><span class="sxs-lookup"><span data-stu-id="571b5-108">A predefined list of stopwords to use.</span></span>
            <span data-ttu-id="571b5-109">Diese Eigenschaft und die Stoppwörter-Eigenschaft können sowohl festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="571b5-109">This property and the stopwords property cannot both be set.</span></span>
            <span data-ttu-id="571b5-110">Standardmäßig ist Englisch.</span><span class="sxs-lookup"><span data-stu-id="571b5-110">Default is English.</span></span> <span data-ttu-id="571b5-111">Folgende Werte sind möglich: "Arabische", "Armenisch", "Baskisch", "Portugiesisch (Brasilien)", "Bulgarisch", "Katalanisch", "Tschechische", "dänische", "Niederländisch", "english", "Finnisch", "Französisch", "Galizisch", "Deutsch", "griechischen", "Hindi", "Ungarisch", "Indonesisch", "Irisch", "Italienisch", " Lettisch ","Norwegisch","persischen"," Portugiesisch","Rumänisch","Russisch","Sorani","Spanische","Schwedisch","thai","Türkisch"</span><span class="sxs-lookup"><span data-stu-id="571b5-111">Possible values include: 'arabic', 'armenian', 'basque', 'brazilian', 'bulgarian', 'catalan', 'czech', 'danish', 'dutch', 'english', 'finnish', 'french', 'galician', 'german', 'greek', 'hindi', 'hungarian', 'indonesian', 'irish', 'italian', 'latvian', 'norwegian', 'persian', 'portuguese', 'romanian', 'russian', 'sorani', 'spanish', 'swedish', 'thai', 'turkish'</span></span></param>
        <param name="ignoreCase"><span data-ttu-id="571b5-112">Ein Wert, der angibt, ob Groß-und Kleinschreibung.</span><span class="sxs-lookup"><span data-stu-id="571b5-112">A value indicating whether to ignore case.</span></span>
            <span data-ttu-id="571b5-113">Bei "true", werden alle Wörter zuerst in Kleinbuchstaben konvertiert.</span><span class="sxs-lookup"><span data-stu-id="571b5-113">If true, all words are converted to lower case first.</span></span> <span data-ttu-id="571b5-114">Die Standardeinstellung ist "false".</span><span class="sxs-lookup"><span data-stu-id="571b5-114">Default is false.</span></span></param>
        <param name="removeTrailingStopWords"><span data-ttu-id="571b5-115">Ein Wert, der angibt, ob den letzten Suchbegriff ignoriert werden sollen, wenn es sich um ein Stoppwort ist.</span><span class="sxs-lookup"><span data-stu-id="571b5-115">A value indicating whether to ignore the last search term if it's a stop word.</span></span> <span data-ttu-id="571b5-116">Der Standardwert ist true.</span><span class="sxs-lookup"><span data-stu-id="571b5-116">Default is true.</span></span></param>
        <summary>
            <span data-ttu-id="571b5-117">Initialisiert eine neue Instanz der StopwordsTokenFilter-Klasse.</span><span class="sxs-lookup"><span data-stu-id="571b5-117">Initializes a new instance of the StopwordsTokenFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IgnoreCase">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-118">Ruft ab oder legt einen Wert, der angibt, ob Groß-und Kleinschreibung.</span><span class="sxs-lookup"><span data-stu-id="571b5-118">Gets or sets a value indicating whether to ignore case.</span></span> <span data-ttu-id="571b5-119">Bei "true", werden alle Wörter zuerst in Kleinbuchstaben konvertiert.</span><span class="sxs-lookup"><span data-stu-id="571b5-119">If true, all words are converted to lower case first.</span></span> <span data-ttu-id="571b5-120">Die Standardeinstellung ist "false".</span><span class="sxs-lookup"><span data-stu-id="571b5-120">Default is false.</span></span>
            </summary>
    ...
    <Member MemberName="RemoveTrailingStopWords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-121">Ruft ab oder legt einen Wert, der angibt, ob den letzten Suchbegriff ignoriert werden sollen, wenn es sich um ein Stoppwort ist.</span><span class="sxs-lookup"><span data-stu-id="571b5-121">Gets or sets a value indicating whether to ignore the last search term if it's a stop word.</span></span> <span data-ttu-id="571b5-122">Der Standardwert ist true.</span><span class="sxs-lookup"><span data-stu-id="571b5-122">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Stopwords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-123">Ruft ab oder legt die Liste mit Stoppwörtern fest.</span><span class="sxs-lookup"><span data-stu-id="571b5-123">Gets or sets the list of stopwords.</span></span> <span data-ttu-id="571b5-124">Diese Eigenschaft und die Stoppwörter List-Eigenschaft können sowohl festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="571b5-124">This property and the stopwords list property cannot both be set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StopwordsList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-125">Ruft ab, oder legt ihn fest eine vordefinierte Liste von Stoppwörtern verwenden.</span><span class="sxs-lookup"><span data-stu-id="571b5-125">Gets or sets a predefined list of stopwords to use.</span></span> <span data-ttu-id="571b5-126">Diese Eigenschaft und die Stoppwörter-Eigenschaft können sowohl festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="571b5-126">This property and the stopwords property cannot both be set.</span></span> <span data-ttu-id="571b5-127">Standardmäßig ist Englisch.</span><span class="sxs-lookup"><span data-stu-id="571b5-127">Default is English.</span></span>
            <span data-ttu-id="571b5-128">Folgende Werte sind möglich: "Arabische", "Armenisch", "Baskisch", "Portugiesisch (Brasilien)", "Bulgarisch", "Katalanisch", "Tschechische", "dänische", "Niederländisch", "english", "Finnisch", "Französisch", "Galizisch", "Deutsch", "griechischen", "Hindi", "Ungarisch", "Indonesisch", "Irisch", "Italienisch", " Lettisch ","Norwegisch","persischen"," Portugiesisch","Rumänisch","Russisch","Sorani","Spanische","Schwedisch","thai","Türkisch"</span><span class="sxs-lookup"><span data-stu-id="571b5-128">Possible values include: 'arabic', 'armenian', 'basque', 'brazilian', 'bulgarian', 'catalan', 'czech', 'danish', 'dutch', 'english', 'finnish', 'french', 'galician', 'german', 'greek', 'hindi', 'hungarian', 'indonesian', 'irish', 'italian', 'latvian', 'norwegian', 'persian', 'portuguese', 'romanian', 'russian', 'sorani', 'spanish', 'swedish', 'thai', 'turkish'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="571b5-129">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="571b5-129">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="571b5-130">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="571b5-130">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
