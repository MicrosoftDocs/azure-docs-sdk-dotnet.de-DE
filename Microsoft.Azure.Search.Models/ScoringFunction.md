<Type Name="ScoringFunction" FullName="Microsoft.Azure.Search.Models.ScoringFunction">
  ...
  <Docs>
    <summary>
            Abstrakte Basisklasse für Funktionen, die während der Rangfolge Dokument Bewertungen ändern können.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ScoringFunction-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Boost">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Multiplikator für die rohbewertung. Muss eine positive Zahl sein nicht gleich 1.0.
            </summary>
    ...
    <Member MemberName="FieldName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Felds verwendet als Eingabe für die Bewertungsfunktion fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Interpolation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, wie das Verstärkung über Dokument Bewertungen interpoliert werden wird. Der Standardwert ist "Linear". Folgende Werte sind möglich: "linear", "konstant", "quadratische", "logarithmisch"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
