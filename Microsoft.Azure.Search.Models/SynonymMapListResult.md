<Type Name="SynonymMapListResult" FullName="Microsoft.Azure.Search.Models.SynonymMapListResult">
  ...
  <Docs>
    <summary>
            Die Antwort aus einer Liste SynonymMaps-Anforderung. Bei erfolgreicher Ausführung umfasst sie die vollständigen Definitionen aller Synonym Zuordnungen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SynonymMapListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="synonymMaps">Das Synonym wird in der Search-Dienst zugeordnet.</param>
        <summary>
            Initialisiert eine neue Instanz der SynonymMapListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SynonymMaps">
      ...
      <Docs>
        <summary>
            Ruft die Zuordnungen Synonym im Suchdienst ab.
            </summary>
