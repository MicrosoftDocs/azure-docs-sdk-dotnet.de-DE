<Type Name="SuggestResult" FullName="Microsoft.Azure.Search.Models.SuggestResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="65adb-101">Enthält die von einer vorschlagsabfrage gefundenes Dokument sowie die zugeordneten Metadaten.</span><span class="sxs-lookup"><span data-stu-id="65adb-101">Contains a document found by a suggestion query, plus associated metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="65adb-102">Initialisiert eine neue Instanz der SuggestResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="65adb-102">Initializes a new instance of the SuggestResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
