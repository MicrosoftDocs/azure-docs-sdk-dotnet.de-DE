<Type Name="TagScoringParameters" FullName="Microsoft.Azure.Search.Models.TagScoringParameters">
  ...
  <Docs>
    <summary>
            Parameterwerte für ein Tag Bewertungsfunktion bereitstellt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TagScoringParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tagsParameter">Der Name des Parameters übergeben in Suchabfragen an die Liste der Tags, die mit dem Feld "Ziel" verglichen.</param>
        <summary>
            Initialisiert eine neue Instanz der TagScoringParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TagsParameter">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Parameters in Suchabfragen an die Liste der Tags zum Vergleich von Feld "Ziel" übergeben.
            </summary>
