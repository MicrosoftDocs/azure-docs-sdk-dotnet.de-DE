<Type Name="IndexListResult" FullName="Microsoft.Azure.Search.Models.IndexListResult">
  ...
  <Docs>
    <summary>
            Die Antwort aus einer Liste Indizes-Anforderung. Bei erfolgreicher Ausführung umfasst sie die vollständigen Definitionen aller Indizes.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der IndexListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="indexes">Die Indizes in der Search-Dienst.</param>
        <summary>
            Initialisiert eine neue Instanz der IndexListResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
