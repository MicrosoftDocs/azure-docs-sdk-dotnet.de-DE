<Type Name="TruncateTokenFilter" FullName="Microsoft.Azure.Search.Models.TruncateTokenFilter">
  ...
  <Docs>
    <summary>
            Schneidet die Begriffe zu einer bestimmten Länge ab. Dieser Filter token wird mithilfe von Apache Lucene implementiert.
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TruncateTokenFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="length">Die Länge, die an der Begriffe abgeschnitten werden.
            Standard- und ist 300.</param>
        <summary>
            Initialisiert eine neue Instanz der TruncateTokenFilter-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Length">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Länge, die an der Begriffe abgeschnitten werden. Standard- und ist 300.
            </summary>
