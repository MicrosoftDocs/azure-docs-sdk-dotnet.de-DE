<Type Name="MetricAvailablity" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MetricAvailablity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="503a0-101">Die Metrik Verfügbarkeit.</span><span class="sxs-lookup"><span data-stu-id="503a0-101">The metric availability.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="503a0-102">Initialisiert eine neue Instanz der MetricAvailablity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="503a0-102">Initializes a new instance of the MetricAvailablity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeGrain"><span data-ttu-id="503a0-103">Das aggregationsintervall für die Metrik.</span><span class="sxs-lookup"><span data-stu-id="503a0-103">The aggregation interval for the metric.</span></span></param>
        <param name="retention"><span data-ttu-id="503a0-104">die Beibehaltungsdauer für die Metrik auf der angegebenen timegrain-Wert.</span><span class="sxs-lookup"><span data-stu-id="503a0-104">The retention period for the metric at the specified timegrain.</span></span></param>
        <summary>
            <span data-ttu-id="503a0-105">Initialisiert eine neue Instanz der MetricAvailablity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="503a0-105">Initializes a new instance of the MetricAvailablity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Retention">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="503a0-106">Abrufen oder festlegen die Beibehaltungsdauer für die Metrik auf der angegebenen timegrain-Wert.</span><span class="sxs-lookup"><span data-stu-id="503a0-106">Gets or sets the retention period for the metric at the specified timegrain.</span></span>
            </summary>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="503a0-107">Ruft ab, oder legt ihn fest aggregationsintervalls für die Metrik.</span><span class="sxs-lookup"><span data-stu-id="503a0-107">Gets or sets the aggregation interval for the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
