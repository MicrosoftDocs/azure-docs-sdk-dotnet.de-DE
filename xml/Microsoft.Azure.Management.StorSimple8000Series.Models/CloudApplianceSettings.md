<Type Name="CloudApplianceSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.CloudApplianceSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b4d14-101">Die Einstellungen für den Cloud-Anwendung.</span><span class="sxs-lookup"><span data-stu-id="b4d14-101">The cloud appliance settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b4d14-102">Initialisiert eine neue Instanz der CloudApplianceSettings-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b4d14-102">Initializes a new instance of the CloudApplianceSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceDataEncryptionKey"><span data-ttu-id="b4d14-103">Der Verschlüsselungsschlüssel für Dienstdaten (mit DAK verschlüsselt).</span><span class="sxs-lookup"><span data-stu-id="b4d14-103">The service data encryption key (encrypted with DAK).</span></span></param>
        <param name="channelIntegrityKey"><span data-ttu-id="b4d14-104">Der Kanal Integrität Schlüssel (mit DAK verschlüsselt).</span><span class="sxs-lookup"><span data-stu-id="b4d14-104">The channel integrity key (encrypted with DAK).</span></span></param>
        <summary>
            <span data-ttu-id="b4d14-105">Initialisiert eine neue Instanz der CloudApplianceSettings-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b4d14-105">Initializes a new instance of the CloudApplianceSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ChannelIntegrityKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b4d14-106">Ruft ab oder legt den Kanal Integrität-Schlüssel (verschlüsselt mit DAK) fest.</span><span class="sxs-lookup"><span data-stu-id="b4d14-106">Gets or sets the channel integrity key (encrypted with DAK).</span></span>
            </summary>
    ...
    <Member MemberName="ServiceDataEncryptionKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b4d14-107">Ruft ab, oder legt ihn fest (verschlüsselten mit DAK) der Dienstdaten-Verschlüsselungsschlüssel.</span><span class="sxs-lookup"><span data-stu-id="b4d14-107">Gets or sets the service data encryption key (encrypted with DAK).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b4d14-108">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="b4d14-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b4d14-109">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="b4d14-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
