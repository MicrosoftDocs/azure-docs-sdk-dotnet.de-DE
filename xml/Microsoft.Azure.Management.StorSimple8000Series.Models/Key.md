<Type Name="Key" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.Key">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="02126-101">Der Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="02126-101">The key.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02126-102">Initialisiert eine neue Instanz der Klasse Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="02126-102">Initializes a new instance of the Key class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="activationKey"><span data-ttu-id="02126-103">Der Aktivierungsschlüssel für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="02126-103">The activation key for the device.</span></span></param>
        <summary>
            <span data-ttu-id="02126-104">Initialisiert eine neue Instanz der Klasse Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="02126-104">Initializes a new instance of the Key class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivationKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02126-105">Ruft ab oder legt den Aktivierungsschlüssel für das Gerät.</span><span class="sxs-lookup"><span data-stu-id="02126-105">Gets or sets the activation key for the device.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02126-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="02126-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="02126-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="02126-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
