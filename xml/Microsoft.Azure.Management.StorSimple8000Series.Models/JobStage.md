<Type Name="JobStage" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.JobStage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="88e2c-101">Die Details über die Phase eines Auftrags.</span><span class="sxs-lookup"><span data-stu-id="88e2c-101">The details about the specific stage of a job.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-102">Initialisiert eine neue Instanz der JobStage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="88e2c-102">Initializes a new instance of the JobStage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stageStatus"><span data-ttu-id="88e2c-103">Der Status Phase.</span><span class="sxs-lookup"><span data-stu-id="88e2c-103">The stage status.</span></span> <span data-ttu-id="88e2c-104">Folgende Werte sind möglich: "Wird ausgeführt", "Erfolgreich abgeschlossen", "Fehlgeschlagen", "abgebrochen"</span><span class="sxs-lookup"><span data-stu-id="88e2c-104">Possible values include: 'Running', 'Succeeded', 'Failed', 'Canceled'</span></span></param>
        <param name="message"><span data-ttu-id="88e2c-105">Die Meldung der Auftrag Stufe.</span><span class="sxs-lookup"><span data-stu-id="88e2c-105">The message of the job stage.</span></span></param>
        <param name="detail"><span data-ttu-id="88e2c-106">Die Details der Stufe.</span><span class="sxs-lookup"><span data-stu-id="88e2c-106">The details of the stage.</span></span></param>
        <param name="errorCode"><span data-ttu-id="88e2c-107">Der Fehlercode der Stufe, sofern vorhanden.</span><span class="sxs-lookup"><span data-stu-id="88e2c-107">The error code of the stage if any.</span></span></param>
        <summary>
            <span data-ttu-id="88e2c-108">Initialisiert eine neue Instanz der JobStage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="88e2c-108">Initializes a new instance of the JobStage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Detail">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-109">Ruft ab oder legt die Details der Stufe.</span><span class="sxs-lookup"><span data-stu-id="88e2c-109">Gets or sets the details of the stage.</span></span>
            </summary>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-110">Abrufen oder festlegen den Fehlercode der Stufe, sofern vorhanden.</span><span class="sxs-lookup"><span data-stu-id="88e2c-110">Gets or sets the error code of the stage if any.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-111">Ruft ab oder legt die Nachricht der Auftrag Stufe.</span><span class="sxs-lookup"><span data-stu-id="88e2c-111">Gets or sets the message of the job stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StageStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-112">Ruft ab oder legt den Status der Phase.</span><span class="sxs-lookup"><span data-stu-id="88e2c-112">Gets or sets the stage status.</span></span> <span data-ttu-id="88e2c-113">Folgende Werte sind möglich: "Wird ausgeführt", "Erfolgreich abgeschlossen", "Fehlgeschlagen", "abgebrochen"</span><span class="sxs-lookup"><span data-stu-id="88e2c-113">Possible values include: 'Running', 'Succeeded', 'Failed', 'Canceled'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88e2c-114">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="88e2c-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="88e2c-115">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="88e2c-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
