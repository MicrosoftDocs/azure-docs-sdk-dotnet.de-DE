<Type Name="SecondaryDNSSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.SecondaryDNSSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cfb78-101">Der sekundäre DNS-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="cfb78-101">The secondary DNS settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cfb78-102">Initialisiert eine neue Instanz der SecondaryDNSSettings-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cfb78-102">Initializes a new instance of the SecondaryDNSSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="secondaryDnsServers"><span data-ttu-id="cfb78-103">Die Liste der sekundären Datenbank werden die DNS-Server IP-Adressen.</span><span class="sxs-lookup"><span data-stu-id="cfb78-103">The list of secondary DNS Server IP addresses.</span></span></param>
        <summary>
            <span data-ttu-id="cfb78-104">Initialisiert eine neue Instanz der SecondaryDNSSettings-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cfb78-104">Initializes a new instance of the SecondaryDNSSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SecondaryDnsServers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cfb78-105">Ruft ab oder legt die Liste der sekundäre DNS-Server IP-Adressen.</span><span class="sxs-lookup"><span data-stu-id="cfb78-105">Gets or sets the list of secondary DNS Server IP addresses.</span></span>
            </summary>
