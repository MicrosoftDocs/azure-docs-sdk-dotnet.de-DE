<Type Name="IWithAllDifferentOptions" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Definition.IWithAllDifferentOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="61845-101">Die SQL-Datenbank-Schnittstelle mit allen beginnend Optionen für die Definition.</span><span class="sxs-lookup"><span data-stu-id="61845-101">The SQL Database interface with all starting options for definition.</span></span>
            </summary>
