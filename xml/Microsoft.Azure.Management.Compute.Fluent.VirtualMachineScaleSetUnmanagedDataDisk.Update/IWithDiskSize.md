<Type Name="IWithDiskSize" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetUnmanagedDataDisk.Update.IWithDiskSize">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c418e-101">Die Phase der nicht verwalteten Daten Datenträger Update zu ermöglichen, legen Sie die Größe des Datenträgers.</span><span class="sxs-lookup"><span data-stu-id="c418e-101">The stage of the unmanaged data disk update allowing to set the disk size.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSizeInGB">
      ...
      <Docs>
        <param name="sizeInGB"><span data-ttu-id="c418e-102">Die Größe des Datenträgers in GB.</span><span class="sxs-lookup"><span data-stu-id="c418e-102">The disk size in GB.</span></span></param>
        <summary>
            <span data-ttu-id="c418e-103">Gibt die neue Größe in GB für Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="c418e-103">Specifies the new size in GB for data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c418e-104">Die nächste Phase der nicht verwalteten Daten Datenträger aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="c418e-104">The next stage of unmanaged data disk update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>