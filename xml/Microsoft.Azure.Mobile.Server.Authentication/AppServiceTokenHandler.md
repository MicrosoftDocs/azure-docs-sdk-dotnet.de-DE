<Type Name="AppServiceTokenHandler" FullName="Microsoft.Azure.Mobile.Server.Authentication.AppServiceTokenHandler">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="78fca-101">Stellt eine Standardimplementierung von der <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.IAppServiceTokenHandler" /> Schnittstelle.</span><span class="sxs-lookup"><span data-stu-id="78fca-101">Provides a default implementation of the <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.IAppServiceTokenHandler" /> interface.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="config"><span data-ttu-id="78fca-102">Der <see cref="T:System.Web.Http.HttpConfiguration" /> für diese Instanz.</span><span class="sxs-lookup"><span data-stu-id="78fca-102">The <see cref="T:System.Web.Http.HttpConfiguration" /> for this instance.</span></span></param>
        <summary>
            <span data-ttu-id="78fca-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceTokenHandler" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="78fca-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceTokenHandler" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ValidateToken">
      ...
      <Docs>
        <param name="token"><span data-ttu-id="78fca-104">Die zu überprüfende JWT-Zeichenfolge token.</span><span class="sxs-lookup"><span data-stu-id="78fca-104">The JWT token string to validate.</span></span></param>
        <param name="secretKey"><span data-ttu-id="78fca-105">Der Schlüssel in der Überprüfung verwenden.</span><span class="sxs-lookup"><span data-stu-id="78fca-105">The key to use in the validation.</span></span></param>
        <param name="audience"><span data-ttu-id="78fca-106">Die Zielgruppe Validierung zu verwendende.</span><span class="sxs-lookup"><span data-stu-id="78fca-106">The audience to use in validation.</span></span></param>
        <param name="issuer"><span data-ttu-id="78fca-107">Der Aussteller Validierung zu verwendende.</span><span class="sxs-lookup"><span data-stu-id="78fca-107">The issuer to use in validation.</span></span></param>
        <summary>
            <span data-ttu-id="78fca-108">Überprüft die angegebene token JWT-Zeichenfolge anhand der angegebene geheime Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="78fca-108">Validates the specified JWT token string against the specified secret key.</span></span> <span data-ttu-id="78fca-109">Die Validierungsmethode ausgelöste Ausnahmen werden nicht abgefangen werden.</span><span class="sxs-lookup"><span data-stu-id="78fca-109">Exceptions thrown by the validation method are not caught.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentException"><span data-ttu-id="78fca-110">Wird ausgelöst, wenn das JWT-Token falsch formatiert ist.</span><span class="sxs-lookup"><span data-stu-id="78fca-110">Thrown if the JWT token is malformed.</span></span></exception>
        <exception cref="T:System.ArgumentNullException"><span data-ttu-id="78fca-111">Wird ausgelöst, wenn einer der Parameter der null oder leer ist.</span><span class="sxs-lookup"><span data-stu-id="78fca-111">Thrown if one of the method parameters are null or empty.</span></span></exception>
        <exception cref="T:System.IdentityModel.Tokens.SecurityTokenValidationException"><span data-ttu-id="78fca-112">Wird ausgelöst, wenn das JWT-Token von der Überprüfung ein Fehler auftritt.</span><span class="sxs-lookup"><span data-stu-id="78fca-112">Thrown if the JWT token fails validation.</span></span></exception>
        <exception cref="T:System.IdentityModel.Tokens.SecurityTokenExpiredException"><span data-ttu-id="78fca-113">Wird ausgelöst, wenn das JWT-Token abgelaufen ist.</span><span class="sxs-lookup"><span data-stu-id="78fca-113">Thrown if the JWT token is expired.</span></span></exception>
        <exception cref="T:System.IdentityModel.Tokens.SecurityTokenNotYetValidException"><span data-ttu-id="78fca-114">Wird ausgelöst, wenn das JWT-Token noch nicht gültig ist.</span><span class="sxs-lookup"><span data-stu-id="78fca-114">Thrown if the JWT token is not yet valid.</span></span></exception>
      </Docs>
    </Member>
  </Members>
</Type>