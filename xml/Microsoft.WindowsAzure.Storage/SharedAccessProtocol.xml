<Type Name="SharedAccessProtocol" FullName="Microsoft.WindowsAzure.Storage.SharedAccessProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b53b5-101">Gibt den Satz der möglichen signierte Protokolle für eine Richtlinie für freigegebenen Zugriff Konto an.</span><span class="sxs-lookup"><span data-stu-id="b53b5-101">Specifies the set of possible signed protocols for a shared access account policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="HttpsOnly">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b53b5-102">Die Berechtigung zum Verwenden von SAS nur über Https gewährt.</span><span class="sxs-lookup"><span data-stu-id="b53b5-102">Permission to use SAS only through https granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="HttpsOrHttp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b53b5-103">Die Berechtigung zum Verwenden von SAS über Https oder http gewährt.</span><span class="sxs-lookup"><span data-stu-id="b53b5-103">Permission to use SAS through https or http granted.</span></span> <span data-ttu-id="b53b5-104">Entspricht der überhaupt keine Berechtigung angegeben.</span><span class="sxs-lookup"><span data-stu-id="b53b5-104">Equivalent to not specifying any permission at all.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
