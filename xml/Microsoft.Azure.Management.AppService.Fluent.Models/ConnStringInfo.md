<Type Name="ConnStringInfo" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ConnStringInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e1463-101">Datenbank-Verbindungszeichenfolge übernommen.</span><span class="sxs-lookup"><span data-stu-id="e1463-101">Database connection string information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1463-102">Initialisiert eine neue Instanz der ConnStringInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e1463-102">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="e1463-103">Der Name der Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="e1463-103">Name of connection string.</span></span></param>
        <param name="connectionString"><span data-ttu-id="e1463-104">Der Verbindungszeichenfolgenwert.</span><span class="sxs-lookup"><span data-stu-id="e1463-104">Connection string value.</span></span></param>
        <param name="type"><span data-ttu-id="e1463-105">Der Typ der Datenbank.</span><span class="sxs-lookup"><span data-stu-id="e1463-105">Type of database.</span></span> <span data-ttu-id="e1463-106">Folgende Werte sind möglich: "MySql", "SQLServer", "SQLAzure", "Benutzerdefiniert", 'NotificationHub', "Service Bus", "EventHub", "ApiHub", "DocDb", "RedisCache"</span><span class="sxs-lookup"><span data-stu-id="e1463-106">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache'</span></span></param>
        <summary>
            <span data-ttu-id="e1463-107">Initialisiert eine neue Instanz der ConnStringInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e1463-107">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1463-108">Ruft ab, oder legt ihn fest verbindungszeichenwert.</span><span class="sxs-lookup"><span data-stu-id="e1463-108">Gets or sets connection string value.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1463-109">Ruft ab oder legt den Namen der Verbindungszeichenfolge fest.</span><span class="sxs-lookup"><span data-stu-id="e1463-109">Gets or sets name of connection string.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1463-110">Ruft ab oder legt ihn fest-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="e1463-110">Gets or sets type of database.</span></span> <span data-ttu-id="e1463-111">Folgende Werte sind möglich: "MySql", "SQLServer", "SQLAzure", "Benutzerdefiniert", 'NotificationHub', "Service Bus", "EventHub", "ApiHub", "DocDb", "RedisCache"</span><span class="sxs-lookup"><span data-stu-id="e1463-111">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
