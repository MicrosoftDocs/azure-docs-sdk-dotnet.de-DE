<Type Name="RecommendationRuleInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.RecommendationRuleInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0ab00-101">Stellt eine Empfehlung-Regel, die das empfehlungsmodul ausführen können.</span><span class="sxs-lookup"><span data-stu-id="0ab00-101">Represents a recommendation rule that the recommendation engine can perform.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-102">Initialisiert eine neue Instanz der RecommendationRuleInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0ab00-102">Initializes a new instance of the RecommendationRuleInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ActionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-103">Ruft ab oder legt die Namen der Aktion, die von dieser Regel in der Zeichenfolge wird empfohlen.</span><span class="sxs-lookup"><span data-stu-id="0ab00-103">Gets or sets name of action that is recommended by this rule in string.</span></span>
            </summary>
    ...
    <Member MemberName="Channels">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-104">Ruft ab oder legt die Liste der verfügbaren Kanäle, die diese Regel gilt.</span><span class="sxs-lookup"><span data-stu-id="0ab00-104">Gets or sets list of available channels that this rule applies.</span></span>
            <span data-ttu-id="0ab00-105">Folgende Werte sind möglich: "Benachrichtigung", "Api", "Email", "Webhook", "All"</span><span class="sxs-lookup"><span data-stu-id="0ab00-105">Possible values include: 'Notification', 'Api', 'Email', 'Webhook', 'All'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-106">Ruft ab, oder legt ihn fest lokalisierte detaillierte Beschreibung der Regel.</span><span class="sxs-lookup"><span data-stu-id="0ab00-106">Gets or sets localized detailed description of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-107">Ruft ab oder legt Benutzeroberfläche angezeigten Namen der Regel.</span><span class="sxs-lookup"><span data-stu-id="0ab00-107">Gets or sets UI friendly name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-108">Ruft ab oder legt diesen fest auswirken, der angibt, wie kritisch mit dieser Regel wird.</span><span class="sxs-lookup"><span data-stu-id="0ab00-108">Gets or sets level of impact indicating how critical this rule is.</span></span>
            <span data-ttu-id="0ab00-109">Folgende Werte sind möglich: "Kritisch", "Warnung", "Information", "NonUrgentSuggestion"</span><span class="sxs-lookup"><span data-stu-id="0ab00-109">Possible values include: 'Critical', 'Warning', 'Information', 'NonUrgentSuggestion'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-110">Ruft ab, oder legt ihn fest lokalisierten Namen der Regel (geeignet für UI).</span><span class="sxs-lookup"><span data-stu-id="0ab00-110">Gets or sets localized name of the rule (Good for UI).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-111">Ruft ab oder legt die eindeutigen Namen der Regel.</span><span class="sxs-lookup"><span data-stu-id="0ab00-111">Gets or sets unique name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecommendationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-112">Abrufen oder Festlegen der Empfehlung, dass die ID eines Objekts zugeordneten Empfehlung an die Regel gebunden werden, wenn vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="0ab00-112">Gets or sets recommendation ID of an associated recommendation object tied to the rule, if exists.</span></span>
            <span data-ttu-id="0ab00-113">Wenn ein solches Objekt nicht vorhanden ist, wird es festgelegt auf Null.</span><span class="sxs-lookup"><span data-stu-id="0ab00-113">If such an object doesn't exist, it is set to null.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ab00-114">Ruft ab oder legt ein Array von Kategorietags, die die Regel enthält.</span><span class="sxs-lookup"><span data-stu-id="0ab00-114">Gets or sets an array of category tags that the rule contains.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
