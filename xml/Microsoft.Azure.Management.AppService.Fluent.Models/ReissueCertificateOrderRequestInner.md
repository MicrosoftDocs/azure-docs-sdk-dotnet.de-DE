<Type Name="ReissueCertificateOrderRequestInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ReissueCertificateOrderRequestInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="83c86-101">Wiederholen Sie die Anforderung darstellen Zertifikats-Klasse.</span><span class="sxs-lookup"><span data-stu-id="83c86-101">Class representing certificate reissue request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83c86-102">Initialisiert eine neue Instanz der ReissueCertificateOrderRequestInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="83c86-102">Initializes a new instance of the ReissueCertificateOrderRequestInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="keySize"><span data-ttu-id="83c86-103">Die Zertifikatschlüsselgröße.</span><span class="sxs-lookup"><span data-stu-id="83c86-103">Certificate Key Size.</span></span></param>
        <param name="delayExistingRevokeInHours"><span data-ttu-id="83c86-104">Verzögerung Stunden, vorhandenes Zertifikat aufzuheben, nachdem das neue Zertifikat ausgestellt wurde.</span><span class="sxs-lookup"><span data-stu-id="83c86-104">Delay in hours to revoke existing certificate after the new certificate is issued.</span></span></param>
        <param name="csr"><span data-ttu-id="83c86-105">CSR für Neuvergabe (Rollover) Vorgang verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="83c86-105">Csr to be used for re-key operation.</span></span></param>
        <param name="isPrivateKeyExternal"><span data-ttu-id="83c86-106">Wir sollten den Typ "ASC" (von verwalteten privaten Schlüssel auf externen privaten Schlüssel und umgekehrt) ändern.</span><span class="sxs-lookup"><span data-stu-id="83c86-106">Should we change the ASC type (from managed private key to external private key and vice versa).</span></span></param>
        <summary>
            <span data-ttu-id="83c86-107">Initialisiert eine neue Instanz der ReissueCertificateOrderRequestInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="83c86-107">Initializes a new instance of the ReissueCertificateOrderRequestInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Csr">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83c86-108">Ruft ab, oder legt ihn fest Csr für Neuvergabe (Rollover) Vorgang verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="83c86-108">Gets or sets csr to be used for re-key operation.</span></span>
            </summary>
    ...
    <Member MemberName="DelayExistingRevokeInHours">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83c86-109">Ruft ab, oder legt fest Verzögerung in Stunden, vorhandenes Zertifikat aufzuheben, nachdem das neue Zertifikat ausgestellt wurde.</span><span class="sxs-lookup"><span data-stu-id="83c86-109">Gets or sets delay in hours to revoke existing certificate after the new certificate is issued.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPrivateKeyExternal">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83c86-110">Ruft ab oder legt ihn fest sollten wir den Typ "ASC" (von verwalteten privaten Schlüssel auf externen privaten Schlüssel und umgekehrt) ändern.</span><span class="sxs-lookup"><span data-stu-id="83c86-110">Gets or sets should we change the ASC type (from managed private key to external private key and vice versa).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeySize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83c86-111">Ruft ab oder legt Zertifikat Schlüsselgröße.</span><span class="sxs-lookup"><span data-stu-id="83c86-111">Gets or sets certificate Key Size.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
