<Type Name="StampCapacity" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.StampCapacity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="82e0a-101">Kapazitätsinformationen zu stempeln.</span><span class="sxs-lookup"><span data-stu-id="82e0a-101">Stamp capacity information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-102">Initialisiert eine neue Instanz der StampCapacity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="82e0a-102">Initializes a new instance of the StampCapacity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="82e0a-103">Der Name des Stempels.</span><span class="sxs-lookup"><span data-stu-id="82e0a-103">Name of the stamp.</span></span></param>
        <param name="availableCapacity"><span data-ttu-id="82e0a-104">Verfügbare Kapazität (Anz. der Computer, Speicherbytes usw....).</span><span class="sxs-lookup"><span data-stu-id="82e0a-104">Available capacity (# of machines, bytes of storage etc...).</span></span></param>
        <param name="totalCapacity"><span data-ttu-id="82e0a-105">Gesamtkapazität (Anz. der Computer, Speicherbytes usw....).</span><span class="sxs-lookup"><span data-stu-id="82e0a-105">Total capacity (# of machines, bytes of storage etc...).</span></span></param>
        <param name="unit"><span data-ttu-id="82e0a-106">Die Namen der Einheit.</span><span class="sxs-lookup"><span data-stu-id="82e0a-106">Name of the unit.</span></span></param>
        <param name="computeMode"><span data-ttu-id="82e0a-107">Freigegebene/dedizierten Worker.</span><span class="sxs-lookup"><span data-stu-id="82e0a-107">Shared/dedicated workers.</span></span> <span data-ttu-id="82e0a-108">Folgende Werte sind möglich: "Shared", "Reserviert", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="82e0a-108">Possible values include: 'Shared', 'Dedicated', 'Dynamic'</span></span></param>
        <param name="workerSize"><span data-ttu-id="82e0a-109">Die Größe der Computer.</span><span class="sxs-lookup"><span data-stu-id="82e0a-109">Size of the machines.</span></span> <span data-ttu-id="82e0a-110">Folgende Werte sind möglich: "Default", "Klein", "Mittel", "Groß"</span><span class="sxs-lookup"><span data-stu-id="82e0a-110">Possible values include: 'Default', 'Small', 'Medium', 'Large'</span></span></param>
        <param name="workerSizeId"><span data-ttu-id="82e0a-111">Size-ID von Computern: 0 - 1 für kleine - Mittel 2 – Groß</span><span class="sxs-lookup"><span data-stu-id="82e0a-111">Size ID of machines: 0 - Small 1 - Medium 2 - Large</span></span></param>
        <param name="excludeFromCapacityAllocation"><span data-ttu-id="82e0a-112">Wenn &lt;Code&gt;"true"&lt;/code&gt;, sie enthält grundlegende apps.</span><span class="sxs-lookup"><span data-stu-id="82e0a-112">If &lt;code&gt;true&lt;/code&gt;, it includes basic apps.</span></span>
            <span data-ttu-id="82e0a-113">Basic-apps werden nicht für kapazitätszuordnung verwendet.</span><span class="sxs-lookup"><span data-stu-id="82e0a-113">Basic apps are not used for capacity allocation.</span></span></param>
        <param name="isApplicableForAllComputeModes"><span data-ttu-id="82e0a-114">&lt;Code&gt;"true"&lt;/code&gt; wenn Kapazität für alle apps anwendbar; andernfalls ist &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="82e0a-114">&lt;code&gt;true&lt;/code&gt; if capacity is applicable for all apps; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="siteMode"><span data-ttu-id="82e0a-115">Freigegeben oder dediziert.</span><span class="sxs-lookup"><span data-stu-id="82e0a-115">Shared or Dedicated.</span></span></param>
        <summary>
            <span data-ttu-id="82e0a-116">Initialisiert eine neue Instanz der StampCapacity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="82e0a-116">Initializes a new instance of the StampCapacity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AvailableCapacity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-117">Ruft ab oder legt die verfügbaren Kapazität (Anz. der Computer, Speicherbytes usw....).</span><span class="sxs-lookup"><span data-stu-id="82e0a-117">Gets or sets available capacity (# of machines, bytes of storage etc...).</span></span>
            </summary>
    ...
    <Member MemberName="ComputeMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-118">Ruft ab, oder legt ihn fest freigegebene/dedizierten Worker.</span><span class="sxs-lookup"><span data-stu-id="82e0a-118">Gets or sets shared/dedicated workers.</span></span> <span data-ttu-id="82e0a-119">Folgende Werte sind möglich: "Shared", "Reserviert", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="82e0a-119">Possible values include: 'Shared', 'Dedicated', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ExcludeFromCapacityAllocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-120">Ruft ab oder legt sie fest, wenn &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; er enthält grundlegende apps.</span><span class="sxs-lookup"><span data-stu-id="82e0a-120">Gets or sets if &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt;, it includes basic apps.</span></span>
            <span data-ttu-id="82e0a-121">Basic-apps werden nicht für kapazitätszuordnung verwendet.</span><span class="sxs-lookup"><span data-stu-id="82e0a-121">Basic apps are not used for capacity allocation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-123">Ruft ab oder legt den Namen des Stempels fest.</span><span class="sxs-lookup"><span data-stu-id="82e0a-123">Gets or sets name of the stamp.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SiteMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-124">Ruft ab oder legt sie fest, freigegeben oder dediziert.</span><span class="sxs-lookup"><span data-stu-id="82e0a-124">Gets or sets shared or Dedicated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalCapacity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-125">Ruft ab oder legt Sie Datenträgerkapazität insgesamt (Anz. der Computer, Speicherbytes usw....).</span><span class="sxs-lookup"><span data-stu-id="82e0a-125">Gets or sets total capacity (# of machines, bytes of storage etc...).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-126">Ruft ab oder legt den Namen der Einheit fest.</span><span class="sxs-lookup"><span data-stu-id="82e0a-126">Gets or sets name of the unit.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WorkerSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-127">Ruft ab oder legt die Größe der Computer.</span><span class="sxs-lookup"><span data-stu-id="82e0a-127">Gets or sets size of the machines.</span></span> <span data-ttu-id="82e0a-128">Folgende Werte sind möglich: "Default", "Klein", "Mittel", "Groß"</span><span class="sxs-lookup"><span data-stu-id="82e0a-128">Possible values include: 'Default', 'Small', 'Medium', 'Large'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WorkerSizeId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e0a-129">Ruft ab oder legt ihn fest Größe-ID von Computern: 0 - 1 für kleine - Mittel 2 – Groß</span><span class="sxs-lookup"><span data-stu-id="82e0a-129">Gets or sets size ID of machines: 0 - Small 1 - Medium 2 - Large</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
