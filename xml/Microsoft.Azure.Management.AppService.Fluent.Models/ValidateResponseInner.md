<Type Name="ValidateResponseInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ValidateResponseInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bb26f-101">Beschreibt das Ergebnis der Überprüfung der Ressource.</span><span class="sxs-lookup"><span data-stu-id="bb26f-101">Describes the result of resource validation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb26f-102">Initialisiert eine neue Instanz der ValidateResponseInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bb26f-102">Initializes a new instance of the ValidateResponseInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="status"><span data-ttu-id="bb26f-103">Ergebnis der Überprüfung.</span><span class="sxs-lookup"><span data-stu-id="bb26f-103">Result of validation.</span></span></param>
        <param name="error"><span data-ttu-id="bb26f-104">Fehlerdetails für den Fall, wenn die Validierung fehlschlägt.</span><span class="sxs-lookup"><span data-stu-id="bb26f-104">Error details for the case when validation fails.</span></span></param>
        <summary>
            <span data-ttu-id="bb26f-105">Initialisiert eine neue Instanz der ValidateResponseInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bb26f-105">Initializes a new instance of the ValidateResponseInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Error">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb26f-106">Ermittelt oder definiert Fehlerdetails für den Fall, wenn die Validierung fehlschlägt.</span><span class="sxs-lookup"><span data-stu-id="bb26f-106">Gets or sets error details for the case when validation fails.</span></span>
            </summary>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb26f-107">Ruft ab, oder legt ihn fest Ergebnis der Überprüfung.</span><span class="sxs-lookup"><span data-stu-id="bb26f-107">Gets or sets result of validation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
