<Type Name="RecommendationInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.RecommendationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c3985-101">Stellt eine von der empfehlungsmodul generierten Empfehlung Ergebnis dar.</span><span class="sxs-lookup"><span data-stu-id="c3985-101">Represents a recommendation result generated by the recommendation engine.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-102">Initialisiert eine neue Instanz der RecommendationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c3985-102">Initializes a new instance of the RecommendationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ActionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-103">Ruft ab, oder legt ihn fest Name der Aktion, die von diesem Objekt empfohlen.</span><span class="sxs-lookup"><span data-stu-id="c3985-103">Gets or sets name of action recommended by this object.</span></span>
            </summary>
    ...
    <Member MemberName="Channels">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-104">Ruft ab, oder legt ihn fest Liste von Kanälen, die diese Empfehlung anwenden kann.</span><span class="sxs-lookup"><span data-stu-id="c3985-104">Gets or sets list of channels that this recommendation can apply.</span></span>
            <span data-ttu-id="c3985-105">Folgende Werte sind möglich: "Benachrichtigung", "Api", "Email", "Webhook", "All"</span><span class="sxs-lookup"><span data-stu-id="c3985-105">Possible values include: 'Notification', 'Api', 'Email', 'Webhook', 'All'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-106">Ermittelt oder definiert Zeitstempel, wenn diese Instanz erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="c3985-106">Gets or sets timestamp when this instance was created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-107">Ruft ab oder legt Benutzeroberfläche angezeigten Namen der Regel (möglicherweise nicht eindeutig sein).</span><span class="sxs-lookup"><span data-stu-id="c3985-107">Gets or sets UI friendly name of the rule (may not be unique).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-108">Ruft ab oder legt die Endzeit in UTC, der einem Bereich, dem die Empfehlung bezieht.</span><span class="sxs-lookup"><span data-stu-id="c3985-108">Gets or sets the end time in UTC of a range that the recommendation refers to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-109">Ruft ab oder legt sie fest, der angibt, wie kritisch diese Empfehlung auswirken kann.</span><span class="sxs-lookup"><span data-stu-id="c3985-109">Gets or sets level indicating how critical this recommendation can impact.</span></span> <span data-ttu-id="c3985-110">Folgende Werte sind möglich: "Kritisch", "Warnung", "Information", "NonUrgentSuggestion"</span><span class="sxs-lookup"><span data-stu-id="c3985-110">Possible values include: 'Critical', 'Warning', 'Information', 'NonUrgentSuggestion'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-111">Text abruft oder festlegt Empfehlung.</span><span class="sxs-lookup"><span data-stu-id="c3985-111">Gets or sets recommendation text.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NextNotificationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-112">Ruft ab oder legt fest, wann diese Empfehlung weiter in UTC zu benachrichtigen.</span><span class="sxs-lookup"><span data-stu-id="c3985-112">Gets or sets when to notify this recommendation next in UTC.</span></span> <span data-ttu-id="c3985-113">NULL bedeutet, dass dies nicht mehr benachrichtigt werden soll.</span><span class="sxs-lookup"><span data-stu-id="c3985-113">Null means that this will never be notified anymore.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotificationExpirationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-114">Ruft ab oder legt Datum und Uhrzeit in UTC, Ablauf dieser Benachrichtigung.</span><span class="sxs-lookup"><span data-stu-id="c3985-114">Gets or sets date and time in UTC when this notification expires.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotifiedTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-115">Ruft ab, oder legt fest Zeitstempel der letzten (UTC), die dieser Instanz tatsächlich benachrichtigt wurde.</span><span class="sxs-lookup"><span data-stu-id="c3985-115">Gets or sets last timestamp in UTC this instance was actually notified.</span></span> <span data-ttu-id="c3985-116">NULL bedeutet, dass diese Empfehlung noch benachrichtigt wurde noch nicht.</span><span class="sxs-lookup"><span data-stu-id="c3985-116">Null means that this recommendation hasn't been notified yet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecommendationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-117">Ruft ab oder legt einen GUID-Wert, dem jede Empfehlung-Objekt zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="c3985-117">Gets or sets a GUID value that each recommendation object is associated with.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-118">Ruft ab, oder legt ihn fest vollständige ARM Resource ID-Zeichenfolge, die diese Empfehlung-Objekt zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="c3985-118">Gets or sets full ARM resource ID string that this recommendation object is associated with.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceScope">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-119">Ruft ab, oder legt ihn fest Name eines Ressourcentyps diese Empfehlung gilt, z. B. "Serverfarm", Abonnement-Website.</span><span class="sxs-lookup"><span data-stu-id="c3985-119">Gets or sets name of a resource type this recommendation applies, e.g. Subscription, ServerFarm, Site.</span></span> <span data-ttu-id="c3985-120">Folgende Werte sind möglich: "", Serverfarm ","Subscription","WebSite"</span><span class="sxs-lookup"><span data-stu-id="c3985-120">Possible values include: 'ServerFarm', 'Subscription', 'WebSite'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RuleName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-121">Ruft ab oder legt die eindeutigen Namen der Regel.</span><span class="sxs-lookup"><span data-stu-id="c3985-121">Gets or sets unique name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Score">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-122">Ruft ab, oder legt ihn fest Metrikwert für einen von der Regel gemessen.</span><span class="sxs-lookup"><span data-stu-id="c3985-122">Gets or sets a metric value measured by the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-123">Ruft ab oder legt die Anfangszeit (UTC), der einem Bereich, dem die Empfehlung bezieht.</span><span class="sxs-lookup"><span data-stu-id="c3985-123">Gets or sets the beginning time in UTC of a range that the recommendation refers to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3985-124">Ruft ab oder legt die Liste der Category-Tags, denen diese Empfehlung gehört.</span><span class="sxs-lookup"><span data-stu-id="c3985-124">Gets or sets the list of category tags that this recommendation belongs to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
