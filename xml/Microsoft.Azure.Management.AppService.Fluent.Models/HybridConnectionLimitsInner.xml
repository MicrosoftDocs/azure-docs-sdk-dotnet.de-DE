<Type Name="HybridConnectionLimitsInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.HybridConnectionLimitsInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="589f8-101">Hybridverbindung schränkt Vertrag.</span><span class="sxs-lookup"><span data-stu-id="589f8-101">Hybrid Connection limits contract.</span></span> <span data-ttu-id="589f8-102">Hiermit wird der Plan Grenzwerte von Hybridverbindungen zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="589f8-102">This is used to return the plan limits of Hybrid Connections.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="589f8-103">Initialisiert eine neue Instanz der HybridConnectionLimitsInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="589f8-103">Initializes a new instance of the HybridConnectionLimitsInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Current">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="589f8-104">Ruft die aktuelle Anzahl der Hybridverbindungen ab.</span><span class="sxs-lookup"><span data-stu-id="589f8-104">Gets the current number of Hybrid Connections.</span></span>
            </summary>
    ...
    <Member MemberName="Maximum">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="589f8-105">Ruft die maximale Anzahl von Hybridverbindungen zulässig.</span><span class="sxs-lookup"><span data-stu-id="589f8-105">Gets the maximum number of Hybrid Connections allowed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
