<Type Name="HybridConnectionInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.HybridConnectionInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e2d8f-101">Hybrid-Connection-Vertrag.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-101">Hybrid Connection contract.</span></span> <span data-ttu-id="e2d8f-102">Dient zum Konfigurieren einer Hybrid-Verbindung.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-102">This is used to configure a Hybrid Connection.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-103">Initialisiert eine neue Instanz der HybridConnectionInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-103">Initializes a new instance of the HybridConnectionInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Hostname">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-104">Ruft ab oder legt den Hostnamen des Endpunkts.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-104">Gets or sets the hostname of the endpoint.</span></span>
            </summary>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-105">Ruft ab oder legt den Port des Endpunkts fest.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-105">Gets or sets the port of the endpoint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RelayArmUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-106">Ruft ab oder legt den ARM-URI an die Service Bus-Relay.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-106">Gets or sets the ARM URI to the Service Bus relay.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RelayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-107">Ruft ab oder legt den Namen der Service Bus-Relay.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-107">Gets or sets the name of the Service Bus relay.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SendKeyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-108">Ruft ab oder legt den Namen des Schlüssels Service Bus Send-Berechtigungen besitzt.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-108">Gets or sets the name of the Service Bus key which has Send permissions.</span></span> <span data-ttu-id="e2d8f-109">Hiermit wird die Service Bus zu authentifizieren.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-109">This is used to authenticate to Service Bus.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SendKeyValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-110">Ruft ab oder legt den Wert für den Service Bus-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-110">Gets or sets the value of the Service Bus key.</span></span> <span data-ttu-id="e2d8f-111">Hiermit wird die Service Bus zu authentifizieren.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-111">This is used to authenticate to Service Bus.</span></span> <span data-ttu-id="e2d8f-112">Verwenden Sie in ARM dieser Schlüssel nicht normal zurückgegeben werden stattdessen die POST-/listKeys API.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-112">In ARM this key will not be returned normally, use the POST /listKeys API instead.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceBusNamespace">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e2d8f-113">Ruft ab oder legt den Namen der Service Bus-Namespace.</span><span class="sxs-lookup"><span data-stu-id="e2d8f-113">Gets or sets the name of the Service Bus namespace.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
