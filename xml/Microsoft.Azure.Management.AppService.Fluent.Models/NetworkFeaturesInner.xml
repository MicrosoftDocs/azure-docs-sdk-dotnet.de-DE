<Type Name="NetworkFeaturesInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.NetworkFeaturesInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="875c9-101">Umfassende Ansicht der Netzwerkfunktionen für eine app (gegenwärtig VNET-Integration und Hybridverbindungen).</span><span class="sxs-lookup"><span data-stu-id="875c9-101">Full view of network features for an app (presently VNET integration and Hybrid Connections).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="875c9-102">Initialisiert eine neue Instanz der NetworkFeaturesInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="875c9-102">Initializes a new instance of the NetworkFeaturesInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="HybridConnections">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="875c9-103">Ruft die Zusammenfassungsansicht der Hybridverbindungen ab.</span><span class="sxs-lookup"><span data-stu-id="875c9-103">Gets the Hybrid Connections summary view.</span></span>
            </summary>
    ...
    <Member MemberName="HybridConnectionsV2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="875c9-104">Ruft den Hybrid Connection V2 (Servicebus) anzeigen.</span><span class="sxs-lookup"><span data-stu-id="875c9-104">Gets the Hybrid Connection V2 (Service Bus) view.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualNetworkConnection">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="875c9-105">Ruft die Zusammenfassungsansicht des virtuellen Netzwerks ab.</span><span class="sxs-lookup"><span data-stu-id="875c9-105">Gets the Virtual Network summary view.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualNetworkName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="875c9-106">Ruft den Namen des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="875c9-106">Gets the Virtual Network name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
