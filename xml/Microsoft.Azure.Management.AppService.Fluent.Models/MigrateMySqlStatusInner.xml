<Type Name="MigrateMySqlStatusInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.MigrateMySqlStatusInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0ac08-101">Migrationsstatus MySQL.</span><span class="sxs-lookup"><span data-stu-id="0ac08-101">MySQL migration status.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ac08-102">Initialisiert eine neue Instanz der MigrateMySqlStatusInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0ac08-102">Initializes a new instance of the MigrateMySqlStatusInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LocalMySqlEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ac08-103">Ruft True, wenn die Web-app im app hat MySql aktiviert</span><span class="sxs-lookup"><span data-stu-id="0ac08-103">Gets true if the web app has in app MySql enabled</span></span>
            </summary>
    ...
    <Member MemberName="MigrationOperationStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ac08-104">Ruft die Status der Migrationsaufgabe ab.</span><span class="sxs-lookup"><span data-stu-id="0ac08-104">Gets status of the migration task.</span></span> <span data-ttu-id="0ac08-105">Folgende Werte sind möglich: "InProgress", "Fehler", "Succeeded", "TimedOut", "Erstellt"</span><span class="sxs-lookup"><span data-stu-id="0ac08-105">Possible values include: 'InProgress', 'Failed', 'Succeeded', 'TimedOut', 'Created'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0ac08-106">Ruft die Vorgangs-ID für die Migrationsaufgabe ab.</span><span class="sxs-lookup"><span data-stu-id="0ac08-106">Gets operation ID for the migration task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
