<Type Name="SiteConfig" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.SiteConfig">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4faab-101">Die Konfiguration einer App Service-App.</span><span class="sxs-lookup"><span data-stu-id="4faab-101">Configuration of an App Service app.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-102">Initialisiert eine neue Instanz der Klasse SiteConfig an.</span><span class="sxs-lookup"><span data-stu-id="4faab-102">Initializes a new instance of the SiteConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="numberOfWorkers"><span data-ttu-id="4faab-103">Anzahl von Arbeitsthreads.</span><span class="sxs-lookup"><span data-stu-id="4faab-103">Number of workers.</span></span></param>
        <param name="defaultDocuments"><span data-ttu-id="4faab-104">Standarddokumente.</span><span class="sxs-lookup"><span data-stu-id="4faab-104">Default documents.</span></span></param>
        <param name="netFrameworkVersion"><span data-ttu-id="4faab-105">.NET Framework-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-105">.NET Framework version.</span></span></param>
        <param name="phpVersion"><span data-ttu-id="4faab-106">PHP-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-106">Version of PHP.</span></span></param>
        <param name="pythonVersion"><span data-ttu-id="4faab-107">Python-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-107">Version of Python.</span></span></param>
        <param name="nodeVersion"><span data-ttu-id="4faab-108">Node.js-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-108">Version of Node.js.</span></span></param>
        <param name="linuxFxVersion"><span data-ttu-id="4faab-109">Linux-App-Framework und version</span><span class="sxs-lookup"><span data-stu-id="4faab-109">Linux App Framework and version</span></span></param>
        <param name="requestTracingEnabled"><span data-ttu-id="4faab-110">&lt;Code&gt;"true"&lt;/code&gt; ist Anforderungsfehler aktiviert ist, andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-110">&lt;code&gt;true&lt;/code&gt; if request tracing is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="requestTracingExpirationTime"><span data-ttu-id="4faab-111">Fordern Sie die Ablaufzeit für die Ablaufverfolgung.</span><span class="sxs-lookup"><span data-stu-id="4faab-111">Request tracing expiration time.</span></span></param>
        <param name="remoteDebuggingEnabled"><span data-ttu-id="4faab-112">&lt;Code&gt;"true"&lt;/code&gt; Wenn Remotedebuggen aktiviert, andernfalls ist &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-112">&lt;code&gt;true&lt;/code&gt; if remote debugging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="remoteDebuggingVersion"><span data-ttu-id="4faab-113">Remote Debug-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-113">Remote debugging version.</span></span></param>
        <param name="httpLoggingEnabled"><span data-ttu-id="4faab-114">&lt;Code&gt;"true"&lt;/code&gt; ist HTTP-Protokollierung aktiviert ist, andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-114">&lt;code&gt;true&lt;/code&gt; if HTTP logging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="logsDirectorySizeLimit"><span data-ttu-id="4faab-115">HTTP-Protokolle Directory Größenlimit.</span><span class="sxs-lookup"><span data-stu-id="4faab-115">HTTP logs directory size limit.</span></span></param>
        <param name="detailedErrorLoggingEnabled"><span data-ttu-id="4faab-116">&lt;Code&gt;"true"&lt;/code&gt; ist ausführliche fehlerprotokollierung aktiviert ist, andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-116">&lt;code&gt;true&lt;/code&gt; if detailed error logging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="publishingUsername"><span data-ttu-id="4faab-117">Benutzername zur Veröffentlichung.</span><span class="sxs-lookup"><span data-stu-id="4faab-117">Publishing user name.</span></span></param>
        <param name="appSettings"><span data-ttu-id="4faab-118">Anwendungseinstellungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-118">Application settings.</span></span></param>
        <param name="connectionStrings"><span data-ttu-id="4faab-119">Verbindungszeichenfolgen.</span><span class="sxs-lookup"><span data-stu-id="4faab-119">Connection strings.</span></span></param>
        <param name="machineKey"><span data-ttu-id="4faab-120">Website-MachineKey.</span><span class="sxs-lookup"><span data-stu-id="4faab-120">Site MachineKey.</span></span></param>
        <param name="handlerMappings"><span data-ttu-id="4faab-121">Handlerzuordnungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-121">Handler mappings.</span></span></param>
        <param name="documentRoot"><span data-ttu-id="4faab-122">Dokumentstamm.</span><span class="sxs-lookup"><span data-stu-id="4faab-122">Document root.</span></span></param>
        <param name="scmType"><span data-ttu-id="4faab-123">SCM-Typ.</span><span class="sxs-lookup"><span data-stu-id="4faab-123">SCM type.</span></span> <span data-ttu-id="4faab-124">Folgende Werte sind möglich: "None", "Ablage", "Tfs", "LocalGit", "GitHub", "CodePlexGit", "CodePlexHg", "BitbucketGit", "BitbucketHg", "ExternalGit", "ExternalHg", "OneDrive", "VSO"</span><span class="sxs-lookup"><span data-stu-id="4faab-124">Possible values include: 'None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO'</span></span></param>
        <param name="use32BitWorkerProcess"><span data-ttu-id="4faab-125">&lt;Code&gt;"true"&lt;/code&gt; mit 32-Bit-Arbeitsprozess; andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-125">&lt;code&gt;true&lt;/code&gt; to use 32-bit worker process; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="webSocketsEnabled"><span data-ttu-id="4faab-126">&lt;Code&gt;"true"&lt;/code&gt; Wenn WebSocket aktiviert, andernfalls ist &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-126">&lt;code&gt;true&lt;/code&gt; if WebSocket is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="alwaysOn"><span data-ttu-id="4faab-127">&lt;Code&gt;"true"&lt;/code&gt; ist AlwaysOn aktiviert ist, andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-127">&lt;code&gt;true&lt;/code&gt; if Always On is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="javaVersion"><span data-ttu-id="4faab-128">Java-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-128">Java version.</span></span></param>
        <param name="javaContainer"><span data-ttu-id="4faab-129">Java-Container.</span><span class="sxs-lookup"><span data-stu-id="4faab-129">Java container.</span></span></param>
        <param name="javaContainerVersion"><span data-ttu-id="4faab-130">Java-Container-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-130">Java container version.</span></span></param>
        <param name="appCommandLine"><span data-ttu-id="4faab-131">App-Befehlszeile zu starten.</span><span class="sxs-lookup"><span data-stu-id="4faab-131">App command line to launch.</span></span></param>
        <param name="managedPipelineMode"><span data-ttu-id="4faab-132">Verwalteter Pipelinemodus.</span><span class="sxs-lookup"><span data-stu-id="4faab-132">Managed pipeline mode.</span></span> <span data-ttu-id="4faab-133">Folgende Werte sind möglich: "Integrierte", "Klassisch"</span><span class="sxs-lookup"><span data-stu-id="4faab-133">Possible values include: 'Integrated', 'Classic'</span></span></param>
        <param name="virtualApplications"><span data-ttu-id="4faab-134">Virtuelle Anwendungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-134">Virtual applications.</span></span></param>
        <param name="loadBalancing"><span data-ttu-id="4faab-135">Standort des Netzwerklastenausgleichs.</span><span class="sxs-lookup"><span data-stu-id="4faab-135">Site load balancing.</span></span> <span data-ttu-id="4faab-136">Folgende Werte sind möglich: "WeightedRoundRobin", "LeastRequests", "LeastResponseTime", "WeightedTotalTraffic", "RequestHash"</span><span class="sxs-lookup"><span data-stu-id="4faab-136">Possible values include: 'WeightedRoundRobin', 'LeastRequests', 'LeastResponseTime', 'WeightedTotalTraffic', 'RequestHash'</span></span></param>
        <param name="experiments"><span data-ttu-id="4faab-137">Dies ist für Polymophic Typen umgehen.</span><span class="sxs-lookup"><span data-stu-id="4faab-137">This is work around for polymophic types.</span></span></param>
        <param name="limits"><span data-ttu-id="4faab-138">Die Grenzwerte.</span><span class="sxs-lookup"><span data-stu-id="4faab-138">Site limits.</span></span></param>
        <param name="autoHealEnabled"><span data-ttu-id="4faab-139">&lt;Code&gt;"true"&lt;/code&gt; Wenn Autom aktiviert, andernfalls ist &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-139">&lt;code&gt;true&lt;/code&gt; if Auto Heal is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="autoHealRules"><span data-ttu-id="4faab-140">Regeln für automatische reparieren.</span><span class="sxs-lookup"><span data-stu-id="4faab-140">Auto Heal rules.</span></span></param>
        <param name="tracingOptions"><span data-ttu-id="4faab-141">Die Ablaufverfolgungsoptionen.</span><span class="sxs-lookup"><span data-stu-id="4faab-141">Tracing options.</span></span></param>
        <param name="vnetName"><span data-ttu-id="4faab-142">Namen des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="4faab-142">Virtual Network name.</span></span></param>
        <param name="cors"><span data-ttu-id="4faab-143">Cross-Origin Resource Sharing (CORS)-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-143">Cross-Origin Resource Sharing (CORS) settings.</span></span></param>
        <param name="push"><span data-ttu-id="4faab-144">Push-endpunkteinstellungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-144">Push endpoint settings.</span></span></param>
        <param name="apiDefinition"><span data-ttu-id="4faab-145">Informationen über die formalen API-Definition für die app.</span><span class="sxs-lookup"><span data-stu-id="4faab-145">Information about the formal API definition for the app.</span></span></param>
        <param name="autoSwapSlotName"><span data-ttu-id="4faab-146">Auto-Swap Slot-Name.</span><span class="sxs-lookup"><span data-stu-id="4faab-146">Auto-swap slot name.</span></span></param>
        <param name="localMySqlEnabled"><span data-ttu-id="4faab-147">&lt;Code&gt;"true"&lt;/code&gt; zum Aktivieren der lokalen MySQL; andernfalls &lt;Code&gt;"false"&lt;/code&gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-147">&lt;code&gt;true&lt;/code&gt; to enable local MySQL; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="ipSecurityRestrictions"><span data-ttu-id="4faab-148">IP-sicherheitseinschränkungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-148">IP security restrictions.</span></span></param>
        <summary>
            <span data-ttu-id="4faab-149">Initialisiert eine neue Instanz der Klasse SiteConfig an.</span><span class="sxs-lookup"><span data-stu-id="4faab-149">Initializes a new instance of the SiteConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AlwaysOn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-150">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn Always On aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-150">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if Always On is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
    ...
    <Member MemberName="ApiDefinition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-151">Ruft ab, oder legt Sie Informationen zu den formalen API-Definition für die app fest.</span><span class="sxs-lookup"><span data-stu-id="4faab-151">Gets or sets information about the formal API definition for the app.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AppCommandLine">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-152">Abrufen oder Festlegen von app-Befehlszeile zu starten.</span><span class="sxs-lookup"><span data-stu-id="4faab-152">Gets or sets app command line to launch.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AppSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-153">Ruft ab, oder legt die Anwendungseinstellungen fest.</span><span class="sxs-lookup"><span data-stu-id="4faab-153">Gets or sets application settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoHealEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-154">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn Autom aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-154">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if Auto Heal is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoHealRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-155">Ruft ab oder legt Regeln für automatische reparieren.</span><span class="sxs-lookup"><span data-stu-id="4faab-155">Gets or sets auto Heal rules.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoSwapSlotName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-156">Ruft ab, oder legt ihn fest automatischen Austausch Slot-Name.</span><span class="sxs-lookup"><span data-stu-id="4faab-156">Gets or sets auto-swap slot name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionStrings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-157">Ruft ab, oder legt ihn fest-Verbindungszeichenfolgen.</span><span class="sxs-lookup"><span data-stu-id="4faab-157">Gets or sets connection strings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Cors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-158">Ruft ab, oder legt ihn fest Cross-Origin Resource Sharing (CORS)-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-158">Gets or sets cross-Origin Resource Sharing (CORS) settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultDocuments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-159">Ruft ab oder legt die Standarddokumente.</span><span class="sxs-lookup"><span data-stu-id="4faab-159">Gets or sets default documents.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DetailedErrorLoggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-160">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn detaillierte fehlerprotokollierung aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-160">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if detailed error logging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DocumentRoot">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-161">Ruft ab, oder legt ihn fest Dokumentstamm.</span><span class="sxs-lookup"><span data-stu-id="4faab-161">Gets or sets document root.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Experiments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-162">Ruft ab oder legt dies umgehen für Polymophic Typen ist.</span><span class="sxs-lookup"><span data-stu-id="4faab-162">Gets or sets this is work around for polymophic types.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HandlerMappings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-163">Ruft ab oder legt Handlerzuordnungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-163">Gets or sets handler mappings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpLoggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-164">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn HTTP-Protokollierung aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-164">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if HTTP logging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpSecurityRestrictions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-165">Ruft ab oder legt die IP-sicherheitseinschränkungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-165">Gets or sets IP security restrictions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaContainer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-166">Ruft ab, oder legt ihn fest Java-Container.</span><span class="sxs-lookup"><span data-stu-id="4faab-166">Gets or sets java container.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaContainerVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-167">Ruft ab oder legt die Version des Java.</span><span class="sxs-lookup"><span data-stu-id="4faab-167">Gets or sets java container version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-168">Ruft ab oder legt die Java-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-168">Gets or sets java version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Limits">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-169">Ruft ab oder legt die Grenzwerte für.</span><span class="sxs-lookup"><span data-stu-id="4faab-169">Gets or sets site limits.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LinuxFxVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-170">Ruft ab oder legt ihn fest Linux App-Framework und Version</span><span class="sxs-lookup"><span data-stu-id="4faab-170">Gets or sets linux App Framework and version</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancing">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-171">Ruft ab, oder legt sie fest, Standort des Lastenausgleichs.</span><span class="sxs-lookup"><span data-stu-id="4faab-171">Gets or sets site load balancing.</span></span> <span data-ttu-id="4faab-172">Folgende Werte sind möglich: "WeightedRoundRobin", "LeastRequests", "LeastResponseTime", "WeightedTotalTraffic", "RequestHash"</span><span class="sxs-lookup"><span data-stu-id="4faab-172">Possible values include: 'WeightedRoundRobin', 'LeastRequests', 'LeastResponseTime', 'WeightedTotalTraffic', 'RequestHash'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LocalMySqlEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-173">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Aktivieren der lokalen MySQL; andernfalls &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-173">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to enable local MySQL; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LogsDirectorySizeLimit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-174">Ruft ab, oder legt ihn fest-Verzeichnis-Größenlimit für HTTP-Protokolle.</span><span class="sxs-lookup"><span data-stu-id="4faab-174">Gets or sets HTTP logs directory size limit.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MachineKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-175">Ruft site MachineKey.</span><span class="sxs-lookup"><span data-stu-id="4faab-175">Gets site MachineKey.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedPipelineMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-176">Abrufen oder Festlegen der verwaltete Pipelinemodus.</span><span class="sxs-lookup"><span data-stu-id="4faab-176">Gets or sets managed pipeline mode.</span></span> <span data-ttu-id="4faab-177">Folgende Werte sind möglich: "Integrierte", "Klassisch"</span><span class="sxs-lookup"><span data-stu-id="4faab-177">Possible values include: 'Integrated', 'Classic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetFrameworkVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-178">Ruft ab oder legt die .NET Framework-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-178">Gets or sets .NET Framework version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NodeVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-179">Ruft ab oder legt Version von Node.js.</span><span class="sxs-lookup"><span data-stu-id="4faab-179">Gets or sets version of Node.js.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumberOfWorkers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-180">Ruft ab oder legt die Anzahl der Arbeitsthreads.</span><span class="sxs-lookup"><span data-stu-id="4faab-180">Gets or sets number of workers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PhpVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-181">Ruft ab oder legt die PHP-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-181">Gets or sets version of PHP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublishingUsername">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-182">Ruft ab oder legt der Benutzername zur Veröffentlichung.</span><span class="sxs-lookup"><span data-stu-id="4faab-182">Gets or sets publishing user name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Push">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-183">Abrufen oder Festlegen der Push-endpunkteinstellungen.</span><span class="sxs-lookup"><span data-stu-id="4faab-183">Gets or sets push endpoint settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PythonVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-184">Ruft ab oder legt die Version von Python.</span><span class="sxs-lookup"><span data-stu-id="4faab-184">Gets or sets version of Python.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RemoteDebuggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-185">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn Remotedebuggen aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-185">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if remote debugging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RemoteDebuggingVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-186">Ruft ab, oder legt ihn fest remote debugging-Version.</span><span class="sxs-lookup"><span data-stu-id="4faab-186">Gets or sets remote debugging version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestTracingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-187">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn Anforderungsfehler aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-187">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if request tracing is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestTracingExpirationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-188">Ruft ab oder legt die Ablaufzeit für Anforderung-Ablaufverfolgung.</span><span class="sxs-lookup"><span data-stu-id="4faab-188">Gets or sets request tracing expiration time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScmType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-189">Ruft ab oder legt SCM-Typ.</span><span class="sxs-lookup"><span data-stu-id="4faab-189">Gets or sets SCM type.</span></span> <span data-ttu-id="4faab-190">Folgende Werte sind möglich: "None", "Ablage", "Tfs", "LocalGit", "GitHub", "CodePlexGit", "CodePlexHg", "BitbucketGit", "BitbucketHg", "ExternalGit", "ExternalHg", "OneDrive", "VSO"</span><span class="sxs-lookup"><span data-stu-id="4faab-190">Possible values include: 'None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TracingOptions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-191">Abrufen oder Festlegen der Ablaufverfolgungsoptionen.</span><span class="sxs-lookup"><span data-stu-id="4faab-191">Gets or sets tracing options.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Use32BitWorkerProcess">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-192">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Verwenden Sie 32-Bit-Arbeitsprozess; andernfalls &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-192">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to use 32-bit worker process; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-193">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="4faab-193">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="4faab-194">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="4faab-194">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="VirtualApplications">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-195">Ruft ab, oder legt Sie virtuelle Anwendungen fest.</span><span class="sxs-lookup"><span data-stu-id="4faab-195">Gets or sets virtual applications.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VnetName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-196">Ruft ab, oder legt ihn fest virtuellen Netzwerknamen.</span><span class="sxs-lookup"><span data-stu-id="4faab-196">Gets or sets virtual Network name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WebSocketsEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4faab-197">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; Wenn WebSocket aktiviert, andernfalls ist &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="4faab-197">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if WebSocket is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
