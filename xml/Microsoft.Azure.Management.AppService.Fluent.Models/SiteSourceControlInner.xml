<Type Name="SiteSourceControlInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.SiteSourceControlInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46625-101">Konfigurieren von Datenquellen-Steuerelement für eine app.</span><span class="sxs-lookup"><span data-stu-id="46625-101">Source control configuration for an app.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-102">Initialisiert eine neue Instanz der SiteSourceControlInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="46625-102">Initializes a new instance of the SiteSourceControlInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Branch">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-103">Ruft ab, oder legt ihn fest Namen der Branch für die Bereitstellung zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="46625-103">Gets or sets name of branch to use for deployment.</span></span>
            </summary>
    ...
    <Member MemberName="DeploymentRollbackEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-104">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; So aktivieren Sie die Bereitstellung zurücksetzen; andernfalls &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt;.</span><span class="sxs-lookup"><span data-stu-id="46625-104">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to enable deployment rollback; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsManualIntegration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-105">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; manuelle Integration; beschränken &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt; fortlaufenden Integration zu aktivieren (die Webhooks in online Repositorys wie GitHub konfiguriert).</span><span class="sxs-lookup"><span data-stu-id="46625-105">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to limit to manual integration; &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt; to enable continuous integration (which configures webhooks into online repos like GitHub).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsMercurial">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-106">Ruft ab oder legt ihn fest &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; für eine Mercurial-Repository; &amp;Lt; Code&amp;Gt "false"&amp;Lt; / code&amp;Gt; für ein Git-Repository.</span><span class="sxs-lookup"><span data-stu-id="46625-106">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; for a Mercurial repository; &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt; for a Git repository.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RepoUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46625-107">Ruft ab, oder legt ihn fest-Repository oder Quelle Steuerelement-URL.</span><span class="sxs-lookup"><span data-stu-id="46625-107">Gets or sets repository or source control URL.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
