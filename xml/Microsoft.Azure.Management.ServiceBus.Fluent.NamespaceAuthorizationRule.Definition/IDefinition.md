<Type Name="IDefinition" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3717a-101">Der Namespace Autorisierung Regeldefinition vollständig.</span><span class="sxs-lookup"><span data-stu-id="3717a-101">The entirety of the namespace authorization rule definition.</span></span>
            </summary>
