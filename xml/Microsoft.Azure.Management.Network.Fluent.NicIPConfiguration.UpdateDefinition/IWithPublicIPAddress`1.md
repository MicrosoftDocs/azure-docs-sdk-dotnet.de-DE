<Type Name="IWithPublicIPAddress&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.UpdateDefinition.IWithPublicIPAddress&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="9d175-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="9d175-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="9d175-102">Die Stufe der Netzwerk-IP-Konfiguration Schnittstellendefinition festlegen, dass es eine öffentliche IP-Adresse zuzuordnen.</span><span class="sxs-lookup"><span data-stu-id="9d175-102">The stage of the network interface IP configuration definition allowing to associate it with a public IP address.</span></span>
            </summary>
