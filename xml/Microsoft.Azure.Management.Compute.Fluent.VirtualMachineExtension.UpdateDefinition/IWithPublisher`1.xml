<Type Name="IWithPublisher&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithPublisher&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="0708c-101">Die Phase des übergeordneten Updates wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="0708c-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="0708c-102">Die Phase der Definition des VM-Erweiterung an den Herausgeber der Erweiterung-Image des virtuellen Computers ermöglicht diese Erweiterung basiert.</span><span class="sxs-lookup"><span data-stu-id="0708c-102">The stage of the virtual machine extension definition allowing to specify the publisher of the virtual machine extension image this extension is based on.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPublisher">
      ...
      <Docs>
        <param name="extensionImagePublisherName"><span data-ttu-id="0708c-103">Der Name des Verlegers.</span><span class="sxs-lookup"><span data-stu-id="0708c-103">The publisher name.</span></span></param>
        <summary>
            <span data-ttu-id="0708c-104">Gibt den Namen des Verlegers Image der virtuellen Maschine.</span><span class="sxs-lookup"><span data-stu-id="0708c-104">Specifies the name of the virtual machine extension image publisher.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0708c-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="0708c-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>