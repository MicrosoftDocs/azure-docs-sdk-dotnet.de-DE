<Type Name="IWithVersion&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithVersion&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="cb5ab-101">Die Phase des übergeordneten Updates wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="cb5ab-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="cb5ab-102">Die Phase der Definition des VM-Erweiterung zur Angabe von der Version der Erweiterung für virtuellen Computer ermöglicht diese Erweiterung basiert.</span><span class="sxs-lookup"><span data-stu-id="cb5ab-102">The stage of the virtual machine extension definition allowing to specify the type of the virtual machine extension version this extension is based on.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithVersion">
      ...
      <Docs>
        <param name="extensionImageVersionName"><span data-ttu-id="cb5ab-103">Der Name der.</span><span class="sxs-lookup"><span data-stu-id="cb5ab-103">The version name.</span></span></param>
        <summary>
            <span data-ttu-id="cb5ab-104">Gibt die Version der Erweiterung des virtuellen Computers-Image.</span><span class="sxs-lookup"><span data-stu-id="cb5ab-104">Specifies the version of the virtual machine image extension.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="cb5ab-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="cb5ab-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>