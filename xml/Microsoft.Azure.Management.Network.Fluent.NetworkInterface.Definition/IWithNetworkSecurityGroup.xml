<Type Name="IWithNetworkSecurityGroup" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkInterface.Definition.IWithNetworkSecurityGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a93f0-101">Die Stufe der netzwerkschnittstellendefinition ermöglicht eine Netzwerksicherheitsgruppe zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="a93f0-101">The stage of the network interface definition allowing to associate a network security group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingNetworkSecurityGroup">
      ...
      <Docs>
        <param name="networkSecurityGroup"><span data-ttu-id="a93f0-102">Eine vorhandene Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="a93f0-102">An existing network security group.</span></span></param>
        <summary>
            <span data-ttu-id="a93f0-103">Ordnet eine vorhandene Netzwerksicherheitsgruppe der Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="a93f0-103">Associates an existing network security group with the network interface.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a93f0-104">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="a93f0-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithNewNetworkSecurityGroup">
      ...
      <Docs>
        <param name="creatable"><span data-ttu-id="a93f0-105">Eine erstellbare Definition für eine neue Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="a93f0-105">A creatable definition for a new network security group.</span></span></param>
        <summary>
            <span data-ttu-id="a93f0-106">Erstellen Sie eine neue Netzwerksicherheitsgruppe Netzwerkschnittstelle, die auf Grundlage der bereitgestellten Definition zugeordnet werden soll.</span><span class="sxs-lookup"><span data-stu-id="a93f0-106">Create a new network security group to associate with network interface, based on the provided definition.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a93f0-107">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="a93f0-107">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>