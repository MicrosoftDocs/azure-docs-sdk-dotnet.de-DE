<Type Name="MetricsLevel" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.MetricsLevel">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0b1c7-101">Enumeration, die den Zustand der metrikauflistung in einem Dienst darstellt.</span><span class="sxs-lookup"><span data-stu-id="0b1c7-101">Enumeration representing the state of metrics collection in a service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b1c7-102">Metrikauflistung ist deaktiviert.</span><span class="sxs-lookup"><span data-stu-id="0b1c7-102">Metrics collection is disabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Service">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b1c7-103">Servicelevel-metrikauflistung ist aktiviert.</span><span class="sxs-lookup"><span data-stu-id="0b1c7-103">Service-level metrics collection is enabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ServiceAndApi">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b1c7-104">Servicelevel-Zielpunkte und API-metrikauflistung sind aktiviert.</span><span class="sxs-lookup"><span data-stu-id="0b1c7-104">Service-level and API metrics collection are enabled.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
