<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityGroup.Definition.IWithGroup">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Network.Fluent.NetworkSecurityGroup.Definition.IWithGroup" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="216d0-101">Die Stufe festlegen, dass die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="216d0-101">The stage allowing to specify the resource group.</span></span>
            </summary>
