<Type Name="ContinuousWebJobStatus" FullName="Microsoft.Azure.Management.WebSites.Models.ContinuousWebJobStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5d8ca-101">Definiert Werte für ContinuousWebJobStatus an.</span><span class="sxs-lookup"><span data-stu-id="5d8ca-101">Defines values for ContinuousWebJobStatus.</span></span>
            </summary>
