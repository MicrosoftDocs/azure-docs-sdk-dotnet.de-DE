<Type Name="HostingEnvironmentDeploymentInfo" FullName="Microsoft.Azure.Management.WebSites.Models.HostingEnvironmentDeploymentInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a0f5b-101">Informationen zum Erstellen von Ressourcen auf einer App Service-Umgebung benötigt.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-101">Information needed to create resources on an App Service Environment.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a0f5b-102">Initialisiert eine neue Instanz der HostingEnvironmentDeploymentInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-102">Initializes a new instance of the HostingEnvironmentDeploymentInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="a0f5b-103">Name des App Service-Umgebung.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-103">Name of the App Service Environment.</span></span></param>
        <param name="location"><span data-ttu-id="a0f5b-104">Speicherort der App Service-Umgebung.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-104">Location of the App Service Environment.</span></span></param>
        <summary>
            <span data-ttu-id="a0f5b-105">Initialisiert eine neue Instanz der HostingEnvironmentDeploymentInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-105">Initializes a new instance of the HostingEnvironmentDeploymentInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a0f5b-106">Ruft ab oder legt die Position des App Service-Umgebung.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-106">Gets or sets location of the App Service Environment.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a0f5b-107">Ruft ab oder legt den Namen der App Service-Umgebung fest.</span><span class="sxs-lookup"><span data-stu-id="a0f5b-107">Gets or sets name of the App Service Environment.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
