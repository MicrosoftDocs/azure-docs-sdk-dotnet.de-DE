<Type Name="Dimension" FullName="Microsoft.Azure.Management.WebSites.Models.Dimension">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6aea5-101">Die Dimension einer Ressource Metrik.</span><span class="sxs-lookup"><span data-stu-id="6aea5-101">Dimension of a resource metric.</span></span> <span data-ttu-id="6aea5-102">Für z. B. Instanz bestimmte HTTP-Anforderungen für eine Web-app, wobei Instanzname Dimension Metrik HTTP-Anforderung ist</span><span class="sxs-lookup"><span data-stu-id="6aea5-102">For e.g. instance specific HTTP requests for a web app, where instance name is dimension of the metric HTTP request</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6aea5-103">Initialisiert eine neue Instanz der Dimension-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6aea5-103">Initializes a new instance of the Dimension class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="6aea5-104">Initialisiert eine neue Instanz der Dimension-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6aea5-104">Initializes a new instance of the Dimension class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
