<Type Name="AutoHealRules" FullName="Microsoft.Azure.Management.WebSites.Models.AutoHealRules">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3d3ec-101">Regeln, die für definiert werden können Autom –.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-101">Rules that can be defined for auto-heal.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3d3ec-102">Initialisiert eine neue Instanz der AutoHealRules-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-102">Initializes a new instance of the AutoHealRules class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="triggers"><span data-ttu-id="3d3ec-103">Bedingungen, die beim Ausführen beschreiben die Aktionen Autom.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-103">Conditions that describe when to execute the auto-heal actions.</span></span></param>
        <param name="actions"><span data-ttu-id="3d3ec-104">Aktionen, die ausgeführt werden, wenn eine Regel ausgelöst wird.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-104">Actions to be executed when a rule is triggered.</span></span></param>
        <summary>
            <span data-ttu-id="3d3ec-105">Initialisiert eine neue Instanz der AutoHealRules-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-105">Initializes a new instance of the AutoHealRules class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Actions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3d3ec-106">Abrufen oder Festlegen von Aktionen an, die ausgeführt werden, wenn eine Regel ausgelöst wird.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-106">Gets or sets actions to be executed when a rule is triggered.</span></span>
            </summary>
    ...
    <Member MemberName="Triggers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3d3ec-107">Ruft ab oder legt die Bedingungen, die beim Ausführen beschreiben die Aktionen Autom.</span><span class="sxs-lookup"><span data-stu-id="3d3ec-107">Gets or sets conditions that describe when to execute the auto-heal actions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
