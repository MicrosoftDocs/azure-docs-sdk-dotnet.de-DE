<Type Name="SiteSealRequest" FullName="Microsoft.Azure.Management.WebSites.Models.SiteSealRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="542ea-101">Standort versiegeln-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="542ea-101">Site seal request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="542ea-102">Initialisiert eine neue Instanz der SiteSealRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="542ea-102">Initializes a new instance of the SiteSealRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lightTheme"><span data-ttu-id="542ea-103">Wenn &lt;Code&gt;"true"&lt;/code&gt; die helle Farbe Design für Standort versiegeln verwenden; verwenden Sie andernfalls das Standarddesign-Farbe.</span><span class="sxs-lookup"><span data-stu-id="542ea-103">If &lt;code&gt;true&lt;/code&gt; use the light color theme for site seal; otherwise, use the default color theme.</span></span></param>
        <param name="locale"><span data-ttu-id="542ea-104">Gebietsschema der Website versiegeln.</span><span class="sxs-lookup"><span data-stu-id="542ea-104">Locale of site seal.</span></span></param>
        <summary>
            <span data-ttu-id="542ea-105">Initialisiert eine neue Instanz der SiteSealRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="542ea-105">Initializes a new instance of the SiteSealRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LightTheme">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="542ea-106">Ruft ab oder legt sie fest, wenn &amp;Lt; Code&amp;Gt; "true"&amp;Lt; / code&amp;Gt; die helle Farbe Design für Standort versiegeln verwenden; verwenden Sie andernfalls das Standarddesign-Farbe.</span><span class="sxs-lookup"><span data-stu-id="542ea-106">Gets or sets if &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; use the light color theme for site seal; otherwise, use the default color theme.</span></span>
            </summary>
    ...
    <Member MemberName="Locale">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="542ea-107">Ruft ab, oder legt ihn fest Gebietsschema des Standorts versiegeln.</span><span class="sxs-lookup"><span data-stu-id="542ea-107">Gets or sets locale of site seal.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
