<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.KeyVault.Fluent.Vault.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b11fa-101">Die Definition einer schlüsseltresor ermöglicht Ressourcengruppe festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="b11fa-101">A key vault definition allowing resource group to be set.</span></span>
            </summary>
