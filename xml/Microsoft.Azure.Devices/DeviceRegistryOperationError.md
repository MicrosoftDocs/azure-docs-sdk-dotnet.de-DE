<Type Name="DeviceRegistryOperationError" FullName="Microsoft.Azure.Devices.DeviceRegistryOperationError">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="17e89-101">Kapselt die Details zum Gerät Registrierung Vorgang Systemfehler.</span><span class="sxs-lookup"><span data-stu-id="17e89-101">Encapsulates device registry operation error details.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="DeviceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="17e89-102">Die ID des Geräts, das der Fehler angegeben.</span><span class="sxs-lookup"><span data-stu-id="17e89-102">The ID of the device that indicated the error.</span></span>
            </summary>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="17e89-103">Der Fehlercode des Fehlers.</span><span class="sxs-lookup"><span data-stu-id="17e89-103">ErrorCode associated with the error.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="17e89-104">Weitere Details des Fehlers.</span><span class="sxs-lookup"><span data-stu-id="17e89-104">Additional details associated with the error.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
