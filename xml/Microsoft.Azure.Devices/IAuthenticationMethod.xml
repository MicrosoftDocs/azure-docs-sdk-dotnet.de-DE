<Type Name="IAuthenticationMethod" FullName="Microsoft.Azure.Devices.IAuthenticationMethod">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2b416-101">Authentifizierung-Schnittstelle, die für die Kommunikation mit IoTHub verwendet.</span><span class="sxs-lookup"><span data-stu-id="2b416-101">Authentication interface to use for IoTHub communications.</span></span>
            </summary>
