<Type Name="ServiceAuthenticationWithSharedAccessPolicyToken" FullName="Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyToken">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dbf8c-101">Die Authentifizierungsmethode, die ein Token der SAS-Richtlinie verwendet.</span><span class="sxs-lookup"><span data-stu-id="dbf8c-101">Authentication method that uses a shared access policy token.</span></span> 
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="policyName"><span data-ttu-id="dbf8c-102">Name der Richtlinie für freigegebenen Zugriff zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="dbf8c-102">Name of the shared access policy to use.</span></span></param>
        <param name="token"><span data-ttu-id="dbf8c-103">Das Token der SAS-Richtlinie zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="dbf8c-103">Token associated with the shared access policy.</span></span></param>
        <summary>
            <span data-ttu-id="dbf8c-104">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyToken" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="dbf8c-104">Initializes a new instance of the <see cref="T:Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyToken" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
