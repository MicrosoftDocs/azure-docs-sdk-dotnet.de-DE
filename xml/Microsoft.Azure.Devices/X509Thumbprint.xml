<Type Name="X509Thumbprint" FullName="Microsoft.Azure.Devices.X509Thumbprint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d9b6-101">X509 Client-zertifikatfingerabdrücken des Geräts</span><span class="sxs-lookup"><span data-stu-id="0d9b6-101">X509 client certificate thumbprints of the device</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="PrimaryThumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d9b6-102">X509 primären Fingerabdruck des Clientzertifikats</span><span class="sxs-lookup"><span data-stu-id="0d9b6-102">X509 client certificate primary thumbprint</span></span>
            </summary>
    ...
    <Member MemberName="SecondaryThumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d9b6-103">X509 sekundären Fingerabdruck des Clientzertifikats</span><span class="sxs-lookup"><span data-stu-id="0d9b6-103">X509 client certificate secondary thumbprint</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
