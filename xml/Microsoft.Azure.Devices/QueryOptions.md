<Type Name="QueryOptions" FullName="Microsoft.Azure.Devices.QueryOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="722cf-101">Gibt die Optionen, die Abfragen zugeordnet sind</span><span class="sxs-lookup"><span data-stu-id="722cf-101">Specifies the options associated with queries</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="722cf-102">Das Token für die Fortsetzung der Enumeration Abfrage verwenden</span><span class="sxs-lookup"><span data-stu-id="722cf-102">The token to use for continuing the query enumeration</span></span>
            </summary>
