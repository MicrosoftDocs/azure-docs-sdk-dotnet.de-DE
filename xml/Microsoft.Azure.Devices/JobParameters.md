<Type Name="JobParameters" FullName="Microsoft.Azure.Devices.JobParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="72a67-101">Geben Sie speziell für einen Auftrag in JobRequest verwendet</span><span class="sxs-lookup"><span data-stu-id="72a67-101">Input specific to a job used in JobRequest</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="JobType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="72a67-102">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="72a67-102">Required.</span></span>
            <span data-ttu-id="72a67-103">Der Typ des auszuführenden Auftrag.</span><span class="sxs-lookup"><span data-stu-id="72a67-103">The type of job to execute.</span></span>
            </summary>
