<Type Name="CloudToDeviceMethodResult" FullName="Microsoft.Azure.Devices.CloudToDeviceMethodResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d0adc-101">Stellt die Methodenergebnisse Aufruf Gerät dar.</span><span class="sxs-lookup"><span data-stu-id="d0adc-101">Represents the Device Method Invocation Results.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="GetPayloadAsJson">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d0adc-102">Laden Sie die Nutzlast als json</span><span class="sxs-lookup"><span data-stu-id="d0adc-102">Get payload as json</span></span>
            </summary>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d0adc-103">Ruft ab oder legt den Status des Geräte-Methodenaufruf.</span><span class="sxs-lookup"><span data-stu-id="d0adc-103">Gets or sets the status of device method invocation.</span></span>
            </summary>
