<Type Name="DeviceJobParameters" FullName="Microsoft.Azure.Devices.DeviceJobParameters">
  ...
  <Docs>
    <summary>
                <span data-ttu-id="1740b-101">Erweitern Sie JobParameters mit Geräte-Ids</span><span class="sxs-lookup"><span data-stu-id="1740b-101">Extend JobParameters with device Ids</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
                <span data-ttu-id="1740b-102">Die Parameter für parameterlosen Gerät Auftrag auf mehreren Geräten</span><span class="sxs-lookup"><span data-stu-id="1740b-102">Parameters for parameterless device job on multiple devices</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
                <span data-ttu-id="1740b-103">Die Parameter für parameterlosen Gerät Auftrag auf ein einziges Gerät</span><span class="sxs-lookup"><span data-stu-id="1740b-103">Parameters for parameterless device job on a single device</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeviceIds">
      ...
      <Docs>
        <summary>
                <span data-ttu-id="1740b-104">IDs der Zielgeräte</span><span class="sxs-lookup"><span data-stu-id="1740b-104">Ids of target devices</span></span>
            </summary>
