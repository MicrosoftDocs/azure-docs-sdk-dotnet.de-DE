<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Cdn.Fluent.CdnProfile.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b0730-101">Die Phase der Definition eines CDN-Profil können die Ressourcengruppe angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="b0730-101">The stage of a CDN profile definition allowing the resource group to be specified.</span></span>
            </summary>
