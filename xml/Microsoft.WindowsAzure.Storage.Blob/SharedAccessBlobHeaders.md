<Type Name="SharedAccessBlobHeaders" FullName="Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="102ad-101">Stellt die optionalen Header, die mit Blobs über SAS zugegriffen zurückgegeben werden können.</span><span class="sxs-lookup"><span data-stu-id="102ad-101">Represents the optional headers that can be returned with blobs accessed using SAS.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="102ad-102">Initializes a new instance of the <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sharedAccessBlobHeaders"><span data-ttu-id="102ad-103">Der Satz von <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" /> klonen.</span><span class="sxs-lookup"><span data-stu-id="102ad-103">The set of <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" /> to clone.</span></span></param>
        <summary>
            <span data-ttu-id="102ad-104">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" /> -Klasse auf Grundlage einer vorhandenen Instanz.</span><span class="sxs-lookup"><span data-stu-id="102ad-104">Initializes a new instance of the <see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobHeaders" /> class based on an existing instance.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CacheControl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-105">Ruft ab oder legt den mit dem Blob zurückgegebenen Cache-Control-Header fest.</span><span class="sxs-lookup"><span data-stu-id="102ad-105">Gets or sets the cache-control header returned with the blob.</span></span>
            </summary>
        <value><span data-ttu-id="102ad-106">Eine Zeichenfolge, die den Cache-Control-Wert enthält.</span><span class="sxs-lookup"><span data-stu-id="102ad-106">A string containing the cache-control value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentDisposition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-107">Ruft ab, oder legt ihn fest mit dem Blob zurückgegebenen Content-Disposition-Headers.</span><span class="sxs-lookup"><span data-stu-id="102ad-107">Gets or sets the content-disposition header returned with the blob.</span></span>
            </summary>
        <value><span data-ttu-id="102ad-108">Eine Zeichenfolge mit der Content-Disposition-Wert.</span><span class="sxs-lookup"><span data-stu-id="102ad-108">A string containing the content-disposition value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentEncoding">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-109">Ruft ab, oder legt ihn fest mit dem Blob zurückgegebenen Content-encoding-Headers.</span><span class="sxs-lookup"><span data-stu-id="102ad-109">Gets or sets the content-encoding header returned with the blob.</span></span>
            </summary>
        <value><span data-ttu-id="102ad-110">Eine Zeichenfolge mit der Content-encoding-Wert.</span><span class="sxs-lookup"><span data-stu-id="102ad-110">A string containing the content-encoding value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-111">Ruft ab, oder legt ihn fest mit dem Blob zurückgegebenen Content-Language-Headers.</span><span class="sxs-lookup"><span data-stu-id="102ad-111">Gets or sets the content-language header returned with the blob.</span></span>
            </summary>
        <value><span data-ttu-id="102ad-112">Eine Zeichenfolge mit der Content-Language-Wert.</span><span class="sxs-lookup"><span data-stu-id="102ad-112">A string containing the content-language value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="102ad-113">Ruft ab, oder legt ihn fest mit dem Blob zurückgegebenen Content-Type-Headers.</span><span class="sxs-lookup"><span data-stu-id="102ad-113">Gets or sets the content-type header returned with the blob.</span></span>
            </summary>
        <value><span data-ttu-id="102ad-114">Eine Zeichenfolge mit der Content-Type-Wert.</span><span class="sxs-lookup"><span data-stu-id="102ad-114">A string containing the content-type value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
