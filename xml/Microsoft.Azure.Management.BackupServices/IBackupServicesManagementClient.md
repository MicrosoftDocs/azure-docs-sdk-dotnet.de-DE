<Type Name="IBackupServicesManagementClient" FullName="Microsoft.Azure.Management.BackupServices.IBackupServicesManagementClient">
  ...
  <Members>
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-101">Ruft die API-Version ab.</span><span class="sxs-lookup"><span data-stu-id="4587b-101">Gets the API version.</span></span>
            </summary>
    ...
    <Member MemberName="BackUp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-102">Definition der Sicherungsvorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-102">Definition of BackUp operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-103">Ruft den URI, der als Basis für alle Cloud-Service-Requests verwendet.</span><span class="sxs-lookup"><span data-stu-id="4587b-103">Gets the URI used as the base for all cloud service requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Container">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-104">Definition der containervorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-104">Definition of Container operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-105">Ruft die abonnementanmeldeinformationen ab Microsoft Azure-Abonnement eindeutig identifiziert.</span><span class="sxs-lookup"><span data-stu-id="4587b-105">Gets subscription credentials which uniquely identify Microsoft Azure subscription.</span></span> <span data-ttu-id="4587b-106">Die Abonnement-ID ist Teil der URI für jeden Dienstaufruf.</span><span class="sxs-lookup"><span data-stu-id="4587b-106">The subscription ID forms part of the URI for every service call.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CSMProtectionPolicy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-107">Die Definition der Schutzrichtlinie Vorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-107">Definition of Protection Policy operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataSource">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-108">Die Definition der DataSource-Vorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-108">Definition of DataSource operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Job">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-109">Definition der auftragsvorgänge für Azure backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-109">Definition of Job operations for Azure backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationInitialTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-110">Ruft ab oder legt das ursprüngliche Timeout für zeitintensive Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="4587b-110">Gets or sets the initial timeout for Long Running Operations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-111">Ruft ab oder legt das wiederholungstimeout für zeitintensive Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="4587b-111">Gets or sets the retry timeout for Long Running Operations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-112">Die Definition des Workflow-Vorgangs für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-112">Definition of Workflow operation for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectableObject">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-113">Definition der schützbaren ObjectOperation Vorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-113">Definition of Protectable ObjectOperation operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-114">Die Definition der Wiederherstellungspunkt-Vorgänge für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-114">Definition of Recovery Point operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Restore">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4587b-115">Definition von Wiederherstellungsvorgängen für die Azure Backup-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="4587b-115">Definition of Restore operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
