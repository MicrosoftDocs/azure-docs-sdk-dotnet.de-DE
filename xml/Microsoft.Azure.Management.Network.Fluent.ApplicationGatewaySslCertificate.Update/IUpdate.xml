<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewaySslCertificate.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="09431-101">Eine Anwendung Gateway SSL-Zertifikat aktualisieren als Teil einer Anwendung gatewayupdate vollständig.</span><span class="sxs-lookup"><span data-stu-id="09431-101">The entirety of an application gateway SSL certificate update as part of an application gateway update.</span></span>
            </summary>
