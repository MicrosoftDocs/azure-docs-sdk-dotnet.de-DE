<Type Name="ICdnManagementClient" FullName="Microsoft.Azure.Management.Cdn.Fluent.ICdnManagementClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2fbdd-101">Verwenden Sie diese APIs zum Verwalten von Azure-CDN-Ressourcen über den Azure Resource Manager.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-101">Use these APIs to manage Azure CDN resources through the Azure Resource Manager.</span></span> <span data-ttu-id="2fbdd-102">Sie müssen sicherstellen, dass für diese Ressourcen vorgenommenen Anforderungen sicher sind.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-102">You must make sure that requests made to these resources are secure.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AcceptLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-103">Ruft ab oder legt die bevorzugte Sprache für die Antwort.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-103">Gets or sets the preferred language for the response.</span></span>
            </summary>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-104">Die Version der API mit der Clientanforderung verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-104">Version of the API to be used with the client request.</span></span> <span data-ttu-id="2fbdd-105">Aktuelle Version ist 2016-10-02.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-105">Current version is 2016-10-02.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-106">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-106">The base URI of the service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CheckNameAvailabilityWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="name">
            <span data-ttu-id="2fbdd-107">Der Name der Ressource zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-107">The resource name to validate.</span></span>
            </param>
        <param name="customHeaders">
            <span data-ttu-id="2fbdd-108">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-108">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="2fbdd-109">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-109">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="2fbdd-110">Überprüfen Sie die Verfügbarkeit der Name einer Ressource.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-110">Check the availability of a resource name.</span></span> <span data-ttu-id="2fbdd-111">Dies ist für Ressourcen erforderlich, wobei der Name global eindeutig sein, z. B. einen CDN-Endpunkt ist.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-111">This is needed for resources where name is globally unique, such as a CDN endpoint.</span></span>
            </summary>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-112">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-112">Credentials needed for the client to connect to Azure.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CustomDomains">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-113">Ruft die ICustomDomainsOperations ab.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-113">Gets the ICustomDomainsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeserializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-114">Ermittelt oder Json-Deserialisierung Einstellungen definiert.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-114">Gets or sets json deserialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EdgeNodes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-115">Ruft die IEdgeNodesOperations ab.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-115">Gets the IEdgeNodesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoints">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-116">Ruft die IEndpointsOperations ab.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-116">Gets the IEndpointsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GenerateClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-117">Bei Festlegung werden auf einen eindeutigen X-ms-Client-Request-Id-Wert "true" generiert und in jeder Anforderung enthalten.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-117">When set to true a unique x-ms-client-request-id value is generated and included in each request.</span></span> <span data-ttu-id="2fbdd-118">Der Standardwert ist true.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-118">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListOperationsNextWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="nextPageLink">
            <span data-ttu-id="2fbdd-119">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-119">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="customHeaders">
            <span data-ttu-id="2fbdd-120">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-120">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="2fbdd-121">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-121">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="2fbdd-122">Zeigt eine Liste aller verfügbaren CDN-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-122">Lists all of the available CDN REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListOperationsWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="customHeaders">
            <span data-ttu-id="2fbdd-123">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-123">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="2fbdd-124">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-124">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="2fbdd-125">Zeigt eine Liste aller verfügbaren CDN-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-125">Lists all of the available CDN REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListResourceUsageNextWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="nextPageLink">
            <span data-ttu-id="2fbdd-126">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-126">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="customHeaders">
            <span data-ttu-id="2fbdd-127">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-127">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="2fbdd-128">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-128">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="2fbdd-129">Überprüfen Sie das Kontingent und die tatsächliche Nutzung CDN-Profil unter dem angegebenen Abonnement.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-129">Check the quota and actual usage of the CDN profiles under the given subscription.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListResourceUsageWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="customHeaders">
            <span data-ttu-id="2fbdd-130">Die Header, die hinzugefügt werden auf Anforderung.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-130">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="2fbdd-131">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-131">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="2fbdd-132">Überprüfen Sie das Kontingent und die tatsächliche Nutzung CDN-Profil unter dem angegebenen Abonnement.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-132">Check the quota and actual usage of the CDN profiles under the given subscription.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-133">Ruft ab oder legt das wiederholungstimeout in Sekunden für zeitintensive Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-133">Gets or sets the retry timeout in seconds for Long Running Operations.</span></span> <span data-ttu-id="2fbdd-134">Standardwert ist 30.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-134">Default value is 30.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Origins">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-135">Ruft die IOriginsOperations ab.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-135">Gets the IOriginsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Profiles">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-136">Ruft die IProfilesOperations ab.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-136">Gets the IProfilesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SerializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-137">Ermittelt oder Json-Serialisierungseinstellungen definiert.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-137">Gets or sets json serialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2fbdd-138">Die Azure-Abonnement-ID.</span><span class="sxs-lookup"><span data-stu-id="2fbdd-138">Azure Subscription ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
