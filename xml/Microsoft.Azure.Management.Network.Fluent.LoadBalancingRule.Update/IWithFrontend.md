<Type Name="IWithFrontend" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Update.IWithFrontend">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3b817-101">Die Phase des Lastenausgleichs Regel Update ermöglicht, so ändern Sie den Front-End-Verweis.</span><span class="sxs-lookup"><span data-stu-id="3b817-101">The stage of a load balancing rule update allowing to modify the frontend reference.</span></span>
            </summary>
