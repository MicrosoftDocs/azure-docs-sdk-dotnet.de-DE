<Type Name="IWithProtocol" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Update.IWithProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f8844-101">Die Phase des Lastenausgleichs Regel Update ermöglicht das Transportprotokoll ändern können, dem die Regel angewendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="f8844-101">The stage of a load balancing rule update allowing to modify the transport protocol the rule applies to.</span></span>
            </summary>
