<Type Name="IWithFrontendPort" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Update.IWithFrontendPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c7bf7-101">Die Phase des Lastenausgleichs Regel Update zum gewähren den Front-End-Port zu ändern.</span><span class="sxs-lookup"><span data-stu-id="c7bf7-101">The stage of a load balancing rule update allowing to modify the frontend port.</span></span>
            </summary>
