<Type Name="IWithBackendPort" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Update.IWithBackendPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e618c-101">Die Phase des Lastenausgleichs Regel Update zum gewähren den Back-End-Port zu ändern.</span><span class="sxs-lookup"><span data-stu-id="e618c-101">The stage of a load balancing rule update allowing to modify the backend port.</span></span>
            </summary>
