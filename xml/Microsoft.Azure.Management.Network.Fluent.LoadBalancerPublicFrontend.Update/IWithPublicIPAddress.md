<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerPublicFrontend.Update.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f5aa6-101">Die Phase eine öffentliche Front-End-Update ermöglichen eine vorhandene öffentliche IP-Adresse angeben.</span><span class="sxs-lookup"><span data-stu-id="f5aa6-101">The stage of a public frontend update allowing to specify an existing public IP address.</span></span>
            </summary>
