<Type Name="IWithSslPassword&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasSslCertificate.Update.IWithSslPassword&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="b7e03-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="b7e03-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="b7e03-102">Die Phase einer Ressource Update ermöglichen Sie das Kennwort für den privaten Schlüssel des importierten SSL-Zertifikats an.</span><span class="sxs-lookup"><span data-stu-id="b7e03-102">The stage of a resource update allowing to specify the password for the private key of the imported SSL certificate.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSslCertificatePassword">
      ...
      <Docs>
        <param name="password"><span data-ttu-id="b7e03-103">Das Kennwort für die importierte PFX-Datei.</span><span class="sxs-lookup"><span data-stu-id="b7e03-103">The password of the imported PFX file.</span></span></param>
        <summary>
            <span data-ttu-id="b7e03-104">Gibt das Kennwort für die angegebene PFX-Datei mit dem privaten Schlüssel des importierten SSL-Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="b7e03-104">Specifies the password for the specified PFX file containing the private key of the imported SSL certificate.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="b7e03-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="b7e03-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>