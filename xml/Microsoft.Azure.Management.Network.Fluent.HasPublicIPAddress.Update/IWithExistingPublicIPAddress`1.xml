<Type Name="IWithExistingPublicIPAddress&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPublicIPAddress.Update.IWithExistingPublicIPAddress&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="5c0df-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="5c0df-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="5c0df-102">Die Phase des Updates ermöglicht, eine vorhandene öffentliche IP-Adresse die Ressource zugeordnet werden soll.</span><span class="sxs-lookup"><span data-stu-id="5c0df-102">The stage of the update allowing to associate the resource with an existing public IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingPublicIPAddress">
      ...
      <Docs>
        <param name="publicIPAddress"><span data-ttu-id="5c0df-103">Eine vorhandene öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="5c0df-103">An existing public IP address.</span></span></param>
        <summary>
            <span data-ttu-id="5c0df-104">Ordnet eine vorhandene öffentliche IP-Adresse der Ressource.</span><span class="sxs-lookup"><span data-stu-id="5c0df-104">Associates an existing public IP address with the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5c0df-105">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="5c0df-105">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithExistingPublicIPAddress">
      ...
      <Docs>
        <param name="resourceId"><span data-ttu-id="5c0df-106">Die Ressourcen-ID, eine vorhandene öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="5c0df-106">The resource ID of an existing public IP address.</span></span></param>
        <summary>
            <span data-ttu-id="5c0df-107">Ordnet eine vorhandene öffentliche IP-Adresse der Ressource.</span><span class="sxs-lookup"><span data-stu-id="5c0df-107">Associates an existing public IP address with the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5c0df-108">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="5c0df-108">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithoutPublicIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5c0df-109">Entfernt den Verweis auf eine öffentliche IP-Adresse an.</span><span class="sxs-lookup"><span data-stu-id="5c0df-109">Removes the existing reference to a public IP address.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5c0df-110">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="5c0df-110">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>