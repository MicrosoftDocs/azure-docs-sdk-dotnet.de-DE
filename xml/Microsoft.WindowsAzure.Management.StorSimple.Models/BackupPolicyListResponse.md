<Type Name="BackupPolicyListResponse" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.BackupPolicyListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2b8ec-101">Das Antwort-Modell für die Liste der Sicherungsrichtlinien.</span><span class="sxs-lookup"><span data-stu-id="2b8ec-101">The response model for the list of backup policies.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2b8ec-102">Initialisiert eine neue Instanz der BackupPolicyListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2b8ec-102">Initializes a new instance of the BackupPolicyListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BackupPolicies">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2b8ec-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="2b8ec-103">Optional.</span></span> <span data-ttu-id="2b8ec-104">Die Auflistung von Sicherungsrichtlinien</span><span class="sxs-lookup"><span data-stu-id="2b8ec-104">The collection of backup policies</span></span>
            </summary>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2b8ec-105">Ruft die Sequenz von BackupPolicies ab.</span><span class="sxs-lookup"><span data-stu-id="2b8ec-105">Gets the sequence of BackupPolicies.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2b8ec-106">Ruft die Sequenz von BackupPolicies ab.</span><span class="sxs-lookup"><span data-stu-id="2b8ec-106">Gets the sequence of BackupPolicies.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
