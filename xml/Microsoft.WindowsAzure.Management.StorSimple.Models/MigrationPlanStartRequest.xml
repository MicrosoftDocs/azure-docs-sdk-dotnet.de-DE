<Type Name="MigrationPlanStartRequest" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.MigrationPlanStartRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="22176-101">Diese Klasse stellt Anforderungstext des Start-Migrationsplan.</span><span class="sxs-lookup"><span data-stu-id="22176-101">This class represents request body of start migration plan.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="22176-102">Initialisiert eine neue Instanz der MigrationPlanStartRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="22176-102">Initializes a new instance of the MigrationPlanStartRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="22176-103">Initialisiert eine neue Instanz der MigrationPlanStartRequest-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="22176-103">Initializes a new instance of the MigrationPlanStartRequest class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConfigId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="22176-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="22176-104">Required.</span></span> <span data-ttu-id="22176-105">Ruft ab, oder legt ihn fest legacy Appliance Konfigurations-Id, die beim Importieren der Konfigurationsdatei übergeben.</span><span class="sxs-lookup"><span data-stu-id="22176-105">Gets or sets legacy appliance config id passed while importing the config.</span></span>
            </summary>
    ...
    <Member MemberName="DataContainerNameList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="22176-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="22176-106">Required.</span></span> <span data-ttu-id="22176-107">Ruft ab, oder legt ihn fest Listennamen von Datencontainer, der Migrationsplan verarbeitet werden muss.</span><span class="sxs-lookup"><span data-stu-id="22176-107">Gets or sets list name of data containers which needs to be processed for migration plan.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
