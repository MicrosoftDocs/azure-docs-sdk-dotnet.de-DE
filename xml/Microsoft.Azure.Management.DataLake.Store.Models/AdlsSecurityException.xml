<Type Name="AdlsSecurityException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsSecurityException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="561ab-101">Eine WebHDFS-Ausnahme ausgelöst, der angibt, dass der Zugriff verweigert wird.</span><span class="sxs-lookup"><span data-stu-id="561ab-101">A WebHDFS exception thrown indicating that access is denied.</span></span> <span data-ttu-id="561ab-102">Wird ausgelöst, wenn ein Antwortcode Fehler 401 (nicht autorisiert) zurückgegeben wird.</span><span class="sxs-lookup"><span data-stu-id="561ab-102">Thrown when a 401 error response code is returned (Unauthorized).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="561ab-103">Initialisiert eine neue Instanz der AdlsSecurityException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="561ab-103">Initializes a new instance of the AdlsSecurityException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="javaClassName"><span data-ttu-id="561ab-104">Das vollständige Paket Klassenname für die Ausnahme ausgelöst wird, z. B. "java.lang.IllegalArgumentException".</span><span class="sxs-lookup"><span data-stu-id="561ab-104">the full class package name for the exception thrown, such as 'java.lang.IllegalArgumentException'.</span></span></param>
        <param name="message"><span data-ttu-id="561ab-105">die die ausgelöste Ausnahme, z. B. zugeordnete Meldung ' Ungültiger Wert für Webhdfs-Parameter "Berechtigung":... ".</span><span class="sxs-lookup"><span data-stu-id="561ab-105">the message associated with the exception that was thrown, such as 'Invalid value for webhdfs parameter "permission":...'.</span></span></param>
        <summary>
            <span data-ttu-id="561ab-106">Initialisiert eine neue Instanz der AdlsSecurityException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="561ab-106">Initializes a new instance of the AdlsSecurityException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
