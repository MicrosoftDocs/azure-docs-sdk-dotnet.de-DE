<Type Name="AdlsAccessControlException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsAccessControlException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a4bfb-101">Eine WebHDFS-Ausnahme ausgelöst, der angibt, dass der Zugriff aufgrund unzureichender Berechtigungen verweigert wird.</span><span class="sxs-lookup"><span data-stu-id="a4bfb-101">A WebHDFS exception thrown indicating that access is denied due to insufficient permissions.</span></span> <span data-ttu-id="a4bfb-102">Wird ausgelöst, wenn ein Antwortcode 403-Fehler (Unzulässige).</span><span class="sxs-lookup"><span data-stu-id="a4bfb-102">Thrown when a 403 error response code is returned (forbidden).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4bfb-103">Initialisiert eine neue Instanz der AdlsAccessControlException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a4bfb-103">Initializes a new instance of the AdlsAccessControlException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="javaClassName"><span data-ttu-id="a4bfb-104">Das vollständige Paket Klassenname für die Ausnahme ausgelöst wird, z. B. "java.lang.IllegalArgumentException".</span><span class="sxs-lookup"><span data-stu-id="a4bfb-104">the full class package name for the exception thrown, such as 'java.lang.IllegalArgumentException'.</span></span></param>
        <param name="message"><span data-ttu-id="a4bfb-105">die die ausgelöste Ausnahme, z. B. zugeordnete Meldung ' Ungültiger Wert für Webhdfs-Parameter "Berechtigung":... ".</span><span class="sxs-lookup"><span data-stu-id="a4bfb-105">the message associated with the exception that was thrown, such as 'Invalid value for webhdfs parameter "permission":...'.</span></span></param>
        <summary>
            <span data-ttu-id="a4bfb-106">Initialisiert eine neue Instanz der AdlsAccessControlException-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a4bfb-106">Initializes a new instance of the AdlsAccessControlException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
