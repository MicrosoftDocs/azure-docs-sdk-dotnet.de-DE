<Type Name="IWithDataSnapshotFromImage" FullName="Microsoft.Azure.Management.Compute.Fluent.Snapshot.Definition.IWithDataSnapshotFromImage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="84ffe-101">Die Stufe der verwalteten Datenträger Definition ermöglicht Quelle Daten Datenträger-Image auswählen.</span><span class="sxs-lookup"><span data-stu-id="84ffe-101">The stage of the managed disk definition allowing to choose source data disk image.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="FromImage">
      ...
      <Docs>
        <param name="image"><span data-ttu-id="84ffe-102">Das Bild.</span><span class="sxs-lookup"><span data-stu-id="84ffe-102">The image.</span></span></param>
        <param name="diskLun"><span data-ttu-id="84ffe-103">Die LUN des Datenträgerimages.</span><span class="sxs-lookup"><span data-stu-id="84ffe-103">LUN of the disk image.</span></span></param>
        <summary>
            <span data-ttu-id="84ffe-104">Gibt ein benutzerdefiniertes Bild, ein datenträgerimage enthält.</span><span class="sxs-lookup"><span data-stu-id="84ffe-104">Specifies a custom image containing a source data disk image.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="84ffe-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="84ffe-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="FromImage">
      ...
      <Docs>
        <param name="image"><span data-ttu-id="84ffe-106">Ein Bild.</span><span class="sxs-lookup"><span data-stu-id="84ffe-106">An image.</span></span></param>
        <param name="diskLun"><span data-ttu-id="84ffe-107">Die LUN des Datenträgerimages.</span><span class="sxs-lookup"><span data-stu-id="84ffe-107">LUN of the disk image.</span></span></param>
        <summary>
            <span data-ttu-id="84ffe-108">Gibt ein Bild, ein datenträgerimage enthält.</span><span class="sxs-lookup"><span data-stu-id="84ffe-108">Specifies an image containing a source data disk image.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="84ffe-109">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="84ffe-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="FromImage">
      ...
      <Docs>
        <param name="imageId"><span data-ttu-id="84ffe-110">Ein Image-Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="84ffe-110">An image resource ID.</span></span></param>
        <param name="diskLun"><span data-ttu-id="84ffe-111">Die LUN des Datenträgerimages.</span><span class="sxs-lookup"><span data-stu-id="84ffe-111">LUN of the disk image.</span></span></param>
        <summary>
            <span data-ttu-id="84ffe-112">Gibt ein Bild, Quelle Daten Datenträger-Image enthält.</span><span class="sxs-lookup"><span data-stu-id="84ffe-112">Specifies an image containing source data disk image.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="84ffe-113">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="84ffe-113">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>