<Type Name="IWithMessageMovedToDeadLetterQueueOnMaxDeliveryCount" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Queue.Update.IWithMessageMovedToDeadLetterQueueOnMaxDeliveryCount">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1c1e0-101">Die Stufe der die Warteschlangendefinition an maximale Übermittlungsanzahl Nachricht vor dem Verschieben an Dead Letter-Warteschlange zulassen.</span><span class="sxs-lookup"><span data-stu-id="1c1e0-101">The stage of the queue definition allowing to specify maximum delivery count of message before moving it to dead-letter queue.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithMessageMovedToDeadLetterQueueOnMaxDeliveryCount">
      ...
      <Docs>
        <param name="deliveryCount"><span data-ttu-id="1c1e0-102">Maximale Übermittlungsanzahl.</span><span class="sxs-lookup"><span data-stu-id="1c1e0-102">Maximum delivery count.</span></span></param>
        <summary>
            <span data-ttu-id="1c1e0-103">Gibt die maximale Anzahl der Häufigkeit, mit die eine Nachricht übermittelt werden kann.</span><span class="sxs-lookup"><span data-stu-id="1c1e0-103">Specifies maximum number of times a message can be delivered.</span></span> <span data-ttu-id="1c1e0-104">Sobald diese Anzahl überschritten wurde, werden Nachrichten an die Dead Letter-Warteschlange verschoben.</span><span class="sxs-lookup"><span data-stu-id="1c1e0-104">Once this count has exceeded, message will be moved to dead-letter queue.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c1e0-105">Die nächste Phase der Warteschlange aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="1c1e0-105">The next stage of queue update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>