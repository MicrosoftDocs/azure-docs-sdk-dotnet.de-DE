<Type Name="IWithSession" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Queue.Update.IWithSession">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="997af-101">Die Stufe der die Warteschlangendefinition zulassen, um Unterstützung für Sitzungen zu aktivieren.</span><span class="sxs-lookup"><span data-stu-id="997af-101">The stage of the queue definition allowing to enable session support.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithoutSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="997af-102">Gibt an, dass die sitzungsunterstützung für die Warteschlange deaktiviert werden soll.</span><span class="sxs-lookup"><span data-stu-id="997af-102">Specifies that session support should be disabled for the queue.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="997af-103">Die nächste Phase der Warteschlange aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="997af-103">The next stage of queue update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="997af-104">Gibt an, dass die sitzungsunterstützung für die Warteschlange aktiviert werden soll.</span><span class="sxs-lookup"><span data-stu-id="997af-104">Specifies that session support should be enabled for the queue.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="997af-105">Die nächste Phase der Warteschlange aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="997af-105">The next stage of queue update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>