<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.Subnet.Definition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c95f1-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="c95f1-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="c95f1-102">Die letzte Phase der subnetzdefinition.</span><span class="sxs-lookup"><span data-stu-id="c95f1-102">The final stage of the subnet definition.</span></span>
            <span data-ttu-id="c95f1-103">Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die subnetzdefinition kann an der Definition des übergeordneten virtuellen Netzwerks mit WithAttach.attach() angefügt werden.</span><span class="sxs-lookup"><span data-stu-id="c95f1-103">At this stage, any remaining optional settings can be specified, or the subnet definition can be attached to the parent virtual network definition using  WithAttach.attach().</span></span>
            </summary>
