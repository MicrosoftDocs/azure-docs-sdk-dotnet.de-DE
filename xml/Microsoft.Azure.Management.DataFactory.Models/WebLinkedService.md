<Type Name="WebLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.WebLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="75614-101">Verknüpft-Webdienst.</span><span class="sxs-lookup"><span data-stu-id="75614-101">Web linked service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="75614-102">Initialisiert eine neue Instanz der WebLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="75614-102">Initializes a new instance of the WebLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="typeProperties"><span data-ttu-id="75614-103">Die Web-Eigenschaften des verknüpften Diensts.</span><span class="sxs-lookup"><span data-stu-id="75614-103">Web linked service properties.</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="75614-104">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="75614-104">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="connectVia"><span data-ttu-id="75614-105">Der Integration Common Language Runtime-Verweis.</span><span class="sxs-lookup"><span data-stu-id="75614-105">The integration runtime reference.</span></span></param>
        <param name="description"><span data-ttu-id="75614-106">Beschreibung des verknüpften Diensts.</span><span class="sxs-lookup"><span data-stu-id="75614-106">Linked service description.</span></span></param>
        <summary>
            <span data-ttu-id="75614-107">Initialisiert eine neue Instanz der WebLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="75614-107">Initializes a new instance of the WebLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TypeProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="75614-108">Abrufen oder Festlegen der Webdiensteigenschaften verknüpft.</span><span class="sxs-lookup"><span data-stu-id="75614-108">Gets or sets web linked service properties.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="75614-109">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="75614-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="75614-110">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="75614-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
