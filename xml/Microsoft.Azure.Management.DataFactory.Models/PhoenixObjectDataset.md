<Type Name="PhoenixObjectDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.PhoenixObjectDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bd307-101">Phoenix Server Dataset.</span><span class="sxs-lookup"><span data-stu-id="bd307-101">Phoenix server dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd307-102">Initialisiert eine neue Instanz der PhoenixObjectDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bd307-102">Initializes a new instance of the PhoenixObjectDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName"><span data-ttu-id="bd307-103">Verknüpften Dienst verweisen.</span><span class="sxs-lookup"><span data-stu-id="bd307-103">Linked service reference.</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="bd307-104">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="bd307-104">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="description"><span data-ttu-id="bd307-105">Beschreibung des Datasets.</span><span class="sxs-lookup"><span data-stu-id="bd307-105">Dataset description.</span></span></param>
        <param name="structure"><span data-ttu-id="bd307-106">Spalten, die die Struktur des Datasets zu definieren.</span><span class="sxs-lookup"><span data-stu-id="bd307-106">Columns that define the structure of the dataset.</span></span> <span data-ttu-id="bd307-107">Typ: Array (oder Ausdruck mit ResultType-Array), ItemType: DatasetDataElement.</span><span class="sxs-lookup"><span data-stu-id="bd307-107">Type: array (or Expression with resultType array), itemType: DatasetDataElement.</span></span></param>
        <param name="parameters"><span data-ttu-id="bd307-108">Parameter für das Dataset.</span><span class="sxs-lookup"><span data-stu-id="bd307-108">Parameters for dataset.</span></span></param>
        <summary>
            <span data-ttu-id="bd307-109">Initialisiert eine neue Instanz der PhoenixObjectDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bd307-109">Initializes a new instance of the PhoenixObjectDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd307-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="bd307-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="bd307-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="bd307-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
