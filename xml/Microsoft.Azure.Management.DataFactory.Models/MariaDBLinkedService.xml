<Type Name="MariaDBLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.MariaDBLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ba474-101">MariaDB-Server verknüpften Dienst an.</span><span class="sxs-lookup"><span data-stu-id="ba474-101">MariaDB server linked service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba474-102">Initialisiert eine neue Instanz der MariaDBLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ba474-102">Initializes a new instance of the MariaDBLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="ba474-103">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="ba474-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="connectVia"><span data-ttu-id="ba474-104">Der Integration Common Language Runtime-Verweis.</span><span class="sxs-lookup"><span data-stu-id="ba474-104">The integration runtime reference.</span></span></param>
        <param name="description"><span data-ttu-id="ba474-105">Beschreibung des verknüpften Diensts.</span><span class="sxs-lookup"><span data-stu-id="ba474-105">Linked service description.</span></span></param>
        <param name="connectionString"><span data-ttu-id="ba474-106">Eine ODBC-Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="ba474-106">An ODBC connection string.</span></span></param>
        <param name="encryptedCredential"><span data-ttu-id="ba474-107">Die verschlüsselten Anmeldeinformationen für die Authentifizierung verwendet.</span><span class="sxs-lookup"><span data-stu-id="ba474-107">The encrypted credential used for authentication.</span></span> <span data-ttu-id="ba474-108">Anmeldeinformationen werden verschlüsselt, mit dem Integration Runtime Anmeldeinformations-Manager.</span><span class="sxs-lookup"><span data-stu-id="ba474-108">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="ba474-109">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="ba474-109">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="ba474-110">Initialisiert eine neue Instanz der MariaDBLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="ba474-110">Initializes a new instance of the MariaDBLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba474-111">Ruft ab oder legt eine ODBC-Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="ba474-111">Gets or sets an ODBC connection string.</span></span>
            </summary>
    ...
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba474-112">Ruft ab oder legt die verschlüsselte Anmeldeinformationen für die Authentifizierung verwendet.</span><span class="sxs-lookup"><span data-stu-id="ba474-112">Gets or sets the encrypted credential used for authentication.</span></span>
            <span data-ttu-id="ba474-113">Anmeldeinformationen werden verschlüsselt, mit dem Integration Runtime Anmeldeinformations-Manager.</span><span class="sxs-lookup"><span data-stu-id="ba474-113">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="ba474-114">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="ba474-114">Type: string (or Expression with resultType string).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba474-115">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="ba474-115">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="ba474-116">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="ba474-116">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
