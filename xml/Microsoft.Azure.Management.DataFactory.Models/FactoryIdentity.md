<Type Name="FactoryIdentity" FullName="Microsoft.Azure.Management.DataFactory.Models.FactoryIdentity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9abd9-101">Identitätseigenschaften von der Factory-Ressource.</span><span class="sxs-lookup"><span data-stu-id="9abd9-101">Identity properties of the factory resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9abd9-102">Initialisiert eine neue Instanz der FactoryIdentity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9abd9-102">Initializes a new instance of the FactoryIdentity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId"><span data-ttu-id="9abd9-103">Der Prinzipal-Id der Identität.</span><span class="sxs-lookup"><span data-stu-id="9abd9-103">The principal id of the identity.</span></span></param>
        <param name="tenantId"><span data-ttu-id="9abd9-104">Die Client-Mandanten-Id der Identität.</span><span class="sxs-lookup"><span data-stu-id="9abd9-104">The client tenant id of the identity.</span></span></param>
        <summary>
            <span data-ttu-id="9abd9-105">Initialisiert eine neue Instanz der FactoryIdentity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9abd9-105">Initializes a new instance of the FactoryIdentity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrincipalId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9abd9-106">Ruft die Prinzipal-Id der Identität ab.</span><span class="sxs-lookup"><span data-stu-id="9abd9-106">Gets the principal id of the identity.</span></span>
            </summary>
    ...
    <Member MemberName="TenantId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9abd9-107">Ruft die Client-Mandanten-Id der Identität ab.</span><span class="sxs-lookup"><span data-stu-id="9abd9-107">Gets the client tenant id of the identity.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9abd9-108">Der Typ der Identität.</span><span class="sxs-lookup"><span data-stu-id="9abd9-108">The identity type.</span></span> <span data-ttu-id="9abd9-109">Derzeit ist der einzige unterstützte Typ "SystemAssigned".</span><span class="sxs-lookup"><span data-stu-id="9abd9-109">Currently the only supported type is 'SystemAssigned'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
