<Type Name="CouchbaseTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.CouchbaseTableDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e95e6-101">Couchbase Server Dataset.</span><span class="sxs-lookup"><span data-stu-id="e95e6-101">Couchbase server dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e95e6-102">Initialisiert eine neue Instanz der CouchbaseTableDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e95e6-102">Initializes a new instance of the CouchbaseTableDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName"><span data-ttu-id="e95e6-103">Verknüpften Dienst verweisen.</span><span class="sxs-lookup"><span data-stu-id="e95e6-103">Linked service reference.</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="e95e6-104">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="e95e6-104">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="description"><span data-ttu-id="e95e6-105">Beschreibung des Datasets.</span><span class="sxs-lookup"><span data-stu-id="e95e6-105">Dataset description.</span></span></param>
        <param name="structure"><span data-ttu-id="e95e6-106">Spalten, die die Struktur des Datasets zu definieren.</span><span class="sxs-lookup"><span data-stu-id="e95e6-106">Columns that define the structure of the dataset.</span></span> <span data-ttu-id="e95e6-107">Typ: Array (oder Ausdruck mit ResultType-Array), ItemType: DatasetDataElement.</span><span class="sxs-lookup"><span data-stu-id="e95e6-107">Type: array (or Expression with resultType array), itemType: DatasetDataElement.</span></span></param>
        <param name="parameters"><span data-ttu-id="e95e6-108">Parameter für das Dataset.</span><span class="sxs-lookup"><span data-stu-id="e95e6-108">Parameters for dataset.</span></span></param>
        <summary>
            <span data-ttu-id="e95e6-109">Initialisiert eine neue Instanz der CouchbaseTableDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e95e6-109">Initializes a new instance of the CouchbaseTableDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e95e6-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="e95e6-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="e95e6-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="e95e6-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
