<Type Name="JiraSource" FullName="Microsoft.Azure.Management.DataFactory.Models.JiraSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="404ae-101">Eine kopieren-Aktivität Jira Serivce Quelle.</span><span class="sxs-lookup"><span data-stu-id="404ae-101">A copy activity Jira Serivce source.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="404ae-102">Initialisiert eine neue Instanz der JiraSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="404ae-102">Initializes a new instance of the JiraSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="404ae-103">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="404ae-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="sourceRetryCount"><span data-ttu-id="404ae-104">Anzahl von Wiederholungsversuchen Quelle.</span><span class="sxs-lookup"><span data-stu-id="404ae-104">Source retry count.</span></span> <span data-ttu-id="404ae-105">Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).</span><span class="sxs-lookup"><span data-stu-id="404ae-105">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sourceRetryWait"><span data-ttu-id="404ae-106">Warten Sie Quelle, versuchen Sie es erneut.</span><span class="sxs-lookup"><span data-stu-id="404ae-106">Source retry wait.</span></span> <span data-ttu-id="404ae-107">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).</span><span class="sxs-lookup"><span data-stu-id="404ae-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="query"><span data-ttu-id="404ae-108">Eine Abfrage zum Abrufen von Daten aus der Quelle.</span><span class="sxs-lookup"><span data-stu-id="404ae-108">A query to retrieve data from source.</span></span> <span data-ttu-id="404ae-109">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="404ae-109">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="404ae-110">Initialisiert eine neue Instanz der JiraSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="404ae-110">Initializes a new instance of the JiraSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="404ae-111">Ruft ab oder legt eine Abfrage zum Abrufen von Daten aus der Quelle.</span><span class="sxs-lookup"><span data-stu-id="404ae-111">Gets or sets a query to retrieve data from source.</span></span> <span data-ttu-id="404ae-112">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="404ae-112">Type: string (or Expression with resultType string).</span></span>
            </summary>
