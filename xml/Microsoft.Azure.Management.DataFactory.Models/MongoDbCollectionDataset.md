<Type Name="MongoDbCollectionDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.MongoDbCollectionDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6741d-101">Das Dataset des MongoDB-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="6741d-101">The MongoDB database dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6741d-102">Initialisiert eine neue Instanz der MongoDbCollectionDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6741d-102">Initializes a new instance of the MongoDbCollectionDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName"><span data-ttu-id="6741d-103">Verknüpften Dienst verweisen.</span><span class="sxs-lookup"><span data-stu-id="6741d-103">Linked service reference.</span></span></param>
        <param name="collectionName"><span data-ttu-id="6741d-104">Der Tabellenname der MongoDB-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="6741d-104">The table name of the MongoDB database.</span></span> <span data-ttu-id="6741d-105">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="6741d-105">Type: string (or Expression with resultType string).</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="6741d-106">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="6741d-106">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="description"><span data-ttu-id="6741d-107">Beschreibung des Datasets.</span><span class="sxs-lookup"><span data-stu-id="6741d-107">Dataset description.</span></span></param>
        <param name="structure"><span data-ttu-id="6741d-108">Spalten, die die Struktur des Datasets zu definieren.</span><span class="sxs-lookup"><span data-stu-id="6741d-108">Columns that define the structure of the dataset.</span></span> <span data-ttu-id="6741d-109">Typ: Array (oder Ausdruck mit ResultType-Array), ItemType: DatasetDataElement.</span><span class="sxs-lookup"><span data-stu-id="6741d-109">Type: array (or Expression with resultType array), itemType: DatasetDataElement.</span></span></param>
        <param name="parameters"><span data-ttu-id="6741d-110">Parameter für das Dataset.</span><span class="sxs-lookup"><span data-stu-id="6741d-110">Parameters for dataset.</span></span></param>
        <summary>
            <span data-ttu-id="6741d-111">Initialisiert eine neue Instanz der MongoDbCollectionDataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6741d-111">Initializes a new instance of the MongoDbCollectionDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CollectionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6741d-112">Ruft ab oder legt den Tabellennamen der MongoDB-Datenbank fest.</span><span class="sxs-lookup"><span data-stu-id="6741d-112">Gets or sets the table name of the MongoDB database.</span></span> <span data-ttu-id="6741d-113">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="6741d-113">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6741d-114">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="6741d-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="6741d-115">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="6741d-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
