<Type Name="OperationListResponse" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c3e07-101">Eine Liste der Vorgänge, die vom Data Factory-Dienst ausgeführt werden können.</span><span class="sxs-lookup"><span data-stu-id="c3e07-101">A list of operations that can be performed by the Data Factory service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3e07-102">Initialisiert eine neue Instanz der OperationListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c3e07-102">Initializes a new instance of the OperationListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="c3e07-103">Liste der Data Factory-Vorgänge, die vom Data Factory-Ressourcenanbieter unterstützt.</span><span class="sxs-lookup"><span data-stu-id="c3e07-103">List of Data Factory operations supported by the Data Factory resource provider.</span></span></param>
        <param name="nextLink"><span data-ttu-id="c3e07-104">Der Link zur nächsten Seite der Ergebnisse, wenn keine weiteren Ergebnisse vorhanden sind.</span><span class="sxs-lookup"><span data-stu-id="c3e07-104">The link to the next page of results, if any remaining results exist.</span></span></param>
        <summary>
            <span data-ttu-id="c3e07-105">Initialisiert eine neue Instanz der OperationListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c3e07-105">Initializes a new instance of the OperationListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3e07-106">Ruft ab oder legt den Link zur nächsten Seite der Ergebnisse, wenn keine weiteren Ergebnisse vorhanden sind.</span><span class="sxs-lookup"><span data-stu-id="c3e07-106">Gets or sets the link to the next page of results, if any remaining results exist.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3e07-107">Ruft ab oder legt die Liste der Data Factory-Vorgänge, die vom Data Factory-Ressourcenanbieter unterstützt.</span><span class="sxs-lookup"><span data-stu-id="c3e07-107">Gets or sets list of Data Factory operations supported by the Data Factory resource provider.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
