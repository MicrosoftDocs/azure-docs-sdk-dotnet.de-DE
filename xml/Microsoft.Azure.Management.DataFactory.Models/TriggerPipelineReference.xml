<Type Name="TriggerPipelineReference" FullName="Microsoft.Azure.Management.DataFactory.Models.TriggerPipelineReference">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dd59e-101">Pipeline, die mit den angegebenen Parametern ausgelöst werden muss.</span><span class="sxs-lookup"><span data-stu-id="dd59e-101">Pipeline that needs to be triggered with the given parameters.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd59e-102">Initialisiert eine neue Instanz der TriggerPipelineReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="dd59e-102">Initializes a new instance of the TriggerPipelineReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="pipelineReference"><span data-ttu-id="dd59e-103">Pipelineverweis.</span><span class="sxs-lookup"><span data-stu-id="dd59e-103">Pipeline reference.</span></span></param>
        <param name="parameters"><span data-ttu-id="dd59e-104">Pipeline-Parameter.</span><span class="sxs-lookup"><span data-stu-id="dd59e-104">Pipeline parameters.</span></span></param>
        <summary>
            <span data-ttu-id="dd59e-105">Initialisiert eine neue Instanz der TriggerPipelineReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="dd59e-105">Initializes a new instance of the TriggerPipelineReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd59e-106">Ruft ab, oder legt ihn fest Pipeline-Parameter.</span><span class="sxs-lookup"><span data-stu-id="dd59e-106">Gets or sets pipeline parameters.</span></span>
            </summary>
    ...
    <Member MemberName="PipelineReference">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd59e-107">Ruft ab, oder legt ihn fest Pipelineverweis.</span><span class="sxs-lookup"><span data-stu-id="dd59e-107">Gets or sets pipeline reference.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd59e-108">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="dd59e-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="dd59e-109">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="dd59e-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
