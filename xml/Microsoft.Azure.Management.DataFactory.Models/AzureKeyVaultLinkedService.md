<Type Name="AzureKeyVaultLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureKeyVaultLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="47020-101">Azure Key Vault verknüpfter Dienst.</span><span class="sxs-lookup"><span data-stu-id="47020-101">Azure Key Vault linked service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="47020-102">Initialisiert eine neue Instanz der AzureKeyVaultLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="47020-102">Initializes a new instance of the AzureKeyVaultLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUrl"><span data-ttu-id="47020-103">Basis-URL des Azure Key Vault.</span><span class="sxs-lookup"><span data-stu-id="47020-103">The base URL of the Azure Key Vault.</span></span> <span data-ttu-id="47020-104">z. B. https://myakv.vault.azure.net Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="47020-104">e.g. https://myakv.vault.azure.net Type: string (or Expression with resultType string).</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="47020-105">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="47020-105">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="connectVia"><span data-ttu-id="47020-106">Der Integration Common Language Runtime-Verweis.</span><span class="sxs-lookup"><span data-stu-id="47020-106">The integration runtime reference.</span></span></param>
        <param name="description"><span data-ttu-id="47020-107">Beschreibung des verknüpften Diensts.</span><span class="sxs-lookup"><span data-stu-id="47020-107">Linked service description.</span></span></param>
        <summary>
            <span data-ttu-id="47020-108">Initialisiert eine neue Instanz der AzureKeyVaultLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="47020-108">Initializes a new instance of the AzureKeyVaultLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BaseUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="47020-109">Ruft ab oder legt die base-URL des Azure Key Vault.</span><span class="sxs-lookup"><span data-stu-id="47020-109">Gets or sets the base URL of the Azure Key Vault.</span></span> <span data-ttu-id="47020-110">z. B. https://myakv.vault.azure.net Typ: Zeichenfolge (oder einen Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="47020-110">e.g. https://myakv.vault.azure.net Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="47020-111">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="47020-111">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="47020-112">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="47020-112">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
