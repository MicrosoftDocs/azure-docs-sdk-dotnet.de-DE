<Type Name="QuickBooksSource" FullName="Microsoft.Azure.Management.DataFactory.Models.QuickBooksSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c3a7f-101">Eine Aktivität QuickBooks Server Kopiequelle.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-101">A copy activity QuickBooks server source.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3a7f-102">Initialisiert eine neue Instanz der QuickBooksSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-102">Initializes a new instance of the QuickBooksSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="c3a7f-103">Nicht übereinstimmende Eigenschaften aus der Nachricht deserialisiert werden diese Sammlung</span><span class="sxs-lookup"><span data-stu-id="c3a7f-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="sourceRetryCount"><span data-ttu-id="c3a7f-104">Anzahl von Wiederholungsversuchen Quelle.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-104">Source retry count.</span></span> <span data-ttu-id="c3a7f-105">Typ: ganze Zahl (oder Ausdrücke mit ganzzahligen ResultType-Element).</span><span class="sxs-lookup"><span data-stu-id="c3a7f-105">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sourceRetryWait"><span data-ttu-id="c3a7f-106">Warten Sie Quelle, versuchen Sie es erneut.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-106">Source retry wait.</span></span> <span data-ttu-id="c3a7f-107">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge), Muster: ((\d+)\.)? () :(60| \d\d) ([0-5][0-9])): () 60 | ([0-5][0-9])).</span><span class="sxs-lookup"><span data-stu-id="c3a7f-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="query"><span data-ttu-id="c3a7f-108">Eine Abfrage zum Abrufen von Daten aus der Quelle.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-108">A query to retrieve data from source.</span></span> <span data-ttu-id="c3a7f-109">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="c3a7f-109">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="c3a7f-110">Initialisiert eine neue Instanz der QuickBooksSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-110">Initializes a new instance of the QuickBooksSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3a7f-111">Ruft ab oder legt eine Abfrage zum Abrufen von Daten aus der Quelle.</span><span class="sxs-lookup"><span data-stu-id="c3a7f-111">Gets or sets a query to retrieve data from source.</span></span> <span data-ttu-id="c3a7f-112">Typ: Zeichenfolge (oder Ausdruck mit ResultType-Zeichenfolge).</span><span class="sxs-lookup"><span data-stu-id="c3a7f-112">Type: string (or Expression with resultType string).</span></span>
            </summary>
