<Type Name="DataSourceResponse" FullName="Microsoft.Azure.Management.BackupServices.Models.DataSourceResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="abbd0-101">Die Definition der Antwort auf eine Liste Management.</span><span class="sxs-lookup"><span data-stu-id="abbd0-101">The definition of a Management List Response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-102">Initialisiert eine neue Instanz der DataSourceResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="abbd0-102">Initializes a new instance of the DataSourceResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-103">Ruft die Sequenz von Objekten ab.</span><span class="sxs-lookup"><span data-stu-id="abbd0-103">Gets the sequence of Objects.</span></span>
            </summary>
    ...
    <Member MemberName="Objects">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-104">Optional.</span><span class="sxs-lookup"><span data-stu-id="abbd0-104">Optional.</span></span> <span data-ttu-id="abbd0-105">Die ID des Quell-Server.</span><span class="sxs-lookup"><span data-stu-id="abbd0-105">The ID of the source Server.</span></span>
            </summary>
    ...
    <Member MemberName="ResultCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-106">Optional.</span><span class="sxs-lookup"><span data-stu-id="abbd0-106">Optional.</span></span> <span data-ttu-id="abbd0-107">Die ID des Quell-Server.</span><span class="sxs-lookup"><span data-stu-id="abbd0-107">The ID of the source Server.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Skiptoken">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-108">Optional.</span><span class="sxs-lookup"><span data-stu-id="abbd0-108">Optional.</span></span> <span data-ttu-id="abbd0-109">Die ID des Quell-Server.</span><span class="sxs-lookup"><span data-stu-id="abbd0-109">The ID of the source Server.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abbd0-110">Ruft die Sequenz von Objekten ab.</span><span class="sxs-lookup"><span data-stu-id="abbd0-110">Gets the sequence of Objects.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
