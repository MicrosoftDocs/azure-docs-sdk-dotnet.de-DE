<Type Name="GetResourceStorageConfigResponse" FullName="Microsoft.Azure.Management.BackupServices.Models.GetResourceStorageConfigResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9554f-101">Die Definition einer Get-Speicher-Config Ressourcenantwort.</span><span class="sxs-lookup"><span data-stu-id="9554f-101">The definition of a get resource storage config response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9554f-102">Initialisiert eine neue Instanz der GetResourceStorageConfigResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9554f-102">Initializes a new instance of the GetResourceStorageConfigResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9554f-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="9554f-103">Optional.</span></span> <span data-ttu-id="9554f-104">Ruft ab oder legt die Ressourcen-ID.</span><span class="sxs-lookup"><span data-stu-id="9554f-104">Gets or sets the resource ID.</span></span>
            </summary>
    ...
    <Member MemberName="StorageDetails">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9554f-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="9554f-105">Optional.</span></span> <span data-ttu-id="9554f-106">Die Details des Ressource-Speicher.</span><span class="sxs-lookup"><span data-stu-id="9554f-106">The resource storage details.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
