<Type Name="MobileAppSettingsKeys" FullName="Microsoft.Azure.Mobile.Server.Config.MobileAppSettingsKeys">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b9e2a-101">Definiert die Schlüssel, die wir in Suchen <see cref="T:Microsoft.Azure.Mobile.Server.MobileAppSettingsDictionary" /> bekannte Einstellungen zu identifizieren.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-101">Defines the keys we look for in <see cref="T:Microsoft.Azure.Mobile.Server.MobileAppSettingsDictionary" /> to identify known settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-102">Der Schlüssel, identifizieren die anwendungseinstellung, die den Hostnamen des mobilen Diensts enthält.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-102">The key identifying the application setting containing the host name of the mobile service.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NotificationHubConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-103">Der Schlüssel zum Identifizieren der Einstellung für die Verbindungszeichenfolge, die die Verbindungszeichenfolge für die Azure-Benachrichtigungs-Hub enthält, die diesem Dienst zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-103">The key identifying the connection string setting containing the connection string for the Azure Notification Hub associated with this service.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NotificationHubName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-104">Der Schlüssel, der die anwendungseinstellung, die mit dem Namen des Azure Notification Hubs identifiziert, die diesem Dienst zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-104">The key identifying the application setting containing the name of the Azure Notification Hub associated with this service.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SkipVersionCheck">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-105">Schlüssel identifiziert, ob das System Version durchsetzt-Überprüfungen für alle eingehenden Mobile App-API-Aufrufe</span><span class="sxs-lookup"><span data-stu-id="b9e2a-105">The key identifying whether the system will enforce version checks on all incoming Mobile App API calls</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-106">Der Schlüssel, der die anwendungseinstellung, enthält die Abonnement-Id für den Dienst zu identifizieren.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-106">The key identifying the application setting containing the subscription id for the service.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9e2a-107">Der Schlüssel, identifizieren die Einstellung für die Verbindungszeichenfolge, die die Standardverbindungszeichenfolge für Controller, die Tabelle enthält.</span><span class="sxs-lookup"><span data-stu-id="b9e2a-107">The key identifying the connection string setting containing the default connection string for table controllers.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
