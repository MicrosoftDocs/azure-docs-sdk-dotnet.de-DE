<Type Name="ITxtRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.ITxtRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1bf51-101">Eine unveränderliche clientseitige Darstellung eines Datensatzes TXT (Text), die in Azure DNS-Zone festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="1bf51-101">An immutable client-side representation of a TXT (text) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Records">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bf51-102">Ruft die TXT-Einträge in diesen Datensatz ab.</span><span class="sxs-lookup"><span data-stu-id="1bf51-102">Gets the TXT records in this record set.</span></span>
            </summary>
