<Type Name="IMXRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.IMXRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="860a2-101">Eine unveränderliche clientseitige Darstellung einen MX (Mail Exchange), die in einer Azure-DNS-Zone festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="860a2-101">An immutable client-side representation of an MX (mail exchange) record set in an Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Records">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="860a2-102">Ruft den MX-Einträge in diesen Datensatz ab.</span><span class="sxs-lookup"><span data-stu-id="860a2-102">Gets the MX records in this record set.</span></span>
            </summary>
