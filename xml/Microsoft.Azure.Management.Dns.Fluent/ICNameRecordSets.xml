<Type Name="ICNameRecordSets" FullName="Microsoft.Azure.Management.Dns.Fluent.ICNameRecordSets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="093c1-101">Einstiegspunkt für CNAME-Eintrag legt fest, in einer DNS-Zone.</span><span class="sxs-lookup"><span data-stu-id="093c1-101">Entry point to CNAME record sets in a DNS zone.</span></span>
            </summary>
