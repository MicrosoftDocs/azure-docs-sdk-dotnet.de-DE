<Type Name="IARecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.IARecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="39422-101">Eine unveränderliche clientseitige Darstellung von A (IPv4)-Recordset in Azure DNS-Zone.</span><span class="sxs-lookup"><span data-stu-id="39422-101">An immutable client-side representation of a A (IPv4) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="IPv4Addresses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="39422-102">Ruft die IP-v4-Adressen von A-Einträgen in diesen Datensatz ab.</span><span class="sxs-lookup"><span data-stu-id="39422-102">Gets the IP v4 addresses of A records in this record set.</span></span>
            </summary>
