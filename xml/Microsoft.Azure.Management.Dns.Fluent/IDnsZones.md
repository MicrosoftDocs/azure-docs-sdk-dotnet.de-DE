<Type Name="IDnsZones" FullName="Microsoft.Azure.Management.Dns.Fluent.IDnsZones">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ac793-101">Der Einstiegspunkt für DNS-Zone-API in Azure.</span><span class="sxs-lookup"><span data-stu-id="ac793-101">Entry point to DNS zone management API in Azure.</span></span>
            </summary>
