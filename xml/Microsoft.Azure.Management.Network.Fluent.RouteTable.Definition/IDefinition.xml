<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ddfdd-101">Eine routingtabellendefinition vollständig.</span><span class="sxs-lookup"><span data-stu-id="ddfdd-101">The entirety of a route table definition.</span></span>
            </summary>
