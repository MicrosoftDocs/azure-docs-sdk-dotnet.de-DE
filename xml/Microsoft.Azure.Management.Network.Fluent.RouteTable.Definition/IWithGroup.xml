<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IWithGroup">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IWithGroup" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3e5a1-101">Die Stufe der eine routingtabellendefinition ermöglicht die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="3e5a1-101">The stage of a route table definition allowing to specify the resource group.</span></span>
            </summary>
