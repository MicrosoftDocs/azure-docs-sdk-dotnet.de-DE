<Type Name="StorageManager+IConfigurable" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageManager+IConfigurable">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c746e-101">Die-Schnittstelle, sodass Konfigurationen festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="c746e-101">The inteface allowing configurations to be set.</span></span>
            </summary>
