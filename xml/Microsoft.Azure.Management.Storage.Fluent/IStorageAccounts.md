<Type Name="IStorageAccounts" FullName="Microsoft.Azure.Management.Storage.Fluent.IStorageAccounts">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2fba8-101">Einstiegspunkt für Konten speicherverwaltungs-API.</span><span class="sxs-lookup"><span data-stu-id="2fba8-101">Entry point for storage accounts management API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CheckNameAvailability">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="2fba8-102">Der Kontoname, um zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="2fba8-102">The account name to check.</span></span></param>
        <summary>
            <span data-ttu-id="2fba8-103">Prüft, ob der Kontoname gültig ist und noch nicht verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="2fba8-103">Checks that account name is valid and is not in use.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2fba8-104">Gibt an, ob der Name verfügbar ist, und klicken Sie mit der anderer Informationen ist dies nicht.</span><span class="sxs-lookup"><span data-stu-id="2fba8-104">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="CheckNameAvailabilityAsync">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="2fba8-105">Der Kontoname, um zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="2fba8-105">The account name to check.</span></span></param>
        <param name="cancellationToken">To be added.</param>
        <summary>
            <span data-ttu-id="2fba8-106">Hier wird überprüft, ob entsprechenden Kontennamen ist gültig und wird nicht verwendet asynchron.</span><span class="sxs-lookup"><span data-stu-id="2fba8-106">Checks that account name is valid and is not in use asynchronously.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>
            <span data-ttu-id="2fba8-107">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="2fba8-107">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
        <return><span data-ttu-id="2fba8-108">Gibt an, ob der Name verfügbar ist, und klicken Sie mit der anderer Informationen ist dies nicht.</span><span class="sxs-lookup"><span data-stu-id="2fba8-108">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>