<Type Name="StorageManager" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageManager">
  ...
  <Members>
    <Member MemberName="Authenticate">
      ...
      <Docs>
        <param name="credentials"><span data-ttu-id="7421e-101">die zu verwendenden Anmeldeinformationen</span><span class="sxs-lookup"><span data-stu-id="7421e-101">the credentials to use</span></span></param>
        <param name="subscriptionId"><span data-ttu-id="7421e-102">die Abonnement-UUID</span><span class="sxs-lookup"><span data-stu-id="7421e-102">the subscription UUID</span></span></param>
        <summary>
            <span data-ttu-id="7421e-103">Erstellt eine Instanz des StorageManager, die Speicher Ressource Management-API-Einstiegspunkte verfügbar macht.</span><span class="sxs-lookup"><span data-stu-id="7421e-103">Creates an instance of StorageManager that exposes storage resource management API entry points.</span></span>
            </summary>
        <returns><span data-ttu-id="7421e-104">StorageManager</span><span class="sxs-lookup"><span data-stu-id="7421e-104">the StorageManager</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Authenticate">
      ...
      <Docs>
        <param name="restClient"><span data-ttu-id="7421e-105">die RestClient für API-Aufrufe verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="7421e-105">the RestClient to be used for API calls.</span></span></param>
        <param name="subscriptionId"><span data-ttu-id="7421e-106">die Abonnement-UUID</span><span class="sxs-lookup"><span data-stu-id="7421e-106">the subscription UUID</span></span></param>
        <summary>
            <span data-ttu-id="7421e-107">Erstellt eine Instanz des StorageManager, die Speicher Ressource Management-API-Einstiegspunkte verfügbar macht.</span><span class="sxs-lookup"><span data-stu-id="7421e-107">Creates an instance of StorageManager that exposes storage resource management API entry points.</span></span>
            </summary>
        <returns><span data-ttu-id="7421e-108">StorageManager</span><span class="sxs-lookup"><span data-stu-id="7421e-108">the StorageManager</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Configure">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7421e-109">Abrufen einer konfigurierbaren her, die zum Erstellen von StorageManager mit optionale Konfiguration verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="7421e-109">Get a Configurable instance that can be used to create StorageManager with optional configuration.</span></span>
            </summary>
        <returns><span data-ttu-id="7421e-110">die Instanz, sodass Konfigurationen</span><span class="sxs-lookup"><span data-stu-id="7421e-110">the instance allowing configurations</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
