<Type Name="IWithGroupAndRegion&lt;T&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.GroupableResource.Definition.IWithGroupAndRegion&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T"><span data-ttu-id="9c348-101">die nächste Phase der Ressourcendefinition</span><span class="sxs-lookup"><span data-stu-id="9c348-101">the next stage of the resource definition</span></span></typeparam>
    <summary>
            <span data-ttu-id="9c348-102">Eine ressourcengruppendefinition, sodass Ressourcengruppe ausgewählt werden.</span><span class="sxs-lookup"><span data-stu-id="9c348-102">A resource group definition allowing resource group to be selected.</span></span>
            <span data-ttu-id="9c348-103">Region muss angegebenen Memberdirektive zum Erstellen einer neuen Ressourcengruppe werden.</span><span class="sxs-lookup"><span data-stu-id="9c348-103">Region has to be specified explictly to create a new resource group.</span></span>
