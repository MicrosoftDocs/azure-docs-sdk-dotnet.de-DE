<Type Name="ISupportsGettingById&lt;T&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsGettingById&lt;T&gt;">
  ...
  <Members>
    <Member MemberName="GetById">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="6de81-101">ID die Id der Ressource.</span><span class="sxs-lookup"><span data-stu-id="6de81-101">id the id of the resource.</span></span></param>
        <summary>
            <span data-ttu-id="6de81-102">Ruft die Informationen zu einer Ressource von Azure auf Grundlage der Ressourcen-Id ab.</span><span class="sxs-lookup"><span data-stu-id="6de81-102">Gets the information about a resource from Azure based on the resource id.</span></span>
            </summary>
        <returns><span data-ttu-id="6de81-103">eine unveränderliche Darstellung der Ressource</span><span class="sxs-lookup"><span data-stu-id="6de81-103">an immutable representation of the resource</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetByIdAsync">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="6de81-104">ID die Id der Ressource.</span><span class="sxs-lookup"><span data-stu-id="6de81-104">id the id of the resource.</span></span></param>
        <param name="cancellationToken"><span data-ttu-id="6de81-105">das Abbruchtoken, das das cancellationToken</span><span class="sxs-lookup"><span data-stu-id="6de81-105">cancellationToken the cancellation token</span></span></param>
        <summary>
            <span data-ttu-id="6de81-106">Ruft die Informationen zu einer Ressource von Azure auf Grundlage der Ressourcen-Id ab.</span><span class="sxs-lookup"><span data-stu-id="6de81-106">Gets the information about a resource from Azure based on the resource id.</span></span>
            </summary>
        <returns><span data-ttu-id="6de81-107">eine unveränderliche Darstellung der Ressource</span><span class="sxs-lookup"><span data-stu-id="6de81-107">an immutable representation of the resource</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
