<Type Name="RedisCreateParametersInner" FullName="Microsoft.Azure.Management.Redis.Fluent.Models.RedisCreateParametersInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2ccf9-101">Parameter für das Erstellen des Redis-zur Verfügung gestellt.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-101">Parameters supplied to the Create Redis operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-102">Initialisiert eine neue Instanz der RedisCreateParametersInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-102">Initializes a new instance of the RedisCreateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sku"><span data-ttu-id="2ccf9-103">Die SKU des Redis-Caches bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-103">The SKU of the Redis cache to deploy.</span></span></param>
        <param name="location">To be added.</param>
        <param name="id">To be added.</param>
        <param name="name">To be added.</param>
        <param name="type">To be added.</param>
        <param name="tags">To be added.</param>
        <param name="redisConfiguration"><span data-ttu-id="2ccf9-104">Alle Redis-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-104">All Redis Settings.</span></span> <span data-ttu-id="2ccf9-105">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-105">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span></param>
        <param name="enableNonSslPort"><span data-ttu-id="2ccf9-106">Gibt an, ob die nicht-Ssl-Redis-Server (6379) port aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-106">Specifies whether the non-ssl Redis server port (6379) is enabled.</span></span></param>
        <param name="tenantSettings"><span data-ttu-id="2ccf9-107">tenantSettings</span><span class="sxs-lookup"><span data-stu-id="2ccf9-107">tenantSettings</span></span></param>
        <param name="shardCount"><span data-ttu-id="2ccf9-108">Die Anzahl der Shards auf eine Premium-Cache-Cluster erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-108">The number of shards to be created on a Premium Cluster Cache.</span></span></param>
        <param name="subnetId"><span data-ttu-id="2ccf9-109">Die vollständige Ressourcen-ID eines Subnetzes in einem virtuellen Netzwerk den Redis-Cache bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-109">The full resource ID of a subnet in a virtual network to deploy the Redis cache in.</span></span> <span data-ttu-id="2ccf9-110">Beispiel für das Format: / Subscriptions / {Subid} / ResourceGroups / {ResourceGroupName} / Microsoft. {Netzwerk | ClassicNetwork} / VirtualNetworks/vnet1/Subnetze/subnet1</span><span class="sxs-lookup"><span data-stu-id="2ccf9-110">Example format: /subscriptions/{subid}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1</span></span></param>
        <param name="staticIP"><span data-ttu-id="2ccf9-111">Statische IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-111">Static IP address.</span></span> <span data-ttu-id="2ccf9-112">Erforderlich, wenn einen Redis-Cache in einem vorhandenen virtuellen Azure-Netzwerk bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-112">Required when deploying a Redis cache inside an existing Azure Virtual Network.</span></span></param>
        <summary>
            <span data-ttu-id="2ccf9-113">Initialisiert eine neue Instanz der RedisCreateParametersInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-113">Initializes a new instance of the RedisCreateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EnableNonSslPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-114">Ruft ab oder legt ihn fest, gibt Sie an, ob die nicht-Ssl-Redis-Server (6379) port aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-114">Gets or sets specifies whether the non-ssl Redis server port (6379) is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="RedisConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-115">Ruft ab oder legt alle Redis-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-115">Gets or sets all Redis Settings.</span></span> <span data-ttu-id="2ccf9-116">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-116">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ShardCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-117">Ruft ab oder legt die Anzahl der Shards auf eine Premium-Cache-Cluster erstellt werden.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-117">Gets or sets the number of shards to be created on a Premium Cluster Cache.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-118">Ruft ab oder legt die SKU des Redis-Caches zum Bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-118">Gets or sets the SKU of the Redis cache to deploy.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StaticIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-119">Ruft ab oder legt die statische IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-119">Gets or sets static IP address.</span></span> <span data-ttu-id="2ccf9-120">Erforderlich, wenn einen Redis-Cache in einem vorhandenen virtuellen Azure-Netzwerk bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-120">Required when deploying a Redis cache inside an existing Azure Virtual Network.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubnetId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-121">Ruft ab, oder legt Sie die vollständige Ressourcen-ID eines Subnetzes in einem virtuellen Netzwerk zum Bereitstellen des Redis-Caches in fest.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-121">Gets or sets the full resource ID of a subnet in a virtual network to deploy the Redis cache in.</span></span> <span data-ttu-id="2ccf9-122">Beispiel für das Format: / Subscriptions / {Subid} / ResourceGroups / {ResourceGroupName} / Microsoft. {Netzwerk | ClassicNetwork} / VirtualNetworks/vnet1/Subnetze/subnet1</span><span class="sxs-lookup"><span data-stu-id="2ccf9-122">Example format: /subscriptions/{subid}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TenantSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-123">Ruft ab oder legt ihn fest tenantSettings</span><span class="sxs-lookup"><span data-stu-id="2ccf9-123">Gets or sets tenantSettings</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ccf9-124">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="2ccf9-124">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="2ccf9-125">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="2ccf9-125">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
