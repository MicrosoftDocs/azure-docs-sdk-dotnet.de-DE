<Type Name="ServiceRemotingDispatcher" FullName="Microsoft.ServiceFabric.Services.Remoting.V1.Runtime.ServiceRemotingDispatcher">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d8ab1-101">Stellt eine Implementierung von <see cref="T:Microsoft.ServiceFabric.Services.Remoting.V1.Runtime.IServiceRemotingMessageHandler" /> , die Nachrichten an den Dienst implementieren können dispatch- <see cref="T:Microsoft.ServiceFabric.Services.Remoting.IService" /> Schnittstelle.</span><span class="sxs-lookup"><span data-stu-id="d8ab1-101">Provides an implementation of <see cref="T:Microsoft.ServiceFabric.Services.Remoting.V1.Runtime.IServiceRemotingMessageHandler" /> that can dispatch messages to the service implementing <see cref="T:Microsoft.ServiceFabric.Services.Remoting.IService" /> interface.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceContext"><span data-ttu-id="d8ab1-102">Dienstkontext</span><span class="sxs-lookup"><span data-stu-id="d8ab1-102">Service context</span></span></param>
        <param name="service"><span data-ttu-id="d8ab1-103">Dienst-Implementierung, die Schnittstellen vom Typ implementiert.<see cref="T:Microsoft.ServiceFabric.Services.Remoting.IService" /></span><span class="sxs-lookup"><span data-stu-id="d8ab1-103">Service implementation that implements interfaces of type <see cref="T:Microsoft.ServiceFabric.Services.Remoting.IService" /></span></span></param>
        <summary>
            <span data-ttu-id="d8ab1-104">Instanziiert die ServiceRemotingDispatcher, die verwendet den angegebenen Dienstkontext und sendet Nachrichten an die angegebene dienstimplementierung.</span><span class="sxs-lookup"><span data-stu-id="d8ab1-104">Instantiates the ServiceRemotingDispatcher that uses the given service context and dispatches messages to the given service implementation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d8ab1-105">Führt anwendungsspezifische Aufgaben durch, die mit der Freigabe, der Zurückgabe oder dem Zurücksetzen von nicht verwalteten Ressourcen zusammenhängen.</span><span class="sxs-lookup"><span data-stu-id="d8ab1-105">Performs application-defined tasks associated with freeing, releasing, or resetting unmanaged resources.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <filterpriority><span data-ttu-id="d8ab1-106">2</span><span class="sxs-lookup"><span data-stu-id="d8ab1-106">2</span></span></filterpriority>
      </Docs>
    </Member>
    <Member MemberName="HandleOneWay">
      ...
      <Docs>
        <param name="requestContext"><span data-ttu-id="d8ab1-107">Anforderungskontext - enthält zusätzliche Informationen zur Anforderung</span><span class="sxs-lookup"><span data-stu-id="d8ab1-107">Request context - contains additional information about the request</span></span></param>
        <param name="messageHeaders"><span data-ttu-id="d8ab1-108">Anforderungsnachrichtenheadern</span><span class="sxs-lookup"><span data-stu-id="d8ab1-108">Request message headers</span></span></param>
        <param name="requestBody"><span data-ttu-id="d8ab1-109">Nachrichtentext</span><span class="sxs-lookup"><span data-stu-id="d8ab1-109">Request message body</span></span></param>
        <summary>
            <span data-ttu-id="d8ab1-110">Eine unidirektionale Nachricht vom Client verarbeitet.</span><span class="sxs-lookup"><span data-stu-id="d8ab1-110">Handles a one way message from the client.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RequestResponseAsync">
      ...
      <Docs>
        <param name="requestContext"><span data-ttu-id="d8ab1-111">Anforderungskontext - enthält zusätzliche Informationen zur Anforderung</span><span class="sxs-lookup"><span data-stu-id="d8ab1-111">Request context - contains additional information about the request</span></span></param>
        <param name="messageHeaders"><span data-ttu-id="d8ab1-112">Anforderungsnachrichtenheadern</span><span class="sxs-lookup"><span data-stu-id="d8ab1-112">Request message headers</span></span></param>
        <param name="requestBody"><span data-ttu-id="d8ab1-113">Nachrichtentext</span><span class="sxs-lookup"><span data-stu-id="d8ab1-113">Request message body</span></span></param>
        <summary>
            <span data-ttu-id="d8ab1-114">Verarbeitet eine Nachricht vom Client, der eine Antwort vom Dienst erforderlich sind.</span><span class="sxs-lookup"><span data-stu-id="d8ab1-114">Handles a message from the client that requires a response from the service.</span></span>
            </summary>
        <returns><span data-ttu-id="d8ab1-115">Antworttext</span><span class="sxs-lookup"><span data-stu-id="d8ab1-115">Response body</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
