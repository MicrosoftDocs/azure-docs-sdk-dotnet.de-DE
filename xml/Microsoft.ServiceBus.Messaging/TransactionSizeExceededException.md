<Type Name="TransactionSizeExceededException" FullName="Microsoft.ServiceBus.Messaging.TransactionSizeExceededException">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="29a35-101">Stellt eine Ausnahme dar, wenn die Transaktionsgröße überschreitet.</span><span class="sxs-lookup"><span data-stu-id="29a35-101">Represents an exception when the transaction size exceeds.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="29a35-102">Die Ausnahmemeldung.</span><span class="sxs-lookup"><span data-stu-id="29a35-102">The exception message.</span></span></param>
        <summary><span data-ttu-id="29a35-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Messaging.TransactionSizeExceededException" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29a35-103">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Messaging.TransactionSizeExceededException" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="29a35-104">Die Ausnahmemeldung.</span><span class="sxs-lookup"><span data-stu-id="29a35-104">The exception message.</span></span></param>
        <param name="innerException"><span data-ttu-id="29a35-105">Der Fehler, der die Ausnahme verursacht hat.</span><span class="sxs-lookup"><span data-stu-id="29a35-105">The error that caused the exception.</span></span></param>
        <summary><span data-ttu-id="29a35-106">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Messaging.TransactionSizeExceededException" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29a35-106">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Messaging.TransactionSizeExceededException" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
