<Type Name="ClientEntity" FullName="Microsoft.ServiceBus.Messaging.ClientEntity">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="119c6-101">Eine Datenstruktur, die die Ereignisse von einem Datenstrom Event Hub gesendete und empfangene darstellt.</span><span class="sxs-lookup"><span data-stu-id="119c6-101">A data structure that represents the events sent and received from an Event Hub stream.</span></span></summary>
  ...
  <Members>
    <Member MemberName="Abort">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="119c6-102">Führt Funktionen für Abbruch der messaging-Entität.</span><span class="sxs-lookup"><span data-stu-id="119c6-102">Performs abort functionality on the messaging entity.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Close">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="119c6-103">Sendet eine Bereinigung-Nachricht an Service Bus, um den Abschluss der Verwendung einer Entität zu signalisieren.</span><span class="sxs-lookup"><span data-stu-id="119c6-103">Sends a cleanup message to Service Bus to signal the completion of the usage of an entity.</span></span></summary>
        <remarks><span data-ttu-id="119c6-104">Im Fall von Ausnahmen führt die Methode einen Abbruch auf die Entität vor dem Auslösen der Ausnahme.</span><span class="sxs-lookup"><span data-stu-id="119c6-104">In the event of any exceptions, the method will perform an abort on the entity before throwing the exception.</span></span></remarks>
      </Docs>
    </Member>
    <Member MemberName="CloseAsync">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="119c6-105">Sendet eine Nachricht Cleanup asynchron in Service Bus, um den Abschluss der Verwendung einer Entität zu signalisieren.</span><span class="sxs-lookup"><span data-stu-id="119c6-105">Sends a cleanup message asynchronously to Service Bus to signal the completion of the usage of an entity.</span></span></summary>
        <returns><span data-ttu-id="119c6-106">Wenn eine Ausnahme auftritt, führt diese Methode ein Abbruchvorgang für die Entität vor dem Auslösen der Ausnahme.</span><span class="sxs-lookup"><span data-stu-id="119c6-106">If an exception occurs, this method performs an abort operation on the entity before throwing the exception.</span></span></returns>
        <remarks><span data-ttu-id="119c6-107">Im Fall von Ausnahmen führt die Methode einen Abbruch auf die Entität vor dem Auslösen der Ausnahme.</span><span class="sxs-lookup"><span data-stu-id="119c6-107">In the event of any exceptions, the method will perform an abort on the entity before throwing the exception.</span></span></remarks>
      </Docs>
    </Member>
    <Member MemberName="Fault">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="119c6-108">Nur zur internen Verwendung.</span><span class="sxs-lookup"><span data-stu-id="119c6-108">For internal use only.</span></span> <span data-ttu-id="119c6-109">Nicht von dieser Klasse erben.</span><span class="sxs-lookup"><span data-stu-id="119c6-109">Do not inherit from this class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsClosed">
      ...
      <Docs>
        <summary />
        <value><span data-ttu-id="119c6-110">Gibt <see cref="T:System.Boolean" />zurück.</span><span class="sxs-lookup"><span data-stu-id="119c6-110">Returns <see cref="T:System.Boolean" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="OnBeginClose">
      ...
      <Docs>
        ...
        <summary />
        <returns><span data-ttu-id="119c6-111">Gibt <see cref="T:System.IAsyncResult" />zurück.</span><span class="sxs-lookup"><span data-stu-id="119c6-111">Returns <see cref="T:System.IAsyncResult" />.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginOpen">
      ...
      <Docs>
        ...
        <param name="state"></param>
        <summary />
        <returns><span data-ttu-id="119c6-112">Gibt <see cref="T:System.IAsyncResult" />zurück.</span><span class="sxs-lookup"><span data-stu-id="119c6-112">Returns <see cref="T:System.IAsyncResult" />.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RetryPolicy">
      ...
      <Docs>
        <summary />
        <value><span data-ttu-id="119c6-113">Gibt <see cref="T:Microsoft.ServiceBus.RetryPolicy" />zurück.</span><span class="sxs-lookup"><span data-stu-id="119c6-113">Returns <see cref="T:Microsoft.ServiceBus.RetryPolicy" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ThisLock">
      ...
      <Docs>
        <summary />
        <value><span data-ttu-id="119c6-114">Gibt <see cref="T:System.Object" />zurück.</span><span class="sxs-lookup"><span data-stu-id="119c6-114">Returns <see cref="T:System.Object" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
