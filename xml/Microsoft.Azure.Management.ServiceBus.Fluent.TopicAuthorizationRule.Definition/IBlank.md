<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.TopicAuthorizationRule.Definition.IBlank">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.ServiceBus.Fluent.TopicAuthorizationRule.Definition.IBlank" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e9bb9-101">Die erste Phase der Thema Autorisierung Regeldefinition.</span><span class="sxs-lookup"><span data-stu-id="e9bb9-101">The first stage of topic authorization rule definition.</span></span>
            </summary>
