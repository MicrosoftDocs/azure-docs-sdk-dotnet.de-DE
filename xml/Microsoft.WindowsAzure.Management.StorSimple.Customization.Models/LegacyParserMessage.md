<Type Name="LegacyParserMessage" FullName="Microsoft.WindowsAzure.Management.StorSimple.Customization.Models.LegacyParserMessage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44213-101">Parser-Nachricht</span><span class="sxs-lookup"><span data-stu-id="44213-101">Parser message</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CustomMessageList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44213-102">Ruft ab oder legt ihn fest benutzerdefinierte Meldungen angezeigt werden</span><span class="sxs-lookup"><span data-stu-id="44213-102">Gets or sets custom messages to be displayed</span></span>
            </summary>
    ...
    <Member MemberName="ObjectType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44213-103">Ruft ab oder legt ihn fest Objekttyp, die vom Parser analysiert werden kann, für die die Meldung protokolliert wird</span><span class="sxs-lookup"><span data-stu-id="44213-103">Gets or sets Object type which can be parsed by the parser for which the message is logged</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Reason">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44213-104">Ruft ab oder legt ihn fest den häufigste Grund für den die Meldung protokolliert wird</span><span class="sxs-lookup"><span data-stu-id="44213-104">Gets or sets the common reason for which the message is logged</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44213-105">Ruft ab oder legt ihn fest Nachrichtentyp, der angibt, der Wichtigkeit der Meldung, die</span><span class="sxs-lookup"><span data-stu-id="44213-105">Gets or sets Message type indicating the criticality of message to be displayed</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
