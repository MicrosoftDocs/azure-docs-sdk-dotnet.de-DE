<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1bdd5-101">Die Phase der Definition einer Anwendung-Gateway, enthält alle erforderlichen Eingaben für die Ressource erstellt werden (über WithCreate.create()), jedoch lässt sich außerdem für alle anderen optionalen Einstellungen angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="1bdd5-101">The stage of an application gateway definition containing all the required inputs for the resource to be created (via  WithCreate.create()), but also allowing for any other optional settings to be specified.</span></span>
            </summary>
