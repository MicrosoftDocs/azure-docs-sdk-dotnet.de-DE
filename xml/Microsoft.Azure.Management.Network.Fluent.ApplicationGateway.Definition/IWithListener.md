<Type Name="IWithListener" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithListener">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="15ab1-101">Die Phase der Definition einer Anwendung-Gateway ermöglicht, einen Listener hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="15ab1-101">The stage of an application gateway definition allowing to add a listener.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="DefineListener">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="15ab1-102">Ein eindeutiger Name für den Listener.</span><span class="sxs-lookup"><span data-stu-id="15ab1-102">A unique name for the listener.</span></span></param>
        <summary>
            <span data-ttu-id="15ab1-103">Beginn der Definition einer neuen Anwendung Gateway Listener an das Gateway angefügt werden.</span><span class="sxs-lookup"><span data-stu-id="15ab1-103">Begins the definition of a new application gateway listener to be attached to the gateway.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="15ab1-104">Die erste Phase der Definition des Listeners.</span><span class="sxs-lookup"><span data-stu-id="15ab1-104">The first stage of the listener definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>