<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="73a4f-101">Die Phase der Definition einer Anwendung-Gateway ermöglicht, eine neue Internetzugriff Front-End-mit einer öffentlichen IP-Adresse hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="73a4f-101">The stage of an application gateway definition allowing to add a new Internet-facing frontend with a public IP address.</span></span>
            </summary>
