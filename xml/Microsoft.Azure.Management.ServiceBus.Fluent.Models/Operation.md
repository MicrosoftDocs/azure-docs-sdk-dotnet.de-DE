<Type Name="Operation" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Models.Operation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2ab6d-101">Ein Service Bus REST-API-Vorgang</span><span class="sxs-lookup"><span data-stu-id="2ab6d-101">A ServiceBus REST API operation</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ab6d-102">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="2ab6d-102">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="2ab6d-103">Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="2ab6d-103">Operation name: {provider}/{resource}/{operation}</span></span></param>
        <param name="display"><span data-ttu-id="2ab6d-104">Das Objekt, das den Vorgang darstellt.</span><span class="sxs-lookup"><span data-stu-id="2ab6d-104">The object that represents the operation.</span></span></param>
        <summary>
            <span data-ttu-id="2ab6d-105">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="2ab6d-105">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ab6d-106">Ruft ab oder legt das Objekt, das den Vorgang darstellt.</span><span class="sxs-lookup"><span data-stu-id="2ab6d-106">Gets or sets the object that represents the operation.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2ab6d-107">Ruft die Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="2ab6d-107">Gets operation name: {provider}/{resource}/{operation}</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
