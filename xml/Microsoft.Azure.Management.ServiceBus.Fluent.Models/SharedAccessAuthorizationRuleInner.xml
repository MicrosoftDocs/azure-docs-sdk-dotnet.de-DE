<Type Name="SharedAccessAuthorizationRuleInner" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Models.SharedAccessAuthorizationRuleInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="82e9e-101">Beschreibung des ein Namespace-Autorisierungsregel.</span><span class="sxs-lookup"><span data-stu-id="82e9e-101">Description of a namespace authorization rule.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e9e-102">Initialisiert eine neue Instanz der SharedAccessAuthorizationRuleInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="82e9e-102">Initializes a new instance of the SharedAccessAuthorizationRuleInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="rights"><span data-ttu-id="82e9e-103">Die Rechte, die in der Regel zugeordneten.</span><span class="sxs-lookup"><span data-stu-id="82e9e-103">The rights associated with the rule.</span></span></param>
        ...
        <summary>
            <span data-ttu-id="82e9e-104">Initialisiert eine neue Instanz der SharedAccessAuthorizationRuleInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="82e9e-104">Initializes a new instance of the SharedAccessAuthorizationRuleInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Rights">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e9e-105">Ruft ab oder legt die Berechtigungen, die in der Regel zugeordneten.</span><span class="sxs-lookup"><span data-stu-id="82e9e-105">Gets or sets the rights associated with the rule.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82e9e-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="82e9e-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="82e9e-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="82e9e-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
