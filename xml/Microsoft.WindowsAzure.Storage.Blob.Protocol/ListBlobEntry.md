<Type Name="ListBlobEntry" FullName="Microsoft.WindowsAzure.Storage.Blob.Protocol.ListBlobEntry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a7c6c-101">Stellt ein Blob-Element, das in der XML-Antwort für eine Blob-Auflistungsvorgang zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-101">Represents a blob item returned in the XML response for a blob listing operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CopyState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-102">Ruft den Status des letzten oder ausstehenden Kopiervorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-102">Gets the state of the most recent or pending copy operation.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-103">Ein <see cref="P:Microsoft.WindowsAzure.Storage.Blob.Protocol.ListBlobEntry.CopyState" /> Objekt, das den Kopierstatus enthält oder <c>null</c> Wenn kein kopierzustand für das Blob für dieses Blob vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-103">A <see cref="P:Microsoft.WindowsAzure.Storage.Blob.Protocol.ListBlobEntry.CopyState" /> object containing the copy state, or <c>null</c> if no copy blob state exists for this blob.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-104">Ruft die benutzerdefinierten Metadaten für das Blob-Element ab.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-104">Gets the user-defined metadata for the blob item.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-105">Ein <see cref="T:System.Collections.Generic.IDictionary`2" /> Objekt, das die Blob-Element-Metadaten als eine Auflistung von Name / Wert-Paaren enthält.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-105">An <see cref="T:System.Collections.Generic.IDictionary`2" /> object containing the blob item's metadata as a collection of name-value pairs.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-106">Ruft den Namen des BLOB-Elements ab.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-106">Gets the name of the blob item.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-107">Eine Zeichenfolge, die mit dem Namen des BLOB-Elements.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-107">A string containing the name of the blob item.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-108">Ruft die Blob-Systemeigenschaften des Elements ab.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-108">Gets the blob item's system properties.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-109">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobProperties" />-Objekt.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-109">A <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobProperties" /> object.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SnapshotTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-110">Ruft das Datum und die Uhrzeit, zu der die Blob-Momentaufnahme erstellt wurde, ab, wenn dieses Blob eine Momentaufnahme ist.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-110">Gets the date and time that the blob snapshot was taken, if this blob is a snapshot.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-111">Momentaufnahmezeit des BLOBs, wenn das Blob eine Momentaufnahme ist; andernfalls <c>null</c>.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-111">The blob's snapshot time if the blob is a snapshot; otherwise, <c>null</c>.</span></span></value>
        <remarks>
            <span data-ttu-id="a7c6c-112">Wenn das Blob keine Momentaufnahme ist, ist der Wert dieser Eigenschaft <c>null</c>.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-112">If the blob is not a snapshot, the value of this property is <c>null</c>.</span></span>
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a7c6c-113">Ruft die Blob-Element-URI ab.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-113">Gets the blob item's URI.</span></span>
            </summary>
        <value><span data-ttu-id="a7c6c-114">Der absolute URI zum BLOB-Element.</span><span class="sxs-lookup"><span data-stu-id="a7c6c-114">The absolute URI to the blob item.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
