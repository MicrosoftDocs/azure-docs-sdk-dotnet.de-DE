<Type Name="IWithEncryption" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Update.IWithEncryption">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d78e5-101">Ein Update von Storage-Konto zulassen Verschlüsselung angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="d78e5-101">A storage account update allowing encryption to be specified.</span></span>
            </summary>
