<Type Name="AzureStorageAccess" FullName="Microsoft.Azure.Management.HDInsight.Job.Models.AzureStorageAccess">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c5b62-101">Verwaltet Speicher Zugriffsdetails für auftragsvorgänge für HDInsight-Cluster an.</span><span class="sxs-lookup"><span data-stu-id="c5b62-101">Manages storage access details for job operations against HDInsight clusters.</span></span>
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="storageAccountName">
            <span data-ttu-id="c5b62-102">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="c5b62-102">Required.</span></span> <span data-ttu-id="c5b62-103">Der Name des Speicherkontos.</span><span class="sxs-lookup"><span data-stu-id="c5b62-103">The storage account name.</span></span>
            </param>
        <param name="storageAccountKey">
            <span data-ttu-id="c5b62-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="c5b62-104">Required.</span></span> <span data-ttu-id="c5b62-105">Der speicherkontoschlüssel.</span><span class="sxs-lookup"><span data-stu-id="c5b62-105">The storage account key.</span></span>
            </param>
        <param name="defaultStorageContainer">
            <span data-ttu-id="c5b62-106">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="c5b62-106">Required.</span></span> <span data-ttu-id="c5b62-107">Der Speicher Standardcontainernamen darstellt.</span><span class="sxs-lookup"><span data-stu-id="c5b62-107">The default storage container name.</span></span>
            </param>
        <param name="storageAccountSuffix">
            <span data-ttu-id="c5b62-108">Optional.</span><span class="sxs-lookup"><span data-stu-id="c5b62-108">Optional.</span></span> <span data-ttu-id="c5b62-109">Das URI-Suffix Storage-Konto.</span><span class="sxs-lookup"><span data-stu-id="c5b62-109">The storage account URI suffix.</span></span> <span data-ttu-id="c5b62-110">Z. B. "core.chinacloudapi.cn".</span><span class="sxs-lookup"><span data-stu-id="c5b62-110">For example, "core.chinacloudapi.cn".</span></span>
            </param>
        <summary>
            <span data-ttu-id="c5b62-111">Initialisiert eine neue Instanz der AzureStorageAccess-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c5b62-111">Initializes a new instance of the AzureStorageAccess class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetFileContent">
      ...
      <Docs>
        <param name="blobReferencePath">
            <span data-ttu-id="c5b62-112">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="c5b62-112">Required.</span></span> <span data-ttu-id="c5b62-113">BLOB-Verweispfad für welche Url generiert werden soll.</span><span class="sxs-lookup"><span data-stu-id="c5b62-113">Blob reference path for which url to be generated.</span></span>
            </param>
        <summary>
            <span data-ttu-id="c5b62-114">Ruft den Dateiinhalt aus Verweispfad Blob ab.</span><span class="sxs-lookup"><span data-stu-id="c5b62-114">Gets the file content from blob reference path.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="c5b62-115">Der Inhalt der Datei für die Eingabe-BLOBs Verweispfad.</span><span class="sxs-lookup"><span data-stu-id="c5b62-115">Content of the file for the input blob reference path.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
