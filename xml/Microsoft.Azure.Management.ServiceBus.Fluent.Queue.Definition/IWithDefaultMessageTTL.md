<Type Name="IWithDefaultMessageTTL" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Queue.Definition.IWithDefaultMessageTTL">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f0094-101">Die Stufe der die Warteschlangendefinition taktmonitoren Standardgültigkeitsdauer für Nachrichten definieren.</span><span class="sxs-lookup"><span data-stu-id="f0094-101">The stage of the queue definition allowing to define default TTL for messages.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDefaultMessageTTL">
      ...
      <Docs>
        <param name="ttl"><span data-ttu-id="f0094-102">Zeit zum live-Dauer.</span><span class="sxs-lookup"><span data-stu-id="f0094-102">Time to live duration.</span></span></param>
        <summary>
            <span data-ttu-id="f0094-103">Gibt den Zeitraum, nach dem die Nachricht abläuft.</span><span class="sxs-lookup"><span data-stu-id="f0094-103">Specifies the duration after which the message expires.</span></span>
            <span data-ttu-id="f0094-104">Hinweis: es sei denn, sie explizit außer Kraft gesetzt wird die standardmäßige Gültigkeitsdauer ist unendlich (TimeSpan.Max).</span><span class="sxs-lookup"><span data-stu-id="f0094-104">Note: unless it is explicitly overridden the default ttl is infinite (TimeSpan.Max).</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f0094-105">Die nächste Phase der Warteschlangendefinition.</span><span class="sxs-lookup"><span data-stu-id="f0094-105">The next stage of queue definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>