<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ea268-101">Die erste Phase der Abonnementdefinition eines.</span><span class="sxs-lookup"><span data-stu-id="ea268-101">The first stage of a subscription definition.</span></span>
            </summary>
