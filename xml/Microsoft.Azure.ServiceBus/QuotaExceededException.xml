<Type Name="QuotaExceededException" FullName="Microsoft.Azure.ServiceBus.QuotaExceededException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="edb9e-101">Die Ausnahme, die ausgelöst wird, wenn der Entität zugewiesene Kontingent (Entität Max Size oder anderen Verbindung usw.) überschritten hat.</span><span class="sxs-lookup"><span data-stu-id="edb9e-101">The exception that is thrown when the Quota (Entity Max Size or other Connection etc) allocated to the Entity has exceeded.</span></span>  <span data-ttu-id="edb9e-102">Aufrufer sollten überprüfen, die Fehlermeldung, um festzustellen, welche das Kontingent überschritten, und ergreifen Sie entsprechende Maßnahmen.</span><span class="sxs-lookup"><span data-stu-id="edb9e-102">Callers should check the error message to see which of the Quota exceeded and take appropriate action.</span></span>
            </summary>
