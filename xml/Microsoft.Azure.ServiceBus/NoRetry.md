<Type Name="NoRetry" FullName="Microsoft.Azure.ServiceBus.NoRetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f5ad5-101">Eine wiederholungsrichtlinie, die tatsächlich keine Wiederholung.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-101">A retry policy, which does not actually retry.</span></span>
            </summary>
    <remarks><span data-ttu-id="f5ad5-102">Verwenden Sie diese Option, wenn Sie alle Service Bus-Ausnahmen vom Benutzercode behandelt werden soll.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-102">Use this if you want all Service Bus exceptions to be handled by user code.</span></span></remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="OnShouldRetry">
      ...
      <Docs>
        <param name="remainingTime"><span data-ttu-id="f5ad5-103">Die verbleibende Zeit, bevor das Timeout abläuft.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-103">The remaining time before the timeout expires.</span></span></param>
        <param name="currentRetryCount"><span data-ttu-id="f5ad5-104">Die Anzahl der Versuche, die verarbeitet wurden.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-104">The number of attempts that have been processed.</span></span></param>
        <param name="retryInterval"><span data-ttu-id="f5ad5-105">Die Zeitspanne zu verzögern, bevor Sie versuchen Sie es erneut.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-105">The amount of time to delay before retry.</span></span></param>
        <summary>
            <span data-ttu-id="f5ad5-106">Wird aufgerufen, um festzustellen, ob ein erneuter Versuch ausgeführt werden soll.</span><span class="sxs-lookup"><span data-stu-id="f5ad5-106">Called to see if a retry should be performed.</span></span>
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
