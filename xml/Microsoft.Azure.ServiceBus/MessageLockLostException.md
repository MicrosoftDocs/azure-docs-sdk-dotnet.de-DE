<Type Name="MessageLockLostException" FullName="Microsoft.Azure.ServiceBus.MessageLockLostException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0680e-101">Die Ausnahme, die ausgelöst wird, wenn die Sperre für die Nachricht verloren geht.</span><span class="sxs-lookup"><span data-stu-id="0680e-101">The exception that is thrown when the lock on the message is lost.</span></span>  <span data-ttu-id="0680e-102">Aufrufer sollten Receive aufrufen und die Nachricht erneut verarbeiten.</span><span class="sxs-lookup"><span data-stu-id="0680e-102">Callers should call Receive and process the message again.</span></span>
            </summary>
