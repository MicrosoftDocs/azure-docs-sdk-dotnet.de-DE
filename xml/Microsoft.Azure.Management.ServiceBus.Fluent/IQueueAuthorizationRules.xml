<Type Name="IQueueAuthorizationRules" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRules">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eb3e5-101">Einstiegspunkt für einen Warteschlange Autorisierung Regeln Verwaltungs-API.</span><span class="sxs-lookup"><span data-stu-id="eb3e5-101">Entry point to queue authorization rules management API.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="eb3e5-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="eb3e5-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members />
</Type>