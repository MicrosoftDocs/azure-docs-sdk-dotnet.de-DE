<Type Name="IServiceBusNamespaces" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IServiceBusNamespaces">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4fe0f-101">Einstiegspunkt für einen Service Bus-Namespace API in Azure.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-101">Entry point to Service Bus namespace API in Azure.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="4fe0f-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="4fe0f-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="CheckNameAvailability">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="4fe0f-103">Der Kontoname, um zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-103">The account name to check.</span></span></param>
        <summary>
            <span data-ttu-id="4fe0f-104">Überprüft, ob der Namespacename ist gültig und wird nicht verwendet.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-104">Checks if namespace name is valid and is not in use.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="4fe0f-105">Gibt an, ob der Name verfügbar ist, und klicken Sie mit der anderer Informationen ist dies nicht.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-105">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="CheckNameAvailabilityAsync">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="4fe0f-106">Der zu überprüfende Namespacename.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-106">The namespace name to check.</span></span></param>
        <param name="cancellationToken">To be added.</param>
        <summary>
            <span data-ttu-id="4fe0f-107">Überprüft, ob der Namespacename ist gültig und wird nicht verwendet asynchron.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-107">Checks if namespace name is valid and is not in use asynchronously.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>
            <span data-ttu-id="4fe0f-108">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="4fe0f-108">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
        <return><span data-ttu-id="4fe0f-109">Gibt an, ob der Name verfügbar ist, und klicken Sie mit der anderer Informationen ist dies nicht.</span><span class="sxs-lookup"><span data-stu-id="4fe0f-109">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>