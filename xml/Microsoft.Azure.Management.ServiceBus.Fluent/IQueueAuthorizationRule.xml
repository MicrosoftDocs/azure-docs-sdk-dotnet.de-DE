<Type Name="IQueueAuthorizationRule" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule">
  ...
  <Interfaces>
    ...
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.ResourceManager.Fluent.Core.ResourceActions.IRefreshable&lt;Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule&gt;</InterfaceName>
    </Interface>
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.ResourceManager.Fluent.Core.ResourceActions.IUpdatable&lt;Microsoft.Azure.Management.ServiceBus.Fluent.QueueAuthorizationRule.Update.IUpdate&gt;</InterfaceName>
    </Interface>
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.ServiceBus.Fluent.IAuthorizationRule&lt;Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule&gt;</InterfaceName>
    </Interface>
  </Interfaces>
  <Docs>
    <summary>
            <span data-ttu-id="a72c5-101">Typ zur Darstellung der Autorisierungsregel für die Warteschlange definiert.</span><span class="sxs-lookup"><span data-stu-id="a72c5-101">Type representing authorization rule defined for queue.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="a72c5-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="a72c5-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="NamespaceName">
      ...
      <MemberSignature Language="DocId" Value="P:Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule.NamespaceName" />
      <MemberSignature Language="VB.NET" Value="Public ReadOnly Property NamespaceName As String" />
      <MemberSignature Language="F#" Value="member this.NamespaceName : string" Usage="Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule.NamespaceName" />
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a72c5-103">Ruft den Namen des Namespaces, der die übergeordnete Warteschlange gehört.</span><span class="sxs-lookup"><span data-stu-id="a72c5-103">Gets the name of the namespace that the parent queue belongs to.</span></span>
            </summary>
    ...
    <Member MemberName="QueueName">
      ...
      <MemberSignature Language="DocId" Value="P:Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule.QueueName" />
      <MemberSignature Language="VB.NET" Value="Public ReadOnly Property QueueName As String" />
      <MemberSignature Language="F#" Value="member this.QueueName : string" Usage="Microsoft.Azure.Management.ServiceBus.Fluent.IQueueAuthorizationRule.QueueName" />
      <MemberType>Property</MemberType>
      <AssemblyInfo>
        <AssemblyName>Microsoft.Azure.Management.ServiceBus.Fluent</AssemblyName>
        <AssemblyVersion>1.0.0.60</AssemblyVersion>
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a72c5-104">Ruft den Namen des übergeordneten Elements Warteschlangenname ab.</span><span class="sxs-lookup"><span data-stu-id="a72c5-104">Gets the name of the parent queue name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
