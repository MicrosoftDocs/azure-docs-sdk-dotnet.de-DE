<Type Name="IAuthorizationKeys" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IAuthorizationKeys">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f2e26-101">Schlüssel und Verbindung autorisierungszeichenfolge der Autorisierungsregel Service Bus-Entitäten zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="f2e26-101">Authorization key and connection string of authorization rule associated with Service Bus entities.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="f2e26-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="f2e26-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="PrimaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2e26-103">Ruft die primäre Verbindungszeichenfolge ab.</span><span class="sxs-lookup"><span data-stu-id="f2e26-103">Gets primary connection string.</span></span>
            </summary>
    ...
    <Member MemberName="PrimaryKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2e26-104">Ruft die Primärschlüssel in der Regel zugeordneten ab.</span><span class="sxs-lookup"><span data-stu-id="f2e26-104">Gets primary key associated with the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2e26-105">Ruft die sekundäre Verbindungszeichenfolge ab.</span><span class="sxs-lookup"><span data-stu-id="f2e26-105">Gets secondary connection string.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2e26-106">Ruft in der Regel zugeordneten Sekundärschlüssel ab.</span><span class="sxs-lookup"><span data-stu-id="f2e26-106">Gets secondary key associated with the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
