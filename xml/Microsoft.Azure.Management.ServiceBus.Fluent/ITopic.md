<Type Name="ITopic" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ITopic">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="29f2e-101">Geben Sie für Service Bus-Thema.</span><span class="sxs-lookup"><span data-stu-id="29f2e-101">Type representing Service Bus topic.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="29f2e-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="29f2e-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="AccessedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-103">Ruft die zuletzt eine Nachricht gesendet wurde, oder der letzten Ausführung, es wurde eine Receive-Anforderung zu diesem Thema.</span><span class="sxs-lookup"><span data-stu-id="29f2e-103">Gets last time a message was sent, or the last time there was a receive request to this topic.</span></span>
            </summary>
    ...
    <Member MemberName="ActiveMessageCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-104">Ruft die Anzahl aktiver Nachrichten im Thema.</span><span class="sxs-lookup"><span data-stu-id="29f2e-104">Gets number of active messages in the topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AuthorizationRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-105">Ruft Einstiegspunkt zum Verwalten von Autorisierungsregeln für den Service Bus-Topic ab.</span><span class="sxs-lookup"><span data-stu-id="29f2e-105">Gets entry point to manage authorization rules for the Service Bus topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-106">Ruft die genaue Uhrzeit, an die das Thema erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="29f2e-106">Gets the exact time the topic was created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CurrentSizeInBytes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-107">Ruft die aktuelle Größe des Themas, in Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="29f2e-107">Gets current size of the topic, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeadLetterMessageCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-108">Ruft die Anzahl der in diesem Thema unzustellbare Nachrichten.</span><span class="sxs-lookup"><span data-stu-id="29f2e-108">Gets number of messages in the dead-letter topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultMessageTtlDuration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-109">Ruft die Dauer, die nach der die Nachricht abläuft, beginnend ab dem Zeitpunkt der Nachricht zum Thema gesendet wird.</span><span class="sxs-lookup"><span data-stu-id="29f2e-109">Gets the duration after which the message expires, starting from when the message is sent to topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeleteOnIdleDurationInMinutes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-110">Ruft die Leerlaufdauer nach der Thema automatisch gelöscht wird.</span><span class="sxs-lookup"><span data-stu-id="29f2e-110">Gets the idle duration after which the topic is automatically deleted.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DuplicateMessageDetectionHistoryDuration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-111">Ruft ab, die die Zeitspanne des duplikaterkennungsverlaufs.</span><span class="sxs-lookup"><span data-stu-id="29f2e-111">Gets the duration of the duplicate detection history.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsBatchedOperationsEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-112">Ruft gibt an, ob serverseitige Batchvorgänge aktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="29f2e-112">Gets indicates whether server-side batched operations are enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDuplicateDetectionEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-113">Ruft gibt an, ob in diesem Thema die Erkennung von Duplikaten ist erforderlich.</span><span class="sxs-lookup"><span data-stu-id="29f2e-113">Gets indicates if this topic requires duplicate detection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsExpressEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-114">Ruft gibt an, ob expressentitäten aktiviert sind.</span><span class="sxs-lookup"><span data-stu-id="29f2e-114">Gets indicates whether express entities are enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPartitioningEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-115">Ruft gibt an, ob das Thema mehrere nachrichtenbroker partitioniert werden.</span><span class="sxs-lookup"><span data-stu-id="29f2e-115">Gets indicates whether the topic is to be partitioned across multiple message brokers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxSizeInMB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-116">Ruft die maximale Größe des Arbeitsspeichers für das Thema in Megabyte an.</span><span class="sxs-lookup"><span data-stu-id="29f2e-116">Gets the maximum size of memory allocated for the topic in megabytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScheduledMessageCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-117">Ruft die Anzahl der Nachrichten an das Thema gesendet, die noch für Verbrauch veröffentlicht werden soll.</span><span class="sxs-lookup"><span data-stu-id="29f2e-117">Gets number of messages sent to the topic that are yet to be released for consumption.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-118">Ruft den aktuellen Status des Themas.</span><span class="sxs-lookup"><span data-stu-id="29f2e-118">Gets the current status of the topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-119">Ruft die Anzahl der Abonnements für das Thema.</span><span class="sxs-lookup"><span data-stu-id="29f2e-119">Gets number of subscriptions for the topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subscriptions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-120">Ruft ab Einstiegspunkt zum Verwalten von Abonnements, die im Thema zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="29f2e-120">Gets entry point to manage subscriptions associated with the topic.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TransferDeadLetterMessageCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-121">Ruft die Anzahl der Nachrichten, die in der unzustellbare Nachrichten übertragen werden.</span><span class="sxs-lookup"><span data-stu-id="29f2e-121">Gets number of messages transferred into dead letters.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TransferMessageCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-122">Ruft die Anzahl der Nachrichten, die in einem anderen Thema, ein Thema oder Abonnement übertragen werden.</span><span class="sxs-lookup"><span data-stu-id="29f2e-122">Gets number of messages transferred to another topic, topic, or subscription.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29f2e-123">Ruft die genaue Uhrzeit für das Thema wurde aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="29f2e-123">Gets the exact time the topic was updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
