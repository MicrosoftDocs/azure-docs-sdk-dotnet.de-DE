<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7479b-101">Erweiterungsmethoden für Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="7479b-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="7479b-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="7479b-102">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="7479b-103">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="7479b-103">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="7479b-104">Zeigt eine Liste aller verfügbaren Service Bus REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="7479b-104">Lists all of the available ServiceBus REST API operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="7479b-105">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="7479b-105">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="7479b-106">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="7479b-106">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="7479b-107">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="7479b-107">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="7479b-108">Zeigt eine Liste aller verfügbaren Service Bus REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="7479b-108">Lists all of the available ServiceBus REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
