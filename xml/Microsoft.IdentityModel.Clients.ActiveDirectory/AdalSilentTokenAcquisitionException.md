<Type Name="AdalSilentTokenAcquisitionException" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.AdalSilentTokenAcquisitionException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f47b8-101">Der Ausnahmetyp ausgelöst, wenn ein Token kann nicht automatisch abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="f47b8-101">The exception type thrown when a token cannot be acquired silently.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
             <span data-ttu-id="f47b8-102">Initialisiert eine neue Instanz der Exception-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f47b8-102">Initializes a new instance of the exception class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
