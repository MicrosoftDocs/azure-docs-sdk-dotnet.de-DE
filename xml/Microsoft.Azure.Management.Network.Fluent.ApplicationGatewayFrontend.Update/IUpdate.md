<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayFrontend.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="50604-101">Die gesamte Anwendung Gateway Front-End-Update als Teil der Anwendung ein Gateway.</span><span class="sxs-lookup"><span data-stu-id="50604-101">The entirety of an application gateway frontend update as part of an application gateway update.</span></span>
            </summary>
