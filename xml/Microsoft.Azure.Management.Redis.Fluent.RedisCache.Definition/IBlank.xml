<Type Name="IBlank" FullName="Microsoft.Azure.Management.Redis.Fluent.RedisCache.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fb2f7-101">Die erste Phase der Definition des Redis-Cache.</span><span class="sxs-lookup"><span data-stu-id="fb2f7-101">The first stage of the Redis Cache definition.</span></span>
            </summary>
