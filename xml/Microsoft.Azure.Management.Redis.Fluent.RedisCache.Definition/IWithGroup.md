<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Redis.Fluent.RedisCache.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8d27f-101">Eine Redis-Cache-Definition, sodass Ressourcengruppe festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="8d27f-101">A Redis Cache definition allowing resource group to be set.</span></span>
            </summary>
