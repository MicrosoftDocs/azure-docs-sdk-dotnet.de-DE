<Type Name="IWithOSDiskSettings" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithOSDiskSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="13bcb-101">Die Phase der Definition eines virtuellen Computers, sodass Konfigurationen der Betriebssystem-Datenträger angeben.</span><span class="sxs-lookup"><span data-stu-id="13bcb-101">The stage of a virtual machine definition allowing to specify OS disk configurations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithOSDiskCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="13bcb-102">ein Zwischenspeichern Typ.</span><span class="sxs-lookup"><span data-stu-id="13bcb-102">A caching type.</span></span></param>
        <summary>
            <span data-ttu-id="13bcb-103">Gibt an, welche Zwischenspeichern für den Betriebssystem-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="13bcb-103">Specifies the caching type for the OS disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="13bcb-104">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="13bcb-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithOSDiskEncryptionSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="13bcb-105">die verschlüsselungseinstellungen.</span><span class="sxs-lookup"><span data-stu-id="13bcb-105">The encryption settings.</span></span></param>
        <summary>
            <span data-ttu-id="13bcb-106">Gibt die Einstellungen für die Verschlüsselung für den Betriebssystem-Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="13bcb-106">Specifies the encryption settings for the OS Disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="13bcb-107">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="13bcb-107">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithOSDiskName">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="13bcb-108">Ein Name für den Betriebssystem-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="13bcb-108">An OS disk name.</span></span></param>
        <summary>
            <span data-ttu-id="13bcb-109">Gibt den Namen für den Betriebssystem-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="13bcb-109">Specifies the name for the OS Disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="13bcb-110">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="13bcb-110">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithOSDiskSizeInGB">
      ...
      <Docs>
        <param name="size"><span data-ttu-id="13bcb-111">Die VHD-Größe.</span><span class="sxs-lookup"><span data-stu-id="13bcb-111">The VHD size.</span></span></param>
        <summary>
            <span data-ttu-id="13bcb-112">Gibt die Größe des OSDisk in GB an.</span><span class="sxs-lookup"><span data-stu-id="13bcb-112">Specifies the size of the OSDisk in GB.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="13bcb-113">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="13bcb-113">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>