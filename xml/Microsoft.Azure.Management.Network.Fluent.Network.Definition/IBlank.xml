<Type Name="IBlank" FullName="Microsoft.Azure.Management.Network.Fluent.Network.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="77391-101">Die erste Phase der Definition eines virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="77391-101">The first stage of a virtual network definition.</span></span>
            </summary>
