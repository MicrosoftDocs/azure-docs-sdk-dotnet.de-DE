<Type Name="HttpsRelayTransportBindingElement" FullName="Microsoft.ServiceBus.HttpsRelayTransportBindingElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="2e3e1-101">Stellt das Bindungselement dar, die eine HTTPS-Relay-Übertragung zum Senden von Nachrichten an.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-101">Represents the binding element used to specify an HTTPS relay transport for transmitting messages.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="2e3e1-102">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> -Klasse unter Verwendung der Standardeinstellungen.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-102">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> class, using the default settings.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="elementToBeCloned"><span data-ttu-id="2e3e1-103">Das Element, geklont zu werden.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-103">The element to be cloned.</span></span></param>
        <summary><span data-ttu-id="2e3e1-104">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> -Klasse unter Verwendung des angegebenen Elements.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-104">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> class, using the specified element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="relayClientAuthenticationType"><span data-ttu-id="2e3e1-105">Die relayclient-Authentifizierungstyp.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-105">The relay client authentication type.</span></span></param>
        <summary><span data-ttu-id="2e3e1-106">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> -Klasse mithilfe des angegebenen Typs der Clientauthentifizierung.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-106">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> class, using the specified type of client authentication.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clone">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="2e3e1-107">Erstellt eine tiefe Kopie des aktuellen Bindungselements.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-107">Creates a deep copy of the current binding element.</span></span></summary>
        <returns><span data-ttu-id="2e3e1-108">Eine tiefe Kopie des aktuellen Bindungselements.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-108">A deep copy of the current binding element.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateInnerChannelBindingElement">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="2e3e1-109">Erstellt eine <see cref="T:System.ServiceModel.Channels.HttpTransportBindingElement" /> Bindungselement für den inneren Kanal.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-109">Creates a <see cref="T:System.ServiceModel.Channels.HttpTransportBindingElement" /> binding element for the inner channel.</span></span></summary>
        <returns><span data-ttu-id="2e3e1-110">Ein Bindungselement für den inneren Kanal.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-110">A binding element for the inner channel.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetProperty&lt;T&gt;">
      ...
      <Docs>
        ...
        <param name="context"> <span data-ttu-id="2e3e1-111">Der Bindungskontext.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-111">The binding context.</span></span></param>
        <summary><span data-ttu-id="2e3e1-112">Ruft die angegebene Eigenschaft aus dem angegebenen Bindungskontext ab.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-112">Gets the specified property from the specified binding context.</span></span></summary>
        <returns><span data-ttu-id="2e3e1-113">Ein Bindungselement, das die Eigenschaft enthält.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-113">A binding element that contains the property.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InitializeInnerChannelBindingElement">
      ...
      <Docs>
        <param name="httpTransportElement"> <span data-ttu-id="2e3e1-114">Das Bindungselement zu initialisieren.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-114">The binding element to initialize.</span></span></param>
        <summary><span data-ttu-id="2e3e1-115">Initialisiert das angegebene Bindungselement, das mit den Einstellungen aus der aktuellen Instanz der dem<see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> Binding-Element.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-115">Initializes the specified binding element with the settings from the current instance of the<see cref="T:Microsoft.ServiceBus.HttpsRelayTransportBindingElement" /> binding element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Scheme">
      ...
      <Docs>
        <summary><span data-ttu-id="2e3e1-116">Ruft das URI-Schema für den Transport ab.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-116">Gets the URI scheme for the transport.</span></span></summary>
        <value><span data-ttu-id="2e3e1-117">Das URI-Schema für den Transport, der "HTTPS" ist.</span><span class="sxs-lookup"><span data-stu-id="2e3e1-117">The URI scheme for the transport, which is “HTTPS”.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
