<Type Name="IWithPrivateIP" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Update.IWithPrivateIP">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="80bdc-101">Die Phase des Netzwerk-Schnittstelle IP-konfigurationsupdates an die private IP zulassen.</span><span class="sxs-lookup"><span data-stu-id="80bdc-101">The stage of the network interface IP configuration update allowing to specify private IP.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrivateIPVersion">
      ...
      <Docs>
        <param name="ipVersion"><span data-ttu-id="80bdc-102">Eine IP-Version.</span><span class="sxs-lookup"><span data-stu-id="80bdc-102">An IP version.</span></span></param>
        <summary>
            <span data-ttu-id="80bdc-103">Gibt die IP-Version für die private IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="80bdc-103">Specifies the IP version for the private IP address.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="80bdc-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="80bdc-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>