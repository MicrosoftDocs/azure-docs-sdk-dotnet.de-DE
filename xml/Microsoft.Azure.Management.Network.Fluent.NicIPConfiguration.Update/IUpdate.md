<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5499c-101">Die gesamte eines Netzwerk-Schnittstelle IP-Konfiguration-Updates im Rahmen eines Updates der Netzwerk-Schnittstelle.</span><span class="sxs-lookup"><span data-stu-id="5499c-101">The entirety of a network interface IP configuration update as part of a network interface update.</span></span>
            </summary>
