<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Update.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9bcc9-101">Die Stufe der das Netzwerk Schnittstelle IP-Konfiguration Update festlegen, dass öffentliche IP-Adresse angeben.</span><span class="sxs-lookup"><span data-stu-id="9bcc9-101">The stage of the network interface IP configuration update allowing to specify public IP address.</span></span>
            </summary>
