<Type Name="IExternalTargetEndpointBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.Definition.IExternalTargetEndpointBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="8cce6-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="8cce6-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="8cce6-102">Die erste Phase einer Traffic Manager Profildefinition externen Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="8cce6-102">The first stage of a traffic manager profile external endpoint definition.</span></span>
            </summary>
