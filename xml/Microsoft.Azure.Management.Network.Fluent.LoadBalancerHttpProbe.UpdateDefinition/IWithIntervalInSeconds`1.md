<Type Name="IWithIntervalInSeconds&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerHttpProbe.UpdateDefinition.IWithIntervalInSeconds&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="a33d0-101">Der übergeordnete Ressourcentyp.</span><span class="sxs-lookup"><span data-stu-id="a33d0-101">The parent resource type.</span></span></typeparam>
    <summary>
            <span data-ttu-id="a33d0-102">Die Phase der HTTP-Test Definition ermöglichen das Testintervall an.</span><span class="sxs-lookup"><span data-stu-id="a33d0-102">The stage of the HTTP probe definition allowing to specify the probe interval.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithIntervalInSeconds">
      ...
      <Docs>
        <param name="seconds"><span data-ttu-id="a33d0-103">Anzahl der Sekunden.</span><span class="sxs-lookup"><span data-stu-id="a33d0-103">Number of seconds.</span></span></param>
        <summary>
            <span data-ttu-id="a33d0-104">Gibt das Intervall zwischen Prüfpunkten in Sekunden an.</span><span class="sxs-lookup"><span data-stu-id="a33d0-104">Specifies the interval between probes, in seconds.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a33d0-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="a33d0-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>