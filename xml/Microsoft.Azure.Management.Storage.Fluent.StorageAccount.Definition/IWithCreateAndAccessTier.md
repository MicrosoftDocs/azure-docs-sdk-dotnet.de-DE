<Type Name="IWithCreateAndAccessTier" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Definition.IWithCreateAndAccessTier">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ae0d3-101">Eine speicherkontendefinition, sodass zugriffstarifs festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-101">A storage account definition allowing access tier to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithAccessTier">
      ...
      <Docs>
        <param name="accessTier"><span data-ttu-id="ae0d3-102">Der Wert für den Access-Ebene.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-102">The access tier value.</span></span></param>
        <summary>
            <span data-ttu-id="ae0d3-103">Gibt die Access-Ebene für die Abrechnung verwendet.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-103">Specifies the access tier used for billing.</span></span>
            <span data-ttu-id="ae0d3-104">Zugriffstarifs kann mehr als einmal alle 7 Tage (168 Stunden) geändert werden.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-104">Access tier cannot be changed more than once every 7 days (168 hours).</span></span>
            <span data-ttu-id="ae0d3-105">Zugriffstarifs kann nicht für StandardLRS, StandardGRS, StandardRAGRS oder PremiumLRS Kontotypen festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-105">Access tier cannot be set for StandardLRS, StandardGRS, StandardRAGRS, or PremiumLRS account types.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ae0d3-106">Die nächste Phase der speicherkontendefinition.</span><span class="sxs-lookup"><span data-stu-id="ae0d3-106">The next stage of storage account definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>