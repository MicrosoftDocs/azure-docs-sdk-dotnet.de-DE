<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Update.IWithPublicIPAddress">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Update.IWithPublicIPAddress" />
  <TypeSignature Language="VB.NET" Value="Public Interface IWithPublicIPAddress&#xA;Implements IWithExistingPublicIPAddress(Of IUpdate), IWithNewPublicIPAddressNoDnsLabel(Of IUpdate), IWithPublicIPAddressNoDnsLabel(Of IUpdate)" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="13837-101">Die Phase von einer Anwendung Gateway Update ermöglicht an eine öffentliche IP-Adresse für das öffentliche Front-End.</span><span class="sxs-lookup"><span data-stu-id="13837-101">The stage of an application gateway update allowing to specify a public IP address for the public frontend.</span></span>
            </summary>
