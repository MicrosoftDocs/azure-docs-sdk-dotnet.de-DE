<Type Name="ImageOSDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ImageOSDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6c3d8-101">Beschreibt die Betriebssystem-Datenträger.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-101">Describes an Operating System disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-102">Initialisiert eine neue Instanz der ImageOSDisk-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-102">Initializes a new instance of the ImageOSDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BlobUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-103">Ruft ab oder legt die virtuelle Festplatte.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-103">Gets or sets the Virtual Hard Disk.</span></span>
            </summary>
    ...
    <Member MemberName="Caching">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-104">Abrufen oder festlegen den caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-104">Gets or sets the caching type.</span></span> <span data-ttu-id="6c3d8-105">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite"</span><span class="sxs-lookup"><span data-stu-id="6c3d8-105">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-106">Ruft ab oder legt den ersten verwalteten Festplattengröße in GB für leere Datenträger und die neue gewünschte Größe für das vorhandene Betriebssystem und die Datenträger.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-106">Gets or sets the initial managed disk size in GB for blank data disks, and the new desired size for existing OS and Data disks.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedDisk">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-107">Ruft ab oder legt die ManagedDisk.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-107">Gets or sets the managedDisk.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-108">Ruft ab oder legt den Status des Betriebssystems.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-108">Gets or sets the OS State.</span></span> <span data-ttu-id="6c3d8-109">Folgende Werte sind möglich: "Generalisiert", "Spezialisiert"</span><span class="sxs-lookup"><span data-stu-id="6c3d8-109">Possible values include: 'Generalized', 'Specialized'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-110">Ruft ab oder legt den Betriebssystemtyp.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-110">Gets or sets the Operating System type.</span></span> <span data-ttu-id="6c3d8-111">Folgende Werte sind möglich: "Windows", "Linux"</span><span class="sxs-lookup"><span data-stu-id="6c3d8-111">Possible values include: 'Windows', 'Linux'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Snapshot">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-112">Ruft ab oder legt die Momentaufnahme.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-112">Gets or sets the snapshot.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6c3d8-113">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="6c3d8-113">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="6c3d8-114">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="6c3d8-114">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
