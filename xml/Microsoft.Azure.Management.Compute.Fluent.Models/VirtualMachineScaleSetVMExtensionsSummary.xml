<Type Name="VirtualMachineScaleSetVMExtensionsSummary" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetVMExtensionsSummary">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7fc4d-101">Legen Sie die Erweiterungen für virtuelle Maschinen von einem VM-Skalierungsgruppe Zusammenfassung.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-101">Extensions summary for virtual machines of a virtual machine scale set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc4d-102">Initialisiert eine neue Instanz der VirtualMachineScaleSetVMExtensionsSummary-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-102">Initializes a new instance of the VirtualMachineScaleSetVMExtensionsSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="7fc4d-103">Der Name der Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-103">The extension name.</span></span></param>
        <param name="statusesSummary"><span data-ttu-id="7fc4d-104">Die Erweiterungsinformationen.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-104">The extensions information.</span></span></param>
        <summary>
            <span data-ttu-id="7fc4d-105">Initialisiert eine neue Instanz der VirtualMachineScaleSetVMExtensionsSummary-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-105">Initializes a new instance of the VirtualMachineScaleSetVMExtensionsSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc4d-106">Ruft den Erweiterungsnamen.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-106">Gets the extension name.</span></span>
            </summary>
    ...
    <Member MemberName="StatusesSummary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc4d-107">Ruft die Erweiterungsinformationen ab.</span><span class="sxs-lookup"><span data-stu-id="7fc4d-107">Gets the extensions information.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
