<Type Name="VirtualMachineStatusCodeCount" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineStatusCodeCount">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="54371-101">Der Statuscode und die Anzahl der VM-Skalierungsgruppe festgelegt Status der Instanz anzeigen Zusammenfassung.</span><span class="sxs-lookup"><span data-stu-id="54371-101">The status code and count of the virtual machine scale set instance view status summary.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="54371-102">Initialisiert eine neue Instanz der VirtualMachineStatusCodeCount-Klasse.</span><span class="sxs-lookup"><span data-stu-id="54371-102">Initializes a new instance of the VirtualMachineStatusCodeCount class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code"><span data-ttu-id="54371-103">Der Statuscode des Instanz anzeigen.</span><span class="sxs-lookup"><span data-stu-id="54371-103">The instance view status code.</span></span></param>
        <param name="count"><span data-ttu-id="54371-104">Die Anzahl der Instanzen, die über einen bestimmten Status-Code verfügen.</span><span class="sxs-lookup"><span data-stu-id="54371-104">The number of instances having a particular status code.</span></span></param>
        <summary>
            <span data-ttu-id="54371-105">Initialisiert eine neue Instanz der VirtualMachineStatusCodeCount-Klasse.</span><span class="sxs-lookup"><span data-stu-id="54371-105">Initializes a new instance of the VirtualMachineStatusCodeCount class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="54371-106">Ruft den Statuscode der Instanz anzeigen.</span><span class="sxs-lookup"><span data-stu-id="54371-106">Gets the instance view status code.</span></span>
            </summary>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="54371-107">Ruft die Anzahl der Instanzen, die über einen bestimmten Status-Code verfügen.</span><span class="sxs-lookup"><span data-stu-id="54371-107">Gets the number of instances having a particular status code.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
