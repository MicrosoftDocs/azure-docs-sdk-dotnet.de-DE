<Type Name="ManagedDiskParametersInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ManagedDiskParametersInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cb44f-101">Die Parameter eines verwalteten Datenträgers.</span><span class="sxs-lookup"><span data-stu-id="cb44f-101">The parameters of a managed disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb44f-102">Initialisiert eine neue Instanz der ManagedDiskParametersInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cb44f-102">Initializes a new instance of the ManagedDiskParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="storageAccountType"><span data-ttu-id="cb44f-103">Der Typ des Speicherkontos.</span><span class="sxs-lookup"><span data-stu-id="cb44f-103">The Storage Account type.</span></span> <span data-ttu-id="cb44f-104">Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""</span><span class="sxs-lookup"><span data-stu-id="cb44f-104">Possible values include: 'Standard_LRS', 'Premium_LRS'</span></span></param>
        <summary>
            <span data-ttu-id="cb44f-105">Initialisiert eine neue Instanz der ManagedDiskParametersInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cb44f-105">Initializes a new instance of the ManagedDiskParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="StorageAccountType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cb44f-106">Ruft ab oder legt die Speicherkonto-Typ.</span><span class="sxs-lookup"><span data-stu-id="cb44f-106">Gets or sets the Storage Account type.</span></span> <span data-ttu-id="cb44f-107">Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""</span><span class="sxs-lookup"><span data-stu-id="cb44f-107">Possible values include: 'Standard_LRS', 'Premium_LRS'</span></span>
            </summary>
