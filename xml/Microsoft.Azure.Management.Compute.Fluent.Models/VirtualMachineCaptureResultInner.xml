<Type Name="VirtualMachineCaptureResultInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineCaptureResultInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cc4a8-101">Ressourcen-Id.</span><span class="sxs-lookup"><span data-stu-id="cc4a8-101">Resource Id.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc4a8-102">Initialisiert eine neue Instanz der VirtualMachineCaptureResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cc4a8-102">Initializes a new instance of the VirtualMachineCaptureResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="output"><span data-ttu-id="cc4a8-103">Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="cc4a8-103">Operation output data (raw JSON)</span></span></param>
        <summary>
            <span data-ttu-id="cc4a8-104">Initialisiert eine neue Instanz der VirtualMachineCaptureResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cc4a8-104">Initializes a new instance of the VirtualMachineCaptureResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Output">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc4a8-105">Ruft ab oder legt ihn fest Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="cc4a8-105">Gets or sets operation output data (raw JSON)</span></span>
            </summary>
