<Type Name="GrantAccessDataInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.GrantAccessDataInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2e387-101">Daten, die für die Anforderung eine SAS.</span><span class="sxs-lookup"><span data-stu-id="2e387-101">Data used for requesting a SAS.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e387-102">Initialisiert eine neue Instanz der GrantAccessDataInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2e387-102">Initializes a new instance of the GrantAccessDataInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="access"><span data-ttu-id="2e387-103">Folgende Werte sind möglich: 'None', 'Read'</span><span class="sxs-lookup"><span data-stu-id="2e387-103">Possible values include: 'None', 'Read'</span></span></param>
        <param name="durationInSeconds"><span data-ttu-id="2e387-104">Die Zeitdauer in Sekunden, bis der SAS-Zugriff läuft ab.</span><span class="sxs-lookup"><span data-stu-id="2e387-104">Time duration in seconds until the SAS access expires.</span></span></param>
        <summary>
            <span data-ttu-id="2e387-105">Initialisiert eine neue Instanz der GrantAccessDataInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2e387-105">Initializes a new instance of the GrantAccessDataInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Access">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e387-106">Ruft ab oder legt folgende Werte möglich sind: 'None', 'Read'</span><span class="sxs-lookup"><span data-stu-id="2e387-106">Gets or sets possible values include: 'None', 'Read'</span></span>
            </summary>
    ...
    <Member MemberName="DurationInSeconds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e387-107">Ruft ab oder legt die Dauer in Sekunden bis zum Ablauf des SAS-Zugriffs fest.</span><span class="sxs-lookup"><span data-stu-id="2e387-107">Gets or sets time duration in seconds until the SAS access expires.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e387-108">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="2e387-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="2e387-109">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="2e387-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
