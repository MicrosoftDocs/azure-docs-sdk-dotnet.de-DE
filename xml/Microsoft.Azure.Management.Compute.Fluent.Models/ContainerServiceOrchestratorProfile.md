<Type Name="ContainerServiceOrchestratorProfile" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ContainerServiceOrchestratorProfile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c0f46-101">Profil für den Container-Orchestrator-Dienst.</span><span class="sxs-lookup"><span data-stu-id="c0f46-101">Profile for the container service orchestrator.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0f46-102">Initialisiert eine neue Instanz der ContainerServiceOrchestratorProfile-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c0f46-102">Initializes a new instance of the ContainerServiceOrchestratorProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="OrchestratorType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0f46-103">Abrufen oder Festlegen der Orchestrator zum Verwalten von Clusterressourcen für Container-Dienst.</span><span class="sxs-lookup"><span data-stu-id="c0f46-103">Gets or sets the orchestrator to use to manage container service cluster resources.</span></span> <span data-ttu-id="c0f46-104">Gültige Werte sind Punktschwarms, DCOS und Benutzerdefiniert.</span><span class="sxs-lookup"><span data-stu-id="c0f46-104">Valid values are Swarm, DCOS, and Custom.</span></span>
            <span data-ttu-id="c0f46-105">Folgende Werte sind möglich: "Containerhostclustern", "DCOS", "Benutzerdefiniert", "Kubernetes"</span><span class="sxs-lookup"><span data-stu-id="c0f46-105">Possible values include: 'Swarm', 'DCOS', 'Custom', 'Kubernetes'</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0f46-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="c0f46-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="c0f46-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="c0f46-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
