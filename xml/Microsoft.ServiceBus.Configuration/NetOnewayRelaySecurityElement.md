<Type Name="NetOnewayRelaySecurityElement" FullName="Microsoft.ServiceBus.Configuration.NetOnewayRelaySecurityElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="e72de-101">Definiert die Sicherheitseinstellungen für die <see cref="T:System.ServiceModel.NetTcpBinding" /> binden in eine Datei "App.config".</span><span class="sxs-lookup"><span data-stu-id="e72de-101">Defines the security settings for the <see cref="T:System.ServiceModel.NetTcpBinding" /> binding in an App.config file.</span></span> <span data-ttu-id="e72de-102">Diese Klasse kann nicht vererbt werden.</span><span class="sxs-lookup"><span data-stu-id="e72de-102">This class cannot be inherited.</span></span></summary>
  ...
  <Members>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary><span data-ttu-id="e72de-103">Ruft die Sicherheitseinstellungen für die Meldung ab.</span><span class="sxs-lookup"><span data-stu-id="e72de-103">Gets the security settings for the message.</span></span></summary>
        <value><span data-ttu-id="e72de-104">Gibt eine <see cref="T:Microsoft.ServiceBus.Configuration.MessageSecurityOverRelayOnewayElement" /> , die die Nachricht enthält.</span><span class="sxs-lookup"><span data-stu-id="e72de-104">Returns a <see cref="T:Microsoft.ServiceBus.Configuration.MessageSecurityOverRelayOnewayElement" /> that contains the message.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary><span data-ttu-id="e72de-105">Ruft den angewendeten Sicherheitstyp ab oder legt ihn fest.</span><span class="sxs-lookup"><span data-stu-id="e72de-105">Gets or sets the type of security that is applied.</span></span></summary>
        <value><span data-ttu-id="e72de-106">Gibt eine <see cref="T:Microsoft.ServiceBus.EndToEndSecurityMode" /> Instanz, die den Sicherheitsmodus enthält.</span><span class="sxs-lookup"><span data-stu-id="e72de-106">Returns an <see cref="T:Microsoft.ServiceBus.EndToEndSecurityMode" /> instance that contains the security mode.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RelayClientAuthenticationType">
      ...
      <Docs>
        <summary><span data-ttu-id="e72de-107">Ruft einen Wert, der beschreibt, ob Clients eines Diensts erforderlich, um beim Senden von Nachrichten an den Azure Service Bus-Dienst von Azure Service Bus-Dienst ausgestelltes Sicherheitstoken vorhanden sind.</span><span class="sxs-lookup"><span data-stu-id="e72de-107">Gets a value that describes whether clients of a service are required to present a security token issued by the Azure Service Bus service to the Azure Service Bus service when sending messages.</span></span></summary>
        <value><span data-ttu-id="e72de-108">Gibt eine <see cref="T:Microsoft.ServiceBus.RelayClientAuthenticationType" /> , enthält die relayclient-Authentifizierungstyp.</span><span class="sxs-lookup"><span data-stu-id="e72de-108">Returns a <see cref="T:Microsoft.ServiceBus.RelayClientAuthenticationType" /> that contains the relay client authentication type.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Transport">
      ...
      <Docs>
        <summary><span data-ttu-id="e72de-109">Ruft die Sicherheitseinstellungen für den Transport ab.</span><span class="sxs-lookup"><span data-stu-id="e72de-109">Gets the security settings for the transport.</span></span></summary>
        <value><span data-ttu-id="e72de-110">Gibt eine <see cref="T:Microsoft.ServiceBus.Configuration.RelayedOnewayTransportSecurityElement" /> , das die Sicherheitseinstellungen enthält.</span><span class="sxs-lookup"><span data-stu-id="e72de-110">Returns a <see cref="T:Microsoft.ServiceBus.Configuration.RelayedOnewayTransportSecurityElement" /> that contains the security settings.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
