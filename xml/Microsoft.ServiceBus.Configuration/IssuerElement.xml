<Type Name="IssuerElement" FullName="Microsoft.ServiceBus.Configuration.IssuerElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="5156a-101">Ein Konfigurationselement, das einen Aussteller eines Tokens für den Azure-Servicebus beschreibt.</span><span class="sxs-lookup"><span data-stu-id="5156a-101">A configuration element that describes an issuer of a token for the Azure Service Bus.</span></span></summary>
  ...
  <Members>
    <Member MemberName="Address">
      ...
      <Docs>
        <summary><span data-ttu-id="5156a-102">Ruft ab oder legt die URI-Adresse des Tokenausstellers.</span><span class="sxs-lookup"><span data-stu-id="5156a-102">Gets or sets the URI address of the token issuer.</span></span></summary>
        <value><span data-ttu-id="5156a-103">Die URI-Adresse des Tokenausstellers.</span><span class="sxs-lookup"><span data-stu-id="5156a-103">The URI address of the token issuer.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="from"> <span data-ttu-id="5156a-104">Das Konfigurationselement zum Kopieren der Inhalte aus.</span><span class="sxs-lookup"><span data-stu-id="5156a-104">The configuration element to copy the contents from.</span></span></param>
        <summary><span data-ttu-id="5156a-105">Kopiert den Inhalt des angegebenen Konfigurationselements in dieses Konfigurationselement.</span><span class="sxs-lookup"><span data-stu-id="5156a-105">Copies the contents of the specified configuration element to this configuration element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary><span data-ttu-id="5156a-106">Ruft die Auflistung der in diesem Konfigurationselement enthaltenen Eigenschaften ab.</span><span class="sxs-lookup"><span data-stu-id="5156a-106">Gets the collection of properties contained in this configuration element.</span></span></summary>
        <value><span data-ttu-id="5156a-107">Die Auflistung der in diesem Konfigurationselement enthaltenen Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="5156a-107">The collection of properties contained in this configuration element.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
