<Type Name="TransportClientEndpointBehaviorElement" FullName="Microsoft.ServiceBus.Configuration.TransportClientEndpointBehaviorElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="74f78-101">Stellt ein Konfigurationselement, das Verhalten eines Dienst- oder Client-Endpunkts für einen Transport für die Azure Service Bus-Relay angibt.</span><span class="sxs-lookup"><span data-stu-id="74f78-101">Represents a configuration element that specifies the behavior of a service or client endpoint for a transport on the Azure Service Bus relay.</span></span></summary>
  ...
  <Members>
    ...
    <Member MemberName="BehaviorType">
      ...
      <Docs>
        <summary><span data-ttu-id="74f78-102">Ruft ab, oder legt ihn fest das Verhalten für den Clientendpunkt Transport.</span><span class="sxs-lookup"><span data-stu-id="74f78-102">Gets or sets the behavior type for the transport client endpoint.</span></span></summary>
        <value><span data-ttu-id="74f78-103">Der Verhaltenstyp für den Clientendpunkt Transport.</span><span class="sxs-lookup"><span data-stu-id="74f78-103">The behavior type for the transport client endpoint.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="from"> <span data-ttu-id="74f78-104">Das Konfigurationselement zum Kopieren der Inhalte aus.</span><span class="sxs-lookup"><span data-stu-id="74f78-104">The configuration element to copy the contents from.</span></span></param>
        <summary><span data-ttu-id="74f78-105">Kopiert den Inhalt des angegebenen Konfigurationselements in dieses Konfigurationselement.</span><span class="sxs-lookup"><span data-stu-id="74f78-105">Copies the contents of the specified configuration element to this configuration element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateBehavior">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="74f78-106">Gibt eine neue <see cref="T:Microsoft.ServiceBus.TransportClientEndpointBehavior" /> Objekt mit den gleichen Einstellungen wie dieses Konfigurationselement.</span><span class="sxs-lookup"><span data-stu-id="74f78-106">Returns a new <see cref="T:Microsoft.ServiceBus.TransportClientEndpointBehavior" /> object with the same settings as this configuration element.</span></span></summary>
        <returns><span data-ttu-id="74f78-107">Ein neues <see cref="T:Microsoft.ServiceBus.TransportClientEndpointBehavior" /> Objekt mit den gleichen Einstellungen wie dieses Konfigurationselement.</span><span class="sxs-lookup"><span data-stu-id="74f78-107">A new <see cref="T:Microsoft.ServiceBus.TransportClientEndpointBehavior" /> object with the same settings as this configuration element.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary><span data-ttu-id="74f78-108">Ruft die Auflistung der in diesem Konfigurationselement enthaltenen Eigenschaften ab.</span><span class="sxs-lookup"><span data-stu-id="74f78-108">Gets the collection of properties contained in this configuration element.</span></span></summary>
        <value><span data-ttu-id="74f78-109">Die Auflistung der in diesem Konfigurationselement enthaltenen Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="74f78-109">The collection of properties contained in this configuration element.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TokenProvider">
      ...
      <Docs>
        <summary><span data-ttu-id="74f78-110">Ruft ab oder legt den Tokenanbieter, der als Bindungsparameter verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="74f78-110">Gets or sets the token provider that is used as a binding parameter.</span></span></summary>
        <value><span data-ttu-id="74f78-111">Der Tokenanbieter, der als Bindungsparameter verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="74f78-111">The token provider used as a binding parameter.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
