<Type Name="AddressConfigurationElementCollection" FullName="Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection">
  ...
  <Docs>
    <summary><span data-ttu-id="e4aa6-101">Stellt eine Auflistung von Elementen in Adresskonfiguration.</span><span class="sxs-lookup"><span data-stu-id="e4aa6-101">Represents a collection of elements in address configuration.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="e4aa6-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e4aa6-102">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Addresses">
      ...
      <Docs>
        <summary><span data-ttu-id="e4aa6-103">Ruft die Adressen der Elemente in der Auflistung ab.</span><span class="sxs-lookup"><span data-stu-id="e4aa6-103">Gets the addresses of the elements in the collection.</span></span></summary>
        <value><span data-ttu-id="e4aa6-104">Die Adressen der Elemente in der Auflistung.</span><span class="sxs-lookup"><span data-stu-id="e4aa6-104">The addresses of the elements in the collection.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
