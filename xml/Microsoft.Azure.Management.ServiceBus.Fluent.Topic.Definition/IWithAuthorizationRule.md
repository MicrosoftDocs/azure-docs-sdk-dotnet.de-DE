<Type Name="IWithAuthorizationRule" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IWithAuthorizationRule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="233ab-101">Die Phase der themadefinition ermöglicht eine Autorisierungsregel für den Zugriff auf das Thema hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="233ab-101">The stage of the topic definition allowing to add an authorization rule for accessing the topic.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithNewListenRule">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="233ab-102">Name der Regel.</span><span class="sxs-lookup"><span data-stu-id="233ab-102">Rule name.</span></span></param>
        <summary>
            <span data-ttu-id="233ab-103">Erstellt eine Autorisierungsregel Lauschen für das Thema an.</span><span class="sxs-lookup"><span data-stu-id="233ab-103">Creates a listen authorization rule for the topic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="233ab-104">Nächste Stufe der themadefinition.</span><span class="sxs-lookup"><span data-stu-id="233ab-104">Next stage of the topic definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithNewManageRule">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="233ab-105">Name der Regel.</span><span class="sxs-lookup"><span data-stu-id="233ab-105">Rule name.</span></span></param>
        <summary>
            <span data-ttu-id="233ab-106">Erstellt eine Autorisierungsregel verwalten für das Thema an.</span><span class="sxs-lookup"><span data-stu-id="233ab-106">Creates a manage authorization rule for the topic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="233ab-107">Nächste Stufe der themadefinition.</span><span class="sxs-lookup"><span data-stu-id="233ab-107">Next stage of the topic definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithNewSendRule">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="233ab-108">Name der Regel.</span><span class="sxs-lookup"><span data-stu-id="233ab-108">Rule name.</span></span></param>
        <summary>
            <span data-ttu-id="233ab-109">Erstellt eine senden-Autorisierungsregel für das Thema an.</span><span class="sxs-lookup"><span data-stu-id="233ab-109">Creates a send authorization rule for the topic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="233ab-110">Nächste Stufe der themadefinition.</span><span class="sxs-lookup"><span data-stu-id="233ab-110">Next stage of the topic definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>