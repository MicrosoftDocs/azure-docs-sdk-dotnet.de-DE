<Type Name="SingleChunkStatus" FullName="Microsoft.Azure.DataLake.Store.FileTransfer.SingleChunkStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2aade-101">Status des eine Übertragung der einzelnen Eintrag</span><span class="sxs-lookup"><span data-stu-id="2aade-101">Status of a transfer of single entry</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2aade-102">Fehler beim Übertragen der</span><span class="sxs-lookup"><span data-stu-id="2aade-102">Transfer failed</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Skipped">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2aade-103">Wenn die Zieldatei vorhanden ist und der Benutzer ausgewählt hat, fehlschlagen, wenn das Ziel vorhanden ist dann sie übersprungen.</span><span class="sxs-lookup"><span data-stu-id="2aade-103">If the destination file exists and the user has selected to fail if the destination exists then it is skipped</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Successful">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2aade-104">Übertragung ist erfolgreich.</span><span class="sxs-lookup"><span data-stu-id="2aade-104">Transfer is successful</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
