<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetExtension.UpdateDefinition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="ba1a1-101">Die Phase des übergeordneten Updates wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="ba1a1-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="ba1a1-102">Legen Sie die erste Phase der VM-Skalierungsgruppe ressourcenerweiterungsdefinition.</span><span class="sxs-lookup"><span data-stu-id="ba1a1-102">The first stage of a virtual machine scale set extension definition.</span></span>
            </summary>
