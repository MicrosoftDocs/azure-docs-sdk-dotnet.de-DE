<Type Name="SecurityToken" FullName="Microsoft.Azure.EventHubs.SecurityToken">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="56760-101">Enthält Informationen zu der ein Sicherheitstoken, z. B. Zielgruppe, Ablaufzeit und die token-Zeichenfolgenwert.</span><span class="sxs-lookup"><span data-stu-id="56760-101">Provides information about a security token such as audience, expiry time, and the string token value.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tokenString"><span data-ttu-id="56760-102">Das token</span><span class="sxs-lookup"><span data-stu-id="56760-102">The token</span></span></param>
        <param name="expiresAtUtc"><span data-ttu-id="56760-103">Die Ablaufzeit</span><span class="sxs-lookup"><span data-stu-id="56760-103">The expiration time</span></span></param>
        <param name="audience"><span data-ttu-id="56760-104">Die Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="56760-104">The audience</span></span></param>
        <param name="tokenType"><span data-ttu-id="56760-105">Der Typ des Tokens</span><span class="sxs-lookup"><span data-stu-id="56760-105">The type of the token</span></span></param>
        <summary>
            <span data-ttu-id="56760-106">Erstellt eine neue Instanz der <see cref="T:Microsoft.Azure.EventHubs.SecurityToken" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="56760-106">Creates a new instance of the <see cref="T:Microsoft.Azure.EventHubs.SecurityToken" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Audience">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="56760-107">Ruft die Zielgruppe dieses Tokens ab.</span><span class="sxs-lookup"><span data-stu-id="56760-107">Gets the audience of this token.</span></span>
            </summary>
    ...
    <Member MemberName="ExpiresAtUtc">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="56760-108">Ruft die Ablaufzeit dieses Tokens ab.</span><span class="sxs-lookup"><span data-stu-id="56760-108">Gets the expiration time of this token.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TokenType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="56760-109">Ruft den Typ des Sicherheitstokens ab.</span><span class="sxs-lookup"><span data-stu-id="56760-109">Gets the token type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TokenValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="56760-110">Ruft die tatsächliche Token ab.</span><span class="sxs-lookup"><span data-stu-id="56760-110">Gets the actual token.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
