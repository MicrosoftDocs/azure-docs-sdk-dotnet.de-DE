<Type Name="ReceiverOptions" FullName="Microsoft.Azure.EventHubs.ReceiverOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ad491-101">Stellt Optionen können während der Erstellung einer Hub-Ereignisempfänger festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="ad491-101">Represents options can be set during the creation of a event hub receiver.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="EnableReceiverRuntimeMetric">
      ...
      <Docs>
        <summary> <span data-ttu-id="ad491-102">Ruft ab oder legt einen Wert, der angibt, ob der Empfänger die Common Language Runtime-Metrik aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="ad491-102">Gets or sets a value indicating whether the runtime metric of a receiver is enabled.</span></span> </summary>
        <value> <span data-ttu-id="ad491-103">"true", wenn ein Client zugreifen möchte <see cref="T:Microsoft.Azure.EventHubs.ReceiverRuntimeInformation" /> mit <see cref="T:Microsoft.Azure.EventHubs.PartitionReceiver" />.</span><span class="sxs-lookup"><span data-stu-id="ad491-103">true if a client wants to access <see cref="T:Microsoft.Azure.EventHubs.ReceiverRuntimeInformation" /> using <see cref="T:Microsoft.Azure.EventHubs.PartitionReceiver" />.</span></span> </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
