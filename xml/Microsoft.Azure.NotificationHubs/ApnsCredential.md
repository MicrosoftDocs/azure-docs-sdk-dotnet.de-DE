<Type Name="ApnsCredential" FullName="Microsoft.Azure.NotificationHubs.ApnsCredential">
  ...
  <Docs>
    <summary><span data-ttu-id="0cc19-101">Stellt eine Apple Push Notification Service (APNS)-Anmeldeinformationen dar.</span><span class="sxs-lookup"><span data-stu-id="0cc19-101">Represents an Apple Push Notification Service (APNS) credential.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="0cc19-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0cc19-102">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="certificateBuffer"><span data-ttu-id="0cc19-103">Der Zertifikat-Puffer.</span><span class="sxs-lookup"><span data-stu-id="0cc19-103">The certificate buffer.</span></span></param>
        <param name="certificateKey"><span data-ttu-id="0cc19-104">Der zertifizierte Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="0cc19-104">The certificated key.</span></span></param>
        <summary><span data-ttu-id="0cc19-105">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0cc19-105">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="certificatePath"><span data-ttu-id="0cc19-106">Der Pfad des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="0cc19-106">The certificate path.</span></span></param>
        <param name="certificateKey"><span data-ttu-id="0cc19-107">Der Schlüssel des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="0cc19-107">The certificate key.</span></span></param>
        <summary><span data-ttu-id="0cc19-108">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0cc19-108">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.ApnsCredential" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ApnsCertificate">
      ...
      <Docs>
        <summary><span data-ttu-id="0cc19-109">Ruft ab oder legt das APNs-Zertifikat.</span><span class="sxs-lookup"><span data-stu-id="0cc19-109">Gets or sets the APNS certificate.</span></span></summary>
        <value><span data-ttu-id="0cc19-110">Das APNs-Zertifikat.</span><span class="sxs-lookup"><span data-stu-id="0cc19-110">The APNS certificate.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CertificateKey">
      ...
      <Docs>
        <summary><span data-ttu-id="0cc19-111">Ruft ab oder legt den Schlüssel des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="0cc19-111">Gets or sets the certificate key.</span></span></summary>
        <value><span data-ttu-id="0cc19-112">Der Schlüssel des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="0cc19-112">The certificate key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary><span data-ttu-id="0cc19-113">Abrufen / definieren den Endpunkt, der diese Anmeldeinformationen.</span><span class="sxs-lookup"><span data-stu-id="0cc19-113">Gets or sets the endpoint of this credential.</span></span></summary>
        <value><span data-ttu-id="0cc19-114">Der Endpunkt, der diese Anmeldeinformationen werden soll.</span><span class="sxs-lookup"><span data-stu-id="0cc19-114">The endpoint of this credential.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Equals">
      ...
      <Docs>
        <param name="other"><span data-ttu-id="0cc19-115">Die andere zu vergleichende Objekt.</span><span class="sxs-lookup"><span data-stu-id="0cc19-115">The other object to compare.</span></span></param>
        <summary><span data-ttu-id="0cc19-116">Gibt an, ob die Anmeldeinformationen, die das jeweilige Objekt identisch ist.</span><span class="sxs-lookup"><span data-stu-id="0cc19-116">Specifies whether the credential is the same as the specific object.</span></span></summary>
        <returns><span data-ttu-id="0cc19-117">"true", wenn die Anmeldeinformationen, die das jeweilige Objekt identisch sind; andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="0cc19-117">true if the credential is the same as the specific object; otherwise, false.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetHashCode">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="0cc19-118">Ruft den Hashcode für die Anmeldeinformationen ab.</span><span class="sxs-lookup"><span data-stu-id="0cc19-118">Retrieves the hash code for the credentials.</span></span></summary>
        <returns><span data-ttu-id="0cc19-119">Der Hashcode für die Anmeldeinformationen.</span><span class="sxs-lookup"><span data-stu-id="0cc19-119">The hash code for the credentials.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnValidate">
      ...
      <Docs>
        <param name="allowLocalMockPns"><span data-ttu-id="0cc19-120">"true", um lokale simulierten PNS zu ermöglichen; andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="0cc19-120">true to allow local mock PNS; otherwise, false.</span></span></param>
        <summary><span data-ttu-id="0cc19-121">Überprüft die APNs-Anmeldeinformationen an.</span><span class="sxs-lookup"><span data-stu-id="0cc19-121">Validates the APNS credential.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
