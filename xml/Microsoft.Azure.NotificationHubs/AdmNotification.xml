<Type Name="AdmNotification" FullName="Microsoft.Azure.NotificationHubs.AdmNotification">
  ...
  <Docs>
    <summary><span data-ttu-id="334b8-101">Stellt die Benachrichtigung Amazon Device Messaging (ADM) dar.</span><span class="sxs-lookup"><span data-stu-id="334b8-101">Represents the Amazon Device Messaging (ADM) notification.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="jsonPayload"><span data-ttu-id="334b8-102">Die JSON-Nutzlast.</span><span class="sxs-lookup"><span data-stu-id="334b8-102">The JSON payload.</span></span></param>
        <summary><span data-ttu-id="334b8-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.AdmNotification" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="334b8-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.AdmNotification" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnValidateAndPopulateHeaders">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="334b8-104">Überprüfen und füllt die Header.</span><span class="sxs-lookup"><span data-stu-id="334b8-104">Validate and populates the headers.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PlatformType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="334b8-105">Ruft den Typ der Plattform ab.</span><span class="sxs-lookup"><span data-stu-id="334b8-105">Gets the type of the platform.</span></span>
            </summary>
        <value>
            <span data-ttu-id="334b8-106">Der Typ der Plattform.</span><span class="sxs-lookup"><span data-stu-id="334b8-106">The type of the platform.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
