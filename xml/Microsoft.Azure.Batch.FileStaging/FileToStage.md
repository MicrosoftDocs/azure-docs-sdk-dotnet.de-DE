<Type Name="FileToStage" FullName="Microsoft.Azure.Batch.FileStaging.FileToStage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dacf2-101">Für das Staging der Datei einer lokalen Datei in den blobspeicher bietet.</span><span class="sxs-lookup"><span data-stu-id="dacf2-101">Provides for file staging of a local file to blob storage.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="localFileToStage"><span data-ttu-id="dacf2-102">Der Name der lokalen Datei.</span><span class="sxs-lookup"><span data-stu-id="dacf2-102">The name of the local file.</span></span></param>
        <param name="storageCredentials"><span data-ttu-id="dacf2-103">Die speicheranmeldeinformationen, die beim Erstellen des Standardcontainers verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="dacf2-103">The storage credentials to be used when creating the default container.</span></span></param>
        <param name="nodeFileName"><span data-ttu-id="dacf2-104">Optionale Name, der für die Datei auf den Computeknoten gewährt werden.</span><span class="sxs-lookup"><span data-stu-id="dacf2-104">Optional name to be given to the file on the compute node.</span></span>  <span data-ttu-id="dacf2-105">Wenn dieser Parameter null ist oder fehlt der Name auf den Computeknoten auf den Wert der von allen Pfadinformationen befreite LocalFileToStage festgelegt werden werden.</span><span class="sxs-lookup"><span data-stu-id="dacf2-105">If this parameter is null or missing the name on the compute node will be set to the value of localFileToStage stripped of all path information.</span></span></param>
        <summary>
            <span data-ttu-id="dacf2-106">Gibt an, dass eine lokale Datei für den blob-Speicher bereitgestellt werden soll.</span><span class="sxs-lookup"><span data-stu-id="dacf2-106">Specifies that a local file should be staged to blob storage.</span></span>  
            <span data-ttu-id="dacf2-107">Das angegebene Konto wird Speicherkosten in Rechnung gestellt.</span><span class="sxs-lookup"><span data-stu-id="dacf2-107">The specified account will be charged for storage costs.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateStagingArtifact">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-108">Weitere Informationen finden Sie unter <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.CreateStagingArtifact" />.</span><span class="sxs-lookup"><span data-stu-id="dacf2-108">See <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.CreateStagingArtifact" />.</span></span>
            </summary>
        <returns><span data-ttu-id="dacf2-109">Eine Instanz des IFileStagingArtifact mit Standardwerten.</span><span class="sxs-lookup"><span data-stu-id="dacf2-109">An instance of IFileStagingArtifact with default values.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Exception">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-110">Die Ausnahme abgefangen ggf. beim Versuch, diese Datei Stufe an.</span><span class="sxs-lookup"><span data-stu-id="dacf2-110">The exception, if any, caught while attempting to stage this file.</span></span>
            </summary>
    ...
    <Member MemberName="LocalFileToStage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-111">Der Name der lokalen Datei, Phase, um Blob-Speicher</span><span class="sxs-lookup"><span data-stu-id="dacf2-111">The name of the local file to stage to blob storage</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NodeFileName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-112">Der Dateiname Ziel auf den Serverknoten, den den Blob-Inhalt heruntergeladen werden.</span><span class="sxs-lookup"><span data-stu-id="dacf2-112">The target filename, on the compute node, to which the blob contents will be downloaded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StagedFiles">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-113">Die Instanzen von ResourcesFile angegebene Dateiname für die bereitgestellten lokalen Datei.</span><span class="sxs-lookup"><span data-stu-id="dacf2-113">The instances of ResourcesFile for the staged local file.</span></span>
            <span data-ttu-id="dacf2-114">Für diese Implementierung führt eine Sammlung mit nur ein Eintrag erfolgreich Datei Staging dieses Objekts.</span><span class="sxs-lookup"><span data-stu-id="dacf2-114">For this implementation, successful file staging of this object will result in a collection with only one entry.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StageFilesAsync">
      ...
      <Docs>
        <param name="filesToStage"><span data-ttu-id="dacf2-115">Die Instanzen der IFileStagingProvider Phase.</span><span class="sxs-lookup"><span data-stu-id="dacf2-115">The instances of IFileStagingProvider to stage.</span></span></param>
        <param name="fileStagingArtifact"><span data-ttu-id="dacf2-116">IFileStagingProvider bestimmte staging-Artefakte, einschließlich Fehler/ausgeführt.</span><span class="sxs-lookup"><span data-stu-id="dacf2-116">IFileStagingProvider specific staging artifacts including error/progress.</span></span></param>
        <summary>
            <span data-ttu-id="dacf2-117">Weitere Informationen finden Sie unter <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.StageFilesAsync(System.Collections.Generic.List{Microsoft.Azure.Batch.FileStaging.IFileStagingProvider},Microsoft.Azure.Batch.IFileStagingArtifact)" />.</span><span class="sxs-lookup"><span data-stu-id="dacf2-117">See <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.StageFilesAsync(System.Collections.Generic.List{Microsoft.Azure.Batch.FileStaging.IFileStagingProvider},Microsoft.Azure.Batch.IFileStagingArtifact)" />.</span></span>
            </summary>
        <returns><span data-ttu-id="dacf2-118">Ein <see cref="T:System.Threading.Tasks.Task" />-Objekt, das den asynchronen Vorgang darstellt.</span><span class="sxs-lookup"><span data-stu-id="dacf2-118">A <see cref="T:System.Threading.Tasks.Task" /> object that represents the asynchronous operation.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dacf2-119">Weitere Informationen finden Sie unter <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.Validate" />.</span><span class="sxs-lookup"><span data-stu-id="dacf2-119">See <see cref="M:Microsoft.Azure.Batch.FileStaging.IFileStagingProvider.Validate" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
