<Type Name="FileGetPropertiesFromComputeNodeHeaders" FullName="Microsoft.Azure.Batch.Protocol.Models.FileGetPropertiesFromComputeNodeHeaders">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="19d8c-101">Definiert die Header für GetPropertiesFromComputeNode-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="19d8c-101">Defines headers for GetPropertiesFromComputeNode operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-102">Initialisiert eine neue Instanz der FileGetPropertiesFromComputeNodeHeaders-Klasse.</span><span class="sxs-lookup"><span data-stu-id="19d8c-102">Initializes a new instance of the FileGetPropertiesFromComputeNodeHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      <MemberSignature Language="C#" Value="public FileGetPropertiesFromComputeNodeHeaders (Nullable&lt;Guid&gt; clientRequestId = null, Nullable&lt;Guid&gt; requestId = null, string eTag = null, Nullable&lt;DateTime&gt; lastModified = null, Nullable&lt;DateTime&gt; ocpCreationTime = null, Nullable&lt;bool&gt; ocpBatchFileIsdirectory = null, string ocpBatchFileUrl = null, string ocpBatchFileMode = null, string contentType = null, Nullable&lt;long&gt; contentLength = null);" />
      ...
      <Docs>
        <param name="clientRequestId"><span data-ttu-id="19d8c-103">Die Client-Request-Id vom Client bereitgestellt wird, während der Anforderung.</span><span class="sxs-lookup"><span data-stu-id="19d8c-103">The client-request-id provided by the client during the request.</span></span> <span data-ttu-id="19d8c-104">Dies wird zurückgegeben, nur, wenn die Return-Client-Request-Id-Parameter festgelegt auf "true".</span><span class="sxs-lookup"><span data-stu-id="19d8c-104">This will be returned only if the return-client-request-id parameter was set to true.</span></span></param>
        <param name="requestId"><span data-ttu-id="19d8c-105">Ein eindeutiger Bezeichner für die Anforderung, die an der Batch-Dienst vorgenommen wurde.</span><span class="sxs-lookup"><span data-stu-id="19d8c-105">A unique identifier for the request that was made to the Batch service.</span></span> <span data-ttu-id="19d8c-106">Wenn bei einer Anforderung kontinuierlich ein Fehler auftritt, obwohl die Anforderung ordnungsgemäß formuliert ist, können Sie den Fehler unter Angabe dieses Werts an Microsoft melden.</span><span class="sxs-lookup"><span data-stu-id="19d8c-106">If a request is consistently failing and you have verified that the request is properly formulated, you may use this value to report the error to Microsoft.</span></span> <span data-ttu-id="19d8c-107">Enthalten Sie in Ihrem Bericht dem Wert des diese Anforderungs-ID, die ungefähre Zeit, dass die Anforderung wurde versucht, das Batch-Konto für die die Anforderung gestellt wurde und die Region, der Konto befindet.</span><span class="sxs-lookup"><span data-stu-id="19d8c-107">In your report, include the value of this request ID, the approximate time that the request was made, the Batch account against which the request was made, and the region that account resides in.</span></span></param>
        <param name="eTag"><span data-ttu-id="19d8c-108">Der ETag-HTTP-Antwortheader.</span><span class="sxs-lookup"><span data-stu-id="19d8c-108">The ETag HTTP response header.</span></span> <span data-ttu-id="19d8c-109">Dies ist eine nicht transparente Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="19d8c-109">This is an opaque string.</span></span> <span data-ttu-id="19d8c-110">Sie können es verwenden, um zu ermitteln, ob die Ressource zwischen Anforderungen geändert hat.</span><span class="sxs-lookup"><span data-stu-id="19d8c-110">You can use it to detect whether the resource has changed between requests.</span></span> <span data-ttu-id="19d8c-111">Insbesondere können Sie das ETag in eines der If-Modified-Since, If-Unmodified-Since, If-Match- oder If-None-Match-Header übergeben.</span><span class="sxs-lookup"><span data-stu-id="19d8c-111">In particular, you can pass the ETag to one of the If-Modified-Since, If-Unmodified-Since, If-Match or If-None-Match headers.</span></span></param>
        <param name="lastModified"><span data-ttu-id="19d8c-112">Der Zeitpunkt der letzten Ressourcenänderung.</span><span class="sxs-lookup"><span data-stu-id="19d8c-112">The time at which the resource was last modified.</span></span></param>
        <param name="ocpCreationTime"><span data-ttu-id="19d8c-113">Die Erstellungszeit der Datei.</span><span class="sxs-lookup"><span data-stu-id="19d8c-113">The file creation time.</span></span></param>
        <param name="ocpBatchFileIsdirectory"><span data-ttu-id="19d8c-114">Gibt an, ob das Objekt ein Verzeichnis darstellt.</span><span class="sxs-lookup"><span data-stu-id="19d8c-114">Whether the object represents a directory.</span></span></param>
        <param name="ocpBatchFileUrl"><span data-ttu-id="19d8c-115">Die URL der Datei.</span><span class="sxs-lookup"><span data-stu-id="19d8c-115">The URL of the file.</span></span></param>
        <param name="ocpBatchFileMode"><span data-ttu-id="19d8c-116">Die Datei Mode-Attribut im Oktalformat.</span><span class="sxs-lookup"><span data-stu-id="19d8c-116">The file mode attribute in octal format.</span></span></param>
        <param name="contentType"><span data-ttu-id="19d8c-117">Der Inhaltstyp der Datei.</span><span class="sxs-lookup"><span data-stu-id="19d8c-117">The content type of the file.</span></span></param>
        <param name="contentLength"><span data-ttu-id="19d8c-118">Die Länge der Datei.</span><span class="sxs-lookup"><span data-stu-id="19d8c-118">The length of the file.</span></span></param>
        <summary>
            <span data-ttu-id="19d8c-119">Initialisiert eine neue Instanz der FileGetPropertiesFromComputeNodeHeaders-Klasse.</span><span class="sxs-lookup"><span data-stu-id="19d8c-119">Initializes a new instance of the FileGetPropertiesFromComputeNodeHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-120">Ruft ab oder legt die vom Client bei der Anforderung angegebene Client-Request-Id.</span><span class="sxs-lookup"><span data-stu-id="19d8c-120">Gets or sets the client-request-id provided by the client during the request.</span></span> <span data-ttu-id="19d8c-121">Dies wird zurückgegeben, nur, wenn die Return-Client-Request-Id-Parameter festgelegt auf "true".</span><span class="sxs-lookup"><span data-stu-id="19d8c-121">This will be returned only if the return-client-request-id parameter was set to true.</span></span>
            </summary>
    ...
    <Member MemberName="ContentLength">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-122">Ruft ab oder legt die Länge der Datei fest.</span><span class="sxs-lookup"><span data-stu-id="19d8c-122">Gets or sets the length of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ContentType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-123">Ruft ab oder legt den Inhaltstyp der Datei.</span><span class="sxs-lookup"><span data-stu-id="19d8c-123">Gets or sets the content type of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-124">Ruft ab oder legt den ETag-HTTP-Antwortheader.</span><span class="sxs-lookup"><span data-stu-id="19d8c-124">Gets or sets the ETag HTTP response header.</span></span> <span data-ttu-id="19d8c-125">Dies ist eine nicht transparente Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="19d8c-125">This is an opaque string.</span></span> <span data-ttu-id="19d8c-126">Sie können es verwenden, um zu ermitteln, ob die Ressource zwischen Anforderungen geändert hat.</span><span class="sxs-lookup"><span data-stu-id="19d8c-126">You can use it to detect whether the resource has changed between requests.</span></span> <span data-ttu-id="19d8c-127">Insbesondere können Sie das ETag in eines der If-Modified-Since, If-Unmodified-Since, If-Match- oder If-None-Match-Header übergeben.</span><span class="sxs-lookup"><span data-stu-id="19d8c-127">In particular, you can pass the ETag to one of the If-Modified-Since, If-Unmodified-Since, If-Match or If-None-Match headers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-128">Ruft ab oder legt die Zeit, zu der die Ressource zuletzt geändert wurde.</span><span class="sxs-lookup"><span data-stu-id="19d8c-128">Gets or sets the time at which the resource was last modified.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileIsdirectory">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-129">Ruft ab oder legt fest, ob das Objekt ein Verzeichnis darstellt.</span><span class="sxs-lookup"><span data-stu-id="19d8c-129">Gets or sets whether the object represents a directory.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-130">Ruft ab oder legt die Datei Mode-Attribut im Oktalformat.</span><span class="sxs-lookup"><span data-stu-id="19d8c-130">Gets or sets the file mode attribute in octal format.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-131">Ruft ab oder legt die URL der Datei fest.</span><span class="sxs-lookup"><span data-stu-id="19d8c-131">Gets or sets the URL of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpCreationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-132">Ruft ab oder legt die Dateizeit für die Erstellung.</span><span class="sxs-lookup"><span data-stu-id="19d8c-132">Gets or sets the file creation time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="19d8c-133">Ermittelt oder definiert einen eindeutigen Bezeichner für die Anforderung, die an der Batch-Dienst vorgenommen wurde.</span><span class="sxs-lookup"><span data-stu-id="19d8c-133">Gets or sets a unique identifier for the request that was made to the Batch service.</span></span> <span data-ttu-id="19d8c-134">Wenn bei einer Anforderung kontinuierlich ein Fehler auftritt, obwohl die Anforderung ordnungsgemäß formuliert ist, können Sie den Fehler unter Angabe dieses Werts an Microsoft melden.</span><span class="sxs-lookup"><span data-stu-id="19d8c-134">If a request is consistently failing and you have verified that the request is properly formulated, you may use this value to report the error to Microsoft.</span></span> <span data-ttu-id="19d8c-135">Enthalten Sie in Ihrem Bericht dem Wert des diese Anforderungs-ID, die ungefähre Zeit, dass die Anforderung wurde versucht, das Batch-Konto für die die Anforderung gestellt wurde und die Region, der Konto befindet.</span><span class="sxs-lookup"><span data-stu-id="19d8c-135">In your report, include the value of this request ID, the approximate time that the request was made, the Batch account against which the request was made, and the region that account resides in.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
