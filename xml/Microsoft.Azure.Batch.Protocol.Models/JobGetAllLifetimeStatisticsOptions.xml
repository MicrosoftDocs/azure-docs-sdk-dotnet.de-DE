<Type Name="JobGetAllLifetimeStatisticsOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.JobGetAllLifetimeStatisticsOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="11c43-101">Zusätzliche Parameter für GetAllLifetimeStatistics-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="11c43-101">Additional parameters for GetAllLifetimeStatistics operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11c43-102">Initialisiert eine neue Instanz der JobGetAllLifetimeStatisticsOptions-Klasse.</span><span class="sxs-lookup"><span data-stu-id="11c43-102">Initializes a new instance of the JobGetAllLifetimeStatisticsOptions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeout"><span data-ttu-id="11c43-103">Die maximale Zeit, die der Server verarbeitet die Anforderung in Sekunden aufwenden kann.</span><span class="sxs-lookup"><span data-stu-id="11c43-103">The maximum time that the server can spend processing the request, in seconds.</span></span> <span data-ttu-id="11c43-104">Der Standardwert ist 30 Sekunden.</span><span class="sxs-lookup"><span data-stu-id="11c43-104">The default is 30 seconds.</span></span></param>
        <param name="clientRequestId"><span data-ttu-id="11c43-105">Die vom Aufrufer generierte Anforderungsidentität in Form einer GUID ohne Dekoration wie etwa geschweifte Klammern ein, z. B. 9C4D50EE 2-d 56-CD 3-8152-34347DC9F2B0 4.</span><span class="sxs-lookup"><span data-stu-id="11c43-105">The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.</span></span></param>
        <param name="returnClientRequestId"><span data-ttu-id="11c43-106">Gibt an, ob der Server die Client-Request-Id in der Antwort zurückgeben soll.</span><span class="sxs-lookup"><span data-stu-id="11c43-106">Whether the server should return the client-request-id in the response.</span></span></param>
        <param name="ocpDate"><span data-ttu-id="11c43-107">Die Zeit, die die Anforderung ausgegeben wurde.</span><span class="sxs-lookup"><span data-stu-id="11c43-107">The time the request was issued.</span></span> <span data-ttu-id="11c43-108">Clientbibliotheken festlegen, in der Regel um die aktuelle Systemuhrzeit; Legen Sie sie explizit die REST-API direkt aufrufen.</span><span class="sxs-lookup"><span data-stu-id="11c43-108">Client libraries typically set this to the current system clock time; set it explicitly if you are calling the REST API directly.</span></span></param>
        <summary>
            <span data-ttu-id="11c43-109">Initialisiert eine neue Instanz der JobGetAllLifetimeStatisticsOptions-Klasse.</span><span class="sxs-lookup"><span data-stu-id="11c43-109">Initializes a new instance of the JobGetAllLifetimeStatisticsOptions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11c43-110">Ruft ab oder legt die vom Aufrufer generierte Anforderungsidentität in Form einer GUID ohne Dekoration wie etwa geschweifte Klammern ein, z. B. 9C4D50EE 2-d 56-CD 3-8152-34347DC9F2B0 4.</span><span class="sxs-lookup"><span data-stu-id="11c43-110">Gets or sets the caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.</span></span>
            </summary>
    ...
    <Member MemberName="OcpDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11c43-111">Ruft ab oder legt die Zeit, die die Anforderung ausgegeben wurde.</span><span class="sxs-lookup"><span data-stu-id="11c43-111">Gets or sets the time the request was issued.</span></span> <span data-ttu-id="11c43-112">Clientbibliotheken festlegen, in der Regel um die aktuelle Systemuhrzeit; Legen Sie sie explizit die REST-API direkt aufrufen.</span><span class="sxs-lookup"><span data-stu-id="11c43-112">Client libraries typically set this to the current system clock time; set it explicitly if you are calling the REST API directly.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReturnClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11c43-113">Ruft ab oder legt sie fest, ob der Server die Client-Request-Id in der Antwort zurückgeben soll.</span><span class="sxs-lookup"><span data-stu-id="11c43-113">Gets or sets whether the server should return the client-request-id in the response.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11c43-114">Ruft ab oder legt die maximale Zeit, dass der Server konsolenmeldungen Verarbeitung der Anforderung in Sekunden fest.</span><span class="sxs-lookup"><span data-stu-id="11c43-114">Gets or sets the maximum time that the server can spend processing the request, in seconds.</span></span> <span data-ttu-id="11c43-115">Der Standardwert ist 30 Sekunden.</span><span class="sxs-lookup"><span data-stu-id="11c43-115">The default is 30 seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
