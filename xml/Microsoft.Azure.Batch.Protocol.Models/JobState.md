<Type Name="JobState" FullName="Microsoft.Azure.Batch.Protocol.Models.JobState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="181f6-101">Definiert Werte für JobState an.</span><span class="sxs-lookup"><span data-stu-id="181f6-101">Defines values for JobState.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Active">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-102">Der Auftrag wird für geplante Aufgaben sind verfügbar.</span><span class="sxs-lookup"><span data-stu-id="181f6-102">The job is available to have tasks scheduled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-103">Alle Aufgaben beendet haben, und das System nimmt alle Weitere Aufgaben oder weiteren Änderungen an den Auftrag.</span><span class="sxs-lookup"><span data-stu-id="181f6-103">All tasks have terminated, and the system will not accept any more tasks or any further changes to the job.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Deleting">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-104">Ein Benutzer hat angefordert, dass der Auftrag gelöscht werden, aber der Löschvorgang ist noch in Bearbeitung (z. B. weil das System dennoch Ausführen von Aufgaben beendet wird).</span><span class="sxs-lookup"><span data-stu-id="181f6-104">A user has requested that the job be deleted, but the delete operation is still in progress (for example, because the system is still terminating running tasks).</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Disabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-105">Ein Benutzer hat den Auftrag deaktiviert.</span><span class="sxs-lookup"><span data-stu-id="181f6-105">A user has disabled the job.</span></span> <span data-ttu-id="181f6-106">Keine Aufgaben ausgeführt werden, und werden keine neue Tasks geplant werden.</span><span class="sxs-lookup"><span data-stu-id="181f6-106">No tasks are running, and no new tasks will be scheduled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Disabling">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-107">Ein Benutzer hat angefordert, dass der Auftrag deaktiviert werden, aber der Deaktivierungsvorgang ist noch in Bearbeitung (z. B. beim Warten auf die Aufgaben beendet).</span><span class="sxs-lookup"><span data-stu-id="181f6-107">A user has requested that the job be disabled, but the disable operation is still in progress (for example, waiting for tasks to terminate).</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Enabling">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-108">Ein Benutzer hat angefordert, dass der Auftrag aktiviert werden, aber der Aktivierungsvorgang ist noch nicht abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="181f6-108">A user has requested that the job be enabled, but the enable operation is still in progress.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Terminating">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="181f6-109">Der Auftrag ist zum Abschließen, weil eine Auftrags-Manager-Aufgabe abgeschlossen wurde oder der Benutzer, den Auftrag beendet wurde, aber der Vorgang "Beenden" noch in Bearbeitung wird (z. B. weil der Auftrag Version Aufgaben ausgeführt werden).</span><span class="sxs-lookup"><span data-stu-id="181f6-109">The job is about to complete, either because a Job Manager task has completed or because the user has terminated the job, but the terminate operation is still in progress (for example, because Job Release tasks are running).</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
