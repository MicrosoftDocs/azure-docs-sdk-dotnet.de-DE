<Type Name="PoolListOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.PoolListOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="88b3c-101">Zusätzliche Parameter für den List-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="88b3c-101">Additional parameters for List operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-102">Initialisiert eine neue Instanz der PoolListOptions-Klasse.</span><span class="sxs-lookup"><span data-stu-id="88b3c-102">Initializes a new instance of the PoolListOptions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="filter"><span data-ttu-id="88b3c-103">Eine OData-$filter-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-103">An OData $filter clause.</span></span> <span data-ttu-id="88b3c-104">Weitere Informationen zum Erstellen dieser Filter finden Sie unter https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-pools.</span><span class="sxs-lookup"><span data-stu-id="88b3c-104">For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-pools.</span></span></param>
        <param name="select"><span data-ttu-id="88b3c-105">Eine OData-$select-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-105">An OData $select clause.</span></span></param>
        <param name="expand"><span data-ttu-id="88b3c-106">Ein OData-$expand-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-106">An OData $expand clause.</span></span></param>
        <param name="maxResults"><span data-ttu-id="88b3c-107">Die maximale Anzahl von Elementen, die in der Antwort zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="88b3c-107">The maximum number of items to return in the response.</span></span> <span data-ttu-id="88b3c-108">Es kann maximal 1.000 Pools zurückgegeben werden.</span><span class="sxs-lookup"><span data-stu-id="88b3c-108">A maximum of 1000 pools can be returned.</span></span></param>
        <param name="timeout"><span data-ttu-id="88b3c-109">Die maximale Zeit, die der Server verarbeitet die Anforderung in Sekunden aufwenden kann.</span><span class="sxs-lookup"><span data-stu-id="88b3c-109">The maximum time that the server can spend processing the request, in seconds.</span></span> <span data-ttu-id="88b3c-110">Der Standardwert ist 30 Sekunden.</span><span class="sxs-lookup"><span data-stu-id="88b3c-110">The default is 30 seconds.</span></span></param>
        <param name="clientRequestId"><span data-ttu-id="88b3c-111">Die vom Aufrufer generierte Anforderungsidentität in Form einer GUID ohne Dekoration wie etwa geschweifte Klammern ein, z. B. 9C4D50EE 2-d 56-CD 3-8152-34347DC9F2B0 4.</span><span class="sxs-lookup"><span data-stu-id="88b3c-111">The caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.</span></span></param>
        <param name="returnClientRequestId"><span data-ttu-id="88b3c-112">Gibt an, ob der Server die Client-Request-Id in der Antwort zurückgeben soll.</span><span class="sxs-lookup"><span data-stu-id="88b3c-112">Whether the server should return the client-request-id in the response.</span></span></param>
        <param name="ocpDate"><span data-ttu-id="88b3c-113">Die Zeit, die die Anforderung ausgegeben wurde.</span><span class="sxs-lookup"><span data-stu-id="88b3c-113">The time the request was issued.</span></span> <span data-ttu-id="88b3c-114">Clientbibliotheken festlegen, in der Regel um die aktuelle Systemuhrzeit; Legen Sie sie explizit die REST-API direkt aufrufen.</span><span class="sxs-lookup"><span data-stu-id="88b3c-114">Client libraries typically set this to the current system clock time; set it explicitly if you are calling the REST API directly.</span></span></param>
        <summary>
            <span data-ttu-id="88b3c-115">Initialisiert eine neue Instanz der PoolListOptions-Klasse.</span><span class="sxs-lookup"><span data-stu-id="88b3c-115">Initializes a new instance of the PoolListOptions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-116">Ruft ab oder legt die vom Aufrufer generierte Anforderungsidentität in Form einer GUID ohne Dekoration wie etwa geschweifte Klammern ein, z. B. 9C4D50EE 2-d 56-CD 3-8152-34347DC9F2B0 4.</span><span class="sxs-lookup"><span data-stu-id="88b3c-116">Gets or sets the caller-generated request identity, in the form of a GUID with no decoration such as curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.</span></span>
            </summary>
    ...
    <Member MemberName="Expand">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-117">Ruft ab oder legt einen OData $expand-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-117">Gets or sets an OData $expand clause.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Filter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-118">Ruft ab oder legt eine OData-$filter-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-118">Gets or sets an OData $filter clause.</span></span> <span data-ttu-id="88b3c-119">Weitere Informationen zum Erstellen dieser Filter finden Sie unter https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-pools.</span><span class="sxs-lookup"><span data-stu-id="88b3c-119">For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-pools.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxResults">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-120">Ruft ab oder legt die maximale Anzahl von Elementen, die in der Antwort zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="88b3c-120">Gets or sets the maximum number of items to return in the response.</span></span>
            <span data-ttu-id="88b3c-121">Es kann maximal 1.000 Pools zurückgegeben werden.</span><span class="sxs-lookup"><span data-stu-id="88b3c-121">A maximum of 1000 pools can be returned.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-122">Ruft ab oder legt die Zeit, die die Anforderung ausgegeben wurde.</span><span class="sxs-lookup"><span data-stu-id="88b3c-122">Gets or sets the time the request was issued.</span></span> <span data-ttu-id="88b3c-123">Clientbibliotheken festlegen, in der Regel um die aktuelle Systemuhrzeit; Legen Sie sie explizit die REST-API direkt aufrufen.</span><span class="sxs-lookup"><span data-stu-id="88b3c-123">Client libraries typically set this to the current system clock time; set it explicitly if you are calling the REST API directly.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReturnClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-124">Ruft ab oder legt sie fest, ob der Server die Client-Request-Id in der Antwort zurückgeben soll.</span><span class="sxs-lookup"><span data-stu-id="88b3c-124">Gets or sets whether the server should return the client-request-id in the response.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Select">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-125">Ruft ab oder legt eine OData-$select-Klausel.</span><span class="sxs-lookup"><span data-stu-id="88b3c-125">Gets or sets an OData $select clause.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="88b3c-126">Ruft ab oder legt die maximale Zeit, dass der Server konsolenmeldungen Verarbeitung der Anforderung in Sekunden fest.</span><span class="sxs-lookup"><span data-stu-id="88b3c-126">Gets or sets the maximum time that the server can spend processing the request, in seconds.</span></span> <span data-ttu-id="88b3c-127">Der Standardwert ist 30 Sekunden.</span><span class="sxs-lookup"><span data-stu-id="88b3c-127">The default is 30 seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
