<Type Name="IOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.IOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="80e4a-101">Optionale Argumente, die für alle dienstanforderungen.</span><span class="sxs-lookup"><span data-stu-id="80e4a-101">Optional arguments applicable to all service requests.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80e4a-102">Die Identität des Aufrufers, die generiert Anforderung, in Form einer GUID ohne Dekoration wie etwa geschweifte Klammern, z. B. 9C4D50EE 2-d 56-CD 3-8152-34347DC9F2B0 4.</span><span class="sxs-lookup"><span data-stu-id="80e4a-102">Caller generated request identity, in the form of a GUID with no decoration such as curly braces e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.</span></span>
            </summary>
    ...
    <Member MemberName="ReturnClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80e4a-103">Gibt an, ob der Server den Client-Request-Id-Bezeichner in der Antwort zurückgeben soll.</span><span class="sxs-lookup"><span data-stu-id="80e4a-103">Specifies if the server should return the client-request-id identifier in the response.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
