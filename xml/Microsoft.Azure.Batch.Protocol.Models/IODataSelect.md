<Type Name="IODataSelect" FullName="Microsoft.Azure.Batch.Protocol.Models.IODataSelect">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="98042-101">Stellt den OData-$select-Parameter unterstützen Options-Objekts dar.</span><span class="sxs-lookup"><span data-stu-id="98042-101">Represents an options object supporting the OData $select parameter.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Select">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="98042-102">Ruft ab oder legt die OData-$select-Klausel.</span><span class="sxs-lookup"><span data-stu-id="98042-102">Gets or sets the OData $select clause.</span></span>
            </summary>
