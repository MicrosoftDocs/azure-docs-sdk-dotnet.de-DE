<Type Name="ErrorResponse" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.ErrorResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4bea9-101">Beschreibt den Fehler, der aufgetreten sind.</span><span class="sxs-lookup"><span data-stu-id="4bea9-101">Describes the error that occurred.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4bea9-102">Initialisiert eine neue Instanz der Klasse ErrorResponse an.</span><span class="sxs-lookup"><span data-stu-id="4bea9-102">Initializes a new instance of the ErrorResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code"><span data-ttu-id="4bea9-103">Der Fehlercode des Fehlers, der aufgetreten ist.</span><span class="sxs-lookup"><span data-stu-id="4bea9-103">Error code associated with the error that occurred.</span></span></param>
        <param name="message"><span data-ttu-id="4bea9-104">Beschreibt den Fehler im Detail.</span><span class="sxs-lookup"><span data-stu-id="4bea9-104">Describes the error in detail.</span></span></param>
        <summary>
            <span data-ttu-id="4bea9-105">Initialisiert eine neue Instanz der Klasse ErrorResponse an.</span><span class="sxs-lookup"><span data-stu-id="4bea9-105">Initializes a new instance of the ErrorResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4bea9-106">Ruft den aufgetretenen zugeordneten Fehlercode ab.</span><span class="sxs-lookup"><span data-stu-id="4bea9-106">Gets error code associated with the error that occurred.</span></span>
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4bea9-107">Ruft die den Fehler im Detail beschreibt.</span><span class="sxs-lookup"><span data-stu-id="4bea9-107">Gets describes the error in detail.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
