<Type Name="AzureTableOutputDataSource" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.AzureTableOutputDataSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="20132-101">Beschreibt eine Datenquelle für Azure Table-Ausgabe.</span><span class="sxs-lookup"><span data-stu-id="20132-101">Describes an Azure Table output data source.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-102">Initialisiert eine neue Instanz der AzureTableOutputDataSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="20132-102">Initializes a new instance of the AzureTableOutputDataSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accountName"><span data-ttu-id="20132-103">Der Name des Azure-Speicherkontos an.</span><span class="sxs-lookup"><span data-stu-id="20132-103">The name of the Azure Storage account.</span></span>
            <span data-ttu-id="20132-104">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-104">Required on PUT (CreateOrReplace) requests.</span></span></param>
        <param name="accountKey"><span data-ttu-id="20132-105">Der kontoschlüssel für das Azure-Speicherkonto an.</span><span class="sxs-lookup"><span data-stu-id="20132-105">The account key for the Azure Storage account.</span></span> <span data-ttu-id="20132-106">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-106">Required on PUT (CreateOrReplace) requests.</span></span></param>
        <param name="table"><span data-ttu-id="20132-107">Der Name der Azure-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="20132-107">The name of the Azure Table.</span></span> <span data-ttu-id="20132-108">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-108">Required on PUT (CreateOrReplace) requests.</span></span></param>
        <param name="partitionKey"><span data-ttu-id="20132-109">Dieses Element gibt den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Partitionsschlüssel verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="20132-109">This element indicates the name of a column from the SELECT statement in the query that will be used as the partition key for the Azure Table.</span></span> <span data-ttu-id="20132-110">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-110">Required on PUT (CreateOrReplace) requests.</span></span></param>
        <param name="rowKey"><span data-ttu-id="20132-111">Dieses Element gibt den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Zeilenschlüssel verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="20132-111">This element indicates the name of a column from the SELECT statement in the query that will be used as the row key for the Azure Table.</span></span> <span data-ttu-id="20132-112">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-112">Required on PUT (CreateOrReplace) requests.</span></span></param>
        <param name="columnsToRemove"><span data-ttu-id="20132-113">Wenn angegeben, wird jedes Element im Array der Name einer Spalte (falls vorhanden) aus den ausgabeereignisentitäten entfernt.</span><span class="sxs-lookup"><span data-stu-id="20132-113">If specified, each item in the array is the name of a column to remove (if present) from output event entities.</span></span></param>
        <param name="batchSize"><span data-ttu-id="20132-114">Die Anzahl der Zeilen in der Azure-Tabellenspeicher blockweise zu schreiben.</span><span class="sxs-lookup"><span data-stu-id="20132-114">The number of rows to write to the Azure Table at a time.</span></span></param>
        <summary>
            <span data-ttu-id="20132-115">Initialisiert eine neue Instanz der AzureTableOutputDataSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="20132-115">Initializes a new instance of the AzureTableOutputDataSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AccountKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-116">Ruft ab oder legt den kontoschlüssel für das Azure-Speicherkonto an.</span><span class="sxs-lookup"><span data-stu-id="20132-116">Gets or sets the account key for the Azure Storage account.</span></span>
            <span data-ttu-id="20132-117">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-117">Required on PUT (CreateOrReplace) requests.</span></span>
            </summary>
    ...
    <Member MemberName="AccountName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-118">Ruft ab oder legt den Namen des Azure-Speicherkontos an.</span><span class="sxs-lookup"><span data-stu-id="20132-118">Gets or sets the name of the Azure Storage account.</span></span> <span data-ttu-id="20132-119">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-119">Required on PUT (CreateOrReplace) requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BatchSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-120">Ruft ab oder legt die Anzahl der Zeilen in der Azure-Tabellenspeicher blockweise zu schreiben.</span><span class="sxs-lookup"><span data-stu-id="20132-120">Gets or sets the number of rows to write to the Azure Table at a time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ColumnsToRemove">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-121">Ruft ab oder legt ihn fest, wenn angegeben, jedes Element im Array ist der Name einer Spalte (falls vorhanden) aus den ausgabeereignisentitäten entfernt.</span><span class="sxs-lookup"><span data-stu-id="20132-121">Gets or sets if specified, each item in the array is the name of a column to remove (if present) from output event entities.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartitionKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-122">Ruft ab oder legt gibt dieses Element den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Partitionsschlüssel verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="20132-122">Gets or sets this element indicates the name of a column from the SELECT statement in the query that will be used as the partition key for the Azure Table.</span></span> <span data-ttu-id="20132-123">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-123">Required on PUT (CreateOrReplace) requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RowKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-124">Ruft ab oder legt gibt dieses Element den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Zeilenschlüssel verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="20132-124">Gets or sets this element indicates the name of a column from the SELECT statement in the query that will be used as the row key for the Azure Table.</span></span> <span data-ttu-id="20132-125">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-125">Required on PUT (CreateOrReplace) requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Table">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="20132-126">Ruft ab oder legt den Namen der Azure-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="20132-126">Gets or sets the name of the Azure Table.</span></span> <span data-ttu-id="20132-127">Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="20132-127">Required on PUT (CreateOrReplace) requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
