<Type Name="JavaScriptFunctionBinding" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.JavaScriptFunctionBinding">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6380a-101">Die Bindung an eine JavaScript-Funktion.</span><span class="sxs-lookup"><span data-stu-id="6380a-101">The binding to a JavaScript function.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6380a-102">Initialisiert eine neue Instanz der JavaScriptFunctionBinding-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6380a-102">Initializes a new instance of the JavaScriptFunctionBinding class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="script"><span data-ttu-id="6380a-103">Der JavaScript-Code, die eine einzelne Funktion-Definition enthält.</span><span class="sxs-lookup"><span data-stu-id="6380a-103">The JavaScript code containing a single function definition.</span></span> <span data-ttu-id="6380a-104">Zum Beispiel: ' Function (X, y) {Return X + y;} "</span><span class="sxs-lookup"><span data-stu-id="6380a-104">For example: 'function (x, y) { return x + y; }'</span></span></param>
        <summary>
            <span data-ttu-id="6380a-105">Initialisiert eine neue Instanz der JavaScriptFunctionBinding-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6380a-105">Initializes a new instance of the JavaScriptFunctionBinding class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Script">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6380a-106">Ruft ab, oder legt ihn fest, die eine einzelne Funktion-Definition enthält JavaScript-Code.</span><span class="sxs-lookup"><span data-stu-id="6380a-106">Gets or sets the JavaScript code containing a single function definition.</span></span> <span data-ttu-id="6380a-107">Zum Beispiel: ' Function (X, y) {Return X + y;} "</span><span class="sxs-lookup"><span data-stu-id="6380a-107">For example: 'function (x, y) { return x + y; }'</span></span>
            </summary>
