<Type Name="IWithDatabaseDtuMax" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Definition.IWithDatabaseDtuMax">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="18347-101">Die maximale DTU für eine einzelne Datenbank festzulegende elastischen Pool für SQL-Definition.</span><span class="sxs-lookup"><span data-stu-id="18347-101">The SQL Elastic Pool definition to set the maximum DTU for one database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDatabaseDtuMax">
      ...
      <Docs>
        <param name="databaseDtuMax"><span data-ttu-id="18347-102">Maximale DTU, die alle eine SQL Azure-Datenbank nutzen kann.</span><span class="sxs-lookup"><span data-stu-id="18347-102">Maximum DTU any one SQL Azure Database can consume.</span></span></param>
        <summary>
            <span data-ttu-id="18347-103">Legt der maximale DTU einer SQL Azure-Datenbank verbraucht werden darf.</span><span class="sxs-lookup"><span data-stu-id="18347-103">Sets the maximum DTU any one SQL Azure Database can consume.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="18347-104">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="18347-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>