<Type Name="IPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ba3cb-101">Öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-101">Public IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Fqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-102">Ruft den zugewiesenen FQDN (vollständig qualifizierter Domänenname) an.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-102">Gets the assigned FQDN (fully qualified domain name).</span></span>
            </summary>
    ...
    <Member MemberName="GetAssignedLoadBalancerFrontend">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ba3cb-103">Der Load Balancer öffentliche Front-End-, die diese öffentliche IP-Adresse zugewiesen wird.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-103">The load balancer public frontend that this public IP address is assigned to.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="GetAssignedNetworkInterfaceIPConfiguration">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ba3cb-104">IP-die Konfiguration der Netzwerkschnittstelle, der diese öffentliche IP-Adresse zugewiesen wird.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-104">The network interface IP configuration that this public IP address is assigned to.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="HasAssignedLoadBalancer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-105">Ruft "true", wenn diese öffentliche IP-Adresse ein Lastenausgleich zugewiesen ist.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-105">Gets true if this public IP address is assigned to a load balancer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HasAssignedNetworkInterface">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-106">Ruft "true", wenn diese öffentliche IP-Adresse einer Netzwerkschnittstelle zugewiesen ist.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-106">Gets true if this public IP address is assigned to a network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IdleTimeoutInMinutes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-107">Ruft die Verbindung im Leerlauf Timeouteinstellung (in Minuten) an.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-107">Gets the idle connection timeout setting (in minutes).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-108">Ruft die zugewiesene IP-Adresse ab.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-108">Gets the assigned IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-109">Ruft die IP-Adresszuordnungsmethode (statische und dynamische) ab.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-109">Gets the IP address allocation method (Static/Dynamic).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LeafDomainLabel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-110">Ruft die Beschriftung der zugewiesenen Leaf-Domäne.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-110">Gets the assigned leaf domain label.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseFqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-111">Ruft den zugewiesenen reverse FQDN ab, sofern vorhanden.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-111">Gets the assigned reverse FQDN, if any.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ba3cb-112">Ruft die IP-Version der öffentlichen IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="ba3cb-112">Gets the IP version of the public IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
