<Type Name="IVirtualMachineScaleSetNetworkInterface" FullName="Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNetworkInterface">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a2154-101">VM-Skalierungsgruppe Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="a2154-101">Virtual machine scale set network interface.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="IPConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a2154-102">Ruft die IP-Konfigurationen von Netzwerk-Schnittstelle, durch deren Namen indiziert.</span><span class="sxs-lookup"><span data-stu-id="a2154-102">Gets the IP configurations of this network interface, indexed by their names.</span></span>
            </summary>
    ...
    <Member MemberName="PrimaryIPConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a2154-103">Ruft die primäre IP-Konfiguration dieser Netzwerkschnittstelle ab.</span><span class="sxs-lookup"><span data-stu-id="a2154-103">Gets the primary IP configuration of this network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
