<Type Name="IVirtualMachineScaleSetNicIPConfiguration" FullName="Microsoft.Azure.Management.Network.Fluent.IVirtualMachineScaleSetNicIPConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d3865-101">Eine IP-Konfiguration in eine Netzwerkschnittstelle mit einer VM-Skalierungsgruppe verknüpft ist.</span><span class="sxs-lookup"><span data-stu-id="d3865-101">An IP configuration in a network interface associated with a virtual machine scale set.</span></span>
            </summary>
