<Type Name="IHasPrivateIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.IHasPrivateIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="14ad9-101">Eine Schnittstelle, die ein Modell kann auf eine private IP-Adresse verweisen darstellt.</span><span class="sxs-lookup"><span data-stu-id="14ad9-101">An interface representing a model's ability to reference a private IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="PrivateIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14ad9-102">Ruft die private IP-Adresse, die dieser Ressource zugeordneten ab.</span><span class="sxs-lookup"><span data-stu-id="14ad9-102">Gets the private IP address associated with this resource.</span></span>
            </summary>
    ...
    <Member MemberName="PrivateIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14ad9-103">Ruft die private IP-Adresszuordnungsmethode innerhalb des zugeordneten Subnetzes an.</span><span class="sxs-lookup"><span data-stu-id="14ad9-103">Gets the private IP address allocation method within the associated subnet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
