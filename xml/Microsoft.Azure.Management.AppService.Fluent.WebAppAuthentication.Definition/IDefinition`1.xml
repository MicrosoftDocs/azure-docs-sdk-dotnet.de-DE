<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="d8f7b-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="d8f7b-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="d8f7b-102">Die Gesamtheit der Definition eines Web-app-Authentifizierung.</span><span class="sxs-lookup"><span data-stu-id="d8f7b-102">The entirety of a web app authentication definition.</span></span>
            </summary>
