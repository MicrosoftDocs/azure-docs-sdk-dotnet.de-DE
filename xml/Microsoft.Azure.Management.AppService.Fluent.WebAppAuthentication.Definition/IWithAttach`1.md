<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.Definition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="d6cba-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="d6cba-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="d6cba-102">Der abschließenden Phase der Definition der Web-app-Authentifizierung.</span><span class="sxs-lookup"><span data-stu-id="d6cba-102">The final stage of the web app authentication definition.</span></span>
            <span data-ttu-id="d6cba-103">Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die Definition der Web-app-Authentifizierung an der Definition des übergeordneten-Web-app mit WithAttach.attach() angefügt werden kann.</span><span class="sxs-lookup"><span data-stu-id="d6cba-103">At this stage, any remaining optional settings can be specified, or the web app authentication definition can be attached to the parent web app definition using  WithAttach.attach().</span></span>
            </summary>
