<Type Name="TelemetryProcessorChain" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.TelemetryProcessorChain">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="969c0-101">Stellt die TelemetryProcessor-Kette dar.</span><span class="sxs-lookup"><span data-stu-id="969c0-101">Represents the TelemetryProcessor chain.</span></span> <span data-ttu-id="969c0-102">Clients sollten TelemetryProcessorChainBuilder verwenden, um dieses Objekt zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="969c0-102">Clients should use TelemetryProcessorChainBuilder to construct this object.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="969c0-103">Gibt die von der aktuellen Instanz der <see cref="T:Microsoft.ApplicationInsights.Extensibility.Implementation.TelemetryProcessorChain" />-Klasse verwendeten Ressourcen frei.</span><span class="sxs-lookup"><span data-stu-id="969c0-103">Releases resources used by the current instance of the <see cref="T:Microsoft.ApplicationInsights.Extensibility.Implementation.TelemetryProcessorChain" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Process">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="969c0-104">Ruft die Prozess-Methode im ersten Telemetrie-Prozessor.</span><span class="sxs-lookup"><span data-stu-id="969c0-104">Invokes the process method in the first telemetry processor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
