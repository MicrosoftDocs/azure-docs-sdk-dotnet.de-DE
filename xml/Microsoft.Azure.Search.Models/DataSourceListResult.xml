<Type Name="DataSourceListResult" FullName="Microsoft.Azure.Search.Models.DataSourceListResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3a717-101">Die Antwort von einer Anforderung zum Auflisten von Datenquellen.</span><span class="sxs-lookup"><span data-stu-id="3a717-101">Response from a List Datasources request.</span></span> <span data-ttu-id="3a717-102">Bei erfolgreicher Ausführung umfasst sie die vollständigen Definitionen aller Datenquellen.</span><span class="sxs-lookup"><span data-stu-id="3a717-102">If successful, it includes the full definitions of all datasources.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a717-103">Initialisiert eine neue Instanz der DataSourceListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3a717-103">Initializes a new instance of the DataSourceListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dataSources"><span data-ttu-id="3a717-104">Die Datenquellen im Suchdienst.</span><span class="sxs-lookup"><span data-stu-id="3a717-104">The datasources in the Search service.</span></span></param>
        <summary>
            <span data-ttu-id="3a717-105">Initialisiert eine neue Instanz der DataSourceListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3a717-105">Initializes a new instance of the DataSourceListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DataSources">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a717-106">Ruft die Datenquellen im Suchdienst ab.</span><span class="sxs-lookup"><span data-stu-id="3a717-106">Gets the datasources in the Search service.</span></span>
            </summary>
