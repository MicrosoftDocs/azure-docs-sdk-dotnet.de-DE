<Type Name="RegexFlags" FullName="Microsoft.Azure.Search.Models.RegexFlags">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7658c-101">Definiert Flags, die kombiniert werden können, um zu steuern, wie reguläre Ausdrücke im Muster Analyzer und Muster Tokenizer verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="7658c-101">Defines flags that can be combined to control how regular expressions are used in the pattern analyzer and pattern tokenizer.</span></span>
  ...
  <Members>
    <Member MemberName="CanonEq">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-102">Ermöglicht die kanonische Äquivalenz.</span><span class="sxs-lookup"><span data-stu-id="7658c-102">Enables canonical equivalence.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#CANON_EQ" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CaseInsensitive">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-103">Ermöglicht die Groß-/Kleinschreibung übereinstimmende.</span><span class="sxs-lookup"><span data-stu-id="7658c-103">Enables case-insensitive matching.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#CASE_INSENSITIVE" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Comments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-104">Ermöglicht Leerzeichen und Kommentare im Muster.</span><span class="sxs-lookup"><span data-stu-id="7658c-104">Permits whitespace and comments in the pattern.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#COMMENTS" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Create">
      ...
      <Docs>
        <param name="flagExpression">
            <span data-ttu-id="7658c-105">Name des Regex-Flag oder einen Ausdruck, bestehend aus mindestens zwei Flags, die durch senkrechte Striche (|) getrennt.</span><span class="sxs-lookup"><span data-stu-id="7658c-105">Name of the regex flag, or an expression comprised of two or more flags separated by vertical bars (|).</span></span>
            </param>
        <summary>
            <span data-ttu-id="7658c-106">Erstellt eine neue Instanz der RegexFlags oder eine vorhandene Instanz zurück, wenn dem angegebenen Namen, die von einer bekannten Regex-Flag übereinstimmt.</span><span class="sxs-lookup"><span data-stu-id="7658c-106">Creates a new RegexFlags instance, or returns an existing instance if the given name matches that of a known regex flag.</span></span>
            </summary>
        <returns><span data-ttu-id="7658c-107">Eine RegexFlags-Instanz mit dem angegebenen Ausdruck.</span><span class="sxs-lookup"><span data-stu-id="7658c-107">A RegexFlags instance with the given expression.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DotAll">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-108">Dotall-Modus aktiviert.</span><span class="sxs-lookup"><span data-stu-id="7658c-108">Enables dotall mode.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#DOTALL" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Literal">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-109">Ermöglicht das literal Analysieren des Musters.</span><span class="sxs-lookup"><span data-stu-id="7658c-109">Enables literal parsing of the pattern.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#LITERAL" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Multiline">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-110">Ermöglicht Mehrzeilenmodus.</span><span class="sxs-lookup"><span data-stu-id="7658c-110">Enables multiline mode.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#MULTILINE" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="op_BitwiseOr">
      ...
      <Docs>
        <param name="lhs"><span data-ttu-id="7658c-111">Die linke Seite des OR-Ausdrucks.</span><span class="sxs-lookup"><span data-stu-id="7658c-111">The left-hand side of the OR expression.</span></span></param>
        <param name="rhs"><span data-ttu-id="7658c-112">Der rechten Seite des OR-Ausdrucks.</span><span class="sxs-lookup"><span data-stu-id="7658c-112">The right-hand side of the OR expression.</span></span></param>
        <summary>
            <span data-ttu-id="7658c-113">Overloads bitweisen oder Operator kombiniert zwei RegexFlags.</span><span class="sxs-lookup"><span data-stu-id="7658c-113">Overloads the bitwise OR operator to combines two RegexFlags.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="7658c-114">Eine neue RegexFlags, die das Ergebnis der Verkettung der beiden angegebenen RegexFlags wird getrennt durch einen senkrechten Strich (|).</span><span class="sxs-lookup"><span data-stu-id="7658c-114">A new RegexFlags that is the result of concatenating the two given RegexFlags, separated by a vertical bar (|).</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="op_Implicit">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="7658c-115">zu konvertierende Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="7658c-115">string to convert.</span></span></param>
        <summary>
            <span data-ttu-id="7658c-116">Definiert die implizite Konvertierung von Zeichenfolgen in RegexFlags.</span><span class="sxs-lookup"><span data-stu-id="7658c-116">Defines implicit conversion from string to RegexFlags.</span></span>
            </summary>
        <returns><span data-ttu-id="7658c-117">Die Zeichenfolge als eine RegexFlags.</span><span class="sxs-lookup"><span data-stu-id="7658c-117">The string as a RegexFlags.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UnicodeCase">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-118">Ermöglicht das Unicode-kompatible Groß-/Kleinschreibung Faltung.</span><span class="sxs-lookup"><span data-stu-id="7658c-118">Enables Unicode-aware case folding.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#UNICODE_CASE" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UnixLines">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7658c-119">Ermöglicht es Unix-Zeilen-Modus.</span><span class="sxs-lookup"><span data-stu-id="7658c-119">Enables Unix lines mode.</span></span> <see href="http://docs.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html#UNIX_LINES" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
