<Type Name="HitHighlights" FullName="Microsoft.Azure.Search.Models.HitHighlights">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4b702-101">Enthält alles, was der Treffer für ein Dokument, das als eine Auflistung von Textfragmente für den entsprechenden Feldern organisiert werden hervorgehoben.</span><span class="sxs-lookup"><span data-stu-id="4b702-101">Contains all the hit highlights for a document, organized as a collection of text fragments for each applicable field.</span></span>
            </summary>
