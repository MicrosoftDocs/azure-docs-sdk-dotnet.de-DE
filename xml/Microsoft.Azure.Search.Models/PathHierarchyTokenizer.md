<Type Name="PathHierarchyTokenizer" FullName="Microsoft.Azure.Search.Models.PathHierarchyTokenizer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="371a7-101">Der Tokenizer für Path-ähnliche Hierarchien.</span><span class="sxs-lookup"><span data-stu-id="371a7-101">Tokenizer for path-like hierarchies.</span></span> <span data-ttu-id="371a7-102">Diese Tokenizer wird mithilfe von Apache Lucene implementiert.</span><span class="sxs-lookup"><span data-stu-id="371a7-102">This tokenizer is implemented using Apache Lucene.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-103">Initialisiert eine neue Instanz der PathHierarchyTokenizer-Klasse.</span><span class="sxs-lookup"><span data-stu-id="371a7-103">Initializes a new instance of the PathHierarchyTokenizer class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="371a7-104">Initialisiert eine neue Instanz der PathHierarchyTokenizer-Klasse.</span><span class="sxs-lookup"><span data-stu-id="371a7-104">Initializes a new instance of the PathHierarchyTokenizer class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BufferSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-105">Ruft ab oder legt die Größe des Puffers.</span><span class="sxs-lookup"><span data-stu-id="371a7-105">Gets or sets the buffer size.</span></span> <span data-ttu-id="371a7-106">Standardwert ist 1024.</span><span class="sxs-lookup"><span data-stu-id="371a7-106">Default is 1024.</span></span>
            </summary>
    ...
    <Member MemberName="Delimiter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-107">Ermittelt oder definiert das Trennzeichen verwenden.</span><span class="sxs-lookup"><span data-stu-id="371a7-107">Gets or sets the delimiter character to use.</span></span> <span data-ttu-id="371a7-108">Standardwert ist "/".</span><span class="sxs-lookup"><span data-stu-id="371a7-108">Default is "/".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumberOfTokensToSkip">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-109">Ruft ab oder legt die Anzahl der anfänglichen Token zu überspringen.</span><span class="sxs-lookup"><span data-stu-id="371a7-109">Gets or sets the number of initial tokens to skip.</span></span> <span data-ttu-id="371a7-110">Der Standardwert ist 0.</span><span class="sxs-lookup"><span data-stu-id="371a7-110">Default is 0.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Replacement">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-111">Ruft ab oder legt einen Wert fest, die, wenn festgelegt ist, ersetzt das Trennzeichen.</span><span class="sxs-lookup"><span data-stu-id="371a7-111">Gets or sets a value that, if set, replaces the delimiter character.</span></span> <span data-ttu-id="371a7-112">Standardwert ist "/".</span><span class="sxs-lookup"><span data-stu-id="371a7-112">Default is "/".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseTokenOrder">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="371a7-113">Ruft ab oder legt einen Wert, der angibt, ob zum Generieren von Token in umgekehrter Reihenfolge.</span><span class="sxs-lookup"><span data-stu-id="371a7-113">Gets or sets a value indicating whether to generate tokens in reverse order.</span></span> <span data-ttu-id="371a7-114">Die Standardeinstellung ist "false".</span><span class="sxs-lookup"><span data-stu-id="371a7-114">Default is false.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
