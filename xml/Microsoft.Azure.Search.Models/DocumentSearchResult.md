<Type Name="DocumentSearchResult" FullName="Microsoft.Azure.Search.Models.DocumentSearchResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ff530-101">Antwort mit der Suche ergibt sich aus einem Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="ff530-101">Response containing search results from an Azure Search index.</span></span>
            </summary>
