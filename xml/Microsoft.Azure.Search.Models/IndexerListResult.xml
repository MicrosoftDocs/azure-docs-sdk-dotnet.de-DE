<Type Name="IndexerListResult" FullName="Microsoft.Azure.Search.Models.IndexerListResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="31e62-101">Die Antwort aus einer Liste Indexer-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="31e62-101">Response from a List Indexers request.</span></span> <span data-ttu-id="31e62-102">Bei erfolgreicher Ausführung umfasst sie die vollständigen Definitionen aller Indexer.</span><span class="sxs-lookup"><span data-stu-id="31e62-102">If successful, it includes the full definitions of all indexers.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31e62-103">Initialisiert eine neue Instanz der IndexerListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="31e62-103">Initializes a new instance of the IndexerListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="indexers"><span data-ttu-id="31e62-104">Die Indexer im Suchdienst.</span><span class="sxs-lookup"><span data-stu-id="31e62-104">The indexers in the Search service.</span></span></param>
        <summary>
            <span data-ttu-id="31e62-105">Initialisiert eine neue Instanz der IndexerListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="31e62-105">Initializes a new instance of the IndexerListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Indexers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31e62-106">Ruft die Indexer im Suchdienst ab.</span><span class="sxs-lookup"><span data-stu-id="31e62-106">Gets the indexers in the Search service.</span></span>
            </summary>
