<Type Name="DataSourceCredentials" FullName="Microsoft.Azure.Search.Models.DataSourceCredentials">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f4825-101">Stellt Anmeldeinformationen, die für die Verbindung mit einer Datenquelle verwendet werden können.</span><span class="sxs-lookup"><span data-stu-id="f4825-101">Represents credentials that can be used to connect to a datasource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f4825-102">Initialisiert eine neue Instanz der "DataSourceCredentials"-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f4825-102">Initializes a new instance of the DataSourceCredentials class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="connectionString"><span data-ttu-id="f4825-103">Die Verbindungszeichenfolge für die Datenquelle.</span><span class="sxs-lookup"><span data-stu-id="f4825-103">The connection string for the datasource.</span></span></param>
        <summary>
            <span data-ttu-id="f4825-104">Initialisiert eine neue Instanz der "DataSourceCredentials"-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f4825-104">Initializes a new instance of the DataSourceCredentials class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f4825-105">Ruft ab oder legt die Verbindungszeichenfolge für die Datenquelle.</span><span class="sxs-lookup"><span data-stu-id="f4825-105">Gets or sets the connection string for the datasource.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f4825-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="f4825-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="f4825-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="f4825-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
