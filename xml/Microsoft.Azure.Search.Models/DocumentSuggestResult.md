<Type Name="DocumentSuggestResult" FullName="Microsoft.Azure.Search.Models.DocumentSuggestResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="85bdb-101">Antwort mit vorschlagsabfrage ergibt sich aus einem Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="85bdb-101">Response containing suggestion query results from an Azure Search index.</span></span>
            </summary>
