<Type Name="DocumentSearchResult&lt;T&gt;" FullName="Microsoft.Azure.Search.Models.DocumentSearchResult&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T">
            <span data-ttu-id="f6ade-101">Die CLR-Typ, der dem IndexSchema zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="f6ade-101">The CLR type that maps to the index schema.</span></span> <span data-ttu-id="f6ade-102">Instanzen dieses Typs können als Dokumente aus dem Index abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="f6ade-102">Instances of this type can be retrieved as documents from the index.</span></span>
            </typeparam>
    <summary>
            <span data-ttu-id="f6ade-103">Antwort mit der Suche ergibt sich aus einem Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="f6ade-103">Response containing search results from an Azure Search index.</span></span>
            </summary>
