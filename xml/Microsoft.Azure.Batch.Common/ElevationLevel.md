<Type Name="ElevationLevel" FullName="Microsoft.Azure.Batch.Common.ElevationLevel">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f0ea7-101">Die Erhöhung der Rechte Ebene des Benutzerkontos ein, die von der Batch-Dienst verwendet, um eine Aufgabe auszuführen.</span><span class="sxs-lookup"><span data-stu-id="f0ea7-101">The elevation level of the user account used by the Batch service to execute a task.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Admin">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f0ea7-102">Der Benutzer verfügt über erhöhte Zugriffsberechtigungen und arbeitet mit vollständigen Administratorberechtigungen.</span><span class="sxs-lookup"><span data-stu-id="f0ea7-102">The user has elevated access and operates with full Administrator permissions.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NonAdmin">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f0ea7-103">Der Benutzer hat die standard-Zugriffsberechtigungen.</span><span class="sxs-lookup"><span data-stu-id="f0ea7-103">The user has standard access permissions.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
