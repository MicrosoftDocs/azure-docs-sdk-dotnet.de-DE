<Type Name="CachingType" FullName="Microsoft.Azure.Batch.Common.CachingType">
  ...
  <Docs>
    <summary>
            Der caching-Typ für einen Betriebssystemdatenträger. <span data-ttu-id="0abe3-102">Weitere Informationen zu Optionen für die Zwischenspeicherung finden Sie unter: https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-azure-drives-disks-and-images/</span><span class="sxs-lookup"><span data-stu-id="0abe3-102">For information about the caching options see: https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-azure-drives-disks-and-images/</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0abe3-103">Keine Zwischenspeicherung ist aktiviert.</span><span class="sxs-lookup"><span data-stu-id="0abe3-103">No caching is enabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ReadOnly">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0abe3-104">Der cachingmodus für den Datenträger ist schreibgeschützt.</span><span class="sxs-lookup"><span data-stu-id="0abe3-104">The caching mode for the disk is read only.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ReadWrite">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0abe3-105">Der cachingmodus des Datenträgers ist Lese-/Schreibzugriff.</span><span class="sxs-lookup"><span data-stu-id="0abe3-105">The caching mode for the disk is read/write.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
