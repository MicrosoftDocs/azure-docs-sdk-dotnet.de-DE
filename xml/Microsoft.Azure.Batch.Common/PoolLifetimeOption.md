<Type Name="PoolLifetimeOption" FullName="Microsoft.Azure.Batch.Common.PoolLifetimeOption">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d9f41-101">Gibt die minimale Lebensdauer der erstellten automatisch Pools und wie mehrere Aufträge nach einem Zeitplan, die den Pools zugewiesen werden.</span><span class="sxs-lookup"><span data-stu-id="d9f41-101">Specifies the minimum lifetime of created auto pools, and how multiple jobs on a schedule are assigned to pools.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Job">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d9f41-102">Der Pool vorhanden ist, für die Lebensdauer des Auftrags, der es reserviert ist.</span><span class="sxs-lookup"><span data-stu-id="d9f41-102">The pool exists for the lifetime of the job to which it is dedicated.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="JobSchedule">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d9f41-103">Der Pool für die Lebensdauer des Auftragszeitplans vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="d9f41-103">The pool exists for the lifetime of the job schedule.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
