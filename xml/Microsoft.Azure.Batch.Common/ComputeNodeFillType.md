<Type Name="ComputeNodeFillType" FullName="Microsoft.Azure.Batch.Common.ComputeNodeFillType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7f813-101">Gibt an, wie Aufgaben auf Serverknoten verteilt werden soll.</span><span class="sxs-lookup"><span data-stu-id="7f813-101">Specifies how tasks should be distributed across compute nodes.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Pack">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7f813-102">Wie viele Aufgaben wie möglich (MaxTasksPerNode) sollte auf jeden Knoten im Pool zugewiesen werden, bevor alle Aufgaben auf den nächsten Knoten im Pool zugewiesen sind.</span><span class="sxs-lookup"><span data-stu-id="7f813-102">As many tasks as possible (maxTasksPerNode) should be assigned to each node in the pool before any tasks are assigned to the next node in the pool.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Spread">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7f813-103">Aufgaben sollten gleichmäßig allen Knoten im Pool zugewiesen werden.</span><span class="sxs-lookup"><span data-stu-id="7f813-103">Tasks should be assigned evenly across all nodes in the pool.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
