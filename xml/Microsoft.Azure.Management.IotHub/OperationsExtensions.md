<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.IotHub.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fc2bb-101">Erweiterungsmethoden für Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="fc2bb-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="fc2bb-103">Zeigt eine Liste aller verfügbaren IoT Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-103">Lists all of the available IoT Hub REST API operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="fc2bb-104">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="fc2bb-105">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="fc2bb-106">Zeigt eine Liste aller verfügbaren IoT Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-106">Lists all of the available IoT Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="fc2bb-107">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="fc2bb-108">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="fc2bb-109">Zeigt eine Liste aller verfügbaren IoT Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-109">Lists all of the available IoT Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="fc2bb-110">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="fc2bb-111">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="fc2bb-112">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="fc2bb-113">Zeigt eine Liste aller verfügbaren IoT Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="fc2bb-113">Lists all of the available IoT Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
