<Type Name="IWithPrivateIP&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayFrontend.Definition.IWithPrivateIP&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="8af66-101">Die Phase der Definition des übergeordneten Anwendung Gateway wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="8af66-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="8af66-102">Die Phase der an die private IP-Adresse zulassen Front-End-Definition einer Anwendung Gateway sollte dieses Anwendungsgateway innerhalb des ausgewählten Subnetzes verfügbar sein.</span><span class="sxs-lookup"><span data-stu-id="8af66-102">The stage of an application gateway frontend definition allowing to specify the private IP address this application gateway should be available at within the selected subnet.</span></span>
            </summary>
