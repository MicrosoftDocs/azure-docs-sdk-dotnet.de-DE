<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Batch.Fluent.Application.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="805b3-101">Die gesamte eine Batchaktualisierung für die Anwendung als Teil eines Batch-Konto-Updates.</span><span class="sxs-lookup"><span data-stu-id="805b3-101">The entirety of a Batch application update as a part of a Batch account update.</span></span>
            </summary>
