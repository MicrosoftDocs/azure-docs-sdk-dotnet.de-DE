<Type Name="DirectoryHttpResponseParsers" FullName="Microsoft.WindowsAzure.Storage.File.Protocol.DirectoryHttpResponseParsers">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2768d-101">Stellt Methoden zum Analysieren Antworten auf Vorgänge für Verzeichnisse in den Dateidienst bereit.</span><span class="sxs-lookup"><span data-stu-id="2768d-101">Provides methods for parsing responses to operations on directories in the File service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="GetMetadata">
      ...
      <Docs>
        <param name="response"><span data-ttu-id="2768d-102">Die Antwort vom Server.</span><span class="sxs-lookup"><span data-stu-id="2768d-102">The response from server.</span></span></param>
        <summary>
            <span data-ttu-id="2768d-103">Ruft die benutzerdefinierten Metadaten ab.</span><span class="sxs-lookup"><span data-stu-id="2768d-103">Gets the user-defined metadata.</span></span>
            </summary>
        <returns><span data-ttu-id="2768d-104">Ein <see cref="T:System.Collections.IDictionary" /> der Metadaten.</span><span class="sxs-lookup"><span data-stu-id="2768d-104">A <see cref="T:System.Collections.IDictionary" /> of the metadata.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetProperties">
      ...
      <Docs>
        <param name="response"><span data-ttu-id="2768d-105">Die Webantwort.</span><span class="sxs-lookup"><span data-stu-id="2768d-105">The web response.</span></span></param>
        <summary>
            <span data-ttu-id="2768d-106">Ruft das Verzeichnis Eigenschaften aus der Antwort ab.</span><span class="sxs-lookup"><span data-stu-id="2768d-106">Gets the directory's properties from the response.</span></span>
            </summary>
        <returns><span data-ttu-id="2768d-107">Attribute für das Verzeichnis.</span><span class="sxs-lookup"><span data-stu-id="2768d-107">The directory's attributes.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetRequestId">
      ...
      <Docs>
        <param name="response"><span data-ttu-id="2768d-108">Die Webantwort.</span><span class="sxs-lookup"><span data-stu-id="2768d-108">The web response.</span></span></param>
        <summary>
            <span data-ttu-id="2768d-109">Ruft die Anforderungs-ID aus der Antwort ab.</span><span class="sxs-lookup"><span data-stu-id="2768d-109">Gets the request ID from the response.</span></span>
            </summary>
        <returns><span data-ttu-id="2768d-110">Ein eindeutiger Wert, der der Anforderung zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="2768d-110">A unique value associated with the request.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
