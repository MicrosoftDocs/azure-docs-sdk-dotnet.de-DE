<Type Name="IWithProbe" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithProbe">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="01c05-101">Die Stufe der Load-Balancer-Definition ermöglicht eine Überprüfung für den Lastenausgleich hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="01c05-101">The stage of the load balancer definition allowing to add a load balancing probe.</span></span>
            </summary>
