<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="73b65-101">Die Stufe der Load-Balancer-Definition ermöglicht die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="73b65-101">The stage of the load balancer definition allowing to specify the resource group.</span></span>
            </summary>
