<Type Name="IWithCreateAndInboundNatRule" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithCreateAndInboundNatRule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cfe54-101">Die Stufe der einen Load Balancer-Definition der Load Balancer erstellen oder eine NAT-Eingangsregel hinzufügen können.</span><span class="sxs-lookup"><span data-stu-id="cfe54-101">The stage of a load balancer definition allowing to create the load balancer or add an inbound NAT rule.</span></span>
            </summary>
