<Type Name="IWithBackend" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithBackend">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="88853-101">Die Stufe der einen Load Balancer-Definition ein Back-End hinzufügen können.</span><span class="sxs-lookup"><span data-stu-id="88853-101">The stage of a load balancer definition allowing to add a backend.</span></span>
            </summary>
