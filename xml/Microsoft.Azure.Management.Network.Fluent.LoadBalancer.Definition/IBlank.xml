<Type Name="IBlank" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7df4a-101">Die erste Phase der Load Balancer-Definition.</span><span class="sxs-lookup"><span data-stu-id="7df4a-101">The first stage of a load balancer definition.</span></span>
            </summary>
