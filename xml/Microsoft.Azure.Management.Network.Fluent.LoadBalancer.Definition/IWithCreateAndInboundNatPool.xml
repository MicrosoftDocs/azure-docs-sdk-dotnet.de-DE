<Type Name="IWithCreateAndInboundNatPool" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithCreateAndInboundNatPool">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d3425-101">Die Stufe der einen Load Balancer-Definition der Load Balancer erstellen oder Hinzufügen eines eingehenden NAT-Pools ermöglicht.</span><span class="sxs-lookup"><span data-stu-id="d3425-101">The stage of a load balancer definition allowing to create the load balancer or add an inbound NAT pool.</span></span>
            </summary>
