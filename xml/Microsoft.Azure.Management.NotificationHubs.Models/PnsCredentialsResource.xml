<Type Name="PnsCredentialsResource" FullName="Microsoft.Azure.Management.NotificationHubs.Models.PnsCredentialsResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4ad90-101">Beschreibung des ein NotificationHub-PNS-Anmeldeinformationen.</span><span class="sxs-lookup"><span data-stu-id="4ad90-101">Description of a NotificationHub PNS Credentials.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-102">Initialisiert eine neue Instanz der PnsCredentialsResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4ad90-102">Initializes a new instance of the PnsCredentialsResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="4ad90-103">Speicherort von Ressourcen</span><span class="sxs-lookup"><span data-stu-id="4ad90-103">Resource location</span></span></param>
        <param name="id"><span data-ttu-id="4ad90-104">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="4ad90-104">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="4ad90-105">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="4ad90-105">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="4ad90-106">Ressourcentyp</span><span class="sxs-lookup"><span data-stu-id="4ad90-106">Resource type</span></span></param>
        <param name="tags"><span data-ttu-id="4ad90-107">Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="4ad90-107">Resource tags</span></span></param>
        <param name="sku"><span data-ttu-id="4ad90-108">Die Sku des erstellten namespace</span><span class="sxs-lookup"><span data-stu-id="4ad90-108">The sku of the created namespace</span></span></param>
        <param name="apnsCredential"><span data-ttu-id="4ad90-109">Die ApnsCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-109">The ApnsCredential of the created NotificationHub</span></span></param>
        <param name="wnsCredential"><span data-ttu-id="4ad90-110">Die WnsCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-110">The WnsCredential of the created NotificationHub</span></span></param>
        <param name="gcmCredential"><span data-ttu-id="4ad90-111">Die GcmCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-111">The GcmCredential of the created NotificationHub</span></span></param>
        <param name="mpnsCredential"><span data-ttu-id="4ad90-112">Die MpnsCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-112">The MpnsCredential of the created NotificationHub</span></span></param>
        <param name="admCredential"><span data-ttu-id="4ad90-113">Die AdmCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-113">The AdmCredential of the created NotificationHub</span></span></param>
        <param name="baiduCredential"><span data-ttu-id="4ad90-114">Die BaiduCredential der erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-114">The BaiduCredential of the created NotificationHub</span></span></param>
        <summary>
            <span data-ttu-id="4ad90-115">Initialisiert eine neue Instanz der PnsCredentialsResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4ad90-115">Initializes a new instance of the PnsCredentialsResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AdmCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-116">Ruft ab oder legt die AdmCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-116">Gets or sets the AdmCredential of the created NotificationHub</span></span>
            </summary>
    ...
    <Member MemberName="ApnsCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-117">Ruft ab oder legt die ApnsCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-117">Gets or sets the ApnsCredential of the created NotificationHub</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaiduCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-118">Ruft ab oder legt die BaiduCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-118">Gets or sets the BaiduCredential of the created NotificationHub</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GcmCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-119">Ruft ab oder legt die GcmCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-119">Gets or sets the GcmCredential of the created NotificationHub</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MpnsCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-120">Ruft ab oder legt die MpnsCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-120">Gets or sets the MpnsCredential of the created NotificationHub</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WnsCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ad90-121">Ruft ab oder legt die WnsCredential des erstellten NotificationHub</span><span class="sxs-lookup"><span data-stu-id="4ad90-121">Gets or sets the WnsCredential of the created NotificationHub</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
