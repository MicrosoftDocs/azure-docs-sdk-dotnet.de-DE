<Type Name="GcmCredential" FullName="Microsoft.Azure.Management.NotificationHubs.Models.GcmCredential">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6ce8b-101">Beschreibung des eine NotificationHub-GcmCredential.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-101">Description of a NotificationHub GcmCredential.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ce8b-102">Initialisiert eine neue Instanz der GcmCredential-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-102">Initializes a new instance of the GcmCredential class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="gcmEndpoint"><span data-ttu-id="6ce8b-103">Die GCM-Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-103">The GCM endpoint.</span></span></param>
        <param name="googleApiKey"><span data-ttu-id="6ce8b-104">Der Google-API-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-104">The Google API key.</span></span></param>
        <summary>
            <span data-ttu-id="6ce8b-105">Initialisiert eine neue Instanz der GcmCredential-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-105">Initializes a new instance of the GcmCredential class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GcmEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ce8b-106">Ruft ab oder legt den GCM-Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-106">Gets or sets the GCM endpoint.</span></span>
            </summary>
    ...
    <Member MemberName="GoogleApiKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ce8b-107">Ruft ab oder legt den Google-API-Schlüssel fest.</span><span class="sxs-lookup"><span data-stu-id="6ce8b-107">Gets or sets the Google API key.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
