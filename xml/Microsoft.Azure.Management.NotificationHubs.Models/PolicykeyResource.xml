<Type Name="PolicykeyResource" FullName="Microsoft.Azure.Management.NotificationHubs.Models.PolicykeyResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44b07-101">Namespace/NotificationHub Regenerate-Schlüssel</span><span class="sxs-lookup"><span data-stu-id="44b07-101">Namespace/NotificationHub Regenerate Keys</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44b07-102">Initialisiert eine neue Instanz der PolicykeyResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="44b07-102">Initializes a new instance of the PolicykeyResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="policyKey"><span data-ttu-id="44b07-103">Der Name des Schlüssels, der für den Namespace/Notification Hub-Autorisierungsregel erneut generiert werden.</span><span class="sxs-lookup"><span data-stu-id="44b07-103">Name of the key that has to be regenerated for the Namespace/Notification Hub Authorization Rule.</span></span> <span data-ttu-id="44b07-104">Der Wert kann es sich um Primärschlüssel Schlüssel/sekundäre Server sein.</span><span class="sxs-lookup"><span data-stu-id="44b07-104">The value can be Primary Key/Secondary Key.</span></span></param>
        <summary>
            <span data-ttu-id="44b07-105">Initialisiert eine neue Instanz der PolicykeyResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="44b07-105">Initializes a new instance of the PolicykeyResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PolicyKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44b07-106">Ruft ab, oder legt ihn fest Name des Schlüssels, der für den Namespace/Notification Hub-Autorisierungsregel erneut generiert werden.</span><span class="sxs-lookup"><span data-stu-id="44b07-106">Gets or sets name of the key that has to be regenerated for the Namespace/Notification Hub Authorization Rule.</span></span> <span data-ttu-id="44b07-107">Der Wert kann es sich um Primärschlüssel Schlüssel/sekundäre Server sein.</span><span class="sxs-lookup"><span data-stu-id="44b07-107">The value can be Primary Key/Secondary Key.</span></span>
            </summary>
