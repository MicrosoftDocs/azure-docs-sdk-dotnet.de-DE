<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="f6bc1-101">Der Rückgabetyp der DnsRecordSet.UpdateDefinitionStages.WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="f6bc1-101">The return type of  DnsRecordSet.UpdateDefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="f6bc1-102">Die letzte Phase der DNS-Zone Ressourceneintragssatz Definition.</span><span class="sxs-lookup"><span data-stu-id="f6bc1-102">The final stage of the DNS zone record set definition.</span></span>
            <span data-ttu-id="f6bc1-103">Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die DNS-Zone Ressourceneintragssatz-Definition an die übergeordnete Traffic Manager-Profildefinition mit DnsRecordSet.UpdateDefinitionStages.WithAttach.attach() angefügt werden kann.</span><span class="sxs-lookup"><span data-stu-id="f6bc1-103">At this stage, any remaining optional settings can be specified, or the DNS zone record set definition can be attached to the parent traffic manager profile definition using  DnsRecordSet.UpdateDefinitionStages.WithAttach.attach().</span></span>
            </summary>
