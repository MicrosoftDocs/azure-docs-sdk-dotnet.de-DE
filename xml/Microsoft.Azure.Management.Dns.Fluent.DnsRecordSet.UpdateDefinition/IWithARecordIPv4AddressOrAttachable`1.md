<Type Name="IWithARecordIPv4AddressOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithARecordIPv4AddressOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="93073-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="93073-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="93073-102">Die Phase der A-Eintrag festgelegt Definition zulassen Hinzufügen zusätzlicher A-Datensätze oder anfügen, mit dem übergeordneten Datensatz.</span><span class="sxs-lookup"><span data-stu-id="93073-102">The stage of the A record set definition allowing to add additional A records or attach the record set to the parent.</span></span>
            </summary>
