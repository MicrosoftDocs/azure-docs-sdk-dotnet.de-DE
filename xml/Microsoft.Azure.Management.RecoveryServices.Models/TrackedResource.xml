<Type Name="TrackedResource" FullName="Microsoft.Azure.Management.RecoveryServices.Models.TrackedResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f2aab-101">Nachverfolgten Ressource mit dem Speicherort.</span><span class="sxs-lookup"><span data-stu-id="f2aab-101">Tracked resource with location.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2aab-102">Initialisiert eine neue Instanz der TrackedResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f2aab-102">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="f2aab-103">Der Ressourcenspeicherort.</span><span class="sxs-lookup"><span data-stu-id="f2aab-103">Resource location.</span></span></param>
        <param name="id"><span data-ttu-id="f2aab-104">Ressourcen-Id stellt den vollständigen Pfad zur Ressource dar.</span><span class="sxs-lookup"><span data-stu-id="f2aab-104">Resource Id represents the complete path to the resource.</span></span></param>
        <param name="name"><span data-ttu-id="f2aab-105">Ressourcennamen der Ressource zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="f2aab-105">Resource name associated with the resource.</span></span></param>
        <param name="type"><span data-ttu-id="f2aab-106">Ressourcentyp "" stellt den vollständigen Pfad des Formulars Namespace/ResourceType/ResourceType /...</span><span class="sxs-lookup"><span data-stu-id="f2aab-106">Resource type represents the complete path of the form Namespace/ResourceType/ResourceType/...</span></span></param>
        <param name="eTag"><span data-ttu-id="f2aab-107">Optionale ETag.</span><span class="sxs-lookup"><span data-stu-id="f2aab-107">Optional ETag.</span></span></param>
        <param name="tags"><span data-ttu-id="f2aab-108">Ressourcentags.</span><span class="sxs-lookup"><span data-stu-id="f2aab-108">Resource tags.</span></span></param>
        <summary>
            <span data-ttu-id="f2aab-109">Initialisiert eine neue Instanz der TrackedResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f2aab-109">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2aab-110">Ruft ab, oder legt ihn fest Ressourcenspeicherort.</span><span class="sxs-lookup"><span data-stu-id="f2aab-110">Gets or sets resource location.</span></span>
            </summary>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2aab-111">Ermittelt oder Ressourcen-Tags definiert.</span><span class="sxs-lookup"><span data-stu-id="f2aab-111">Gets or sets resource tags.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2aab-112">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="f2aab-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="f2aab-113">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="f2aab-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
