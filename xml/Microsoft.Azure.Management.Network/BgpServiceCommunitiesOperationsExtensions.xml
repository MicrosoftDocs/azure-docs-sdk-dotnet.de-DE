<Type Name="BgpServiceCommunitiesOperationsExtensions" FullName="Microsoft.Azure.Management.Network.BgpServiceCommunitiesOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1c77f-101">Erweiterungsmethoden für BgpServiceCommunitiesOperations.</span><span class="sxs-lookup"><span data-stu-id="1c77f-101">Extension methods for BgpServiceCommunitiesOperations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="1c77f-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="1c77f-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="1c77f-103">Ruft alle verfügbaren Bgp-Service-Communitys ab.</span><span class="sxs-lookup"><span data-stu-id="1c77f-103">Gets all the available bgp service communities.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="1c77f-104">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="1c77f-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="1c77f-105">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="1c77f-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="1c77f-106">Ruft alle verfügbaren Bgp-Service-Communitys ab.</span><span class="sxs-lookup"><span data-stu-id="1c77f-106">Gets all the available bgp service communities.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="1c77f-107">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="1c77f-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="1c77f-108">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="1c77f-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="1c77f-109">Ruft alle verfügbaren Bgp-Service-Communitys ab.</span><span class="sxs-lookup"><span data-stu-id="1c77f-109">Gets all the available bgp service communities.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="1c77f-110">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="1c77f-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="1c77f-111">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="1c77f-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="1c77f-112">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="1c77f-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="1c77f-113">Ruft alle verfügbaren Bgp-Service-Communitys ab.</span><span class="sxs-lookup"><span data-stu-id="1c77f-113">Gets all the available bgp service communities.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
