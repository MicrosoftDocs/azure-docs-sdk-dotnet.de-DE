<Type Name="IUpdateAaaaRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateAaaaRecordSet.IUpdateAaaaRecordSet">
  ...
  <Interfaces>
    ...
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Update.IWithAaaaRecordIPv6Address</InterfaceName>
    </Interface>
    <Interface>
  ...
  <Docs>
    <summary>
            <span data-ttu-id="78166-101">Vollständig ein (AAAA)-Ressourceneintrag Festlegung Update als Teil der übergeordneten DNS-Zone aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="78166-101">The entirety of an AAAA record set update as a part of parent DNS zone update.</span></span>
            </summary>
