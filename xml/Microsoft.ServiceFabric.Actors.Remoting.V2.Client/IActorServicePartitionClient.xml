<Type Name="IActorServicePartitionClient" FullName="Microsoft.ServiceFabric.Actors.Remoting.V2.Client.IActorServicePartitionClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a6ace-101">Definiert die Schnittstelle für den Client die Kommunikation mit einem Akteur innerhalb einer Dienstpartition.</span><span class="sxs-lookup"><span data-stu-id="a6ace-101">Defines the interface for the client that communicate with an actor within a service partition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ActorId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6ace-102">Ruft die Id des Akteurs, der diesem Client kommuniziert.</span><span class="sxs-lookup"><span data-stu-id="a6ace-102">Gets the id of the actor this client communicates with.</span></span>
            </summary>
