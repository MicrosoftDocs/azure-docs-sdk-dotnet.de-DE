<Type Name="AzureStorageLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureStorageLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b050b-101">Der LinkedService des Speicher-Konto.</span><span class="sxs-lookup"><span data-stu-id="b050b-101">The storage account linkedService.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b050b-102">Initialisiert eine neue Instanz der AzureStorageLinkedService-Klasse.</span><span class="sxs-lookup"><span data-stu-id="b050b-102">Initializes a new instance of the AzureStorageLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="b050b-103">Initialisiert eine neue Instanz der AzureStorageLinkedService-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="b050b-103">Initializes a new instance of the AzureStorageLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b050b-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="b050b-104">Required.</span></span> <span data-ttu-id="b050b-105">Verbindungszeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="b050b-105">The connection string.</span></span>
            </summary>
