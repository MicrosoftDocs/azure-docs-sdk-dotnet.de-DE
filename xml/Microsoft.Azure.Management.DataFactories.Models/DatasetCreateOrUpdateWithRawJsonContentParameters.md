<Type Name="DatasetCreateOrUpdateWithRawJsonContentParameters" FullName="Microsoft.Azure.Management.DataFactories.Models.DatasetCreateOrUpdateWithRawJsonContentParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8c09f-101">Parameter, die den unformatierten Json-Inhalt zum Erstellen oder Aktualisieren eines Datasets angeben.</span><span class="sxs-lookup"><span data-stu-id="8c09f-101">Parameters specifying the raw json content for creating or updating a Dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8c09f-102">Initialisiert eine neue Instanz der DatasetCreateOrUpdateWithRawJsonContentParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8c09f-102">Initializes a new instance of the DatasetCreateOrUpdateWithRawJsonContentParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="8c09f-103">Initialisiert eine neue Instanz der DatasetCreateOrUpdateWithRawJsonContentParameters-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="8c09f-103">Initializes a new instance of the DatasetCreateOrUpdateWithRawJsonContentParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Content">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8c09f-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="8c09f-104">Required.</span></span> <span data-ttu-id="8c09f-105">Die vom Benutzer angegebener unformatierten Json-Inhalt zum Erstellen oder Aktualisieren eines verknüpften Diensts.</span><span class="sxs-lookup"><span data-stu-id="8c09f-105">The user specified raw json content for creating or updating a Linked Service.</span></span>
            </summary>
