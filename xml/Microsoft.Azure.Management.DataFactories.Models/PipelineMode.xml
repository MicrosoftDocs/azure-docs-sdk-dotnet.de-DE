<Type Name="PipelineMode" FullName="Microsoft.Azure.Management.DataFactories.Models.PipelineMode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6b715-101">Die Methode zu planen, die für eine Pipeline ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="6b715-101">The method of scheduling runs for a pipeline.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="OneTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b715-102">"Einmalige" gibt an, dass die Pipeline nur einmal ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="6b715-102">'OneTime' indicates that the pipeline will run only once.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Scheduled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b715-103">"Geplant" gibt an, dass die Pipeline in einem angegebenen Zeitintervall gemäß seines Aktivitätszeitraums fest (Start- und End-Zeit) ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="6b715-103">'Scheduled' indicates that the pipeline will run at a specified time interval according to its active period (start and end time).</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
