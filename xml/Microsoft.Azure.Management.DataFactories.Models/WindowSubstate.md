<Type Name="WindowSubstate" FullName="Microsoft.Azure.Management.DataFactories.Models.WindowSubstate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c2c37-101">Die Enumeration für alle unterstützten Aktivität Fenster Status.</span><span class="sxs-lookup"><span data-stu-id="c2c37-101">The enum for all the supported activity window states.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ActivityResume">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-102">Die Aktivität wurde angehalten und kann nicht die Slices nicht ausführen, bis er fortgesetzt wird.</span><span class="sxs-lookup"><span data-stu-id="c2c37-102">The activity is paused and cannot run the slices until it is resumed.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Canceled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-103">Durch den Benutzer abgebrochen.</span><span class="sxs-lookup"><span data-stu-id="c2c37-103">Canceled by user action.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ComputeResources">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-104">Die Compute-Ressourcen sind nicht verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c2c37-104">The compute resources are not available.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConcurrencyLimit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-105">Alle Aktivitätsinstanzen führen andere Aktivitätsfenster aus.</span><span class="sxs-lookup"><span data-stu-id="c2c37-105">All the activity instances are busy running other activity windows.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DatasetDependencies">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-106">Die Upstream-Abhängigkeiten sind nicht bereit.</span><span class="sxs-lookup"><span data-stu-id="c2c37-106">The upstream dependencies are not ready.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Retry">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-107">Ausführung der Aktivität wird wiederholt.</span><span class="sxs-lookup"><span data-stu-id="c2c37-107">The activity execution will be retried.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ScheduledTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-108">Die geplante Zeit für das Aktivitätsfenster ausgeführt wurde noch nicht übergeben.</span><span class="sxs-lookup"><span data-stu-id="c2c37-108">The scheduled time for the activity window to run has not yet passed.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TimedOut">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-109">Ausführung dauerte länger als Zeitlimit für die Aktivität zulässig.</span><span class="sxs-lookup"><span data-stu-id="c2c37-109">Execution took longer than allowed by the activity's timeout period.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Validating">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-110">Die Überprüfung wird ausgeführt.</span><span class="sxs-lookup"><span data-stu-id="c2c37-110">Validation in progress.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Validation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-111">Überprüfung wurde nicht gestartet noch mit als auch im Status "fehlerhaft" verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="c2c37-111">Validation has not started yet, can be used with Failed state as well.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ValidationRetry">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c2c37-112">Es wird auf die Wiederholung der Überprüfung gewartet.</span><span class="sxs-lookup"><span data-stu-id="c2c37-112">Waiting for the validation to be retried.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
