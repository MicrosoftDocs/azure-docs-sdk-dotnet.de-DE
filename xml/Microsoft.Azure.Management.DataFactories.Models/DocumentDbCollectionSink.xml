<Type Name="DocumentDbCollectionSink" FullName="Microsoft.Azure.Management.DataFactories.Models.DocumentDbCollectionSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="00c5b-101">Kopieren-Aktivität Dokument Datenbanksammlung Senke.</span><span class="sxs-lookup"><span data-stu-id="00c5b-101">A copy activity Document Database Collection sink.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="NestingSeparator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="00c5b-102">Trennzeichen für geschachtelte Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="00c5b-102">Nested properties separator.</span></span>
            </summary>
