<Type Name="AzureSearchIndexSink" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9315f-101">Eine kopieren-Aktivität eine Ereignissenke für einen Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="9315f-101">A copy activity sink for an Azure Search Index.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9315f-102">Optional.</span><span class="sxs-lookup"><span data-stu-id="9315f-102">Optional.</span></span> <span data-ttu-id="9315f-103">Gibt an, wie für Upsert-Dokumenten in einen Azure Search-Index.</span><span class="sxs-lookup"><span data-stu-id="9315f-103">Specifies how to upsert documents into an Azure Search Index.</span></span>
            <span data-ttu-id="9315f-104">Muss einer der <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexWriteBehavior" />.</span><span class="sxs-lookup"><span data-stu-id="9315f-104">Must be one of <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexWriteBehavior" />.</span></span> <span data-ttu-id="9315f-105">Der Standardwert ist "Merge", wenn kein Wert angegeben wird.</span><span class="sxs-lookup"><span data-stu-id="9315f-105">The default value is 'Merge' if no value is specified.</span></span>
            </summary>
