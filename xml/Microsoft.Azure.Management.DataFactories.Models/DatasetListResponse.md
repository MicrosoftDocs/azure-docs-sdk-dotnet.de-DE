<Type Name="DatasetListResponse" FullName="Microsoft.Azure.Management.DataFactories.Models.DatasetListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9dc73-101">Die Liste Datasets Operation-Antwort.</span><span class="sxs-lookup"><span data-stu-id="9dc73-101">The List Datasets operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9dc73-102">Initialisiert eine neue Instanz der DatasetListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9dc73-102">Initializes a new instance of the DatasetListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="9dc73-103">Initialisiert eine neue Instanz der DatasetListResponse-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="9dc73-103">Initializes a new instance of the DatasetListResponse class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Datasets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9dc73-104">Eine Liste der zurückgegebenen Dataset-Instanzen.</span><span class="sxs-lookup"><span data-stu-id="9dc73-104">A list of the returned Dataset instances.</span></span>
            </summary>
    ...
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9dc73-105">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="9dc73-105">Required.</span></span> <span data-ttu-id="9dc73-106">Der Link (Url) auf die nächste Seite der Ergebnisse.</span><span class="sxs-lookup"><span data-stu-id="9dc73-106">The link (url) to the next page of results.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
