<Type Name="SqlDWSource" FullName="Microsoft.Azure.Management.DataFactories.Models.SqlDWSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="af6c9-101">Eine SQL Data Warehouse-Quelle kopieren-Aktivität.</span><span class="sxs-lookup"><span data-stu-id="af6c9-101">A copy activity SQL Data Warehouse source.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="SqlReaderQuery">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af6c9-102">SQL Datawarehouse-Reader-Abfrage.</span><span class="sxs-lookup"><span data-stu-id="af6c9-102">SQL data warehouse reader query.</span></span>
            </summary>
    ...
    <Member MemberName="SqlReaderStoredProcedureName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af6c9-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="af6c9-103">Optional.</span></span> <span data-ttu-id="af6c9-104">Der Name der gespeicherten Prozedur für eine SQL Data Warehouse-Datenquelle.</span><span class="sxs-lookup"><span data-stu-id="af6c9-104">Name of the stored procedure for a SQL Data Warehouse source.</span></span> <span data-ttu-id="af6c9-105">Dies kann nicht gleichzeitig als die SqlReaderQuery verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="af6c9-105">This cannot be used at the same time as SqlReaderQuery.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StoredProcedureParameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af6c9-106">Optional.</span><span class="sxs-lookup"><span data-stu-id="af6c9-106">Optional.</span></span> <span data-ttu-id="af6c9-107">Wert und Typ für Parameter gespeicherter Prozeduren festlegen.</span><span class="sxs-lookup"><span data-stu-id="af6c9-107">Value and type setting for stored procedure parameters.</span></span> <span data-ttu-id="af6c9-108">Beispiel: "{Parameter1: {Wert:"1", Typ:"Int"}}".</span><span class="sxs-lookup"><span data-stu-id="af6c9-108">Example: "{Parameter1: {value: "1", type: "int"}}".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
