<Type Name="HDInsightHiveActivity" FullName="Microsoft.Azure.Management.DataFactories.Models.HDInsightHiveActivity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0c3b3-101">Hive-Aktivität, die auf HDInsight ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-101">Hive activity which runs on HDInsight.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c3b3-102">Initialisiert eine neue Instanz der HDInsightHiveActivity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-102">Initializes a new instance of the HDInsightHiveActivity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Defines">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c3b3-103">Ermöglicht Benutzer Folgendes definiert für Hive-Auftrag-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-103">Allows user to specify defines for Hive job request.</span></span>
            </summary>
    ...
    <Member MemberName="Script">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c3b3-104">Hive-Skript.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-104">Hive script.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScriptLinkedService">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c3b3-105">Speicher verknüpften Dienst, in dem die Skriptdatei gespeichert ist.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-105">Storage linked service where the script file is located.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScriptPath">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c3b3-106">Der Pfad zum Skript im Blob-Speicher.</span><span class="sxs-lookup"><span data-stu-id="0c3b3-106">Path to the script in blob storage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
