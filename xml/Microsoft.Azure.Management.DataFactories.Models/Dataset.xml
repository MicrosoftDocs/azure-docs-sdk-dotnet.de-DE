<Type Name="Dataset" FullName="Microsoft.Azure.Management.DataFactories.Models.Dataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6b5e1-101">Ein Dataset definiert das Schema der Daten als auch seinen Speicher.</span><span class="sxs-lookup"><span data-stu-id="6b5e1-101">A Dataset defines the schema of the data as well as its storage.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b5e1-102">Initialisiert eine neue Instanz der Dataset-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6b5e1-102">Initializes a new instance of the Dataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="6b5e1-103">Initialisiert eine neue Instanz der Dataset-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="6b5e1-103">Initializes a new instance of the Dataset class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b5e1-104">Der Name des Datasets.</span><span class="sxs-lookup"><span data-stu-id="6b5e1-104">Name of the Dataset.</span></span>
            </summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b5e1-105">Dataset-Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="6b5e1-105">Dataset properties.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
