<Type Name="DotNetActivity" FullName="Microsoft.Azure.Management.DataFactories.Models.DotNetActivity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ee53a-101">.NET-Aktivität.</span><span class="sxs-lookup"><span data-stu-id="ee53a-101">.NET activity.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="AssemblyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ee53a-102">Der Name der Assembly.</span><span class="sxs-lookup"><span data-stu-id="ee53a-102">Assembly name.</span></span>
            </summary>
    ...
    <Member MemberName="EntryPoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ee53a-103">Einstiegspunkt.</span><span class="sxs-lookup"><span data-stu-id="ee53a-103">Entry point.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ExtendedProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ee53a-104">Benutzerdefinierter Eigenschaftenbehälter.</span><span class="sxs-lookup"><span data-stu-id="ee53a-104">User defined property bag.</span></span> <span data-ttu-id="ee53a-105">Es gibt keine Einschränkung für den Schlüssel oder Werte, die verwendet werden können.</span><span class="sxs-lookup"><span data-stu-id="ee53a-105">There is no restriction on the keys or values that can be used.</span></span> <span data-ttu-id="ee53a-106">Der Benutzer angegeben, dass .NET Aktivität hat die volle Verantwortung zu nutzen und interpretieren den Inhalt definiert.</span><span class="sxs-lookup"><span data-stu-id="ee53a-106">The user specified .NET activity has the full responsibility to consume and interpret the content defined.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PackageFile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ee53a-107">Die Paketdatei.</span><span class="sxs-lookup"><span data-stu-id="ee53a-107">Package file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PackageLinkedService">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ee53a-108">Paket verknüpften Dienst an.</span><span class="sxs-lookup"><span data-stu-id="ee53a-108">Package linked service.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
