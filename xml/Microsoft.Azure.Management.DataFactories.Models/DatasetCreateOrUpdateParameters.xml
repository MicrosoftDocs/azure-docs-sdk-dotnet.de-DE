<Type Name="DatasetCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.DataFactories.Models.DatasetCreateOrUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cab10-101">Parameter, die, die aus des Datasets erstellt oder aktualisiert werden.</span><span class="sxs-lookup"><span data-stu-id="cab10-101">Parameters specifying the Dataset to be created or updated.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Dataset">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cab10-102">Die Definition des Datasets erstellt oder aktualisiert werden.</span><span class="sxs-lookup"><span data-stu-id="cab10-102">The definition of the Dataset to be created or updated.</span></span>
            </summary>
