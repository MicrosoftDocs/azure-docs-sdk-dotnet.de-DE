<Type Name="GatewayRegenerateAuthKeyResponse" FullName="Microsoft.Azure.Management.DataFactories.Models.GatewayRegenerateAuthKeyResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e1ca1-101">Regenerate Gateway Authentication Key Antworten für den Vorgang.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-101">The regenerate gateway auth key operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1ca1-102">Initialisiert eine neue Instanz der GatewayRegenerateAuthKeyResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-102">Initializes a new instance of the GatewayRegenerateAuthKeyResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Key1">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1ca1-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-103">Optional.</span></span> <span data-ttu-id="e1ca1-104">Neu generierten Auth gatewayschlüssel 1.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-104">Regenerated gateway auth key 1.</span></span>
            </summary>
    ...
    <Member MemberName="Key2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e1ca1-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-105">Optional.</span></span> <span data-ttu-id="e1ca1-106">Neu generierten Auth gatewayschlüssel 2.</span><span class="sxs-lookup"><span data-stu-id="e1ca1-106">Regenerated gateway auth key 2.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
