<Type Name="AzureSqlTableDataset" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSqlTableDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="23228-101">Die Azure SQL Server-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="23228-101">The Azure SQL Server database.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23228-102">Der Tabellenname der Azure SQL-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="23228-102">The table name of the Azure SQL database.</span></span>
            </summary>
