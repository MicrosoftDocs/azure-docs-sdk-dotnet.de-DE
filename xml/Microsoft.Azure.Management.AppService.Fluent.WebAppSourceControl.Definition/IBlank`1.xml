<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppSourceControl.Definition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="8a00a-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="8a00a-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="8a00a-102">Die erste Phase der Web-app Quelle Steuerelementdefinition als Teil der Definition einer Web-app.</span><span class="sxs-lookup"><span data-stu-id="8a00a-102">The first stage of a web app source control definition as part of a definition of a web app.</span></span>
            </summary>
