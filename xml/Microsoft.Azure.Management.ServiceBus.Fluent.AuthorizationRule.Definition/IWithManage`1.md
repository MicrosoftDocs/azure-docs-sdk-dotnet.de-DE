<Type Name="IWithManage&lt;T&gt;" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.AuthorizationRule.Definition.IWithManage&lt;T&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="T"><span data-ttu-id="7f1ff-101">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="7f1ff-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="7f1ff-102">Die Phase der der Service Bus-Autorisierung Regeldefinition aktivieren ermöglicht Richtlinien verwalten.</span><span class="sxs-lookup"><span data-stu-id="7f1ff-102">The stage of the Service Bus authorization rule definition allowing to enable manage policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithManagementEnabled">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="7f1ff-103">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="7f1ff-103">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>