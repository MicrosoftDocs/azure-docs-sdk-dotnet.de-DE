<Type Name="IOAuthOperations" FullName="Microsoft.Azure.Management.DataFactories.Core.IOAuthOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="833cf-101">Vorgänge für das OAuth-autorisierungen.</span><span class="sxs-lookup"><span data-stu-id="833cf-101">Operations for OAuth authorizations.</span></span>
            </summary>
    ...
    <Member MemberName="GetAsync">
      ...
      <Docs>
        <param name="resourceGroupName">
            <span data-ttu-id="833cf-102">Der Ressourcengruppenname der Data Factory.</span><span class="sxs-lookup"><span data-stu-id="833cf-102">The resource group name of the data factory.</span></span>
            </param>
        <param name="dataFactoryName">
            <span data-ttu-id="833cf-103">Eine eindeutige Data Factory-Instanzname.</span><span class="sxs-lookup"><span data-stu-id="833cf-103">A unique data factory instance name.</span></span>
            </param>
        <param name="linkedServiceType">
            <span data-ttu-id="833cf-104">Der Typ des verknüpften OAuth-Dienst.</span><span class="sxs-lookup"><span data-stu-id="833cf-104">The type of OAuth linked service.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="833cf-105">Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="833cf-105">Cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="833cf-106">Ruft eine Sitzung für OAuth Authorization ab.</span><span class="sxs-lookup"><span data-stu-id="833cf-106">Gets an OAuth authorization session.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="833cf-107">Get-Autorisierung Sitzung Antworten für den Vorgang.</span><span class="sxs-lookup"><span data-stu-id="833cf-107">The Get authorization session operation response.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
