<Type Name="RunbookCreateOrUpdateDraftParameters" FullName="Microsoft.Azure.Management.Automation.Models.RunbookCreateOrUpdateDraftParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c862e-101">Die Parameter für das Runbook erstellen oder Aktualisieren zur Verfügung gestellt.</span><span class="sxs-lookup"><span data-stu-id="c862e-101">The parameters supplied to the create or update runbook operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c862e-102">Initialisiert eine neue Instanz der RunbookCreateOrUpdateDraftParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c862e-102">Initializes a new instance of the RunbookCreateOrUpdateDraftParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="c862e-103">Initialisiert eine neue Instanz der RunbookCreateOrUpdateDraftParameters-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="c862e-103">Initializes a new instance of the RunbookCreateOrUpdateDraftParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c862e-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="c862e-104">Required.</span></span> <span data-ttu-id="c862e-105">Ruft ab oder legt ihn fest-runbookentwurfs erstellen oder Aktualisieren von Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="c862e-105">Gets or sets runbook draft create or update properties.</span></span>
            </summary>
