<Type Name="DscNodeReportListParameters" FullName="Microsoft.Azure.Management.Automation.Models.DscNodeReportListParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a4d6f-101">Die Parameter für den Auftragsvorgang Liste angegeben.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-101">The parameters supplied to the list job operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4d6f-102">Initialisiert eine neue Instanz der DscNodeReportListParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-102">Initializes a new instance of the DscNodeReportListParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4d6f-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-103">Optional.</span></span> <span data-ttu-id="a4d6f-104">Für das Ende sollte Zeitfilter der Wert eine Datetime-Zeichenfolge im UTC-Format gemäß ISO 8601 sein.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-104">For the end time filter the value should be a datetime string in UTC format as defined in ISO 8601.</span></span> <span data-ttu-id="a4d6f-105">Zum Beispiel: 2014-09-25T17:49:17.2252204Z</span><span class="sxs-lookup"><span data-stu-id="a4d6f-105">For example, 2014-09-25T17:49:17.2252204Z</span></span>
            </summary>
    ...
    <Member MemberName="NodeId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4d6f-106">Optional.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-106">Optional.</span></span> <span data-ttu-id="a4d6f-107">Ruft ab oder legt die Knoten-Id.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-107">Gets or sets the the node id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4d6f-108">Optional.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-108">Optional.</span></span> <span data-ttu-id="a4d6f-109">Für den Beginn sollten Zeitfilter der Wert eine Datetime-Zeichenfolge im UTC-Format gemäß ISO 8601 sein.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-109">For the start time filter the value should be a datetime string in UTC format as defined in ISO 8601.</span></span> <span data-ttu-id="a4d6f-110">Zum Beispiel: 2014-09-25T17:49:17.2252204Z</span><span class="sxs-lookup"><span data-stu-id="a4d6f-110">For example, 2014-09-25T17:49:17.2252204Z</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a4d6f-111">Optional.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-111">Optional.</span></span> <span data-ttu-id="a4d6f-112">Ruft ab oder legt den Typ des Knotens Berichts fest.</span><span class="sxs-lookup"><span data-stu-id="a4d6f-112">Gets or sets the type of the node report.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
