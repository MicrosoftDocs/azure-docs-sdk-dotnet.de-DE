<Type Name="UsageListResponse" FullName="Microsoft.Azure.Management.Automation.Models.UsageListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a97a5-101">Das Antwort-Modell für den Abrufvorgang für die Verwendung.</span><span class="sxs-lookup"><span data-stu-id="a97a5-101">The response model for the get usage operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a97a5-102">Initialisiert eine neue Instanz der UsageListResponse-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a97a5-102">Initializes a new instance of the UsageListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a97a5-103">Ruft die Sequenz der Nutzung ab.</span><span class="sxs-lookup"><span data-stu-id="a97a5-103">Gets the sequence of Usage.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a97a5-104">Ruft die Sequenz der Nutzung ab.</span><span class="sxs-lookup"><span data-stu-id="a97a5-104">Gets the sequence of Usage.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Usage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a97a5-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="a97a5-105">Optional.</span></span> <span data-ttu-id="a97a5-106">Ruft ab oder legt Verwendung fest.</span><span class="sxs-lookup"><span data-stu-id="a97a5-106">Gets or sets usage.</span></span>
            </summary>
