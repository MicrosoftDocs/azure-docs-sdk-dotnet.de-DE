<Type Name="DscCompilationJobProperties" FullName="Microsoft.Azure.Management.Automation.Models.DscCompilationJobProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="513e9-101">Definition der Auftragseigenschaften Dsc-Kompilierung.</span><span class="sxs-lookup"><span data-stu-id="513e9-101">Definition of Dsc Compilation job properties.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="513e9-102">Initialisiert eine neue Instanz der DscCompilationJobProperties-Klasse.</span><span class="sxs-lookup"><span data-stu-id="513e9-102">Initializes a new instance of the DscCompilationJobProperties class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Configuration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="513e9-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="513e9-103">Optional.</span></span> <span data-ttu-id="513e9-104">Ruft ab oder legt die Konfiguration fest.</span><span class="sxs-lookup"><span data-stu-id="513e9-104">Gets or sets the configuration.</span></span>
            </summary>
    ...
    <Member MemberName="StartedBy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="513e9-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="513e9-105">Optional.</span></span> <span data-ttu-id="513e9-106">Abrufen oder Festlegen der Kompilierungsauftrag von gestartet.</span><span class="sxs-lookup"><span data-stu-id="513e9-106">Gets or sets the compilation job started by.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
