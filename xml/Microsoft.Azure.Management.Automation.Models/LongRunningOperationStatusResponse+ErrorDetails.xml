<Type Name="LongRunningOperationStatusResponse+ErrorDetails" FullName="Microsoft.Azure.Management.Automation.Models.LongRunningOperationStatusResponse+ErrorDetails">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b8063-101">Wenn der asynchrone Vorgang fehlgeschlagen ist, wird der Antworttext enthält den HTTP-Statuscode für die fehlerhafte Anforderung, und enthält auch Informationen zum Fehler.</span><span class="sxs-lookup"><span data-stu-id="b8063-101">If the asynchronous operation failed, the response body includes the HTTP status code for the failed request, and also includes error information regarding the failure.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b8063-102">Initialisiert eine neue Instanz der Klasse ErrorDetails an.</span><span class="sxs-lookup"><span data-stu-id="b8063-102">Initializes a new instance of the ErrorDetails class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b8063-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="b8063-103">Optional.</span></span> <span data-ttu-id="b8063-104">Der Fehlercode des Management-Dienst wird zurückgegeben, wenn die asynchrone Anforderung fehlgeschlagen ist.</span><span class="sxs-lookup"><span data-stu-id="b8063-104">The management service error code returned if the asynchronous request failed.</span></span>
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b8063-105">Optional.</span><span class="sxs-lookup"><span data-stu-id="b8063-105">Optional.</span></span> <span data-ttu-id="b8063-106">Die Management-Fehlermeldung zurückgegeben, wenn die asynchrone Anforderung fehlgeschlagen ist.</span><span class="sxs-lookup"><span data-stu-id="b8063-106">The management service error message returned if the asynchronous request failed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
