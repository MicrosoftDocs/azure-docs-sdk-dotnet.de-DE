<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.DomainContact.Definition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c9000-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="c9000-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="c9000-102">Die letzte Stufe der Domäne, wenden Sie sich an die Definition.</span><span class="sxs-lookup"><span data-stu-id="c9000-102">The final stage of the domain contact definition.</span></span>
            <span data-ttu-id="c9000-103">Zu diesem Zeitpunkt alle verbleibenden Einstellungen an optionalen können angegeben werden, oder die Domänendefinition wenden Sie sich an der Definition des übergeordneten Domäne mit WithAttach.attach() angefügt werden kann.</span><span class="sxs-lookup"><span data-stu-id="c9000-103">At this stage, any remaining optional settings can be specified, or the domain contact definition can be attached to the parent domain definition using  WithAttach.attach().</span></span>
            </summary>
