<Type Name="ITenant" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.ITenant">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="95ba9-101">Eine unveränderliche clientseitige Darstellung von einem Azure-Mandanten.</span><span class="sxs-lookup"><span data-stu-id="95ba9-101">An immutable client-side representation of an Azure tenant.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="TenantId">
      ...
      <Docs>
        ...
        <value><span data-ttu-id="95ba9-102">eine UUID des Mandanten</span><span class="sxs-lookup"><span data-stu-id="95ba9-102">a UUID of the tenant</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
