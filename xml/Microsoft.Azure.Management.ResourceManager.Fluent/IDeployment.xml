<Type Name="IDeployment" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.IDeployment">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="81c0b-101">Eine unveränderliche clientseitige Darstellung einer Azure-Bereitstellung.</span><span class="sxs-lookup"><span data-stu-id="81c0b-101">An immutable client-side representation of an Azure deployment.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Cancel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="81c0b-102">Abbrechen einer derzeit ausgeführten vorlagenbereitstellung.</span><span class="sxs-lookup"><span data-stu-id="81c0b-102">Cancel a currently running template deployment.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CancelAsync">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="81c0b-103">Abbrechen einer derzeit ausgeführten vorlagenbereitstellung.</span><span class="sxs-lookup"><span data-stu-id="81c0b-103">Cancel a currently running template deployment.</span></span>
            </summary>
    ...
    <Member MemberName="CorrelationId">
      ...
      <Docs>
        ...
        <value><span data-ttu-id="81c0b-104">die Korrelations-ID der Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="81c0b-104">the correlation ID of the deployment</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dependencies">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-105">die Liste der bereitstellungsabhängigkeiten</span><span class="sxs-lookup"><span data-stu-id="81c0b-105">the list of deployment dependencies</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeploymentOperations">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-106">die Vorgänge im Zusammenhang mit dieser Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="81c0b-106">the operations related to this deployment</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ExportTemplate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="81c0b-107">Exportiert eine Bereitstellungsvorlage an.</span><span class="sxs-lookup"><span data-stu-id="81c0b-107">Exports a deployment template.</span></span>
            </summary>
        <returns><span data-ttu-id="81c0b-108">Das Ergebnis exportieren</span><span class="sxs-lookup"><span data-stu-id="81c0b-108">the export result</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ExportTemplateAsync">
      ...
      <Docs>
        <param name="cancellationToken">To be added.</param>
        <summary>
            <span data-ttu-id="81c0b-109">Exportiert eine Bereitstellungsvorlage an.</span><span class="sxs-lookup"><span data-stu-id="81c0b-109">Exports a deployment template.</span></span>
            </summary>
        <returns><span data-ttu-id="81c0b-110">Das Ergebnis exportieren</span><span class="sxs-lookup"><span data-stu-id="81c0b-110">the export result</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-111">Der Bereitstellungsmodus.</span><span class="sxs-lookup"><span data-stu-id="81c0b-111">the deployment mode.</span></span> <span data-ttu-id="81c0b-112">Mögliche Werte sind:</span><span class="sxs-lookup"><span data-stu-id="81c0b-112">Possible values include:</span></span></value>
        <value><span data-ttu-id="81c0b-113">"Inkrementell", "Abgeschlossen".</span><span class="sxs-lookup"><span data-stu-id="81c0b-113">'Incremental', 'Complete'.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Outputs">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-114">Schlüssel/Wert-Paare, die Bereitstellung Ausgabe darstellen.</span><span class="sxs-lookup"><span data-stu-id="81c0b-114">key/value pairs that represent deployment output</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-115">der Bereitstellungsparameter</span><span class="sxs-lookup"><span data-stu-id="81c0b-115">the deployment parameters</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ParametersLink">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-116">Der URI-verweisen auf die Parameter</span><span class="sxs-lookup"><span data-stu-id="81c0b-116">the URI referencing the parameters</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Providers">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-117">die Liste der für die Bereitstellung erforderlichen Ressourcenanbieter</span><span class="sxs-lookup"><span data-stu-id="81c0b-117">the list of resource providers needed for the deployment</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-118">der Status des Bereitstellungsvorgangs Ressourcen bereitgestellt wird</span><span class="sxs-lookup"><span data-stu-id="81c0b-118">the state of the provisioning process of the resources being deployed</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ResourceGroupName">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-119">der Name der Ressourcengruppe für diese Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="81c0b-119">the name of this deployment's resource group</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Template">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-120">der Inhalt der Vorlage</span><span class="sxs-lookup"><span data-stu-id="81c0b-120">the template content</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TemplateLink">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-121">Der URI, der auf die Vorlage verweist</span><span class="sxs-lookup"><span data-stu-id="81c0b-121">the URI referencing the template</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="81c0b-122">der Zeitstempel der vorlagenbereitstellung</span><span class="sxs-lookup"><span data-stu-id="81c0b-122">the timestamp of the template deployment</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
