<Type Name="IDeployments" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.IDeployments">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5b559-101">Einstiegspunkt für einen vorlagenbereitstellung in Azure.</span><span class="sxs-lookup"><span data-stu-id="5b559-101">Entry point to template deployment in Azure.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CheckExistence">
      ...
      <Docs>
        <param name="resourceGroupName"><span data-ttu-id="5b559-102">ResourceGroupName Name der Ressourcengruppe</span><span class="sxs-lookup"><span data-stu-id="5b559-102">resourceGroupName the resource group's name</span></span></param>
        <param name="deploymentName"><span data-ttu-id="5b559-103">%deploymentname den Namen der Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="5b559-103">deploymentName the deployment's name</span></span></param>
        <summary>
            <span data-ttu-id="5b559-104">Überprüft, ob eine Bereitstellung in einer Ressourcengruppe vorhanden ist.</span><span class="sxs-lookup"><span data-stu-id="5b559-104">Checks if a deployment exists in a resource group.</span></span>
            </summary>
        <returns><span data-ttu-id="5b559-105">"true", wenn die Bereitstellung vorhanden ist; "false" andernfalls</span><span class="sxs-lookup"><span data-stu-id="5b559-105">true if the deployment exists; false otherwise</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
