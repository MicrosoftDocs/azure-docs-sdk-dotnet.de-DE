<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.EventHub.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e3b6c-101">Erweiterungsmethoden für Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="e3b6c-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="e3b6c-103">Zeigt eine Liste aller verfügbaren Event Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-103">Lists all of the available Event Hub REST API operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="e3b6c-104">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="e3b6c-105">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="e3b6c-106">Zeigt eine Liste aller verfügbaren Event Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-106">Lists all of the available Event Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="e3b6c-107">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="e3b6c-108">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="e3b6c-109">Zeigt eine Liste aller verfügbaren Event Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-109">Lists all of the available Event Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="e3b6c-110">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="e3b6c-111">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="e3b6c-112">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="e3b6c-113">Zeigt eine Liste aller verfügbaren Event Hub-REST-API-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="e3b6c-113">Lists all of the available Event Hub REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
