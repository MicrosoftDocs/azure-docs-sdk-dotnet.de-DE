<Type Name="ResourceMoveDefinition" FullName="Microsoft.Azure.Management.Sql.Models.ResourceMoveDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="29e94-101">Enthält die erforderlichen Informationen für eine Ressource verschieben (Umbenennen) ausführen.</span><span class="sxs-lookup"><span data-stu-id="29e94-101">Contains the information necessary to perform a resource move (rename).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29e94-102">Initialisiert eine neue Instanz der ResourceMoveDefinition-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29e94-102">Initializes a new instance of the ResourceMoveDefinition class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="29e94-103">Die Ziel-ID für die Ressource</span><span class="sxs-lookup"><span data-stu-id="29e94-103">The target ID for the resource</span></span></param>
        <summary>
            <span data-ttu-id="29e94-104">Initialisiert eine neue Instanz der ResourceMoveDefinition-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29e94-104">Initializes a new instance of the ResourceMoveDefinition class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29e94-105">Ruft ab oder legt die Ziel-ID für die Ressource</span><span class="sxs-lookup"><span data-stu-id="29e94-105">Gets or sets the target ID for the resource</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29e94-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="29e94-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="29e94-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="29e94-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
