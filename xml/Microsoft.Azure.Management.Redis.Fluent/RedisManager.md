<Type Name="RedisManager" FullName="Microsoft.Azure.Management.Redis.Fluent.RedisManager">
  ...
  <Members>
    ...
    <Member MemberName="Configure">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="72f06-101">Eine konfigurierbare Instanz zurückgegeben, die zum Erstellen von RedisManager mit optionale Konfiguration verwendet werden kann.</span><span class="sxs-lookup"><span data-stu-id="72f06-101">Returns a Configurable instance that can be used to create RedisManager with optional configuration.</span></span>
            </summary>
        <returns><span data-ttu-id="72f06-102">die Instanz, sodass Konfigurationen</span><span class="sxs-lookup"><span data-stu-id="72f06-102">The instance allowing configurations</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
