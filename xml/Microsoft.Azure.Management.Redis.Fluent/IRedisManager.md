<Type Name="IRedisManager" FullName="Microsoft.Azure.Management.Redis.Fluent.IRedisManager">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e4aed-101">Der Einstiegspunkt für Azure Redis Cache-Verwaltung.</span><span class="sxs-lookup"><span data-stu-id="e4aed-101">Entry point to Azure Redis Cache management.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="RedisCaches">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e4aed-102">Ruft die Redis-Cache-Management-API-Einstiegspunkt an.</span><span class="sxs-lookup"><span data-stu-id="e4aed-102">Gets the Redis Cache management API entry point.</span></span>
            </summary>
