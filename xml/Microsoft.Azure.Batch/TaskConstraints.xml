<Type Name="TaskConstraints" FullName="Microsoft.Azure.Batch.TaskConstraints">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="05848-101">Definiert die Beschränkungen auf eine bestimmte Azure Batch-Aufgabe.</span><span class="sxs-lookup"><span data-stu-id="05848-101">Defines the constraints on a particular Azure Batch task.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="maxWallClockTime"><span data-ttu-id="05848-102">Die maximal verstrichene Zeit, die der Task ausgeführt werden kann, gemessen ab dem Zeitpunkt der Task beginnt.</span><span class="sxs-lookup"><span data-stu-id="05848-102">The maximum elapsed time that the task may run, measured from the time the task starts.</span></span></param>
        <param name="retentionTime"><span data-ttu-id="05848-103">Die minimale Zeit, das Arbeitsverzeichnis für den Task auf den Computeknoten beizubehalten, wo es ab dem Zeitpunkt Lief, Ausführung abgeschlossen ist.</span><span class="sxs-lookup"><span data-stu-id="05848-103">The minimum time to retain the working directory for the task on the compute node where it ran, from the time it completes execution.</span></span> <span data-ttu-id="05848-104">Nach dieser Zeit kann der Batch-Dienst das Arbeitsverzeichnis und der gesamte Inhalt löschen.</span><span class="sxs-lookup"><span data-stu-id="05848-104">After this time, the Batch service may delete the working directory and all its contents.</span></span></param>
        <param name="maxTaskRetryCount"><span data-ttu-id="05848-105">Die maximale Anzahl von Wiederholungen für den Task.</span><span class="sxs-lookup"><span data-stu-id="05848-105">The maximum number of retries for the task.</span></span></param>
        <summary>
            <span data-ttu-id="05848-106">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Batch.TaskConstraints" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="05848-106">Initializes a new instance of the <see cref="T:Microsoft.Azure.Batch.TaskConstraints" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MaxTaskRetryCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="05848-107">Ruft ab oder legt die maximale Anzahl von Wiederholungen für den Task.</span><span class="sxs-lookup"><span data-stu-id="05848-107">Gets or sets the maximum number of retries for the task.</span></span>
            </summary>
    ...
    <Member MemberName="MaxWallClockTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="05848-108">Ruft ab oder legt die maximale Zeitspanne, die der Task ausgeführt werden kann, gemessen ab dem Zeitpunkt, den der Task beginnt.</span><span class="sxs-lookup"><span data-stu-id="05848-108">Gets or sets the maximum elapsed time that the task may run, measured from the time the task starts.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetentionTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="05848-109">Ruft ab oder legt das früheste für das Arbeitsverzeichnis für den Task auf den Computeknoten beibehalten werden sollen, auf dem ausgeführt, ab dem Zeitpunkt, die Ausführung abgeschlossen ist.</span><span class="sxs-lookup"><span data-stu-id="05848-109">Gets or sets the minimum time to retain the working directory for the task on the compute node where it ran, from the time it completes execution.</span></span> <span data-ttu-id="05848-110">Nach dieser Zeit kann der Batch-Dienst das Arbeitsverzeichnis und der gesamte Inhalt löschen.</span><span class="sxs-lookup"><span data-stu-id="05848-110">After this time, the Batch service may delete the working directory and all its contents.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
