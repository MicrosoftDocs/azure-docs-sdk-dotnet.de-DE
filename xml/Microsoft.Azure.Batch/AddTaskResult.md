<Type Name="AddTaskResult" FullName="Microsoft.Azure.Batch.AddTaskResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fbce6-101">Auslöser für eine einzelne Aufgabe, die als Teil einer Auflistung von Aufgaben hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-101">Result for a single task added as part of a collection of tasks.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Error">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-102">Ruft den Fehler erfasst, während der Task hinzufügen möchten.</span><span class="sxs-lookup"><span data-stu-id="fbce6-102">Gets the error caught while attempting to add the task.</span></span>
            </summary>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-103">Ruft ein ETag verknüpft sind mit einem Task wurde erfolgreich hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-103">Gets an ETag associated with a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-104">Ruft die Uhrzeit der letzten Änderung verknüpft sind mit einem Task wurde erfolgreich hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-104">Gets the last modified time associated with a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-105">Ruft die URL einer Aufgabe wurde erfolgreich hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-105">Gets the URL of a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetryCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-106">Ruft die Anzahl der Häufigkeit, mit die der Vorgang des Agentverwaltungstasks hinzufügen wiederholt wurde für diese Aufgabe ab.</span><span class="sxs-lookup"><span data-stu-id="fbce6-106">Gets the number of times the Add Task operation was retried for this task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-107">Ruft den Status der Anforderung zum Hinzufügen eines Vorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="fbce6-107">Gets the status of the add task request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Task">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-108">Ruft die Details der Aufgabe ab.</span><span class="sxs-lookup"><span data-stu-id="fbce6-108">Gets details of the task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TaskId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-109">Ruft die Id der Aufgabe, die dieses Ergebnis gilt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-109">Gets the id of the task which this result applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fbce6-110">Gibt eine Zeichenfolge zurück, die das aktuelle Objekt darstellt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-110">Returns a string that represents the current object.</span></span>
            </summary>
        <returns><span data-ttu-id="fbce6-111">Eine Zeichenfolge, die das aktuelle Objekt darstellt.</span><span class="sxs-lookup"><span data-stu-id="fbce6-111">A string that represents the current object.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
