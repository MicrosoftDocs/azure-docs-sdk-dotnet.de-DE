<Type Name="JobStatistics" FullName="Microsoft.Azure.Batch.JobStatistics">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8a02c-101">Statistiken zum Ressourceneinsatz während des Auftrags.</span><span class="sxs-lookup"><span data-stu-id="8a02c-101">Resource usage statistics for the job.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="FailedTaskCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-102">Ruft die Gesamtanzahl der Taskfehler im Auftrag.</span><span class="sxs-lookup"><span data-stu-id="8a02c-102">Gets the total number of task failures in the job.</span></span>
            </summary>
    ...
    <Member MemberName="KernelCpuTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-103">Ruft die gesamten Kernel CPU-Zeit im (pro Kern) aller Aufgaben im Auftrag ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-103">Gets the total kernel mode CPU time (per core) consumed by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastUpdateTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-104">Ruft den Zeitpunkt, an dem die Statistik zuletzt aktualisiert wurden.</span><span class="sxs-lookup"><span data-stu-id="8a02c-104">Gets the time at which the statistics were last updated.</span></span> <span data-ttu-id="8a02c-105">Alle Statistiken sind beschränkt auf den Bereich zwischen <see cref="P:Microsoft.Azure.Batch.JobStatistics.StartTime" /> und diesen Wert.</span><span class="sxs-lookup"><span data-stu-id="8a02c-105">All statistics are limited to the range between <see cref="P:Microsoft.Azure.Batch.JobStatistics.StartTime" /> and this value.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadIOGiB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-106">Ruft die gesamte Gibibytes e/a-Lesevorgängen aller Aufgaben im Auftrag vom Datenträger ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-106">Gets the total gibibytes of I/O read from disk by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadIOps">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-107">Ruft die Gesamtanzahl der Datenträger-Lesevorgänge aller Aufgaben im Auftrag ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-107">Gets the total number of disk read operations made by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-108">Ruft die Startzeit des Zeitraums, der von den Statistiken abgedeckt.</span><span class="sxs-lookup"><span data-stu-id="8a02c-108">Gets the start time of the time range covered by the statistics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SucceededTaskCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-109">Ruft die Gesamtzahl der Aufgaben im Auftrag während des angegebenen Zeitraums erfolgreich abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="8a02c-109">Gets the total number of tasks successfully completed in the job during the given time range.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TaskRetryCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-110">Ruft die Gesamtanzahl der Wiederholungen Aufgabe im Auftrag.</span><span class="sxs-lookup"><span data-stu-id="8a02c-110">Gets the total number of task retries in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-111">Die URL der der Auftragsstatistik ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-111">Gets the URL of the job statistics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserCpuTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-112">Ruft die Gesamtzeit CPU-Zeit im (pro Kern) aller Aufgaben im Auftrag ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-112">Gets the total user mode CPU time (per core) consumed by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WaitTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-113">Ruft die Gesamtwartezeit für alle Aufgaben im Auftrag.</span><span class="sxs-lookup"><span data-stu-id="8a02c-113">Gets the total wait time of all tasks in the job.</span></span> <span data-ttu-id="8a02c-114">Die Wartezeit für eine Aufgabe wird als die Zeitspanne zwischen dem Erstellen der Aufgabe und dem Start der Ausführung der Aufgabe definiert.</span><span class="sxs-lookup"><span data-stu-id="8a02c-114">The wait time for a task is defined as the elapsed time between the creation of the task and the start of task execution.</span></span> <span data-ttu-id="8a02c-115">(Wenn die Aufgabe aufgrund von Fehlern wiederholt wird, ist die Wartezeit der Zeit der letzten Ausführung der Aufgabe.)</span><span class="sxs-lookup"><span data-stu-id="8a02c-115">(If the task is retried due to failures, the wait time is the time to the most recent task execution.)</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="8a02c-116">Dieser Wert wird nur in der lebensdauerstatistiken Konto gemeldet.</span><span class="sxs-lookup"><span data-stu-id="8a02c-116">This value is only reported in the account lifetime statistics.</span></span>
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="WallClockTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-117">Ruft die gesamte verstrichene Zeit ab.</span><span class="sxs-lookup"><span data-stu-id="8a02c-117">Gets the total elapsed time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WriteIOGiB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-118">Ruft die gesamte Gibibytes e/a durch alle Aufgaben im Auftrag auf den Datenträger geschrieben.</span><span class="sxs-lookup"><span data-stu-id="8a02c-118">Gets the total gibibytes of I/O written to disk by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WriteIOps">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a02c-119">Ruft die Gesamtzahl der Schreibvorgänge auf Datenträger durch alle Aufgaben im Auftrag vorgenommen.</span><span class="sxs-lookup"><span data-stu-id="8a02c-119">Gets the total number of disk write operations made by all tasks in the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
