<Type Name="FabricClient+ServiceManagementClient+ServiceNotificationEventArgs" FullName="System.Fabric.FabricClient+ServiceManagementClient+ServiceNotificationEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c5b92-101">Die Ereignisargumente für ein <see cref="E:System.Fabric.FabricClient.ServiceManagementClient.ServiceNotificationFilterMatched" /> Ereignis.</span><span class="sxs-lookup"><span data-stu-id="c5b92-101">The event arguments for a <see cref="E:System.Fabric.FabricClient.ServiceManagementClient.ServiceNotificationFilterMatched" /> event.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Notification">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="c5b92-102">Ruft das Benachrichtigungsobjekt ab.</span><span class="sxs-lookup"><span data-stu-id="c5b92-102">Gets the notification object.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="c5b92-103">Das Benachrichtigungsobjekt.</span><span class="sxs-lookup"><span data-stu-id="c5b92-103">The notification object.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
