<Type Name="UpgradeDomainState" FullName="System.Fabric.UpgradeDomainState">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="983f5-101">Listet den Status einer upgradedomäne.</span><span class="sxs-lookup"><span data-stu-id="983f5-101">Enumerates the states of an upgrade domain.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="983f5-102">Gibt an, dass das Upgrade abgeschlossen ist.</span><span class="sxs-lookup"><span data-stu-id="983f5-102">Indicates that the upgrade is completed.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="InProgress">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="983f5-103">Gibt an, dass das Upgrade ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="983f5-103">Indicates that the upgrade is in progress.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="983f5-104">Gibt an, dass dieses Upgrade ungültig ist.</span><span class="sxs-lookup"><span data-stu-id="983f5-104">Indicates that this upgrade is not valid.</span></span> <span data-ttu-id="983f5-105">Alle Service Fabric-Enumerationen wurde ein ungültiger Typ.</span><span class="sxs-lookup"><span data-stu-id="983f5-105">All Service Fabric enumerations have the invalid type.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Pending">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="983f5-106">Gibt an, dass das Upgrade aussteht und nicht gestartet wurde.</span><span class="sxs-lookup"><span data-stu-id="983f5-106">Indicates that the upgrade is pending and has not started.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
