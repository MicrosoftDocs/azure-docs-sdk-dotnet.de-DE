<Type Name="IUpdateDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerBackend.UpdateDefinition.IUpdateDefinition&lt;ParentT&gt;">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Network.Fluent.LoadBalancerBackend.UpdateDefinition.IUpdateDefinition`1" />
  ...
  <Interfaces>
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.Network.Fluent.LoadBalancerBackend.UpdateDefinition.IBlank&lt;ParentT&gt;</InterfaceName>
    </Interface>
    <Interface>
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="278d7-101">Der Rückgabetyp des endgültigen UpdateDefinitionStages.WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="278d7-101">The return type of the final  UpdateDefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="278d7-102">Die gesamte einen Load Balancer-Back-End-Definition als Teil eines Load Balancer-Updates.</span><span class="sxs-lookup"><span data-stu-id="278d7-102">The entirety of a load balancer backend definition as part of a load balancer update.</span></span>
            </summary>
