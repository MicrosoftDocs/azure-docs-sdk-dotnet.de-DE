<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="97ac6-101">Die Vorlage für den Updatevorgang für eine Route Tabelle mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="97ac6-101">The template for a route table update operation, containing all the settings that can be modified.</span></span>
            <span data-ttu-id="97ac6-102">Rufen Sie Update.apply(), um die Änderungen auf die Ressource in Azure übernehmen.</span><span class="sxs-lookup"><span data-stu-id="97ac6-102">Call  Update.apply() to apply the changes to the resource in Azure.</span></span>
            </summary>
