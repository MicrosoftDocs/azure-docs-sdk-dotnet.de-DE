<Type Name="MonitorConfig" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.Models.MonitorConfig">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c8c91-101">Klasse, die Einstellungen in einem Traffic Manager-Profil für die endpunktüberwachung enthält.</span><span class="sxs-lookup"><span data-stu-id="c8c91-101">Class containing endpoint monitoring settings in a Traffic Manager profile.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8c91-102">Initialisiert eine neue Instanz der MonitorConfig-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c8c91-102">Initializes a new instance of the MonitorConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8c91-103">Ruft ab oder legt den Pfad relativ zum Domänennamen Endpunkts verwendet, um für die Suche nach endpunktzuständen fest.</span><span class="sxs-lookup"><span data-stu-id="c8c91-103">Gets or sets the path relative to the endpoint domain name used to probe for endpoint health.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8c91-104">Ruft ab oder legt den TCP-Port verwendet, um für die Suche nach endpunktzuständen.</span><span class="sxs-lookup"><span data-stu-id="c8c91-104">Gets or sets the TCP port used to probe for endpoint health.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProfileMonitorStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8c91-105">Ruft ab, oder legt ihn fest-Messagingeigenschaften auf Profilebene Überwachungsstatus Traffic Manager-Profils.</span><span class="sxs-lookup"><span data-stu-id="c8c91-105">Gets or sets the profile-level monitoring status of the Traffic Manager profile.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8c91-106">Abrufen oder Festlegen des Protokolls (HTTP oder HTTPS), um für die Suche nach endpunktzuständen verwendet.</span><span class="sxs-lookup"><span data-stu-id="c8c91-106">Gets or sets the protocol (HTTP or HTTPS) used to probe for endpoint health.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
