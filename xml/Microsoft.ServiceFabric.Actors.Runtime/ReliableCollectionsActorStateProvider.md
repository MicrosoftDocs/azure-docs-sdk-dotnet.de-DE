<Type Name="ReliableCollectionsActorStateProvider" FullName="Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider">
  ...
  <Docs>
    <summary>
      <span data-ttu-id="c4d5b-101"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />ist derzeit als Vorschau verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-101"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> is currently in PREVIEW.</span></span>
            <span data-ttu-id="c4d5b-102">Stellt eine Implementierung von <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.IActorStateProvider" /> verwendet <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> zum Speichern und den Akteur Zustand beibehalten.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-102">Provides an implementation of <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.IActorStateProvider" /> which uses <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> to store and persist the actor state.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <span data-ttu-id="c4d5b-103"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />ist derzeit als Vorschau verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-103"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> is currently in PREVIEW.</span></span>
             <span data-ttu-id="c4d5b-104">Initialisiert eine neue Instanz der ReliableCollectionsActorStateProvider-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-104">Initializes a new instance of the ReliableCollectionsActorStateProvider class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stateManagerConfig">
            <span data-ttu-id="c4d5b-105">Ein <see cref="T:Microsoft.ServiceFabric.Data.ReliableStateManagerConfiguration" /> , beschreibt <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-105">A <see cref="T:Microsoft.ServiceFabric.Data.ReliableStateManagerConfiguration" /> that describes <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> configuration.</span></span> 
            </param>
        <summary>
          <span data-ttu-id="c4d5b-106"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />ist derzeit als Vorschau verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-106"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> is currently in PREVIEW.</span></span>
            <span data-ttu-id="c4d5b-107">Initialisiert eine neue Instanz der ReliableCollectionsActorStateProvider-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-107">Initializes a new instance of the ReliableCollectionsActorStateProvider class.</span></span>
            <span data-ttu-id="c4d5b-108">mit der angegebenen Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-108">with specified configuration.</span></span> <span data-ttu-id="c4d5b-109">Dies ist zurzeit als Vorschau verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-109">This is currently in PREVIEW.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stateManagerConfig">
            <span data-ttu-id="c4d5b-110">Ein <see cref="T:Microsoft.ServiceFabric.Data.ReliableStateManagerConfiguration" /> , beschreibt <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-110">A <see cref="T:Microsoft.ServiceFabric.Data.ReliableStateManagerConfiguration" /> that describes <see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" /> configuration.</span></span>
            </param>
        <param name="actorStateDictionaryCount">
            <span data-ttu-id="c4d5b-111">Anzahl der <see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" /> über die eine actorsperre Zustände partitioniert und gespeichert werden.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-111">Number of <see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" /> across which actor states will be partitioned and stored.</span></span>
            </param>
        <param name="reminderDictionaryCount">
            <span data-ttu-id="c4d5b-112">Anzahl der <see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" /> über welche Erinnerungen partitioniert und gespeichert werden.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-112">Number of <see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" /> across which reminders will be partitioned and stored.</span></span>
            </param>
        <summary>
          <span data-ttu-id="c4d5b-113"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />ist derzeit als Vorschau verfügbar.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-113"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> is currently in PREVIEW.</span></span>
            <span data-ttu-id="c4d5b-114">Initialisiert eine neue Instanz der Klasse ReliableDictionaryActorStateProvider mit der angegebenen Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-114">Initializes a new instance of the ReliableDictionaryActorStateProvider class with specified configuration.</span></span>
            </summary>
        <remarks>
            <span data-ttu-id="c4d5b-115">Werte für <paramref name="actorStateDictionaryCount" /> und <paramref name="reminderDictionaryCount" /> kann nur einmal angegeben werden bei der Akteur-Dienst zum ersten Mal erstellt wird.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-115">Values for <paramref name="actorStateDictionaryCount" /> and <paramref name="reminderDictionaryCount" /> can be specified only once when the Actor Service is created for first time.</span></span> <span data-ttu-id="c4d5b-116">Danach kann nicht geändert werden und <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> ignoriert alle Werte, die von der ersten unterscheiden.</span><span class="sxs-lookup"><span data-stu-id="c4d5b-116">It cannot be changed after that and <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" /> will ignore any values that are different from first time.</span></span>
            </remarks>
      </Docs>
    </Member>
