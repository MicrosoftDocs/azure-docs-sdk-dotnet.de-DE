<Type Name="IWithListen&lt;T&gt;" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.AuthorizationRule.Update.IWithListen&lt;T&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="T"><span data-ttu-id="d35be-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="d35be-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="d35be-102">Die Phase der Service Bus Autorisierung Regel Update zu ermöglichen, aktivieren Sie Lauschen Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="d35be-102">The stage of the Service Bus authorization rule update allowing to enable listen policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithListeningEnabled">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d35be-103">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="d35be-103">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>