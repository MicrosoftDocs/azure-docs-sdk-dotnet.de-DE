<Type Name="IWithSend&lt;T&gt;" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.AuthorizationRule.Update.IWithSend&lt;T&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="T"><span data-ttu-id="ce542-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="ce542-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="ce542-102">Die Phase der Service Bus Autorisierung Regel Update zu ermöglichen, aktivieren Sie senden Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="ce542-102">The stage of the Service Bus authorization rule update allowing to enable send policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSendingEnabled">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ce542-103">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="ce542-103">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>