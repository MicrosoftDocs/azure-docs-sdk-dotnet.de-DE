<Type Name="TrackedResource" FullName="Microsoft.Azure.Management.ServiceBus.Models.TrackedResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a9541-101">Die in der Ressourcendefinition.</span><span class="sxs-lookup"><span data-stu-id="a9541-101">The Resource definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9541-102">Initialisiert eine neue Instanz der TrackedResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a9541-102">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="a9541-103">Der geografische Standort, in dem die Ressource aktiv ist</span><span class="sxs-lookup"><span data-stu-id="a9541-103">The Geo-location where the resource lives</span></span></param>
        <param name="id"><span data-ttu-id="a9541-104">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="a9541-104">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="a9541-105">Ressourcenname</span><span class="sxs-lookup"><span data-stu-id="a9541-105">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="a9541-106">Ressourcentyp</span><span class="sxs-lookup"><span data-stu-id="a9541-106">Resource type</span></span></param>
        <param name="tags"><span data-ttu-id="a9541-107">Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="a9541-107">Resource tags</span></span></param>
        <summary>
            <span data-ttu-id="a9541-108">Initialisiert eine neue Instanz der TrackedResource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a9541-108">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9541-109">Ruft ab oder legt den geografischen Standort aktiv ist, in dem die Ressource</span><span class="sxs-lookup"><span data-stu-id="a9541-109">Gets or sets the Geo-location where the resource lives</span></span>
            </summary>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9541-110">Ruft ab oder legt ihn fest Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="a9541-110">Gets or sets resource tags</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9541-111">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="a9541-111">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="a9541-112">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="a9541-112">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
