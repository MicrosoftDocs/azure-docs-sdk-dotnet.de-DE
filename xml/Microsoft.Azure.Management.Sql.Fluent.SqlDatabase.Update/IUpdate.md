<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f4537-101">Die Vorlage für eine SQL-Datenbank modifiyState an, die mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="f4537-101">The template for a SQLDatabase modifyState operation, containing all the settings that can be modified.</span></span>
            </summary>
