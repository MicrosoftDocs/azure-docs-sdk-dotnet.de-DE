<Type Name="IUpdate" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="24d94-101">Die gesamte den Namespace Autorisierung Regel aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="24d94-101">The entirety of the namespace authorization rule update.</span></span>
            </summary>
