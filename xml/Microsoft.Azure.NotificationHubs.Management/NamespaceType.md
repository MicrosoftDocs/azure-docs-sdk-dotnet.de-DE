<Type Name="NamespaceType" FullName="Microsoft.Azure.NotificationHubs.Management.NamespaceType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f5b82-101">Enumeratess Namespacetypen</span><span class="sxs-lookup"><span data-stu-id="f5b82-101">Enumeratess namespace types</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Messaging">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f5b82-102">Messaging: Meldung Entitäten (Warteschlange/Thema/Relay/Event Hub) können unter diesem Namespace erstellt werden</span><span class="sxs-lookup"><span data-stu-id="f5b82-102">Messaging: Message entities (Queue/topic/relay/eventhub) can be created under this type of namespace</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Mixed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f5b82-103">Gemischt: Beide Messaging-Entitäten und in NotificationHub-Entität kann erstellt werden unter diesem Namespace (veraltet)</span><span class="sxs-lookup"><span data-stu-id="f5b82-103">Mixed: Both Messaging entities and NotificationHub entity can be created under this type of namespace  (obsolete)</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NotificationHub">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f5b82-104">Benachrichtigungs-Hub: unter diesem Namespace kann nur NotificationHub-Entität erstellt werden</span><span class="sxs-lookup"><span data-stu-id="f5b82-104">Notification hub: Only notificationHub entity can be created under this type of namespace</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
