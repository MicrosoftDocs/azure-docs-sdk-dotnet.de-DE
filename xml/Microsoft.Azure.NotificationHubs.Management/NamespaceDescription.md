<Type Name="NamespaceDescription" FullName="Microsoft.Azure.NotificationHubs.Management.NamespaceDescription">
  ...
  <Docs>
    <summary><span data-ttu-id="c82b7-101">Definiert die gewünschte Semantik für einen Dienstnamespace.</span><span class="sxs-lookup"><span data-stu-id="c82b7-101">Defines the desired semantics for a service namespace.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="c82b7-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.Management.NamespaceDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c82b7-102">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.Management.NamespaceDescription" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AcsManagementEndpoint">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-103">Ruft ab, oder legt ihn fest-verwaltungsendpunkt für Access Control Service.</span><span class="sxs-lookup"><span data-stu-id="c82b7-103">Gets or sets the management endpoint for the access control service.</span></span></summary>
        <value><span data-ttu-id="c82b7-104">Verwaltungsendpunkt für Access Control Service.</span><span class="sxs-lookup"><span data-stu-id="c82b7-104">The management endpoint for the access control service.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-105">Ruft ab oder legt die Verbindungszeichenfolge, die vom Client verwendet wird, für die Verbindung mit dem Server.</span><span class="sxs-lookup"><span data-stu-id="c82b7-105">Gets or sets the connection string that is used by the client to connect to the server.</span></span></summary>
        <value><span data-ttu-id="c82b7-106">Die Verbindungszeichenfolge, die vom Client verwendet wird, für die Verbindung mit dem Server.</span><span class="sxs-lookup"><span data-stu-id="c82b7-106">The connection string that is used by the client to connect to the server.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateACSNamespace">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-107">Ruft ab oder legt einen Wert, der angibt, ob ACS-Namespace erstellt.</span><span class="sxs-lookup"><span data-stu-id="c82b7-107">Gets or sets a value that indicates whether to create ACS namespace.</span></span></summary>
        <value><span data-ttu-id="c82b7-108">"true", wenn die ACS-Namespace erstellt wurde; andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="c82b7-108">true if ACS namespace has been created; otherwise, false.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-109">Ruft ab oder legt das Datum der Erstellung der Namespace fest.</span><span class="sxs-lookup"><span data-stu-id="c82b7-109">Gets or sets the date when the namespace was created.</span></span></summary>
        <value><span data-ttu-id="c82b7-110">Das Datum der Erstellung der Namespace.</span><span class="sxs-lookup"><span data-stu-id="c82b7-110">The date when the namespace was created.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Critical">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-111">Ruft ab oder legt fest, ob die Beschreibung eine Beschreibung des NULL-Werte zu kritischen ist.</span><span class="sxs-lookup"><span data-stu-id="c82b7-111">Gets or sets whether the description is a nullable critical description.</span></span></summary>
        <value><span data-ttu-id="c82b7-112">"true", wenn die Beschreibung eine Beschreibung des NULL-Werte zu kritischen; andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="c82b7-112">true if the description is a nullable critical description; otherwise, false.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultKey">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-113">Ruft ab oder legt den Standardschlüssel für den Namespace.</span><span class="sxs-lookup"><span data-stu-id="c82b7-113">Gets or sets the default key for the namespace.</span></span></summary>
        <value><span data-ttu-id="c82b7-114">Der Standardschlüssel für den Namespace.</span><span class="sxs-lookup"><span data-stu-id="c82b7-114">The default key for the namespace.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-115">Gibt an, ob diese Instanz aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="c82b7-115">Specifies whether this instance is enabled.</span></span></summary>
        <value><span data-ttu-id="c82b7-116">"true", wenn diese Instanz aktiviert ist; andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="c82b7-116">true if this instance is enabled; otherwise, false.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EventHubEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c82b7-117">(veraltet) Gibt an, ob der EventHub-Funktion aktiviert ist</span><span class="sxs-lookup"><span data-stu-id="c82b7-117">(obsolete) Whether eventHub feature is enabled</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-118">Ruft ab oder legt den Namen des Namespaces fest.</span><span class="sxs-lookup"><span data-stu-id="c82b7-118">Gets or sets the name of the namespace.</span></span></summary>
        <value><span data-ttu-id="c82b7-119">Der Name des Namespaces.</span><span class="sxs-lookup"><span data-stu-id="c82b7-119">The name of the namespace.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NamespaceType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c82b7-120">Der Typ des Namespaces.</span><span class="sxs-lookup"><span data-stu-id="c82b7-120">Type of the namespace.</span></span> <span data-ttu-id="c82b7-121">Wenn es NotificationHub ' oder ' gemischt ist, konnten wir NotificationHubs im Namespace zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="c82b7-121">If it is NotificationHub or Mixed, we could create notificationHubs in the namespace.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-122">Abrufen oder Festlegen der geografischen Region der Microsoft-Rechenzentren, die in denen Kundendaten gespeichert werden soll.</span><span class="sxs-lookup"><span data-stu-id="c82b7-122">Gets or sets the geographic region(s) of the Microsoft datacenters in which Customer Data will be stored.</span></span></summary>
        <value><span data-ttu-id="c82b7-123">Die geografischen Region der Microsoft-Rechenzentren, die in denen Kundendaten gespeichert werden soll.</span><span class="sxs-lookup"><span data-stu-id="c82b7-123">The geographic region(s) of the Microsoft datacenters in which Customer Data will be stored.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Serializer">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-124">Der Datenvertrags-Serialisierer, die dem Namespace zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="c82b7-124">The data contract serializer associated with the namespace.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceBusEndpoint">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-125">Ruft ab oder legt den Servicebus-Endpunkt-Wert.</span><span class="sxs-lookup"><span data-stu-id="c82b7-125">Gets or sets the service bus end point value.</span></span></summary>
        <value><span data-ttu-id="c82b7-126">Der Wert der Servicebus-Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="c82b7-126">The service bus end point value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Status">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-127">Ruft ab oder legt den Status des Namespaces fest.</span><span class="sxs-lookup"><span data-stu-id="c82b7-127">Gets or sets the state of the namespace.</span></span></summary>
        <value><span data-ttu-id="c82b7-128">Der Status des Namespaces.</span><span class="sxs-lookup"><span data-stu-id="c82b7-128">The state of the namespace.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary><span data-ttu-id="c82b7-129">Abrufen oder festlegen den Namespacebezeichner für das Abonnement.</span><span class="sxs-lookup"><span data-stu-id="c82b7-129">Gets or sets the namespace subscription identifier.</span></span></summary>
        <value><span data-ttu-id="c82b7-130">Der Bezeichner für den Namespace-Abonnement.</span><span class="sxs-lookup"><span data-stu-id="c82b7-130">The namespace subscription identifier.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
