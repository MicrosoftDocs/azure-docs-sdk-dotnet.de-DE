<Type Name="IWithVhdAttachedDiskSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineUnmanagedDataDisk.Definition.IWithVhdAttachedDiskSettings&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="a900a-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="a900a-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="a900a-102">Die Stufe, die ermöglicht das Konfigurieren der Datenträger, die basierend auf vorhandenen virtuellen Festplatte.</span><span class="sxs-lookup"><span data-stu-id="a900a-102">The stage that allows configure the disk based on existing VHD.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="a900a-103">der Datenträger, die caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="a900a-103">The disk caching type.</span></span> <span data-ttu-id="a900a-104">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite".</span><span class="sxs-lookup"><span data-stu-id="a900a-104">Possible values include: 'None', 'ReadOnly', 'ReadWrite'.</span></span></param>
        <summary>
            <span data-ttu-id="a900a-105">Gibt an, welche Zwischenspeichern für den Datenträger.</span><span class="sxs-lookup"><span data-stu-id="a900a-105">Specifies the caching type for the data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a900a-106">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="a900a-106">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithLun">
      ...
      <Docs>
        <param name="lun"><span data-ttu-id="a900a-107">Die logische Gerätenummer.</span><span class="sxs-lookup"><span data-stu-id="a900a-107">The logical unit number.</span></span></param>
        <summary>
            <span data-ttu-id="a900a-108">Gibt die logische Gerätenummer für den Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="a900a-108">Specifies the logical unit number for the data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a900a-109">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="a900a-109">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithSizeInGB">
      ...
      <Docs>
        <param name="sizeInGB"><span data-ttu-id="a900a-110">Die Größe des Datenträgers in GB.</span><span class="sxs-lookup"><span data-stu-id="a900a-110">The disk size in GB.</span></span></param>
        <summary>
            <span data-ttu-id="a900a-111">Gibt die Größe in GB für den Datenträger muss geändert werden soll.</span><span class="sxs-lookup"><span data-stu-id="a900a-111">Specifies the size in GB the disk needs to be resized.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a900a-112">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="a900a-112">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>