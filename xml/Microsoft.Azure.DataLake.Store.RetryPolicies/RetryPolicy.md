<Type Name="RetryPolicy" FullName="Microsoft.Azure.DataLake.Store.RetryPolicies.RetryPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ef632-101">Abstrakte Klasse Immplemented von verschiedenen Arten von wiederholungsrichtlinien</span><span class="sxs-lookup"><span data-stu-id="ef632-101">Abstract class immplemented by different types of retry policies</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ShouldRetry">
      ...
      <Docs>
        ...
        <param name="ex"><span data-ttu-id="ef632-102">Letzte Ausnahme, die während der Httprequest Filtermenü</span><span class="sxs-lookup"><span data-stu-id="ef632-102">Last exception that we saw during Httprequest</span></span></param>
        <summary>
            <span data-ttu-id="ef632-103">Bestimmt, ob die HttpRequest wiederholt werden sollte</span><span class="sxs-lookup"><span data-stu-id="ef632-103">Determines whether the HttpRequest should be retried</span></span>
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
