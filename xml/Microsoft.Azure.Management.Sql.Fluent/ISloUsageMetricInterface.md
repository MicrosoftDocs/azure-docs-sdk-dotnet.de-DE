<Type Name="ISloUsageMetricInterface" FullName="Microsoft.Azure.Management.Sql.Fluent.ISloUsageMetricInterface">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b96c9-101">Eine unveränderliche clientseitige Darstellung von SloUsageMetric für eine Azure SQL-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="b96c9-101">An immutable client-side representation of an Azure SQL database's SloUsageMetric.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="InRangeTimeRatio">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b96c9-102">Ruft InRangeTimeRatio für SLO-Metrik "Verwendung".</span><span class="sxs-lookup"><span data-stu-id="b96c9-102">Gets inRangeTimeRatio for SLO usage metric.</span></span>
            </summary>
    ...
    <Member MemberName="ServiceLevelObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b96c9-103">Ruft die ServiceLevelObjective für SLO-Metrik "Verwendung".</span><span class="sxs-lookup"><span data-stu-id="b96c9-103">Gets the serviceLevelObjective for SLO usage metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceLevelObjectiveId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b96c9-104">Ruft die ServiceLevelObjectiveId für SLO-Metrik "Verwendung".</span><span class="sxs-lookup"><span data-stu-id="b96c9-104">Gets the serviceLevelObjectiveId for SLO usage metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
