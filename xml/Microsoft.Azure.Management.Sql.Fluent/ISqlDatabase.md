<Type Name="ISqlDatabase" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlDatabase">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f2c9a-101">Eine unveränderliche clientseitige Darstellung einer Azure SQL-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-101">An immutable client-side representation of an Azure SQL Database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AsWarehouse">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-102">Für weitere Vorgänge SqlWarehouse-Instanz.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-102">SqlWarehouse instance for more operations.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="Collation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-103">Ruft die Sortierung der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-103">Gets the collation of the Azure SQL Database.</span></span>
            </summary>
    ...
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-104">Ruft das Erstellungsdatum der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-104">Gets the creation date of the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CurrentServiceObjectiveId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-105">Ruft die aktuelle Service Level Objective-Id der Azure SQL-Datenbank ist dies die Id des SLO an, die derzeit aktiv ist.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-105">Gets the current Service Level Objective Id of the Azure SQL Database, this is the Id of the Service Level Objective that is currently active.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-106">Ruft die Id der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-106">Gets the Id of the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultSecondaryLocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-107">Ruft den DefaultSecondaryLocation-Wert.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-107">Gets the defaultSecondaryLocation value.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-108">Löscht die vorhandene SQL-Datenbank.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-108">Deletes the existing SQL database.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EarliestRestoreDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-109">Ruft den Zeitraum Startdatum Wiederherstellung der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-109">Gets the recovery period start date of the Azure SQL Database.</span></span> <span data-ttu-id="f2c9a-110">Auf diese Weise werden das Startdatum und die Uhrzeit, wann Wiederherstellungspunkte für Azure SQL-Datenbank verfügbar ist.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-110">This records the start date and time when recovery is available for this Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-111">Ruft die Edition der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-111">Gets the edition of the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-112">Ruft den ElasticPoolName-Wert.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-112">Gets the elasticPoolName value.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetTransparentDataEncryption">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-113">Ruft eine Azure SQL-Datenbank Transparent Data Encryption für die Datenbank an.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-113">Gets an Azure SQL Database Transparent Data Encryption for the database.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-114">Eine Azure SQL-Datenbank Transparent Data Encryption für die Datenbank.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-114">An Azure SQL Database Transparent Data Encryption for the database.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="GetUpgradeHint">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-115">Der UpgradeHint-Wert.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-115">The upgradeHint value.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="IsDataWarehouse">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-116">Ruft "true", wenn diese Datenbank SqlWarehouse ist.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-116">Gets true if this Database is SqlWarehouse.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListReplicationLinks">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-117">Alle replikationsverknüpfungen der Datenbank zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-117">All the replication links associated with the database.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListRestorePoints">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-118">Gibt die Liste aller Wiederherstellungspunkte für die Datenbank zurück.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-118">Returns the list of all restore points on the database.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListServiceTierAdvisors">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-119">Informationen zum Dienst Ebene Ratgeber für die angegebene Datenbank.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-119">Information about service tier advisors for specified database.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListUsages">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="f2c9a-120">Gibt die Liste der Verwendungen (DatabaseMetrics) der Datenbank zurück.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-120">Returns the list of usages (DatabaseMetrics) of the database.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="MaxSizeBytes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-121">Ruft die maximale Größe der Azure SQL-Datenbank in Bytes ausgedrückt.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-121">Gets the max size of the Azure SQL Database expressed in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjectiveId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-122">Ruft die konfigurierten Service Level Objective-Id ab der Azure SQL-Datenbank ist dies der Servicelevel-Zielpunkt, die Azure SQL-Datenbank angewendet wird.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-122">Gets the configured Service Level Objective Id of the Azure SQL Database, this is the Service Level Objective that is being applied to the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjectiveName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-123">Ruft den Namen der konfigurierten Servicelevel-Zielpunkt der Azure SQL-Datenbank, dies ist der Servicelevel-Zielpunkt, die Azure SQL-Datenbank angewendet wird.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-123">Gets the name of the configured Service Level Objective of the Azure SQL Database, this is the Service Level Objective that is being applied to the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceLevelObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-124">Ruft den Servicelevel-Zielpunkt der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-124">Gets the Service Level Objective of the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SqlServerName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-125">Ruft die Namen des SQL-Servers, zu dem diese Datenbank gehört.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-125">Gets name of the SQL Server to which this database belongs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2c9a-126">Ruft den Status der Azure SQL-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="f2c9a-126">Gets the status of the Azure SQL Database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
