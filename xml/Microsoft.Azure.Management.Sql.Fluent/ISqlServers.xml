<Type Name="ISqlServers" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlServers">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="88f38-101">Einstiegspunkt für einen SQL Server-Verwaltungs-API.</span><span class="sxs-lookup"><span data-stu-id="88f38-101">Entry point to SQL Server management API.</span></span>
            </summary>
