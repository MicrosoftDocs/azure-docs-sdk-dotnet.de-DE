<Type Name="IElasticPoolDatabaseActivity" FullName="Microsoft.Azure.Management.Sql.Fluent.IElasticPoolDatabaseActivity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9cd37-101">Eine unveränderliche clientseitige Darstellung der Aktivität "Datenbank für eine Azure SQL-ElasticPool".</span><span class="sxs-lookup"><span data-stu-id="9cd37-101">An immutable client-side representation of an Azure SQL ElasticPool's Database Activity.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CurrentElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-102">Ruft den Namen des aktuellen elastischen Pools, der die Datenbank befindet sich im If verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-102">Gets the name of the current Elastic Pool the database is in if available.</span></span>
            </summary>
    ...
    <Member MemberName="CurrentServiceObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-103">Ruft den Namen des aktuellen dienstziels ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-103">Gets the name of the current service objective if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-104">Ruft den Datenbanknamen ab.</span><span class="sxs-lookup"><span data-stu-id="9cd37-104">Gets the database name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-105">Ruft den Zeitpunkt der Vorgang abgeschlossen, (ISO8601-Format).</span><span class="sxs-lookup"><span data-stu-id="9cd37-105">Gets the time the operation finished (ISO8601 format).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-106">Ruft den Fehlercode ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-106">Gets the error code if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-107">Ruft die Fehlermeldung ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-107">Gets the error message if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorSeverity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-108">Ruft den Schweregrad des Fehlers ab, sofern verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-108">Gets the error severity if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-109">Ruft den Vorgangsnamen.</span><span class="sxs-lookup"><span data-stu-id="9cd37-109">Gets the operation name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-110">Ruft die eindeutige Vorgangs-ID ab.</span><span class="sxs-lookup"><span data-stu-id="9cd37-110">Gets the unique operation ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PercentComplete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-111">Ruft den Prozentsatz abgeschlossen, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-111">Gets the percentage complete if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-112">Ruft den Namen für den elastischen Pool, der die Datenbank gegebenenfalls auf verschoben werden.</span><span class="sxs-lookup"><span data-stu-id="9cd37-112">Gets the name for the Elastic Pool the database is moving into if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-113">Ruft den Namen des Ziels angeforderten Dienst ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="9cd37-113">Gets the name of the requested service objective if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-114">Ruft den Namen des Azure SQL-Servers in der elastische Pool ist.</span><span class="sxs-lookup"><span data-stu-id="9cd37-114">Gets the name of the Azure SQL Server the Elastic Pool is in.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-115">Ruft den Zeitpunkt der Vorgang (ISO8601-Format) gestartet wurde.</span><span class="sxs-lookup"><span data-stu-id="9cd37-115">Gets the time the operation started (ISO8601 format).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9cd37-116">Ruft den aktuellen Status des Vorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="9cd37-116">Gets the current state of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
