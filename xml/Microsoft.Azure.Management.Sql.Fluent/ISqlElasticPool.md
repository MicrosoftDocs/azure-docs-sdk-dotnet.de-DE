<Type Name="ISqlElasticPool" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlElasticPool">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6b8da-101">Eine unveränderliche clientseitige Darstellung einer Azure SQL-ElasticPool.</span><span class="sxs-lookup"><span data-stu-id="6b8da-101">An immutable client-side representation of an Azure SQL ElasticPool.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-102">Ruft das Erstellungsdatum des elastischen Pools für Azure SQL ab.</span><span class="sxs-lookup"><span data-stu-id="6b8da-102">Gets the creation date of the Azure SQL Elastic Pool.</span></span>
            </summary>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-103">Ruft die maximale DTU SQL Azure eine beliebige Datenbank nutzen kann.</span><span class="sxs-lookup"><span data-stu-id="6b8da-103">Gets the maximum DTU any one SQL Azure database can consume.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-104">Ruft die minimale DTU kann, alle SQL Azure-Datenbanken garantiert werden ab.</span><span class="sxs-lookup"><span data-stu-id="6b8da-104">Gets the minimum DTU all SQL Azure Databases are guaranteed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-105">Löscht den elastischen Pool vom Server an.</span><span class="sxs-lookup"><span data-stu-id="6b8da-105">Deletes the elastic pool from the server.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-106">Ruft den gesamten freigegebenen DTU für den elastischen Pool für SQL Azure-Datenbank ab.</span><span class="sxs-lookup"><span data-stu-id="6b8da-106">Gets The total shared DTU for the SQL Azure Database Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-107">Ruft die Edition von Azure SQL-elastischen Pool ab.</span><span class="sxs-lookup"><span data-stu-id="6b8da-107">Gets the edition of Azure SQL Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDatabase">
      ...
      <Docs>
        <param name="databaseName"><span data-ttu-id="6b8da-108">Der Name der Datenbank in gesucht werden soll.</span><span class="sxs-lookup"><span data-stu-id="6b8da-108">Name of the database to look into.</span></span></param>
        <summary>
            <span data-ttu-id="6b8da-109">Ruft die spezielle Datenbank im elastischen Pool an.</span><span class="sxs-lookup"><span data-stu-id="6b8da-109">Gets the specific database in the elastic pool.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6b8da-110">Informationen über bestimmte Datenbank im elastischen Pool.</span><span class="sxs-lookup"><span data-stu-id="6b8da-110">The information about specific database in elastic pool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6b8da-111">Die Informationen zur elastischen Pool Aktivitäten.</span><span class="sxs-lookup"><span data-stu-id="6b8da-111">The information about elastic pool activities.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabaseActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6b8da-112">Die Informationen zur elastischen Pool Datenbankaktivitäten.</span><span class="sxs-lookup"><span data-stu-id="6b8da-112">The information about elastic pool database activities.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabases">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6b8da-113">Die Informationen zu Datenbanken im elastischen Pool.</span><span class="sxs-lookup"><span data-stu-id="6b8da-113">The information about databases in elastic pool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="SqlServerName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-114">Ruft die Namen des SQL-Servers, zu dem diese elastischen Pool gehört.</span><span class="sxs-lookup"><span data-stu-id="6b8da-114">Gets name of the SQL Server to which this elastic pool belongs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-115">Ruft den Zustand des elastischen Pools für Azure SQL ab.</span><span class="sxs-lookup"><span data-stu-id="6b8da-115">Gets the state of the Azure SQL Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageMB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6b8da-116">Ruft die Speicherobergrenze für den SQL Azure-Datenbank elastischen Pool in MB an.</span><span class="sxs-lookup"><span data-stu-id="6b8da-116">Gets the storage limit for the SQL Azure Database Elastic Pool in MB.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
