<Type Name="IWithEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerProfile.Definition.IWithEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9659f-101">Die Phase der Traffic Manager Profildefinition ermöglicht Endpunkt angegeben wird.</span><span class="sxs-lookup"><span data-stu-id="9659f-101">The stage of the traffic manager profile definition allowing to specify endpoint.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="DefineAzureTargetEndpoint">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="9659f-102">Der Name für den Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="9659f-102">The name for the endpoint.</span></span></param>
        <summary>
            <span data-ttu-id="9659f-103">Gibt die Definition der Azure-Endpunkt an die Traffic Manager-Profil angefügt werden.</span><span class="sxs-lookup"><span data-stu-id="9659f-103">Specifies definition of an Azure endpoint to be attached to the traffic manager profile.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9659f-104">Die Phase, Konfiguration für den Endpunkt darstellt.</span><span class="sxs-lookup"><span data-stu-id="9659f-104">The stage representing configuration for the endpoint.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="DefineExternalTargetEndpoint">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="9659f-105">Der Name für den Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="9659f-105">The name for the endpoint.</span></span></param>
        <summary>
            <span data-ttu-id="9659f-106">Gibt die Definition einen externen Endpunkt an die Traffic Manager-Profil angefügt werden.</span><span class="sxs-lookup"><span data-stu-id="9659f-106">Specifies definition of an external endpoint to be attached to the traffic manager profile.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9659f-107">Die Phase, Konfiguration für den Endpunkt darstellt.</span><span class="sxs-lookup"><span data-stu-id="9659f-107">The stage representing configuration for the endpoint.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="DefineNestedTargetEndpoint">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="9659f-108">Der Name für den Endpunkt.</span><span class="sxs-lookup"><span data-stu-id="9659f-108">The name for the endpoint.</span></span></param>
        <summary>
            <span data-ttu-id="9659f-109">Gibt die Definition eines Endpunkts verschachtelten Profil an die Traffic Manager-Profil angefügt werden.</span><span class="sxs-lookup"><span data-stu-id="9659f-109">Specifies definition of an nested profile endpoint to be attached to the traffic manager profile.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9659f-110">Die Phase, Konfiguration für den Endpunkt darstellt.</span><span class="sxs-lookup"><span data-stu-id="9659f-110">The stage representing configuration for the endpoint.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>