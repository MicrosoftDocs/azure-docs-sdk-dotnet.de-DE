<Type Name="IPrincipalExtensions" FullName="System.Security.Principal.IPrincipalExtensions">
  ...
  <Members>
    <Member MemberName="GetAppServiceIdentityAsync&lt;T&gt;">
      ...
      <Docs>
        <typeparam name="T"><span data-ttu-id="d3d50-101">Der Anbietertyp.</span><span class="sxs-lookup"><span data-stu-id="d3d50-101">The provider type.</span></span></typeparam>
        <param name="principal"><span data-ttu-id="d3d50-102">Das <see cref="T:System.Security.Principal.IPrincipal" />-Objekt.</span><span class="sxs-lookup"><span data-stu-id="d3d50-102">The <see cref="T:System.Security.Principal.IPrincipal" /> object.</span></span></param>
        <param name="request"><span data-ttu-id="d3d50-103">Der Anforderungskontext.</span><span class="sxs-lookup"><span data-stu-id="d3d50-103">The request context.</span></span></param>
        <summary>
            <span data-ttu-id="d3d50-104">Ruft den Identitätsanbieter Einzelheiten zu bestimmten Identität der <see cref="T:System.Security.Principal.IPrincipal" /> Ausführen der Anforderung verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="d3d50-104">Gets the identity provider specific identity details for the <see cref="T:System.Security.Principal.IPrincipal" /> making the request.</span></span>
            </summary>
        <returns><span data-ttu-id="d3d50-105">Die Identity Provider-Anmeldeinformationen, sofern gefunden, andernfalls null.</span><span class="sxs-lookup"><span data-stu-id="d3d50-105">The identity provider credentials if found, otherwise null.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetAppServiceIdentityAsync&lt;T&gt;">
