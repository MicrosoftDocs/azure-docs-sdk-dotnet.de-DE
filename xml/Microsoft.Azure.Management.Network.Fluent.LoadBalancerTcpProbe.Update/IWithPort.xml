<Type Name="IWithPort" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerTcpProbe.Update.IWithPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8df80-101">Die Phase des TCP-Prüfpunkt Update so ändern Sie die Portnummer überwachen können.</span><span class="sxs-lookup"><span data-stu-id="8df80-101">The stage of the TCP probe update allowing to modify the port number to monitor.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPort">
      ...
      <Docs>
        <param name="port"><span data-ttu-id="8df80-102">eine Portnummer an.</span><span class="sxs-lookup"><span data-stu-id="8df80-102">A port number.</span></span></param>
        <summary>
            <span data-ttu-id="8df80-103">Gibt die Portnummer für die Systemüberwachung aufrufen.</span><span class="sxs-lookup"><span data-stu-id="8df80-103">Specifies the port number to call for health monitoring.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="8df80-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="8df80-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>