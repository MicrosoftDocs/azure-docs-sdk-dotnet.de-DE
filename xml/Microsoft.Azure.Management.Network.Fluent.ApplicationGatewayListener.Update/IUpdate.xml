<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayListener.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5db47-101">Die gesamte Anwendung Gateway HTTP-Listener Update als Teil einer Anwendung gatewayupdate.</span><span class="sxs-lookup"><span data-stu-id="5db47-101">The entirety of an application gateway HTTP listener update as part of an application gateway update.</span></span>
            </summary>
