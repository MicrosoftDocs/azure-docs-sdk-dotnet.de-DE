<Type Name="IWithParentResource" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.GenericResource.Definition.IWithParentResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c14a2-101">Eine allgemeine Ressource-Definition, sodass übergeordnete Ressource angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="c14a2-101">A generic resource definition allowing parent resource to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithParentResource">
      ...
      <Docs>
        <param name="parentResourceId"><span data-ttu-id="c14a2-102">ParentResourceId Ressourcen-Id des übergeordneten Elements</span><span class="sxs-lookup"><span data-stu-id="c14a2-102">parentResourceId the parent resource id</span></span></param>
        <summary>
            <span data-ttu-id="c14a2-103">Gibt die übergeordnete Ressource an.</span><span class="sxs-lookup"><span data-stu-id="c14a2-103">Specifies the parent resource.</span></span>
            </summary>
        <returns><span data-ttu-id="c14a2-104">die nächste Phase der Definition der allgemeine Ressource</span><span class="sxs-lookup"><span data-stu-id="c14a2-104">the next stage of the generic resource definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
