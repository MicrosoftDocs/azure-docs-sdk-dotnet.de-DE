<Type Name="IWithApiVersion" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.GenericResource.Definition.IWithApiVersion">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="273f5-101">Eine allgemeine Ressource-Definition, sodass API-Version angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="273f5-101">A generic resource definition allowing api version to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithApiVersion">
      ...
      <Docs>
        <param name="apiVersion"><span data-ttu-id="273f5-102">"apiversion" die API-Version der Ressource</span><span class="sxs-lookup"><span data-stu-id="273f5-102">apiVersion the API version of the resource</span></span></param>
        <summary>
            <span data-ttu-id="273f5-103">Gibt die api-Version.</span><span class="sxs-lookup"><span data-stu-id="273f5-103">Specifies the api version.</span></span>
            </summary>
        <returns><span data-ttu-id="273f5-104">die nächste Phase der Definition der allgemeine Ressource</span><span class="sxs-lookup"><span data-stu-id="273f5-104">the next stage of the generic resource definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
