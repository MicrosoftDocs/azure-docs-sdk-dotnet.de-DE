<Type Name="IBlank" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.GenericResource.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9bf78-101">Eine allgemeine Ressource-Definition, sodass Region angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="9bf78-101">A generic resource definition allowing region to be specified.</span></span>
            </summary>
