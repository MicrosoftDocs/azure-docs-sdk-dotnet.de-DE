<Type Name="PurgeCompletedEvent" FullName="Microsoft.WindowsAzure.MobileServices.Sync.PurgeCompletedEvent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e7a0-101">Einen mobilen Dienst-Ereignis, das veröffentlicht wird, wenn anhand des lokalen Speichers für ein entfernen-Vorgang abgeschlossen ist.</span><span class="sxs-lookup"><span data-stu-id="7e7a0-101">A mobile service event that is published when a purge operation against the local store is completed.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="EventName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7a0-102">Löschvorgang abgeschlossen Ereignisname.</span><span class="sxs-lookup"><span data-stu-id="7e7a0-102">The purge completed event name.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7a0-103">Ruft den Namen des Ereignisses ab.</span><span class="sxs-lookup"><span data-stu-id="7e7a0-103">Gets the event name.</span></span>
            </summary>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e7a0-104">Ruft den Namen der Tabelle, die das Ziel der entfernen-Vorgang war.</span><span class="sxs-lookup"><span data-stu-id="7e7a0-104">Gets the name of the table that was the target of the purge operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
