<Type Name="StoreChangeEvent" FullName="Microsoft.WindowsAzure.MobileServices.Sync.StoreChangeEvent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0e3be-101">Stellt ein Ereignis ausgelöst, die als Ergebnis einer Änderung für den lokalen Speicher.</span><span class="sxs-lookup"><span data-stu-id="0e3be-101">Represents an event raised as a result of a change against the local store.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0e3be-102">Ruft den Namen des Ereignisses ab.</span><span class="sxs-lookup"><span data-stu-id="0e3be-102">Gets the event name.</span></span>
            </summary>
