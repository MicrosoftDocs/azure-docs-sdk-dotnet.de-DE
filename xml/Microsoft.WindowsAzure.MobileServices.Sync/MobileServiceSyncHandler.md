<Type Name="MobileServiceSyncHandler" FullName="Microsoft.WindowsAzure.MobileServices.Sync.MobileServiceSyncHandler">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46af2-101">Fehler bei Vorgängen Handles Tabelle und Push Abschluss Ergebnisse.</span><span class="sxs-lookup"><span data-stu-id="46af2-101">Handles table operation errors and push completion results.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ExecuteTableOperationAsync">
      ...
      <Docs>
        <param name="operation"><span data-ttu-id="46af2-102">Instanz des <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.IMobileServiceTableOperation" /> , der einen Remotetabelle Vorgang darstellt.</span><span class="sxs-lookup"><span data-stu-id="46af2-102">Instance of <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.IMobileServiceTableOperation" /> that represents a remote table operation.</span></span></param>
        <summary>
            <span data-ttu-id="46af2-103">Eine Methode, die aufgerufen wird, um einen einzelnen tabellenvorgang gegen Remotetabelle auszuführen.</span><span class="sxs-lookup"><span data-stu-id="46af2-103">A method that is called to execute a single table operation against remote table.</span></span>
            </summary>
        <returns><span data-ttu-id="46af2-104">Aufgabe, die abgeschlossen wird, wenn der Vorgang ausgeführt wurde und Fehler wurde behandelt.</span><span class="sxs-lookup"><span data-stu-id="46af2-104">Task that completes when operation has been executed and errors have been handled.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnPushCompleteAsync">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="46af2-105">Eine Instanz von <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.MobileServicePushCompletionResult" />.</span><span class="sxs-lookup"><span data-stu-id="46af2-105">An instance of <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.MobileServicePushCompletionResult" /></span></span></param>
        <summary>
            <span data-ttu-id="46af2-106">Eine Methode, die aufgerufen wird, wenn die Push-Vorgang abgeschlossen wurde.</span><span class="sxs-lookup"><span data-stu-id="46af2-106">A method that is called when push operation has completed.</span></span>
            </summary>
        <returns><span data-ttu-id="46af2-107">Eine Aufgabe, die abgeschlossen wird, wenn das Ergebnis verarbeitet wurde.</span><span class="sxs-lookup"><span data-stu-id="46af2-107">Task that completes when result has been handled.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
