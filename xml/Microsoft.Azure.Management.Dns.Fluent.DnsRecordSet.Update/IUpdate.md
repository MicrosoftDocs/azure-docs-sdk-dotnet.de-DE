<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b1836-101">Der Satz von Konfigurationen, die für DNS-Datensatzgruppe unabhängig von ihrem Typ RecordType aktualisiert werden können.</span><span class="sxs-lookup"><span data-stu-id="b1836-101">The set of configurations that can be updated for DNS record set irrespective of their type  RecordType.</span></span>
            </summary>
