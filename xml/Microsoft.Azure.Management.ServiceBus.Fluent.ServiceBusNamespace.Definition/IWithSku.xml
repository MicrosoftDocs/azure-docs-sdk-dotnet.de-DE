<Type Name="IWithSku" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ServiceBusNamespace.Definition.IWithSku">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b5cd9-101">Die Phase der Definition des Service Bus-Namespace ermöglichen die Sku an.</span><span class="sxs-lookup"><span data-stu-id="b5cd9-101">The stage of the Service Bus namespace definition allowing to specify the sku.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSku">
      ...
      <Docs>
        <param name="namespaceSku"><span data-ttu-id="b5cd9-102">Die Sku.</span><span class="sxs-lookup"><span data-stu-id="b5cd9-102">The sku.</span></span></param>
        <summary>
            <span data-ttu-id="b5cd9-103">Gibt die Namespace-Sku.</span><span class="sxs-lookup"><span data-stu-id="b5cd9-103">Specifies the namespace sku.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="b5cd9-104">Nächste Stufe der Definition des Service Bus-Namespace.</span><span class="sxs-lookup"><span data-stu-id="b5cd9-104">Next stage of the Service Bus namespace definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>