<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ServiceBusNamespace.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="209de-101">Die Phase der Definition des Service Bus-Namespace ermöglichen die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="209de-101">The stage of the Service Bus namespace definition allowing to specify the resource group.</span></span>
            </summary>
