<Type Name="IWithQueue" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ServiceBusNamespace.Definition.IWithQueue">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c7362-101">Die Phase der Definition des Service Bus-Namespace ermöglicht, eine neue Warteschlange im Namespace hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="c7362-101">The stage of the Service Bus namespace definition allowing to add a new queue in the namespace.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithNewQueue">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="c7362-102">Der Name der Warteschlange.</span><span class="sxs-lookup"><span data-stu-id="c7362-102">Queue name.</span></span></param>
        <param name="maxSizeInMB"><span data-ttu-id="c7362-103">Maximale Größe des Arbeitsspeichers für die warteschlangenentität.</span><span class="sxs-lookup"><span data-stu-id="c7362-103">Maximum size of memory allocated for the queue entity.</span></span></param>
        <summary>
            <span data-ttu-id="c7362-104">Erstellt eine warteschlangenentität in Service Bus-Namespace an.</span><span class="sxs-lookup"><span data-stu-id="c7362-104">Creates a queue entity in the Service Bus namespace.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c7362-105">Nächste Stufe der Definition des Service Bus-Namespace.</span><span class="sxs-lookup"><span data-stu-id="c7362-105">Next stage of the Service Bus namespace definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>