<Type Name="ResourceGroupPatchable" FullName="Microsoft.Azure.Management.ResourceManager.Models.ResourceGroupPatchable">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="29ff8-101">Informationen zur Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="29ff8-101">Resource group information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29ff8-102">Initialisiert eine neue Instanz der ResourceGroupPatchable-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29ff8-102">Initializes a new instance of the ResourceGroupPatchable class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="29ff8-103">Der Name der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="29ff8-103">The name of the resource group.</span></span></param>
        <param name="properties">To be added.</param>
        <param name="managedBy"><span data-ttu-id="29ff8-104">Die ID der Ressource, die diese Ressourcengruppe verwaltet.</span><span class="sxs-lookup"><span data-stu-id="29ff8-104">The ID of the resource that manages this resource group.</span></span></param>
        <param name="tags"><span data-ttu-id="29ff8-105">Die Ressourcengruppe zugeordneten Tags.</span><span class="sxs-lookup"><span data-stu-id="29ff8-105">The tags attached to the resource group.</span></span></param>
        <summary>
            <span data-ttu-id="29ff8-106">Initialisiert eine neue Instanz der ResourceGroupPatchable-Klasse.</span><span class="sxs-lookup"><span data-stu-id="29ff8-106">Initializes a new instance of the ResourceGroupPatchable class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ManagedBy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29ff8-107">Ruft ab oder legt die ID der Ressource, die diese Ressourcengruppe verwaltet.</span><span class="sxs-lookup"><span data-stu-id="29ff8-107">Gets or sets the ID of the resource that manages this resource group.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29ff8-108">Ruft ab oder legt den Namen der Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="29ff8-108">Gets or sets the name of the resource group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="29ff8-109">Abrufen oder Festlegen der Ressourcengruppe zugeordneten Tags.</span><span class="sxs-lookup"><span data-stu-id="29ff8-109">Gets or sets the tags attached to the resource group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
