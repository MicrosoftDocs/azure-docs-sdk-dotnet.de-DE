<Type Name="PolicyDefinitionReference" FullName="Microsoft.Azure.Management.ResourceManager.Models.PolicyDefinitionReference">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2040a-101">Vom Richtlinienverweis Definition.</span><span class="sxs-lookup"><span data-stu-id="2040a-101">The policy definition reference.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2040a-102">Initialisiert eine neue Instanz der PolicyDefinitionReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2040a-102">Initializes a new instance of the PolicyDefinitionReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="policyDefinitionId"><span data-ttu-id="2040a-103">Die ID der Richtliniendefinition oder Richtlinie festgelegt Definition.</span><span class="sxs-lookup"><span data-stu-id="2040a-103">The ID of the policy definition or policy set definition.</span></span></param>
        <param name="parameters"><span data-ttu-id="2040a-104">Erforderlich, wenn ein Parameter in der Richtlinienregel verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="2040a-104">Required if a parameter is used in policy rule.</span></span></param>
        <summary>
            <span data-ttu-id="2040a-105">Initialisiert eine neue Instanz der PolicyDefinitionReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2040a-105">Initializes a new instance of the PolicyDefinitionReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2040a-106">Ruft ab oder legt erforderlich, wenn ein Parameter in der Richtlinienregel verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="2040a-106">Gets or sets required if a parameter is used in policy rule.</span></span>
            </summary>
    ...
    <Member MemberName="PolicyDefinitionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2040a-107">Ruft ab oder legt die ID der Richtliniendefinition oder Satzdefinition Richtlinie fest.</span><span class="sxs-lookup"><span data-stu-id="2040a-107">Gets or sets the ID of the policy definition or policy set definition.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
