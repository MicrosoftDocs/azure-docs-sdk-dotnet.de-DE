<Type Name="Port" FullName="Microsoft.Azure.Management.ContainerInstance.Models.Port">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="80126-101">Der Port für die Containergruppe verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="80126-101">The port exposed on the container group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80126-102">Initialisiert eine neue Instanz der Klasse Port an.</span><span class="sxs-lookup"><span data-stu-id="80126-102">Initializes a new instance of the Port class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="portProperty"><span data-ttu-id="80126-103">Die Portnummer.</span><span class="sxs-lookup"><span data-stu-id="80126-103">The port number.</span></span></param>
        <param name="protocol"><span data-ttu-id="80126-104">Das Protokoll der Port zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="80126-104">The protocol associated with the port.</span></span>
            <span data-ttu-id="80126-105">Folgende Werte sind möglich: "TCP", "UDP"</span><span class="sxs-lookup"><span data-stu-id="80126-105">Possible values include: 'TCP', 'UDP'</span></span></param>
        <summary>
            <span data-ttu-id="80126-106">Initialisiert eine neue Instanz der Klasse Port an.</span><span class="sxs-lookup"><span data-stu-id="80126-106">Initializes a new instance of the Port class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PortProperty">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80126-107">Ruft ab oder legt die Portnummer fest.</span><span class="sxs-lookup"><span data-stu-id="80126-107">Gets or sets the port number.</span></span>
            </summary>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80126-108">Ermittelt oder definiert das Protokoll der Port zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="80126-108">Gets or sets the protocol associated with the port.</span></span> <span data-ttu-id="80126-109">Folgende Werte sind möglich: "TCP", "UDP"</span><span class="sxs-lookup"><span data-stu-id="80126-109">Possible values include: 'TCP', 'UDP'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="80126-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="80126-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="80126-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="80126-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
