<Type Name="IpAddress" FullName="Microsoft.Azure.Management.ContainerInstance.Models.IpAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e91f7-101">IP-Adresse für die Containergruppe.</span><span class="sxs-lookup"><span data-stu-id="e91f7-101">IP address for the container group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e91f7-102">Initialisiert eine neue Instanz der Klasse IP-Adresse an.</span><span class="sxs-lookup"><span data-stu-id="e91f7-102">Initializes a new instance of the IpAddress class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="ports"><span data-ttu-id="e91f7-103">Die Liste der Ports, die für die Containergruppe verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="e91f7-103">The list of ports exposed on the container group.</span></span></param>
        <param name="ip"><span data-ttu-id="e91f7-104">Die IP-Adresse für das öffentliche Internet verfügbar gemacht.</span><span class="sxs-lookup"><span data-stu-id="e91f7-104">The IP exposed to the public internet.</span></span></param>
        <summary>
            <span data-ttu-id="e91f7-105">Initialisiert eine neue Instanz der Klasse IP-Adresse an.</span><span class="sxs-lookup"><span data-stu-id="e91f7-105">Initializes a new instance of the IpAddress class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Ip">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e91f7-106">Ruft ab oder legt die IP-Adresse für das öffentliche Internet verfügbar gemacht.</span><span class="sxs-lookup"><span data-stu-id="e91f7-106">Gets or sets the IP exposed to the public internet.</span></span>
            </summary>
    ...
    <Member MemberName="Ports">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e91f7-107">Ruft ab oder legt die Liste der Ports, die für die Containergruppe verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="e91f7-107">Gets or sets the list of ports exposed on the container group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e91f7-108">Gibt an, ob die IP-Adresse für das öffentliche Internet verfügbar gemacht wird.</span><span class="sxs-lookup"><span data-stu-id="e91f7-108">Specifies if the IP is exposed to the public internet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e91f7-109">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="e91f7-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="e91f7-110">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="e91f7-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
