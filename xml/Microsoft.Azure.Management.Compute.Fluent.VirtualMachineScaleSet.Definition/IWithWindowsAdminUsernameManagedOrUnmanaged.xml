<Type Name="IWithWindowsAdminUsernameManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithWindowsAdminUsernameManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="115d1-101">Die Phase der Windows-VM-Skalierungsgruppe festgelegt Definition ermöglicht Benutzername des Administrators angeben.</span><span class="sxs-lookup"><span data-stu-id="115d1-101">The stage of the Windows virtual machine scale set definition allowing to specify administrator user name.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithAdminUsername">
      ...
      <Docs>
        <param name="adminUserName"><span data-ttu-id="115d1-102">der Benutzername des Windows-Administrators.</span><span class="sxs-lookup"><span data-stu-id="115d1-102">The Windows administrator user name.</span></span> <span data-ttu-id="115d1-103">Dies muss der erforderlichen Benennungskonvention für Windows-Benutzernamen folgen.</span><span class="sxs-lookup"><span data-stu-id="115d1-103">This must follow the required naming convention for Windows user name.</span></span></param>
        <summary>
            <span data-ttu-id="115d1-104">Gibt an, der Benutzername des Administrators für den virtuellen Windows-Computer.</span><span class="sxs-lookup"><span data-stu-id="115d1-104">Specifies the administrator user name for the Windows virtual machine.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="115d1-105">Die Phase, die erstellbaren Linux-VM-Definition darstellt.</span><span class="sxs-lookup"><span data-stu-id="115d1-105">The stage representing creatable Linux VM definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>