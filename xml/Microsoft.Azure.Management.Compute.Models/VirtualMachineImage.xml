<Type Name="VirtualMachineImage" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineImage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bde6f-101">Beschreibt ein Image eines virtuellen Computers an.</span><span class="sxs-lookup"><span data-stu-id="bde6f-101">Describes a Virtual Machine Image.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bde6f-102">Initialisiert eine neue Instanz der VirtualMachineImage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bde6f-102">Initializes a new instance of the VirtualMachineImage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="bde6f-103">Der Name der Ressource.</span><span class="sxs-lookup"><span data-stu-id="bde6f-103">The name of the resource.</span></span></param>
        <param name="location"><span data-ttu-id="bde6f-104">Den unterstützten Azure-Speicherort der Ressource.</span><span class="sxs-lookup"><span data-stu-id="bde6f-104">The supported Azure location of the resource.</span></span></param>
        <param name="id"><span data-ttu-id="bde6f-105">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="bde6f-105">Resource Id</span></span></param>
        <param name="tags"><span data-ttu-id="bde6f-106">Gibt die Tags an, die mit dem virtuellen Computer zugewiesen sind.</span><span class="sxs-lookup"><span data-stu-id="bde6f-106">Specifies the tags that are assigned to the virtual machine.</span></span> <span data-ttu-id="bde6f-107">Weitere Informationen zum Verwenden von Tags finden Sie unter [mithilfe von Tags zum Organisieren Ihrer Azure-Ressourcen](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-using-tags.md).</span><span class="sxs-lookup"><span data-stu-id="bde6f-107">For more information about using tags, see [Using tags to organize your Azure resources](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-using-tags.md).</span></span></param>
        <param name="plan">To be added.</param>
        <param name="osDiskImage">To be added.</param>
        <param name="dataDiskImages">To be added.</param>
        <summary>
            <span data-ttu-id="bde6f-108">Initialisiert eine neue Instanz der VirtualMachineImage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bde6f-108">Initializes a new instance of the VirtualMachineImage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bde6f-109">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="bde6f-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="bde6f-110">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="bde6f-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
