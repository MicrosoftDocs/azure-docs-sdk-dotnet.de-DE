<Type Name="ResourceUpdate" FullName="Microsoft.Azure.Management.Compute.Models.ResourceUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eb7ea-101">Die Modell in der Ressourcendefinition.</span><span class="sxs-lookup"><span data-stu-id="eb7ea-101">The Resource model definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb7ea-102">Initialisiert eine neue Instanz der ResourceUpdate-Klasse.</span><span class="sxs-lookup"><span data-stu-id="eb7ea-102">Initializes a new instance of the ResourceUpdate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tags"><span data-ttu-id="eb7ea-103">Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="eb7ea-103">Resource tags</span></span></param>
        <param name="sku">To be added.</param>
        <summary>
            <span data-ttu-id="eb7ea-104">Initialisiert eine neue Instanz der ResourceUpdate-Klasse.</span><span class="sxs-lookup"><span data-stu-id="eb7ea-104">Initializes a new instance of the ResourceUpdate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb7ea-105">Ruft ab oder legt ihn fest Ressourcentags</span><span class="sxs-lookup"><span data-stu-id="eb7ea-105">Gets or sets resource tags</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
