<Type Name="NetworkProfile" FullName="Microsoft.Azure.Management.Compute.Models.NetworkProfile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="50d3c-101">Gibt die Netzwerkschnittstellen des virtuellen Computers an.</span><span class="sxs-lookup"><span data-stu-id="50d3c-101">Specifies the network interfaces of the virtual machine.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="50d3c-102">Initialisiert eine neue Instanz der Klasse Netzwerkprofil an.</span><span class="sxs-lookup"><span data-stu-id="50d3c-102">Initializes a new instance of the NetworkProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="networkInterfaces"><span data-ttu-id="50d3c-103">Gibt die Liste der Ressourcen-Ids für die Netzwerkschnittstellen, die dem virtuellen Computer zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="50d3c-103">Specifies the list of resource Ids for the network interfaces associated with the virtual machine.</span></span></param>
        <summary>
            <span data-ttu-id="50d3c-104">Initialisiert eine neue Instanz der Klasse Netzwerkprofil an.</span><span class="sxs-lookup"><span data-stu-id="50d3c-104">Initializes a new instance of the NetworkProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NetworkInterfaces">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="50d3c-105">Ruft ab oder legt gibt die Liste der Ressourcen-Ids für die Netzwerkschnittstellen, die dem virtuellen Computer zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="50d3c-105">Gets or sets specifies the list of resource Ids for the network interfaces associated with the virtual machine.</span></span>
            </summary>
