<Type Name="VirtualMachineScaleSetUpdateOSDisk" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetUpdateOSDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c0faf-101">Beschreibt die virtuelle Maschine Scale Set Betriebssystem-Datenträger Objekt zum Aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="c0faf-101">Describes virtual machine scale set operating system disk Update Object.</span></span> <span data-ttu-id="c0faf-102">Dies sollte für die Aktualisierung VMSS BS-Datenträger verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="c0faf-102">This should be used for Updating VMSS OS Disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0faf-103">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdateOSDisk-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c0faf-103">Initializes a new instance of the VirtualMachineScaleSetUpdateOSDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="caching"><span data-ttu-id="c0faf-104">Der caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="c0faf-104">The caching type.</span></span> <span data-ttu-id="c0faf-105">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite"</span><span class="sxs-lookup"><span data-stu-id="c0faf-105">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span></param>
        <param name="image"><span data-ttu-id="c0faf-106">Die Quelle Benutzer Image "virtualharddisk".</span><span class="sxs-lookup"><span data-stu-id="c0faf-106">The Source User Image VirtualHardDisk.</span></span> <span data-ttu-id="c0faf-107">Diese "-virtualharddisk" wird vor der Verwendung für die Verbindung mit dem virtuellen Computer kopiert werden.</span><span class="sxs-lookup"><span data-stu-id="c0faf-107">This VirtualHardDisk will be copied before using it to attach to the Virtual Machine.</span></span> <span data-ttu-id="c0faf-108">Wenn SourceImage bereitgestellt wird, sollte der Destination VirtualHardDisk nicht vorhanden.</span><span class="sxs-lookup"><span data-stu-id="c0faf-108">If SourceImage is provided, the destination VirtualHardDisk should not exist.</span></span></param>
        <param name="vhdContainers"><span data-ttu-id="c0faf-109">Die Liste der virtuellen Festplatte Container Uris.</span><span class="sxs-lookup"><span data-stu-id="c0faf-109">The list of virtual hard disk container uris.</span></span></param>
        <param name="managedDisk"><span data-ttu-id="c0faf-110">Die verwaltete Datenträgerparameter.</span><span class="sxs-lookup"><span data-stu-id="c0faf-110">The managed disk parameters.</span></span></param>
        <summary>
            <span data-ttu-id="c0faf-111">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdateOSDisk-Klasse.</span><span class="sxs-lookup"><span data-stu-id="c0faf-111">Initializes a new instance of the VirtualMachineScaleSetUpdateOSDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Caching">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0faf-112">Abrufen oder festlegen den caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="c0faf-112">Gets or sets the caching type.</span></span> <span data-ttu-id="c0faf-113">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite"</span><span class="sxs-lookup"><span data-stu-id="c0faf-113">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span>
            </summary>
    ...
    <Member MemberName="Image">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0faf-114">Abrufen oder Festlegen der Quelle Benutzer Image "virtualharddisk".</span><span class="sxs-lookup"><span data-stu-id="c0faf-114">Gets or sets the Source User Image VirtualHardDisk.</span></span> <span data-ttu-id="c0faf-115">Diese "-virtualharddisk" wird vor der Verwendung für die Verbindung mit dem virtuellen Computer kopiert werden.</span><span class="sxs-lookup"><span data-stu-id="c0faf-115">This VirtualHardDisk will be copied before using it to attach to the Virtual Machine.</span></span> <span data-ttu-id="c0faf-116">Wenn SourceImage bereitgestellt wird, sollte der Destination VirtualHardDisk nicht vorhanden.</span><span class="sxs-lookup"><span data-stu-id="c0faf-116">If SourceImage is provided, the destination VirtualHardDisk should not exist.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedDisk">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0faf-117">Ruft ab oder legt den verwalteten Datenträgerparameter.</span><span class="sxs-lookup"><span data-stu-id="c0faf-117">Gets or sets the managed disk parameters.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VhdContainers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0faf-118">Ruft ab oder legt die Liste der virtuellen Festplatte Container Uris.</span><span class="sxs-lookup"><span data-stu-id="c0faf-118">Gets or sets the list of virtual hard disk container uris.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
