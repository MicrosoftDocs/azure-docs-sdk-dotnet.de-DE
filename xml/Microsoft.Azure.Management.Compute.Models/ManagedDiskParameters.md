<Type Name="ManagedDiskParameters" FullName="Microsoft.Azure.Management.Compute.Models.ManagedDiskParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46cea-101">Die Parameter eines verwalteten Datenträgers.</span><span class="sxs-lookup"><span data-stu-id="46cea-101">The parameters of a managed disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46cea-102">Initialisiert eine neue Instanz der ManagedDiskParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="46cea-102">Initializes a new instance of the ManagedDiskParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="46cea-103">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="46cea-103">Resource Id</span></span></param>
        <param name="storageAccountType"><span data-ttu-id="46cea-104">Gibt den Typ des Speicher-Konto für den verwalteten Datenträger.</span><span class="sxs-lookup"><span data-stu-id="46cea-104">Specifies the storage account type for the managed disk.</span></span> <span data-ttu-id="46cea-105">Mögliche Werte sind: Standard_LRS oder "premium_lrs".</span><span class="sxs-lookup"><span data-stu-id="46cea-105">Possible values are: Standard_LRS or Premium_LRS.</span></span> <span data-ttu-id="46cea-106">Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""</span><span class="sxs-lookup"><span data-stu-id="46cea-106">Possible values include: 'Standard_LRS', 'Premium_LRS'</span></span></param>
        <summary>
            <span data-ttu-id="46cea-107">Initialisiert eine neue Instanz der ManagedDiskParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="46cea-107">Initializes a new instance of the ManagedDiskParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="StorageAccountType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46cea-108">Ruft ab oder legt gibt der speicherkontotyp für den verwalteten Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="46cea-108">Gets or sets specifies the storage account type for the managed disk.</span></span> <span data-ttu-id="46cea-109">Mögliche Werte sind: Standard_LRS oder "premium_lrs".</span><span class="sxs-lookup"><span data-stu-id="46cea-109">Possible values are: Standard_LRS or Premium_LRS.</span></span> <span data-ttu-id="46cea-110">Folgende Werte sind möglich: "Standard_LRS", "premium_lrs" ""</span><span class="sxs-lookup"><span data-stu-id="46cea-110">Possible values include: 'Standard_LRS', 'Premium_LRS'</span></span>
            </summary>
