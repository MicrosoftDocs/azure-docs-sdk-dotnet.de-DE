<Type Name="VirtualMachineScaleSetUpdatePublicIPAddressConfiguration" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetUpdatePublicIPAddressConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="41b47-101">Beschreibt eine Skalierung von virtuellen Computern legen Sie IP-Konfiguration des PublicIPAddress-Konfiguration</span><span class="sxs-lookup"><span data-stu-id="41b47-101">Describes a virtual machines scale set IP Configuration's PublicIPAddress configuration</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="41b47-102">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdatePublicIPAddressConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="41b47-102">Initializes a new instance of the VirtualMachineScaleSetUpdatePublicIPAddressConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="41b47-103">Der Konfigurationsname der öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="41b47-103">The publicIP address configuration name.</span></span></param>
        <param name="idleTimeoutInMinutes"><span data-ttu-id="41b47-104">Das Leerlauftimeout der öffentlichen IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="41b47-104">The idle timeout of the public IP address.</span></span></param>
        <param name="dnsSettings"><span data-ttu-id="41b47-105">Die DNS-Einstellungen für die öffentliche IP-Adressen verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="41b47-105">The dns settings to be applied on the publicIP addresses .</span></span></param>
        <summary>
            <span data-ttu-id="41b47-106">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdatePublicIPAddressConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="41b47-106">Initializes a new instance of the VirtualMachineScaleSetUpdatePublicIPAddressConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DnsSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="41b47-107">Ruft ab oder legt die DNS-Einstellungen für die öffentliche IP-Adressen verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="41b47-107">Gets or sets the dns settings to be applied on the publicIP addresses .</span></span>
            </summary>
    ...
    <Member MemberName="IdleTimeoutInMinutes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="41b47-108">Ruft ab oder legt das Leerlauftimeout der öffentlichen IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="41b47-108">Gets or sets the idle timeout of the public IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="41b47-109">Ruft ab oder legt den Namen der öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="41b47-109">Gets or sets the publicIP address configuration name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="41b47-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="41b47-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="41b47-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="41b47-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
