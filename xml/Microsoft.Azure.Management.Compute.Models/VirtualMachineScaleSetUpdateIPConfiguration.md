<Type Name="VirtualMachineScaleSetUpdateIPConfiguration" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetUpdateIPConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2e403-101">Beschreibt eine virtuelle Maschine Skalierung Satz Netzwerkprofil des IP-Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="2e403-101">Describes a virtual machine scale set network profile's IP configuration.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-102">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdateIPConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2e403-102">Initializes a new instance of the VirtualMachineScaleSetUpdateIPConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="2e403-103">Ressourcen-Id</span><span class="sxs-lookup"><span data-stu-id="2e403-103">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="2e403-104">Der Name des IP-Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="2e403-104">The IP configuration name.</span></span></param>
        <param name="subnet"><span data-ttu-id="2e403-105">Das Subnetz.</span><span class="sxs-lookup"><span data-stu-id="2e403-105">The subnet.</span></span></param>
        <param name="primary"><span data-ttu-id="2e403-106">Gibt die primäre IP-Konfiguration an, für den Fall, dass die Netzwerkschnittstelle mit mehr als eine IP-Konfiguration hat.</span><span class="sxs-lookup"><span data-stu-id="2e403-106">Specifies the primary IP Configuration in case the network interface has more than one IP Configuration.</span></span></param>
        <param name="publicIPAddressConfiguration"><span data-ttu-id="2e403-107">Die PublicIPAddressConfiguration.</span><span class="sxs-lookup"><span data-stu-id="2e403-107">The publicIPAddressConfiguration.</span></span></param>
        <param name="privateIPAddressVersion"><span data-ttu-id="2e403-108">Von Api-Version 2017-03-30 darstellt oder höher, er, ob die spezifische IP-Konfiguration IPv4 oder IPv6 ist.</span><span class="sxs-lookup"><span data-stu-id="2e403-108">Available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6.</span></span> <span data-ttu-id="2e403-109">Standardmäßig wird als IPv4 verwendet.</span><span class="sxs-lookup"><span data-stu-id="2e403-109">Default is taken as IPv4.</span></span>
            <span data-ttu-id="2e403-110">Mögliche Werte sind: "IPv4" und "IPv6".</span><span class="sxs-lookup"><span data-stu-id="2e403-110">Possible values are: 'IPv4' and 'IPv6'.</span></span> <span data-ttu-id="2e403-111">Folgende Werte sind möglich: "IPv4", "IPv6"</span><span class="sxs-lookup"><span data-stu-id="2e403-111">Possible values include: 'IPv4', 'IPv6'</span></span></param>
        <param name="applicationGatewayBackendAddressPools"><span data-ttu-id="2e403-112">Application Gateway Back-End-Adresspools.</span><span class="sxs-lookup"><span data-stu-id="2e403-112">The application gateway backend address pools.</span></span></param>
        <param name="loadBalancerBackendAddressPools"><span data-ttu-id="2e403-113">Load Balancer Back-End-Adresspools.</span><span class="sxs-lookup"><span data-stu-id="2e403-113">The load balancer backend address pools.</span></span></param>
        <param name="loadBalancerInboundNatPools"><span data-ttu-id="2e403-114">Der Load Balancer eingehende Nat-Pools an.</span><span class="sxs-lookup"><span data-stu-id="2e403-114">The load balancer inbound nat pools.</span></span></param>
        <summary>
            <span data-ttu-id="2e403-115">Initialisiert eine neue Instanz der VirtualMachineScaleSetUpdateIPConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2e403-115">Initializes a new instance of the VirtualMachineScaleSetUpdateIPConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ApplicationGatewayBackendAddressPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-116">Ruft ab oder legt das Application Gateway Back-End-Adresspools.</span><span class="sxs-lookup"><span data-stu-id="2e403-116">Gets or sets the application gateway backend address pools.</span></span>
            </summary>
    ...
    <Member MemberName="LoadBalancerBackendAddressPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-117">Abrufen oder Festlegen der Load Balancer Back-End-Adresspools.</span><span class="sxs-lookup"><span data-stu-id="2e403-117">Gets or sets the load balancer backend address pools.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancerInboundNatPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-118">Ruft ab oder legt ihn fest der Load Balancer eingehende Nat-Pools.</span><span class="sxs-lookup"><span data-stu-id="2e403-118">Gets or sets the load balancer inbound nat pools.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-119">Ruft ab oder legt den Namen der IP-Konfiguration fest.</span><span class="sxs-lookup"><span data-stu-id="2e403-119">Gets or sets the IP configuration name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Primary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-120">Ruft ab oder legt gibt die primäre IP-Konfiguration für den Fall, dass die Netzwerkschnittstelle mit mehr als eine IP-Konfiguration hat.</span><span class="sxs-lookup"><span data-stu-id="2e403-120">Gets or sets specifies the primary IP Configuration in case the network interface has more than one IP Configuration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAddressVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-121">Ruft ab oder legt ihn fest-Api-Version 2017-03-30 verfügbar oder höher, stellt, ob die spezifische IP-Konfiguration IPv4 oder IPv6 ist dar.</span><span class="sxs-lookup"><span data-stu-id="2e403-121">Gets or sets available from Api-Version 2017-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6.</span></span>
            <span data-ttu-id="2e403-122">Standardmäßig wird als IPv4 verwendet.</span><span class="sxs-lookup"><span data-stu-id="2e403-122">Default is taken as IPv4.</span></span>  <span data-ttu-id="2e403-123">Mögliche Werte sind: "IPv4" und "IPv6".</span><span class="sxs-lookup"><span data-stu-id="2e403-123">Possible values are: 'IPv4' and 'IPv6'.</span></span>
            <span data-ttu-id="2e403-124">Folgende Werte sind möglich: "IPv4", "IPv6"</span><span class="sxs-lookup"><span data-stu-id="2e403-124">Possible values include: 'IPv4', 'IPv6'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddressConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-125">Ruft ab oder legt die PublicIPAddressConfiguration.</span><span class="sxs-lookup"><span data-stu-id="2e403-125">Gets or sets the publicIPAddressConfiguration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-126">Ruft ab oder legt das Subnetz.</span><span class="sxs-lookup"><span data-stu-id="2e403-126">Gets or sets the subnet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2e403-127">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="2e403-127">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="2e403-128">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="2e403-128">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
