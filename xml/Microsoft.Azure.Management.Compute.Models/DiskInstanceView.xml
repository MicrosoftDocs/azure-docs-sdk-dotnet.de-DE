<Type Name="DiskInstanceView" FullName="Microsoft.Azure.Management.Compute.Models.DiskInstanceView">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bb563-101">Die Instanzansicht des Datenträgers.</span><span class="sxs-lookup"><span data-stu-id="bb563-101">The instance view of the disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb563-102">Initialisiert eine neue Instanz der DiskInstanceView-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bb563-102">Initializes a new instance of the DiskInstanceView class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="bb563-103">Der Name des Datenträgers.</span><span class="sxs-lookup"><span data-stu-id="bb563-103">The disk name.</span></span></param>
        <param name="encryptionSettings"><span data-ttu-id="bb563-104">Gibt die Einstellungen für die Verschlüsselung für den Betriebssystem-Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="bb563-104">Specifies the encryption settings for the OS Disk.</span></span> <span data-ttu-id="bb563-105">&lt;Brasilien&gt;&lt;Br&gt; -api-Mindestversion: 2015-06-15</span><span class="sxs-lookup"><span data-stu-id="bb563-105">&lt;br&gt;&lt;br&gt; Minimum api-version: 2015-06-15</span></span></param>
        <param name="statuses"><span data-ttu-id="bb563-106">Die Statusinformationen für die Ressource.</span><span class="sxs-lookup"><span data-stu-id="bb563-106">The resource status information.</span></span></param>
        <summary>
            <span data-ttu-id="bb563-107">Initialisiert eine neue Instanz der DiskInstanceView-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bb563-107">Initializes a new instance of the DiskInstanceView class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EncryptionSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb563-108">Ruft ab oder legt gibt die Einstellungen für die Verschlüsselung für den Betriebssystem-Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="bb563-108">Gets or sets specifies the encryption settings for the OS Disk.</span></span>
            <span data-ttu-id="bb563-109">&amp;Lt; Br&amp;Gt;&amp; Lt; Br&amp;Gt; Api-Mindestversion: 2015-06-15</span><span class="sxs-lookup"><span data-stu-id="bb563-109">&amp;lt;br&amp;gt;&amp;lt;br&amp;gt; Minimum api-version: 2015-06-15</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb563-110">Ruft ab oder legt den Datenträgernamen.</span><span class="sxs-lookup"><span data-stu-id="bb563-110">Gets or sets the disk name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Statuses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bb563-111">Ruft ab oder legt die Statusinformationen für die Ressource.</span><span class="sxs-lookup"><span data-stu-id="bb563-111">Gets or sets the resource status information.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
