<Type Name="RunCommandResult" FullName="Microsoft.Azure.Management.Compute.Models.RunCommandResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1bdc1-101">Führen Sie Befehlsantwort-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="1bdc1-101">Run command operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bdc1-102">Initialisiert eine neue Instanz der RunCommandResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="1bdc1-102">Initializes a new instance of the RunCommandResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="1bdc1-103">Vorgangs-ID</span><span class="sxs-lookup"><span data-stu-id="1bdc1-103">Operation ID</span></span></param>
        <param name="status"><span data-ttu-id="1bdc1-104">Vorgangsstatus</span><span class="sxs-lookup"><span data-stu-id="1bdc1-104">Operation status</span></span></param>
        <param name="startTime"><span data-ttu-id="1bdc1-105">Startzeit des Vorgangs</span><span class="sxs-lookup"><span data-stu-id="1bdc1-105">Start time of the operation</span></span></param>
        <param name="endTime"><span data-ttu-id="1bdc1-106">Die Endzeit des Vorgangs</span><span class="sxs-lookup"><span data-stu-id="1bdc1-106">End time of the operation</span></span></param>
        <param name="error"><span data-ttu-id="1bdc1-107">API-Fehler</span><span class="sxs-lookup"><span data-stu-id="1bdc1-107">Api error</span></span></param>
        <param name="output"><span data-ttu-id="1bdc1-108">Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="1bdc1-108">Operation output data (raw JSON)</span></span></param>
        <summary>
            <span data-ttu-id="1bdc1-109">Initialisiert eine neue Instanz der RunCommandResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="1bdc1-109">Initializes a new instance of the RunCommandResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Output">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bdc1-110">Ruft ab oder legt ihn fest Ausgabe Vorgangsdaten (raw JSON)</span><span class="sxs-lookup"><span data-stu-id="1bdc1-110">Gets or sets operation output data (raw JSON)</span></span>
            </summary>
