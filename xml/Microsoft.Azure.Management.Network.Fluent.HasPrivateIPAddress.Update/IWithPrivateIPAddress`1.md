<Type Name="IWithPrivateIPAddress&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPrivateIPAddress.Update.IWithPrivateIPAddress&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="04639-101">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="04639-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="04639-102">Die Phase eines Updates zulassen an um die private IP-Adresse zu ändern.</span><span class="sxs-lookup"><span data-stu-id="04639-102">The stage of an update allowing to modify the private IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrivateIPAddressDynamic">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04639-103">Aktiviert dynamischen private IP-Adresszuordnung innerhalb des zugeordneten Subnetzes an.</span><span class="sxs-lookup"><span data-stu-id="04639-103">Enables dynamic private IP address allocation within the associated subnet.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="04639-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="04639-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPrivateIPAddressStatic">
      ...
      <Docs>
        <param name="ipAddress"><span data-ttu-id="04639-105">Eine statische IP-Adresse innerhalb des zugehörigen privaten IP-Adressbereichs.</span><span class="sxs-lookup"><span data-stu-id="04639-105">A static IP address within the associated private IP range.</span></span></param>
        <summary>
            <span data-ttu-id="04639-106">Weist die angegebene statische private IP-Adresse innerhalb des zugeordneten Subnetzes an.</span><span class="sxs-lookup"><span data-stu-id="04639-106">Assigns the specified static private IP address within the associated subnet.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="04639-107">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="04639-107">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>