<Type Name="BatchAccountKeysInner" FullName="Microsoft.Azure.Management.Batch.Fluent.Models.BatchAccountKeysInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cbc22-101">Ein Satz von Azure Batch-Account-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="cbc22-101">A set of Azure Batch account keys.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cbc22-102">Initialisiert eine neue Instanz der BatchAccountKeysInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cbc22-102">Initializes a new instance of the BatchAccountKeysInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Primary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cbc22-103">Ruft ab oder legt den Primärschlüssel, der dem Konto zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="cbc22-103">Gets or sets the primary key associated with the account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Secondary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cbc22-104">Ruft ab oder legt den sekundären Schlüssel, der dem Konto zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="cbc22-104">Gets or sets the secondary key associated with the account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
