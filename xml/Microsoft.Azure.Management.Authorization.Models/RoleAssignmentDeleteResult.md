<Type Name="RoleAssignmentDeleteResult" FullName="Microsoft.Azure.Management.Authorization.Models.RoleAssignmentDeleteResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="226dc-101">Löschen von rollenzuweisungen Ergebnis</span><span class="sxs-lookup"><span data-stu-id="226dc-101">Role assignments delete result</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="226dc-102">Initialisiert eine neue Instanz der RoleAssignmentDeleteResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="226dc-102">Initializes a new instance of the RoleAssignmentDeleteResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RoleAssignment">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="226dc-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="226dc-103">Optional.</span></span> <span data-ttu-id="226dc-104">Rollenzuweisung</span><span class="sxs-lookup"><span data-stu-id="226dc-104">Role assignment</span></span>
            </summary>
