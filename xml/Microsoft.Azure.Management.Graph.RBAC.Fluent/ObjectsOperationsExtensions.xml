<Type Name="ObjectsOperationsExtensions" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.ObjectsOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d3aef-101">Erweiterungsmethoden für ObjectsOperations.</span><span class="sxs-lookup"><span data-stu-id="d3aef-101">Extension methods for ObjectsOperations.</span></span>
            </summary>
    ...
    <Member MemberName="GetCurrentUserAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="d3aef-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="d3aef-102">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="d3aef-103">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="d3aef-103">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="d3aef-104">Ruft die Details für den derzeit angemeldeten Benutzer ab.</span><span class="sxs-lookup"><span data-stu-id="d3aef-104">Gets the details for the currently logged-in user.</span></span>
            </summary>
