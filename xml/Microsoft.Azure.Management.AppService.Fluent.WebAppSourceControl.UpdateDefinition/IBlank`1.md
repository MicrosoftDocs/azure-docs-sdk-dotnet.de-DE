<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppSourceControl.UpdateDefinition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c01e2-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="c01e2-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="c01e2-102">Die erste Phase der Web-app Quelle Steuerelementdefinition als Teil eines Updates einer Web-app.</span><span class="sxs-lookup"><span data-stu-id="c01e2-102">The first stage of a web app source control definition as part of an update of a web app.</span></span>
            </summary>
