<Type Name="IWithPrimaryInternalLoadBalancerNatPool" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternalLoadBalancerNatPool">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="478f2-101">Die Phase der VM-Skalierungsgruppe festgelegt Update ermöglicht, die primären Netzwerkschnittstelle der virtuellen Computer in der Menge Skalierung eingehenden NAT-Pools, von der ausgewählten internen Load Balancer zugeordnet werden soll.</span><span class="sxs-lookup"><span data-stu-id="478f2-101">The stage of a virtual machine scale set update allowing to associate inbound NAT pools of the selected internal load balancer with the primary network interface of the virtual machines in the scale set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrimaryInternalLoadBalancerInboundNatPools">
      ...
      <Docs>
        <param name="natPoolNames"><span data-ttu-id="478f2-102">Die Namen der vorhandenen eingehenden NAT-Pools in der ausgewählten Load Balancer.</span><span class="sxs-lookup"><span data-stu-id="478f2-102">The names of existing inbound NAT pools in the selected load balancer.</span></span></param>
        <summary>
            <span data-ttu-id="478f2-103">Ordnet der angegebenen internen Lastenausgleich eingehende NAT-Pools mit der die primäre Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.</span><span class="sxs-lookup"><span data-stu-id="478f2-103">Associates the specified internal load balancer inbound NAT pools with the the primary network interface of the virtual machines in the scale set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="478f2-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="478f2-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>