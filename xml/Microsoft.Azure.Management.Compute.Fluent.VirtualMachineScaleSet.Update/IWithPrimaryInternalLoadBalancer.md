<Type Name="IWithPrimaryInternalLoadBalancer" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternalLoadBalancer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="210fd-101">Virtuelle Computer festlegen des Status der eine virtuelle Maschine Skalierung Gruppe Update mit einem internen Lastenausgleich für die primäre Netzwerkschnittstelle der Skala an.</span><span class="sxs-lookup"><span data-stu-id="210fd-101">The stage of a virtual machine scale set update allowing to specify an internal load balancer for the primary network interface of the scale set virtual machines.</span></span>
            </summary>
