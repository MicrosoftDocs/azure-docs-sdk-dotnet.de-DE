<Type Name="IWithPrimaryInternetFacingLoadBalancerBackendOrNatPool" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternetFacingLoadBalancerBackendOrNatPool">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bcbde-101">Festlegen des Status der VM-Skalierungsgruppe, Updates zulassen, Zuordnen einer Back-End-Pool und/oder eingehenden NAT-Pool des ausgewählten Internetzugriff zum Lastenausgleich mit der primären Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.</span><span class="sxs-lookup"><span data-stu-id="bcbde-101">The stage of a virtual machine scale set update allowing to associate a backend pool and/or inbound NAT pool of the selected Internet-facing load balancer with the primary network interface of the virtual machines in the scale set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrimaryInternetFacingLoadBalancerBackends">
      ...
      <Docs>
        <param name="backendNames"><span data-ttu-id="bcbde-102">Die Back-End-Namen.</span><span class="sxs-lookup"><span data-stu-id="bcbde-102">The backend names.</span></span></param>
        <summary>
            <span data-ttu-id="bcbde-103">Ordnet die angegebene Internetzugriff Laden des Lastenausgleichsmoduls-Back-Ends mit der primären Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.</span><span class="sxs-lookup"><span data-stu-id="bcbde-103">Associates the specified Internet-facing load balancer backends with the primary network interface of the virtual machines in the scale set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="bcbde-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="bcbde-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>