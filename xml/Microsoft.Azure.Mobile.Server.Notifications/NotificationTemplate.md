<Type Name="NotificationTemplate" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0f224-101">Ein <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" /> enthält Informationen zum Registrieren einer Vorlage mit einem <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />.</span><span class="sxs-lookup"><span data-stu-id="0f224-101">A <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" /> contains information for registering a template with a <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Body">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0f224-102">Die benachrichtigungsnutzlast für diesen <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />.</span><span class="sxs-lookup"><span data-stu-id="0f224-102">The notification payload for this <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />.</span></span>
            </summary>
    ...
    <Member MemberName="Headers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0f224-103">Für WNS geben ein Wörterbuch mit Namen von Spaltenüberschriften auf Werte, die die Benachrichtigung angeben (Beispiel:) "X-WNS-TYPE": "Wns/Toast").</span><span class="sxs-lookup"><span data-stu-id="0f224-103">For WNS, a dictionary of header names to values that specify the notification type (i.e. "X-WNS-TYPE":"wns/toast").</span></span>
            <span data-ttu-id="0f224-104">Diese Eigenschaft ist für alle anderen Plattformen bedeutungslos.</span><span class="sxs-lookup"><span data-stu-id="0f224-104">For all other platforms this property is meaningless.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
