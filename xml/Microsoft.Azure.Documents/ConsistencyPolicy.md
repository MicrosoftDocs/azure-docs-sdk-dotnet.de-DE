<Type Name="ConsistencyPolicy" FullName="Microsoft.Azure.Documents.ConsistencyPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="691da-101">Stellt die Konsistenz Richtlinie eines Kontos für die Datenbank des Diensts Azure-Cosmos-Datenbank dar.</span><span class="sxs-lookup"><span data-stu-id="691da-101">Represents the consistency policy of a database account of the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="691da-102">Der Standardkonstruktor für ConsistencyPolicy-Klasse in der Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="691da-102">Default constructor for ConsistencyPolicy class in the Azure Cosmos DB service.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultConsistencyLevel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="691da-103">Abrufen oder Festlegen der Standardebene für die Konsistenz im Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="691da-103">Get or set the default consistency level in the Azure Cosmos DB service.</span></span>
            </summary>
    ...
    <Member MemberName="MaxStalenessIntervalInSeconds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="691da-104">Die maximal zulässige aus Gründen der Konsistenz mit begrenzter Veraltung Veraltung in Begriffen Zeitintervall im Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="691da-104">For bounded staleness consistency, the maximum allowed staleness in terms time interval in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxStalenessPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="691da-105">Die maximal zulässige aus Gründen der Konsistenz mit begrenzter Veraltung Überalterung Begriffe Hauptunterschied in Sequenznummern (aka Version) im Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="691da-105">For bounded staleness consistency, the maximum allowed staleness in terms difference in sequence numbers (aka version) in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
