<Type Name="ReplicationPolicy" FullName="Microsoft.Azure.Documents.ReplicationPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9150c-101">Replikationsrichtlinie.</span><span class="sxs-lookup"><span data-stu-id="9150c-101">Replication policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9150c-102">Konstruktor.</span><span class="sxs-lookup"><span data-stu-id="9150c-102">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AsyncReplication">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9150c-103">Gibt an, ob asynchrone Replikation aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="9150c-103">Whether or not async replication is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="MaxReplicaSetSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9150c-104">Maximale Anzahl der Replikate für die Partition.</span><span class="sxs-lookup"><span data-stu-id="9150c-104">Maximum number of replicas for the partition.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MinReplicaSetSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9150c-105">Minimale Anzahl der Replikate, um die Verfügbarkeit der Partition sicherzustellen.</span><span class="sxs-lookup"><span data-stu-id="9150c-105">Minimum number of replicas to ensure availability of the partition.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
