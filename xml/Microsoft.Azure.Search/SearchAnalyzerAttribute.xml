<Type Name="SearchAnalyzerAttribute" FullName="Microsoft.Azure.Search.SearchAnalyzerAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d1b41-101">Gibt an, dass die <see cref="T:Microsoft.Azure.Search.Models.Field" /> von generierten <see cref="T:Microsoft.Azure.Search.FieldBuilder" /> für das Ziel aufweisen seine <see cref="P:Microsoft.Azure.Search.Models.Field.SearchAnalyzer" /> -Eigenschaft auf den angegebenen Analyzer festgelegt.</span><span class="sxs-lookup"><span data-stu-id="d1b41-101">Indicates that the <see cref="T:Microsoft.Azure.Search.Models.Field" /> generated by <see cref="T:Microsoft.Azure.Search.FieldBuilder" /> for the target property should have its <see cref="P:Microsoft.Azure.Search.Models.Field.SearchAnalyzer" /> property set to the specified analyzer.</span></span>
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="analyzerName">
            <span data-ttu-id="d1b41-102">Der Name des Analyzers.</span><span class="sxs-lookup"><span data-stu-id="d1b41-102">The name of the analyzer.</span></span> <span data-ttu-id="d1b41-103">Verwenden Sie einen Namen im <see cref="T:Microsoft.Azure.Search.Models.AnalyzerName.AsString" /> oder den Namen einer benutzerdefinierten Analyzer.</span><span class="sxs-lookup"><span data-stu-id="d1b41-103">Use one of the names in <see cref="T:Microsoft.Azure.Search.Models.AnalyzerName.AsString" /> or the name of a custom analyzer.</span></span>
            </param>
        <summary>
            <span data-ttu-id="d1b41-104">Gibt an, dass der angegebene Analyzer verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="d1b41-104">Indicates that the specified analyzer should be used.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
