<Type Name="MigrationConfig" FullName="Microsoft.WindowsAzure.Management.StorSimple.MigrationConfig">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5256b-101">Stellt den o/p von Get-, die alle Migration zu planen</span><span class="sxs-lookup"><span data-stu-id="5256b-101">Represents the o/p of get all migration plan</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="migrationPlan"><span data-ttu-id="5256b-102">Migrationsplan</span><span class="sxs-lookup"><span data-stu-id="5256b-102">Migration Plan</span></span></param>
        <summary>
            <span data-ttu-id="5256b-103">Erstellt die Migration Config(s) nicht importiert</span><span class="sxs-lookup"><span data-stu-id="5256b-103">Constructs the migration config(s) imported</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeviceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5256b-104">Ruft ab oder legt den Namen des Zielgeräts zugeordnete Config hochgeladen</span><span class="sxs-lookup"><span data-stu-id="5256b-104">Gets or sets the target device name associated with config uploaded</span></span>
            </summary>
    ...
    <Member MemberName="LegacyConfigId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5256b-105">Ruft ab oder legt ihn fest Config hochgeladen</span><span class="sxs-lookup"><span data-stu-id="5256b-105">Gets or sets Config uploaded</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
