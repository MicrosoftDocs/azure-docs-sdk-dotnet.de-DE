<Type Name="LegacyApplianceConfiguration" FullName="Microsoft.WindowsAzure.Management.StorSimple.LegacyApplianceConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a1bb4-101">Ältere Anwendungskonfiguration von zurückgegeben werden sollen Importieren älterer Config-cmdlet</span><span class="sxs-lookup"><span data-stu-id="a1bb4-101">Legacy appliance configuration to be returned by import legacy config cmdlet</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ConfigFile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-102">Abrufen oder Festlegen des Namens der Config-Datei importiert wird</span><span class="sxs-lookup"><span data-stu-id="a1bb4-102">Get or sets the name of the config file which is imported</span></span>
            </summary>
    ...
    <Member MemberName="Details">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-103">Ruft ab oder legt die Metadaten für die Konfiguration von legacy-Appliance, der migriert werden muss</span><span class="sxs-lookup"><span data-stu-id="a1bb4-103">Gets or sets the config metadata from legacy appliance which needs to be migrated</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ImportedOn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-104">Ruft ab oder legt die Ortszeit, zu dem Config importiert wird</span><span class="sxs-lookup"><span data-stu-id="a1bb4-104">Gets or sets the local time at which config is imported</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LegacyConfigId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-105">Ruft ab oder legt dem eindeutigen Bezeichner für die Konfiguration der zu importierenden</span><span class="sxs-lookup"><span data-stu-id="a1bb4-105">Gets or sets the unique identifier for the config which being imported</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Result">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-106">Ruft ab oder legt das Ergebnis o/p-Konfiguration importieren</span><span class="sxs-lookup"><span data-stu-id="a1bb4-106">Gets or sets the o/p result of import config</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetApplianceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1bb4-107">Ruft ab oder legt den Namen des Ziel-appliance</span><span class="sxs-lookup"><span data-stu-id="a1bb4-107">Gets or sets the name of target appliance</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
