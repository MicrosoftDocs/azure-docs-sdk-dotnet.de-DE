<Type Name="RangeMappingCreationInfo&lt;TKey&gt;" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMappingCreationInfo&lt;TKey&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="TKey"><span data-ttu-id="efcb3-101">Der Typ des Schlüssels (Begrenzungswerte).</span><span class="sxs-lookup"><span data-stu-id="efcb3-101">Type of the key (boundary values).</span></span></typeparam>
    <summary>
            <span data-ttu-id="efcb3-102">Argumente, die zum Erstellen einer <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMapping`1" />.</span><span class="sxs-lookup"><span data-stu-id="efcb3-102">Arguments used to create a <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMapping`1" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="efcb3-103">Im Bereich zugeordnet werden.</span><span class="sxs-lookup"><span data-stu-id="efcb3-103">Range being mapped.</span></span></param>
        <param name="shard"><span data-ttu-id="efcb3-104">Shard als Zuordnungsziel für die verwendet.</span><span class="sxs-lookup"><span data-stu-id="efcb3-104">Shard used as the mapping target.</span></span></param>
        <param name="status"><span data-ttu-id="efcb3-105">Status der Zuordnung.</span><span class="sxs-lookup"><span data-stu-id="efcb3-105">Status of the mapping.</span></span></param>
        <summary>
            <span data-ttu-id="efcb3-106">Argumente, die für die Erstellung einer Range-Zuordnung verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="efcb3-106">Arguments used for creation of a range mapping.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Shard">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efcb3-107">Ruft den Shard für die Zuordnung ab.</span><span class="sxs-lookup"><span data-stu-id="efcb3-107">Gets Shard for the mapping.</span></span>
            </summary>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efcb3-108">Ruft die Status der Zuordnung ab.</span><span class="sxs-lookup"><span data-stu-id="efcb3-108">Gets Status of the mapping.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efcb3-109">Ruft die Bereich zugeordnet werden.</span><span class="sxs-lookup"><span data-stu-id="efcb3-109">Gets Range being mapped.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
