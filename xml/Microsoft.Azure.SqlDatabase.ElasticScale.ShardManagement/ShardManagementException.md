<Type Name="ShardManagementException" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.ShardManagementException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6e2cf-101">Darstellung von Ausnahmen, die auftreten, während Speichervorgängen.</span><span class="sxs-lookup"><span data-stu-id="6e2cf-101">Representation of exceptions that occur during storage operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ErrorCategory">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e2cf-102">Fehlerkategorie.</span><span class="sxs-lookup"><span data-stu-id="6e2cf-102">Error category.</span></span>
            </summary>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e2cf-103">Fehlercode</span><span class="sxs-lookup"><span data-stu-id="6e2cf-103">Error code.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetObjectData">
      ...
      <Docs>
        <param name="info"><span data-ttu-id="6e2cf-104">Mit Daten aufzufüllende SerializationInfo-Objekt.</span><span class="sxs-lookup"><span data-stu-id="6e2cf-104">The SerializationInfo to populate with data.</span></span></param>
        <param name="context"><span data-ttu-id="6e2cf-105">Das Ziel (Siehe StreamingContext) dieser Serialisierung.</span><span class="sxs-lookup"><span data-stu-id="6e2cf-105">The destination (see StreamingContext) for this serialization.</span></span></param>
        <summary>
            <span data-ttu-id="6e2cf-106">Füllt ein SerializationInfo-Objekt mit den Daten, die zum Serialisieren des Zielobjekts erforderlich sind.</span><span class="sxs-lookup"><span data-stu-id="6e2cf-106">Populates a SerializationInfo with the data needed to serialize the target object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
