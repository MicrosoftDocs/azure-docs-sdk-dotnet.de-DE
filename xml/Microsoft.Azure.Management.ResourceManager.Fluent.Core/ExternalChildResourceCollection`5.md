<Type Name="ExternalChildResourceCollection&lt;FluentModelTImpl,IFluentModelT,InnerModelT,IParentT,ParentImplT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ExternalChildResourceCollection&lt;FluentModelTImpl,IFluentModelT,InnerModelT,IParentT,ParentImplT&gt;">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="parent"><span data-ttu-id="ef0f9-101">das übergeordnete Element Azure-Ressource</span><span class="sxs-lookup"><span data-stu-id="ef0f9-101">the parent Azure resource</span></span></param>
        <param name="childResourceName"><span data-ttu-id="ef0f9-102">der Name der untergeordneten Ressourcen</span><span class="sxs-lookup"><span data-stu-id="ef0f9-102">the child resource name</span></span></param>
        <summary>
            <span data-ttu-id="ef0f9-103">Erstellt eine neue ExternalChildResourceCollection an.</span><span class="sxs-lookup"><span data-stu-id="ef0f9-103">Creates a new ExternalChildResourceCollection.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="childResourceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef0f9-104">Zum Erstellen von Fehlerzeichenfolge verwendet, ist dies Benutzerfreundlicher Name der untergeordneten Ressource (z. B. "Subnet", "Erweiterung").</span><span class="sxs-lookup"><span data-stu-id="ef0f9-104">Used to construct error string, this is user friendly name of the child resource (e.g. Subnet, Extension).</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="collection">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef0f9-105">Die untergeordnete Ressource-Instanzen, die diese Auflistung enthält.</span><span class="sxs-lookup"><span data-stu-id="ef0f9-105">The child resource instances that this collection contains.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Find">
      ...
      <Docs>
        ...
        <summary>
             <span data-ttu-id="ef0f9-106">Sucht eine untergeordnete Ressource mit dem angegebenen Namen.</span><span class="sxs-lookup"><span data-stu-id="ef0f9-106">Finds a child resource with the given name.</span></span>
            </summary>
        <returns><span data-ttu-id="ef0f9-107">die untergeordnete Ressource Wenn in der Auflistung, die sonst null vorhanden</span><span class="sxs-lookup"><span data-stu-id="ef0f9-107">the child resource if exists in the collection else null</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parent">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value><span data-ttu-id="ef0f9-108">Die übergeordnete Ressource der dieser Auflistung von untergeordneten Ressourcen.</span><span class="sxs-lookup"><span data-stu-id="ef0f9-108">The parent resource of this collection of child resources.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
