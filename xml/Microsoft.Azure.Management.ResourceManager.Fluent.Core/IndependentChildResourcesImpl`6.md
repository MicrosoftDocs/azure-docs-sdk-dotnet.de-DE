<Type Name="IndependentChildResourcesImpl&lt;T,ImplT,InnerT,InnerCollectionT,ManagerT,ParentT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.IndependentChildResourcesImpl&lt;T,ImplT,InnerT,InnerCollectionT,ManagerT,ParentT&gt;">
  ...
  <Docs>
    ...
    <summary>
            <span data-ttu-id="a6fb0-101">GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnJlc291cmNlcy5mbHVlbnRjb3JlLmFybS5jb2xsZWN0aW9uLmltcGxlbWVudGF0aW9uLkluZGVwZW5kZW50Q2hpbGRSZXNvdXJjZXNJbXBs-Basisklasse für unabhängige untergeordnete Sammlung Ressourcenklasse.</span><span class="sxs-lookup"><span data-stu-id="a6fb0-101">GENTHASH:Y29tLm1pY3Jvc29mdC5henVyZS5tYW5hZ2VtZW50LnJlc291cmNlcy5mbHVlbnRjb3JlLmFybS5jb2xsZWN0aW9uLmltcGxlbWVudGF0aW9uLkluZGVwZW5kZW50Q2hpbGRSZXNvdXJjZXNJbXBs Base class for independent child resource collection class.</span></span>
             <span data-ttu-id="a6fb0-102">(Nur interne Verwendung).</span><span class="sxs-lookup"><span data-stu-id="a6fb0-102">(Internal use only).</span></span>
             </summary>
