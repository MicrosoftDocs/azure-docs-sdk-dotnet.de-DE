<Type Name="IndependentChildImpl&lt;IFluentResourceT,FluentParentModelT,InnerResourceT,FluentResourceT,IResourceT,IUpdatableT,ManagerT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.IndependentChildImpl&lt;IFluentResourceT,FluentParentModelT,InnerResourceT,FluentResourceT,IResourceT,IUpdatableT,ManagerT&gt;">
  ...
  <Docs>
    ...
    <summary>
             <span data-ttu-id="5ad78-101">Die Implementierung für die untergeordnete Ressource, die CRUDed unabhängig von der übergeordneten Ressource sein kann.</span><span class="sxs-lookup"><span data-stu-id="5ad78-101">Implementation for the child resource which can be CRUDed independently from the parent resource.</span></span>
             <span data-ttu-id="5ad78-102">(nur interne Verwendung).</span><span class="sxs-lookup"><span data-stu-id="5ad78-102">(internal use only).</span></span>
             </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="5ad78-103">Der Name der Ressource.</span><span class="sxs-lookup"><span data-stu-id="5ad78-103">The name of the resource.</span></span></param>
        <param name="innerObject"><span data-ttu-id="5ad78-104">Das innere Objekt.</span><span class="sxs-lookup"><span data-stu-id="5ad78-104">The inner object.</span></span></param>
        <param name="manager">To be added.</param>
        <summary>
             <span data-ttu-id="5ad78-105">Erstellt eine neue Instanz der IndependentChildResourceImpl an.</span><span class="sxs-lookup"><span data-stu-id="5ad78-105">Creates a new instance of IndependentChildResourceImpl.</span></span>
             </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsInCreateMode">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>
          <span data-ttu-id="5ad78-106"><tt>"true"</tt> Wenn derzeit in definieren... Der Erstellungsmodus.</span><span class="sxs-lookup"><span data-stu-id="5ad78-106"><tt>true</tt> if currently in define..create mode.</span></span></return>
      </Docs>
    </Member>
