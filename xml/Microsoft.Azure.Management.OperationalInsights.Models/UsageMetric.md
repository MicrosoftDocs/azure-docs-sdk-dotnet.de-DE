<Type Name="UsageMetric" FullName="Microsoft.Azure.Management.OperationalInsights.Models.UsageMetric">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="831da-101">Eine Metrik, beschreibt die Verwendung einer Ressource.</span><span class="sxs-lookup"><span data-stu-id="831da-101">A metric describing the usage of a resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-102">Initialisiert eine neue Instanz der UsageMetric-Klasse.</span><span class="sxs-lookup"><span data-stu-id="831da-102">Initializes a new instance of the UsageMetric class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="831da-103">Der Name der Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-103">The name of the metric.</span></span></param>
        <param name="unit"><span data-ttu-id="831da-104">Die Einheiten für die Metrik verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="831da-104">The units used for the metric.</span></span></param>
        <param name="currentValue"><span data-ttu-id="831da-105">Der aktuelle Wert der Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-105">The current value of the metric.</span></span></param>
        <param name="limit"><span data-ttu-id="831da-106">Die Kontingentgrenze für die Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-106">The quota limit for the metric.</span></span></param>
        <param name="nextResetTime"><span data-ttu-id="831da-107">Die Zeit, die die Metrik Wert zurückgesetzt wird.</span><span class="sxs-lookup"><span data-stu-id="831da-107">The time that the metric's value will reset.</span></span></param>
        <param name="quotaPeriod"><span data-ttu-id="831da-108">Das Kontingentszeitraum, der die Zeitdauer zwischen dem Wert bestimmt wird zurückgesetzt.</span><span class="sxs-lookup"><span data-stu-id="831da-108">The quota period that determines the length of time between value resets.</span></span></param>
        <summary>
            <span data-ttu-id="831da-109">Initialisiert eine neue Instanz der UsageMetric-Klasse.</span><span class="sxs-lookup"><span data-stu-id="831da-109">Initializes a new instance of the UsageMetric class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CurrentValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-110">Ruft ab oder legt den aktuellen Wert der Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-110">Gets or sets the current value of the metric.</span></span>
            </summary>
    ...
    <Member MemberName="Limit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-111">Ruft ab oder legt die Kontingentgrenze für die Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-111">Gets or sets the quota limit for the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-112">Ruft ab oder legt den Namen der Metrik.</span><span class="sxs-lookup"><span data-stu-id="831da-112">Gets or sets the name of the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NextResetTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-113">Ruft ab oder legt die Zeit, die die Metrik Wert zurückgesetzt wird.</span><span class="sxs-lookup"><span data-stu-id="831da-113">Gets or sets the time that the metric's value will reset.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QuotaPeriod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-114">Abrufen oder festlegen den Kontingentszeitraum, der bestimmt, die Länge der Zeit zwischen den Wert zurückgesetzt.</span><span class="sxs-lookup"><span data-stu-id="831da-114">Gets or sets the quota period that determines the length of time between value resets.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="831da-115">Ruft ab oder legt die Einheiten für die Metrik verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="831da-115">Gets or sets the units used for the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
