<Type Name="TableControllerConfigAttribute" FullName="Microsoft.Azure.Mobile.Server.Tables.TableControllerConfigAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="42836-101">Führt die Anpassungen der Konfiguration für <see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" /> Controller abgeleitet.</span><span class="sxs-lookup"><span data-stu-id="42836-101">Performs configuration customizations for <see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" /> derived controllers.</span></span>
            </summary>
