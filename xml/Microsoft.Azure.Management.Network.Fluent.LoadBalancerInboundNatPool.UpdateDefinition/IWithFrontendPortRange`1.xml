<Type Name="IWithFrontendPortRange&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatPool.UpdateDefinition.IWithFrontendPortRange&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="6a0a5-101">Der übergeordnete Load Balancer-Typ.</span><span class="sxs-lookup"><span data-stu-id="6a0a5-101">The parent load balancer type.</span></span></typeparam>
    <summary>
            <span data-ttu-id="6a0a5-102">Die Stufe der eine eingehende NAT-Pool-Definition an den Front-End-Portbereich ermöglicht.</span><span class="sxs-lookup"><span data-stu-id="6a0a5-102">The stage of an inbound NAT pool definition allowing to specify the frontend port range.</span></span>
            </summary>
