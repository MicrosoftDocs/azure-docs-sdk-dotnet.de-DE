<Type Name="TrafficRoutingMethod" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficRoutingMethod">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8e916-101">Mögliche Verteilermethoden von Traffic Manager-Profil unterstützt.</span><span class="sxs-lookup"><span data-stu-id="8e916-101">Possible routing methods supported by Traffic manager profile.</span></span>
            </summary>
