<Type Name="ServicePlacementPolicyDescription" FullName="System.Fabric.Description.ServicePlacementPolicyDescription">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="72537-101">Stellt den Basistyp für alle Typen von PlacementPolicyDescription im Cluster dar.</span><span class="sxs-lookup"><span data-stu-id="72537-101">Represents the base type for all PlacementPolicyDescription types in the cluster.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="other">
          <para> <span data-ttu-id="72537-102">Die ServicePlacementPolicyDescription, die das neue Objekt aus erstellt werden soll.</span><span class="sxs-lookup"><span data-stu-id="72537-102">The ServicePlacementPolicyDescription that the new object should be constructed from.</span></span></para>
        </param>
        <summary>
          <para> 
            <span data-ttu-id="72537-103">Konstruktor für eine ServicePlacementPolicyDescription</span><span class="sxs-lookup"><span data-stu-id="72537-103">Constructor for a ServicePlacementPolicyDescription</span></span>
            </para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">
          <para><span data-ttu-id="72537-104">Der Richtlinientyp der Platzierung.</span><span class="sxs-lookup"><span data-stu-id="72537-104">The service placement policy type.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="72537-105">Initialisiert eine neue Instanz der <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="72537-105">Initializes a new instance of the <see cref="T:System.Fabric.Description.ServicePlacementPolicyDescription" /> class.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="72537-106">Ruft den Diensttyp der Platzierung Richtlinie ab.</span><span class="sxs-lookup"><span data-stu-id="72537-106">Gets the service placement policy type.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="72537-107">Der Richtlinientyp der Platzierung.</span><span class="sxs-lookup"><span data-stu-id="72537-107">The service placement policy type.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
