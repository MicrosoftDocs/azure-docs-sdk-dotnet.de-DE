<Type Name="NamedPartitionSchemeDescription" FullName="System.Fabric.Description.NamedPartitionSchemeDescription">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="9ae55-101">Beschreibt die benanntes Partitionsschema des Diensts an.</span><span class="sxs-lookup"><span data-stu-id="9ae55-101">Describes the named partition scheme of the service.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="9ae55-102">Instanziiert eine neue Instanz der <see cref="T:System.Fabric.Description.NamedPartitionSchemeDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9ae55-102">Instantiates a new instance of the <see cref="T:System.Fabric.Description.NamedPartitionSchemeDescription" /> class.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionNames">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="9ae55-103">Ruft die Liste der Namen, die jede Partition darstellen.</span><span class="sxs-lookup"><span data-stu-id="9ae55-103">Gets the list of names that represent each partition.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="9ae55-104">Die Liste der Namen, die jede Partition darstellen.</span><span class="sxs-lookup"><span data-stu-id="9ae55-104">The list of names that represent each partition.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
