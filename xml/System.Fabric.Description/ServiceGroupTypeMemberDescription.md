<Type Name="ServiceGroupTypeMemberDescription" FullName="System.Fabric.Description.ServiceGroupTypeMemberDescription">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="fae94-101">Stellt den Typ des Members Beschreibung für die Dienstgruppe dar.</span><span class="sxs-lookup"><span data-stu-id="fae94-101">Represents the type of member description for the service group.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="fae94-102">Initialisiert eine neue Instanz der dem <see cref="T:System.Fabric.Description.ServiceGroupTypeMemberDescription" /> Klasse.</span><span class="sxs-lookup"><span data-stu-id="fae94-102">initializes a new instance of the <see cref="T:System.Fabric.Description.ServiceGroupTypeMemberDescription" /> class.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LoadMetrics">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="fae94-103">Ruft ab oder legt die Auflistung der <see cref="T:System.Fabric.Description.ServiceLoadMetricDescription" /> für diesen Dienst.</span><span class="sxs-lookup"><span data-stu-id="fae94-103">Gets or sets the collection of <see cref="T:System.Fabric.Description.ServiceLoadMetricDescription" /> for this service.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="fae94-104">Die Auflistung der <see cref="T:System.Fabric.Description.ServiceLoadMetricDescription" /> für diesen Dienst.</span><span class="sxs-lookup"><span data-stu-id="fae94-104">The collection of <see cref="T:System.Fabric.Description.ServiceLoadMetricDescription" /> for this service.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceTypeName">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="fae94-105">Ruft den Namen des Diensttyps.</span><span class="sxs-lookup"><span data-stu-id="fae94-105">Gets the name of the service type.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="fae94-106">Den Namen des Diensttyps.</span><span class="sxs-lookup"><span data-stu-id="fae94-106">The name of the service type.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
