<Type Name="Operation" FullName="Microsoft.Azure.Management.Monitor.Management.Models.Operation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="01ae3-101">Definition der Microsoft Insights-API-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="01ae3-101">Microsoft Insights API operation definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01ae3-102">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="01ae3-102">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="01ae3-103">Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="01ae3-103">Operation name: {provider}/{resource}/{operation}</span></span></param>
        <param name="display"><span data-ttu-id="01ae3-104">Anzeigen von Metadaten, die dem Vorgang zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="01ae3-104">Display metadata associated with the operation.</span></span></param>
        <summary>
            <span data-ttu-id="01ae3-105">Initialisiert eine neue Instanz der Klasse Vorgang an.</span><span class="sxs-lookup"><span data-stu-id="01ae3-105">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01ae3-106">Ruft ab, oder legt ihn fest Metadaten anzeigen, die dem Vorgang zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="01ae3-106">Gets or sets display metadata associated with the operation.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01ae3-107">Ruft ab oder legt ihn fest Vorgangsname: {Anbieter} / {Resource} / {Operation}</span><span class="sxs-lookup"><span data-stu-id="01ae3-107">Gets or sets operation name: {provider}/{resource}/{operation}</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
