<Type Name="RuleDataSource" FullName="Microsoft.Azure.Management.Monitor.Management.Models.RuleDataSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="70e3e-101">Die Ressource, von der die Regel erfasst die zugehörigen Daten.</span><span class="sxs-lookup"><span data-stu-id="70e3e-101">The resource from which the rule collects its data.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="70e3e-102">Initialisiert eine neue Instanz der RuleDataSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="70e3e-102">Initializes a new instance of the RuleDataSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceUri"><span data-ttu-id="70e3e-103">Der Ressourcenbezeichner der Ressource die Regel überwacht.</span><span class="sxs-lookup"><span data-stu-id="70e3e-103">the resource identifier of the resource the rule monitors.</span></span> <span data-ttu-id="70e3e-104">**Hinweis**: Diese Eigenschaft kann nicht aktualisiert werden, für eine vorhandene Regel.</span><span class="sxs-lookup"><span data-stu-id="70e3e-104">**NOTE**: this property cannot be updated for an existing rule.</span></span></param>
        <summary>
            <span data-ttu-id="70e3e-105">Initialisiert eine neue Instanz der RuleDataSource-Klasse.</span><span class="sxs-lookup"><span data-stu-id="70e3e-105">Initializes a new instance of the RuleDataSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ResourceUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="70e3e-106">Ruft ab oder legt überwacht der Ressourcenbezeichner der Ressource die Regel.</span><span class="sxs-lookup"><span data-stu-id="70e3e-106">Gets or sets the resource identifier of the resource the rule monitors.</span></span> <span data-ttu-id="70e3e-107">**Hinweis**: Diese Eigenschaft kann nicht aktualisiert werden, für eine vorhandene Regel.</span><span class="sxs-lookup"><span data-stu-id="70e3e-107">**NOTE**: this property cannot be updated for an existing rule.</span></span>
            </summary>
