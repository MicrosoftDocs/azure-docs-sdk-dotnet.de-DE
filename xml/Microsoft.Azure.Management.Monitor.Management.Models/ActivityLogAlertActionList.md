<Type Name="ActivityLogAlertActionList" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ActivityLogAlertActionList">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a9954-101">Eine Liste der Warnungen aktivitätsaktionen für Protokoll.</span><span class="sxs-lookup"><span data-stu-id="a9954-101">A list of activity log alert actions.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9954-102">Initialisiert eine neue Instanz der ActivityLogAlertActionList-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a9954-102">Initializes a new instance of the ActivityLogAlertActionList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="actionGroups"><span data-ttu-id="a9954-103">Die Liste der Warnungen der Aktivität-Protokoll.</span><span class="sxs-lookup"><span data-stu-id="a9954-103">The list of activity log alerts.</span></span></param>
        <summary>
            <span data-ttu-id="a9954-104">Initialisiert eine neue Instanz der ActivityLogAlertActionList-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a9954-104">Initializes a new instance of the ActivityLogAlertActionList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActionGroups">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a9954-105">Ruft ab oder legt die Liste der Aktivität Protokoll Warnungen.</span><span class="sxs-lookup"><span data-stu-id="a9954-105">Gets or sets the list of activity log alerts.</span></span>
            </summary>
