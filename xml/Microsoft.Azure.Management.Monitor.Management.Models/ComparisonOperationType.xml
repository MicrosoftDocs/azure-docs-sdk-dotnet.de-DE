<Type Name="ComparisonOperationType" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ComparisonOperationType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f5f39-101">Definiert Werte für ComparisonOperationType an.</span><span class="sxs-lookup"><span data-stu-id="f5f39-101">Defines values for ComparisonOperationType.</span></span>
            </summary>
