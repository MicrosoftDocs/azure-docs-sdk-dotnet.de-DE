<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.HostNameBinding.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="6d705-101">Der Rückgabetyp des endgültigen Attachable.attach().</span><span class="sxs-lookup"><span data-stu-id="6d705-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="6d705-102">Die Gesamtheit der Definition eines Hostnamens-Bindung.</span><span class="sxs-lookup"><span data-stu-id="6d705-102">The entirety of a hostname binding definition.</span></span>
            </summary>
