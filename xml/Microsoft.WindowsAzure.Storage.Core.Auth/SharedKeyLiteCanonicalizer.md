<Type Name="SharedKeyLiteCanonicalizer" FullName="Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyLiteCanonicalizer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f1242-101">Stellt eine Canonicalizer, die HTTP-Anforderungsdaten in ein Standardformat für das Signieren über das Shared Key Lite-Authentifizierungsschema für den BLOB- oder Warteschlangendienst konvertiert.</span><span class="sxs-lookup"><span data-stu-id="f1242-101">Represents a canonicalizer that converts HTTP request data into a standard form appropriate for signing via the Shared Key Lite authentication scheme for the Blob or Queue service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AuthorizationScheme">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1242-102">Ruft die für die Kanonikalisierung verwendete Authentifizierungsschema ab.</span><span class="sxs-lookup"><span data-stu-id="f1242-102">Gets the authorization scheme used for canonicalization.</span></span>
            </summary>
        <value><span data-ttu-id="f1242-103">Für die Kanonikalisierung verwendete Autorisierungsschemas.</span><span class="sxs-lookup"><span data-stu-id="f1242-103">The authorization scheme used for canonicalization.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanonicalizeHttpRequest">
      ...
      <Docs>
        <param name="request"><span data-ttu-id="f1242-104">Die HTTP-Anforderung, die signiert werden muss.</span><span class="sxs-lookup"><span data-stu-id="f1242-104">The HTTP request that needs to be signed.</span></span></param>
        <param name="accountName"><span data-ttu-id="f1242-105">Der Name des Speicherkontos an, dem die HTTP-Anforderung zugreifen.</span><span class="sxs-lookup"><span data-stu-id="f1242-105">The name of the storage account that the HTTP request will access.</span></span></param>
        <summary>
            <span data-ttu-id="f1242-106">Konvertiert die angegebene HTTP-Anforderungsdaten in ein Standardformat zum Signieren von entsprechenden an.</span><span class="sxs-lookup"><span data-stu-id="f1242-106">Converts the specified HTTP request data into a standard form appropriate for signing.</span></span>
            </summary>
        <returns><span data-ttu-id="f1242-107">Die kanonikalisierte Zeichenfolge, die die HTTP-Anforderungsdaten in ein Standardformat zum Signieren von entsprechenden enthält.</span><span class="sxs-lookup"><span data-stu-id="f1242-107">The canonicalized string containing the HTTP request data in a standard form appropriate for signing.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Instance">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1242-108">Ruft eine statische Instanz die <see cref="T:Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyLiteCanonicalizer" /> Objekt.</span><span class="sxs-lookup"><span data-stu-id="f1242-108">Gets a static instance of the <see cref="T:Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyLiteCanonicalizer" /> object.</span></span>
            </summary>
        <value><span data-ttu-id="f1242-109">Die statische Instanz der Klasse.</span><span class="sxs-lookup"><span data-stu-id="f1242-109">The static instance of the class.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
