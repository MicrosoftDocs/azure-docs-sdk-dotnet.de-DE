<Type Name="RequestInterceptor" FullName="Microsoft.Azure.Batch.Protocol.RequestInterceptor">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="751cf-101">Diese Klasse ermöglicht einen Interceptor zu überprüfen, zu ändern oder zu ignorieren einer <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" />.</span><span class="sxs-lookup"><span data-stu-id="751cf-101">This class enables an interceptor to inspect, modify or ignore a <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="751cf-102">Initialisiert eine neue Instanz der RequestInterceptor an.</span><span class="sxs-lookup"><span data-stu-id="751cf-102">Initializes a new instance of RequestInterceptor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="interceptor"><span data-ttu-id="751cf-103">Ein Delegat, der zugelassen wird, um zu überprüfen, ändern oder eine BatchRequest ignorieren.</span><span class="sxs-lookup"><span data-stu-id="751cf-103">A delegate that will be allowed to inspect, modify or ignore a BatchRequest.</span></span></param>
        <summary>
            <span data-ttu-id="751cf-104">Initialisiert eine neue Instanz der RequestInterceptor, die einen bestimmten BatchRequestModificationInterceptHandler aufruft.</span><span class="sxs-lookup"><span data-stu-id="751cf-104">Initializes a new instance of RequestInterceptor that calls a given BatchRequestModificationInterceptHandler.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ModificationInterceptHandler">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="751cf-105">Ruft ab oder legt die BatchRequestModificationInterceptHandler.</span><span class="sxs-lookup"><span data-stu-id="751cf-105">Gets or sets the BatchRequestModificationInterceptHandler.</span></span>
            </summary>
