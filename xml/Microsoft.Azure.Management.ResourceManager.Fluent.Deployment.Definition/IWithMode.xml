<Type Name="IWithMode" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Deployment.Definition.IWithMode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b4d22-101">Die Bereitstellungsdefinition einer ermöglicht den Bereitstellungsmodus angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="b4d22-101">A deployment definition allowing the deployment mode to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithMode">
      ...
      <Docs>
        <param name="mode"><span data-ttu-id="b4d22-102">der Modus für die Bereitstellung</span><span class="sxs-lookup"><span data-stu-id="b4d22-102">mode the mode of the deployment</span></span></param>
        <summary>
            <span data-ttu-id="b4d22-103">Gibt den Bereitstellungsmodus.</span><span class="sxs-lookup"><span data-stu-id="b4d22-103">Specifies the deployment mode.</span></span>
            </summary>
        <returns><span data-ttu-id="b4d22-104">die nächste Phase der Bereitstellungsdefinition</span><span class="sxs-lookup"><span data-stu-id="b4d22-104">the next stage of the deployment definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
