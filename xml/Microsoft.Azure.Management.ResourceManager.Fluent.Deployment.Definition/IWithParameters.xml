<Type Name="IWithParameters" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Deployment.Definition.IWithParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1583d-101">Die Bereitstellungsdefinition einer können die Parameter angegeben werden.</span><span class="sxs-lookup"><span data-stu-id="1583d-101">A deployment definition allowing the parameters to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithParameters">
      ...
      <Docs>
        <param name="parameters"><span data-ttu-id="1583d-102">das Objekt</span><span class="sxs-lookup"><span data-stu-id="1583d-102">the object</span></span></param>
        <summary>
            <span data-ttu-id="1583d-103">Gibt die Parameter als ein Objekt an.</span><span class="sxs-lookup"><span data-stu-id="1583d-103">Specifies the parameters as an object.</span></span>
            </summary>
        <returns><span data-ttu-id="1583d-104">die nächste Phase der Bereitstellungsdefinition</span><span class="sxs-lookup"><span data-stu-id="1583d-104">the next stage of the deployment definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithParameters">
      ...
      <Docs>
        <param name="parametersJson"><span data-ttu-id="1583d-105">ParametersJson die JSON-Zeichenfolge</span><span class="sxs-lookup"><span data-stu-id="1583d-105">parametersJson the JSON string</span></span></param>
        <summary>
            <span data-ttu-id="1583d-106">Gibt die Parameter als JSON-Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="1583d-106">Specifies the parameters as a JSON string.</span></span>
            </summary>
        <returns><span data-ttu-id="1583d-107">die nächste Phase der Bereitstellungsdefinition</span><span class="sxs-lookup"><span data-stu-id="1583d-107">the next stage of the deployment definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithParametersLink">
      ...
      <Docs>
        <param name="uri"><span data-ttu-id="1583d-108">URI der Speicherort der Parameterdatei remote</span><span class="sxs-lookup"><span data-stu-id="1583d-108">uri the location of the remote parameters file</span></span></param>
        <param name="contentVersion"><span data-ttu-id="1583d-109">ContentVersion die Version der Parameterdatei an</span><span class="sxs-lookup"><span data-stu-id="1583d-109">contentVersion the version of the parameters file</span></span></param>
        <summary>
            <span data-ttu-id="1583d-110">Gibt die Parameter als URL verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="1583d-110">Specifies the parameters as a URL.</span></span>
            </summary>
        <returns><span data-ttu-id="1583d-111">die nächste Phase der Bereitstellungsdefinition</span><span class="sxs-lookup"><span data-stu-id="1583d-111">the next stage of the deployment definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
