<Type Name="IBlank&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Definition.IBlank&lt;ReturnT&gt;">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Definition.IBlank`1" />
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="dbc50-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="dbc50-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="dbc50-102">Die erste Phase der Lastenausgleich Regeldefinition.</span><span class="sxs-lookup"><span data-stu-id="dbc50-102">The first stage of the load balancing rule definition.</span></span>
            </summary>
