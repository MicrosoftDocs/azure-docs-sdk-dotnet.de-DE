<Type Name="SrvRecord" FullName="Microsoft.Azure.Management.Dns.Fluent.Models.SrvRecord">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a1cf4-101">Einen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-101">An SRV record.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1cf4-102">Initialisiert eine neue Instanz der SrvRecord-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-102">Initializes a new instance of the SrvRecord class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="priority"><span data-ttu-id="a1cf4-103">Die Priority-Wert für diesen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-103">The priority value for this SRV record.</span></span></param>
        <param name="weight"><span data-ttu-id="a1cf4-104">Der Wert für die Linienstärke für den SRV-Eintrag.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-104">The weight value for this SRV record.</span></span></param>
        <param name="port"><span data-ttu-id="a1cf4-105">Der Portwert für diesen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-105">The port value for this SRV record.</span></span></param>
        <param name="target"><span data-ttu-id="a1cf4-106">Der Name der Ziel-Domäne für diese SRV-Eintrag.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-106">The target domain name for this SRV record.</span></span></param>
        <summary>
            <span data-ttu-id="a1cf4-107">Initialisiert eine neue Instanz der SrvRecord-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-107">Initializes a new instance of the SrvRecord class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1cf4-108">Ruft ab oder legt den Wert für den Port für diesen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-108">Gets or sets the port value for this SRV record.</span></span>
            </summary>
    ...
    <Member MemberName="Priority">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1cf4-109">Ruft ab oder legt den Prioritätswert für diesen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-109">Gets or sets the priority value for this SRV record.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1cf4-110">Ruft ab oder legt den Ziel-Domänennamen für diesen SRV-Datensatz.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-110">Gets or sets the target domain name for this SRV record.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Weight">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1cf4-111">Ruft ab oder legt den Wert für die Linienstärke für den SRV-Eintrag.</span><span class="sxs-lookup"><span data-stu-id="a1cf4-111">Gets or sets the weight value for this SRV record.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
