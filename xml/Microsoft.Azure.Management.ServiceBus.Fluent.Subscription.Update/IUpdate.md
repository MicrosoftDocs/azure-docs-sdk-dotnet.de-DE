<Type Name="IUpdate" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8c006-101">Die Vorlage für ein Abonnement Update-Vorgang mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="8c006-101">The template for a subscription update operation, containing all the settings that can be modified.</span></span>
            </summary>
