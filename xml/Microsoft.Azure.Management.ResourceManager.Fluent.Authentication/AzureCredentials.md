<Type Name="AzureCredentials" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Authentication.AzureCredentials">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="064a0-101">Anmeldeinformationen zum Authentifizieren eines fluent Verwaltungsclient in Azure verwendet.</span><span class="sxs-lookup"><span data-stu-id="064a0-101">Credentials used for authenticating a fluent management client to Azure.</span></span>
            </summary>
