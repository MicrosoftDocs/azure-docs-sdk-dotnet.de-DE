<Type Name="IWithDiskSource" FullName="Microsoft.Azure.Management.Compute.Fluent.Disk.Definition.IWithDiskSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7ac4c-101">Die Phase der Definition eines verwalteten Datenträger, sodass OS-Quelle oder eine Datenquelle auswählen.</span><span class="sxs-lookup"><span data-stu-id="7ac4c-101">The stage of a managed disk definition allowing to choose OS source or data source.</span></span>
            </summary>
