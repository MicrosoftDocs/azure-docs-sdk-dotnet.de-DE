<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.Disk.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="08f78-101">Die Phase der Definition eines verwalteten Datenträger, die Ressourcengruppe angeben können.</span><span class="sxs-lookup"><span data-stu-id="08f78-101">The stage of a managed disk definition allowing to specify the resource group.</span></span>
            </summary>
