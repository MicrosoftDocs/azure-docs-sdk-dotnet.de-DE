<Type Name="EventTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.EventTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="04100-101">Telemetrie-Typ verwendet, um Ereignisse nachzuverfolgen.</span><span class="sxs-lookup"><span data-stu-id="04100-101">Telemetry type used to track events.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ApplicationInsights.DataContracts.EventTelemetry" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="04100-102">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.EventTelemetry" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="04100-103">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ApplicationInsights.DataContracts.EventTelemetry" /> -Klasse mit der angegebenen <paramref name="name" />.</span><span class="sxs-lookup"><span data-stu-id="04100-103">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.EventTelemetry" /> class with the given <paramref name="name" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentException"><span data-ttu-id="04100-104">Das Ereignis <paramref name="name" /> ist null oder eine leere Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="04100-104">The event <paramref name="name" /> is null or empty string.</span></span></exception>
      </Docs>
    </Member>
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-105">Ruft das aktuelle Element der Telemetrie zugeordneten Kontext.</span><span class="sxs-lookup"><span data-stu-id="04100-105">Gets the context associated with the current telemetry item.</span></span>
            </summary>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-106">Ruft ein Wörterbuch der Anwendung definiertes Ereignis Metriken ab.</span><span class="sxs-lookup"><span data-stu-id="04100-106">Gets a dictionary of application-defined event metrics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-107">Bereinigt die Eigenschaften, die auf Einschränkungen basieren.</span><span class="sxs-lookup"><span data-stu-id="04100-107">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Microsoft.ApplicationInsights.DataContracts.ISupportSampling.SamplingPercentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-108">Ruft ab, oder legt ihn fest Datenstichproben Prozentwert (zwischen 0 und 100).</span><span class="sxs-lookup"><span data-stu-id="04100-108">Gets or sets data sampling percentage (between 0 and 100).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-109">Ruft ab oder legt den Namen des Ereignisses.</span><span class="sxs-lookup"><span data-stu-id="04100-109">Gets or sets the name of the event.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-110">Ruft ein Wörterbuch von anwendungsdefinierten Eigenschaftennamen und Werte, die zusätzliche Informationen zu diesem Ereignis.</span><span class="sxs-lookup"><span data-stu-id="04100-110">Gets a dictionary of application-defined property names and values providing additional information about this event.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-111">Ruft ab oder legt den Wert an, der absolute Reihenfolge der Telemetrie-Elements definiert.</span><span class="sxs-lookup"><span data-stu-id="04100-111">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04100-112">Ruft ab oder legt Datum und Uhrzeit, wann das Ereignis aufgezeichnet wurde.</span><span class="sxs-lookup"><span data-stu-id="04100-112">Gets or sets date and time when event was recorded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
