<Type Name="DependencyTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6cd94-101">Die Klasse, die Informationen über die gesammelten Abhängigkeit darstellt.</span><span class="sxs-lookup"><span data-stu-id="6cd94-101">The class that represents information about the collected dependency.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="6cd94-102">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="6cd94-103">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> -Klasse mit der angegebenen <paramref name="dependencyName" />, <paramref name="target" />, <paramref name="dependencyName" />, <paramref name="data" /> Eigenschaftswerte.</span><span class="sxs-lookup"><span data-stu-id="6cd94-103">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> class with the given <paramref name="dependencyName" />, <paramref name="target" />, <paramref name="dependencyName" />, <paramref name="data" /> property values.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="6cd94-104">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> -Klasse mit der angegebenen <paramref name="dependencyName" />, <paramref name="data" />, <paramref name="startTime" />, <paramref name="duration" /> und <paramref name="success" /> Eigenschaftswerte.</span><span class="sxs-lookup"><span data-stu-id="6cd94-104">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> class with the given <paramref name="dependencyName" />, <paramref name="data" />, <paramref name="startTime" />, <paramref name="duration" /> and <paramref name="success" /> property values.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="success">To be added.</param>
        <summary>
            <span data-ttu-id="6cd94-105">Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> -Klasse mit der angegebenen <paramref name="dependencyName" />, <paramref name="target" />, <paramref name="dependencyName" />, <paramref name="data" />, <paramref name="startTime" />, <paramref name="duration" />, <paramref name="resultCode" /> und <paramref name="success" /> und Eigenschaftswerte.</span><span class="sxs-lookup"><span data-stu-id="6cd94-105">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.DependencyTelemetry" /> class with the given <paramref name="dependencyName" />, <paramref name="target" />, <paramref name="dependencyName" />, <paramref name="data" />, <paramref name="startTime" />, <paramref name="duration" />, <paramref name="resultCode" /> and <paramref name="success" /> and  property values.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CommandName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-106">Ruft ab oder legt Text der SQL-Befehl oder leeren nicht zutreffend.</span><span class="sxs-lookup"><span data-stu-id="6cd94-106">Gets or sets text of SQL command or empty it not applicable.</span></span>
            </summary>
    ...
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-107">Ruft das aktuelle Element der Telemetrie zugeordneten Kontext.</span><span class="sxs-lookup"><span data-stu-id="6cd94-107">Gets the context associated with the current telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Data">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-108">Abrufen oder Festlegen der aktuellen Instanz der Abhängigkeitseigenschaft zugeordnete Daten.</span><span class="sxs-lookup"><span data-stu-id="6cd94-108">Gets or sets data associated with the current dependency instance.</span></span> <span data-ttu-id="6cd94-109">Name-Anweisung-befehlsanweisung für SQL-Abhängigkeit, die URL für HTTP-Abhängigkeit.</span><span class="sxs-lookup"><span data-stu-id="6cd94-109">Command name/statement statement for SQL dependency, URL for http dependency.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DependencyKind">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-110">Ruft ab oder legt die Abhängigkeit Art, wie SQL "," HTTP "," Azure "," usw.</span><span class="sxs-lookup"><span data-stu-id="6cd94-110">Gets or sets the dependency kind, like SQL, HTTP, Azure, etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DependencyTypeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-111">Ruft ab oder legt den Typnamen der Abhängigkeit.</span><span class="sxs-lookup"><span data-stu-id="6cd94-111">Gets or sets the dependency type name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Duration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-112">Ruft ab oder legt fest, wie der Zeit die Anwendung zur Verarbeitung der Anforderung benötigt wurde.</span><span class="sxs-lookup"><span data-stu-id="6cd94-112">Gets or sets the amount of time it took the application to handle the request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>  
            <span data-ttu-id="6cd94-113">Ruft ab oder legt sie fest, Abhängigkeit-ID.</span><span class="sxs-lookup"><span data-stu-id="6cd94-113">Gets or sets Dependency ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-114">Ruft ein Wörterbuch der Anwendung definiertes Ereignis Metriken ab.</span><span class="sxs-lookup"><span data-stu-id="6cd94-114">Gets a dictionary of application-defined event metrics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-115">Bereinigt die Eigenschaften, die auf Einschränkungen basieren.</span><span class="sxs-lookup"><span data-stu-id="6cd94-115">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Microsoft.ApplicationInsights.DataContracts.ISupportSampling.SamplingPercentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-116">Ruft ab, oder legt ihn fest Datenstichproben Prozentwert (zwischen 0 und 100).</span><span class="sxs-lookup"><span data-stu-id="6cd94-116">Gets or sets data sampling percentage (between 0 and 100).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-117">Ruft ab, oder legt ihn fest Ressourcenname.</span><span class="sxs-lookup"><span data-stu-id="6cd94-117">Gets or sets resource name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-118">Ruft ein Wörterbuch von anwendungsdefinierten Eigenschaftennamen und Werte, die zusätzliche Informationen über diese remote Abhängigkeit.</span><span class="sxs-lookup"><span data-stu-id="6cd94-118">Gets a dictionary of application-defined property names and values providing additional information about this remote dependency.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResultCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-119">Abrufen oder Festlegen der Ergebniscode.</span><span class="sxs-lookup"><span data-stu-id="6cd94-119">Gets or sets the Result Code.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-120">Ruft ab oder legt den Wert an, der absolute Reihenfolge der Telemetrie-Elements definiert.</span><span class="sxs-lookup"><span data-stu-id="6cd94-120">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Success">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-121">Ruft ab oder legt einen Wert, der angibt, ob die Abhängigkeit Aufruf erfolgreich oder nicht war.</span><span class="sxs-lookup"><span data-stu-id="6cd94-121">Gets or sets a value indicating whether the dependency call was successful or not.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-122">Ruft ab, oder legt ihn fest Ziel Abhängigkeit-Aufrufs.</span><span class="sxs-lookup"><span data-stu-id="6cd94-122">Gets or sets target of dependency call.</span></span> <span data-ttu-id="6cd94-123">SQL Server-Name, Url-Host, usw.</span><span class="sxs-lookup"><span data-stu-id="6cd94-123">SQL server name, url host, etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-124">Ruft ab oder legt Datum und Uhrzeit, wann Telemetrie aufgezeichnet wurde.</span><span class="sxs-lookup"><span data-stu-id="6cd94-124">Gets or sets date and time when telemetry was recorded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cd94-125">Ruft ab oder legt den Typnamen der Abhängigkeit.</span><span class="sxs-lookup"><span data-stu-id="6cd94-125">Gets or sets the dependency type name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
