<Type Name="IHostNameSslBinding" FullName="Microsoft.Azure.Management.AppService.Fluent.IHostNameSslBinding">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3c641-101">Eine unveränderliche Darstellung einer Hostnamen SSL-Bindungen.</span><span class="sxs-lookup"><span data-stu-id="3c641-101">An immutable representation of an host name SSL binding.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="3c641-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="3c641-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="SslState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3c641-103">Ruft den SSL-Typ ab.</span><span class="sxs-lookup"><span data-stu-id="3c641-103">Gets the SSL type.</span></span>
            </summary>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3c641-104">Ruft den Fingerabdruck des SSL-Zertifikat ab.</span><span class="sxs-lookup"><span data-stu-id="3c641-104">Gets the SSL cert thumbprint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3c641-105">Ruft die virtuelle IP-Adresse, den Hostnamen zugewiesen, wenn die IP-basiertes SSL aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="3c641-105">Gets the virtual IP address assigned to the host name if IP based SSL is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
