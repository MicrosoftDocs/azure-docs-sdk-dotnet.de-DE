<Type Name="IDeploymentSlot" FullName="Microsoft.Azure.Management.AppService.Fluent.IDeploymentSlot">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3091c-101">Eine unveränderliche clientseitige Darstellung einer Azure-Web-App-bereitstellungsslots.</span><span class="sxs-lookup"><span data-stu-id="3091c-101">An immutable client-side representation of an Azure Web App deployment slot.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="3091c-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="3091c-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members />
</Type>