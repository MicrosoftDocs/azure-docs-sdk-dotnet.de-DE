<Type Name="IWebApp" FullName="Microsoft.Azure.Management.AppService.Fluent.IWebApp">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4ef1c-101">Eine unveränderliche clientseitige Darstellung einer Azure-Web-App.</span><span class="sxs-lookup"><span data-stu-id="4ef1c-101">An immutable client-side representation of an Azure Web App.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="4ef1c-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="4ef1c-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="DeploymentSlots">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ef1c-103">Ruft den Einstiegspunkt für die Bereitstellung Slot Verwaltungs-API unter der Web-app.</span><span class="sxs-lookup"><span data-stu-id="4ef1c-103">Gets the entry point to deployment slot management API under the web app.</span></span>
            </summary>
