<Type Name="PacketCaptureInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.PacketCaptureInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fdcec-101">Parameter, die das Paket erstellen definieren erfassen Vorgang.</span><span class="sxs-lookup"><span data-stu-id="fdcec-101">Parameters that define the create packet capture operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-102">Initialisiert eine neue Instanz der PacketCaptureInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="fdcec-102">Initializes a new instance of the PacketCaptureInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="target"><span data-ttu-id="fdcec-103">Die Zielressource nur VM-ID wird derzeit unterstützt.</span><span class="sxs-lookup"><span data-stu-id="fdcec-103">The ID of the targeted resource, only VM is currently supported.</span></span></param>
        <param name="storageLocation">To be added.</param>
        <param name="bytesToCapturePerPacket"><span data-ttu-id="fdcec-104">Anzahl von Bytes pro Paket erfasst, werden die restlichen Bytes abgeschnitten.</span><span class="sxs-lookup"><span data-stu-id="fdcec-104">Number of bytes captured per packet, the remaining bytes are truncated.</span></span></param>
        <param name="totalBytesPerSession"><span data-ttu-id="fdcec-105">Maximale Größe der Capture-Ausgabe.</span><span class="sxs-lookup"><span data-stu-id="fdcec-105">Maximum size of the capture output.</span></span></param>
        <param name="timeLimitInSeconds"><span data-ttu-id="fdcec-106">Maximale Dauer der aufzeichnungssitzung in Sekunden.</span><span class="sxs-lookup"><span data-stu-id="fdcec-106">Maximum duration of the capture session in seconds.</span></span></param>
        <param name="filters">To be added.</param>
        <summary>
            <span data-ttu-id="fdcec-107">Initialisiert eine neue Instanz der PacketCaptureInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="fdcec-107">Initializes a new instance of the PacketCaptureInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BytesToCapturePerPacket">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-108">Ruft ab oder legt die Anzahl von Bytes pro Paket, erfasst die restlichen Bytes abgeschnitten werden.</span><span class="sxs-lookup"><span data-stu-id="fdcec-108">Gets or sets number of bytes captured per packet, the remaining bytes are truncated.</span></span>
            </summary>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-109">Ruft ab oder legt fest, die die Zielressource nur VM-ID derzeit unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="fdcec-109">Gets or sets the ID of the targeted resource, only VM is currently supported.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeLimitInSeconds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-110">Ruft ab oder legt die maximale Dauer der aufzeichnungssitzung in Sekunden fest.</span><span class="sxs-lookup"><span data-stu-id="fdcec-110">Gets or sets maximum duration of the capture session in seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalBytesPerSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-111">Ruft ab oder legt die maximale Größe der Capture-Ausgabe.</span><span class="sxs-lookup"><span data-stu-id="fdcec-111">Gets or sets maximum size of the capture output.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcec-112">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="fdcec-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="fdcec-113">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="fdcec-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
