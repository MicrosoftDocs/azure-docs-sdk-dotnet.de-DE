<Type Name="EffectiveNetworkSecurityGroupListResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.EffectiveNetworkSecurityGroupListResultInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4ef78-101">Rufen Sie die Antwort für Liste effektive Sicherheit Gruppen-API-Netzwerkdienst.</span><span class="sxs-lookup"><span data-stu-id="4ef78-101">Response for list effective network security groups API service call.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ef78-102">Initialisiert eine neue Instanz der EffectiveNetworkSecurityGroupListResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4ef78-102">Initializes a new instance of the EffectiveNetworkSecurityGroupListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="4ef78-103">Eine Liste der effektiven netzwerksicherheitsgruppen.</span><span class="sxs-lookup"><span data-stu-id="4ef78-103">A list of effective network security groups.</span></span></param>
        <param name="nextLink"><span data-ttu-id="4ef78-104">Die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="4ef78-104">The URL to get the next set of results.</span></span></param>
        <summary>
            <span data-ttu-id="4ef78-105">Initialisiert eine neue Instanz der EffectiveNetworkSecurityGroupListResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4ef78-105">Initializes a new instance of the EffectiveNetworkSecurityGroupListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ef78-106">Ruft ab oder legt die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="4ef78-106">Gets or sets the URL to get the next set of results.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4ef78-107">Ruft ab oder legt eine Liste der effektiven netzwerksicherheitsgruppen fest.</span><span class="sxs-lookup"><span data-stu-id="4ef78-107">Gets or sets a list of effective network security groups.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
