<Type Name="NetworkSecurityGroupInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.NetworkSecurityGroupInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7645b-101">NetworkSecurityGroup-Ressource.</span><span class="sxs-lookup"><span data-stu-id="7645b-101">NetworkSecurityGroup resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-102">Initialisiert eine neue Instanz der NetworkSecurityGroupInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7645b-102">Initializes a new instance of the NetworkSecurityGroupInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="securityRules"><span data-ttu-id="7645b-103">Eine Auflistung von Sicherheitsregeln der Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="7645b-103">A collection of security rules of the network security group.</span></span></param>
        <param name="defaultSecurityRules"><span data-ttu-id="7645b-104">Die Standard-Sicherheitsregeln der Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="7645b-104">The default security rules of network security group.</span></span></param>
        <param name="networkInterfaces"><span data-ttu-id="7645b-105">Eine Auflistung von Verweisen auf Netzwerkschnittstellen.</span><span class="sxs-lookup"><span data-stu-id="7645b-105">A collection of references to network interfaces.</span></span></param>
        <param name="subnets"><span data-ttu-id="7645b-106">Eine Auflistung von Verweisen auf Subnetze.</span><span class="sxs-lookup"><span data-stu-id="7645b-106">A collection of references to subnets.</span></span></param>
        <param name="resourceGuid"><span data-ttu-id="7645b-107">Die Ressource GUID-Eigenschaft der netzwerksicherheitsgruppen-Ressource.</span><span class="sxs-lookup"><span data-stu-id="7645b-107">The resource GUID property of the network security group resource.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="7645b-108">Der Bereitstellungsstatus der öffentlichen IP-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="7645b-108">The provisioning state of the public IP resource.</span></span> <span data-ttu-id="7645b-109">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="7645b-109">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span></param>
        <param name="etag"><span data-ttu-id="7645b-110">Eine eindeutige schreibgeschützte Zeichenfolge, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="7645b-110">A unique read-only string that changes whenever the resource is updated.</span></span></param>
        <summary>
            <span data-ttu-id="7645b-111">Initialisiert eine neue Instanz der NetworkSecurityGroupInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7645b-111">Initializes a new instance of the NetworkSecurityGroupInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultSecurityRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-112">Ruft ab oder legt den Standardwert Sicherheitsregeln der Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="7645b-112">Gets or sets the default security rules of network security group.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-113">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="7645b-113">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkInterfaces">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-114">Ruft eine Auflistung von Verweisen auf Netzwerkschnittstellen.</span><span class="sxs-lookup"><span data-stu-id="7645b-114">Gets a collection of references to network interfaces.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-115">Ruft ab oder legt den Bereitstellungsstatus der öffentlichen IP-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="7645b-115">Gets or sets the provisioning state of the public IP resource.</span></span>
            <span data-ttu-id="7645b-116">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="7645b-116">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-117">Ruft ab oder legt die GUID-Eigenschaft, der die netzwerksicherheitsgruppen-Ressource "Ressource".</span><span class="sxs-lookup"><span data-stu-id="7645b-117">Gets or sets the resource GUID property of the network security group resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecurityRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-118">Ruft ab oder legt eine Auflistung von Sicherheitsregeln der Netzwerksicherheitsgruppe.</span><span class="sxs-lookup"><span data-stu-id="7645b-118">Gets or sets a collection of security rules of the network security group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7645b-119">Ruft eine Auflistung von Verweisen auf Subnetze.</span><span class="sxs-lookup"><span data-stu-id="7645b-119">Gets a collection of references to subnets.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
