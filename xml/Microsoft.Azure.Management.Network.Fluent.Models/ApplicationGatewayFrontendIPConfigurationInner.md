<Type Name="ApplicationGatewayFrontendIPConfigurationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayFrontendIPConfigurationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="891db-101">Frontend IP-Konfiguration eines Gateways für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="891db-101">Frontend IP configuration of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-102">Initialisiert eine neue Instanz der ApplicationGatewayFrontendIPConfigurationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="891db-102">Initializes a new instance of the ApplicationGatewayFrontendIPConfigurationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-103">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="891db-103">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-104">Ruft ab oder legt die Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="891db-104">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="891db-105">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="891db-105">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-106">Abrufen oder Festlegen der Netzwerkschnittstelle, die IP-Konfiguration der Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="891db-106">Gets or sets privateIPAddress of the network interface IP Configuration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-107">Ruft ab, oder legt ihn fest PrivateIP Zuordnungsmethode.</span><span class="sxs-lookup"><span data-stu-id="891db-107">Gets or sets privateIP allocation method.</span></span> <span data-ttu-id="891db-108">Mögliche Werte sind: "Static" und "Dynamic".</span><span class="sxs-lookup"><span data-stu-id="891db-108">Possible values are: 'Static' and 'Dynamic'.</span></span> <span data-ttu-id="891db-109">Folgende Werte sind möglich: "Static", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="891db-109">Possible values include: 'Static', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-110">Ruft ab, oder legt sie fest, der Bereitstellungsstatus der öffentlichen IP-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="891db-110">Gets or sets provisioning state of the public IP resource.</span></span> <span data-ttu-id="891db-111">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="891db-111">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-112">Ruft ab, oder legt ihn fest Verweis, der die öffentliche IP-Ressource.</span><span class="sxs-lookup"><span data-stu-id="891db-112">Gets or sets reference of the PublicIP resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="891db-113">Ruft ab, oder legt ihn fest Verweis der Ressource Subnetz.</span><span class="sxs-lookup"><span data-stu-id="891db-113">Gets or sets reference of the subnet resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
