<Type Name="FlowLogInformationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.FlowLogInformationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="76792-101">Informationen über die Konfiguration des Protokolls für Datenfluss.</span><span class="sxs-lookup"><span data-stu-id="76792-101">Information on the configuration of flow log.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="76792-102">Initialisiert eine neue Instanz der FlowLogInformationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="76792-102">Initializes a new instance of the FlowLogInformationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetResourceId"><span data-ttu-id="76792-103">Die ID der Ressource für die Datenfluss-Protokollierung zu konfigurieren.</span><span class="sxs-lookup"><span data-stu-id="76792-103">The ID of the resource to configure for flow logging.</span></span></param>
        <param name="storageId"><span data-ttu-id="76792-104">Die ID des Speicherkontos, das die zum Speichern der Datenfluss verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="76792-104">ID of the storage account which is used to store the flow log.</span></span></param>
        <param name="enabled"><span data-ttu-id="76792-105">Flag zum Aktivieren/Deaktivieren flow Protokollierung.</span><span class="sxs-lookup"><span data-stu-id="76792-105">Flag to enable/disable flow logging.</span></span></param>
        <param name="retentionPolicy">To be added.</param>
        <summary>
            <span data-ttu-id="76792-106">Initialisiert eine neue Instanz der FlowLogInformationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="76792-106">Initializes a new instance of the FlowLogInformationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="76792-107">Ruft ab, oder legt ihn fest-Flag aktiviert bzw. deaktiviert die Protokollierung der Datenfluss.</span><span class="sxs-lookup"><span data-stu-id="76792-107">Gets or sets flag to enable/disable flow logging.</span></span>
            </summary>
    ...
    <Member MemberName="StorageId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="76792-108">Ermittelt oder definiert die ID des Speicherkontos, das die zum Speichern der Datenfluss verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="76792-108">Gets or sets ID of the storage account which is used to store the flow log.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetResourceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="76792-109">Ruft ab oder legt die ID der Ressource für die Datenfluss-Protokollierung zu konfigurieren.</span><span class="sxs-lookup"><span data-stu-id="76792-109">Gets or sets the ID of the resource to configure for flow logging.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="76792-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="76792-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="76792-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="76792-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
