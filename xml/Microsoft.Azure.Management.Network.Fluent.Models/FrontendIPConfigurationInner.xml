<Type Name="FrontendIPConfigurationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.FrontendIPConfigurationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f6794-101">Frontend IP-Adresse des Lastenausgleichs.</span><span class="sxs-lookup"><span data-stu-id="f6794-101">Frontend IP address of the load balancer.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-102">Initialisiert eine neue Instanz der FrontendIPConfigurationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f6794-102">Initializes a new instance of the FrontendIPConfigurationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-103">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="f6794-103">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="InboundNatPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-104">Ruft nur gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="f6794-104">Gets read only.</span></span> <span data-ttu-id="f6794-105">Eingehende Pools URIs, die diese Front-End-IP-Adresse verwenden.</span><span class="sxs-lookup"><span data-stu-id="f6794-105">Inbound pools URIs that use this frontend IP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InboundNatRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-106">Ruft nur gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="f6794-106">Gets read only.</span></span> <span data-ttu-id="f6794-107">Eingehende Regeln URIs, die diese Front-End-IP-Adresse verwenden.</span><span class="sxs-lookup"><span data-stu-id="f6794-107">Inbound rules URIs that use this frontend IP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancingRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-108">Ruft den Regeln URIs Lastenausgleich, die diese Front-End-IP-Adresse verwenden.</span><span class="sxs-lookup"><span data-stu-id="f6794-108">Gets load balancing rules URIs that use this frontend IP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-109">Ruft ab oder legt den Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="f6794-109">Gets or sets the name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="f6794-110">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="f6794-110">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutboundNatRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-111">Ruft nur gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="f6794-111">Gets read only.</span></span> <span data-ttu-id="f6794-112">Ausgehende Regeln URIs, die diese Front-End-IP-Adresse verwenden.</span><span class="sxs-lookup"><span data-stu-id="f6794-112">Outbound rules URIs that use this frontend IP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-113">Ruft ab oder legt die private IP-Adresse die IP-Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="f6794-113">Gets or sets the private IP address of the IP configuration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-114">Ruft ab oder legt die privaten IP-Zuordnungsmethode.</span><span class="sxs-lookup"><span data-stu-id="f6794-114">Gets or sets the Private IP allocation method.</span></span> <span data-ttu-id="f6794-115">Mögliche Werte sind: "Static" und "Dynamic".</span><span class="sxs-lookup"><span data-stu-id="f6794-115">Possible values are: 'Static' and 'Dynamic'.</span></span> <span data-ttu-id="f6794-116">Folgende Werte sind möglich: "Static", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="f6794-116">Possible values include: 'Static', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-117">Ruft den Bereitstellungsstatus der öffentlichen IP-Ressource ab.</span><span class="sxs-lookup"><span data-stu-id="f6794-117">Gets the provisioning state of the public IP resource.</span></span> <span data-ttu-id="f6794-118">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="f6794-118">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-119">Ruft ab oder legt den Verweis der öffentlichen IP-Ressource.</span><span class="sxs-lookup"><span data-stu-id="f6794-119">Gets or sets the reference of the Public IP resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f6794-120">Ruft ab oder legt den Verweis der Ressource Subnetz.</span><span class="sxs-lookup"><span data-stu-id="f6794-120">Gets or sets the reference of the subnet resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
