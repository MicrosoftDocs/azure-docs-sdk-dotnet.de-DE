<Type Name="PacketCaptureResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.PacketCaptureResultInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e7266-101">Informationen zum Paket erfassungssitzung.</span><span class="sxs-lookup"><span data-stu-id="e7266-101">Information about packet capture session.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-102">Initialisiert eine neue Instanz der PacketCaptureResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e7266-102">Initializes a new instance of the PacketCaptureResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="target"><span data-ttu-id="e7266-103">Die Zielressource nur VM-ID wird derzeit unterstützt.</span><span class="sxs-lookup"><span data-stu-id="e7266-103">The ID of the targeted resource, only VM is currently supported.</span></span></param>
        <param name="storageLocation">To be added.</param>
        <param name="name"><span data-ttu-id="e7266-104">Der Name der aufzeichnungssitzung Paket.</span><span class="sxs-lookup"><span data-stu-id="e7266-104">Name of the packet capture session.</span></span></param>
        <param name="id"><span data-ttu-id="e7266-105">ID des Pakets Capture-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="e7266-105">ID of the packet capture operation.</span></span></param>
        <param name="etag">To be added.</param>
        <param name="bytesToCapturePerPacket"><span data-ttu-id="e7266-106">Anzahl von Bytes pro Paket erfasst, werden die restlichen Bytes abgeschnitten.</span><span class="sxs-lookup"><span data-stu-id="e7266-106">Number of bytes captured per packet, the remaining bytes are truncated.</span></span></param>
        <param name="totalBytesPerSession"><span data-ttu-id="e7266-107">Maximale Größe der Capture-Ausgabe.</span><span class="sxs-lookup"><span data-stu-id="e7266-107">Maximum size of the capture output.</span></span></param>
        <param name="timeLimitInSeconds"><span data-ttu-id="e7266-108">Maximale Dauer der aufzeichnungssitzung in Sekunden.</span><span class="sxs-lookup"><span data-stu-id="e7266-108">Maximum duration of the capture session in seconds.</span></span></param>
        <param name="filters">To be added.</param>
        <param name="provisioningState"><span data-ttu-id="e7266-109">Der Bereitstellungsstatus der aufzeichnungssitzung Paket.</span><span class="sxs-lookup"><span data-stu-id="e7266-109">The provisioning state of the packet capture session.</span></span> <span data-ttu-id="e7266-110">Folgende Werte sind möglich: "Erfolgreich abgeschlossen", "Aktualisieren", "Löschen", "fehlgeschlagen"</span><span class="sxs-lookup"><span data-stu-id="e7266-110">Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'</span></span></param>
        <summary>
            <span data-ttu-id="e7266-111">Initialisiert eine neue Instanz der PacketCaptureResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e7266-111">Initializes a new instance of the PacketCaptureResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BytesToCapturePerPacket">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-112">Ruft ab oder legt die Anzahl von Bytes pro Paket, erfasst die restlichen Bytes abgeschnitten werden.</span><span class="sxs-lookup"><span data-stu-id="e7266-112">Gets or sets number of bytes captured per packet, the remaining bytes are truncated.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-113">Ruft die ID des Pakets Capture-Vorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="e7266-113">Gets ID of the packet capture operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-114">Ruft die Namen der aufzeichnungssitzung Paket ab.</span><span class="sxs-lookup"><span data-stu-id="e7266-114">Gets name of the packet capture session.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-115">Ruft ab oder legt den Bereitstellungsstatus der aufzeichnungssitzung Paket.</span><span class="sxs-lookup"><span data-stu-id="e7266-115">Gets or sets the provisioning state of the packet capture session.</span></span>
            <span data-ttu-id="e7266-116">Folgende Werte sind möglich: "Erfolgreich abgeschlossen", "Aktualisieren", "Löschen", "fehlgeschlagen"</span><span class="sxs-lookup"><span data-stu-id="e7266-116">Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-117">Ruft ab oder legt fest, die die Zielressource nur VM-ID derzeit unterstützt wird.</span><span class="sxs-lookup"><span data-stu-id="e7266-117">Gets or sets the ID of the targeted resource, only VM is currently supported.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeLimitInSeconds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-118">Ruft ab oder legt die maximale Dauer der aufzeichnungssitzung in Sekunden fest.</span><span class="sxs-lookup"><span data-stu-id="e7266-118">Gets or sets maximum duration of the capture session in seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalBytesPerSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-119">Ruft ab oder legt die maximale Größe der Capture-Ausgabe.</span><span class="sxs-lookup"><span data-stu-id="e7266-119">Gets or sets maximum size of the capture output.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7266-120">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="e7266-120">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="e7266-121">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="e7266-121">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
