<Type Name="BgpServiceCommunityInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.BgpServiceCommunityInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="56b67-101">Community-Diensteigenschaften.</span><span class="sxs-lookup"><span data-stu-id="56b67-101">Service Community Properties.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="56b67-102">Initialisiert eine neue Instanz der BgpServiceCommunityInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="56b67-102">Initializes a new instance of the BgpServiceCommunityInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      <MemberSignature Language="C#" Value="public BgpServiceCommunityInner (string location = null, string id = null, string name = null, string type = null, System.Collections.Generic.IDictionary&lt;string,string&gt; tags = null, string serviceName = null, System.Collections.Generic.IList&lt;Microsoft.Azure.Management.Network.Fluent.Models.BGPCommunity&gt; bgpCommunities = null);" />
      ...
      <MemberSignature Language="VB.NET" Value="Public Sub New (Optional location As String = null, Optional id As String = null, Optional name As String = null, Optional type As String = null, Optional tags As IDictionary(Of String, String) = null, Optional serviceName As String = null, Optional bgpCommunities As IList(Of BGPCommunity) = null)" />
      ...
      <Docs>
        ...
        <param name="bgpCommunities">To be added.</param>
