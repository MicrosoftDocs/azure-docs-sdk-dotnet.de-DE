<Type Name="EffectiveRouteListResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.EffectiveRouteListResultInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d905-101">Rufen Sie die Antwort für Liste effektiven Route-API-Dienst.</span><span class="sxs-lookup"><span data-stu-id="0d905-101">Response for list effective route API service call.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d905-102">Initialisiert eine neue Instanz der EffectiveRouteListResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0d905-102">Initializes a new instance of the EffectiveRouteListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="0d905-103">Eine Liste der effektiven Routen.</span><span class="sxs-lookup"><span data-stu-id="0d905-103">A list of effective routes.</span></span></param>
        <param name="nextLink"><span data-ttu-id="0d905-104">Die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="0d905-104">The URL to get the next set of results.</span></span></param>
        <summary>
            <span data-ttu-id="0d905-105">Initialisiert eine neue Instanz der EffectiveRouteListResultInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0d905-105">Initializes a new instance of the EffectiveRouteListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d905-106">Ruft ab oder legt die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="0d905-106">Gets or sets the URL to get the next set of results.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d905-107">Ruft ab oder legt eine Liste der effektiven Routen.</span><span class="sxs-lookup"><span data-stu-id="0d905-107">Gets or sets a list of effective routes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
