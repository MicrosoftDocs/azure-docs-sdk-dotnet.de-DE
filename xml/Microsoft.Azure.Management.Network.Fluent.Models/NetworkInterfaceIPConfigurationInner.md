<Type Name="NetworkInterfaceIPConfigurationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.NetworkInterfaceIPConfigurationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4cb32-101">IP-Konfiguration in eine Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="4cb32-101">IPConfiguration in a network interface.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-102">Initialisiert eine neue Instanz der NetworkInterfaceIPConfigurationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4cb32-102">Initializes a new instance of the NetworkInterfaceIPConfigurationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ApplicationGatewayBackendAddressPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-103">Ruft ab oder legt den Verweis der ApplicationGatewayBackendAddressPool Ressource.</span><span class="sxs-lookup"><span data-stu-id="4cb32-103">Gets or sets the reference of ApplicationGatewayBackendAddressPool resource.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-104">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="4cb32-104">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancerBackendAddressPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-105">Ruft ab oder legt den Verweis der LoadBalancerBackendAddressPool Ressource.</span><span class="sxs-lookup"><span data-stu-id="4cb32-105">Gets or sets the reference of LoadBalancerBackendAddressPool resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancerInboundNatRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-106">Ruft ab oder legt eine Liste von Verweisen auf LoadBalancerInboundNatRules.</span><span class="sxs-lookup"><span data-stu-id="4cb32-106">Gets or sets a list of references of LoadBalancerInboundNatRules.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-107">Ruft ab oder legt den Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="4cb32-107">Gets or sets the name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="4cb32-108">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="4cb32-108">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Primary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-109">Ruft ab, ob dies eine primäre Kundenadresse auf der Netzwerkschnittstelle ist.</span><span class="sxs-lookup"><span data-stu-id="4cb32-109">Gets whether this is a primary customer address on the network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAddressVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-110">Ruft ab oder legt ihn fest-Api-Version 2016-03-30 verfügbar oder höher, stellt, ob die spezifische IP-Konfiguration IPv4 oder IPv6 ist dar.</span><span class="sxs-lookup"><span data-stu-id="4cb32-110">Gets or sets available from Api-Version 2016-03-30 onwards, it represents whether the specific ipconfiguration is IPv4 or IPv6.</span></span>
            <span data-ttu-id="4cb32-111">Standardmäßig wird als IPv4 verwendet.</span><span class="sxs-lookup"><span data-stu-id="4cb32-111">Default is taken as IPv4.</span></span>  <span data-ttu-id="4cb32-112">Mögliche Werte sind: "IPv4" und "IPv6".</span><span class="sxs-lookup"><span data-stu-id="4cb32-112">Possible values are: 'IPv4' and 'IPv6'.</span></span>
            <span data-ttu-id="4cb32-113">Folgende Werte sind möglich: "IPv4", "IPv6"</span><span class="sxs-lookup"><span data-stu-id="4cb32-113">Possible values include: 'IPv4', 'IPv6'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4cb32-114">Ruft ab oder legt ihn fest definiert, wie eine private IP-Adresse zugewiesen wird.</span><span class="sxs-lookup"><span data-stu-id="4cb32-114">Gets or sets defines how a private IP address is assigned.</span></span> <span data-ttu-id="4cb32-115">Mögliche Werte sind: "Static" und "Dynamic".</span><span class="sxs-lookup"><span data-stu-id="4cb32-115">Possible values are: 'Static' and 'Dynamic'.</span></span> <span data-ttu-id="4cb32-116">Folgende Werte sind möglich: "Static", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="4cb32-116">Possible values include: 'Static', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
