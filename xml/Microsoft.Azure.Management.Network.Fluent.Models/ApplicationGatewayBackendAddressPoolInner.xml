<Type Name="ApplicationGatewayBackendAddressPoolInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayBackendAddressPoolInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d6772-101">Back-End-Adresspool für ein vorhandenes Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="d6772-101">Backend Address Pool of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-102">Initialisiert eine neue Instanz der ApplicationGatewayBackendAddressPoolInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="d6772-102">Initializes a new instance of the ApplicationGatewayBackendAddressPoolInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BackendAddresses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-103">Ruft ab oder legt ihn fest-Back-End-Adressen</span><span class="sxs-lookup"><span data-stu-id="d6772-103">Gets or sets backend addresses</span></span>
            </summary>
    ...
    <Member MemberName="BackendIPConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-104">Abrufen oder Festlegen der Auflistung von Verweisen auf die IP-Adressen im Netzwerkschnittstellen definiert.</span><span class="sxs-lookup"><span data-stu-id="d6772-104">Gets or sets collection of references to IPs defined in network interfaces.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-105">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="d6772-105">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-106">Ruft ab, oder legt ihn fest-Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="d6772-106">Gets or sets resource that is unique within a resource group.</span></span> <span data-ttu-id="d6772-107">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="d6772-107">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d6772-108">Ruft ab, oder legt sie fest, der Bereitstellungsstatus des Back-End-Pool-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="d6772-108">Gets or sets provisioning state of the backend address pool resource.</span></span> <span data-ttu-id="d6772-109">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="d6772-109">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
