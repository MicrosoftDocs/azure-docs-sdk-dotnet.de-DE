<Type Name="PublicIPAddressInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.PublicIPAddressInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8a3a7-101">Öffentliche IP-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-101">Public IP address resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-102">Initialisiert eine neue Instanz der PublicIPAddressInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-102">Initializes a new instance of the PublicIPAddressInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DnsSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-103">Ruft ab oder legt den FQDN des DNS-Datensatzes der öffentlichen IP-Adresse zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-103">Gets or sets the FQDN of the DNS record associated with the public IP address.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-104">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-104">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IdleTimeoutInMinutes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-105">Ruft ab oder legt das Leerlauftimeout der öffentlichen IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-105">Gets or sets the idle timeout of the public IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-106">Abrufen oder festlegen den Bereitstellungsstatus der PublicIP-Ressource.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-106">Gets or sets the provisioning state of the PublicIP resource.</span></span>
            <span data-ttu-id="8a3a7-107">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="8a3a7-107">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddressVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-108">Ruft ab oder legt die Version der öffentliche IP-Adresse.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-108">Gets or sets the public IP address version.</span></span> <span data-ttu-id="8a3a7-109">Mögliche Werte sind: "IPv4" und "IPv6".</span><span class="sxs-lookup"><span data-stu-id="8a3a7-109">Possible values are: 'IPv4' and 'IPv6'.</span></span> <span data-ttu-id="8a3a7-110">Folgende Werte sind möglich: "IPv4", "IPv6"</span><span class="sxs-lookup"><span data-stu-id="8a3a7-110">Possible values include: 'IPv4', 'IPv6'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-111">Ruft ab oder legt die öffentliche IP-Zuordnungsmethode.</span><span class="sxs-lookup"><span data-stu-id="8a3a7-111">Gets or sets the public IP allocation method.</span></span> <span data-ttu-id="8a3a7-112">Mögliche Werte sind: "Static" und "Dynamic".</span><span class="sxs-lookup"><span data-stu-id="8a3a7-112">Possible values are: 'Static' and 'Dynamic'.</span></span> <span data-ttu-id="8a3a7-113">Folgende Werte sind möglich: "Static", "Dynamic"</span><span class="sxs-lookup"><span data-stu-id="8a3a7-113">Possible values include: 'Static', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8a3a7-114">Ruft ab oder legt die GUID-Eigenschaft, der die öffentliche IP-Adressressource "Ressource".</span><span class="sxs-lookup"><span data-stu-id="8a3a7-114">Gets or sets the resource GUID property of the public IP resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
