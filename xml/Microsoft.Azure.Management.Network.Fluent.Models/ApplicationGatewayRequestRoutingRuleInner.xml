<Type Name="ApplicationGatewayRequestRoutingRuleInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayRequestRoutingRuleInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="789e2-101">Fordern Sie Routingregel eines Gateways für die Anwendung an.</span><span class="sxs-lookup"><span data-stu-id="789e2-101">Request routing rule of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-102">Initialisiert eine neue Instanz der ApplicationGatewayRequestRoutingRuleInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="789e2-102">Initializes a new instance of the ApplicationGatewayRequestRoutingRuleInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BackendAddressPool">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-103">Ruft ab, oder legt ihn fest-Back-End-Pool Adressressource für das Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="789e2-103">Gets or sets backend address pool resource of the application gateway.</span></span>
            </summary>
    ...
    <Member MemberName="BackendHttpSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-104">Ruft ab, oder legt ihn fest Front-End-Port-Ressource für das Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="789e2-104">Gets or sets frontend port resource of the application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-105">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="789e2-105">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpListener">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-106">Abrufen oder Festlegen der HTTP-Listener-Ressource für das Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="789e2-106">Gets or sets http listener resource of the application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-107">Ruft ab oder legt die Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="789e2-107">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="789e2-108">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="789e2-108">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-109">Ruft ab, oder legt sie fest, der Bereitstellungsstatus der Anforderung routing Regel Ressource.</span><span class="sxs-lookup"><span data-stu-id="789e2-109">Gets or sets provisioning state of the request routing rule resource.</span></span> <span data-ttu-id="789e2-110">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="789e2-110">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RuleType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-111">Ruft ab oder legt ihn fest Regel.</span><span class="sxs-lookup"><span data-stu-id="789e2-111">Gets or sets rule type.</span></span> <span data-ttu-id="789e2-112">Mögliche Werte sind: "Basic" und "PathBasedRouting".</span><span class="sxs-lookup"><span data-stu-id="789e2-112">Possible values are: 'Basic' and 'PathBasedRouting'.</span></span> <span data-ttu-id="789e2-113">Folgende Werte sind möglich: "Basic", "PathBasedRouting"</span><span class="sxs-lookup"><span data-stu-id="789e2-113">Possible values include: 'Basic', 'PathBasedRouting'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UrlPathMap">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="789e2-114">Ruft ab oder legt die URL-Pfad-Map-Ressource für das Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="789e2-114">Gets or sets URL path map resource of the application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
