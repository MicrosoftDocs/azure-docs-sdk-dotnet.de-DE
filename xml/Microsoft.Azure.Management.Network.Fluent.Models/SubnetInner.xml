<Type Name="SubnetInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.SubnetInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e6aa-101">Subnetz in ein virtuelles Netzwerk-Ressource.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-101">Subnet in a virtual network resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-102">Initialisiert eine neue Instanz der SubnetInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-102">Initializes a new instance of the SubnetInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AddressPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-103">Ruft ab oder legt das Adresspräfix für das Subnetz.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-103">Gets or sets the address prefix for the subnet.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-104">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-104">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-105">Ruft ein Array von Verweisen auf die über netzwerkschnittstellenkonfigurationen IP-Subnetz verwenden.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-105">Gets an array of references to the network interface IP configurations using subnet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-106">Ruft ab oder legt den Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-106">Gets or sets the name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="7e6aa-107">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-107">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroup">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-108">Ruft ab oder legt den Verweis der NetworkSecurityGroup Ressource.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-108">Gets or sets the reference of the NetworkSecurityGroup resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-109">Ruft ab oder legt den Bereitstellungsstatus der Ressource.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-109">Gets or sets the provisioning state of the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceNavigationLinks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-110">Ruft ein Array von Verweisen auf die externen Ressourcen, die mithilfe der Subnetz ab.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-110">Gets an array of references to the external resources using subnet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTable">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7e6aa-111">Ruft ab oder legt den Verweis der RouteTable Ressource.</span><span class="sxs-lookup"><span data-stu-id="7e6aa-111">Gets or sets the reference of the RouteTable resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
