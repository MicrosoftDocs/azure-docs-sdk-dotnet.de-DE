<Type Name="ApplicationGatewayIPConfigurationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayIPConfigurationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="635eb-101">IP-Konfiguration eines Gateways für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="635eb-101">IP configuration of an application gateway.</span></span> <span data-ttu-id="635eb-102">Derzeit ist 1 öffentliche und 1 private IP-Konfiguration zulässig.</span><span class="sxs-lookup"><span data-stu-id="635eb-102">Currently 1 public and 1 private IP configuration is allowed.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="635eb-103">Initialisiert eine neue Instanz der ApplicationGatewayIPConfigurationInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="635eb-103">Initializes a new instance of the ApplicationGatewayIPConfigurationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="635eb-104">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="635eb-104">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="635eb-105">Ruft ab oder legt die Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="635eb-105">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="635eb-106">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="635eb-106">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="635eb-107">Ruft ab, oder legt sie fest, der Bereitstellungsstatus der Anwendung Gateway-Subnetz-Ressource.</span><span class="sxs-lookup"><span data-stu-id="635eb-107">Gets or sets provisioning state of the application gateway subnet resource.</span></span> <span data-ttu-id="635eb-108">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="635eb-108">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="635eb-109">Ruft ab, oder legt ihn fest Verweis der Ressource Subnetz.</span><span class="sxs-lookup"><span data-stu-id="635eb-109">Gets or sets reference of the subnet resource.</span></span> <span data-ttu-id="635eb-110">Ein Subnetz aus, in denen Anwendungsgateway seine private Adresse erhält.</span><span class="sxs-lookup"><span data-stu-id="635eb-110">A subnet from where application gateway gets its private address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
