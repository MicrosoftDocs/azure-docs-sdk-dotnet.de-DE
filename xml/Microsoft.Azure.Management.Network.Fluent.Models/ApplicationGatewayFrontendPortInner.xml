<Type Name="ApplicationGatewayFrontendPortInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayFrontendPortInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2cb3b-101">Front-End-Port, der ein vorhandenes Anwendungsgateway.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-101">Frontend port of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2cb3b-102">Initialisiert eine neue Instanz der ApplicationGatewayFrontendPortInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-102">Initializes a new instance of the ApplicationGatewayFrontendPortInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2cb3b-103">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-103">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2cb3b-104">Ruft ab oder legt die Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-104">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="2cb3b-105">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-105">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2cb3b-106">Ruft ab oder legt ihn fest Front-End-port</span><span class="sxs-lookup"><span data-stu-id="2cb3b-106">Gets or sets frontend port</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2cb3b-107">Ruft ab, oder legt sie fest, der Bereitstellungsstatus der Front-End-Port-Ressource.</span><span class="sxs-lookup"><span data-stu-id="2cb3b-107">Gets or sets provisioning state of the frontend port resource.</span></span>
            <span data-ttu-id="2cb3b-108">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="2cb3b-108">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
