<Type Name="IWithBackendPort" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IWithBackendPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e7702-101">Die Phase eines eingehenden NAT-Regel-Updates an den Back-End-Port zulassen.</span><span class="sxs-lookup"><span data-stu-id="e7702-101">The stage of an inbound NAT rule update allowing to specify the backend port.</span></span>
            </summary>
