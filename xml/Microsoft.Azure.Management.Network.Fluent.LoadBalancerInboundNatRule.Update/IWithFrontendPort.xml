<Type Name="IWithFrontendPort" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IWithFrontendPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="961d2-101">Die Phase eines eingehenden NAT-Regel-Updates an den Front-End-Port zulassen.</span><span class="sxs-lookup"><span data-stu-id="961d2-101">The stage of an inbound NAT rule update allowing to specify the frontend port.</span></span>
            </summary>
