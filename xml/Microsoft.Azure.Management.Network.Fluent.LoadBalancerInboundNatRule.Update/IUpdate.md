<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e3cfd-101">Vollständig eine NAT-Regel, die im Rahmen eines Load Balancer-Updates aktualisiert werden.</span><span class="sxs-lookup"><span data-stu-id="e3cfd-101">The entirety of an inbound NAT rule update as part of a load balancer update.</span></span>
            </summary>
