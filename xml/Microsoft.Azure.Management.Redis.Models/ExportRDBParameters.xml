<Type Name="ExportRDBParameters" FullName="Microsoft.Azure.Management.Redis.Models.ExportRDBParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="edacd-101">Parameter für Redis-Exportvorgang.</span><span class="sxs-lookup"><span data-stu-id="edacd-101">Parameters for Redis export operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="edacd-102">Initialisiert eine neue Instanz der ExportRDBParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="edacd-102">Initializes a new instance of the ExportRDBParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="prefix"><span data-ttu-id="edacd-103">Präfix für exportierte Dateien verwenden.</span><span class="sxs-lookup"><span data-stu-id="edacd-103">Prefix to use for exported files.</span></span></param>
        <param name="container"><span data-ttu-id="edacd-104">Der Containername zu exportieren.</span><span class="sxs-lookup"><span data-stu-id="edacd-104">Container name to export to.</span></span></param>
        <param name="format"><span data-ttu-id="edacd-105">Dateiformat.</span><span class="sxs-lookup"><span data-stu-id="edacd-105">File format.</span></span></param>
        <summary>
            <span data-ttu-id="edacd-106">Initialisiert eine neue Instanz der ExportRDBParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="edacd-106">Initializes a new instance of the ExportRDBParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Container">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="edacd-107">Ruft ab, oder legt ihn fest Containernamen zu exportieren.</span><span class="sxs-lookup"><span data-stu-id="edacd-107">Gets or sets container name to export to.</span></span>
            </summary>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="edacd-108">Ruft ab, oder legt ihn fest-Dateiformat.</span><span class="sxs-lookup"><span data-stu-id="edacd-108">Gets or sets file format.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Prefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="edacd-109">Ruft ab, oder legt ihn fest Präfixes, das für die exportierten Dateien verwendet.</span><span class="sxs-lookup"><span data-stu-id="edacd-109">Gets or sets prefix to use for exported files.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="edacd-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="edacd-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="edacd-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="edacd-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
