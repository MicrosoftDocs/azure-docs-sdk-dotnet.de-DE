<Type Name="KeyVaultReference" FullName="Microsoft.Azure.Management.Batch.Models.KeyVaultReference">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8d884-101">Identifiziert die Azure-schlüsseltresor ein Batch-Konto zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8d884-101">Identifies the Azure key vault associated with a Batch account.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8d884-102">Initialisiert eine neue Instanz der KeyVaultReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8d884-102">Initializes a new instance of the KeyVaultReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="8d884-103">Die Ressourcen-ID des Azure Key Vault, die das Batch-Konto zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="8d884-103">The resource ID of the Azure key vault associated with the Batch account.</span></span></param>
        <param name="url"><span data-ttu-id="8d884-104">Die URL des Azure Key Vault. der Batch-Konto zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8d884-104">The URL of the Azure key vault associated with the Batch account.</span></span></param>
        <summary>
            <span data-ttu-id="8d884-105">Initialisiert eine neue Instanz der KeyVaultReference-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8d884-105">Initializes a new instance of the KeyVaultReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8d884-106">Ruft ab oder legt die Ressourcen-ID des Azure Key Vault. der Batch-Konto zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8d884-106">Gets or sets the resource ID of the Azure key vault associated with the Batch account.</span></span>
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8d884-107">Ruft ab oder legt die URL des Azure Key Vault. der Batch-Konto zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="8d884-107">Gets or sets the URL of the Azure key vault associated with the Batch account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8d884-108">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="8d884-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="8d884-109">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="8d884-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
