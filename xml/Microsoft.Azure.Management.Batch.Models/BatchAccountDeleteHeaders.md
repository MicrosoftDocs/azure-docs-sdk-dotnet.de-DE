<Type Name="BatchAccountDeleteHeaders" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccountDeleteHeaders">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="11d02-101">Definiert die Header für den Löschvorgang.</span><span class="sxs-lookup"><span data-stu-id="11d02-101">Defines headers for Delete operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11d02-102">Initialisiert eine neue Instanz der BatchAccountDeleteHeaders-Klasse.</span><span class="sxs-lookup"><span data-stu-id="11d02-102">Initializes a new instance of the BatchAccountDeleteHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="11d02-103">Die URL der Ressource verwendet, um den Status des asynchronen Vorgangs zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="11d02-103">The URL of the resource used to check the status of the asynchronous operation.</span></span></param>
        <param name="retryAfter"><span data-ttu-id="11d02-104">Vorgeschlagene Verzögerung zum Überprüfen des Status des asynchronen Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="11d02-104">Suggested delay to check the status of the asynchronous operation.</span></span> <span data-ttu-id="11d02-105">Der Wert ist eine ganze Zahl, die die Verzögerung in Sekunden angibt.</span><span class="sxs-lookup"><span data-stu-id="11d02-105">The value is an integer that specifies the delay in seconds.</span></span></param>
        <summary>
            <span data-ttu-id="11d02-106">Initialisiert eine neue Instanz der BatchAccountDeleteHeaders-Klasse.</span><span class="sxs-lookup"><span data-stu-id="11d02-106">Initializes a new instance of the BatchAccountDeleteHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11d02-107">Ruft ab oder legt die URL der Ressource verwendet, um den Status des asynchronen Vorgangs zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="11d02-107">Gets or sets the URL of the resource used to check the status of the asynchronous operation.</span></span>
            </summary>
    ...
    <Member MemberName="RetryAfter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="11d02-108">Ruft ab, oder legt ihn fest vorgeschlagenen Verzögerung zum Überprüfen des Status des asynchronen Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="11d02-108">Gets or sets suggested delay to check the status of the asynchronous operation.</span></span> <span data-ttu-id="11d02-109">Der Wert ist eine ganze Zahl, die die Verzögerung in Sekunden angibt.</span><span class="sxs-lookup"><span data-stu-id="11d02-109">The value is an integer that specifies the delay in seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
