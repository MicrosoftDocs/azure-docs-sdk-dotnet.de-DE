<Type Name="AutoUserScope" FullName="Microsoft.Azure.Management.Batch.Models.AutoUserScope">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="efaa5-101">Definiert Werte für AutoUserScope an.</span><span class="sxs-lookup"><span data-stu-id="efaa5-101">Defines values for AutoUserScope.</span></span>
            </summary>
