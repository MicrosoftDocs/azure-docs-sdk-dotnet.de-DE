<Type Name="ElasticPoolDatabaseActivityInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ElasticPoolDatabaseActivityInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="78475-101">Stellt die Aktivität in einem elastischen Pool für Azure SQL dar.</span><span class="sxs-lookup"><span data-stu-id="78475-101">Represents the activity on an Azure SQL Elastic Pool.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-102">Initialisiert eine neue Instanz der ElasticPoolDatabaseActivityInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="78475-102">Initializes a new instance of the ElasticPoolDatabaseActivityInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseName"><span data-ttu-id="78475-103">Der Datenbankname.</span><span class="sxs-lookup"><span data-stu-id="78475-103">The database name.</span></span></param>
        <param name="endTime"><span data-ttu-id="78475-104">Die Zeit, die der Vorgang abgeschlossen, (ISO8601-Format).</span><span class="sxs-lookup"><span data-stu-id="78475-104">The time the operation finished (ISO8601 format).</span></span></param>
        <param name="errorCode"><span data-ttu-id="78475-105">Der Fehlercode, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-105">The error code if available.</span></span></param>
        <param name="errorMessage"><span data-ttu-id="78475-106">Die Fehlermeldung, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-106">The error message if available.</span></span></param>
        <param name="errorSeverity"><span data-ttu-id="78475-107">Schweregrad des Fehlers falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-107">The error severity if available.</span></span></param>
        <param name="operation"><span data-ttu-id="78475-108">Der Name des Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="78475-108">The operation name.</span></span></param>
        <param name="operationId"><span data-ttu-id="78475-109">Die eindeutige Vorgangs-ID.</span><span class="sxs-lookup"><span data-stu-id="78475-109">The unique operation ID.</span></span></param>
        <param name="percentComplete"><span data-ttu-id="78475-110">Der Prozentsatz abgeschlossen, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-110">The percentage complete if available.</span></span></param>
        <param name="requestedElasticPoolName"><span data-ttu-id="78475-111">Der Name für den elastischen Pool, der die Datenbank in verschoben wird, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-111">The name for the Elastic Pool the database is moving into if available.</span></span></param>
        <param name="currentElasticPoolName"><span data-ttu-id="78475-112">Der Name des aktuellen elastischen Pools, der die Datenbank befindet sich im If verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-112">The name of the current Elastic Pool the database is in if available.</span></span></param>
        <param name="currentServiceObjective"><span data-ttu-id="78475-113">Der Name des aktuellen dienstziels, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-113">The name of the current service objective if available.</span></span></param>
        <param name="requestedServiceObjective"><span data-ttu-id="78475-114">Der Name des angeforderten dienstziels, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-114">The name of the requested service objective if available.</span></span></param>
        <param name="serverName"><span data-ttu-id="78475-115">Der Name des Azure SQL-Servers den elastischen Pool wird.</span><span class="sxs-lookup"><span data-stu-id="78475-115">The name of the Azure SQL server the Elastic Pool is in.</span></span></param>
        <param name="startTime"><span data-ttu-id="78475-116">Beim Start des Vorgangs (ISO8601-Format).</span><span class="sxs-lookup"><span data-stu-id="78475-116">The time the operation started (ISO8601 format).</span></span></param>
        <param name="state"><span data-ttu-id="78475-117">Der aktuelle Status des Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="78475-117">The current state of the operation.</span></span></param>
        <summary>
            <span data-ttu-id="78475-118">Initialisiert eine neue Instanz der ElasticPoolDatabaseActivityInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="78475-118">Initializes a new instance of the ElasticPoolDatabaseActivityInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CurrentElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-119">Ruft den Namen des aktuellen elastischen Pools, der die Datenbank befindet sich im If verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-119">Gets the name of the current Elastic Pool the database is in if available.</span></span>
            </summary>
    ...
    <Member MemberName="CurrentServiceObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-120">Ruft den Namen des aktuellen dienstziels ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-120">Gets the name of the current service objective if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-121">Ruft den Datenbanknamen ab.</span><span class="sxs-lookup"><span data-stu-id="78475-121">Gets the database name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-122">Ruft den Zeitpunkt der Vorgang abgeschlossen, (ISO8601-Format).</span><span class="sxs-lookup"><span data-stu-id="78475-122">Gets the time the operation finished (ISO8601 format).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-123">Ruft den Fehlercode ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-123">Gets the error code if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-124">Ruft die Fehlermeldung ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-124">Gets the error message if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorSeverity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-125">Ruft den Schweregrad des Fehlers ab, sofern verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-125">Gets the error severity if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-126">Ruft den Vorgangsnamen.</span><span class="sxs-lookup"><span data-stu-id="78475-126">Gets the operation name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-127">Ruft die eindeutige Vorgangs-ID ab.</span><span class="sxs-lookup"><span data-stu-id="78475-127">Gets the unique operation ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PercentComplete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-128">Ruft den Prozentsatz abgeschlossen, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-128">Gets the percentage complete if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-129">Ruft den Namen für den elastischen Pool, der die Datenbank gegebenenfalls auf verschoben werden.</span><span class="sxs-lookup"><span data-stu-id="78475-129">Gets the name for the Elastic Pool the database is moving into if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedServiceObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-130">Ruft den Namen des Ziels angeforderten Dienst ab, falls verfügbar.</span><span class="sxs-lookup"><span data-stu-id="78475-130">Gets the name of the requested service objective if available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-131">Ruft den Namen des Azure SQL-Servers ein, die in der elastische Pool ist.</span><span class="sxs-lookup"><span data-stu-id="78475-131">Gets the name of the Azure SQL server the Elastic Pool is in.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-132">Ruft den Zeitpunkt der Vorgang (ISO8601-Format) gestartet wurde.</span><span class="sxs-lookup"><span data-stu-id="78475-132">Gets the time the operation started (ISO8601 format).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78475-133">Ruft den aktuellen Status des Vorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="78475-133">Gets the current state of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
