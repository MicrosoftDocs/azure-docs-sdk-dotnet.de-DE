<Type Name="IkeIntegrity" FullName="Microsoft.Azure.Management.Network.Models.IkeIntegrity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cd933-101">Definiert Werte für IkeIntegrity an.</span><span class="sxs-lookup"><span data-stu-id="cd933-101">Defines values for IkeIntegrity.</span></span>
            </summary>
