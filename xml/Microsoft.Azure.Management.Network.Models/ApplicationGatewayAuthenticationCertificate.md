<Type Name="ApplicationGatewayAuthenticationCertificate" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayAuthenticationCertificate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e3bff-101">Authentifizierungszertifikate eines Gateways für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="e3bff-101">Authentication certificates of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-102">Initialisiert eine neue Instanz der ApplicationGatewayAuthenticationCertificate-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e3bff-102">Initializes a new instance of the ApplicationGatewayAuthenticationCertificate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="e3bff-103">Ressourcen-ID</span><span class="sxs-lookup"><span data-stu-id="e3bff-103">Resource ID.</span></span></param>
        <param name="data"><span data-ttu-id="e3bff-104">Öffentliche Zertifikatdaten.</span><span class="sxs-lookup"><span data-stu-id="e3bff-104">Certificate public data.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="e3bff-105">Der Bereitstellungsstatus der Authentifizierung zertifikatsressource.</span><span class="sxs-lookup"><span data-stu-id="e3bff-105">Provisioning state of the authentication certificate resource.</span></span> <span data-ttu-id="e3bff-106">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="e3bff-106">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span></param>
        <param name="name"><span data-ttu-id="e3bff-107">Der Name der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="e3bff-107">Name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="e3bff-108">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="e3bff-108">This name can be used to access the resource.</span></span></param>
        <param name="etag"><span data-ttu-id="e3bff-109">Eine eindeutige schreibgeschützte Zeichenfolge, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="e3bff-109">A unique read-only string that changes whenever the resource is updated.</span></span></param>
        <param name="type"><span data-ttu-id="e3bff-110">Der Typ der Ressource.</span><span class="sxs-lookup"><span data-stu-id="e3bff-110">Type of the resource.</span></span></param>
        <summary>
            <span data-ttu-id="e3bff-111">Initialisiert eine neue Instanz der ApplicationGatewayAuthenticationCertificate-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e3bff-111">Initializes a new instance of the ApplicationGatewayAuthenticationCertificate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Data">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-112">Ruft ab, oder legt ihn fest öffentliche Zertifikatdaten.</span><span class="sxs-lookup"><span data-stu-id="e3bff-112">Gets or sets certificate public data.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-113">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="e3bff-113">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-114">Ruft ab oder legt die Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="e3bff-114">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="e3bff-115">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="e3bff-115">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-116">Ruft ab, oder legt sie fest, der Bereitstellungsstatus der Authentifizierung zertifikatsressource.</span><span class="sxs-lookup"><span data-stu-id="e3bff-116">Gets or sets provisioning state of the authentication certificate resource.</span></span> <span data-ttu-id="e3bff-117">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="e3bff-117">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e3bff-118">Ruft ab oder legt den Ressourcentyp aus.</span><span class="sxs-lookup"><span data-stu-id="e3bff-118">Gets or sets type of the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
