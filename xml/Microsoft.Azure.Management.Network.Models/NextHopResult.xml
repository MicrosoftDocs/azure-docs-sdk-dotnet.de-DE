<Type Name="NextHopResult" FullName="Microsoft.Azure.Management.Network.Models.NextHopResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="52982-101">Die Informationen zum nächsten Hop von den angegebenen virtuellen Computer.</span><span class="sxs-lookup"><span data-stu-id="52982-101">The information about next hop from the specified VM.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52982-102">Initialisiert eine neue Instanz der NextHopResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="52982-102">Initializes a new instance of the NextHopResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nextHopType"><span data-ttu-id="52982-103">Typ des nächsten Hops.</span><span class="sxs-lookup"><span data-stu-id="52982-103">Next hop type.</span></span> <span data-ttu-id="52982-104">Folgende Werte sind möglich: "Internet", "virtualappliance" "", "VirtualNetworkGateway", "VnetLocal", "HyperNetGateway", "None"</span><span class="sxs-lookup"><span data-stu-id="52982-104">Possible values include: 'Internet', 'VirtualAppliance', 'VirtualNetworkGateway', 'VnetLocal', 'HyperNetGateway', 'None'</span></span></param>
        <param name="nextHopIpAddress"><span data-ttu-id="52982-105">IP-Adresse des nächsten Abschnitts</span><span class="sxs-lookup"><span data-stu-id="52982-105">Next hop IP Address</span></span></param>
        <param name="routeTableId"><span data-ttu-id="52982-106">Der Ressourcenbezeichner für die Routentabelle verknüpft sind, mit der Route, die zurückgegeben wird.</span><span class="sxs-lookup"><span data-stu-id="52982-106">The resource identifier for the route table associated with the route being returned.</span></span> <span data-ttu-id="52982-107">Wenn die Route, die zurückgegeben wird nicht für jeden Benutzer, Routen erstellt wird, wird dieses Feld die Zeichenfolge 'System Route' sein.</span><span class="sxs-lookup"><span data-stu-id="52982-107">If the route being returned does not correspond to any user created routes then this field will be the string 'System Route'.</span></span></param>
        <summary>
            <span data-ttu-id="52982-108">Initialisiert eine neue Instanz der NextHopResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="52982-108">Initializes a new instance of the NextHopResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextHopIpAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52982-109">Ruft ab oder legt die nächsten Hop IP-Adresse</span><span class="sxs-lookup"><span data-stu-id="52982-109">Gets or sets next hop IP Address</span></span>
            </summary>
    ...
    <Member MemberName="NextHopType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52982-110">Ruft ab oder legt der Typ des nächsten Hops.</span><span class="sxs-lookup"><span data-stu-id="52982-110">Gets or sets next hop type.</span></span> <span data-ttu-id="52982-111">Folgende Werte sind möglich: "Internet", "virtualappliance" "", "VirtualNetworkGateway", "VnetLocal", "HyperNetGateway", "None"</span><span class="sxs-lookup"><span data-stu-id="52982-111">Possible values include: 'Internet', 'VirtualAppliance', 'VirtualNetworkGateway', 'VnetLocal', 'HyperNetGateway', 'None'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTableId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52982-112">Abrufen oder festlegen den Ressourcenbezeichner für die Routentabelle verknüpft sind, mit der Route, die zurückgegeben wird.</span><span class="sxs-lookup"><span data-stu-id="52982-112">Gets or sets the resource identifier for the route table associated with the route being returned.</span></span> <span data-ttu-id="52982-113">Wenn die Route, die zurückgegeben wird nicht für jeden Benutzer, Routen erstellt wird, wird dieses Feld die Zeichenfolge 'System Route' sein.</span><span class="sxs-lookup"><span data-stu-id="52982-113">If the route being returned does not correspond to any user created routes then this field will be the string 'System Route'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
