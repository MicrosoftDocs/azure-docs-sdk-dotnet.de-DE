<Type Name="Topology" FullName="Microsoft.Azure.Management.Network.Models.Topology">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d125e-101">Topologie der angegebenen Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="d125e-101">Topology of the specified resource group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d125e-102">Initialisiert eine neue Instanz der Klasse Topologie an.</span><span class="sxs-lookup"><span data-stu-id="d125e-102">Initializes a new instance of the Topology class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="d125e-103">GUID, die die Vorgangs-Id darstellt.</span><span class="sxs-lookup"><span data-stu-id="d125e-103">GUID representing the operation id.</span></span></param>
        <param name="createdDateTime"><span data-ttu-id="d125e-104">Die "DateTime", wenn die Topologie für die Ressourcengruppe erstmalig erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="d125e-104">The datetime when the topology was initially created for the resource group.</span></span></param>
        <param name="lastModified"><span data-ttu-id="d125e-105">Das Datum und die Uhrzeit der letzten Änderung der Topologie.</span><span class="sxs-lookup"><span data-stu-id="d125e-105">The datetime when the topology was last modified.</span></span></param>
        <param name="resources">To be added.</param>
        <summary>
            <span data-ttu-id="d125e-106">Initialisiert eine neue Instanz der Klasse Topologie an.</span><span class="sxs-lookup"><span data-stu-id="d125e-106">Initializes a new instance of the Topology class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreatedDateTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d125e-107">Ruft den DateTime-Wert ab, wenn die Topologie für die Ressourcengruppe erstmalig erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="d125e-107">Gets the datetime when the topology was initially created for the resource group.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d125e-108">Ruft die GUID, die die Vorgangs-Id darstellt.</span><span class="sxs-lookup"><span data-stu-id="d125e-108">Gets GUID representing the operation id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d125e-109">Ruft den DateTime-Wert ab, die Topologie zuletzt geändert wurde.</span><span class="sxs-lookup"><span data-stu-id="d125e-109">Gets the datetime when the topology was last modified.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
