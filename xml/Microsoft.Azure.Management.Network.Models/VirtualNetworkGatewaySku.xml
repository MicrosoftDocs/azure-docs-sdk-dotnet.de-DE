<Type Name="VirtualNetworkGatewaySku" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkGatewaySku">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9bffe-101">VirtualNetworkGatewaySku-details</span><span class="sxs-lookup"><span data-stu-id="9bffe-101">VirtualNetworkGatewaySku details</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9bffe-102">Initialisiert eine neue Instanz der VirtualNetworkGatewaySku-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9bffe-102">Initializes a new instance of the VirtualNetworkGatewaySku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="9bffe-103">Gateway-SKU-Name.</span><span class="sxs-lookup"><span data-stu-id="9bffe-103">Gateway SKU name.</span></span> <span data-ttu-id="9bffe-104">Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</span><span class="sxs-lookup"><span data-stu-id="9bffe-104">Possible values include: 'Basic', 'HighPerformance', 'Standard', 'UltraPerformance', 'VpnGw1', 'VpnGw2', 'VpnGw3'</span></span></param>
        <param name="tier"><span data-ttu-id="9bffe-105">Gateway-SKU-Tarif.</span><span class="sxs-lookup"><span data-stu-id="9bffe-105">Gateway SKU tier.</span></span> <span data-ttu-id="9bffe-106">Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</span><span class="sxs-lookup"><span data-stu-id="9bffe-106">Possible values include: 'Basic', 'HighPerformance', 'Standard', 'UltraPerformance', 'VpnGw1', 'VpnGw2', 'VpnGw3'</span></span></param>
        <param name="capacity"><span data-ttu-id="9bffe-107">Die Kapazität.</span><span class="sxs-lookup"><span data-stu-id="9bffe-107">The capacity.</span></span></param>
        <summary>
            <span data-ttu-id="9bffe-108">Initialisiert eine neue Instanz der VirtualNetworkGatewaySku-Klasse.</span><span class="sxs-lookup"><span data-stu-id="9bffe-108">Initializes a new instance of the VirtualNetworkGatewaySku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9bffe-109">Ruft ab oder legt die Kapazität fest.</span><span class="sxs-lookup"><span data-stu-id="9bffe-109">Gets or sets the capacity.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9bffe-110">Ruft ab, oder legt ihn fest Gateway-SKU-Name.</span><span class="sxs-lookup"><span data-stu-id="9bffe-110">Gets or sets gateway SKU name.</span></span> <span data-ttu-id="9bffe-111">Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</span><span class="sxs-lookup"><span data-stu-id="9bffe-111">Possible values include: 'Basic', 'HighPerformance', 'Standard', 'UltraPerformance', 'VpnGw1', 'VpnGw2', 'VpnGw3'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9bffe-112">Ruft ab, oder legt ihn fest Gateway-SKU-Tarif.</span><span class="sxs-lookup"><span data-stu-id="9bffe-112">Gets or sets gateway SKU tier.</span></span> <span data-ttu-id="9bffe-113">Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</span><span class="sxs-lookup"><span data-stu-id="9bffe-113">Possible values include: 'Basic', 'HighPerformance', 'Standard', 'UltraPerformance', 'VpnGw1', 'VpnGw2', 'VpnGw3'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
