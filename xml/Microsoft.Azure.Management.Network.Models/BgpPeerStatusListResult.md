<Type Name="BgpPeerStatusListResult" FullName="Microsoft.Azure.Management.Network.Models.BgpPeerStatusListResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="adeb9-101">Rufen Sie die Antwort für Liste BGP-Peer-Status-API-Dienst</span><span class="sxs-lookup"><span data-stu-id="adeb9-101">Response for list BGP peer status API service call</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="adeb9-102">Initialisiert eine neue Instanz der BgpPeerStatusListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="adeb9-102">Initializes a new instance of the BgpPeerStatusListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="adeb9-103">Liste der BGP-peers</span><span class="sxs-lookup"><span data-stu-id="adeb9-103">List of BGP peers</span></span></param>
        <summary>
            <span data-ttu-id="adeb9-104">Initialisiert eine neue Instanz der BgpPeerStatusListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="adeb9-104">Initializes a new instance of the BgpPeerStatusListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="adeb9-105">Ruft ab oder legt die Liste der BGP-peers</span><span class="sxs-lookup"><span data-stu-id="adeb9-105">Gets or sets list of BGP peers</span></span>
            </summary>
