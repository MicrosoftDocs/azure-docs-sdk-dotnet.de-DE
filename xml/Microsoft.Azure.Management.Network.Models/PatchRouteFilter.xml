<Type Name="PatchRouteFilter" FullName="Microsoft.Azure.Management.Network.Models.PatchRouteFilter">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="193a0-101">Route-Filter-Ressource.</span><span class="sxs-lookup"><span data-stu-id="193a0-101">Route Filter Resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-102">Initialisiert eine neue Instanz der PatchRouteFilter-Klasse.</span><span class="sxs-lookup"><span data-stu-id="193a0-102">Initializes a new instance of the PatchRouteFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="193a0-103">Ressourcen-ID</span><span class="sxs-lookup"><span data-stu-id="193a0-103">Resource ID.</span></span></param>
        <param name="rules"><span data-ttu-id="193a0-104">Die Auflistung von RouteFilterRules innerhalb eines Filters Route enthalten sind.</span><span class="sxs-lookup"><span data-stu-id="193a0-104">Collection of RouteFilterRules contained within a route filter.</span></span></param>
        <param name="peerings"><span data-ttu-id="193a0-105">Eine Auflistung von Verweisen auf express Route Circuit kann.</span><span class="sxs-lookup"><span data-stu-id="193a0-105">A collection of references to express route circuit peerings.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="193a0-106">Der Bereitstellungsstatus der Ressource.</span><span class="sxs-lookup"><span data-stu-id="193a0-106">The provisioning state of the resource.</span></span> <span data-ttu-id="193a0-107">Mögliche Werte sind: "Aktualisieren", "Löschen", "Succeeded" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="193a0-107">Possible values are: 'Updating', 'Deleting', 'Succeeded' and 'Failed'.</span></span></param>
        <param name="name"><span data-ttu-id="193a0-108">Der Name der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="193a0-108">The name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="193a0-109">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="193a0-109">This name can be used to access the resource.</span></span></param>
        <param name="etag"><span data-ttu-id="193a0-110">Eine eindeutige schreibgeschützte Zeichenfolge, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="193a0-110">A unique read-only string that changes whenever the resource is updated.</span></span></param>
        <param name="type"><span data-ttu-id="193a0-111">Der Ressourcentyp.</span><span class="sxs-lookup"><span data-stu-id="193a0-111">Resource type.</span></span></param>
        <param name="tags"><span data-ttu-id="193a0-112">Ressourcentags.</span><span class="sxs-lookup"><span data-stu-id="193a0-112">Resource tags.</span></span></param>
        <summary>
            <span data-ttu-id="193a0-113">Initialisiert eine neue Instanz der PatchRouteFilter-Klasse.</span><span class="sxs-lookup"><span data-stu-id="193a0-113">Initializes a new instance of the PatchRouteFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-114">Ruft eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="193a0-114">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-115">Ruft den Namen der Ressource, die innerhalb einer Ressourcengruppe eindeutig ist.</span><span class="sxs-lookup"><span data-stu-id="193a0-115">Gets the name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="193a0-116">Dieser Name kann verwendet werden, auf die Ressource zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="193a0-116">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Peerings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-117">Ruft ab oder legt eine Auflistung von Verweisen auf express Route Circuit kann.</span><span class="sxs-lookup"><span data-stu-id="193a0-117">Gets or sets a collection of references to express route circuit peerings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-118">Ruft den Bereitstellungsstatus der Ressource ab.</span><span class="sxs-lookup"><span data-stu-id="193a0-118">Gets the provisioning state of the resource.</span></span> <span data-ttu-id="193a0-119">Mögliche Werte sind: "Aktualisieren", "Löschen", "Succeeded" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="193a0-119">Possible values are: 'Updating', 'Deleting', 'Succeeded' and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Rules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-120">Abrufen oder Festlegen der Auflistung von RouteFilterRules innerhalb eines Filters Route enthalten sind.</span><span class="sxs-lookup"><span data-stu-id="193a0-120">Gets or sets collection of RouteFilterRules contained within a route filter.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-121">Ermittelt oder Ressourcen-Tags definiert.</span><span class="sxs-lookup"><span data-stu-id="193a0-121">Gets or sets resource tags.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="193a0-122">Ruft den Ressourcentyp ab.</span><span class="sxs-lookup"><span data-stu-id="193a0-122">Gets resource type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
