<Type Name="RouteTable" FullName="Microsoft.Azure.Management.Network.Models.RouteTable">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f3223-101">Route-Tabellenressource.</span><span class="sxs-lookup"><span data-stu-id="f3223-101">Route table resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-102">Initialisiert eine neue Instanz der RouteTable-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f3223-102">Initializes a new instance of the RouteTable class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="f3223-103">Ressourcen-ID</span><span class="sxs-lookup"><span data-stu-id="f3223-103">Resource ID.</span></span></param>
        <param name="name"><span data-ttu-id="f3223-104">Name der Ressource.</span><span class="sxs-lookup"><span data-stu-id="f3223-104">Resource name.</span></span></param>
        <param name="type"><span data-ttu-id="f3223-105">Der Ressourcentyp.</span><span class="sxs-lookup"><span data-stu-id="f3223-105">Resource type.</span></span></param>
        <param name="location"><span data-ttu-id="f3223-106">Der Ressourcenspeicherort.</span><span class="sxs-lookup"><span data-stu-id="f3223-106">Resource location.</span></span></param>
        <param name="tags"><span data-ttu-id="f3223-107">Ressourcentags.</span><span class="sxs-lookup"><span data-stu-id="f3223-107">Resource tags.</span></span></param>
        <param name="routes"><span data-ttu-id="f3223-108">Die Auflistung der Routen, die innerhalb einer Routingtabelle enthalten.</span><span class="sxs-lookup"><span data-stu-id="f3223-108">Collection of routes contained within a route table.</span></span></param>
        <param name="subnets"><span data-ttu-id="f3223-109">Eine Auflistung von Verweisen auf Subnetze.</span><span class="sxs-lookup"><span data-stu-id="f3223-109">A collection of references to subnets.</span></span></param>
        <param name="disableBgpRoutePropagation"><span data-ttu-id="f3223-110">Ruft ab oder legt fest, ob die Routen, die von BGP für diese Routentabelle zu deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="f3223-110">Gets or sets whether to disable the routes learned by BGP on that route table.</span></span> <span data-ttu-id="f3223-111">"True" bedeutet deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="f3223-111">True means disable.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="f3223-112">Der Bereitstellungsstatus der Ressource.</span><span class="sxs-lookup"><span data-stu-id="f3223-112">The provisioning state of the resource.</span></span> <span data-ttu-id="f3223-113">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="f3223-113">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span></param>
        <param name="etag"><span data-ttu-id="f3223-114">Ruft eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="f3223-114">Gets a unique read-only string that changes whenever the resource is updated.</span></span></param>
        <summary>
            <span data-ttu-id="f3223-115">Initialisiert eine neue Instanz der RouteTable-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f3223-115">Initializes a new instance of the RouteTable class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DisableBgpRoutePropagation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-116">Ruft ab oder legt fest, ob die Routen, die von BGP für diese Routentabelle zu deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="f3223-116">Gets or sets whether to disable the routes learned by BGP on that route table.</span></span> <span data-ttu-id="f3223-117">"True" bedeutet deaktivieren.</span><span class="sxs-lookup"><span data-stu-id="f3223-117">True means disable.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-118">Ruft eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="f3223-118">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-119">Ruft ab oder legt den Bereitstellungsstatus der Ressource.</span><span class="sxs-lookup"><span data-stu-id="f3223-119">Gets or sets the provisioning state of the resource.</span></span> <span data-ttu-id="f3223-120">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="f3223-120">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Routes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-121">Ruft ab oder legt die Auflistung von Routen innerhalb einer Routingtabelle enthaltenen.</span><span class="sxs-lookup"><span data-stu-id="f3223-121">Gets or sets collection of routes contained within a route table.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3223-122">Ruft eine Auflistung von Verweisen auf Subnetze.</span><span class="sxs-lookup"><span data-stu-id="f3223-122">Gets a collection of references to subnets.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
