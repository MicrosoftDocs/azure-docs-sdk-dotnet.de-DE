<Type Name="AvailableProvidersList" FullName="Microsoft.Azure.Management.Network.Models.AvailableProvidersList">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0c0ad-101">Liste der verfügbaren Länder mit Details.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-101">List of available countries with details.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c0ad-102">Initialisiert eine neue Instanz der AvailableProvidersList-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-102">Initializes a new instance of the AvailableProvidersList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="countries"><span data-ttu-id="0c0ad-103">Liste von Ländern verfügbar.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-103">List of available countries.</span></span></param>
        <summary>
            <span data-ttu-id="0c0ad-104">Initialisiert eine neue Instanz der AvailableProvidersList-Klasse.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-104">Initializes a new instance of the AvailableProvidersList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Countries">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c0ad-105">Ruft ab oder legt die Liste der verfügbaren Länder.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-105">Gets or sets list of available countries.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0c0ad-106">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="0c0ad-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="0c0ad-107">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="0c0ad-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
