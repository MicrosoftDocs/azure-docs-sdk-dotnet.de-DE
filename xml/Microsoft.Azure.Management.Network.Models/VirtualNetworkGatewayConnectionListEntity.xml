<Type Name="VirtualNetworkGatewayConnectionListEntity" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkGatewayConnectionListEntity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f1094-101">Eine allgemeine Klasse für allgemeine Ressourceninformationen</span><span class="sxs-lookup"><span data-stu-id="f1094-101">A common class for general resource information</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-102">Initialisiert eine neue Instanz der VirtualNetworkGatewayConnectionListEntity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f1094-102">Initializes a new instance of the VirtualNetworkGatewayConnectionListEntity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="virtualNetworkGateway1"><span data-ttu-id="f1094-103">der Verweis auf die gatewayressource des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="f1094-103">The reference to virtual network gateway resource.</span></span></param>
        <param name="connectionType"><span data-ttu-id="f1094-104">Gateway-Verbindungstyp.</span><span class="sxs-lookup"><span data-stu-id="f1094-104">Gateway connection type.</span></span> <span data-ttu-id="f1094-105">Mögliche Werte sind: "Ipsec", "Vnet2Vnet", "ExpressRoute" und "VPNClient.</span><span class="sxs-lookup"><span data-stu-id="f1094-105">Possible values are: 'Ipsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.</span></span>
            <span data-ttu-id="f1094-106">Folgende Werte sind möglich: "IPsec", "Vnet2Vnet", "ExpressRoute", "VPNClient"</span><span class="sxs-lookup"><span data-stu-id="f1094-106">Possible values include: 'IPsec', 'Vnet2Vnet', 'ExpressRoute', 'VPNClient'</span></span></param>
        <param name="id"><span data-ttu-id="f1094-107">Ressourcen-ID</span><span class="sxs-lookup"><span data-stu-id="f1094-107">Resource ID.</span></span></param>
        <param name="name"><span data-ttu-id="f1094-108">Name der Ressource.</span><span class="sxs-lookup"><span data-stu-id="f1094-108">Resource name.</span></span></param>
        <param name="type"><span data-ttu-id="f1094-109">Der Ressourcentyp.</span><span class="sxs-lookup"><span data-stu-id="f1094-109">Resource type.</span></span></param>
        <param name="location"><span data-ttu-id="f1094-110">Der Ressourcenspeicherort.</span><span class="sxs-lookup"><span data-stu-id="f1094-110">Resource location.</span></span></param>
        <param name="tags"><span data-ttu-id="f1094-111">Ressourcentags.</span><span class="sxs-lookup"><span data-stu-id="f1094-111">Resource tags.</span></span></param>
        <param name="authorizationKey"><span data-ttu-id="f1094-112">Die AuthorizationKey.</span><span class="sxs-lookup"><span data-stu-id="f1094-112">The authorizationKey.</span></span></param>
        <param name="virtualNetworkGateway2"><span data-ttu-id="f1094-113">der Verweis auf die gatewayressource des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="f1094-113">The reference to virtual network gateway resource.</span></span></param>
        <param name="localNetworkGateway2"><span data-ttu-id="f1094-114">Der Verweis auf das lokale Gateway Netzwerkressource.</span><span class="sxs-lookup"><span data-stu-id="f1094-114">The reference to local network gateway resource.</span></span></param>
        <param name="routingWeight"><span data-ttu-id="f1094-115">Das routing Gewichtung.</span><span class="sxs-lookup"><span data-stu-id="f1094-115">The routing weight.</span></span></param>
        <param name="sharedKey"><span data-ttu-id="f1094-116">Der freigegebene IPSec-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="f1094-116">The IPSec shared key.</span></span></param>
        <param name="connectionStatus"><span data-ttu-id="f1094-117">Das virtuelle Netzwerk-Gateway-Verbindungsstatus.</span><span class="sxs-lookup"><span data-stu-id="f1094-117">Virtual network Gateway connection status.</span></span> <span data-ttu-id="f1094-118">Mögliche Werte sind "Unknown", "Verbinden", "Verbunden" und "NotConnected".</span><span class="sxs-lookup"><span data-stu-id="f1094-118">Possible values are 'Unknown', 'Connecting', 'Connected' and 'NotConnected'.</span></span> <span data-ttu-id="f1094-119">Folgende Werte sind möglich: "Unknown", "Verbinden", "Verbunden", "NotConnected"</span><span class="sxs-lookup"><span data-stu-id="f1094-119">Possible values include: 'Unknown', 'Connecting', 'Connected', 'NotConnected'</span></span></param>
        <param name="tunnelConnectionStatus"><span data-ttu-id="f1094-120">Die Auflistung der Integritätsstatus für alle Tunnel-Verbindung.</span><span class="sxs-lookup"><span data-stu-id="f1094-120">Collection of all tunnels' connection health status.</span></span></param>
        <param name="egressBytesTransferred"><span data-ttu-id="f1094-121">Die ausgehenden Bytes übertragen bei dieser Verbindung.</span><span class="sxs-lookup"><span data-stu-id="f1094-121">The egress bytes transferred in this connection.</span></span></param>
        <param name="ingressBytesTransferred"><span data-ttu-id="f1094-122">Die Ingress-Bytes übertragen bei dieser Verbindung.</span><span class="sxs-lookup"><span data-stu-id="f1094-122">The ingress bytes transferred in this connection.</span></span></param>
        <param name="peer"><span data-ttu-id="f1094-123">Der Verweis auf die Ressource kann.</span><span class="sxs-lookup"><span data-stu-id="f1094-123">The reference to peerings resource.</span></span></param>
        <param name="enableBgp"><span data-ttu-id="f1094-124">EnableBgp-flag</span><span class="sxs-lookup"><span data-stu-id="f1094-124">EnableBgp flag</span></span></param>
        <param name="usePolicyBasedTrafficSelectors"><span data-ttu-id="f1094-125">Richtlinienbasierte Datenverkehr Auswahlen zu aktivieren.</span><span class="sxs-lookup"><span data-stu-id="f1094-125">Enable policy-based traffic selectors.</span></span></param>
        <param name="ipsecPolicies"><span data-ttu-id="f1094-126">Die IPSec-Richtlinien, die von dieser Verbindung berücksichtigt werden.</span><span class="sxs-lookup"><span data-stu-id="f1094-126">The IPSec Policies to be considered by this connection.</span></span></param>
        <param name="resourceGuid"><span data-ttu-id="f1094-127">Die GUID-Eigenschaft der Ressource VirtualNetworkGatewayConnection-Ressource.</span><span class="sxs-lookup"><span data-stu-id="f1094-127">The resource GUID property of the VirtualNetworkGatewayConnection resource.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="f1094-128">Der Bereitstellungsstatus der VirtualNetworkGatewayConnection Ressource.</span><span class="sxs-lookup"><span data-stu-id="f1094-128">The provisioning state of the VirtualNetworkGatewayConnection resource.</span></span> <span data-ttu-id="f1094-129">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="f1094-129">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span></param>
        <param name="etag"><span data-ttu-id="f1094-130">Ruft eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="f1094-130">Gets a unique read-only string that changes whenever the resource is updated.</span></span></param>
        <summary>
            <span data-ttu-id="f1094-131">Initialisiert eine neue Instanz der VirtualNetworkGatewayConnectionListEntity-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f1094-131">Initializes a new instance of the VirtualNetworkGatewayConnectionListEntity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AuthorizationKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-132">Ruft ab oder legt die AuthorizationKey.</span><span class="sxs-lookup"><span data-stu-id="f1094-132">Gets or sets the authorizationKey.</span></span>
            </summary>
    ...
    <Member MemberName="ConnectionStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-133">Ruft virtuelle Netzwerk-Gateway-Verbindungsstatus ab.</span><span class="sxs-lookup"><span data-stu-id="f1094-133">Gets virtual network Gateway connection status.</span></span> <span data-ttu-id="f1094-134">Mögliche Werte sind "Unknown", "Verbinden", "Verbunden" und "NotConnected".</span><span class="sxs-lookup"><span data-stu-id="f1094-134">Possible values are 'Unknown', 'Connecting', 'Connected' and 'NotConnected'.</span></span> <span data-ttu-id="f1094-135">Folgende Werte sind möglich: "Unknown", "Verbinden", "Verbunden", "NotConnected"</span><span class="sxs-lookup"><span data-stu-id="f1094-135">Possible values include: 'Unknown', 'Connecting', 'Connected', 'NotConnected'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-136">Ruft ab oder legt ihn fest Gateway Verbindung.</span><span class="sxs-lookup"><span data-stu-id="f1094-136">Gets or sets gateway connection type.</span></span> <span data-ttu-id="f1094-137">Mögliche Werte sind: "Ipsec", "Vnet2Vnet", "ExpressRoute" und "VPNClient.</span><span class="sxs-lookup"><span data-stu-id="f1094-137">Possible values are: 'Ipsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.</span></span> <span data-ttu-id="f1094-138">Folgende Werte sind möglich: "IPsec", "Vnet2Vnet", "ExpressRoute", "VPNClient"</span><span class="sxs-lookup"><span data-stu-id="f1094-138">Possible values include: 'IPsec', 'Vnet2Vnet', 'ExpressRoute', 'VPNClient'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EgressBytesTransferred">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-139">Ruft die ausgehenden Bytes, die bei dieser Verbindung übertragen.</span><span class="sxs-lookup"><span data-stu-id="f1094-139">Gets the egress bytes transferred in this connection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableBgp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-140">Ruft ab bzw. legt EnableBgp-Flag fest</span><span class="sxs-lookup"><span data-stu-id="f1094-140">Gets or sets enableBgp flag</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-141">Ruft eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="f1094-141">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IngressBytesTransferred">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-142">Ruft die in dieser Verbindung übertragen eingehend Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="f1094-142">Gets the ingress bytes transferred in this connection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpsecPolicies">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-143">Abrufen oder Festlegen der IPSec-Richtlinien, die von dieser Verbindung berücksichtigt werden.</span><span class="sxs-lookup"><span data-stu-id="f1094-143">Gets or sets the IPSec Policies to be considered by this connection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LocalNetworkGateway2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-144">Ruft ab oder legt den Verweis auf das lokale Gateway Netzwerkressource.</span><span class="sxs-lookup"><span data-stu-id="f1094-144">Gets or sets the reference to local network gateway resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Peer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-145">Ruft ab oder legt den Verweis auf die Ressource kann.</span><span class="sxs-lookup"><span data-stu-id="f1094-145">Gets or sets the reference to peerings resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-146">Ruft den Bereitstellungsstatus der VirtualNetworkGatewayConnection Ressource ab.</span><span class="sxs-lookup"><span data-stu-id="f1094-146">Gets the provisioning state of the VirtualNetworkGatewayConnection resource.</span></span> <span data-ttu-id="f1094-147">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="f1094-147">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-148">Abrufen oder Festlegen der Ressourcen-GUID-Eigenschaft der Ressource VirtualNetworkGatewayConnection.</span><span class="sxs-lookup"><span data-stu-id="f1094-148">Gets or sets the resource GUID property of the VirtualNetworkGatewayConnection resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RoutingWeight">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-149">Abrufen oder Festlegen der routing-Gewichtung.</span><span class="sxs-lookup"><span data-stu-id="f1094-149">Gets or sets the routing weight.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SharedKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-150">Ruft ab oder legt den gemeinsam verwendeten Schlüssel für IPSec.</span><span class="sxs-lookup"><span data-stu-id="f1094-150">Gets or sets the IPSec shared key.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TunnelConnectionStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-151">Ruft die Auflistung der Integritätsstatus für alle Tunnel-Verbindung ab.</span><span class="sxs-lookup"><span data-stu-id="f1094-151">Gets collection of all tunnels' connection health status.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UsePolicyBasedTrafficSelectors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-152">Ruft ab oder legt ihn fest Aktivieren einer richtlinienbasierten Datenverkehr Selektoren.</span><span class="sxs-lookup"><span data-stu-id="f1094-152">Gets or sets enable policy-based traffic selectors.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-153">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="f1094-153">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="f1094-154">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="f1094-154">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="VirtualNetworkGateway1">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-155">Ruft ab oder legt den Verweis auf die gatewayressource des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="f1094-155">Gets or sets the reference to virtual network gateway resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualNetworkGateway2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f1094-156">Ruft ab oder legt den Verweis auf die gatewayressource des virtuellen Netzwerks.</span><span class="sxs-lookup"><span data-stu-id="f1094-156">Gets or sets the reference to virtual network gateway resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
