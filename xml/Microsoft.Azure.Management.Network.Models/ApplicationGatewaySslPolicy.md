<Type Name="ApplicationGatewaySslPolicy" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewaySslPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7fd3a-101">Application Gateway Ssl-Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-101">Application Gateway Ssl policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-102">Initialisiert eine neue Instanz der ApplicationGatewaySslPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-102">Initializes a new instance of the ApplicationGatewaySslPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="disabledSslProtocols"><span data-ttu-id="7fd3a-103">SSL-Protokolle für Anwendungsgateway deaktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-103">Ssl protocols to be disabled on application gateway.</span></span></param>
        <param name="policyType"><span data-ttu-id="7fd3a-104">Typ des Ssl-Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-104">Type of Ssl Policy.</span></span> <span data-ttu-id="7fd3a-105">Folgende Werte sind möglich: "Vordefinierte", "Custom"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-105">Possible values include: 'Predefined', 'Custom'</span></span></param>
        <param name="policyName"><span data-ttu-id="7fd3a-106">Name der Ssl vordefinierten Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-106">Name of Ssl predefined policy.</span></span> <span data-ttu-id="7fd3a-107">Folgende Werte sind möglich: "AppGwSslPolicy20150501", "AppGwSslPolicy20170401", "AppGwSslPolicy20170401S"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-107">Possible values include: 'AppGwSslPolicy20150501', 'AppGwSslPolicy20170401', 'AppGwSslPolicy20170401S'</span></span></param>
        <param name="cipherSuites"><span data-ttu-id="7fd3a-108">SSL-Verschlüsselungssammlungen in der angegebenen Reihenfolge für das Anwendungsgateway aktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-108">Ssl cipher suites to be enabled in the specified order to application gateway.</span></span></param>
        <param name="minProtocolVersion"><span data-ttu-id="7fd3a-109">Minimale Version des Ssl-Protokolls, die auf Application Gateway unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-109">Minimum version of Ssl protocol to be supported on application gateway.</span></span> <span data-ttu-id="7fd3a-110">Folgende Werte sind möglich: "TLSv1_0", "TLSv1_1", "TLSv1_2"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-110">Possible values include: 'TLSv1_0', 'TLSv1_1', 'TLSv1_2'</span></span></param>
        <summary>
            <span data-ttu-id="7fd3a-111">Initialisiert eine neue Instanz der ApplicationGatewaySslPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-111">Initializes a new instance of the ApplicationGatewaySslPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CipherSuites">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-112">Abrufen oder Festlegen der Ssl-Verschlüsselungssammlungen in der angegebenen Reihenfolge für das Anwendungsgateway aktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-112">Gets or sets ssl cipher suites to be enabled in the specified order to application gateway.</span></span>
            </summary>
    ...
    <Member MemberName="DisabledSslProtocols">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-113">Abrufen oder Festlegen der Ssl-Protokolle für Anwendungsgateway deaktiviert werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-113">Gets or sets ssl protocols to be disabled on application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MinProtocolVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-114">Ruft ab, oder legt ihn fest Mindestversion des Ssl-Protokolls, die auf Application Gateway unterstützt werden.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-114">Gets or sets minimum version of Ssl protocol to be supported on application gateway.</span></span> <span data-ttu-id="7fd3a-115">Folgende Werte sind möglich: "TLSv1_0", "TLSv1_1", "TLSv1_2"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-115">Possible values include: 'TLSv1_0', 'TLSv1_1', 'TLSv1_2'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PolicyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-116">Ruft ab, oder legt ihn fest Namen vordefinierte Ssl-Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-116">Gets or sets name of Ssl predefined policy.</span></span> <span data-ttu-id="7fd3a-117">Folgende Werte sind möglich: "AppGwSslPolicy20150501", "AppGwSslPolicy20170401", "AppGwSslPolicy20170401S"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-117">Possible values include: 'AppGwSslPolicy20150501', 'AppGwSslPolicy20170401', 'AppGwSslPolicy20170401S'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PolicyType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fd3a-118">Ruft ab oder legt ihn fest Ssl-Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="7fd3a-118">Gets or sets type of Ssl Policy.</span></span> <span data-ttu-id="7fd3a-119">Folgende Werte sind möglich: "Vordefinierte", "Custom"</span><span class="sxs-lookup"><span data-stu-id="7fd3a-119">Possible values include: 'Predefined', 'Custom'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
