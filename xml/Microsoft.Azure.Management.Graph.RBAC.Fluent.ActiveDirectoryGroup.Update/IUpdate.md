<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.ActiveDirectoryGroup.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="839fe-101">Die Vorlage für eine Gruppe Update-Vorgang mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="839fe-101">The template for a group update operation, containing all the settings that can be modified.</span></span>
            </summary>
