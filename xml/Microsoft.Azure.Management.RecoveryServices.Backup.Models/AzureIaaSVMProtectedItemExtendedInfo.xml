<Type Name="AzureIaaSVMProtectedItemExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureIaaSVMProtectedItemExtendedInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8497a-101">Weitere Informationen zu bestimmten Azure-IaaS-VM Sichern des Elements.</span><span class="sxs-lookup"><span data-stu-id="8497a-101">Additional information on Azure IaaS VM specific backup item.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8497a-102">Initialisiert eine neue Instanz der AzureIaaSVMProtectedItemExtendedInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8497a-102">Initializes a new instance of the AzureIaaSVMProtectedItemExtendedInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="oldestRecoveryPoint"><span data-ttu-id="8497a-103">Die älteste Sicherungskopie für dieses Element für die Sicherung zur Verfügung.</span><span class="sxs-lookup"><span data-stu-id="8497a-103">The oldest backup copy available for this backup item.</span></span></param>
        <param name="recoveryPointCount"><span data-ttu-id="8497a-104">Die Anzahl von Sicherungskopien, die für dieses Element für die Sicherung zur Verfügung.</span><span class="sxs-lookup"><span data-stu-id="8497a-104">Number of backup copies available for this backup item.</span></span></param>
        <param name="policyInconsistent"><span data-ttu-id="8497a-105">Gibt an, ob der Richtlinie für das Sichern des Elements zugeordnet inkonsistent ist.</span><span class="sxs-lookup"><span data-stu-id="8497a-105">Specifies if backup policy associated with the backup item is inconsistent.</span></span></param>
        <summary>
            <span data-ttu-id="8497a-106">Initialisiert eine neue Instanz der AzureIaaSVMProtectedItemExtendedInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8497a-106">Initializes a new instance of the AzureIaaSVMProtectedItemExtendedInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OldestRecoveryPoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8497a-107">Ruft ab oder legt die älteste Sicherungskopie erstellen, die für dieses Element für die Sicherung.</span><span class="sxs-lookup"><span data-stu-id="8497a-107">Gets or sets the oldest backup copy available for this backup item.</span></span>
            </summary>
    ...
    <Member MemberName="PolicyInconsistent">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8497a-108">Ruft ab oder legt gibt an, ob der Richtlinie für das Sichern des Elements zugeordnet inkonsistent ist.</span><span class="sxs-lookup"><span data-stu-id="8497a-108">Gets or sets specifies if backup policy associated with the backup item is inconsistent.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPointCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8497a-109">Ruft ab oder legt die Anzahl von Sicherungskopien, die für dieses Element für die Sicherung zur Verfügung.</span><span class="sxs-lookup"><span data-stu-id="8497a-109">Gets or sets number of backup copies available for this backup item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
