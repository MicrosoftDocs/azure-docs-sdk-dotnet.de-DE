<Type Name="AzureIaaSVMProtectionPolicy" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureIaaSVMProtectionPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4a0cd-101">IaaS-VM arbeitsauslastungsspezifischen Sicherungsrichtlinie.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-101">IaaS VM workload-specific backup policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a0cd-102">Initialisiert eine neue Instanz der AzureIaaSVMProtectionPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-102">Initializes a new instance of the AzureIaaSVMProtectionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="protectedItemsCount"><span data-ttu-id="4a0cd-103">Anzahl der Elemente, die dieser Richtlinie zugeordnet sind.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-103">Number of items associated with this policy.</span></span></param>
        <param name="schedulePolicy"><span data-ttu-id="4a0cd-104">Sicherungszeitplan, der als Teil der Richtlinie angegeben ist.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-104">Backup schedule specified as part of backup policy.</span></span></param>
        <param name="retentionPolicy"><span data-ttu-id="4a0cd-105">Aufbewahrungsrichtlinie mit den Details auf Beibehaltungsdauern Sicherungskopie.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-105">Retention policy with the details on backup copy retention ranges.</span></span></param>
        <param name="timeZone"><span data-ttu-id="4a0cd-106">Optionale TimeZone-Eingabe als Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-106">TimeZone optional input as string.</span></span> <span data-ttu-id="4a0cd-107">Zum Beispiel: Zeitzone "Pacific Standard Time" =.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-107">For example: TimeZone = "Pacific Standard Time".</span></span></param>
        <summary>
            <span data-ttu-id="4a0cd-108">Initialisiert eine neue Instanz der AzureIaaSVMProtectionPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-108">Initializes a new instance of the AzureIaaSVMProtectionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RetentionPolicy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a0cd-109">Ruft ab, oder legt Sie Aufbewahrungsrichtlinie mit den Details Sicherungskopie Beibehaltungsdauern fest.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-109">Gets or sets retention policy with the details on backup copy retention ranges.</span></span>
            </summary>
    ...
    <Member MemberName="SchedulePolicy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a0cd-110">Ruft ab, oder legt ihn fest Sicherungszeitplan, die als Teil der Sicherungsrichtlinie angegeben.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-110">Gets or sets backup schedule specified as part of backup policy.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeZone">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a0cd-111">Ruft ab oder legt optional TimeZone-Eingabe als Zeichenfolge.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-111">Gets or sets timeZone optional input as string.</span></span> <span data-ttu-id="4a0cd-112">Zum Beispiel: Zeitzone "Pacific Standard Time" =.</span><span class="sxs-lookup"><span data-stu-id="4a0cd-112">For example: TimeZone = "Pacific Standard Time".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
