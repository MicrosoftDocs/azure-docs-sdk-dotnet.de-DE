<Type Name="AzureSqlProtectedItemExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureSqlProtectedItemExtendedInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="58396-101">Weitere Informationen zu Sql Azure spezifische geschützte Element.</span><span class="sxs-lookup"><span data-stu-id="58396-101">Additional information on Azure Sql specific protected item.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58396-102">Initialisiert eine neue Instanz der AzureSqlProtectedItemExtendedInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="58396-102">Initializes a new instance of the AzureSqlProtectedItemExtendedInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="oldestRecoveryPoint"><span data-ttu-id="58396-103">Die älteste Sicherungskopie für dieses Element in den Dienst verfügbar.</span><span class="sxs-lookup"><span data-stu-id="58396-103">The oldest backup copy available for this item in the service.</span></span></param>
        <param name="recoveryPointCount"><span data-ttu-id="58396-104">Die Anzahl der verfügbaren Sicherungskopien dieser Sichern des Elements zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="58396-104">Number of available backup copies associated with this backup item.</span></span></param>
        <param name="policyState"><span data-ttu-id="58396-105">Status der Sicherungsrichtlinie dieser Sichern des Elements zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="58396-105">State of the backup policy associated with this backup item.</span></span></param>
        <summary>
            <span data-ttu-id="58396-106">Initialisiert eine neue Instanz der AzureSqlProtectedItemExtendedInfo-Klasse.</span><span class="sxs-lookup"><span data-stu-id="58396-106">Initializes a new instance of the AzureSqlProtectedItemExtendedInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OldestRecoveryPoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58396-107">Ruft ab oder legt die älteste Sicherungskopie erstellen, die für dieses Element im Dienst.</span><span class="sxs-lookup"><span data-stu-id="58396-107">Gets or sets the oldest backup copy available for this item in the service.</span></span>
            </summary>
    ...
    <Member MemberName="PolicyState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58396-108">Ruft ab oder legt ihn fest der Sicherungsrichtlinie verknüpft sind mit diesem Element für die Sicherung.</span><span class="sxs-lookup"><span data-stu-id="58396-108">Gets or sets state of the backup policy associated with this backup item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPointCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58396-109">Ruft ab oder legt die Anzahl der verfügbaren Sicherungskopien dieser Sichern des Elements zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="58396-109">Gets or sets number of available backup copies associated with this backup item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
