<Type Name="IaasVMBackupRequest" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.IaasVMBackupRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="328cd-101">IaaS-VM spezifische Anforderung für die Sicherung.</span><span class="sxs-lookup"><span data-stu-id="328cd-101">IaaS VM workload-specific backup request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="328cd-102">Initialisiert eine neue Instanz der IaasVMBackupRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="328cd-102">Initializes a new instance of the IaasVMBackupRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="recoveryPointExpiryTimeInUTC"><span data-ttu-id="328cd-103">Sicherungskopie läuft nach der angegebenen Zeit (UTC).</span><span class="sxs-lookup"><span data-stu-id="328cd-103">Backup copy will expire after the time specified (UTC).</span></span></param>
        <summary>
            <span data-ttu-id="328cd-104">Initialisiert eine neue Instanz der IaasVMBackupRequest-Klasse.</span><span class="sxs-lookup"><span data-stu-id="328cd-104">Initializes a new instance of the IaasVMBackupRequest class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RecoveryPointExpiryTimeInUTC">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="328cd-105">Ruft ab oder legt fest, die Sicherungskopie nach dem Zeitpunkt laufen angegeben (UTC).</span><span class="sxs-lookup"><span data-stu-id="328cd-105">Gets or sets backup copy will expire after the time specified (UTC).</span></span>
            </summary>
