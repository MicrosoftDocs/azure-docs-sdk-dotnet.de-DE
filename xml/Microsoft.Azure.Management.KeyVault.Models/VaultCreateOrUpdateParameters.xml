<Type Name="VaultCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.KeyVault.Models.VaultCreateOrUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4b3d7-101">Parameter zum Erstellen oder Aktualisieren eines Tresors</span><span class="sxs-lookup"><span data-stu-id="4b3d7-101">Parameters for creating or updating a vault</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4b3d7-102">Initialisiert eine neue Instanz der VaultCreateOrUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-102">Initializes a new instance of the VaultCreateOrUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="4b3d7-103">Den unterstützten Azure-Speicherort, in dem der schlüsseltresor erstellt werden soll.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-103">The supported Azure location where the key vault should be created.</span></span></param>
        <param name="properties"><span data-ttu-id="4b3d7-104">Eigenschaften des Tresors</span><span class="sxs-lookup"><span data-stu-id="4b3d7-104">Properties of the vault</span></span></param>
        <param name="tags"><span data-ttu-id="4b3d7-105">Die Tags, die auf den schlüsseltresor zugewiesen werden soll.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-105">The tags that will be assigned to the key vault.</span></span></param>
        <summary>
            <span data-ttu-id="4b3d7-106">Initialisiert eine neue Instanz der VaultCreateOrUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-106">Initializes a new instance of the VaultCreateOrUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4b3d7-107">Ruft ab oder legt den unterstützten Azure-Speicherort, in dem der schlüsseltresor erstellt werden soll.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-107">Gets or sets the supported Azure location where the key vault should be created.</span></span>
            </summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4b3d7-108">Ruft ab oder legt die Eigenschaften des Tresors</span><span class="sxs-lookup"><span data-stu-id="4b3d7-108">Gets or sets properties of the vault</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4b3d7-109">Ermittelt oder definiert die Tags, die auf den schlüsseltresor zugewiesen werden soll.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-109">Gets or sets the tags that will be assigned to the key vault.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4b3d7-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="4b3d7-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="4b3d7-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="4b3d7-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
