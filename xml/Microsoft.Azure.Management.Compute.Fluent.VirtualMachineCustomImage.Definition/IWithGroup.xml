<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineCustomImage.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3e44d-101">Die Phase der Image-Definition ermöglicht die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="3e44d-101">The stage of the image definition allowing to specify the resource group.</span></span>
            </summary>
