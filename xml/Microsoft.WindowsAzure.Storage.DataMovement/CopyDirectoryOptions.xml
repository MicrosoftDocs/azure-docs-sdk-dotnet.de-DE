<Type Name="CopyDirectoryOptions" FullName="Microsoft.WindowsAzure.Storage.DataMovement.CopyDirectoryOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d00dc-101">Stellt eine Reihe von Optionen, die für den Kopiervorgang-Verzeichnis angegeben werden können</span><span class="sxs-lookup"><span data-stu-id="d00dc-101">Represents a set of options that may be specified for copy directory operation</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="BlobType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d00dc-102">Ruft ab oder legt ihn fest Ziel-Blob.</span><span class="sxs-lookup"><span data-stu-id="d00dc-102">Gets or sets type of destination blob.</span></span> <span data-ttu-id="d00dc-103">Diese Option wird wirksam, nur beim Kopieren von nicht-Azure-Blob-Speicher in Azure Blob-Speicher.</span><span class="sxs-lookup"><span data-stu-id="d00dc-103">This option takes effect only when copying from non Azure blob storage to Azure blob storage.</span></span> <span data-ttu-id="d00dc-104">Wenn der Blob-Typ nicht angegeben ist, wird die Datensicherungsdateien verwendet.</span><span class="sxs-lookup"><span data-stu-id="d00dc-104">If blob type is not specified, BlockBlob is used.</span></span>
            </summary>
    ...
    <Member MemberName="Delimiter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d00dc-105">Ermittelt oder definiert einen Char, der das Trennzeichen zum Trennen der virtuellen Verzeichnisse in einem blobnamen angibt.</span><span class="sxs-lookup"><span data-stu-id="d00dc-105">Gets or sets a char that indicates the delimiter character used to delimit virtual directories in a blob name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IncludeSnapshots">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d00dc-106">Ruft ab oder legt ein Flag, der angibt, ob Momentaufnahmen eingeschlossen werden sollen, wenn aus dem Azure-Blob-Speicher kopieren.</span><span class="sxs-lookup"><span data-stu-id="d00dc-106">Gets or sets a flag indicating whether to include snapshots when copying from Azure blob storage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="d00dc-107">Wenn dieses Flag, auf "true" Momentaufnahmen des Quell-Blob festgelegt ist wird als separate Dateien an Ziel kopiert werden.</span><span class="sxs-lookup"><span data-stu-id="d00dc-107">If this flag is set to true, snapshots of the source blob will be copied to destination as separate files.</span></span> <span data-ttu-id="d00dc-108">Ein Quell-Blob-Name im Format "x.y" wird angegeben, ist, auf dem "X" ist der Dateiname ohne Erweiterung und den Buchstaben "j" wird die Dateinamenerweiterung der Zieldateiname des Blob-Momentaufnahme als "x (% snapshot_time_stamp%).y" formatiert.</span><span class="sxs-lookup"><span data-stu-id="d00dc-108">Given a source blob name in the form of "x.y", where 'x' is the file name without extension and 'y' is the file name extension, the destination file name of blob snapshot is formatted as "x (%snapshot_time_stamp%).y".</span></span>
            </remarks>
      </Docs>
    </Member>
  </Members>
