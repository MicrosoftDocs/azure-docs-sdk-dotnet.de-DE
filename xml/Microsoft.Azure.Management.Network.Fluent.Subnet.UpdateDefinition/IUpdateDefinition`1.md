<Type Name="IUpdateDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.Subnet.UpdateDefinition.IUpdateDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="d92c2-101">Der Rückgabetyp des endgültigen UpdateDefinitionStages.WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="d92c2-101">The return type of the final  UpdateDefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="d92c2-102">Die Gesamtheit der subnetzdefinition als Teil eines virtuellen Netzwerks Updates.</span><span class="sxs-lookup"><span data-stu-id="d92c2-102">The entirety of a subnet definition as part of a virtual network update.</span></span>
            </summary>
