<Type Name="IUpdateAzureEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.UpdateAzureEndpoint.IUpdateAzureEndpoint">
  ...
  <Interfaces>
    ...
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.Update.IWithAzureResource</InterfaceName>
    </Interface>
  </Interfaces>
  <Docs>
    <summary>
            <span data-ttu-id="2c72a-101">Ein Azure-Endpunkt-Update als Teil des übergeordneten Traffic Manager-Profil Profil Update vollständig.</span><span class="sxs-lookup"><span data-stu-id="2c72a-101">The entirety of an Azure endpoint update as a part of parent traffic manager profile profile update.</span></span>
            </summary>
