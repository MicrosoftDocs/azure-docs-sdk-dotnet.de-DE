<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.Definition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="f6862-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="f6862-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="f6862-102">Die erste Phase der Definition eines VM-Erweiterung.</span><span class="sxs-lookup"><span data-stu-id="f6862-102">The first stage of a virtual machine extension definition.</span></span>
            </summary>
