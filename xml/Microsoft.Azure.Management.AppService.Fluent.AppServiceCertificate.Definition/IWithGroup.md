<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServiceCertificate.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f295e-101">Eine app Zertifikat Dienstdefinition Ressourcengruppe festgelegt werden können.</span><span class="sxs-lookup"><span data-stu-id="f295e-101">An app service certificate definition allowing resource group to be set.</span></span>
            </summary>
