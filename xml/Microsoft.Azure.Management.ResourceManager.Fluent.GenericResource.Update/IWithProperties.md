<Type Name="IWithProperties" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.GenericResource.Update.IWithProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="41e4d-101">Eine allgemeine Ressource Update zum Ändern der Ressourceneigenschaften ermöglicht.</span><span class="sxs-lookup"><span data-stu-id="41e4d-101">A generic resource update allowing to change the resource properties.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithProperties">
      ...
      <Docs>
        <param name="properties"><span data-ttu-id="41e4d-102">Eigenschaften der Properties-Objekt</span><span class="sxs-lookup"><span data-stu-id="41e4d-102">properties the properties object</span></span></param>
        <summary>
            <span data-ttu-id="41e4d-103">Gibt die anderen Eigenschaften der Ressource an.</span><span class="sxs-lookup"><span data-stu-id="41e4d-103">Specifies other properties of the resource.</span></span>
            </summary>
        <returns><span data-ttu-id="41e4d-104">die nächste Phase der allgemeine Ressource aktualisieren</span><span class="sxs-lookup"><span data-stu-id="41e4d-104">the next stage of generic resource update</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
