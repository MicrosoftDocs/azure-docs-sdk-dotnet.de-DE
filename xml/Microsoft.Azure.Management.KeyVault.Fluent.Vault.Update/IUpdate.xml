<Type Name="IUpdate" FullName="Microsoft.Azure.Management.KeyVault.Fluent.Vault.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="316a5-101">Die Vorlage für einen schlüsseltresor Update-Vorgang mit den Einstellungen aus, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="316a5-101">The template for a key vault update operation, containing all the settings that can be modified.</span></span>
            </summary>
