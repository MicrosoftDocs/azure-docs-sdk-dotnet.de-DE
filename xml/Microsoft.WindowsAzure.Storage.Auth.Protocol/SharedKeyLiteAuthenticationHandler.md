<Type Name="SharedKeyLiteAuthenticationHandler" FullName="Microsoft.WindowsAzure.Storage.Auth.Protocol.SharedKeyLiteAuthenticationHandler">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d9060-101">Stellt einen Handler, der die HTTP-Anforderungen mit einem gemeinsamen Schlüssel signiert.</span><span class="sxs-lookup"><span data-stu-id="d9060-101">Represents a handler that signs HTTP requests with a shared key.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="canonicalizer"><span data-ttu-id="d9060-102">Eine Canonicalizer, die HTTP-Anforderungsdaten in ein Standardformat zum Signieren von entsprechenden konvertiert.</span><span class="sxs-lookup"><span data-stu-id="d9060-102">A canonicalizer that converts HTTP request data into a standard form appropriate for signing.</span></span></param>
        <param name="credentials"><span data-ttu-id="d9060-103">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Auth.StorageCredentials" /> Objekt Anmeldeinformationen für die Anforderung anzugeben.</span><span class="sxs-lookup"><span data-stu-id="d9060-103">A <see cref="T:Microsoft.WindowsAzure.Storage.Auth.StorageCredentials" /> object providing credentials for the request.</span></span></param>
        <param name="resourceAccountName"><span data-ttu-id="d9060-104">Der Name des Speicherkontos an, dem die HTTP-Anforderung zugreifen.</span><span class="sxs-lookup"><span data-stu-id="d9060-104">The name of the storage account that the HTTP request will access.</span></span></param>
        <summary>
            <span data-ttu-id="d9060-105">Initialisiert eine neue Instanz der <see cref="T:Microsoft.WindowsAzure.Storage.Auth.Protocol.SharedKeyLiteAuthenticationHandler" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="d9060-105">Initializes a new instance of the <see cref="T:Microsoft.WindowsAzure.Storage.Auth.Protocol.SharedKeyLiteAuthenticationHandler" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SignRequest">
      ...
      <Docs>
        <param name="request"><span data-ttu-id="d9060-106">Die zum Signieren von HTTP-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="d9060-106">The HTTP request to sign.</span></span></param>
        <param name="operationContext"><span data-ttu-id="d9060-107">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</span><span class="sxs-lookup"><span data-stu-id="d9060-107">An <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> object that represents the context for the current operation.</span></span></param>
        <summary>
            <span data-ttu-id="d9060-108">Signiert die angegebene HTTP-Anforderung mit einem gemeinsamen Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="d9060-108">Signs the specified HTTP request with a shared key.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
