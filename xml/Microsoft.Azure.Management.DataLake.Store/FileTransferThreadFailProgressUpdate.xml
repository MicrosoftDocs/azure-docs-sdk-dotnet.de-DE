<Type Name="FileTransferThreadFailProgressUpdate" FullName="Microsoft.Azure.Management.DataLake.Store.FileTransferThreadFailProgressUpdate">
  ...
  <Docs>
    ...
    <summary>
            <span data-ttu-id="13a2a-101">Stellt einen Delegaten, der im Falle einer Übertragung Thread aufgerufen wird, eine Datei unerwartet beendet.</span><span class="sxs-lookup"><span data-stu-id="13a2a-101">Represents a delegate that is called in the event of a thread transfering a file terminating unexpectedly.</span></span>
            </summary>
