<Type Name="TableContinuationToken" FullName="Microsoft.WindowsAzure.Storage.Table.TableContinuationToken">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="93a1f-101">Stellt ein Fortsetzungstoken für Auflistungsvorgänge dar.</span><span class="sxs-lookup"><span data-stu-id="93a1f-101">Represents a continuation token for listing operations.</span></span> 
            </summary>
    <remarks><span data-ttu-id="93a1f-102">Eine Methode, die eine Teilmenge der Ergebnisse über zurückzugeben kann ein <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableResultSegment" /> -Objekt gibt auch ein Fortsetzungstoken an, die in einem nachfolgenden Aufruf verwendet werden kann, um den nächsten Satz verfügbarer Ergebnisse zurückzugeben.</span><span class="sxs-lookup"><span data-stu-id="93a1f-102">A method that may return a partial set of results via a <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableResultSegment" /> object also returns a continuation token, which can be used in a subsequent call to return the next set of available results.</span></span> </remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="GetSchema">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93a1f-103">Ruft eine XML-Darstellung eines Objekts ab.</span><span class="sxs-lookup"><span data-stu-id="93a1f-103">Gets an XML representation of an object.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="93a1f-104">Ein <see cref="T:System.Xml.Schema.XmlSchema" /> zur Beschreibung der XML-Darstellung des Objekts, das von der <see cref="M:System.Xml.Serialization.IXmlSerializable.WriteXml(System.Xml.XmlWriter)" />-Methode erstellt und von der <see cref="M:System.Xml.Serialization.IXmlSerializable.ReadXml(System.Xml.XmlReader)" />-Methode verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="93a1f-104">An <see cref="T:System.Xml.Schema.XmlSchema" /> that describes the XML representation of the object that is produced by the <see cref="M:System.Xml.Serialization.IXmlSerializable.WriteXml(System.Xml.XmlWriter)" /> method and consumed by the <see cref="M:System.Xml.Serialization.IXmlSerializable.ReadXml(System.Xml.XmlReader)" /> method.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextPartitionKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93a1f-105">Ruft ab oder legt den nächsten Partitionsschlüssel für <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumerationsvorgängen.</span><span class="sxs-lookup"><span data-stu-id="93a1f-105">Gets or sets the next partition key for <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="93a1f-106">Eine Zeichenfolge, die den nächsten Partitionsschlüssel enthält.</span><span class="sxs-lookup"><span data-stu-id="93a1f-106">A string containing the next partition key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextRowKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93a1f-107">Ruft ab oder legt den nächsten Zeilenschlüssel für <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumerationsvorgängen.</span><span class="sxs-lookup"><span data-stu-id="93a1f-107">Gets or sets the next row key for <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="93a1f-108">Eine Zeichenfolge, die den nächsten Zeilenschlüssel enthält.</span><span class="sxs-lookup"><span data-stu-id="93a1f-108">A string containing the next row key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextTableName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93a1f-109">Ruft ab oder legt den nächsten Tabellennamen für <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumerationsvorgängen.</span><span class="sxs-lookup"><span data-stu-id="93a1f-109">Gets or sets the next table name for <see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="93a1f-110">Eine Zeichenfolge mit dem Namen des in der nächsten Tabelle.</span><span class="sxs-lookup"><span data-stu-id="93a1f-110">A string containing the name of the next table.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadXml">
      ...
      <Docs>
        <param name="reader"><span data-ttu-id="93a1f-111">Die <see cref="T:System.Xml.XmlReader" /> stream, aus dem das Fortsetzungstoken deserialisiert wird.</span><span class="sxs-lookup"><span data-stu-id="93a1f-111">The <see cref="T:System.Xml.XmlReader" /> stream from which the continuation token is deserialized.</span></span></param>
        <summary>
            <span data-ttu-id="93a1f-112">Generiert ein serialisierbares Fortsetzungstoken aus seiner XML-Darstellung.</span><span class="sxs-lookup"><span data-stu-id="93a1f-112">Generates a serializable continuation token from its XML representation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TargetLocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93a1f-113">Ruft ab oder legt den Speicherort an, dem das Fortsetzungstoken gilt.</span><span class="sxs-lookup"><span data-stu-id="93a1f-113">Gets or sets the storage location that the continuation token applies to.</span></span>
            </summary>
        <value><span data-ttu-id="93a1f-114">Ein <see cref="T:Microsoft.WindowsAzure.Storage.StorageLocation" />-Enumerationswert.</span><span class="sxs-lookup"><span data-stu-id="93a1f-114">A <see cref="T:Microsoft.WindowsAzure.Storage.StorageLocation" /> enumeration value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteXml">
      ...
      <Docs>
        <param name="writer"><span data-ttu-id="93a1f-115">Die <see cref="T:System.Xml.XmlWriter" /> stream, in den das Fortsetzungstoken serialisiert wird.</span><span class="sxs-lookup"><span data-stu-id="93a1f-115">The <see cref="T:System.Xml.XmlWriter" /> stream to which the continuation token is serialized.</span></span></param>
        <summary>
            <span data-ttu-id="93a1f-116">Konvertiert ein serialisierbares Fortsetzungstoken in seine XML-Darstellung.</span><span class="sxs-lookup"><span data-stu-id="93a1f-116">Converts a serializable continuation token into its XML representation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
