<Type Name="TableQuerySegment&lt;TElement&gt;" FullName="Microsoft.WindowsAzure.Storage.Table.TableQuerySegment&lt;TElement&gt;">
  ...
  <Docs>
    <typeparam name="TElement"><span data-ttu-id="947a5-101">Der Typ des Ergebnisses, das das Segment enthält.</span><span class="sxs-lookup"><span data-stu-id="947a5-101">The type of the result that the segment contains.</span></span></typeparam>
    <summary>
            <span data-ttu-id="947a5-102">Stellt ein Segment der Ergebnisse dar und enthält fortsetzungstokeninformationen.</span><span class="sxs-lookup"><span data-stu-id="947a5-102">Represents a segment of results and contains continuation token information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="947a5-103">Ruft ein Fortsetzungstoken zum Abrufen des nächsten Satz von Ergebnissen mit einem nachfolgenden Aufruf des Vorgangs ab.</span><span class="sxs-lookup"><span data-stu-id="947a5-103">Gets a continuation token to use to retrieve the next set of results with a subsequent call to the operation.</span></span>
            </summary>
        <value><span data-ttu-id="947a5-104">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableContinuationToken" />-Objekt.</span><span class="sxs-lookup"><span data-stu-id="947a5-104">A <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableContinuationToken" /> object.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="947a5-105">Gibt einen Enumerator zurück, der die <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" /> durchläuft.</span><span class="sxs-lookup"><span data-stu-id="947a5-105">Returns an enumerator that iterates through the <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" />.</span></span>
            </summary>
        <returns><span data-ttu-id="947a5-106">Ein Enumerator, durchläuft die <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" />.</span><span class="sxs-lookup"><span data-stu-id="947a5-106">An enumerator that iterates through the <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" />.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Results">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="947a5-107">Ruft eine aufzählbare Auflistung von Ergebnissen ab.</span><span class="sxs-lookup"><span data-stu-id="947a5-107">Gets an enumerable collection of results.</span></span>
            </summary>
        <value><span data-ttu-id="947a5-108">Eine aufzählbare Auflistung von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="947a5-108">An enumerable collection of results.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
