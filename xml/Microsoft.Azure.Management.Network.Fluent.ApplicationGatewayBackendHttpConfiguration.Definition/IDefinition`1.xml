<Type Name="IDefinition&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Definition.IDefinition&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="d9e27-101">Die Phase der Definition des übergeordneten Anwendung Gateway wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="d9e27-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="d9e27-102">Die Gesamtheit der Definition einer Anwendung Gateway Back-End-HTTP-Konfiguration.</span><span class="sxs-lookup"><span data-stu-id="d9e27-102">The entirety of an application gateway backend HTTP configuration definition.</span></span>
            </summary>
