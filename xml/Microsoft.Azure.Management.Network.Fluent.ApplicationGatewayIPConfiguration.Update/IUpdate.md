<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayIPConfiguration.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3e935-101">Die gesamte Anwendung Gateway IP-Konfiguration Update als Teil einer Anwendung gatewayupdate.</span><span class="sxs-lookup"><span data-stu-id="3e935-101">The entirety of an application gateway IP configuration update as part of an application gateway update.</span></span>
            </summary>
