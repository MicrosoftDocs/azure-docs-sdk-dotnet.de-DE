<Type Name="UpdatedAtAttribute" FullName="Microsoft.WindowsAzure.MobileServices.UpdatedAtAttribute">
  ...
  <TypeSignature Language="VB.NET" Value="Public Class UpdatedAtAttribute&#xA;Inherits Attribute" />
  <TypeSignature Language="F#" Value="type UpdatedAtAttribute = class&#xA;    inherit Attribute&#xA;    interface ISystemPropertyAttribute" />
  <AssemblyInfo>
  ...
  <Docs>
    <summary>
            <span data-ttu-id="390bd-101">Angewendet auf einen Member eines Typs angeben, dass sie die Systemeigenschaft UpdatedAt darstellt.</span><span class="sxs-lookup"><span data-stu-id="390bd-101">Attribute applied to a member of a type to specify that it represents the updatedAt system property.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="390bd-102">Initialisiert eine neue Instanz der UpdatedAtAttribute-Klasse.</span><span class="sxs-lookup"><span data-stu-id="390bd-102">Initializes a new instance of the UpdatedAtAttribute class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
