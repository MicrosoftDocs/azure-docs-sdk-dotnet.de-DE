<Type Name="IWithBillingContact" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServiceDomain.Update.IWithBillingContact">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="df479-101">Die Domänendefinition einer ermöglicht Rechnungskontakt festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="df479-101">A domain definition allowing billing contact to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithBillingContact">
      ...
      <Docs>
        <param name="contact"><span data-ttu-id="df479-102">Die Rechnungskontakt.</span><span class="sxs-lookup"><span data-stu-id="df479-102">The billing contact.</span></span></param>
        <summary>
            <span data-ttu-id="df479-103">Geben Sie den Rechnungskontakt.</span><span class="sxs-lookup"><span data-stu-id="df479-103">Specify the billing contact.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="df479-104">die nächste Phase der Domänendefinition.</span><span class="sxs-lookup"><span data-stu-id="df479-104">The next stage of domain definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>