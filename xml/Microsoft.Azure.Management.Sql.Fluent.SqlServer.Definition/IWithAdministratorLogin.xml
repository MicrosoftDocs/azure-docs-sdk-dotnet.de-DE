<Type Name="IWithAdministratorLogin" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlServer.Definition.IWithAdministratorLogin">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a5a7f-101">Ein SQL Server-Definition Einstellung Administrator-Benutzername.</span><span class="sxs-lookup"><span data-stu-id="a5a7f-101">A SQL Server definition setting administrator user name.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithAdministratorLogin">
      ...
      <Docs>
        <param name="administratorLogin"><span data-ttu-id="a5a7f-102">Anmeldung Benutzername des Administrators.</span><span class="sxs-lookup"><span data-stu-id="a5a7f-102">Administrator login user name.</span></span></param>
        <summary>
            <span data-ttu-id="a5a7f-103">Legt fest, der Administrator Benutzernamen ein.</span><span class="sxs-lookup"><span data-stu-id="a5a7f-103">Sets the administrator login user name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a5a7f-104">Nächste Phase der SQL Server-Definition.</span><span class="sxs-lookup"><span data-stu-id="a5a7f-104">Next stage of the SQL Server definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>