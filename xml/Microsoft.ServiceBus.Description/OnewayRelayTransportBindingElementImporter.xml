<Type Name="OnewayRelayTransportBindingElementImporter" FullName="Microsoft.ServiceBus.Description.OnewayRelayTransportBindingElementImporter">
  ...
  <Docs>
    <summary><span data-ttu-id="bcb93-101">WSDL-Verträgen und Richtlinienassertionen in Azure Service Bus OnewayRelayTransport Bindungen zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="bcb93-101">Maps WSDL contracts and policy assertions into Azure Service Bus OnewayRelayTransport bindings.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="bcb93-102">Initialisiert eine neue Instanz der <see cref="T:Microsoft.ServiceBus.Description.OnewayRelayTransportBindingElementImporter" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bcb93-102">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Description.OnewayRelayTransportBindingElementImporter" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
