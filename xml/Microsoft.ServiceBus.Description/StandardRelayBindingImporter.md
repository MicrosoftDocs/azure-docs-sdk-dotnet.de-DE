<Type Name="StandardRelayBindingImporter" FullName="Microsoft.ServiceBus.Description.StandardRelayBindingImporter">
  ...
  <Docs>
    <summary><span data-ttu-id="63452-101">WSDL-Verträgen und Richtlinienassertionen in Azure Service Bus-standardbindungen zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="63452-101">Maps WSDL contracts and policy assertions into Azure Service Bus standard bindings.</span></span></summary>
  ...
  <Members>
    ...
    <Member MemberName="BeforeImport">
      ...
      <Docs>
        <param name="wsdlDocuments"><span data-ttu-id="63452-102">Beschreibt den Dienst.</span><span class="sxs-lookup"><span data-stu-id="63452-102">Describes the service.</span></span></param>
        <param name="xmlSchemas"><span data-ttu-id="63452-103">Beschreibt die <paramref name="wsdlDocuments" />.</span><span class="sxs-lookup"><span data-stu-id="63452-103">Describes the <paramref name="wsdlDocuments" />.</span></span></param>
        <param name="policy"><span data-ttu-id="63452-104">Den Richtlinienelementen.</span><span class="sxs-lookup"><span data-stu-id="63452-104">Contains the policy elements.</span></span></param>
        <summary><span data-ttu-id="63452-105">Wird vor dem Importieren der Metadatendokumente aufgerufen, die mit der Standardbindung verknüpft sind.</span><span class="sxs-lookup"><span data-stu-id="63452-105">Called prior to importing the metadata documents associated with the standard binding.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ImportContract">
      ...
      <Docs>
        <param name="importer"> <span data-ttu-id="63452-106">Die WSDL-Importer zum Importieren und Auflösen von WSDL-Metadaten.</span><span class="sxs-lookup"><span data-stu-id="63452-106">The WSDL importer for importing and resolving WSDL metadata.</span></span></param>
        <param name="context"> <span data-ttu-id="63452-107">Stellt den Kontext für die Konvertierung von WSDL zur Beschreibung Diensts bereit.</span><span class="sxs-lookup"><span data-stu-id="63452-107">Provides the context for the conversion from WSDL to the service description.</span></span></param>
        <summary><span data-ttu-id="63452-108">Importiert WSDL-Vertragsinformationen für standardbindungen.</span><span class="sxs-lookup"><span data-stu-id="63452-108">Imports WSDL contract information for standard bindings.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ImportEndpoint">
      ...
      <Docs>
        <param name="importer"> <span data-ttu-id="63452-109">Die WSDL-Importer zum Importieren und Auflösen von WSDL-Metadaten.</span><span class="sxs-lookup"><span data-stu-id="63452-109">The WSDL importer for importing and resolving WSDL metadata.</span></span></param>
        <param name="endpointContext"> <span data-ttu-id="63452-110">Der Kontext für die Konvertierung.</span><span class="sxs-lookup"><span data-stu-id="63452-110">The context for the conversion.</span></span></param>
        <summary><span data-ttu-id="63452-111">Wird in die Beschreibung des Diensts in WSDL definierte Endpunkten zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="63452-111">Maps endpoints defined in WSDL into the service description.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
