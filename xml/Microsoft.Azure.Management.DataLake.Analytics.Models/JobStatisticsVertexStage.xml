<Type Name="JobStatisticsVertexStage" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.JobStatisticsVertexStage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="99836-101">Data Lake Analytics-Auftrag Statistikinformationen Vertexshader-Stufe.</span><span class="sxs-lookup"><span data-stu-id="99836-101">The Data Lake Analytics job statistics vertex stage information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-102">Initialisiert eine neue Instanz der JobStatisticsVertexStage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="99836-102">Initializes a new instance of the JobStatisticsVertexStage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dataRead"><span data-ttu-id="99836-103">die Menge der Daten eingelesenen Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="99836-103">the amount of data read, in bytes.</span></span></param>
        <param name="dataReadCrossPod"><span data-ttu-id="99836-104">die Menge der Daten, die über mehrere Pods, in Bytes gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="99836-104">the amount of data read across multiple pods, in bytes.</span></span></param>
        <param name="dataReadIntraPod"><span data-ttu-id="99836-105">die Menge der Daten in eine Pod, in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-105">the amount of data read in one pod, in bytes.</span></span></param>
        <param name="dataToRead"><span data-ttu-id="99836-106">die Menge der Daten, die verbleiben, die in Bytes gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="99836-106">the amount of data remaining to be read, in bytes.</span></span></param>
        <param name="dataWritten"><span data-ttu-id="99836-107">die Menge der Daten, die geschrieben werden, in Bytes.</span><span class="sxs-lookup"><span data-stu-id="99836-107">the amount of data written, in bytes.</span></span></param>
        <param name="duplicateDiscardCount"><span data-ttu-id="99836-108">die Anzahl von Duplikaten, die verworfen wurden.</span><span class="sxs-lookup"><span data-stu-id="99836-108">the number of duplicates that were discarded.</span></span></param>
        <param name="failedCount"><span data-ttu-id="99836-109">die Anzahl von Fehlern, die in dieser Phase durchgeführt werden soll.</span><span class="sxs-lookup"><span data-stu-id="99836-109">the number of failures that occured in this stage.</span></span></param>
        <param name="maxVertexDataRead"><span data-ttu-id="99836-110">die Höchstmenge an Daten, die in einen einzelnen Vertex, in Bytes gelesen werden.</span><span class="sxs-lookup"><span data-stu-id="99836-110">the maximum amount of data read in a single vertex, in bytes.</span></span></param>
        <param name="minVertexDataRead"><span data-ttu-id="99836-111">die Mindestmenge an Daten in einen einzelnen Vertex, in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-111">the minimum amount of data read in a single vertex, in bytes.</span></span></param>
        <param name="readFailureCount"><span data-ttu-id="99836-112">die Anzahl der gelesenen Fehler in dieser Phase werden soll.</span><span class="sxs-lookup"><span data-stu-id="99836-112">the number of read failures in this stage.</span></span></param>
        <param name="revocationCount"><span data-ttu-id="99836-113">die Anzahl der Scheitelpunkte, die in dieser Phase aufgehoben wurden.</span><span class="sxs-lookup"><span data-stu-id="99836-113">the number of vertices that were revoked during this stage.</span></span></param>
        <param name="runningCount"><span data-ttu-id="99836-114">die Anzahl der Scheitelpunkte derzeit in dieser Phase ausgeführt werden.</span><span class="sxs-lookup"><span data-stu-id="99836-114">the number of currently running vertices in this stage.</span></span></param>
        <param name="scheduledCount"><span data-ttu-id="99836-115">die Anzahl der derzeit geplanter Scheitelpunkten in dieser Phase</span><span class="sxs-lookup"><span data-stu-id="99836-115">the number of currently scheduled vertices in this stage</span></span></param>
        <param name="stageName"><span data-ttu-id="99836-116">der Name dieser Phase in der Ausführung eines Auftrags.</span><span class="sxs-lookup"><span data-stu-id="99836-116">the name of this stage in job execution.</span></span></param>
        <param name="succeededCount"><span data-ttu-id="99836-117">die Anzahl der Scheitelpunkte, die in dieser Phase war erfolgreich.</span><span class="sxs-lookup"><span data-stu-id="99836-117">the number of vertices that succeeded in this stage.</span></span></param>
        <param name="tempDataWritten"><span data-ttu-id="99836-118">die Menge des temporären Daten geschrieben werden, in Bytes.</span><span class="sxs-lookup"><span data-stu-id="99836-118">the amount of temporary data written, in bytes.</span></span></param>
        <param name="totalCount"><span data-ttu-id="99836-119">die Anzahl der insgesamt Vertex für diese Stufe.</span><span class="sxs-lookup"><span data-stu-id="99836-119">the total vertex count for this stage.</span></span></param>
        <param name="totalFailedTime"><span data-ttu-id="99836-120">die Zeitspanne, die Scheitelpunkte nicht benötigte oben in dieser Phase.</span><span class="sxs-lookup"><span data-stu-id="99836-120">the amount of time that failed vertices took up in this stage.</span></span></param>
        <param name="totalProgress"><span data-ttu-id="99836-121">der aktuelle Status dieser Phase, als Prozentsatz.</span><span class="sxs-lookup"><span data-stu-id="99836-121">the current progress of this stage, as a percentage.</span></span></param>
        <param name="totalSucceededTime"><span data-ttu-id="99836-122">die Zeitspanne, die alle erfolgreichen Scheitelpunkte in dieser Phase ausgeführt haben.</span><span class="sxs-lookup"><span data-stu-id="99836-122">the amount of time all successful vertices took in this stage.</span></span></param>
        <summary>
            <span data-ttu-id="99836-123">Initialisiert eine neue Instanz der JobStatisticsVertexStage-Klasse.</span><span class="sxs-lookup"><span data-stu-id="99836-123">Initializes a new instance of the JobStatisticsVertexStage class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DataRead">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-124">Ruft die Menge der Daten, die gelesen, in Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="99836-124">Gets the amount of data read, in bytes.</span></span>
            </summary>
    ...
    <Member MemberName="DataReadCrossPod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-125">Ruft die Menge der Daten, die über mehrere Pods, in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-125">Gets the amount of data read across multiple pods, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataReadIntraPod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-126">Ruft die Menge der Daten in eine Pod, in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-126">Gets the amount of data read in one pod, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataToRead">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-127">Ruft die Menge der Daten, die noch um zu gelesen werden, in Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="99836-127">Gets the amount of data remaining to be read, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataWritten">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-128">Ruft die Menge der Daten, die geschrieben werden, in Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="99836-128">Gets the amount of data written, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DuplicateDiscardCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-129">Ruft die Anzahl von Duplikaten, die verworfen wurden.</span><span class="sxs-lookup"><span data-stu-id="99836-129">Gets the number of duplicates that were discarded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FailedCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-130">Ruft die Anzahl von Fehlern, die in dieser Phase aufgetreten sind.</span><span class="sxs-lookup"><span data-stu-id="99836-130">Gets the number of failures that occured in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxVertexDataRead">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-131">Ruft die maximale Datenmenge, die in einem einzelnen Scheitelpunkt in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-131">Gets the maximum amount of data read in a single vertex, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MinVertexDataRead">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-132">Ruft die minimale Datenmenge in einen einzelnen Vertex, in Bytes zu lesen.</span><span class="sxs-lookup"><span data-stu-id="99836-132">Gets the minimum amount of data read in a single vertex, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadFailureCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-133">Ruft die Anzahl der gelesenen Fehler in dieser Phase an.</span><span class="sxs-lookup"><span data-stu-id="99836-133">Gets the number of read failures in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RevocationCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-134">Ruft die Anzahl der Scheitelpunkte, die in dieser Phase aufgehoben wurden.</span><span class="sxs-lookup"><span data-stu-id="99836-134">Gets the number of vertices that were revoked during this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunningCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-135">Ruft die Anzahl der derzeit in dieser Phase ausgeführten Scheitelpunkte.</span><span class="sxs-lookup"><span data-stu-id="99836-135">Gets the number of currently running vertices in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScheduledCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-136">Ruft die Anzahl der derzeit geplanter Scheitelpunkten in dieser Phase</span><span class="sxs-lookup"><span data-stu-id="99836-136">Gets the number of currently scheduled vertices in this stage</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StageName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-137">Ruft den Namen dieser Phase in der Ausführung eines Auftrags ab.</span><span class="sxs-lookup"><span data-stu-id="99836-137">Gets the name of this stage in job execution.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SucceededCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-138">Ruft die Anzahl der Scheitelpunkte, die in dieser Phase war erfolgreich.</span><span class="sxs-lookup"><span data-stu-id="99836-138">Gets the number of vertices that succeeded in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TempDataWritten">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-139">Ruft die Menge des temporären Daten geschrieben werden, in Bytes ab.</span><span class="sxs-lookup"><span data-stu-id="99836-139">Gets the amount of temporary data written, in bytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-140">Ruft die Anzahl der insgesamt Vertex für diese Stufe an.</span><span class="sxs-lookup"><span data-stu-id="99836-140">Gets the total vertex count for this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalFailedTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-141">Ruft dauerte die Zeitspanne, die nicht der Scheitelpunkte oben in dieser Phase.</span><span class="sxs-lookup"><span data-stu-id="99836-141">Gets the amount of time that failed vertices took up in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-142">Ruft den aktuellen Status dieser Phase als Prozentsatz ab.</span><span class="sxs-lookup"><span data-stu-id="99836-142">Gets the current progress of this stage, as a percentage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalSucceededTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99836-143">Ruft die Zeitspanne, die alle erfolgreichen Scheitelpunkte in dieser Phase ausgeführt haben.</span><span class="sxs-lookup"><span data-stu-id="99836-143">Gets the amount of time all successful vertices took in this stage.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
