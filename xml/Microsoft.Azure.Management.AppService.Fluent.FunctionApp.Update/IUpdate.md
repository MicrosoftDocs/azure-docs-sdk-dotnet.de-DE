<Type Name="IUpdate" FullName="Microsoft.Azure.Management.AppService.Fluent.FunctionApp.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fe6ce-101">Die Vorlage für eine Funktion-app-Updatevorgang, enthält alle Einstellungen, die geändert werden können.</span><span class="sxs-lookup"><span data-stu-id="fe6ce-101">The template for a function app update operation, containing all the settings that can be modified.</span></span>
            </summary>
