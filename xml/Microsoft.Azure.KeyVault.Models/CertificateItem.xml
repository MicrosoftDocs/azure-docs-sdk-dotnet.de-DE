<Type Name="CertificateItem" FullName="Microsoft.Azure.KeyVault.Models.CertificateItem">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d55ed-101">Das zertifikatselement mit Zertifikat-Metadaten</span><span class="sxs-lookup"><span data-stu-id="d55ed-101">The certificate item containing certificate metadata</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-102">Initialisiert eine neue Instanz der CertificateItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="d55ed-102">Initializes a new instance of the CertificateItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="d55ed-103">Zertifikatsbezeichner.</span><span class="sxs-lookup"><span data-stu-id="d55ed-103">Certificate identifier.</span></span></param>
        <param name="attributes"><span data-ttu-id="d55ed-104">Die Zertifikat-Management-Attribute.</span><span class="sxs-lookup"><span data-stu-id="d55ed-104">The certificate management attributes.</span></span></param>
        <param name="tags"><span data-ttu-id="d55ed-105">Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="d55ed-105">Application specific metadata in the form of key-value pairs.</span></span></param>
        <param name="x509Thumbprint"><span data-ttu-id="d55ed-106">Der Fingerabdruck des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="d55ed-106">Thumbprint of the certificate.</span></span></param>
        <summary>
            <span data-ttu-id="d55ed-107">Initialisiert eine neue Instanz der CertificateItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="d55ed-107">Initializes a new instance of the CertificateItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Attributes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-108">Ruft ab oder legt das Zertifikat Management Attribute.</span><span class="sxs-lookup"><span data-stu-id="d55ed-108">Gets or sets the certificate management attributes.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-109">Ruft ab, oder legt ihn fest Zertifikatsbezeichner.</span><span class="sxs-lookup"><span data-stu-id="d55ed-109">Gets or sets certificate identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Identifier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-110">Der Bezeichner des Zertifikats</span><span class="sxs-lookup"><span data-stu-id="d55ed-110">The certificate identifier</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-111">Ruft ab oder legt Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="d55ed-111">Gets or sets application specific metadata in the form of key-value pairs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="X509Thumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d55ed-112">Abrufen oder Festlegen der Fingerabdruck des Zertifikats.</span><span class="sxs-lookup"><span data-stu-id="d55ed-112">Gets or sets thumbprint of the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
