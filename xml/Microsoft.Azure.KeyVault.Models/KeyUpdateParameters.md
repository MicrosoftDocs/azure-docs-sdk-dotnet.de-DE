<Type Name="KeyUpdateParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aecf0-101">Die Parameter Schlüssel aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="aecf0-101">The key update parameters.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aecf0-102">Initialisiert eine neue Instanz der KeyUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="aecf0-102">Initializes a new instance of the KeyUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyOps"><span data-ttu-id="aecf0-103">JSON Web Key-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="aecf0-103">Json web key operations.</span></span> <span data-ttu-id="aecf0-104">Weitere Informationen zu möglichen Schlüsselvorgänge finden Sie unter JsonWebKeyOperation.</span><span class="sxs-lookup"><span data-stu-id="aecf0-104">For more information on possible key operations, see JsonWebKeyOperation.</span></span></param>
        <param name="keyAttributes">To be added.</param>
        <param name="tags"><span data-ttu-id="aecf0-105">Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="aecf0-105">Application specific metadata in the form of key-value pairs.</span></span></param>
        <summary>
            <span data-ttu-id="aecf0-106">Initialisiert eine neue Instanz der KeyUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="aecf0-106">Initializes a new instance of the KeyUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="KeyOps">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aecf0-107">Ruft ab oder legt Json Web Key-Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="aecf0-107">Gets or sets json web key operations.</span></span> <span data-ttu-id="aecf0-108">Weitere Informationen zu möglichen Schlüsselvorgänge finden Sie unter JsonWebKeyOperation.</span><span class="sxs-lookup"><span data-stu-id="aecf0-108">For more information on possible key operations, see JsonWebKeyOperation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aecf0-109">Ruft ab oder legt Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="aecf0-109">Gets or sets application specific metadata in the form of key-value pairs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
