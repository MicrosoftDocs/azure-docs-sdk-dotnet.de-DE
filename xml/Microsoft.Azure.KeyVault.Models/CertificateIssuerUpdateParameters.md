<Type Name="CertificateIssuerUpdateParameters" FullName="Microsoft.Azure.KeyVault.Models.CertificateIssuerUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="240a2-101">Der Aussteller des Zertifikats Aktualisieren von Parametern.</span><span class="sxs-lookup"><span data-stu-id="240a2-101">The certificate issuer update parameters.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="240a2-102">Initialisiert eine neue Instanz der CertificateIssuerUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="240a2-102">Initializes a new instance of the CertificateIssuerUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider"><span data-ttu-id="240a2-103">Der Aussteller-Anbieter.</span><span class="sxs-lookup"><span data-stu-id="240a2-103">The issuer provider.</span></span></param>
        <param name="credentials"><span data-ttu-id="240a2-104">Die Anmeldeinformationen für den Aussteller verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="240a2-104">The credentials to be used for the issuer.</span></span></param>
        <param name="organizationDetails"><span data-ttu-id="240a2-105">Details der Organisation wie an den Aussteller angegeben.</span><span class="sxs-lookup"><span data-stu-id="240a2-105">Details of the organization as provided to the issuer.</span></span></param>
        <param name="attributes"><span data-ttu-id="240a2-106">Attribute des Ausstellers-Objekts.</span><span class="sxs-lookup"><span data-stu-id="240a2-106">Attributes of the issuer object.</span></span></param>
        <summary>
            <span data-ttu-id="240a2-107">Initialisiert eine neue Instanz der CertificateIssuerUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="240a2-107">Initializes a new instance of the CertificateIssuerUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Attributes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="240a2-108">Abrufen oder Festlegen der Attribute des Ausstellers-Objekts.</span><span class="sxs-lookup"><span data-stu-id="240a2-108">Gets or sets attributes of the issuer object.</span></span>
            </summary>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="240a2-109">Ruft ab oder legt die Anmeldeinformationen für den Aussteller zu verwendende fest.</span><span class="sxs-lookup"><span data-stu-id="240a2-109">Gets or sets the credentials to be used for the issuer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OrganizationDetails">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="240a2-110">Ermittelt oder definiert die Details der Organisation wie an den Aussteller angegeben.</span><span class="sxs-lookup"><span data-stu-id="240a2-110">Gets or sets details of the organization as provided to the issuer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="240a2-111">Abrufen oder Festlegen des Ausstellers-Anbieters.</span><span class="sxs-lookup"><span data-stu-id="240a2-111">Gets or sets the issuer provider.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
