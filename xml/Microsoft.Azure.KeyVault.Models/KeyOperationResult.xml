<Type Name="KeyOperationResult" FullName="Microsoft.Azure.KeyVault.Models.KeyOperationResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46a3a-101">Das Ergebnis Schlüsselvorgang.</span><span class="sxs-lookup"><span data-stu-id="46a3a-101">The key operation result.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46a3a-102">Initialisiert eine neue Instanz der KeyOperationResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="46a3a-102">Initializes a new instance of the KeyOperationResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="46a3a-103">Schlüssel-ID</span><span class="sxs-lookup"><span data-stu-id="46a3a-103">Key identifier</span></span></param>
        <param name="result">To be added.</param>
        <summary>
            <span data-ttu-id="46a3a-104">Initialisiert eine neue Instanz der KeyOperationResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="46a3a-104">Initializes a new instance of the KeyOperationResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46a3a-105">Ruft den Schlüsselbezeichner ab</span><span class="sxs-lookup"><span data-stu-id="46a3a-105">Gets key identifier</span></span>
            </summary>
