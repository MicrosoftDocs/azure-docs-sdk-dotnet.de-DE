<Type Name="KeyItem" FullName="Microsoft.Azure.KeyVault.Models.KeyItem">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8222a-101">Das Key-Element, die Metadaten enthält.</span><span class="sxs-lookup"><span data-stu-id="8222a-101">The key item containing key metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-102">Initialisiert eine neue Instanz der KeyItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8222a-102">Initializes a new instance of the KeyItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="8222a-103">Der Schlüsselbezeichner.</span><span class="sxs-lookup"><span data-stu-id="8222a-103">Key identifier.</span></span></param>
        <param name="attributes"><span data-ttu-id="8222a-104">Die schlüsselverwaltung-Attribute.</span><span class="sxs-lookup"><span data-stu-id="8222a-104">The key management attributes.</span></span></param>
        <param name="tags"><span data-ttu-id="8222a-105">Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="8222a-105">Application specific metadata in the form of key-value pairs.</span></span></param>
        <param name="managed"><span data-ttu-id="8222a-106">"True", wenn der Schlüssel Lebensdauer von schlüsseltresor verwaltet wird.</span><span class="sxs-lookup"><span data-stu-id="8222a-106">True if the key's lifetime is managed by key vault.</span></span> <span data-ttu-id="8222a-107">Ist dies ein Schlüssel sichern wird ein Zertifikat, klicken Sie dann verwalteten "true" sein.</span><span class="sxs-lookup"><span data-stu-id="8222a-107">If this is a key backing a certificate, then managed will be true.</span></span></param>
        <summary>
            <span data-ttu-id="8222a-108">Initialisiert eine neue Instanz der KeyItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="8222a-108">Initializes a new instance of the KeyItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Attributes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-109">Ruft ab oder legt die Attribute für die schlüsselverwaltung.</span><span class="sxs-lookup"><span data-stu-id="8222a-109">Gets or sets the key management attributes.</span></span>
            </summary>
    ...
    <Member MemberName="Identifier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-110">Bezeichner für das Schlüsselobjekt</span><span class="sxs-lookup"><span data-stu-id="8222a-110">Identifier for the key object</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-111">Ruft ab oder legt den Schlüsselbezeichner.</span><span class="sxs-lookup"><span data-stu-id="8222a-111">Gets or sets key identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Managed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-112">Ruft "true", wenn der Schlüssel Lebensdauer von schlüsseltresor verwaltet wird.</span><span class="sxs-lookup"><span data-stu-id="8222a-112">Gets true if the key's lifetime is managed by key vault.</span></span> <span data-ttu-id="8222a-113">Ist dies ein Schlüssel sichern wird ein Zertifikat, klicken Sie dann verwalteten "true" sein.</span><span class="sxs-lookup"><span data-stu-id="8222a-113">If this is a key backing a certificate, then managed will be true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8222a-114">Ruft ab oder legt Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="8222a-114">Gets or sets application specific metadata in the form of key-value pairs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
