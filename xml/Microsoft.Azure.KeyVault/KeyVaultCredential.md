<Type Name="KeyVaultCredential" FullName="Microsoft.Azure.KeyVault.KeyVaultCredential">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c38cb-101">Die Key Vault-Credential-Klasse, die implementiert<see cref="T:Microsoft.Rest.ServiceClientCredentials" /></span><span class="sxs-lookup"><span data-stu-id="c38cb-101">The Key Vault credential class that implements <see cref="T:Microsoft.Rest.ServiceClientCredentials" /></span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="authenticationCallback"> <span data-ttu-id="c38cb-102">der authentifizierungsrückruf.</span><span class="sxs-lookup"><span data-stu-id="c38cb-102">the authentication callback.</span></span> </param>
        <summary>
            <span data-ttu-id="c38cb-103">Konstruktor.</span><span class="sxs-lookup"><span data-stu-id="c38cb-103">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnAuthenticate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c38cb-104">Der authentifizierungsrückruf</span><span class="sxs-lookup"><span data-stu-id="c38cb-104">The authentication callback</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Token">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c38cb-105">Bearer-token</span><span class="sxs-lookup"><span data-stu-id="c38cb-105">Bearer token</span></span>
            </summary>
