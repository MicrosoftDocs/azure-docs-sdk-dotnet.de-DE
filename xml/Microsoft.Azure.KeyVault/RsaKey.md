<Type Name="RsaKey" FullName="Microsoft.Azure.KeyVault.RsaKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bee4e-101">Ein RSA-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="bee4e-101">An RSA key.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bee4e-102">Konstruktor erstellt einen 2048-Bit-Schlüssel mit einem GUID-Bezeichner.</span><span class="sxs-lookup"><span data-stu-id="bee4e-102">Constructor, creates a 2048 bit key with a GUID identifier.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="bee4e-103">Der Schlüsselbezeichner verwenden</span><span class="sxs-lookup"><span data-stu-id="bee4e-103">The key identifier to use</span></span></param>
        <summary>
            <span data-ttu-id="bee4e-104">Konstruktor erstellt einen 2048-Bit-RSA-Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="bee4e-104">Constructor, creates a 2048 bit RSA key.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="bee4e-105">Der Schlüsselbezeichner verwenden</span><span class="sxs-lookup"><span data-stu-id="bee4e-105">The key identifier to use</span></span></param>
        <param name="keySize"><span data-ttu-id="bee4e-106">Die Größe des Schlüssels</span><span class="sxs-lookup"><span data-stu-id="bee4e-106">The size of the key</span></span></param>
        <summary>
            <span data-ttu-id="bee4e-107">Konstruktor.</span><span class="sxs-lookup"><span data-stu-id="bee4e-107">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="bee4e-108">Der Schlüsselbezeichner verwenden</span><span class="sxs-lookup"><span data-stu-id="bee4e-108">The key identifier to use</span></span></param>
        <param name="csp"><span data-ttu-id="bee4e-109">Die RSA-Objekt für den Schlüssel</span><span class="sxs-lookup"><span data-stu-id="bee4e-109">The RSA object for the key</span></span></param>
        <summary>
            <span data-ttu-id="bee4e-110">Konstruktor.</span><span class="sxs-lookup"><span data-stu-id="bee4e-110">Constructor.</span></span>
            </summary>
        <remarks><span data-ttu-id="bee4e-111">RSA-Objekt ist IDisposable, diese Klasse wird einen Verweis auf den RSA-Objekt enthalten, aber wird nicht freigegeben, der Aufrufer dieses Konstruktors ist verantwortlich für die Lebensdauer dieses Parameters.</span><span class="sxs-lookup"><span data-stu-id="bee4e-111">The RSA object is IDisposable, this class will hold a reference to the RSA object but will not dispose it, the caller of this constructor is responsible for the lifetime of this parameter.</span></span></remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="bee4e-112">Der Schlüsselbezeichner verwenden</span><span class="sxs-lookup"><span data-stu-id="bee4e-112">The key identifier to use</span></span></param>
        <param name="keyParameters"><span data-ttu-id="bee4e-113">Die RSA-Parameter für den Schlüssel</span><span class="sxs-lookup"><span data-stu-id="bee4e-113">The RSA parameters for the key</span></span></param>
        <summary>
            <span data-ttu-id="bee4e-114">Konstruktor</span><span class="sxs-lookup"><span data-stu-id="bee4e-114">Constructor</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bee4e-115">Schlüsselbezeichner</span><span class="sxs-lookup"><span data-stu-id="bee4e-115">Key Identifier</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
