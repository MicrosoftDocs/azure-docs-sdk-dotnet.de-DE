<Type Name="TrafficManagerManagementClient" FullName="Microsoft.Azure.Management.TrafficManager.TrafficManagerManagementClient">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="handlers">
            <span data-ttu-id="5bb43-101">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-101">Optional.</span></span> <span data-ttu-id="5bb43-102">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-102">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-103">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-103">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="credentials">
            <span data-ttu-id="5bb43-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-104">Required.</span></span> <span data-ttu-id="5bb43-105">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-105">Credentials needed for the client to connect to Azure.</span></span>
            </param>
        <param name="handlers">
        ...
        <summary>
            <span data-ttu-id="5bb43-108">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-108">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-109">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-109">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="rootHandler">
            <span data-ttu-id="5bb43-110">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-110">Optional.</span></span> <span data-ttu-id="5bb43-111">Der Client HTTP-Handler zum Verarbeiten von HTTP-Transport verwendet.</span><span class="sxs-lookup"><span data-stu-id="5bb43-111">The http client handler used to handle http transport.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-112">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-112">Optional.</span></span> <span data-ttu-id="5bb43-113">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-113">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-114">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-114">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUri">
            <span data-ttu-id="5bb43-115">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-115">Optional.</span></span> <span data-ttu-id="5bb43-116">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="5bb43-116">The base URI of the service.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-117">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-117">Optional.</span></span> <span data-ttu-id="5bb43-118">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-118">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-119">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-119">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-120">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-120">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="credentials">
            <span data-ttu-id="5bb43-121">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-121">Required.</span></span> <span data-ttu-id="5bb43-122">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-122">Credentials needed for the client to connect to Azure.</span></span>
            </param>
        <param name="rootHandler">
            <span data-ttu-id="5bb43-123">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-123">Optional.</span></span> <span data-ttu-id="5bb43-124">Der Client HTTP-Handler zum Verarbeiten von HTTP-Transport verwendet.</span><span class="sxs-lookup"><span data-stu-id="5bb43-124">The http client handler used to handle http transport.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-125">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-125">Optional.</span></span> <span data-ttu-id="5bb43-126">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-126">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-127">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-127">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-128">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-128">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUri">
            <span data-ttu-id="5bb43-129">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-129">Optional.</span></span> <span data-ttu-id="5bb43-130">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="5bb43-130">The base URI of the service.</span></span>
            </param>
        <param name="credentials">
            <span data-ttu-id="5bb43-131">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-131">Required.</span></span> <span data-ttu-id="5bb43-132">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-132">Credentials needed for the client to connect to Azure.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-133">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-133">Optional.</span></span> <span data-ttu-id="5bb43-134">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-134">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-135">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-135">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-136">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-136">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUri">
            <span data-ttu-id="5bb43-137">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-137">Optional.</span></span> <span data-ttu-id="5bb43-138">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="5bb43-138">The base URI of the service.</span></span>
            </param>
        <param name="rootHandler">
            <span data-ttu-id="5bb43-139">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-139">Optional.</span></span> <span data-ttu-id="5bb43-140">Der Client HTTP-Handler zum Verarbeiten von HTTP-Transport verwendet.</span><span class="sxs-lookup"><span data-stu-id="5bb43-140">The http client handler used to handle http transport.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-141">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-141">Optional.</span></span> <span data-ttu-id="5bb43-142">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-142">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-143">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-143">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-144">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-144">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUri">
            <span data-ttu-id="5bb43-145">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-145">Optional.</span></span> <span data-ttu-id="5bb43-146">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="5bb43-146">The base URI of the service.</span></span>
            </param>
        <param name="credentials">
            <span data-ttu-id="5bb43-147">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-147">Required.</span></span> <span data-ttu-id="5bb43-148">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-148">Credentials needed for the client to connect to Azure.</span></span>
            </param>
        <param name="rootHandler">
            <span data-ttu-id="5bb43-149">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-149">Optional.</span></span> <span data-ttu-id="5bb43-150">Der Client HTTP-Handler zum Verarbeiten von HTTP-Transport verwendet.</span><span class="sxs-lookup"><span data-stu-id="5bb43-150">The http client handler used to handle http transport.</span></span>
            </param>
        <param name="handlers">
            <span data-ttu-id="5bb43-151">Optional.</span><span class="sxs-lookup"><span data-stu-id="5bb43-151">Optional.</span></span> <span data-ttu-id="5bb43-152">Die delegierenden Handler der HTTP-Client-Pipeline hinzu.</span><span class="sxs-lookup"><span data-stu-id="5bb43-152">The delegating handlers to add to the http client pipeline.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5bb43-153">Initialisiert eine neue Instanz der TrafficManagerManagementClient-Klasse.</span><span class="sxs-lookup"><span data-stu-id="5bb43-153">Initializes a new instance of the TrafficManagerManagementClient class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">
            <span data-ttu-id="5bb43-154">Wird ausgelöst, wenn ein erforderlicher Parameter null ist.</span><span class="sxs-lookup"><span data-stu-id="5bb43-154">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="AcceptLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-155">Ruft ab oder legt die bevorzugte Sprache für die Antwort.</span><span class="sxs-lookup"><span data-stu-id="5bb43-155">Gets or sets the preferred language for the response.</span></span>
            </summary>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-156">Client-API-Version.</span><span class="sxs-lookup"><span data-stu-id="5bb43-156">Client Api Version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-157">Die Basis-URI des Diensts.</span><span class="sxs-lookup"><span data-stu-id="5bb43-157">The base URI of the service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-158">Anmeldeinformationen für den Client zum Verbinden mit Azure erforderlich.</span><span class="sxs-lookup"><span data-stu-id="5bb43-158">Credentials needed for the client to connect to Azure.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeserializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-159">Ermittelt oder Json-Deserialisierung Einstellungen definiert.</span><span class="sxs-lookup"><span data-stu-id="5bb43-159">Gets or sets json deserialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoints">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-160">Ruft die IEndpointsOperations ab.</span><span class="sxs-lookup"><span data-stu-id="5bb43-160">Gets the IEndpointsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GenerateClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-161">Bei Festlegung werden auf einen eindeutigen X-ms-Client-Request-Id-Wert "true" generiert und in jeder Anforderung enthalten.</span><span class="sxs-lookup"><span data-stu-id="5bb43-161">When set to true a unique x-ms-client-request-id value is generated and included in each request.</span></span> <span data-ttu-id="5bb43-162">Der Standardwert ist true.</span><span class="sxs-lookup"><span data-stu-id="5bb43-162">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GeographicHierarchies">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-163">Ruft die IGeographicHierarchiesOperations ab.</span><span class="sxs-lookup"><span data-stu-id="5bb43-163">Gets the IGeographicHierarchiesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-164">Ruft ab oder legt das wiederholungstimeout in Sekunden für zeitintensive Vorgänge.</span><span class="sxs-lookup"><span data-stu-id="5bb43-164">Gets or sets the retry timeout in seconds for Long Running Operations.</span></span>
            <span data-ttu-id="5bb43-165">Standardwert ist 30.</span><span class="sxs-lookup"><span data-stu-id="5bb43-165">Default value is 30.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Profiles">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-166">Ruft die IProfilesOperations ab.</span><span class="sxs-lookup"><span data-stu-id="5bb43-166">Gets the IProfilesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SerializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-167">Ermittelt oder Json-Serialisierungseinstellungen definiert.</span><span class="sxs-lookup"><span data-stu-id="5bb43-167">Gets or sets json serialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5bb43-168">Ruft die abonnementanmeldeinformationen ab Microsoft Azure-Abonnement eindeutig identifiziert.</span><span class="sxs-lookup"><span data-stu-id="5bb43-168">Gets subscription credentials which uniquely identify Microsoft Azure subscription.</span></span> <span data-ttu-id="5bb43-169">Die Abonnement-ID ist Teil der URI für jeden Dienstaufruf.</span><span class="sxs-lookup"><span data-stu-id="5bb43-169">The subscription ID forms part of the URI for every service call.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
