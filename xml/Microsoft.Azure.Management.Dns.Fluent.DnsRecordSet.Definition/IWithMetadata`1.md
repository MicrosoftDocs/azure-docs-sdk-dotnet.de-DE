<Type Name="IWithMetadata&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithMetadata&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="d5dc3-101">Der Rückgabetyp der UpdateDefinitionStages.WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="d5dc3-101">The return type of  UpdateDefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="d5dc3-102">Die Phase des Datensatzes festgelegt Definition zu ermöglichen, Metadaten angeben.</span><span class="sxs-lookup"><span data-stu-id="d5dc3-102">The stage of the record set definition allowing to specify metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithMetadata">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="d5dc3-103">Der Schlüssel für die Metadaten.</span><span class="sxs-lookup"><span data-stu-id="d5dc3-103">The key for the metadata.</span></span></param>
        <param name="value"><span data-ttu-id="d5dc3-104">Der Wert für die Metadaten.</span><span class="sxs-lookup"><span data-stu-id="d5dc3-104">The value for the metadata.</span></span></param>
        <summary>
            <span data-ttu-id="d5dc3-105">Fügt Metadaten für die Ressource an.</span><span class="sxs-lookup"><span data-stu-id="d5dc3-105">Adds a metadata to the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d5dc3-106">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="d5dc3-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>