<Type Name="IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="9ca54-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="9ca54-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="9ca54-102">Die Phase der AAAA-Eintrag festgelegt Definition ermöglicht zusätzliche AAAA-Datensätze hinzufügen, oder fügen Sie dem übergeordneten Datensatz.</span><span class="sxs-lookup"><span data-stu-id="9ca54-102">The stage of the AAAA record set definition allowing to add additional AAAA records or attach the record set to the parent.</span></span>
            </summary>
