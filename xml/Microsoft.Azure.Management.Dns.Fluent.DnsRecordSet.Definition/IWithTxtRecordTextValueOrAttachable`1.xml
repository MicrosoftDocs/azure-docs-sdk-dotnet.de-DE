<Type Name="IWithTxtRecordTextValueOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithTxtRecordTextValueOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="5c0b5-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="5c0b5-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="5c0b5-102">Die Phase der TXT-Eintrag festgelegt Definition ermöglicht zusätzliche TXT-Einträge hinzufügen oder Anfügen an den übergeordneten Datensatz.</span><span class="sxs-lookup"><span data-stu-id="5c0b5-102">The stage of the TXT record set definition allowing to add additional TXT records or attach the record set to the parent.</span></span>
            </summary>
