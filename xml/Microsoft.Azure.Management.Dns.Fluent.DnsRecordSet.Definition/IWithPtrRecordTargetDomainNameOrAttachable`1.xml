<Type Name="IWithPtrRecordTargetDomainNameOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithPtrRecordTargetDomainNameOrAttachable&lt;ParentT&gt;">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithPtrRecordTargetDomainNameOrAttachable`1" />
  <TypeSignature Language="VB.NET" Value="Public Interface IWithPtrRecordTargetDomainNameOrAttachable(Of ParentT)&#xA;Implements IInDefinition(Of ParentT), IWithAttach(Of ParentT), IWithETagCheck(Of ParentT), IWithMetadata(Of ParentT), IWithPtrRecordTargetDomainName(Of ParentT), IWithTtl(Of ParentT)" />
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="50dcc-101">Der Rückgabetyp der WithAttach.attach().</span><span class="sxs-lookup"><span data-stu-id="50dcc-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="50dcc-102">Die Phase der PTR-Eintrag festgelegt Definition ermöglicht zusätzliche PTR-Einträge hinzufügen, oder fügen Sie dem übergeordneten Datensatz.</span><span class="sxs-lookup"><span data-stu-id="50dcc-102">The stage of the PTR record set definition allowing to add additional PTR records or attach the record set to the parent.</span></span>
            </summary>
