<Type Name="ITransportSettings" FullName="Microsoft.Azure.Devices.Client.ITransportSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="66c1a-101">Schnittstelle verwendet, um verschiedene transportspezifischen einstellungslogik für DeviceClient definieren</span><span class="sxs-lookup"><span data-stu-id="66c1a-101">Interface used to define various transport-specific settings for DeviceClient</span></span>
            </summary>
