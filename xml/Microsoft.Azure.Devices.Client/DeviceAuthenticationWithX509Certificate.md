<Type Name="DeviceAuthenticationWithX509Certificate" FullName="Microsoft.Azure.Devices.Client.DeviceAuthenticationWithX509Certificate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2824b-101">Authentifizierungsmethode, die ein x. 509-Zertifikat verwendet.</span><span class="sxs-lookup"><span data-stu-id="2824b-101">Authentication method that uses a X.509 certificate</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="deviceId"><span data-ttu-id="2824b-102">Gerätebezeichner.</span><span class="sxs-lookup"><span data-stu-id="2824b-102">Device Identifier.</span></span></param>
        <param name="certificate"><span data-ttu-id="2824b-103">X. 509-Zertifikat.</span><span class="sxs-lookup"><span data-stu-id="2824b-103">X.509 Certificate.</span></span></param>
        <summary>
            <span data-ttu-id="2824b-104">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Devices.Client.DeviceAuthenticationWithX509Certificate" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="2824b-104">Initializes a new instance of the <see cref="T:Microsoft.Azure.Devices.Client.DeviceAuthenticationWithX509Certificate" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Certificate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2824b-105">Ruft ab oder legt dieses Gerät zugeordnete x. 509-Zertifikat</span><span class="sxs-lookup"><span data-stu-id="2824b-105">Gets or sets the X.509 certificate associated with this device</span></span>
            </summary>
    ...
    <Member MemberName="DeviceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2824b-106">Ruft ab, oder legt Sie die Geräte-ID fest.</span><span class="sxs-lookup"><span data-stu-id="2824b-106">Gets or sets the device identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Populate">
      ...
      <Docs>
        <param name="iotHubConnectionStringBuilder"><span data-ttu-id="2824b-107">Die Instanz zum Auffüllen.</span><span class="sxs-lookup"><span data-stu-id="2824b-107">Instance to populate.</span></span></param>
        <summary>
            <span data-ttu-id="2824b-108">Füllt ein <see cref="T:Microsoft.Azure.Devices.Client.IotHubConnectionStringBuilder" /> -Instanz auf Grundlage der Eigenschaften der aktuellen Instanz.</span><span class="sxs-lookup"><span data-stu-id="2824b-108">Populates an <see cref="T:Microsoft.Azure.Devices.Client.IotHubConnectionStringBuilder" /> instance based on the properties of the current instance.</span></span>
            </summary>
        <returns><span data-ttu-id="2824b-109">Die aufgefüllte <see cref="T:Microsoft.Azure.Devices.Client.IotHubConnectionStringBuilder" /> Instanz.</span><span class="sxs-lookup"><span data-stu-id="2824b-109">The populated <see cref="T:Microsoft.Azure.Devices.Client.IotHubConnectionStringBuilder" /> instance.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
