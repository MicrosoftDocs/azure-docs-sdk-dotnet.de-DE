<Type Name="ReadOnlyDictionary45&lt;TKey,TValue&gt;" FullName="Microsoft.Azure.Devices.Client.ReadOnlyDictionary45&lt;TKey,TValue&gt;">
  ...
  <Docs>
    <typeparam name="TKey"><span data-ttu-id="3e3d2-101">Geben Sie ein Schlüssel verwendet werden soll.</span><span class="sxs-lookup"><span data-stu-id="3e3d2-101">Type to be used for keys.</span></span></typeparam>
    <typeparam name="TValue"><span data-ttu-id="3e3d2-102">Für Werte verwendet werden soll</span><span class="sxs-lookup"><span data-stu-id="3e3d2-102">Type to be used for values</span></span></typeparam>
    <summary>
            <span data-ttu-id="3e3d2-103">Nur-Lese Wrapper für eine andere generisches Wörterbuch.</span><span class="sxs-lookup"><span data-stu-id="3e3d2-103">Read-only wrapper for another generic dictionary.</span></span>
            </summary>
