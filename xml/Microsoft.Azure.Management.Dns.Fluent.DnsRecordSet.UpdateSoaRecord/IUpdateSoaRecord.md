<Type Name="IUpdateSoaRecord" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateSoaRecord.IUpdateSoaRecord">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ba89f-101">Ein SOA vollständig aufzeichnen Update als Teil der übergeordneten DNS-Zone aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="ba89f-101">The entirety of a SOA record update as a part of parent DNS zone update.</span></span>
            </summary>
