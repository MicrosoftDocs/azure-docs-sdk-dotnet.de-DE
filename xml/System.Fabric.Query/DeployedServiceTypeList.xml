<Type Name="DeployedServiceTypeList" FullName="System.Fabric.Query.DeployedServiceTypeList">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="5f984-101">Stellt eine Liste von <see cref="T:System.Fabric.Query.DeployedServiceType" />.</span><span class="sxs-lookup"><span data-stu-id="5f984-101">Represents a list of <see cref="T:System.Fabric.Query.DeployedServiceType" />.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="5f984-102">Das Element, das hinzugefügt werden soll.</span><span class="sxs-lookup"><span data-stu-id="5f984-102">The item to add.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-103">Fügt das angegebene Element der Liste hinzu.</span><span class="sxs-lookup"><span data-stu-id="5f984-103">Adds the specified item to the list.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="5f984-104">Entfernt alle Elemente aus der Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-104">Removes all items from the list.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="5f984-105">Das Element zu suchen.</span><span class="sxs-lookup"><span data-stu-id="5f984-105">The item to search.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-106">Gibt ein Flag, das angibt, ob die Liste ein bestimmtes Element enthält.</span><span class="sxs-lookup"><span data-stu-id="5f984-106">Indicates a flag that specifies whether the list contains a specific item.</span></span></para>
        </summary>
        <returns>
          <para>
            <span data-ttu-id="5f984-107"><languageKeyword>"true"</languageKeyword> , wenn die Liste einen bestimmten, andernfalls enthält <languageKeyword>"false"</languageKeyword>.</span><span class="sxs-lookup"><span data-stu-id="5f984-107"><languageKeyword>true</languageKeyword> if the list contains a specific item; otherwise, <languageKeyword>false</languageKeyword>.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">
          <para><span data-ttu-id="5f984-108">Das Array.</span><span class="sxs-lookup"><span data-stu-id="5f984-108">The array.</span></span></para>
        </param>
        <param name="arrayIndex">
          <para><span data-ttu-id="5f984-109">Der Startindex des Arrays.</span><span class="sxs-lookup"><span data-stu-id="5f984-109">The starting index of the array.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-110">Kopiert die Elemente aus der Liste in das angegebene Array am angegebenen Index ab.</span><span class="sxs-lookup"><span data-stu-id="5f984-110">Copies items from the list to the specified array at the specified starting index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="5f984-111">Ruft ab oder legt die Anzahl der Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-111">Gets or sets the number of items in this list.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="5f984-112">Die Anzahl der Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-112">The number of items in this list.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="5f984-113">Ruft einen Enumerator für Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-113">Gets an enumerator to items in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="5f984-114">Der Enumerator Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-114">The enumerator to items in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="5f984-115">Das Element in der Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-115">The item in the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-116">Ruft den Index des angegebenen Elements in dieser Liste ab.</span><span class="sxs-lookup"><span data-stu-id="5f984-116">Gets the index of the specified item in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="5f984-117">Der Index des angegebenen Elements in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-117">The index of the specified item in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="5f984-118">Der Index, in dem das Element eingefügt wird.</span><span class="sxs-lookup"><span data-stu-id="5f984-118">The index where the item will be inserted.</span></span></para>
        </param>
        <param name="item">
          <para><span data-ttu-id="5f984-119">Das einzufügende Element.</span><span class="sxs-lookup"><span data-stu-id="5f984-119">The item to insert.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-120">Fügt das Element am angegebenen Index.</span><span class="sxs-lookup"><span data-stu-id="5f984-120">Inserts the item at the specified index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="5f984-121">Ruft ab oder legt ein Flag, das angibt, ob die Liste geändert werden kann.</span><span class="sxs-lookup"><span data-stu-id="5f984-121">Gets or sets a flag that indicates whether the list can be modified.</span></span></para>
        </summary>
        <value>
          <para>
            <span data-ttu-id="5f984-122"><languageKeyword>"true"</languageKeyword> , wenn die Liste geändert, andernfalls werden kann <languageKeyword>"false"</languageKeyword>.</span><span class="sxs-lookup"><span data-stu-id="5f984-122"><languageKeyword>true</languageKeyword> if the list can be modified; otherwise, <languageKeyword>false</languageKeyword>.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="5f984-123">Der Index des Elements.</span><span class="sxs-lookup"><span data-stu-id="5f984-123">The index of the item.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-124">Ruft das Element am angegebenen Index ab.</span><span class="sxs-lookup"><span data-stu-id="5f984-124">Gets the item at the specified index.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="5f984-125">Das Element am angegebenen Index.</span><span class="sxs-lookup"><span data-stu-id="5f984-125">The item at the specified index.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="5f984-126">Das zu entfernende Element.</span><span class="sxs-lookup"><span data-stu-id="5f984-126">The item to remove.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-127">Entfernen Sie das angegebene Element aus dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-127">Remove the specified item from this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="5f984-128">Die Liste mit dem entfernten Element.</span><span class="sxs-lookup"><span data-stu-id="5f984-128">The list with removed item.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="5f984-129">Der Index des zu entfernenden Elements.</span><span class="sxs-lookup"><span data-stu-id="5f984-129">The index of the item to remove.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="5f984-130">Entfernt das Element am angegebenen Index.</span><span class="sxs-lookup"><span data-stu-id="5f984-130">Removes the item at the specified index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="5f984-131">Ruft einen Enumerator für Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-131">Gets an enumerator for items in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="5f984-132">Der Enumerator für Elemente in dieser Liste.</span><span class="sxs-lookup"><span data-stu-id="5f984-132">The enumerator for items in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
