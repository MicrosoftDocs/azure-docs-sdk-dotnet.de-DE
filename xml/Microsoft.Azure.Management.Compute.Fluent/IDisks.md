<Type Name="IDisks" FullName="Microsoft.Azure.Management.Compute.Fluent.IDisks">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0b8aa-101">Der Einstiegspunkt für verwaltete Datenträger-API in Azure.</span><span class="sxs-lookup"><span data-stu-id="0b8aa-101">Entry point to managed disk management API in Azure.</span></span>
            </summary>
