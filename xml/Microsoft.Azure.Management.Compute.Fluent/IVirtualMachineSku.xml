<Type Name="IVirtualMachineSku" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineSku">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="69890-101">Stellt ein Image eines virtuellen Computers SKU dar.</span><span class="sxs-lookup"><span data-stu-id="69890-101">Represents a virtual machine image SKU.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Images">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="69890-102">Ruft die Images virtueller Computer in der SKU ab.</span><span class="sxs-lookup"><span data-stu-id="69890-102">Gets virtual machine images in the SKU.</span></span>
            </summary>
    ...
    <Member MemberName="Offer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="69890-103">Ruft den Namen des virtuellen Computers-Angebot an, zu dem diese SKU gehört.</span><span class="sxs-lookup"><span data-stu-id="69890-103">Gets the virtual machine offer name that this SKU belongs to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Publisher">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="69890-104">Ruft den Herausgeber der dieses VM-Image-Angebot SKU ab.</span><span class="sxs-lookup"><span data-stu-id="69890-104">Gets the publisher of this virtual machine image offer SKU.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="69890-105">Ruft die Region, in dem diese VM-Image Verwaltungsprodukt SKU verfügbar ist.</span><span class="sxs-lookup"><span data-stu-id="69890-105">Gets the region where this virtual machine image offer SKU is available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
