<Type Name="IAvailabilitySets" FullName="Microsoft.Azure.Management.Compute.Fluent.IAvailabilitySets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="313fe-101">Der Einstiegspunkt für Availability-Set-Verwaltungs-API.</span><span class="sxs-lookup"><span data-stu-id="313fe-101">Entry point to availability set management API.</span></span>
            </summary>
