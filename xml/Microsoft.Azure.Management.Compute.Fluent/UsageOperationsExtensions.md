<Type Name="UsageOperationsExtensions" FullName="Microsoft.Azure.Management.Compute.Fluent.UsageOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ad216-101">Erweiterungsmethoden für UsageOperations.</span><span class="sxs-lookup"><span data-stu-id="ad216-101">Extension methods for UsageOperations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="ad216-102">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="ad216-102">The operations group for this extension method.</span></span>
            </param>
        <param name="location">
            <span data-ttu-id="ad216-103">Der Speicherort, für welche, den Ressource Nutzung abgefragt wird.</span><span class="sxs-lookup"><span data-stu-id="ad216-103">The location for which resource usage is queried.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="ad216-104">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="ad216-104">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="ad216-105">Ruft ab, für den angegebenen Speicherort, der aktuelle Nutzungsinformationen der Compute-Ressource sowie die Grenzwerte für die Serverressourcen unter dem Abonnement ein.</span><span class="sxs-lookup"><span data-stu-id="ad216-105">Gets, for the specified location, the current compute resource usage information as well as the limits for compute resources under the subscription.</span></span>
            </summary>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="ad216-106">Die Operations-Gruppe für diese Erweiterungsmethode.</span><span class="sxs-lookup"><span data-stu-id="ad216-106">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="ad216-107">Die "NextLink" aus dem vorherigen erfolgreichen Aufruf List-Vorgangs.</span><span class="sxs-lookup"><span data-stu-id="ad216-107">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="ad216-108">Das Abbruchtoken.</span><span class="sxs-lookup"><span data-stu-id="ad216-108">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="ad216-109">Ruft ab, für den angegebenen Speicherort, der aktuelle Nutzungsinformationen der Compute-Ressource sowie die Grenzwerte für die Serverressourcen unter dem Abonnement ein.</span><span class="sxs-lookup"><span data-stu-id="ad216-109">Gets, for the specified location, the current compute resource usage information as well as the limits for compute resources under the subscription.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
