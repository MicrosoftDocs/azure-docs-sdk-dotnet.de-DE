<Type Name="SettingsParameterDescription" FullName="Microsoft.Azure.Management.ServiceFabric.Models.SettingsParameterDescription">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bc507-101">ServiceFabric Einstellungen in den Abschnitten</span><span class="sxs-lookup"><span data-stu-id="bc507-101">ServiceFabric settings under sections</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bc507-102">Initialisiert eine neue Instanz der SettingsParameterDescription-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bc507-102">Initializes a new instance of the SettingsParameterDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="bc507-103">Der Name der Eigenschaft</span><span class="sxs-lookup"><span data-stu-id="bc507-103">The name of settings property</span></span></param>
        <param name="value"><span data-ttu-id="bc507-104">Der Wert der Eigenschaft.</span><span class="sxs-lookup"><span data-stu-id="bc507-104">The value of the property</span></span></param>
        <summary>
            <span data-ttu-id="bc507-105">Initialisiert eine neue Instanz der SettingsParameterDescription-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bc507-105">Initializes a new instance of the SettingsParameterDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bc507-106">Ruft ab oder legt den Namen der Einstellungseigenschaft</span><span class="sxs-lookup"><span data-stu-id="bc507-106">Gets or sets the name of settings property</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bc507-107">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="bc507-107">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="bc507-108">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="bc507-108">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bc507-109">Ruft ab oder legt den Wert der Eigenschaft</span><span class="sxs-lookup"><span data-stu-id="bc507-109">Gets or sets the value of the property</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
