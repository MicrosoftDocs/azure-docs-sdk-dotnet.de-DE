<Type Name="NotifyTransactionChangedEventArgs" FullName="Microsoft.ServiceFabric.Data.Notifications.NotifyTransactionChangedEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fe492-101">Die Ereignisargumente für Transaktionen.</span><span class="sxs-lookup"><span data-stu-id="fe492-101">Event arguments for transactions.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="transaction"><span data-ttu-id="fe492-102">Eine Transaktion, die die Änderung verknüpft ist.</span><span class="sxs-lookup"><span data-stu-id="fe492-102">Transaction that the change is related to.</span></span></param>
        <param name="action"><span data-ttu-id="fe492-103">Der Typ der Benachrichtigung.</span><span class="sxs-lookup"><span data-stu-id="fe492-103">The type of notification.</span></span></param>
        <summary>
            <span data-ttu-id="fe492-104">Initialisiert eine neue Instanz der dem<cref name="NotifyStateManagerSingleEntityChangedEventArgs" /></span><span class="sxs-lookup"><span data-stu-id="fe492-104">Initializes a new instance of the <cref name="NotifyStateManagerSingleEntityChangedEventArgs" /></span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Action">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe492-105">Typ der Aktion, die für die das Ereignis erstellt wurde.</span><span class="sxs-lookup"><span data-stu-id="fe492-105">Type of action for which the event was created.</span></span>
            </summary>
        <value>
            <span data-ttu-id="fe492-106">Der Typ der Benachrichtigung.</span><span class="sxs-lookup"><span data-stu-id="fe492-106">The type of notification.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Transaction">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe492-107">Ruft die Transaktion ab.</span><span class="sxs-lookup"><span data-stu-id="fe492-107">Gets the transaction.</span></span>
            </summary>
        <value>
            <span data-ttu-id="fe492-108">Die Transaktion, die dem Vorgang zugeordnet wird.</span><span class="sxs-lookup"><span data-stu-id="fe492-108">The transaction associated with the operation.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
