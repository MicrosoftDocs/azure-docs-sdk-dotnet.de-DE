<Type Name="NotifyStateManagerRebuildEventArgs" FullName="Microsoft.ServiceFabric.Data.Notifications.NotifyStateManagerRebuildEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ada78-101">Stellt Daten für das StateManagerChanged-Ereignis, das durch eine Wiederherstellung verursacht.</span><span class="sxs-lookup"><span data-stu-id="ada78-101">Provides data for the StateManagerChanged event caused by a rebuild.</span></span>
            <span data-ttu-id="ada78-102">Im Allgemeinen bezeichnet, während der Wiederherstellung, Wiederherstellung und Ende der Kopie.</span><span class="sxs-lookup"><span data-stu-id="ada78-102">Commonly called during recovery, restore and end of copy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="reliableStates">
          <span data-ttu-id="ada78-103"><cref name="IAsyncEnumerable" />von der ReliableState nach der Neuerstellung.</span><span class="sxs-lookup"><span data-stu-id="ada78-103"><cref name="IAsyncEnumerable" /> of all the ReliableState after the rebuild.</span></span>
            </param>
        <summary>
            <span data-ttu-id="ada78-104">Initialisiert eine neue Instanz der dem<cref name="NotifyStateManagerChangedEventArgs" /></span><span class="sxs-lookup"><span data-stu-id="ada78-104">Initializes a new instance of the <cref name="NotifyStateManagerChangedEventArgs" /></span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReliableStates">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ada78-105">Aufzählbare aller neuen Zustand Anbieter jetzt in den Status-Manager.</span><span class="sxs-lookup"><span data-stu-id="ada78-105">Enumerable of all the new state providers now in the State Manager.</span></span>
            </summary>
        <value>
            <span data-ttu-id="ada78-106">Asynchrone aufzählbare, die die neue Gruppe von enthält <cref name="IReliableState" />s.</span><span class="sxs-lookup"><span data-stu-id="ada78-106">Asynchronous enumerable that contains the new set of <cref name="IReliableState" />s.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
