<Type Name="NotifyDictionaryItemAddedEventArgs&lt;TKey,TValue&gt;" FullName="Microsoft.ServiceFabric.Data.Notifications.NotifyDictionaryItemAddedEventArgs&lt;TKey,TValue&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="TKey"><span data-ttu-id="740e4-101">Der Typ der Schlüssel in der <cref name="IReliableDictionary" />.</span><span class="sxs-lookup"><span data-stu-id="740e4-101">The type of the keys in the <cref name="IReliableDictionary" />.</span></span></typeparam>
    <typeparam name="TValue"><span data-ttu-id="740e4-102">Der Typ der Werte in der <cref name="IReliableDictionary" />.</span><span class="sxs-lookup"><span data-stu-id="740e4-102">The type of the values in the <cref name="IReliableDictionary" />.</span></span></typeparam>
    <summary>
            <span data-ttu-id="740e4-103">Stellt Daten für das DictionaryChanged-Ereignis, das durch die Hinzufügung von Elementen verursacht.</span><span class="sxs-lookup"><span data-stu-id="740e4-103">Provides data for the DictionaryChanged event caused by item addition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="transaction"><span data-ttu-id="740e4-104">Eine Transaktion, die der Vorgang mit verknüpft ist.</span><span class="sxs-lookup"><span data-stu-id="740e4-104">Transaction that the operation is related to.</span></span></param>
        <param name="key"><span data-ttu-id="740e4-105">Schlüssel, der hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="740e4-105">Key that was added.</span></span></param>
        <param name="value"><span data-ttu-id="740e4-106">Wert, der hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="740e4-106">Value that was added.</span></span></param>
        <summary>
            <span data-ttu-id="740e4-107">Initialisiert eine neue Instanz der dem<cref name="NotifyDictionaryItemAddedEventArgs" /></span><span class="sxs-lookup"><span data-stu-id="740e4-107">Initializes a new instance of the <cref name="NotifyDictionaryItemAddedEventArgs" /></span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="740e4-108">Ruft den Schlüssel ab.</span><span class="sxs-lookup"><span data-stu-id="740e4-108">Gets the key.</span></span>
            </summary>
        <value>
            <span data-ttu-id="740e4-109">Der Schlüssel.</span><span class="sxs-lookup"><span data-stu-id="740e4-109">The key.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="740e4-110">Ruft den Wert ab.</span><span class="sxs-lookup"><span data-stu-id="740e4-110">Gets the value.</span></span>
            </summary>
        <value>
            <span data-ttu-id="740e4-111">Der Wert.</span><span class="sxs-lookup"><span data-stu-id="740e4-111">The value.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
