<Type Name="CaptureDescription" FullName="Microsoft.Azure.Management.EventHub.Models.CaptureDescription">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="77b18-101">Eigenschaften zum Konfigurieren der Capture-Beschreibung für den eventhub</span><span class="sxs-lookup"><span data-stu-id="77b18-101">Properties to configure capture description for eventhub</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-102">Initialisiert eine neue Instanz der CaptureDescription-Klasse.</span><span class="sxs-lookup"><span data-stu-id="77b18-102">Initializes a new instance of the CaptureDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="77b18-103">Ein Wert, der angibt, ob die Beschreibung des Capture aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="77b18-103">A value that indicates whether capture description is enabled.</span></span> </param>
        <param name="encoding"><span data-ttu-id="77b18-104">Listet die möglichen Werte für das Codierungsformat von Capture-Beschreibung an.</span><span class="sxs-lookup"><span data-stu-id="77b18-104">Enumerates the possible values for the encoding format of capture description.</span></span> <span data-ttu-id="77b18-105">Folgende Werte sind möglich: "Avro", "AvroDeflate"</span><span class="sxs-lookup"><span data-stu-id="77b18-105">Possible values include: 'Avro', 'AvroDeflate'</span></span></param>
        <param name="intervalInSeconds"><span data-ttu-id="77b18-106">Die Zeitfenster können Sie die Häufigkeit, mit denen die Erfassung des Azure-Blobs ausgeführt, sollte der Wert zwischen 60 und 900 Sekunden, festlegen</span><span class="sxs-lookup"><span data-stu-id="77b18-106">The time window allows you to set the frequency with which the capture to Azure Blobs will happen, value should between 60 to 900 seconds</span></span></param>
        <param name="sizeLimitInBytes"><span data-ttu-id="77b18-107">Das Fenster der Größe definiert, die Menge der Daten in Ihren Event Hub vor einem Vorgang Capture aufgebaut, Wert muss zwischen zu 524288000 10485760 bytes</span><span class="sxs-lookup"><span data-stu-id="77b18-107">The size window defines the amount of data built up in your Event Hub before an capture operation, value should be between 10485760 to 524288000 bytes</span></span></param>
        <param name="destination"><span data-ttu-id="77b18-108">Eigenschaften des Ziels, wo Capture gespeichert werden sollen.</span><span class="sxs-lookup"><span data-stu-id="77b18-108">Properties of Destination where capture will be stored.</span></span> <span data-ttu-id="77b18-109">(Speicherkonto, Blob-Namen)</span><span class="sxs-lookup"><span data-stu-id="77b18-109">(Storage Account, Blob Names)</span></span></param>
        <summary>
            <span data-ttu-id="77b18-110">Initialisiert eine neue Instanz der CaptureDescription-Klasse.</span><span class="sxs-lookup"><span data-stu-id="77b18-110">Initializes a new instance of the CaptureDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Destination">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-111">Ruft ab oder legt die Eigenschaften des Ziels, wo Capture gespeichert werden sollen.</span><span class="sxs-lookup"><span data-stu-id="77b18-111">Gets or sets properties of Destination where capture will be stored.</span></span> <span data-ttu-id="77b18-112">(Speicherkonto, Blob-Namen)</span><span class="sxs-lookup"><span data-stu-id="77b18-112">(Storage Account, Blob Names)</span></span>
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-113">Ruft ab oder legt einen Wert, der angibt, ob die Beschreibung des Capture aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="77b18-113">Gets or sets a value that indicates whether capture description is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Encoding">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-114">Ruft ab oder legt Listet die möglichen Werte für das Codierungsformat von Capture-Beschreibung.</span><span class="sxs-lookup"><span data-stu-id="77b18-114">Gets or sets enumerates the possible values for the encoding format of capture description.</span></span> <span data-ttu-id="77b18-115">Folgende Werte sind möglich: "Avro", "AvroDeflate"</span><span class="sxs-lookup"><span data-stu-id="77b18-115">Possible values include: 'Avro', 'AvroDeflate'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SizeLimitInBytes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-117">Ruft ab oder legt die Fenstergröße aufgebaut Datenmenge in Ihren Event Hub vor einem Capture-Vorgang definiert, sollte Wert zwischen zu 524288000 10485760 Bytes sein.</span><span class="sxs-lookup"><span data-stu-id="77b18-117">Gets or sets the size window defines the amount of data built up in your Event Hub before an capture operation, value should be between 10485760 to 524288000 bytes</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="77b18-118">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="77b18-118">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="77b18-119">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="77b18-119">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
