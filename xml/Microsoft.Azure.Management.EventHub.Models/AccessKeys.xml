<Type Name="AccessKeys" FullName="Microsoft.Azure.Management.EventHub.Models.AccessKeys">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="27ce4-101">Namespace/EventHub-Verbindungszeichenfolge</span><span class="sxs-lookup"><span data-stu-id="27ce4-101">Namespace/EventHub Connection String</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-102">Initialisiert eine neue Instanz der AccessKeys-Klasse.</span><span class="sxs-lookup"><span data-stu-id="27ce4-102">Initializes a new instance of the AccessKeys class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="primaryConnectionString"><span data-ttu-id="27ce4-103">Primäre Verbindungszeichenfolge für den erstellten Namespace AuthorizationRule.</span><span class="sxs-lookup"><span data-stu-id="27ce4-103">Primary connection string of the created namespace AuthorizationRule.</span></span></param>
        <param name="secondaryConnectionString"><span data-ttu-id="27ce4-104">Sekundäre Verbindungszeichenfolge für den erstellten Namespace AuthorizationRule.</span><span class="sxs-lookup"><span data-stu-id="27ce4-104">Secondary connection string of the created namespace AuthorizationRule.</span></span></param>
        <param name="aliasPrimaryConnectionString"><span data-ttu-id="27ce4-105">Primäre Verbindungszeichenfolge für den Alias, wenn GEO-DR aktiviert ist</span><span class="sxs-lookup"><span data-stu-id="27ce4-105">Primary connection string of the alias if GEO DR is enabled</span></span></param>
        <param name="aliasSecondaryConnectionString"><span data-ttu-id="27ce4-106">Sekundäre Verbindungszeichenfolge für den Alias, wenn GEO-DR aktiviert ist</span><span class="sxs-lookup"><span data-stu-id="27ce4-106">Secondary  connection string of the alias if GEO DR is enabled</span></span></param>
        <param name="primaryKey"><span data-ttu-id="27ce4-107">Ein primärer Base64-codierter 256-Bit-Schlüssel zum Signieren und Überprüfen des SAS-Tokens.</span><span class="sxs-lookup"><span data-stu-id="27ce4-107">A base64-encoded 256-bit primary key for signing and validating the SAS token.</span></span></param>
        <param name="secondaryKey"><span data-ttu-id="27ce4-108">Ein primärer Base64-codierter 256-Bit-Schlüssel zum Signieren und Überprüfen des SAS-Tokens.</span><span class="sxs-lookup"><span data-stu-id="27ce4-108">A base64-encoded 256-bit primary key for signing and validating the SAS token.</span></span></param>
        <param name="keyName"><span data-ttu-id="27ce4-109">Eine Zeichenfolge, die AuthorizationRule beschreibt.</span><span class="sxs-lookup"><span data-stu-id="27ce4-109">A string that describes the AuthorizationRule.</span></span></param>
        <summary>
            <span data-ttu-id="27ce4-110">Initialisiert eine neue Instanz der AccessKeys-Klasse.</span><span class="sxs-lookup"><span data-stu-id="27ce4-110">Initializes a new instance of the AccessKeys class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AliasPrimaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-111">Ruft die primäre Verbindungszeichenfolge des Alias ab, wenn GEO-DR aktiviert ist</span><span class="sxs-lookup"><span data-stu-id="27ce4-111">Gets primary connection string of the alias if GEO DR is enabled</span></span>
            </summary>
    ...
    <Member MemberName="AliasSecondaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-112">Ruft die sekundäre Verbindungszeichenfolge des Alias ab, wenn GEO-DR aktiviert ist</span><span class="sxs-lookup"><span data-stu-id="27ce4-112">Gets secondary  connection string of the alias if GEO DR is enabled</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-113">Ruft eine Zeichenfolge, die AuthorizationRule beschreibt.</span><span class="sxs-lookup"><span data-stu-id="27ce4-113">Gets a string that describes the AuthorizationRule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-114">Ruft die primäre Verbindungszeichenfolge für den erstellten Namespace AuthorizationRule ab.</span><span class="sxs-lookup"><span data-stu-id="27ce4-114">Gets primary connection string of the created namespace AuthorizationRule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-115">Ruft einen base64-codierte primären 256-Bit-Schlüssel zum Signieren und überprüfen das SAS-Token.</span><span class="sxs-lookup"><span data-stu-id="27ce4-115">Gets a base64-encoded 256-bit primary key for signing and validating the SAS token.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-116">Ruft die sekundäre Verbindungszeichenfolge für den erstellten Namespace AuthorizationRule ab.</span><span class="sxs-lookup"><span data-stu-id="27ce4-116">Gets secondary connection string of the created namespace AuthorizationRule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27ce4-117">Ruft einen base64-codierte primären 256-Bit-Schlüssel zum Signieren und überprüfen das SAS-Token.</span><span class="sxs-lookup"><span data-stu-id="27ce4-117">Gets a base64-encoded 256-bit primary key for signing and validating the SAS token.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
