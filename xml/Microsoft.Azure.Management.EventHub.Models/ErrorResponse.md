<Type Name="ErrorResponse" FullName="Microsoft.Azure.Management.EventHub.Models.ErrorResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4fa5a-101">Fehler Search Response – gibt an, dass der EventHub-Dienst nicht die eingehende Anforderung verarbeitet wurde.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-101">Error reponse indicates EventHub service is not able to process the incoming request.</span></span> <span data-ttu-id="4fa5a-102">Der Grund ist in der Fehlermeldung angegeben.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-102">The reason is provided in the error message.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4fa5a-103">Initialisiert eine neue Instanz der Klasse ErrorResponse an.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-103">Initializes a new instance of the ErrorResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code"><span data-ttu-id="4fa5a-104">Fehlercode</span><span class="sxs-lookup"><span data-stu-id="4fa5a-104">Error code.</span></span></param>
        <param name="message"><span data-ttu-id="4fa5a-105">Die Fehlermeldung, der angibt, warum der Vorgang fehlgeschlagen ist.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-105">Error message indicating why the operation failed.</span></span></param>
        <summary>
            <span data-ttu-id="4fa5a-106">Initialisiert eine neue Instanz der Klasse ErrorResponse an.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-106">Initializes a new instance of the ErrorResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4fa5a-107">Ruft ab, oder legt ihn fest-Fehlercode.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-107">Gets or sets error code.</span></span>
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4fa5a-108">Ruft ab oder legt die Fehlermeldung, der angibt, warum der Vorgang fehlgeschlagen ist.</span><span class="sxs-lookup"><span data-stu-id="4fa5a-108">Gets or sets error message indicating why the operation failed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
