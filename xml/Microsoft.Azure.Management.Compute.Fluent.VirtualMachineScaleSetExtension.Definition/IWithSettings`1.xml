<Type Name="IWithSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetExtension.Definition.IWithSettings&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="1c31e-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="1c31e-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="1c31e-102">Die Phase der VM-Skalierungsgruppe festgelegt ressourcenerweiterungsdefinition zulassen, um die öffentlichen und privaten Einstellungen anzugeben.</span><span class="sxs-lookup"><span data-stu-id="1c31e-102">The stage of a virtual machine scale set extension definition allowing to specify the public and private settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithProtectedSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="1c31e-103">Der Schlüssel eines Eintrags private-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-103">The key of a private settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="1c31e-104">Der Wert des Eintrags private-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-104">The value of the private settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="1c31e-105">Gibt einen Eintrag für die private-Einstellungen an.</span><span class="sxs-lookup"><span data-stu-id="1c31e-105">Specifies a private settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c31e-106">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="1c31e-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithProtectedSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="1c31e-107">Die Einstellungen für privaten.</span><span class="sxs-lookup"><span data-stu-id="1c31e-107">The private settings.</span></span></param>
        <summary>
            <span data-ttu-id="1c31e-108">Gibt Einstellungen für private an.</span><span class="sxs-lookup"><span data-stu-id="1c31e-108">Specifies private settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c31e-109">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="1c31e-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="1c31e-110">Der Schlüssel eines Eintrags public-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-110">The key of a public settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="1c31e-111">Der Wert des Eintrags public-Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-111">The value of the public settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="1c31e-112">Gibt einen Eintrag für die öffentlichen Einstellungen an.</span><span class="sxs-lookup"><span data-stu-id="1c31e-112">Specifies a public settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c31e-113">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="1c31e-113">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="1c31e-114">Die öffentlichen Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-114">The public settings.</span></span></param>
        <summary>
            <span data-ttu-id="1c31e-115">Gibt die öffentliche Einstellungen.</span><span class="sxs-lookup"><span data-stu-id="1c31e-115">Specifies public settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c31e-116">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="1c31e-116">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>