<Type Name="IWithFaultDomainCount" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithFaultDomainCount">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3f599-101">Die Stufe der Verfügbarkeit festgelegt Definition ermöglicht wird, um die Anzahl der Fehlerdomänen anzugeben.</span><span class="sxs-lookup"><span data-stu-id="3f599-101">The stage of the availability set definition allowing to specify the fault domain count.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithFaultDomainCount">
      ...
      <Docs>
        <param name="faultDomainCount"><span data-ttu-id="3f599-102">Die Anzahl der Fehlerdomänen.</span><span class="sxs-lookup"><span data-stu-id="3f599-102">The fault domain count.</span></span></param>
        <summary>
            <span data-ttu-id="3f599-103">Gibt die Anzahl der Fehlerdomänen für die verfügbarkeitsgruppe an.</span><span class="sxs-lookup"><span data-stu-id="3f599-103">Specifies the fault domain count for the availability set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="3f599-104">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="3f599-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>