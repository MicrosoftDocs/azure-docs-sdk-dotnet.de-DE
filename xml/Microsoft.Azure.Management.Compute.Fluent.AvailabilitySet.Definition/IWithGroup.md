<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithGroup">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithGroup" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a293b-101">Legen Sie die Stufe der Verfügbarkeit Definition ermöglicht die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="a293b-101">The stage of the availability set definition allowing to specify the resource group.</span></span>
            </summary>
