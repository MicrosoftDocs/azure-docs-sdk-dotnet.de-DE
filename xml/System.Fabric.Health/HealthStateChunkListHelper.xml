<Type Name="HealthStateChunkListHelper" FullName="System.Fabric.Health.HealthStateChunkListHelper">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="52ed5-101">Erweiterungen für den Integritätsstatus in Blöcken Auflisten von Vorgängen.</span><span class="sxs-lookup"><span data-stu-id="52ed5-101">Extensions for health state chunk list operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ToArray&lt;T&gt;">
      ...
      <Docs>
        <typeparam name="T"><span data-ttu-id="52ed5-102">Der Typ der List-Objekte.</span><span class="sxs-lookup"><span data-stu-id="52ed5-102">The type of the list objects.</span></span></typeparam>
        <param name="list"><span data-ttu-id="52ed5-103">Die Liste der Integrität Status-Block.</span><span class="sxs-lookup"><span data-stu-id="52ed5-103">The health state chunk list.</span></span></param>
        <summary>
            <span data-ttu-id="52ed5-104">Ein Array mit den Elementen zurückgegeben in der Liste der Block.</span><span class="sxs-lookup"><span data-stu-id="52ed5-104">Returns an array with the items in the chunk list.</span></span>
            </summary>
        <returns><span data-ttu-id="52ed5-105">Das Array.</span><span class="sxs-lookup"><span data-stu-id="52ed5-105">The array.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
