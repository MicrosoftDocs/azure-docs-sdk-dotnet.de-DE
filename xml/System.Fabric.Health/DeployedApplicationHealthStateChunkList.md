<Type Name="DeployedApplicationHealthStateChunkList" FullName="System.Fabric.Health.DeployedApplicationHealthStateChunkList">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2c1fa-101">Stellt eine Liste mit <see cref="T:System.Fabric.Health.DeployedApplicationHealthStateChunk" /> Elemente.</span><span class="sxs-lookup"><span data-stu-id="2c1fa-101">Represents a list that contains <see cref="T:System.Fabric.Health.DeployedApplicationHealthStateChunk" /> items.</span></span>
            </summary>
    <remarks><span data-ttu-id="2c1fa-102">Die Liste kann über integritätsabfragen Status-Blocks abgerufen werden.</span><span class="sxs-lookup"><span data-stu-id="2c1fa-102">The list can be obtained through health state chunk queries.</span></span> <span data-ttu-id="2c1fa-103">Abfragen können als Ergebnis Segmente aufweisen, die eine Nachricht eingefügt werden kann.</span><span class="sxs-lookup"><span data-stu-id="2c1fa-103">The queries may have as result more chunks that can fit a message.</span></span>
            <span data-ttu-id="2c1fa-104">In diesem Fall die Liste der Elemente, die die Nachricht wird zurückgegeben, sowie eine Anzahl, die zeigt, wie viele gesamtelemente sind verfügbar.</span><span class="sxs-lookup"><span data-stu-id="2c1fa-104">In this case, the list of items that fit the message is returned plus a count that shows how many total items are available.</span></span></remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c1fa-105">Instanziiert eine leere <see cref="T:System.Fabric.Health.DeployedApplicationHealthStateChunkList" />.</span><span class="sxs-lookup"><span data-stu-id="2c1fa-105">Instantiates an empty <see cref="T:System.Fabric.Health.DeployedApplicationHealthStateChunkList" />.</span></span>
            </summary>
