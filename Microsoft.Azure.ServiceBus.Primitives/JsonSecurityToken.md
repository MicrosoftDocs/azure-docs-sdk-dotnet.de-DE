<Type Name="JsonSecurityToken" FullName="Microsoft.Azure.ServiceBus.Primitives.JsonSecurityToken">
  ...
  <Docs>
    <summary>
            SecurityToken erweitert für JWT-spezifischen Eigenschaften
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="rawToken">JSON-Webtoken rohzeichenfolge</param>
        <param name="audience">Die Zielgruppe</param>
        <summary>
            Erstellt eine neue Instanz der <see cref="T:Microsoft.Azure.ServiceBus.Primitives.JsonSecurityToken" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
