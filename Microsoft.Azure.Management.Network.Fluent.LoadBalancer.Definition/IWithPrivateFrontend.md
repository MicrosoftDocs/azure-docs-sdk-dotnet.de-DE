<Type Name="IWithPrivateFrontend" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IWithPrivateFrontend">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9e412-101">Die Phase von einer internen Load Balancer-Definition, die festlegen, dass um eine oder mehrere private Front-Ends zu definieren.</span><span class="sxs-lookup"><span data-stu-id="9e412-101">The stage of an internal load balancer definition allowing to define one or more private frontends.</span></span>
            </summary>
