<Type Name="ApplicationGatewaySku" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewaySku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Name des einen Anwendungsgateway SKU. Folgende Werte sind möglich: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium", "WAF_Large"</param>
        <param name="tier">Ein vorhandenes Anwendungsgateway-Ebene: Folgende Werte sind möglich: "Standard", "WAF"</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Name, der ein vorhandenes Anwendungsgateway SKU. Folgende Werte sind möglich: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium", "WAF_Large"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway Ebene. Folgende Werte sind möglich: "Standard", "WAF"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
