<Type Name="QueryTroubleshootingParameters" FullName="Microsoft.Azure.Management.Network.Models.QueryTroubleshootingParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der QueryTroubleshootingParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetResourceId">Führen zum Abfragen der Fehlerbehebung die Zielressourcen-ID.</param>
        <summary>
            Initialisiert eine neue Instanz der QueryTroubleshootingParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TargetResourceId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie Abfragen das Ergebnis zur Fehlerbehebung die Zielressourcen-ID fest.
            </summary>
