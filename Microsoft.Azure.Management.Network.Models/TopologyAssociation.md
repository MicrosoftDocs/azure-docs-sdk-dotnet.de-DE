<Type Name="TopologyAssociation" FullName="Microsoft.Azure.Management.Network.Models.TopologyAssociation">
  ...
  <Docs>
    <summary>
            Ressourcen, die eine Zuordnung zu übergeordneten Ressource haben.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TopologyAssociation-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Ressource, die die übergeordnete Ressource zugeordnet ist.</param>
        <param name="resourceId">Die ID der Ressource, die die übergeordnete Ressource zugeordnet ist.</param>
        <param name="associationType">Der Zuordnungstyp der untergeordnete Ressource auf die übergeordnete Ressource. Folgende Werte sind möglich: "Verknüpft", "Contains"</param>
        <summary>
            Initialisiert eine neue Instanz der TopologyAssociation-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AssociationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Zuordnungstyp der untergeordnete Ressource, auf die übergeordnete Ressource. Folgende Werte sind möglich: "Verknüpft", "Contains"
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Ressource, die die übergeordnete Ressource zugeordnet ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID der Ressource, die die übergeordnete Ressource zugeordnet ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
