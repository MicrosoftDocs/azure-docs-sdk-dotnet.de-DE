<Type Name="Subnet" FullName="Microsoft.Azure.Management.Network.Models.Subnet">
  ...
  <Docs>
    <summary>
            Subnetz in ein virtuelles Netzwerk-Ressource.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse Subnetz an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="addressPrefix">Das Adresspräfix für das Subnetz.</param>
        <param name="networkSecurityGroup">Der Verweis der NetworkSecurityGroup Ressource.</param>
        <param name="routeTable">Der Verweis der RouteTable Ressource.</param>
        <param name="serviceEndpoints">Ein Array von Dienstendpunkten.</param>
        <param name="ipConfigurations">Ruft ein Array von Verweisen auf die über netzwerkschnittstellenkonfigurationen IP-Subnetz verwenden.</param>
        <param name="resourceNavigationLinks">Ruft ein Array von Verweisen auf die externen Ressourcen, die mithilfe der Subnetz ab.</param>
    ...
    <Member MemberName="AddressPrefix">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Adresspräfix für das Subnetz.
            </summary>
    ...
    <Member MemberName="IpConfigurations">
      ...
      <Docs>
        <summary>
            Ruft ein Array von Verweisen auf die über netzwerkschnittstellenkonfigurationen IP-Subnetz verwenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceNavigationLinks">
      ...
      <Docs>
        <summary>
            Ruft ein Array von Verweisen auf die externen Ressourcen, die mithilfe der Subnetz ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTable">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Verweis der RouteTable Ressource.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceEndpoints">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ein Array von Dienstendpunkten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
