<Type Name="ExpressRouteCircuitsRoutesTableListResult" FullName="Microsoft.Azure.Management.Network.Models.ExpressRouteCircuitsRoutesTableListResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e465c-101">Die Antwort für ListRoutesTable Verbindungen-API für Express Route zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="e465c-101">Response for ListRoutesTable associated with the Express Route Circuits API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e465c-102">Initialisiert eine neue Instanz der ExpressRouteCircuitsRoutesTableListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e465c-102">Initializes a new instance of the ExpressRouteCircuitsRoutesTableListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="e465c-103">Die Liste der Routen-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="e465c-103">The list of routes table.</span></span></param>
        <param name="nextLink"><span data-ttu-id="e465c-104">Die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="e465c-104">The URL to get the next set of results.</span></span></param>
        <summary>
            <span data-ttu-id="e465c-105">Initialisiert eine neue Instanz der ExpressRouteCircuitsRoutesTableListResult-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e465c-105">Initializes a new instance of the ExpressRouteCircuitsRoutesTableListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e465c-106">Ruft ab oder legt die URL zum Abrufen des nächsten Satzes von Ergebnissen.</span><span class="sxs-lookup"><span data-stu-id="e465c-106">Gets or sets the URL to get the next set of results.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e465c-107">Ruft ab oder legt die Liste der Routen-Tabelle.</span><span class="sxs-lookup"><span data-stu-id="e465c-107">Gets or sets the list of routes table.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
