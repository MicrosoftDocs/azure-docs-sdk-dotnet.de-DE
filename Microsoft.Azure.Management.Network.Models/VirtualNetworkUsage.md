<Type Name="VirtualNetworkUsage" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkUsage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualNetworkUsage-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="currentValue">Gibt die Anzahl der IP-Adressen aus dem Subnetz verwendet.</param>
        <param name="id">Subnetzbezeichner.</param>
        <param name="limit">Gibt die Größe des Subnetzes an.</param>
        <param name="name">Der Name, allgemeine und lokalisierten Wert für die Verwendung enthält.</param>
        <param name="unit">Verwendung von Einheiten. Gibt "Count"</param>
        <summary>
            Initialisiert eine neue Instanz der VirtualNetworkUsage-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CurrentValue">
      ...
      <Docs>
        <summary>
            Ruft gibt die Anzahl der IP-Adressen verwendet werden, aus dem Subnetz an.
            </summary>
    ...
    <Member MemberName="Limit">
      ...
      <Docs>
        <summary>
            Ruft gibt die Größe des Subnetzes an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft den Namen der allgemeinen und lokalisierten Wert für die Verwendung mit ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            Ruft Verwendungsdaten Einheiten ab. Gibt "Count"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
