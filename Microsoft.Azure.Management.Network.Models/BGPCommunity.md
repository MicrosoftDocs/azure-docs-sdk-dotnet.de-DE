<Type Name="BGPCommunity" FullName="Microsoft.Azure.Management.Network.Models.BGPCommunity">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceSupportedRegion">Die Region, die der Dienst zu unterstützen. ist z. B. für Office 365, Region "Global".</param>
        <param name="communityName">Der Name des Bgp-Community. z. B. Skype.</param>
        <param name="communityValue">Der Wert der Bgp-Community. Weitere Informationen: https://docs.microsoft.com/en-us/azure/expressroute/expressroute-routing.</param>
        <param name="communityPrefixes">Die Präfixe, die die Bgp-Community enthält.</param>
        <param name="isAuthorizedToUse">Kunden ist autorisiert, mithilfe von Bgp-Community oder nicht.</param>
        <param name="serviceGroup">Die Dienstgruppe der Bgp-Community enthält.</param>
        <summary>
            Initialisiert eine neue Instanz der BGPCommunity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IsAuthorizedToUse">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Kunden mithilfe von Bgp-Community oder nicht autorisiert ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceGroup">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, die der Gruppe "Dienst" der Bgp-Community enthält.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceSupportedRegion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Region, die der Dienst zu unterstützen. ist z. B. für Office 365, Region "Global".
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
