<Type Name="ApplicationGatewayProbeHealthResponseMatch" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayProbeHealthResponseMatch">
  ...
  <Docs>
    <summary>
            Application Gateway Prüfpunkt SoH-Antwort übereinstimmen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayProbeHealthResponseMatch-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="body">Text, der in der SoH-Antwort enthalten sein muss. Standardwert ist leer.</param>
        <param name="statusCodes">Zulässige Bereiche der fehlerfrei Statuscodes.
            Standardbereich fehlerfrei Statuscodes ist 200 399.</param>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayProbeHealthResponseMatch-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Body">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie-Textkörper, der enthalten sein muss in der SoH-Antwort fest.
    ...
    <Member MemberName="StatusCodes">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der zulässigen Bereiche der fehlerfrei Statuscodes. Standardbereich fehlerfrei Statuscodes ist 200 399.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
