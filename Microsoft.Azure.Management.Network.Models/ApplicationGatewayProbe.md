<Type Name="ApplicationGatewayProbe" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayProbe">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayProbe-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="host">Hostname, der die Überprüfung zu senden.</param>
        <param name="path">Relative Pfad der Prüfpunkts. Gültiger Pfad beginnt mit "/". Prüfpunkt wird gesendet, um &lt;Protokoll&gt;://&lt;Host&gt;:&lt;Port&gt;&lt;Pfad&gt;</param>
        <param name="interval">Die Untersuchung verwendeten Intervall in Sekunden. Dies ist das Zeitintervall zwischen zwei aufeinanderfolgenden Überprüfungen. Die zulässigen Werte reichen von 1 Sekunde bis 86400 Sekunden.</param>
        <param name="timeout">das Test-Timeout in Sekunden. Prüfpunkt markiert als fehlgeschlagen eingestuft, wenn Sie mit diesen Timeouts keine gültige Antwort empfangen wird.
            Die zulässigen Werte reichen von 1 Sekunde bis 86400 Sekunden.</param>
        <param name="unhealthyThreshold">Anzahl der Wiederholungsversuche des Prüfpunkts. Back-End-Server ist ausgefallen gekennzeichnet, nach der Anzahl der aufeinander folgenden Test Fehler UnhealthyThreshold erreicht. Gültige Werte liegen zwischen 1 Sekunde
            20.</param>
        <param name="pickHostNameFromBackendHttpSettings">Gibt an, ob der Host-Header aus den Back-End-HTTP-Einstellungen ausgewählt werden sollte. Der Standardwert ist „false“.</param>
        <param name="minServers">Minimale Anzahl von Servern, die immer fehlerfrei gekennzeichnet sind. Standardwert ist 0.</param>
        <param name="match">Kriterium für eine fehlerfreie überprüfungsantwort zu klassifizieren.</param>
    ...
    <Member MemberName="Match">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Kriterium für eine fehlerfreie überprüfungsantwort zu klassifizieren.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MinServers">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Mindestanzahl von Servern, die immer fehlerfrei gekennzeichnet sind. Standardwert ist 0.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PickHostNameFromBackendHttpSettings">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob der Host-Header aus der Back-End-HTTP-Einstellungen ausgewählt werden sollte. Der Standardwert ist „false“.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
