  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="routes">Die Auflistung der Routen, die innerhalb einer Routingtabelle enthalten.</param>
        <param name="subnets">Eine Auflistung von Verweisen auf Subnetze.</param>
        <param name="disableBgpRoutePropagation">Ruft ab oder legt fest, ob die Routen, die von BGP für diese Routentabelle zu deaktivieren. "True" bedeutet deaktivieren.</param>
    ...
    <Member MemberName="DisableBgpRoutePropagation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob die Routen, die von BGP für diese Routentabelle zu deaktivieren. "True" bedeutet deaktivieren.
            </summary>
    ...
    <Member MemberName="Routes">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Auflistung von Routen innerhalb einer Routingtabelle enthaltenen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
