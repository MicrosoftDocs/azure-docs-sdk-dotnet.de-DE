<Type Name="AvailableProvidersListParameters" FullName="Microsoft.Azure.Management.Network.Models.AvailableProvidersListParameters">
  ...
  <Docs>
    <summary>
            Einschränkungen, die die Liste der verfügbaren Internetdienstanbieter zu bestimmen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AvailableProvidersListParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="azureLocations">Eine Liste der Azure-Regionen.</param>
        <param name="country">Das Land für die Liste der verfügbaren Anbieter.</param>
        <param name="state">Der Status für die Liste der verfügbaren Anbieter.</param>
        <param name="city">Die Stadt oder die Stadt, für die Liste der verfügbaren Anbieter.</param>
        <summary>
            Initialisiert eine neue Instanz der AvailableProvidersListParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AzureLocations">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste der Azure-Regionen.
            </summary>
    ...
    <Member MemberName="City">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, die Stadt oder einen Ort für die Liste der verfügbaren Anbieter aus.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Country">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Land für die Liste der verfügbaren Anbieter.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Zustand für die Liste der verfügbaren Anbieter fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
