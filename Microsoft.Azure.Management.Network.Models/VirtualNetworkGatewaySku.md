<Type Name="VirtualNetworkGatewaySku" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkGatewaySku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Gateway-SKU-Name. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</param>
        <param name="tier">Gateway-SKU-Tarif. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Gateway-SKU-Name. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Gateway-SKU-Tarif. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance", "VpnGw1", "VpnGw2", "VpnGw3"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
