<Type Name="ApplicationGatewayAuthenticationCertificate" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayAuthenticationCertificate">
  ...
  <Docs>
    <summary>
            Authentifizierungszertifikate eines Gateways für die Anwendung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayAuthenticationCertificate-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="data">Öffentliche Zertifikatdaten.</param>
        <param name="provisioningState">Der Bereitstellungsstatus der Authentifizierung zertifikatsressource. Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</param>
    ...
    <Member MemberName="Data">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest öffentliche Zertifikatdaten.
            </summary>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, der Bereitstellungsstatus der Authentifizierung zertifikatsressource. Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
