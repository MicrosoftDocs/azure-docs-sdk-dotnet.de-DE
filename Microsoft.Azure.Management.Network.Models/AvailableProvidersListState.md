<Type Name="AvailableProvidersListState" FullName="Microsoft.Azure.Management.Network.Models.AvailableProvidersListState">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AvailableProvidersListState-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stateName">Der Statusname.</param>
        <param name="providers">Eine Liste der Internetdienstanbieter.</param>
        <param name="cities">Liste der verfügbaren Städte oder Städte in den Zustand.</param>
        <summary>
            Initialisiert eine neue Instanz der AvailableProvidersListState-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Cities">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der verfügbaren Städte oder Städte in den Zustand fest.
            </summary>
