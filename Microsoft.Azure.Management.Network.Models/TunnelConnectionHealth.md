<Type Name="TunnelConnectionHealth" FullName="Microsoft.Azure.Management.Network.Models.TunnelConnectionHealth">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TunnelConnectionHealth-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tunnel">Name der Tunnel.</param>
        <param name="connectionStatus">Das virtuelle Netzwerk-Gateway-Verbindungsstatus. Folgende Werte sind möglich: "Unknown", "Verbinden", "Verbunden", "NotConnected"</param>
        <param name="ingressBytesTransferred">Eingehend Bytes übertragen bei dieser Verbindung</param>
        <param name="egressBytesTransferred">Der ausgehenden Bytes übertragen bei dieser Verbindung</param>
        <param name="lastConnectionEstablishedUtcTime">Der Zeitpunkt, zu dem Verbindung, im Utc-Format hergestellt wurde.</param>
        <summary>
            Initialisiert eine neue Instanz der TunnelConnectionHealth-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConnectionStatus">
      ...
      <Docs>
        <summary>
            Ruft virtuelle Netzwerk-Gateway-Verbindungsstatus ab. Folgende Werte sind möglich: "Unknown", "Verbinden", "Verbunden", "NotConnected"
            </summary>
    ...
    <Member MemberName="EgressBytesTransferred">
      ...
      <Docs>
        <summary>
            Ruft die ausgehenden Bytes übertragen, in dieser Verbindung
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IngressBytesTransferred">
      ...
      <Docs>
        <summary>
            Ruft den Eingang Bytes übertragen, in dieser Verbindung
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastConnectionEstablishedUtcTime">
      ...
      <Docs>
        <summary>
            Ruft den Zeitpunkt, an dem Verbindung, im Utc-Format hergestellt wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
