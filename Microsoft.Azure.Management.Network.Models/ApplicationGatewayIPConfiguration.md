<Type Name="ApplicationGatewayIPConfiguration" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayIPConfiguration">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayIPConfiguration-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="subnet">Verweis auf die Subnetz-Ressource. Ein Subnetz aus, in denen Anwendungsgateway seine private Adresse erhält.</param>
        <param name="provisioningState">Der Bereitstellungsstatus der Anwendung Gateway-Subnetz-Ressource. Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</param>
