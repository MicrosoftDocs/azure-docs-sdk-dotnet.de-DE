<Type Name="ApplicationGatewayUrlPathMap" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayUrlPathMap">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayUrlPathMap-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="defaultBackendAddressPool">Standardmäßig Back-End-Pool Adressressource der URL-Pfad-Zuordnung.</param>
        <param name="defaultBackendHttpSettings">Back-End-HTTP-Einstellungen Standardressource von URL-Pfad-Zuordnung.</param>
        <param name="defaultRedirectConfiguration">Standard umleitungs-Ressource mit der Konfiguration von URL-Pfad-Zuordnung.</param>
        <param name="pathRules">Pfadregel von URL-Pfad-Map-Ressource.</param>
    ...
    <Member MemberName="DefaultRedirectConfiguration">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Standardressource Umleitung Konfiguration von URL-Pfad-Zuordnung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
