<Type Name="AzureReachabilityReportParameters" FullName="Microsoft.Azure.Management.Network.Models.AzureReachabilityReportParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e229a-101">Geografische und Zeit-Einschränkungen für Azure Erreichbarkeit Bericht.</span><span class="sxs-lookup"><span data-stu-id="e229a-101">Geographic and time constraints for Azure reachability report.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-102">Initialisiert eine neue Instanz der AzureReachabilityReportParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e229a-102">Initializes a new instance of the AzureReachabilityReportParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="startTime"><span data-ttu-id="e229a-103">Die Startzeit für den Azure Erreichbarkeit Bericht.</span><span class="sxs-lookup"><span data-stu-id="e229a-103">The start time for the Azure reachability report.</span></span></param>
        <param name="endTime"><span data-ttu-id="e229a-104">Die Endzeit für den Azure Erreichbarkeit Bericht.</span><span class="sxs-lookup"><span data-stu-id="e229a-104">The end time for the Azure reachability report.</span></span></param>
        <param name="providers"><span data-ttu-id="e229a-105">Liste der Internetdienstanbieter.</span><span class="sxs-lookup"><span data-stu-id="e229a-105">List of Internet service providers.</span></span></param>
        <param name="azureLocations"><span data-ttu-id="e229a-106">Optionale Azure-Regionen, die Abfrage zum Bereich festzulegen.</span><span class="sxs-lookup"><span data-stu-id="e229a-106">Optional Azure regions to scope the query to.</span></span></param>
        <summary>
            <span data-ttu-id="e229a-107">Initialisiert eine neue Instanz der AzureReachabilityReportParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="e229a-107">Initializes a new instance of the AzureReachabilityReportParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AzureLocations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-108">Ruft ab, oder legt ihn fest optionale Azure-Regionen, um die Abfrage zu konzentrieren.</span><span class="sxs-lookup"><span data-stu-id="e229a-108">Gets or sets optional Azure regions to scope the query to.</span></span>
            </summary>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-109">Ruft ab oder legt die Endzeit für den Azure Erreichbarkeit Bericht.</span><span class="sxs-lookup"><span data-stu-id="e229a-109">Gets or sets the end time for the Azure reachability report.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Providers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-110">Ruft ab oder legt die Liste der Internetdienstanbieter.</span><span class="sxs-lookup"><span data-stu-id="e229a-110">Gets or sets list of Internet service providers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-111">Ruft ab oder legt die Startzeit für den Azure Erreichbarkeit Bericht fest.</span><span class="sxs-lookup"><span data-stu-id="e229a-111">Gets or sets the start time for the Azure reachability report.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e229a-112">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="e229a-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="e229a-113">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="e229a-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
