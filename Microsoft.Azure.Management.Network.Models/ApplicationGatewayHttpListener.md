<Type Name="ApplicationGatewayHttpListener" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayHttpListener">
  ...
  <Docs>
    <summary>
            HTTP-Listener, der ein vorhandenes Anwendungsgateway.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayHttpListener-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="frontendIPConfiguration">Frontend IP Konfigurationsressource eines Gateways für die Anwendung.</param>
        <param name="frontendPort">Front-End-Port Ressource eines Gateways für die Anwendung.</param>
        <param name="protocol">Protokoll. Folgende Werte sind möglich: "Http", "Https"</param>
        <param name="hostName">Der Hostname des HTTP-Listener.</param>
        <param name="sslCertificate">SSL-Zertifikat-Ressource eines Gateways für die Anwendung.</param>
        <param name="requireServerNameIndication">Nur anwendbar, wenn Protokoll Https ist. Aktiviert SNI für Multihosting an.</param>
        <param name="provisioningState">Der Bereitstellungsstatus der HTTP-Listener-Ressource. Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</param>
    ...
    <Member MemberName="FrontendIPConfiguration">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway Front-End-IP-Konfigurationsressource.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FrontendPort">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway Front-End-Port Ressource.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Hostnamen des HTTP-Listener.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, der Bereitstellungsstatus der HTTP-Listener-Ressource.
    ...
    <Member MemberName="RequireServerNameIndication">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest nur anwendbar, wenn Protokoll Https ist. Aktiviert SNI für Multihosting an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SslCertificate">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway SSL-zertifikatsressource.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
