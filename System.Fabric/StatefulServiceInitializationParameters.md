<Type Name="StatefulServiceInitializationParameters" FullName="System.Fabric.StatefulServiceInitializationParameters">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="67939-101">Definiert die Dienst-Initialisierungsparameter für ein zustandsbehafteter Dienst.</span><span class="sxs-lookup"><span data-stu-id="67939-101">Defines service initialization parameters for a stateful service.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="ReplicaId">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="67939-102">Gibt den eindeutigen Bezeichner für die statusbehafteten dienstreplikats an.</span><span class="sxs-lookup"><span data-stu-id="67939-102">Specifies the unique identifier for the stateful service replica.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="67939-103">Gibt <see cref="T:System.Int64" />zurück.</span><span class="sxs-lookup"><span data-stu-id="67939-103">Returns <see cref="T:System.Int64" />.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
