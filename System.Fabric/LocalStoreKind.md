<Type Name="LocalStoreKind" FullName="System.Fabric.LocalStoreKind">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="9c3ea-101">Gibt den Typ der lokalen Speicher-Anbieter.</span><span class="sxs-lookup"><span data-stu-id="9c3ea-101">Specifies the local store provider type.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Ese">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="9c3ea-102">Gibt eine Datenbankanbieter Extensible Store Engine (ESE) an.</span><span class="sxs-lookup"><span data-stu-id="9c3ea-102">Indicates an Extensible Store Engine (ESE) database provider.</span></span> <span data-ttu-id="9c3ea-103">Weitere Informationen finden Sie unter http://msdn.microsoft.com/library/gg269245(v=exchg.10).aspx for documentation on ESE.</span><span class="sxs-lookup"><span data-stu-id="9c3ea-103">Please see http://msdn.microsoft.com/library/gg269245(v=exchg.10).aspx for documentation on ESE.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="9c3ea-104">Für zukünftige Verwendung reserviert.</span><span class="sxs-lookup"><span data-stu-id="9c3ea-104">Reserved for future use.</span></span> <span data-ttu-id="9c3ea-105">Es gibt keine gültigen Datenbank-Anbieter.</span><span class="sxs-lookup"><span data-stu-id="9c3ea-105">Does not indicate a valid database provider.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
