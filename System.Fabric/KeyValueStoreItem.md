<Type Name="KeyValueStoreItem" FullName="System.Fabric.KeyValueStoreItem">
  ...
  <Docs>
    <summary>
      <para>Stellt ein Element im Schlüssel/Wert-Speicher.</para>
    </summary>
  ...
  <Members>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
          <para>Ruft eine <see cref="T:System.Fabric.KeyValueStoreItemMetadata" /> Objekt, das die Metadaten für ein Element im Schlüssel/Wert-Speicher darstellt. </para>
        </summary>
        <value>
          <para>Ein <see cref="T:System.Fabric.KeyValueStoreItemMetadata" /> Objekt, das die Metadaten für ein Element im Schlüssel/Wert-Speicher darstellt.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
          <para>Ruft eine <see cref="T:System.Byte" /> , die den Wert eines Elements im Schlüssel/Wert-Speicher darstellt.</para>
        </summary>
        <value>
          <para>Ein <see cref="T:System.Byte" /> , die den Wert eines Elements im Schlüssel/Wert-Speicher darstellt.</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
