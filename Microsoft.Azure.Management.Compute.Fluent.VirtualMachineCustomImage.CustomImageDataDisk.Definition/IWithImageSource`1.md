<Type Name="IWithImageSource&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineCustomImage.CustomImageDataDisk.Definition.IWithImageSource&lt;ParentT&gt;">
  ...
  <Docs>
    ...
    <summary>
            Die Phase der Image-Definition ermöglicht die Quelle der Daten auf Datenträger Image.
            </summary>
  ...
  <Members>
    <Member MemberName="FromManagedDisk">
      ...
      <Docs>
        ...
        <summary>
            Gibt verwaltete Quelldatenträger für der Daten-Datenträger-Imagedatei an.
            </summary>
    ...
    <Member MemberName="FromSnapshot">
      ...
      <Docs>
        ...
        <summary>
            Gibt die Quellmomentaufnahme für die Datenträger-Imagedatei Daten.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
    ...
    <Member MemberName="FromVhd">
      ...
      <Docs>
        ...
        <summary>
            Gibt die Quelle VHD für das Daten-Datenträger-Image.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
