<Type Name="CommunicationClientEventArgs" FullName="Microsoft.ServiceFabric.Services.Communication.Client.CommunicationClientEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a46d4-101">Gibt die Argumente für die Kommunikation von Client verbunden/getrennt Ereignisse-Handler.</span><span class="sxs-lookup"><span data-stu-id="a46d4-101">Specifies the arguments for the communication client connected/disconnected events handler.</span></span>
            </summary>
