<Type Name="ExceptionHandlingThrowResult" FullName="Microsoft.ServiceFabric.Services.Communication.Client.ExceptionHandlingThrowResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="47243-101">Gibt an, die Ausnahmebehandlung Ergebnis, wenn die Anforderung vom Client an den Dienst nicht wiederholt werden kann</span><span class="sxs-lookup"><span data-stu-id="47243-101">Specifies the exception handling result when the request from client to service cannot be retried</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ExceptionToThrow">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="47243-102">Die Ausnahme, die an den Client ausgelöst werden soll.</span><span class="sxs-lookup"><span data-stu-id="47243-102">The exception that should be thrown to the client.</span></span>
            </summary>
        <value><span data-ttu-id="47243-103">Ausnahme ausgelöst werden soll</span><span class="sxs-lookup"><span data-stu-id="47243-103">Exception to throw</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
