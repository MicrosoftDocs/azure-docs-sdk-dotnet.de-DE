<Type Name="SasDefinitionItem" FullName="Microsoft.Azure.KeyVault.Models.SasDefinitionItem">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="afc2d-101">Der Speicher-SAS-Definition Elementmetadaten mit Speicher-SAS-Definition.</span><span class="sxs-lookup"><span data-stu-id="afc2d-101">The storage SAS definition item containing storage SAS definition metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-102">Initialisiert eine neue Instanz der SasDefinitionItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afc2d-102">Initializes a new instance of the SasDefinitionItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="afc2d-103">Der Bezeichner für den Speicher-SAS.</span><span class="sxs-lookup"><span data-stu-id="afc2d-103">The storage SAS identifier.</span></span></param>
        <param name="secretId"><span data-ttu-id="afc2d-104">Die Speicher-Konto-SAS-Definition für den geheimen-ID.</span><span class="sxs-lookup"><span data-stu-id="afc2d-104">The storage account SAS definition secret id.</span></span></param>
        <param name="attributes"><span data-ttu-id="afc2d-105">Die SAS-Definition Management-Attribute.</span><span class="sxs-lookup"><span data-stu-id="afc2d-105">The SAS definition management attributes.</span></span></param>
        <param name="tags"><span data-ttu-id="afc2d-106">Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</span><span class="sxs-lookup"><span data-stu-id="afc2d-106">Application specific metadata in the form of key-value pairs.</span></span></param>
        <summary>
            <span data-ttu-id="afc2d-107">Initialisiert eine neue Instanz der SasDefinitionItem-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afc2d-107">Initializes a new instance of the SasDefinitionItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Attributes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-108">Ruft die Definition des SAS-Management-Attribute ab.</span><span class="sxs-lookup"><span data-stu-id="afc2d-108">Gets the SAS definition management attributes.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-109">Ruft den Speicher-SAS-Bezeichner ab.</span><span class="sxs-lookup"><span data-stu-id="afc2d-109">Gets the storage SAS identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Identifier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-110">Der schlüsseltresor Speicher SAS-Definition Bezeichner.</span><span class="sxs-lookup"><span data-stu-id="afc2d-110">The key vault storage SAS definition identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecretId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-111">Ruft die Konto-SAS-Definition für den geheimen-Id ab.</span><span class="sxs-lookup"><span data-stu-id="afc2d-111">Gets the storage account SAS definition secret id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afc2d-112">Ruft die Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren ab.</span><span class="sxs-lookup"><span data-stu-id="afc2d-112">Gets application specific metadata in the form of key-value pairs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
