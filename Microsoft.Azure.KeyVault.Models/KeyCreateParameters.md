<Type Name="KeyCreateParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyCreateParameters">
  ...
  <Docs>
    <summary>
            Erstellen des Schlüssels-Parameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeyCreateParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kty">Der Typ des Schlüssels zu erstellen. Gültige Werte finden Sie unter JsonWebKeyType. Folgende Werte sind möglich: "EC", "EC-HSM", "RSA", "RSA-HSM", "oct"</param>
        <param name="keySize">Die Schlüsselgröße in Bytes. Z. B. 1024 oder
            2048.</param>
        ...
        <param name="curve">Name der Elliptische Kurve. Gültige Werte finden Sie unter JsonWebKeyCurveName. Folgende Werte sind möglich: "P-256", "P-384", "P-521", "SECP256K1"</param>
        <summary>
            Initialisiert eine neue Instanz der KeyCreateParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Curve">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Elliptische Kurve Namen. Gültige Werte finden Sie unter JsonWebKeyCurveName. Folgende Werte sind möglich: "P-256", "P-384", "P-521", "SECP256K1"
            </summary>
    ...
    <Member MemberName="KeySize">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Größe des Schlüssels in Bytes fest. Z. B. 1024 oder 2048.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Kty">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Typ des Schlüssels zu erstellen. Gültige Werte finden Sie unter JsonWebKeyType. Folgende Werte sind möglich: "EC", "EC-HSM", "RSA", "RSA-HSM", "oct"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
