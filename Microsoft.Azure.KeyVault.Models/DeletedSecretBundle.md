<Type Name="DeletedSecretBundle" FullName="Microsoft.Azure.KeyVault.Models.DeletedSecretBundle">
  ...
  <Docs>
    <summary>
            Eine gelöscht geheime Schlüssel besteht aus vorherigen-Id, Attribute und die Tags, sowie Informationen auf, wenn sie gelöscht werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DeletedSecretBundle-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">Der geheime Wert.</param>
        <param name="id">Der Id.</param>
        <param name="contentType">Der Inhaltstyp des geheimen Schlüssels.</param>
        <param name="attributes">Die Attribute für den geheimen Management.</param>
        <param name="tags">Anwendung bestimmter Metadaten in Form von Schlüssel-Wert-Paaren.</param>
        <param name="kid">Wenn es sich um einen geheimen Schlüssel Sichern eines Zertifikats KV handelt, gibt dieses Feld den entsprechenden Schlüssel des Zertifikats KV sichern.</param>
        <param name="managed">"True", wenn der geheime Lebensdauer von schlüsseltresor verwaltet wird. Wenn es sich um einen geheimen Sicherungsspeicher handelt werden "true" ein Zertifikat, klicken Sie dann verwaltet.</param>
        <param name="recoveryId">Die Url der Recovery-Objekt, zum Identifizieren und Wiederherstellen den gelöschten geheime Schlüssel verwendet.</param>
        <param name="scheduledPurgeDate">Die Zeit, wenn der geheime Schlüssel geplant ist (UTC) gelöscht werden</param>
        <param name="deletedDate">Die Zeit, wenn der geheime Schlüssel (UTC) gelöscht wurde</param>
        <summary>
            Initialisiert eine neue Instanz der DeletedSecretBundle-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DeletedDate">
      ...
      <Docs>
        <summary>
            Ruft die Zeit, wenn der geheime Schlüssel, in UTC gelöscht wurde, ab
            </summary>
    ...
    <Member MemberName="RecoveryId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Url der Recovery-Objekt, zum Identifizieren und Wiederherstellen den gelöschten geheime Schlüssel verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryIdentifier">
      ...
      <Docs>
        <summary>
            Der Bezeichner des geheimen gelöschten Objekts. Hiermit wird den geheime Schlüssel wiederhergestellt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScheduledPurgeDate">
      ...
      <Docs>
        <summary>
            Ruft die Zeit, wenn der geheime Schlüssel geplant ist (UTC) gelöscht werden
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
