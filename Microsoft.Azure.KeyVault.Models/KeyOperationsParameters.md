<Type Name="KeyOperationsParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyOperationsParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeyOperationsParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="algorithm">Algorithmusbezeichner. Folgende Werte sind möglich: "RSA-OAEP", "RSA-OAEP-256", "RSA1_5"</param>
    ...
    <Member MemberName="Algorithm">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt diesen fest Algorithmus. Folgende Werte sind möglich: "RSA-OAEP", "RSA-OAEP-256", "RSA1_5"
            </summary>
