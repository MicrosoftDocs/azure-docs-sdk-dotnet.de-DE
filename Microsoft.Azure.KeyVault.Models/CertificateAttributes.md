<Type Name="CertificateAttributes" FullName="Microsoft.Azure.KeyVault.Models.CertificateAttributes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1e753-101">Die Zertifikat-Management-Attribute.</span><span class="sxs-lookup"><span data-stu-id="1e753-101">The certificate management attributes.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1e753-102">Initialisiert eine neue Instanz der CertificateAttributes-Klasse.</span><span class="sxs-lookup"><span data-stu-id="1e753-102">Initializes a new instance of the CertificateAttributes class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="1e753-103">Bestimmt, ob das Objekt aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="1e753-103">Determines whether the object is enabled.</span></span></param>
        <param name="notBefore"><span data-ttu-id="1e753-104">Nicht vor dem Datum in UTC.</span><span class="sxs-lookup"><span data-stu-id="1e753-104">Not before date in UTC.</span></span></param>
        <param name="expires"><span data-ttu-id="1e753-105">Ablaufdatum in UTC.</span><span class="sxs-lookup"><span data-stu-id="1e753-105">Expiry date in UTC.</span></span></param>
        <param name="created"><span data-ttu-id="1e753-106">Der Erstellungszeitpunkt (UTC).</span><span class="sxs-lookup"><span data-stu-id="1e753-106">Creation time in UTC.</span></span></param>
        <param name="updated"><span data-ttu-id="1e753-107">Letzte aktualisierte Zeit in UTC.</span><span class="sxs-lookup"><span data-stu-id="1e753-107">Last updated time in UTC.</span></span></param>
        <param name="recoveryLevel"><span data-ttu-id="1e753-108">Gibt die löschen Recovery Ebene derzeit wirksamen für Zertifikate in den aktuellen Tresor wieder.</span><span class="sxs-lookup"><span data-stu-id="1e753-108">Reflects the deletion recovery level currently in effect for certificates in the current vault.</span></span> <span data-ttu-id="1e753-109">Wenn sie "Purgeable" enthält, kann das Zertifikat von einem privilegierten Benutzer endgültig gelöscht werden; Andernfalls kann nur das System das Zertifikat am Ende das beibehaltungsintervall löschen.</span><span class="sxs-lookup"><span data-stu-id="1e753-109">If it contains 'Purgeable', the certificate can be permanently deleted by a privileged user; otherwise, only the system can purge the certificate, at the end of the retention interval.</span></span> <span data-ttu-id="1e753-110">Folgende Werte sind möglich: "Purgeable", "Behebbarer + Purgeable", "Wiederherstellbar", "Behebbarer + ProtectedSubscription"</span><span class="sxs-lookup"><span data-stu-id="1e753-110">Possible values include: 'Purgeable', 'Recoverable+Purgeable', 'Recoverable', 'Recoverable+ProtectedSubscription'</span></span></param>
        <summary>
            <span data-ttu-id="1e753-111">Initialisiert eine neue Instanz der CertificateAttributes-Klasse.</span><span class="sxs-lookup"><span data-stu-id="1e753-111">Initializes a new instance of the CertificateAttributes class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RecoveryLevel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1e753-112">Ruft widerspiegelt löschen Wiederherstellung die Ebene des derzeit wirksamen für Zertifikate in den aktuellen Tresor.</span><span class="sxs-lookup"><span data-stu-id="1e753-112">Gets reflects the deletion recovery level currently in effect for certificates in the current vault.</span></span> <span data-ttu-id="1e753-113">Wenn sie "Purgeable" enthält, kann das Zertifikat von einem privilegierten Benutzer endgültig gelöscht werden; Andernfalls kann nur das System das Zertifikat am Ende das beibehaltungsintervall löschen.</span><span class="sxs-lookup"><span data-stu-id="1e753-113">If it contains 'Purgeable', the certificate can be permanently deleted by a privileged user; otherwise, only the system can purge the certificate, at the end of the retention interval.</span></span> <span data-ttu-id="1e753-114">Folgende Werte sind möglich: "Purgeable", "Behebbarer + Purgeable", "Wiederherstellbar", "Behebbarer + ProtectedSubscription"</span><span class="sxs-lookup"><span data-stu-id="1e753-114">Possible values include: 'Purgeable', 'Recoverable+Purgeable', 'Recoverable', 'Recoverable+ProtectedSubscription'</span></span>
            </summary>
