<Type Name="CertificateAttributes" FullName="Microsoft.Azure.KeyVault.Models.CertificateAttributes">
  ...
  <Docs>
    <summary>
            Die Zertifikat-Management-Attribute.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CertificateAttributes-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="recoveryLevel">Gibt die löschen Recovery Ebene derzeit wirksamen für Zertifikate in den aktuellen Tresor wieder. Wenn sie "Purgeable" enthält, kann das Zertifikat von einem privilegierten Benutzer endgültig gelöscht werden; Andernfalls kann nur das System das Zertifikat am Ende das beibehaltungsintervall löschen. Folgende Werte sind möglich: "Purgeable", "Behebbarer + Purgeable", "Wiederherstellbar", "Behebbarer + ProtectedSubscription"</param>
        <summary>
            Initialisiert eine neue Instanz der CertificateAttributes-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RecoveryLevel">
      ...
      <Docs>
        <summary>
            Ruft widerspiegelt löschen Wiederherstellung die Ebene des derzeit wirksamen für Zertifikate in den aktuellen Tresor. Wenn sie "Purgeable" enthält, kann das Zertifikat von einem privilegierten Benutzer endgültig gelöscht werden; Andernfalls kann nur das System das Zertifikat am Ende das beibehaltungsintervall löschen. Folgende Werte sind möglich: "Purgeable", "Behebbarer + Purgeable", "Wiederherstellbar", "Behebbarer + ProtectedSubscription"
            </summary>
