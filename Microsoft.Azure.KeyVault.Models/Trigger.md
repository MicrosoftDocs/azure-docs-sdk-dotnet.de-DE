<Type Name="Trigger" FullName="Microsoft.Azure.KeyVault.Models.Trigger">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b3f01-101">Eine Bedingung, die für eine Aktion ausgeführt werden, erfüllt werden.</span><span class="sxs-lookup"><span data-stu-id="b3f01-101">A condition to be satisfied for an action to be executed.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b3f01-102">Initialisiert eine neue Instanz der betreffenden auslöserklasse.</span><span class="sxs-lookup"><span data-stu-id="b3f01-102">Initializes a new instance of the Trigger class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lifetimePercentage"><span data-ttu-id="b3f01-103">Prozentsatz der Lebensdauer, auf denen ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="b3f01-103">Percentage of lifetime at which to trigger.</span></span> <span data-ttu-id="b3f01-104">Wert muss zwischen 1 und 99 liegen.</span><span class="sxs-lookup"><span data-stu-id="b3f01-104">Value should be between 1 and 99.</span></span></param>
        <param name="daysBeforeExpiry"><span data-ttu-id="b3f01-105">Tage bis zum Ablauf.</span><span class="sxs-lookup"><span data-stu-id="b3f01-105">Days before expiry.</span></span></param>
        <summary>
            <span data-ttu-id="b3f01-106">Initialisiert eine neue Instanz der betreffenden auslöserklasse.</span><span class="sxs-lookup"><span data-stu-id="b3f01-106">Initializes a new instance of the Trigger class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DaysBeforeExpiry">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b3f01-107">Ruft ab oder Tage vor Ablauf festgelegt.</span><span class="sxs-lookup"><span data-stu-id="b3f01-107">Gets or sets days before expiry.</span></span>
            </summary>
    ...
    <Member MemberName="LifetimePercentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b3f01-108">Abrufen oder Festlegen der Prozentsatz der Lebensdauer, auf denen ausgelöst.</span><span class="sxs-lookup"><span data-stu-id="b3f01-108">Gets or sets percentage of lifetime at which to trigger.</span></span> <span data-ttu-id="b3f01-109">Wert muss zwischen 1 und 99 liegen.</span><span class="sxs-lookup"><span data-stu-id="b3f01-109">Value should be between 1 and 99.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b3f01-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="b3f01-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b3f01-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="b3f01-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
