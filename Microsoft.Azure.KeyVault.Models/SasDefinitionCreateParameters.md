<Type Name="SasDefinitionCreateParameters" FullName="Microsoft.Azure.KeyVault.Models.SasDefinitionCreateParameters">
  ...
  <Docs>
    <summary>
            Erstellen der Definition des SAS-Parameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SasDefinitionCreateParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="parameters">SAS-Definition Erstellung Metadaten in Form von Schlüssel-Wert-Paaren.</param>
        <param name="sasDefinitionAttributes">Die Attribute der SAS-Definition.</param>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie Metadaten für die Erstellung von Sas-Definition in Form von Schlüssel-Wert-Paare fest.
            </summary>
    ...
    <Member MemberName="SasDefinitionAttributes">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Attribute der SAS-Definition.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
