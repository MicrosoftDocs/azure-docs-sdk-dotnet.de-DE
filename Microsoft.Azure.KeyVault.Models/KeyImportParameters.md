<Type Name="KeyImportParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyImportParameters">
  ...
  <Docs>
    <summary>
            Die wichtigsten Importparameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeyImportParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="hsm">Ob als Hardwareschlüssel (HSM) oder Softwareschlüssel zu importieren.</param>
        <param name="keyAttributes">Die schlüsselverwaltung-Attribute.</param>
    ...
    <Member MemberName="Hsm">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob als Hardwareschlüssel (HSM) oder Softwareschlüssel zu importieren.
            </summary>
