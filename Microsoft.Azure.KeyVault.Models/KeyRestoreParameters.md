<Type Name="KeyRestoreParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyRestoreParameters">
  ...
  <Docs>
    <summary>
            Die wichtigsten Restore-Parameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeyRestoreParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyBundleBackup">Der Blob-Sicherungsdatei eine wichtige Paket zugeordnet.</param>
        <summary>
            Initialisiert eine neue Instanz der KeyRestoreParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyBundleBackup">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Blob-Sicherungsdatei eine wichtige Paket zugeordnet.
            </summary>
