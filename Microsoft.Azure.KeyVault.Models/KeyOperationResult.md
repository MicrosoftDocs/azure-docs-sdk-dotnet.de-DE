<Type Name="KeyOperationResult" FullName="Microsoft.Azure.KeyVault.Models.KeyOperationResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der KeyOperationResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">Schlüssel-ID</param>
    ...
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            Ruft den Schlüsselbezeichner ab
            </summary>
