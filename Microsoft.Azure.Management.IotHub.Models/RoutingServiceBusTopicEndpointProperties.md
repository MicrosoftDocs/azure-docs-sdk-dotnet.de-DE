<Type Name="RoutingServiceBusTopicEndpointProperties" FullName="Microsoft.Azure.Management.IotHub.Models.RoutingServiceBusTopicEndpointProperties">
  ...
  <Docs>
    <summary>
            Die Eigenschaften im Zusammenhang mit Endpunkttypen der Servicebus-Thema.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RoutingServiceBusTopicEndpointProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="connectionString">Die Verbindungszeichenfolge der Servicebus-Thema-Endpunkt.</param>
        <param name="name">Der Name zum Identifizieren von diesem Endpunkt. Der Name kann nur alphanumerische Zeichen, Punkte, Unterstriche, Bindestriche enthalten und besitzt eine maximale Länge von 64 Zeichen lang sein. Die folgenden Namen sind reserviert: Ereignisse, OperationsMonitoringEvents, FileNotifications, $default. Endpunktnamen müssen über Endpunkttypen eindeutig sein.  Der Name muss nicht identisch mit dem tatsächlichen Themanamen sein.</param>
        <param name="subscriptionId">Die Abonnement-ID des Servicebus-Thema-Endpunkt.</param>
        <param name="resourceGroup">Der Name der Ressourcengruppe des Servicebus-Thema-Endpunkt.</param>
        <summary>
            Initialisiert eine neue Instanz der RoutingServiceBusTopicEndpointProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Verbindungszeichenfolge der Servicebus-Thema-Endpunkt.
            </summary>
    ...
    <Member MemberName="ResourceGroup">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Ressourcengruppe des Servicebus-Thema-Endpunkt fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Abonnement-ID des Servicebus-Thema-Endpunkt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
