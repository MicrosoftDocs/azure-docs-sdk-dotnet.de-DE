<Type Name="RouteProperties" FullName="Microsoft.Azure.Management.IotHub.Models.RouteProperties">
  ...
  <Docs>
    <summary>
            Die Eigenschaften des eine Routingregel, die Ihren IoT Hub zum Weiterleiten von Nachrichten an Endpunkte verwendet.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RouteProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Route. Der Name kann nur alphanumerische Zeichen, Punkte, Unterstriche, Bindestriche enthalten, hat eine maximale Länge von 64 Zeichen lang sein und muss eindeutig sein.</param>
        <param name="source">Die Quelle, die die Routingregel, z. B. DeviceMessages angewendet werden. Folgende Werte sind möglich: "DeviceMessages", "TwinChangeEvents", "DeviceLifecycleEvents", "DeviceJobLifecycleEvents"</param>
        <param name="endpointNames">Die Liste der Endpunkte, die an die Nachrichten, die die Bedingung erfüllen weitergeleitet werden. Derzeit wird nur ein einziger Endpunkt zulässig.</param>
        <param name="isEnabled">Dient zum angeben, ob eine Route aktiviert ist.</param>
        <param name="condition">Die Bedingung, die ausgewertet wird, um die Weiterleitungsregel anzuwenden. Wenn keine Bedingung angegeben wird, wertet er standardmäßig auf "true". Grammatik, finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language</param>
        <summary>
            Initialisiert eine neue Instanz der RouteProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Condition">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Bedingung, die ausgewertet wird, um die Weiterleitungsregel anzuwenden. Wenn keine Bedingung angegeben wird, wertet er standardmäßig auf "true".
            Grammatik, finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language
            </summary>
    ...
    <Member MemberName="EndpointNames">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Endpunkte, die an die Nachrichten, die die Bedingung erfüllen weitergeleitet werden. Derzeit wird nur ein einziger Endpunkt zulässig.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsEnabled">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest, die verwendet, um anzugeben, ob eine Route aktiviert ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Route fest. Der Name kann nur alphanumerische Zeichen, Punkte, Unterstriche, Bindestriche enthalten, hat eine maximale Länge von 64 Zeichen lang sein und muss eindeutig sein.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Source">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Quelle, die die Routingregel, z. B. DeviceMessages angewendet werden. Folgende Werte sind möglich: "DeviceMessages", "TwinChangeEvents", "DeviceLifecycleEvents", "DeviceJobLifecycleEvents"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
