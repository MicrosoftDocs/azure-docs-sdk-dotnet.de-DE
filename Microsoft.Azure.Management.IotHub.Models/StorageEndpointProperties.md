<Type Name="StorageEndpointProperties" FullName="Microsoft.Azure.Management.IotHub.Models.StorageEndpointProperties">
  ...
  <Docs>
    <summary>
            Die Eigenschaften des Azure-Speicher-Endpunkts für die Datei hochgeladen werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der StorageEndpointProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="connectionString">Die Verbindungszeichenfolge für das Azure-Speicherkonto auf dem Dateien hochgeladen werden.</param>
        <param name="containerName">Der Name des Stammcontainers, in dem Sie Dateien hochladen. Der Container muss nicht vorhanden, aber sollten erstellt mithilfe der "ConnectionString" angegeben werden.</param>
        <param name="sasTtlAsIso8601">Der Zeitraum für die die der SAS-URI generiert durch den IoT Hub Dateiupload ist ungültig. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.</param>
        <summary>
            Initialisiert eine neue Instanz der StorageEndpointProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Verbindungszeichenfolge für das Azure-Speicherkonto auf dem Dateien hochgeladen werden.
            </summary>
    ...
    <Member MemberName="ContainerName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Stammcontainers fest, in dem Sie Dateien hochladen.
            Der Container muss nicht vorhanden, aber sollten erstellt mithilfe der "ConnectionString" angegeben werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SasTtlAsIso8601">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Zeitraum für die die der SAS-URI generiert durch den IoT Hub Dateiupload ist ungültig. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-file-upload#file-upload-notification-configuration-options.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
