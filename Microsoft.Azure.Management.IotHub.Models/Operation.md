<Type Name="Operation" FullName="Microsoft.Azure.Management.IotHub.Models.Operation">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Vorgangsname: {Anbieter} / {Resource} / {Lesen | Schreiben | Aktion | löschen}</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft die Vorgangsname: {Anbieter} / {Resource} / {Lesen | Schreiben | Aktion | löschen}
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
