<Type Name="IotHubSkuInfo" FullName="Microsoft.Azure.Management.IotHub.Models.IotHubSkuInfo">
  ...
  <Docs>
    <summary>
            Informationen über die SKU von IoT Hub.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der IotHubSkuInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der SKU. Folgende Werte sind möglich: "F1", "S1", "S2", "S3"</param>
        <param name="capacity">Die Anzahl der bereitgestellten IoT Hub-Einheiten.
            Finden Sie unter: https://docs.microsoft.com/azure/azure-subscription-service-limits#iot-hub-limits.</param>
        <param name="tier">Die abrechnungsebene für den IoT Hub. Folgende Werte sind möglich: "Free", "Standard"</param>
        <summary>
            Initialisiert eine neue Instanz der IotHubSkuInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der bereitgestellten IoT Hub-Einheiten. Finden Sie unter: https://docs.microsoft.com/azure/azure-subscription-service-limits#iot-hub-limits.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der SKU. Folgende Werte sind möglich: "F1", "S1", "S2", "S3"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ruft die abrechnungsebene für IoT Hub ab. Folgende Werte sind möglich: "Free", "Standard"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
