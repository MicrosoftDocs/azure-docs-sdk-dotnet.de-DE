<Type Name="CertificateBodyDescription" FullName="Microsoft.Azure.Management.IotHub.Models.CertificateBodyDescription">
  ...
  <Docs>
    <summary>
            Die JSON-serialisierten X509 Zertifikat.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CertificateBodyDescription-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="certificate">Base64-Darstellung der X509 CER-Zertifikatdatei Blatt- oder nur PEM-Datei Inhalt.</param>
        <summary>
            Initialisiert eine neue Instanz der CertificateBodyDescription-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Certificate">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Base64-Darstellung der X509 CER-Zertifikatdatei Blatt- oder nur PEM-Datei Inhalt.
            </summary>
