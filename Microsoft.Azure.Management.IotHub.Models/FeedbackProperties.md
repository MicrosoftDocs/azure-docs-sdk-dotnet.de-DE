<Type Name="FeedbackProperties" FullName="Microsoft.Azure.Management.IotHub.Models.FeedbackProperties">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FeedbackProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lockDurationAsIso8601">Die Dauer der Sperre für die feedbackwarteschlange. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.</param>
        <param name="ttlAsIso8601">Die Zeitspanne, für die eine Nachricht zu verarbeiten, bevor es vom IoT Hub als abgelaufen gilt verfügbar ist. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.</param>
        <param name="maxDeliveryCount">Die Anzahl der Versuche IoT Hub, auf die feedbackwarteschlange eine Nachricht zuzustellen. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.</param>
        <summary>
            Initialisiert eine neue Instanz der FeedbackProperties-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="LockDurationAsIso8601">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Dauer der Sperre für die feedbackwarteschlange. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
            </summary>
    ...
    <Member MemberName="MaxDeliveryCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der Versuche IoT Hub, auf die feedbackwarteschlange eine Nachricht zuzustellen. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TtlAsIso8601">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeitspanne, für die eine Nachricht zu verarbeiten, bevor es vom IoT Hub als abgelaufen gilt verfügbar ist. Finden Sie unter: https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
