<Type Name="SharedAccessSignatureAuthorizationRule" FullName="Microsoft.Azure.Management.IotHub.Models.SharedAccessSignatureAuthorizationRule">
  ...
  <Docs>
    <summary>
            Die Eigenschaften des IoT Hub freigegebenen Zugriffsrichtlinien.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SharedAccessSignatureAuthorizationRule-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyName">Der Name der Richtlinie für freigegebenen Zugriff.</param>
        <param name="rights">Die Berechtigungen, die die SAS-Richtlinie zugewiesen ist. Mögliche Werte sind: "RegistryRead", "RegistryWrite", "ServiceConnect", "DeviceConnect", 'RegistryRead RegistryWrite', 'RegistryRead, ServiceConnect', 'RegistryRead, DeviceConnect', 'RegistryWrite, ServiceConnect', ' RegistryWrite, DeviceConnect', 'ServiceConnect, DeviceConnect', "RegistryRead RegistryWrite, ServiceConnect", "RegistryRead RegistryWrite, DeviceConnect", "RegistryRead ServiceConnect, DeviceConnect", "RegistryWrite ServiceConnect, DeviceConnect", " RegistryRead, RegistryWrite, ServiceConnect, DeviceConnect "</param>
        <param name="primaryKey">Der primäre Schlüssel.</param>
        <param name="secondaryKey">Der sekundäre Schlüssel.</param>
        <summary>
            Initialisiert eine neue Instanz der SharedAccessSignatureAuthorizationRule-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Richtlinie für freigegebenen Zugriff.
            </summary>
    ...
    <Member MemberName="PrimaryKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den primären Schlüssel fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Rights">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Berechtigungen, die die SAS-Richtlinie zugewiesen ist.
    ...
    <Member MemberName="SecondaryKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den sekundären Schlüssel fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
