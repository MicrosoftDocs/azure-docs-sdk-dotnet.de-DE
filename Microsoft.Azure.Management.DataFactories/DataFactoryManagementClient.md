<Type Name="DataFactoryManagementClient" FullName="Microsoft.Azure.Management.DataFactories.DataFactoryManagementClient">
  ...
  <Docs>
    <summary>
            Client für die Interaktion mit dem Azure Data Factory-Dienst.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Management.DataFactories.DataFactoryManagementClient" />-Klasse. 
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="credentials">
            Erforderlich. Wenn Sie einen Windows Azure-Abonnement erstellen, wird er eindeutig durch eine Abonnement-ID identifiziert. Die Abonnement-ID ist Teil der URI für jeden Aufruf, die Sie an die Dienstverwaltungs-API vornehmen. Der Windows Azure-Dienst ManagementAPI verwenden gegenseitige Authentifizierung von verwaltungszertifikaten über SSL, um sicherzustellen, dass eine Anforderung an den Dienst sicher ist. Keine anonyme Anforderungen sind zulässig.
            </param>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Management.DataFactories.DataFactoryManagementClient" />-Klasse. 
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="baseUri">
            Optional. Der URI, der als Basis für alle Service Management-Anforderungen verwendet wird.
            </param>
        <param name="httpClient">
            Der HTTP-client
            </param>
    ...
    <Member MemberName="Clone">
      ...
      <Docs>
        <param name="client">
            Instanz des DataFactoryManagementClient zum Klonen in
            </param>
        <summary>
            Klont Eigenschaften aus der aktuellen Instanz in eine andere DataFactoryManagementClient-Instanz an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LongRunningOperationInitialTimeout">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das ursprüngliche Timeout für zeitintensive Vorgänge (in Sekunden) fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das wiederholungstimeout für zeitintensive Vorgänge (in Sekunden) fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OAuth">
      ...
      <Docs>
        <summary>
            Vorgänge für die OAuth-Autorisierung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
