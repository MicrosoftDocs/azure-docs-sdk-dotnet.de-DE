<Type Name="IActivityWindowOperations" FullName="Microsoft.Azure.Management.DataFactories.IActivityWindowOperations">
  ...
  <Members>
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="parameters">
            Windows-Liste von Pipeline-Aktivitätsparameter Aktivitäten.
            </param>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="parameters">
            Aktivität Windows eine Liste optionaler Filterparameter aufgetreten.
            </param>
        <param name="cancellationToken">
            Abbruchtoken.
            </param>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="parameters">
            Windows-Aktivitätsliste von datasetparameter.
            </param>
        <param name="cancellationToken">
            Abbruchtoken.
            </param>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="parameters">
            Windows-Aktivitätsliste von Pipeline-Parameter.
            </param>
        <param name="cancellationToken">
            Abbruchtoken.
            </param>
