<Type Name="IWithRequestTimeout" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Update.IWithRequestTimeout">
  ...
  <Docs>
    <summary>
            Die Stufe der eine Anwendung Gateway Back-End-HTTP-Konfiguration ermöglicht das Anforderungstimeout angeben.
            </summary>
  ...
  <Members>
    <Member MemberName="WithRequestTimeout">
      ...
      <Docs>
        <param name="seconds">Eine Anzahl von Sekunden.</param>
        <summary>
            Gibt das Anforderungstimeout.
            </summary>
