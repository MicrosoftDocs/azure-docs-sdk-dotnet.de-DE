<Type Name="IWithTxtRecordTextValue" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Update.IWithTxtRecordTextValue">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5f2e4-101">Die Stufe der SRV-Datensatz Definition ermöglicht hinzufügen oder Entfernen von TXT-Eintrag.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-101">The stage of the SRV record definition allowing to add or remove TXT record.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WithoutText">
      ...
      <Docs>
        <param name="text"><span data-ttu-id="5f2e4-102">Der Textwert.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-102">The text value.</span></span></param>
        <summary>
            <span data-ttu-id="5f2e4-103">Entfernt einen Txt-Eintrag mit dem angegebenen Text von diesen Datensatz.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-103">Removes a Txt record with the given text from this record set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5f2e4-104">Die nächste Phase des Recordset-Updates.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-104">The next stage of the record set update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithText">
      ...
      <Docs>
        <param name="text"><span data-ttu-id="5f2e4-105">Der Textwert.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-105">The text value.</span></span></param>
        <summary>
            <span data-ttu-id="5f2e4-106">Erstellt einen Txt-Eintrag mit dem angegebenen Text in diesen Datensatz.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-106">Creates a Txt record with the given text in this record set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5f2e4-107">Die nächste Phase des Recordset-Updates.</span><span class="sxs-lookup"><span data-stu-id="5f2e4-107">The next stage of the record set update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>