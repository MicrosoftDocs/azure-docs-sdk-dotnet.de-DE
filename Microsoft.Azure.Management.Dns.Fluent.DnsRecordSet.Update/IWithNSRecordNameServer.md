<Type Name="IWithNSRecordNameServer" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Update.IWithNSRecordNameServer">
  ...
  <Docs>
    <summary>
            Die Phase der NS Ressourceneintragssatz Definition Möglichkeit zum Hinzufügen oder Entfernen einer Namenservereintrag.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WithoutNameServer">
      ...
      <Docs>
        <param name="nameServerHostName">Der Server den Hostnamen.</param>
        <summary>
            Rmoves NS-Datensatz mit dem angegebenen Namenserver aus dieser Datensatz festgelegt.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Die nächste Phase des Recordset-Updates.</return>
