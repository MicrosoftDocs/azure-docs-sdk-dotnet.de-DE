<Type Name="IWithOptionalProperties" FullName="Microsoft.Azure.Management.Batch.Fluent.Application.Update.IWithOptionalProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0ae60-101">Die Phase einer Anwendung aktualisieren, aktivieren oder deaktivieren die automatische Aktualisierung der Anwendung ermöglicht.</span><span class="sxs-lookup"><span data-stu-id="0ae60-101">The stage of an application update allowing to enable or disable auto upgrade of the application.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithAllowUpdates">
      ...
      <Docs>
        <param name="allowUpdates"><span data-ttu-id="0ae60-102">"True", um die automatische Updates der Anwendung, andernfalls "false" zuzulassen.</span><span class="sxs-lookup"><span data-stu-id="0ae60-102">True to allow the automatic updates of the application, otherwise false.</span></span></param>
        <summary>
            <span data-ttu-id="0ae60-103">Kann automatische Anwendungsupdates an.</span><span class="sxs-lookup"><span data-stu-id="0ae60-103">Allows automatic application updates.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0ae60-104">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="0ae60-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithDisplayName">
      ...
      <Docs>
        <param name="displayName"><span data-ttu-id="0ae60-105">Ein Anzeigename.</span><span class="sxs-lookup"><span data-stu-id="0ae60-105">A display name.</span></span></param>
        <summary>
            <span data-ttu-id="0ae60-106">Gibt den Anzeigenamen für die Anwendung an.</span><span class="sxs-lookup"><span data-stu-id="0ae60-106">Specifies the display name for the application.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0ae60-107">die nächste Phase des Updates.</span><span class="sxs-lookup"><span data-stu-id="0ae60-107">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>