<Type Name="IUpdateSrvRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateSrvRecordSet.IUpdateSrvRecordSet">
  ...
  <Interfaces>
    ...
    <Interface>
      <InterfaceName>Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Update.IWithSrvRecordEntry</InterfaceName>
    </Interface>
    <Interface>
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2bca6-101">Die Gesamtheit der SRV-Eintrag festgelegt Update als Teil der übergeordneten DNS-Zone aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="2bca6-101">The entirety of a SRV record set update as a part of parent DNS zone update.</span></span>
            </summary>
