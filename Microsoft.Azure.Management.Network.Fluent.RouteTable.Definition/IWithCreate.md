<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            Die Phase der eine routingtabellendefinition enthält alle minimale erforderlichen Eingaben für die Ressource erstellt werden (über WithCreate.create()), sondern auch für andere optionalen Einstellungen angegeben werden.
            </summary>
