<Type Name="UsageStatistics" FullName="Microsoft.Azure.Batch.UsageStatistics">
  ...
  <Docs>
    <summary>
            Statistik zu Verwendungsdaten Pool.
            </summary>
  ...
  <Members>
    <Member MemberName="DedicatedCoreTime">
      ...
      <Docs>
        <summary>
            Ruft die aggregierten wanduhrzeit der dedizierten Serverknoten wird Teil des Pools an.
            </summary>
    ...
    <Member MemberName="LastUpdateTime">
      ...
      <Docs>
        <summary>
            Ruft den Zeitpunkt, an dem die Statistik zuletzt aktualisiert wurden. Alle Statistiken sind beschränkt auf den Bereich zwischen <see cref="P:Microsoft.Azure.Batch.UsageStatistics.StartTime" /> und diesen Wert.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
