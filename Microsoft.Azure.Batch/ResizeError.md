<Type Name="ResizeError" FullName="Microsoft.Azure.Batch.ResizeError">
  ...
  <Members>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            Ruft einen Code für den Pool poolgrößenänderungsfehler. Finden Sie unter <see cref="T:Microsoft.Azure.Batch.Common.PoolResizeErrorCodes" /> mögliche Werte.
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft eine Meldung angezeigt, den Pool größenänderungsfehler zurück, für die Anzeige in einer Benutzeroberfläche geeignet sein soll.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Values">
      ...
      <Docs>
        <summary>
            Ruft eine Liste mit zusätzlichen Fehlerinformationen im Zusammenhang mit dem Pool poolgrößenänderungsfehler.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
