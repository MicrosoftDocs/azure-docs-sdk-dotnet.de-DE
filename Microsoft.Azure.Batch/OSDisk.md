<Type Name="OSDisk" FullName="Microsoft.Azure.Batch.OSDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="db4d7-101">Einstellungen für den Betriebssystemdatenträger des virtuellen Computers.</span><span class="sxs-lookup"><span data-stu-id="db4d7-101">Settings for the operating system disk of the virtual machine.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="caching"><span data-ttu-id="db4d7-102">Der Typ des Zwischenspeichern konfigurieren, um für den Betriebssystem-Datenträger zu aktivieren.</span><span class="sxs-lookup"><span data-stu-id="db4d7-102">The type of caching to enable for the OS disk.</span></span></param>
        <summary>
            <span data-ttu-id="db4d7-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Batch.OSDisk" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="db4d7-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.Batch.OSDisk" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Caching">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="db4d7-104">Ruft den Typ des Zwischenspeicherns, um für den Betriebssystem-Datenträger zu aktivieren.</span><span class="sxs-lookup"><span data-stu-id="db4d7-104">Gets the type of caching to enable for the OS disk.</span></span>
            </summary>
