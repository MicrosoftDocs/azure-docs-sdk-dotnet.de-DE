<Type Name="NodeFile" FullName="Microsoft.Azure.Batch.NodeFile">
  ...
  <Docs>
    <summary>
            Macht Methoden und Eigenschaften aus Knoten oder Vorgänge auf Dateien zugreifen.
            </summary>
  ...
  <Members>
    <Member MemberName="CopyToStream">
      ...
      <Docs>
        <param name="stream">Der Stream, in das der Inhalt der Datei kopiert werden.</param>
        <param name="byteRange">Die Datei Bytebereich abgerufen. Wenn der Wert null ist, wird die gesamte Datei abgerufen.</param>
        ...
        <summary>
            Blockierenden Aufruf, um den Inhalt der Datei in dem angegebenen Stream zu kopieren.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyToStreamAsync">
      ...
      <Docs>
        ...
        <summary>
            Startet einen asynchronen Aufruf, um den Inhalt der Datei in dem angegebenen Stream zu kopieren.
            </summary>
    ...
    <Member MemberName="CustomBehaviors">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste der Verhaltensweisen, die ändern oder Anpassen von Anforderungen an den Batch-Dienst, die über dieses <see cref="T:Microsoft.Azure.Batch.NodeFile" />.
            </summary>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        ...
        <param name="additionalBehaviors">Eine Auflistung von BatchClientBehavior-Instanzen, die nach der CustomBehaviors für das aktuelle Objekt angewendet werden.</param>
        <summary>
            Blockierenden Aufruf zum Löschen der Datei an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <param name="cancellationToken">Ein <see cref="T:System.Threading.CancellationToken" /> für die Steuerung der Lebensdauer eines asynchronen Vorgangs.</param>
        <summary>
            Startet einen asynchronen Aufruf zum Löschen der Datei an.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task" />-Objekt, das den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDirectory">
      ...
      <Docs>
        <summary>
            Ruft den Wert, der angibt, ob die Datei ein Verzeichnis ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft die FileProperties der Datei ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadAsString">
      ...
      <Docs>
        <param name="encoding">Die Codierung verwendet, zum Interpretieren der Dateidaten. Wenn kein Wert oder Null angegeben wird, wird die UTF8 verwendet.</param>
        <param name="byteRange">Die Datei Bytebereich abgerufen. Wenn der Wert null ist, wird die gesamte Datei abgerufen.</param>
        <param name="additionalBehaviors">Eine Auflistung von BatchClientBehavior-Instanzen, die nach der CustomBehaviors für das aktuelle Objekt angewendet werden.</param>
        <summary>
            Blockierenden Aufruf, um den Inhalt der Datei als Zeichenfolge zurückzugeben.
            </summary>
        <returns>Eine Zeichenfolge mit dem Inhalt der Datei.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadAsStringAsync">
      ...
      <Docs>
        ...
        <param name="cancellationToken">Ein <see cref="T:System.Threading.CancellationToken" /> für die Steuerung der Lebensdauer eines asynchronen Vorgangs.</param>
        <summary>
            Startet die asynchronen Aufruf, um den Inhalt der Datei als Zeichenfolge zurückzugeben.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task" />-Objekt, das den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Refresh">
      ...
      <Docs>
        <param name="detailLevel">Die Detailstufe für die Aktualisierung.  Wenn einer der weglässt Detailebene der <see cref="P:Microsoft.Azure.Batch.NodeFile.Name" /> -Eigenschaft angegeben ist, scheitert die Aktualisierung.</param>
        <param name="additionalBehaviors">Eine Auflistung von <see cref="T:Microsoft.Azure.Batch.BatchClientBehavior" /> Instanzen, die für die Batchanforderung-Dienst nach gelten die <see cref="P:Microsoft.Azure.Batch.NodeFile.CustomBehaviors" />.</param>
        <summary>
            Aktualisiert das aktuelle <see cref="T:Microsoft.Azure.Batch.NodeFile" />.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
