<Type Name="JobSpecification" FullName="Microsoft.Azure.Batch.JobSpecification">
  ...
  <Docs>
    <summary>
            Die <see cref="P:Microsoft.Azure.Batch.CloudJobSchedule.JobSpecification" /> von einem <see cref="T:Microsoft.Azure.Batch.CloudJobSchedule" />.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="poolInformation">Der Pool, auf dem der Batch-Dienst führt die Aufgaben in der erstellten Aufträge über dieses <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.</param>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Batch.JobSpecification" />-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CommonEnvironmentSettings">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste der allgemeinen umgebungsvariableneinstellungen.
            </summary>
        <value>To be added.</value>
        <remarks>
            Diese Umgebungsvariablen festgelegt sind, für alle Aufgaben in den unter diesem erstellten Aufträge <see cref="T:Microsoft.Azure.Batch.CloudJobSchedule" /> (einschließlich der Auftrags-Manager, Auftrag zur Vorbereitung und Auftrag Version).
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Constraints">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ausführungseinschränkungen für Aufträge, die über diese erstellt <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Anzeigenamen für alle Aufträge, die über diese erstellt <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JobManagerTask">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Sie die Details einer Auftrags-Manager-Aufgabe gestartet werden, wenn ein Auftrag, über dieses erstellt wird <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JobPreparationTask">
      ...
      <Docs>
        <summary>
            Übernimmt oder bestimmt die Aufgabe Auftrag zur Vorbereitung für Aufträge, die über diese erstellt <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>
            Der Batch-Dienst wird die Auftrag zur Vorbereitung Aufgabe vor dem Starten alle Aufgaben dieses Auftrags auf diesem Computeknoten auf einem Serverknoten ausgeführt.
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="JobReleaseTask">
      ...
      <Docs>
        <summary>
            Übernimmt oder bestimmt die Version des Auftrags Aufgabe für Aufträge, die über diese erstellt <see cref="T:Microsoft.Azure.Batch.JobSpecification" />. 
            </summary>
        <value>To be added.</value>
        <remarks>
            Der Batch-Dienst führt den Auftrag Version Task aus, wenn der Auftrag beendet, in dem jede Aufgabe des Auftrags ausgeführt wurde, auf jedem Computeknoten.
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste von Name / Wert-Paaren, die über dieses erstellten Aufträge zugeordnet <see cref="T:Microsoft.Azure.Batch.JobSpecification" /> als Metadaten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PoolInformation">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Pool, auf dem der Batch-Dienst führt die Aufgaben in der erstellten Aufträge über dieses <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Priority">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Priorität der Aufträge, die über diese erstellt <see cref="T:Microsoft.Azure.Batch.JobSpecification" />.
            </summary>
        <value>To be added.</value>
        <remarks>
             Priority-Werte reichen von-1000 bis 1000,-1000 wird die niedrigste Priorität und 1000 die höchste Priorität.
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="UsesTaskDependencies">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt sie fest, ob die Aufgaben in Aufträgen unter diesem erstellt <see cref="T:Microsoft.Azure.Batch.CloudJobSchedule" /> Definieren der Abhängigkeiten können voneinander abhängig.
            </summary>
        <value>To be added.</value>
        <remarks>
