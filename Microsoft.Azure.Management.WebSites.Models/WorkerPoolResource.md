<Type Name="WorkerPoolResource" FullName="Microsoft.Azure.Management.WebSites.Models.WorkerPoolResource">
  ...
  <Docs>
    <summary>
            Workerpool einer App Service-Umgebung ARM-Ressource.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WorkerPoolResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="workerSizeId">Workergrößen-ID zum Verweisen auf diese workerpool.</param>
        <param name="computeMode">Freigegeben oder dediziert app gehostet wird. Folgende Werte sind möglich: "Shared", "Reserviert", "Dynamic"</param>
        <param name="workerSize">VM-Größe der Pool-Worker-Instanzen.</param>
        <param name="workerCount">Die Anzahl der Instanzen in der workerpool.</param>
        <param name="instanceNames">Die Namen aller Instanzen in der workerpool (schreibgeschützt).</param>
    ...
    <Member MemberName="ComputeMode">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, freigegeben oder dediziert app hosten. Folgende Werte sind möglich: "Shared", "Reserviert", "Dynamic"
            </summary>
    ...
    <Member MemberName="InstanceNames">
      ...
      <Docs>
        <summary>
            Ruft die Namen aller Instanzen in der workerpool (schreibgeschützt).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WorkerCount">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie Anzahl der Instanzen in der workerpool fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WorkerSize">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der VM-Größe der Pool-Worker-Instanzen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WorkerSizeId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie workergrößen-ID zum Verweisen auf diese workerpool fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
