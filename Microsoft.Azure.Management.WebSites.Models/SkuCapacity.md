<Type Name="SkuCapacity" FullName="Microsoft.Azure.Management.WebSites.Models.SkuCapacity">
  ...
  <Docs>
    <summary>
            Beschreibung der App Service-Plan Skalierungsoptionen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SkuCapacity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="minimum">Minimale Anzahl von Arbeitsthreads für diese App Service-Plan-SKU.</param>
        <param name="maximum">Maximale Anzahl von Arbeitsthreads für diese App Service-Plan-SKU.</param>
        <param name="defaultProperty">Die Standardanzahl der Worker für diese App Service-Plan-SKU.</param>
        <param name="scaleType">Verfügbare Skalierung Konfigurationen für App Service-Plan.</param>
        <summary>
            Initialisiert eine neue Instanz der SkuCapacity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DefaultProperty">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Standardanzahl der Worker für diese App Service-Plan-SKU.
            </summary>
    ...
    <Member MemberName="Maximum">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Anzahl von Arbeitsthreads für diese App Service-Plan-SKU.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Minimum">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Mindestanzahl an Workern für diese App Service-Plan-SKU.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScaleType">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest verfügbaren Skalierung Konfigurationen für App Service-Plan.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
