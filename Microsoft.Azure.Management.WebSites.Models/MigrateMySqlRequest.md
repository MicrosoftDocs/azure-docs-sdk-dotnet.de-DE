<Type Name="MigrateMySqlRequest" FullName="Microsoft.Azure.Management.WebSites.Models.MigrateMySqlRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der MigrateMySqlRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="connectionString">Die Verbindungszeichenfolge für die MySQL-Remotedatenbank.</param>
        <param name="migrationType">Der Typ der Migrationsvorgang durchgeführt werden. Folgende Werte sind möglich: "LocalToRemote", "RemoteToLocal"</param>
        <summary>
            Initialisiert eine neue Instanz der MigrateMySqlRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Verbindungszeichenfolge für die MySQL-Remotedatenbank.
            </summary>
    ...
    <Member MemberName="MigrationType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Typ des Migrationsvorgangs durchgeführt werden. Folgende Werte sind möglich: "LocalToRemote", "RemoteToLocal"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
