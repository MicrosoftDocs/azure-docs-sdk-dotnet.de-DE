<Type Name="RestoreResponse" FullName="Microsoft.Azure.Management.WebSites.Models.RestoreResponse">
  ...
  <Docs>
    <summary>
            Antwort auf eine Anforderung zum Wiederherstellen von app.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RestoreResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="operationId">Beim Starten des Servers des Wiederherstellungsprozess, wird eine Identifizierung dieser bestimmten Wiederherstellungsvorgang Vorgangs-ID zurückgegeben.</param>
        <summary>
            Initialisiert eine neue Instanz der RestoreResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            Ruft beim Starten der Wiederherstellung des Servers, wird eine Identifizierung dieser bestimmten Wiederherstellungsvorgang Vorgangs-ID zurückgegeben.
            </summary>
