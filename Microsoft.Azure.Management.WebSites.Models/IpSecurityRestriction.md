<Type Name="IpSecurityRestriction" FullName="Microsoft.Azure.Management.WebSites.Models.IpSecurityRestriction">
  ...
  <Docs>
    <summary>
            Einschränkung für die IP-Sicherheit für eine app.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der IpSecurityRestriction-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="ipAddress">IP-Adresse die sicherheitsbeschränkung ist gültig.</param>
        <param name="subnetMask">Subnetzmaske ist für die IP-Einschränkung Adressen für gültig.</param>
        <summary>
            Initialisiert eine neue Instanz der IpSecurityRestriction-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IpAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die IP-Adresse, die die sicherheitsbeschränkung für gültig ist.
            </summary>
    ...
    <Member MemberName="SubnetMask">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Subnetzmaske im Bereich von IP-Adressen, die die Einschränkung für gültig ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
