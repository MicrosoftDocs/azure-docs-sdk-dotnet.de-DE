<Type Name="FunctionSecrets" FullName="Microsoft.Azure.Management.WebSites.Models.FunctionSecrets">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FunctionSecrets-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="key">Für den geheimen Schlüssel.</param>
        <param name="triggerUrl">Bereitstellungsauslöser-URL.</param>
        <summary>
            Initialisiert eine neue Instanz der FunctionSecrets-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt für den geheimen Schlüssel fest.
            </summary>
    ...
    <Member MemberName="TriggerUrl">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt bereitstellungsauslöser-URL.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
