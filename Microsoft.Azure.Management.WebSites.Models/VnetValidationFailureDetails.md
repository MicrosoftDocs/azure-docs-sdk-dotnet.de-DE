<Type Name="VnetValidationFailureDetails" FullName="Microsoft.Azure.Management.WebSites.Models.VnetValidationFailureDetails">
  ...
  <Docs>
    <summary>
            Eine Klasse, die den Grund für einen Validierungsfehler beschreibt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VnetValidationFailureDetails-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="failed">Ein Flag, ob Fehler bei der Überprüfung beschreibt.</param>
        <param name="failedTests">Eine Liste der Tests, die in die Überprüfung nicht bestanden.</param>
        <summary>
            Initialisiert eine neue Instanz der VnetValidationFailureDetails-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ein Flag, ob Fehler bei der Überprüfung beschreibt.
            </summary>
    ...
    <Member MemberName="FailedTests">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste der fehlgeschlagenen Tests in die Überprüfung.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
