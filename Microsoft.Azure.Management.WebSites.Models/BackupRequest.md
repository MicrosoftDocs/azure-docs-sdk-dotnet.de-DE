<Type Name="BackupRequest" FullName="Microsoft.Azure.Management.WebSites.Models.BackupRequest">
  ...
  <Docs>
    <summary>
            Beschreibung des eine Sicherung in der gesucht werden soll.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BackupRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="backupRequestName">Der Name des Sicherungssatzes.</param>
        <param name="enabled">True, wenn Sie der Sicherungszeitplan aktiviert ist (muss enthalten in diesem Fall), "false", wenn Sie der Sicherungszeitplan deaktiviert werden soll.</param>
        <param name="storageAccountUrl">SAS-URL für den Container.</param>
        <param name="backupSchedule">Zeitplan für die Sicherung in regelmäßigen Abständen ausgeführt wird.</param>
        <param name="databases">Datenbanken, die in der Sicherung enthalten.</param>
        <param name="backupRequestType">Der Typ der Sicherung. Folgende Werte sind möglich: "Default", "Klonen", "Verschieben", "Snapshot"</param>
        <summary>
            Initialisiert eine neue Instanz der BackupRequest-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BackupRequestName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Sicherungssatzes fest.
            </summary>
    ...
    <Member MemberName="BackupRequestType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Sicherungstyp. Folgende Werte sind möglich: "Default", "Klonen", "Verschieben", "Snapshot"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BackupSchedule">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Zeitplan für die Sicherung fest, wenn sie in regelmäßigen Abständen ausgeführt wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Databases">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest in der Sicherung enthaltenen Datenbanken.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest "true", wenn Sie der Sicherungszeitplan aktiviert ist (muss enthalten in diesem Fall), "false", wenn Sie der Sicherungszeitplan deaktiviert werden soll.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
