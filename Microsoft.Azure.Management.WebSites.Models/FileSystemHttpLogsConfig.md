<Type Name="FileSystemHttpLogsConfig" FullName="Microsoft.Azure.Management.WebSites.Models.FileSystemHttpLogsConfig">
  ...
  <Docs>
    <summary>
            HTTP-Protokolle auf die Konfiguration des Dateisystems.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FileSystemHttpLogsConfig-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="retentionInMb">Maximale Größe in Megabyte an, denen HTTP-Protokolldateien verwenden können.
            Wenn Alter erreicht werden Protokolldateien entfernt werden, um Platz für neue zu schaffen.
            Wert kann zwischen 25 und 100 liegen.</param>
        <param name="retentionInDays">Die Beibehaltungsdauer in Tagen.
            Entfernen Sie Dateien, die älter als X Tage.
    ...
    <Member MemberName="RetentionInMb">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Größe in Megabyte an, mit dem HTTP-Protokolldateien können fest.
            Wenn Alter erreicht werden Protokolldateien entfernt werden, um Platz für neue zu schaffen.
            Wert kann zwischen 25 und 100 liegen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
