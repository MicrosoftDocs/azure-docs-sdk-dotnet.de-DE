<Type Name="SiteConfigurationSnapshotInfo" FullName="Microsoft.Azure.Management.WebSites.Models.SiteConfigurationSnapshotInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SiteConfigurationSnapshotInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="time">Die Uhrzeit, die Erstellung der Momentaufnahme.</param>
        <param name="siteConfigurationSnapshotInfoId">Die Id der Momentaufnahme</param>
        <summary>
            Initialisiert eine neue Instanz der SiteConfigurationSnapshotInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
