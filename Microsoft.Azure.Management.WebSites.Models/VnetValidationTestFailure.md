<Type Name="VnetValidationTestFailure" FullName="Microsoft.Azure.Management.WebSites.Models.VnetValidationTestFailure">
  ...
  <Docs>
    <summary>
            Eine Klasse, die einen Test zu beschreiben, die während der NSG und UDR Überprüfung nicht bestanden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VnetValidationTestFailure-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="testName">Der Name des fehlgeschlagenen Test.</param>
        <param name="details">Die Details der Ursache des Fehlers hinweist, z. B. die blockierende Regelname usw.</param>
        <summary>
            Initialisiert eine neue Instanz der VnetValidationTestFailure-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Details">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Details der Ursache des Fehlers hinweist, z. B. die blockierende Regelname usw.
            </summary>
    ...
    <Member MemberName="TestName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des fehlgeschlagenen Test.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
