<Type Name="AppServiceEnvironmentPatchResource" FullName="Microsoft.Azure.Management.WebSites.Models.AppServiceEnvironmentPatchResource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AppServiceEnvironmentPatchResource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="appServiceEnvironmentPatchResourceName">Name des App Service-Umgebung.</param>
        <param name="location">Speicherort der App Service-Umgebung, z. B. "West US".</param>
        ...
        <param name="vipMappings">Beschreibung des IP-SSL-Zuordnung für die App Service-Umgebung.</param>
    ...
    <Member MemberName="EnvironmentIsHealthy">
      ...
      <Docs>
        <summary>
            Ruft ab, der angibt, ob die App Service-Umgebung fehlerfrei ist wahr/falsch.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FrontEndScaleFactor">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Skalierungsfaktor für Front-Ends.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
