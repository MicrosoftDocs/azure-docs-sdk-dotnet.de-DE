<Type Name="Address" FullName="Microsoft.Azure.Management.WebSites.Models.Address">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="address1">Erste Zeile einer Adresse.</param>
        <param name="city">Der Ort für die Adresse.</param>
        <param name="country">Das Land für die Adresse.</param>
        <param name="postalCode">Die Postleitzahl für die Adresse.</param>
        <param name="state">Das Bundesland oder einen Kanton für die Adresse.</param>
        <param name="address2">Die zweite Zeile der Adresse.
            Optional.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Adresse an.
            </summary>
    ...
    <Member MemberName="Address1">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die erste Zeile einer Adresse.
            </summary>
    ...
    <Member MemberName="Address2">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Adresse die zweite Zeile. Optional.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="City">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Ort für die Adresse.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Country">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Land für die Adresse.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PostalCode">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Postleitzahl für die Adresse.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt sie fest, das Bundesland oder einen Kanton für die Adresse.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
