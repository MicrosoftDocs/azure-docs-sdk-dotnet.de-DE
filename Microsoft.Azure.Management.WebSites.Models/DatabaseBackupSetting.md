<Type Name="DatabaseBackupSetting" FullName="Microsoft.Azure.Management.WebSites.Models.DatabaseBackupSetting">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="databaseType">Datenbanktyp (z. B. SqlAzure / MySql).
            Folgende Werte sind möglich: "SqlAzure", "MySql", "LocalMySql", "PostgreSql"</param>
    ...
    <Member MemberName="DatabaseType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Datenbanktyp (z. B. SqlAzure / MySql). Folgende Werte sind möglich: "SqlAzure", "MySql", "LocalMySql", "PostgreSql"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
