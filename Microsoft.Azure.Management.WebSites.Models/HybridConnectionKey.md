<Type Name="HybridConnectionKey" FullName="Microsoft.Azure.Management.WebSites.Models.HybridConnectionKey">
  ...
  <Docs>
    <summary>
            Wichtige Hybrid Connection-Vertrag. Dies hat den Send-Schlüsselnamen und den Wert für eine Hybridverbindung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der HybridConnectionKey-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sendKeyName">Der Name des Schlüssels senden.</param>
        <param name="sendKeyValue">Der Wert des Schlüssels senden.</param>
        <summary>
            Initialisiert eine neue Instanz der HybridConnectionKey-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SendKeyName">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Schlüssels senden.
            </summary>
    ...
    <Member MemberName="SendKeyValue">
      ...
      <Docs>
        <summary>
            Ruft den Wert des Schlüssels senden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
