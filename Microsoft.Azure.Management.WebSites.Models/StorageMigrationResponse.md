<Type Name="StorageMigrationResponse" FullName="Microsoft.Azure.Management.WebSites.Models.StorageMigrationResponse">
  ...
  <Docs>
    <summary>
            Die Antwort für eine Migration von app-Geräteprogramminhalts-Anfrage.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der StorageMigrationResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="operationId">Beim Starten des Servers während der Migration, wird eine Identifizierung dieser bestimmten Migrationsvorgang Vorgangs-ID zurückgegeben.</param>
        <summary>
            Initialisiert eine neue Instanz der StorageMigrationResponse-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            Ruft beim Starten des Servers während der Migration, wird eine Identifizierung dieser bestimmten Migrationsvorgang Vorgangs-ID zurückgegeben.
            </summary>
