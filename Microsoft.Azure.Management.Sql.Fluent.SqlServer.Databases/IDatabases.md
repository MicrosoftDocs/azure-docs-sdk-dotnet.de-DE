  ...
  <Members>
    <Member MemberName="Define">
      ...
      <Docs>
        ...
        <summary>
            Erstellt eine neue Datenbank in SQL Server.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt eine Stufe aus, um die Argumente der Datenbank angeben.</return>
      </Docs>
    </Member>
    <Member MemberName="Delete">
      ...
      <Docs>
        <param name="databaseName">Name des zu löschenden Datenbank.</param>
        <summary>
            Löschen Sie die angegebene Datenbank auf dem Server.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="databaseName">Der Name der Sql-Datenbank abgerufen.</param>
        <summary>
            Ruft eine bestimmte SQL­Datenbank ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Gibt die Datenbank mit SQL Server zurück.</return>
      </Docs>
    </Member>
    <Member MemberName="List">
      ...
      <Docs>
        <summary>
            Es werden alle Datenbanken für den Server zurückgegeben.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die Liste der Datenbanken für den Server.</return>
      </Docs>
    </Member>
  </Members>
</Type>