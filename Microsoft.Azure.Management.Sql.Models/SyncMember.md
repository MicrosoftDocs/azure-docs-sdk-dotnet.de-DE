<Type Name="SyncMember" FullName="Microsoft.Azure.Management.Sql.Models.SyncMember">
  ...
  <Docs>
    <summary>
            Eine Azure SQL-Datenbank-Sync-Element.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SyncMember-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseType">Der Datenbanktyp des Sync-Elements.
            Folgende Werte sind möglich: "AzureSqlDatabase", "SqlServerDatabase"</param>
        <param name="syncAgentId">ARM-Ressourcen-Id des Synchronisierungs-Agent in das Sync-Element.</param>
        <param name="sqlServerDatabaseId">SQL Server-Datenbank-Id des Sync-Elements.</param>
        <param name="serverName">Servername des Mitgliedsdatenbank in das Sync-Element</param>
        <param name="databaseName">Name der Datenbank von der Mitgliedsdatenbank in das Sync-Element.</param>
        <param name="userName">Der Benutzername von der Mitgliedsdatenbank in das Sync-Element.</param>
        <param name="password">Kennwort des Mitgliedsdatenbank in das Sync-Element.</param>
        <param name="syncDirection">Synchronisierungsrichtung des Sync-Elements.
            Folgende Werte sind möglich: "Bidirektional", "OneWayMemberToHub", "OneWayHubToMember"</param>
        <param name="syncState">Der Synchronisierungsstatus des Sync-Elements. Folgende Werte sind möglich: "SyncInProgress", "SyncSucceeded", "SyncFailed", "DisabledTombstoneCleanup", "DisabledBackupRestore", "SyncSucceededWithWarnings", "SyncCancelling", "SyncCancelled", "UnProvisioned", "Wird bereitgestellt", "Bereitgestellt", "ProvisionFailed", "Aufheben der Bereitstellung", "Bereitstellung aufgehoben", "DeProvisionFailed", "erneute" können, "ReprovisionFailed", "UnReprovisioned" Bereitstellung</param>
        <summary>
            Initialisiert eine neue Instanz der SyncMember-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie Datenbankname der Mitgliedsdatenbank in das Sync-Element fest.
            </summary>
    ...
    <Member MemberName="DatabaseType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Datenbank das Sync-Element. Folgende Werte sind möglich: "AzureSqlDatabase", "SqlServerDatabase"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Kennwort des Mitgliedsdatenbank in das Sync-Element.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerName">
      ...
      <Docs>
        <summary>
            Im abruft oder festlegt Servernamen der Mitgliedsdatenbank das Sync-Element
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SqlServerDatabaseId">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der SQL Server-Datenbank-Id des Sync-Elements.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncAgentId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie ARM-Ressourcen-Id des Synchronisierungs-Agent in das Sync-Element fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncDirection">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest synchronisierungsrichtung des Sync-Elements. Folgende Werte sind möglich: "Bidirektional", "OneWayMemberToHub", "OneWayHubToMember"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncState">
      ...
      <Docs>
        <summary>
            Ruft synchronisieren Zustand des Sync-Elements. Folgende Werte sind möglich: "SyncInProgress", "SyncSucceeded", "SyncFailed", "DisabledTombstoneCleanup", "DisabledBackupRestore", "SyncSucceededWithWarnings", "SyncCancelling", "SyncCancelled", "UnProvisioned", "Wird bereitgestellt", "Bereitgestellt", "ProvisionFailed", "Aufheben der Bereitstellung", "Bereitstellung aufgehoben", "DeProvisionFailed", "erneute" können, "ReprovisionFailed", "UnReprovisioned" Bereitstellung
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie Benutzername von der Mitgliedsdatenbank in das Sync-Element fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
