<Type Name="ElasticPoolDatabaseActivity" FullName="Microsoft.Azure.Management.Sql.Models.ElasticPoolDatabaseActivity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ElasticPoolDatabaseActivity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="requestedElasticPoolName">Der Name für den elastischen Pool, dem die Datenbank in verschoben wird, falls verfügbar.</param>
        <param name="currentElasticPoolName">Der Name des aktuellen elastischen Pools If wird die Datenbank verfügbar.</param>
    ...
    <Member MemberName="RequestedElasticPoolName">
      ...
      <Docs>
        <summary>
            Ruft den Namen für den elastischen Pool, dem die Datenbank gegebenenfalls auf verschoben werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
