<Type Name="ServerDnsAlias" FullName="Microsoft.Azure.Management.Sql.Models.ServerDnsAlias">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ServerDnsAlias-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="azureDnsRecord">Der vollqualifizierte DNS-Eintrag für alias</param>
        <summary>
            Initialisiert eine neue Instanz der ServerDnsAlias-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AzureDnsRecord">
      ...
      <Docs>
        <summary>
            Ruft den vollqualifizierten DNS-Eintrag für alias
            </summary>
