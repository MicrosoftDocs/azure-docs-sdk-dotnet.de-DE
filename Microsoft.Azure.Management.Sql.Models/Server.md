<Type Name="Server" FullName="Microsoft.Azure.Management.Sql.Models.Server">
  ...
  <Docs>
    <summary>
            Eine Azure SQL-Datenbankserver.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Server-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="identity">Die Azure Active Directory-Identität des Servers.</param>
        <param name="kind">Die Art von SqlServer. Dies ist die Metadaten für die Azure portalumgebung verwendet.</param>
        <param name="administratorLogin">Administratorbenutzername für den Server. Nach der Erstellung nicht geändert werden kann.</param>
        <param name="administratorLoginPassword">Das Administratorkennwort (erforderlich für die Erstellung des Servers).</param>
        <param name="version">Die Version des Servers.</param>
        <param name="state">Der Status des Servers.</param>
        <param name="fullyQualifiedDomainName">Der vollqualifizierte Domänenname des Servers.</param>
        <summary>
            Initialisiert eine neue Instanz der Server-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AdministratorLogin">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Administratorbenutzername für den Server. Nach der Erstellung nicht geändert werden kann.
            </summary>
    ...
    <Member MemberName="AdministratorLoginPassword">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Administrator Anmeldekennwort (erforderlich für die Erstellung von Server).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FullyQualifiedDomainName">
      ...
      <Docs>
        <summary>
            Ruft den vollqualifizierten Domänennamen des Servers ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Identity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Azure Active Directory-Identität des Servers fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            Ruft die Art von SqlServer. Dies ist die Metadaten für die Azure portalumgebung verwendet.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft den Zustand des Servers ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version des Servers.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
