<Type Name="ServerConnectionPolicy" FullName="Microsoft.Azure.Management.Sql.Models.ServerConnectionPolicy">
  ...
  <Docs>
    <summary>
            Eine sichere Verbindung Serverrichtlinie.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ServerConnectionPolicy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="connectionType">Der Server-Verbindungstyp. Folgende Werte sind möglich: "Default", "Proxy", "Umleiten"</param>
        <param name="id">Ressourcen-ID</param>
        <param name="name">Name der Ressource.</param>
        <param name="type">Der Ressourcentyp.</param>
        <param name="kind">Die Metadaten für die Azure portalumgebung verwendet.</param>
    ...
    <Member MemberName="ConnectionType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Servertyp für die Verbindung. Folgende Werte sind möglich: "Default", "Proxy", "Umleiten"
            </summary>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            Ruft Metadaten für die Azure portalumgebung ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
