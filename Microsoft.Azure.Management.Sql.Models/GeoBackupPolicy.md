<Type Name="GeoBackupPolicy" FullName="Microsoft.Azure.Management.Sql.Models.GeoBackupPolicy">
  ...
  <Docs>
    <summary>
            Eine Datenbank Geo backup-Richtlinie.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der GeoBackupPolicy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="state">Der Status der Geo-Sicherungsrichtlinie. Folgende Werte sind möglich: "Deaktiviert", "Aktiviert"</param>
        <param name="id">Ressourcen-ID</param>
        <param name="name">Name der Ressource.</param>
        <param name="type">Der Ressourcentyp.</param>
        <param name="storageType">Der geografische Sicherungsrichtlinie Speichertyp.</param>
        <param name="kind">Art der Geo-Sicherungsrichtlinie.  Dies ist die Metadaten für die Azure portalumgebung verwendet.</param>
        <param name="location">Speicherort der Sicherungsrichtlinie.</param>
        <summary>
            Initialisiert eine neue Instanz der GeoBackupPolicy-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            Ruft die Art der Geo-Sicherungsrichtlinie.  Dies ist die Metadaten für die Azure portalumgebung verwendet.
            </summary>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            Ruft die Sicherungsrichtlinie Speicherort ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Status der Geo-Sicherungsrichtlinie fest. Folgende Werte sind möglich: "Deaktiviert", "Aktiviert"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageType">
      ...
      <Docs>
        <summary>
            Ruft den Speichertyp, der Sicherungsrichtlinie geografische ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
