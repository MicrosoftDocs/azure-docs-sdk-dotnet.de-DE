<Type Name="SyncAgent" FullName="Microsoft.Azure.Management.Sql.Models.SyncAgent">
  ...
  <Docs>
    <summary>
            Eine Azure SQL-Datenbank-Synchronisierungs-Agent.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse SyncAgent an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="syncAgentName">Name des Synchronisierungs-Agent.</param>
        <param name="syncDatabaseId">ARM-Ressourcen-Id des Sync-Datenbank in der Synchronisierungs-Agent.</param>
        <param name="lastAliveTime">Letzte alive Zeitpunkt des Synchronisierungs-Agent.</param>
        <param name="state">Status des Synchronisierungs-Agent. Folgende Werte sind möglich: "Online", "Offline", "NeverConnected"</param>
        <param name="isUpToDate">Wenn die Version von Sync-Agents auf dem neuesten Stand ist.</param>
        <param name="expiryTime">Die Ablaufzeit des Agent-Version von Sync.</param>
        <param name="version">Version des Synchronisierungs-Agent.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse SyncAgent an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ExpiryTime">
      ...
      <Docs>
        <summary>
            Ruft die Ablaufzeit der Sync-Agent-Version ab.
            </summary>
    ...
    <Member MemberName="IsUpToDate">
      ...
      <Docs>
        <summary>
            Ruft ab, wenn die Version von Sync-Agents auf dem neuesten Stand ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastAliveTime">
      ...
      <Docs>
        <summary>
            Ruft die zuletzt aktiv des Synchronisierungs-Agent ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft den Status des Synchronisierungs-Agent. Folgende Werte sind möglich: "Online", "Offline", "NeverConnected"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncAgentName">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Synchronisierungs-Agent.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncDatabaseId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt Sie ARM-Ressourcen-Id des Sync-Datenbank in der Synchronisierungs-Agent fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft die Version des Synchronisierungs-Agent ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
