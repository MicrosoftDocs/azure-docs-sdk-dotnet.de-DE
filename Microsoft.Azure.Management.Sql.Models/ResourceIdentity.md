<Type Name="ResourceIdentity" FullName="Microsoft.Azure.Management.Sql.Models.ResourceIdentity">
  ...
  <Docs>
    <summary>
            Azure Active Directory Identity-Konfiguration für eine Ressource.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ResourceIdentity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId">Der Prinzipal-Id der Azure Active Directory.</param>
        <param name="type">Der Typ der Identität. Legen Sie "SystemAssigned", um automatisch zu erstellen und ein Azure Active Directory-Dienstprinzipal für die Ressource zuweisen. Folgende Werte sind möglich: "SystemAssigned"</param>
        <param name="tenantId">Die Azure Active Directory-Mandanten-Id an.</param>
        <summary>
            Initialisiert eine neue Instanz der ResourceIdentity-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PrincipalId">
      ...
      <Docs>
        <summary>
            Ruft die Azure Active Directory-Prinzipal-Id ab.
            </summary>
    ...
    <Member MemberName="TenantId">
      ...
      <Docs>
        <summary>
            Ruft die Azure Active Directory-Mandanten-Id ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Identity-Typ. Legen Sie "SystemAssigned", um automatisch zu erstellen und ein Azure Active Directory-Dienstprinzipal für die Ressource zuweisen. Folgende Werte sind möglich: "SystemAssigned"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
