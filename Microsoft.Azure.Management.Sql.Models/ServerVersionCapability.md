<Type Name="ServerVersionCapability" FullName="Microsoft.Azure.Management.Sql.Models.ServerVersionCapability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ServerVersionCapability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Server-Version.</param>
        <param name="status">Der Status des Server-Version. Folgende Werte sind möglich: "Sichtbar", "Verfügbar", "Default", "Deaktiviert"</param>
        <param name="supportedEditions">Die Liste der unterstützten Datenbankeditionen.</param>
        <param name="supportedElasticPoolEditions">Die Liste der unterstützten elastischen Pool-Editionen.</param>
        <summary>
            Initialisiert eine neue Instanz der ServerVersionCapability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft den Status von Server-Version ab. Folgende Werte sind möglich: "Sichtbar", "Verfügbar", "Default", "Deaktiviert"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedElasticPoolEditions">
      ...
      <Docs>
        <summary>
            Ruft die Liste der unterstützten elastischen Pool Editionen ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
