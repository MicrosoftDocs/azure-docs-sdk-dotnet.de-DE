<Type Name="DatabaseOperation" FullName="Microsoft.Azure.Management.Sql.Models.DatabaseOperation">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse DatabaseOperation.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseName">Der Name der Datenbank wird auf der Vorgang ausgeführt wird.</param>
        <param name="operation">Der Name des Vorgangs.</param>
        <param name="operationFriendlyName">Der angezeigte Name des Vorgangs.</param>
        <param name="percentComplete">Der Prozentsatz der der Vorgang abgeschlossen wurde.</param>
        <param name="serverName">Der Name des Servers.</param>
        <param name="startTime">Die Startzeit für den Vorgang.</param>
        <param name="state">Der Status des Vorgangs. Folgende Werte sind möglich: "Ausstehend", "InProgress", "Erfolgreich abgeschlossen", "Fehlgeschlagen", "CancelInProgress", "Abgebrochen"</param>
        <param name="errorCode">Der Fehlercode für den Vorgang.</param>
        <param name="errorDescription">Die fehlerbeschreibung für den Vorgang.</param>
        <param name="errorSeverity">Der Vorgang Fehlerschweregrad.</param>
        <param name="isUserError">Der Fehler ist, und zwar unabhängig davon, ob ein Benutzerfehler.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse DatabaseOperation.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            Ruft den Namen der Datenbank, die, der für der Vorgang ausgeführt wird.
            </summary>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            Ruft den Fehlercode für den Vorgang ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorDescription">
      ...
      <Docs>
        <summary>
            Ruft die Beschreibung des Vorgangs ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ErrorSeverity">
      ...
      <Docs>
        <summary>
            Ruft den Schweregrad des Fehlers Vorgang ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsUserError">
      ...
      <Docs>
        <summary>
            Ruft ab, und zwar unabhängig davon, ob der Fehler ein Fehler ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationFriendlyName">
      ...
      <Docs>
        <summary>
            Ruft den Anzeigenamen des Vorgangs ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PercentComplete">
      ...
      <Docs>
        <summary>
            Ruft den Prozentsatz der der Vorgang abgeschlossen wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft den Status des Vorgangs ab. Folgende Werte sind möglich: "Ausstehend", "InProgress", "Erfolgreich abgeschlossen", "Fehlgeschlagen", "CancelInProgress", "Abgebrochen"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
