<Type Name="LocationCapabilities" FullName="Microsoft.Azure.Management.Sql.Models.LocationCapabilities">
  ...
  <Docs>
    <summary>
            Die Funktionen für einen Standort.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der LocationCapabilities-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="status">Azure SQL-Datenbank den Status für den Speicherort.
            Folgende Werte sind möglich: "Sichtbar", "Verfügbar", "Default", "Deaktiviert"</param>
        <param name="supportedServerVersions">Die Liste der unterstützten Serverversionen.</param>
        <summary>
            Initialisiert eine neue Instanz der LocationCapabilities-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft den Status der Azure SQL-Datenbank für den Speicherort ab. Folgende Werte sind möglich: "Sichtbar", "Verfügbar", "Default", "Deaktiviert"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedServerVersions">
      ...
      <Docs>
        <summary>
            Ruft die Liste der unterstützten Serverversionen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
