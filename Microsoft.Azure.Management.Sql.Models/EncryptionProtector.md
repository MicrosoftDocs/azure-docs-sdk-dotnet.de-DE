<Type Name="EncryptionProtector" FullName="Microsoft.Azure.Management.Sql.Models.EncryptionProtector">
  ...
  <Docs>
    <summary>
            Der Schutz für den Server-Verschlüsselung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der EncryptionProtector-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serverKeyType">Die Verschlüsselung schutzkomponenten-Typs, z. B. "ServiceManaged", "AzureKeyVault". Folgende Werte sind möglich: "ServiceManaged", "AzureKeyVault"</param>
        <param name="id">Ressourcen-ID</param>
        <param name="name">Name der Ressource.</param>
        <param name="type">Der Ressourcentyp.</param>
        <param name="kind">Art der Verschlüsselung Schutzvorrichtung. Dies ist die Metadaten für die Azure portalumgebung verwendet.</param>
        <param name="location">Der Ressourcenspeicherort.</param>
        <param name="subregion">Unterbereich, der die Verschlüsselung Schutzvorrichtung.</param>
        <param name="serverKeyName">Der Name des Schlüssels für Server.</param>
        <param name="uri">Der URI des Schlüssels für Server.</param>
        <param name="thumbprint">Der Fingerabdruck des Schlüssels für Server.</param>
        <summary>
            Initialisiert eine neue Instanz der EncryptionProtector-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Art der Verschlüsselung Schutzvorrichtung. Dies ist die Metadaten für die Azure portalumgebung verwendet.
            </summary>
    ...
    <Member MemberName="ServerKeyName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Schlüssels für den Server fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerKeyType">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Verschlüsselung schutzvorrichtungstyp wie "ServiceManaged", "AzureKeyVault". Folgende Werte sind möglich: "ServiceManaged", "AzureKeyVault"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subregion">
      ...
      <Docs>
        <summary>
            Ruft die Unterbereich, der die Verschlüsselung Schutzvorrichtung ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            Ruft den Fingerabdruck des Schlüssels für Server.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            Ruft den URI des Schlüssels für den Server ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
