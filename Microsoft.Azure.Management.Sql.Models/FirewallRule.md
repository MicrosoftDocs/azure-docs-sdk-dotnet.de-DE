<Type Name="FirewallRule" FullName="Microsoft.Azure.Management.Sql.Models.FirewallRule">
  ...
  <Docs>
    <summary>
            Stellt eine Server-Firewall-Regel dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der FirewallRule-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startIpAddress">Die erste IP-Adresse der Firewallregel. Muss im IPv4-Format vorliegen. Verwenden der Wert "0.0.0.0" alle Azure-internen IP-Adressen darstellen.</param>
        <param name="endIpAddress">Die letzte IP-Adresse der Firewallregel.
            Muss im IPv4-Format vorliegen. Muss größer als oder gleich beim Start sein. Verwenden der Wert "0.0.0.0" alle Azure-internen IP-Adressen darstellen.</param>
    ...
    <Member MemberName="EndIpAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die IP-Endadresse der Firewallregel. Muss im IPv4-Format vorliegen. Muss größer als oder gleich beim Start sein. Verwenden der Wert "0.0.0.0" alle Azure-internen IP-Adressen darstellen.
            </summary>
    ...
    <Member MemberName="StartIpAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die erste IP-Adresse der Firewallregel. Muss im IPv4-Format vorliegen. Verwenden der Wert "0.0.0.0" alle Azure-internen IP-Adressen darstellen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
