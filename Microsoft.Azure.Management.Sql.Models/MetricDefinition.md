<Type Name="MetricDefinition" FullName="Microsoft.Azure.Management.Sql.Models.MetricDefinition">
  ...
  <Docs>
    <summary>
            Eine Datenbank metrischen Definition.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Die Informationen für die Metrik.</param>
        <param name="primaryAggregationType">Die primäre Aggregation geben definierenden wie Metrikwerte angezeigt werden. Folgende Werte sind möglich: 'None', 'Average', 'Count', "Minimum", "Maximum", "Total"</param>
        <param name="resourceUri">Der Ressourcen-Uri der Datenbank.</param>
        <param name="unit">Die Einheit der Metrik. Folgende Werte sind möglich: "Count", "Byte", "Sekunden", "Prozent", "CountPerSecond", "BytesPerSecond"</param>
        <param name="metricAvailabilities">Die Liste der Metrik Availabities Datenbank, für die Metrik.</param>
        <summary>
            Initialisiert eine neue Instanz der MetricDefinition-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MetricAvailabilities">
      ...
      <Docs>
        <summary>
            Ruft die Liste der Metrik Availabities Datenbank für die Metrik an.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft die Informationen für die Metrik ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryAggregationType">
      ...
      <Docs>
        <summary>
            Ruft den primären Aggregationstyp definierenden wie Metrikwerte angezeigt werden. Folgende Werte sind möglich: 'None', 'Average', 'Count', "Minimum", "Maximum", "Total"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceUri">
      ...
      <Docs>
        <summary>
            Ruft den Ressourcen-Uri der Datenbank ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            Ruft die Maßeinheit der Metrik an. Folgende Werte sind möglich: "Count", "Byte", "Sekunden", "Prozent", "CountPerSecond", "BytesPerSecond"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
