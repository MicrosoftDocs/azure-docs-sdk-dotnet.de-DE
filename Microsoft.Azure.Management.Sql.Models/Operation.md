<Type Name="Operation" FullName="Microsoft.Azure.Management.Sql.Models.Operation">
  ...
  <Docs>
    <summary>
            Definition der SQL-REST-API-Vorgang.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Vorgangs für dieses bestimmte Objekt ausgeführt wird.</param>
        <param name="display">Die lokalisierte Anzeigeinformationen für diesen Vorgang / Aktion.</param>
        <param name="origin">Der vorgesehene Executor des Vorgangs.
            Folgende Werte sind möglich: "User", "System"</param>
        <param name="properties">Zusätzliche Beschreibungen für den Vorgang.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Vorgang an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft die lokalisierte Anzeigeinformationen für diesen Vorgang / Aktion.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft den Namen des Vorgangs für dieses bestimmte Objekt ausgeführt wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Origin">
      ...
      <Docs>
        <summary>
            Ruft den vorgesehenen Executor des Vorgangs ab. Folgende Werte sind möglich: "User", "System"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
