<Type Name="Metric" FullName="Microsoft.Azure.Management.Sql.Models.Metric">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startTime">Die Startzeit für die Metrik (ISO-8601-Format).</param>
        <param name="endTime">Die Endzeit für die Metrik (ISO-8601-Format).</param>
        <param name="timeGrain">Der Zeitschritt verwendet werden, um die Metrikwerte zusammenzufassen.</param>
        ...
        <param name="metricValues">Die Metrik Werte für das angegebene Zeitfenster und Timestep.</param>
        <summary>
            Initialisiert eine neue Instanz der Metrik-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            Ruft die Endzeit für die Metrik (ISO-8601-Format) ab.
            </summary>
    ...
    <Member MemberName="MetricValues">
      ...
      <Docs>
        <summary>
            Ruft die Metrik Werte für das angegebene Zeitfenster und Timestep ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            Ruft die Startzeit für die Metrik (ISO-8601-Format) ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            Ruft den Zeitschritt verwendet werden, um die Metrikwerte zusammenzufassen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
