<Type Name="ServerDnsAliasAcquisition" FullName="Microsoft.Azure.Management.Sql.Models.ServerDnsAliasAcquisition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="67cb7-101">Ein Server, DNS-alias Acquisition-Anforderung.</span><span class="sxs-lookup"><span data-stu-id="67cb7-101">A server DNS alias acquisition request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="67cb7-102">Initialisiert eine neue Instanz der ServerDnsAliasAcquisition-Klasse.</span><span class="sxs-lookup"><span data-stu-id="67cb7-102">Initializes a new instance of the ServerDnsAliasAcquisition class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="oldServerDnsAliasId"><span data-ttu-id="67cb7-103">Die Id des Serveralias, der vom eingerichteten werden wird, um stattdessen auf diesen Server verweisen.</span><span class="sxs-lookup"><span data-stu-id="67cb7-103">The id of the server alias that will be acquired to point to this server instead.</span></span></param>
        <summary>
            <span data-ttu-id="67cb7-104">Initialisiert eine neue Instanz der ServerDnsAliasAcquisition-Klasse.</span><span class="sxs-lookup"><span data-stu-id="67cb7-104">Initializes a new instance of the ServerDnsAliasAcquisition class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OldServerDnsAliasId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="67cb7-105">Ruft ab oder legt die Id des Serveralias, der abgerufen werden kann, um auf diesen Server verweisen stattdessen fest.</span><span class="sxs-lookup"><span data-stu-id="67cb7-105">Gets or sets the id of the server alias that will be acquired to point to this server instead.</span></span>
            </summary>
