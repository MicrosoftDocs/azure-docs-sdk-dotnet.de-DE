<Type Name="IUpdate" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.Update.IUpdate">
  ...
  <Docs>
    <summary>
            Der Satz von Konfigurationen, die für alle Endpoint unabhängig von ihrem Typ (Azure, externe, geschachtelte Profile) aktualisiert werden können.
            </summary>
