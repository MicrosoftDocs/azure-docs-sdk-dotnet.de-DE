<Type Name="JobSchedulePatchBatchRequest" FullName="Microsoft.Azure.Batch.Protocol.BatchRequests.JobSchedulePatchBatchRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a560f-101">Ein <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> für den JobSchedulePatch-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="a560f-101">An <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> for the JobSchedulePatch operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceClient"><span data-ttu-id="a560f-102">Der Dienstclient verwendet.</span><span class="sxs-lookup"><span data-stu-id="a560f-102">The service client to use.</span></span></param>
        <param name="parameters"><span data-ttu-id="a560f-103">Die Parameter zu verwenden.</span><span class="sxs-lookup"><span data-stu-id="a560f-103">The parameters to use.</span></span></param>
        <param name="cancellationToken"><span data-ttu-id="a560f-104">Ein <see cref="T:System.Threading.CancellationToken" /> Steuerung der Lebensdauer der Anforderung.</span><span class="sxs-lookup"><span data-stu-id="a560f-104">A <see cref="T:System.Threading.CancellationToken" /> controlling the request lifetime.</span></span></param>
        <summary>
            <span data-ttu-id="a560f-105">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.JobSchedulePatchBatchRequest" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a560f-105">Initializes a new instance of the <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.JobSchedulePatchBatchRequest" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
