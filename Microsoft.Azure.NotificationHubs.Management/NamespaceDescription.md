<Type Name="NamespaceDescription" FullName="Microsoft.Azure.NotificationHubs.Management.NamespaceDescription">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.Management.NamespaceDescription" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="EventHubEnabled">
      ...
      <Docs>
        <summary>
            (veraltet) Gibt an, ob der EventHub-Funktion aktiviert ist
            </summary>
    ...
    <Member MemberName="NamespaceType">
      ...
      <Docs>
        <summary>
            Der Typ des Namespaces. Wenn es NotificationHub ' oder ' gemischt ist, konnten wir NotificationHubs im Namespace zu erstellen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
