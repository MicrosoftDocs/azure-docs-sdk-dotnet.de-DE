<Type Name="NamespaceType" FullName="Microsoft.Azure.NotificationHubs.Management.NamespaceType">
  ...
  <Members>
    <Member MemberName="Messaging">
      ...
      <Docs>
        <summary>
            Messaging: Meldung Entitäten (Warteschlange/Thema/Relay/Event Hub) können unter diesem Namespace erstellt werden
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Mixed">
      ...
      <Docs>
        <summary>
            Gemischt: Beide Messaging-Entitäten und in NotificationHub-Entität kann erstellt werden unter diesem Namespace (veraltet)
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NotificationHub">
      ...
      <Docs>
        <summary>
            Benachrichtigungs-Hub: unter diesem Namespace kann nur NotificationHub-Entität erstellt werden
            </summary>
      </Docs>
    </Member>
  </Members>
