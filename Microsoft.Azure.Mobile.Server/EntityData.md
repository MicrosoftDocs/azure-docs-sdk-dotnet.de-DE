<Type Name="EntityData" FullName="Microsoft.Azure.Mobile.Server.EntityData">
  ...
  <Docs>
    <summary>
            Eine abstrakte Implementierung von der <see cref="T:Microsoft.Azure.Mobile.Server.Tables.ITableData" /> Schnittstelle, der angibt, wie die Systemeigenschaften für ein Datenmodell für die angegebene Tabelle sind bei der Kommunikation mit Clients, wenn Entity Framework verwendet wird, für den Zugriff auf den Back-End-Speicher serialisiert werden.
            Die einheitliche Serialisierung von Systemeigenschaften wird sichergestellt, dass die Clients die Systemeigenschaften gleichmäßig über Plattformen hinweg verarbeiten können. Konkrete Entity Framework-Modelle können von dieser Basisklasse abgeleitet werden, um die Systemeigenschaften zu unterstützen.
            </summary>
