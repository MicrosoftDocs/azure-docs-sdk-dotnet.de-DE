<Type Name="QueryBody" FullName="Microsoft.Azure.OperationalInsights.Models.QueryBody">
  ...
  <Docs>
    <summary>
            Die Analyseabfrage. Erfahren Sie mehr über die [Analytics Abfragesyntax](https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/)
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der QueryBody-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="query">Die auszuführende Abfrage.</param>
        <param name="timespan">Optional. Die Zeitspanne für die zum Abfragen von Daten. Dies ist ein Wert für den Zeitraum ISO8601.  Diese Zeitspanne wird zusätzlich zu anderen angewendet, die im Abfrageausdruck angegeben sind.</param>
        <param name="workspaces">Eine Liste der Arbeitsbereiche, die in der Abfrage enthalten sind.</param>
        <summary>
            Initialisiert eine neue Instanz der QueryBody-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die auszuführende Abfrage.
            </summary>
    ...
    <Member MemberName="Timespan">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt dies ist optional. Die Zeitspanne für die zum Abfragen von Daten. Dies ist ein Wert für den Zeitraum ISO8601.  Diese Zeitspanne wird zusätzlich zu anderen angewendet, die im Abfrageausdruck angegeben sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Workspaces">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Liste der Arbeitsbereiche, die in der Abfrage enthalten sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
