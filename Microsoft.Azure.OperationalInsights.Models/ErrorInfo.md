<Type Name="ErrorInfo" FullName="Microsoft.Azure.OperationalInsights.Models.ErrorInfo">
  ...
  <Docs>
    <summary>
            Der Code und eine Nachricht für einen Fehler.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ErrorInfo-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">Eine lesbare Fehlermeldung Computercode.</param>
        <param name="message">Interaktive Workflowdienste-lesbare Fehlermeldung.</param>
        <param name="details">Fehlerdetails.</param>
        <param name="innererror">Interner Fehler-Details, sofern vorhanden.</param>
    ...
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Computer lesbaren-Fehlercode.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Innererror">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die internen Fehlerdetails fest, sofern vorhanden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
