<Type Name="Operation" FullName="Microsoft.Azure.Management.EventGrid.Models.Operation">
  ...
  <Docs>
    <summary>
            Stellt einen Vorgang, durch die GetOperations-Anforderung zurückgegeben
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">Anzeigename des Vorgangs</param>
        <param name="origin">Der Ursprung des Vorgangs. Folgende Werte sind möglich: "User", "System", "UserAndSystem"</param>
        <param name="properties">Eigenschaften des Vorgangs</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Vorgang an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Anzeigename des Vorgangs
            </summary>
    ...
    <Member MemberName="Origin">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Ursprung des Vorgangs. Folgende Werte sind möglich: "User", "System", "UserAndSystem"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Eigenschaften des Vorgangs fest
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
