<Type Name="IWithWindowsSnapshotSource" FullName="Microsoft.Azure.Management.Compute.Fluent.Snapshot.Definition.IWithWindowsSnapshotSource">
  ...
  <Docs>
    <summary>
            Die Phase der verwalteten Momentaufnahmendefinition ermöglicht Windows-Betriebssystem-Quelle auswählen.
            </summary>
  ...
  <Members>
    <Member MemberName="WithWindowsFromDisk">
      ...
      <Docs>
        ...
        <summary>
            Gibt den verwalteten Windows-Betriebssystems Quelldatenträger an.
            </summary>
    ...
    <Member MemberName="WithWindowsFromSnapshot">
      ...
      <Docs>
        ...
        <summary>
            Gibt die Quelle verwaltete Windows-Betriebssystem-Momentaufnahme.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
    ...
    <Member MemberName="WithWindowsFromVhd">
      ...
      <Docs>
        ...
        <summary>
            Gibt die Quelle spezialisiert oder Windows-Betriebssystem-VHD generalisiert.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>die nächste Phase der Definition.</return>
