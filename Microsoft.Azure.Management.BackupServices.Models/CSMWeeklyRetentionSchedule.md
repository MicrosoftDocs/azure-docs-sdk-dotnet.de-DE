<Type Name="CSMWeeklyRetentionSchedule" FullName="Microsoft.Azure.Management.BackupServices.Models.CSMWeeklyRetentionSchedule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cc92a-101">Die Definition eines CSMWeeklyRetentionSchedule-Objekts.</span><span class="sxs-lookup"><span data-stu-id="cc92a-101">The definition of a CSMWeeklyRetentionSchedule object.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc92a-102">Initialisiert eine neue Instanz der CSMWeeklyRetentionSchedule-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cc92a-102">Initializes a new instance of the CSMWeeklyRetentionSchedule class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DaysOfTheWeek">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc92a-103">Optional.</span><span class="sxs-lookup"><span data-stu-id="cc92a-103">Optional.</span></span> <span data-ttu-id="cc92a-104">Liste der Tage der Woche für wöchentliche Beibehaltung Richtlinie.</span><span class="sxs-lookup"><span data-stu-id="cc92a-104">List of Days of Week for Weekly Retention policy.</span></span>
            </summary>
