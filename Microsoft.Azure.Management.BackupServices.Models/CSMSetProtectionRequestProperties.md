<Type Name="CSMSetProtectionRequestProperties" FullName="Microsoft.Azure.Management.BackupServices.Models.CSMSetProtectionRequestProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bd1a7-101">Die Definition eines CSMSetProtectionRequestProperties-Objekts.</span><span class="sxs-lookup"><span data-stu-id="bd1a7-101">The definition of a CSMSetProtectionRequestProperties object.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd1a7-102">Initialisiert eine neue Instanz der CSMSetProtectionRequestProperties-Klasse.</span><span class="sxs-lookup"><span data-stu-id="bd1a7-102">Initializes a new instance of the CSMSetProtectionRequestProperties class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="bd1a7-103">Initialisiert eine neue Instanz der CSMSetProtectionRequestProperties-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="bd1a7-103">Initializes a new instance of the CSMSetProtectionRequestProperties class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PolicyId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd1a7-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="bd1a7-104">Required.</span></span> <span data-ttu-id="bd1a7-105">PolicyId für das Festlegen von Schutz durch.</span><span class="sxs-lookup"><span data-stu-id="bd1a7-105">policyId  for setting protection.</span></span>
            </summary>
