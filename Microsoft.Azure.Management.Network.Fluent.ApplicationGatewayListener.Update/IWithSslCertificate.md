<Type Name="IWithSslCertificate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayListener.Update.IWithSslCertificate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="21c2f-101">Die Phase eines Listeners Front-End-Anwendung Gateway aktualisieren, sodass an das SSL-Zertifikat des Listeners zugeordnet werden soll.</span><span class="sxs-lookup"><span data-stu-id="21c2f-101">The stage of an application gateway frontend listener update allowing to specify the SSL certificate to associate with the listener.</span></span>
            </summary>
