<Type Name="PartitionHealthState" FullName="System.Fabric.Health.PartitionHealthState">
  ...
  <Docs>
    <summary>
      <para>Stellt den Zustand einer Partition, die die Partitions-ID und der aggregierte Integritätszustand enthält.</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            Erstellt eine zeichenfolgenbeschreibung des Integritätsstatus Partition an.
            </summary>
        <returns>Zeichenfolgenbeschreibung des der <see cref="T:System.Fabric.Health.PartitionHealthState" />.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
