<Type Name="BaiduTemplateRegistrationDescription" FullName="Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="afed8-101">Stellt ein Baidu-Registrierung vorlagenbeschreibung dar.</span><span class="sxs-lookup"><span data-stu-id="afed8-101">Represents a Baidu template registration description.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sourceRegistration"><span data-ttu-id="afed8-102">Die Quell-Registrierung.</span><span class="sxs-lookup"><span data-stu-id="afed8-102">The source registration.</span></span></param>
        <summary>
            <span data-ttu-id="afed8-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afed8-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baiduUserId"><span data-ttu-id="afed8-104">Die Benutzer-ID Baidu.</span><span class="sxs-lookup"><span data-stu-id="afed8-104">The baidu user identifier.</span></span></param>
        <param name="baiduChannelId"><span data-ttu-id="afed8-105">Der Bezeichner für den Baidu-Kanal.</span><span class="sxs-lookup"><span data-stu-id="afed8-105">The baidu channel identifier.</span></span></param>
        <summary>
            <span data-ttu-id="afed8-106">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afed8-106">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baiduUserId"><span data-ttu-id="afed8-107">Die Benutzer-ID Baidu.</span><span class="sxs-lookup"><span data-stu-id="afed8-107">The baidu user identifier.</span></span></param>
        <param name="baiduChannelId"><span data-ttu-id="afed8-108">Der Bezeichner für den Baidu-Kanal.</span><span class="sxs-lookup"><span data-stu-id="afed8-108">The baidu channel identifier.</span></span></param>
        <param name="jsonPayload"><span data-ttu-id="afed8-109">Die Json-Nutzlast.</span><span class="sxs-lookup"><span data-stu-id="afed8-109">The json payload.</span></span></param>
        <summary>
            <span data-ttu-id="afed8-110">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afed8-110">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baiduUserId"><span data-ttu-id="afed8-111">Die Benutzer-ID Baidu.</span><span class="sxs-lookup"><span data-stu-id="afed8-111">The baidu user identifier.</span></span></param>
        <param name="baiduChannelId"><span data-ttu-id="afed8-112">Der Bezeichner für den Baidu-Kanal.</span><span class="sxs-lookup"><span data-stu-id="afed8-112">The baidu channel identifier.</span></span></param>
        <param name="jsonPayload"><span data-ttu-id="afed8-113">Die Json-Nutzlast.</span><span class="sxs-lookup"><span data-stu-id="afed8-113">The json payload.</span></span></param>
        <param name="tags"><span data-ttu-id="afed8-114">Die Tags.</span><span class="sxs-lookup"><span data-stu-id="afed8-114">The tags.</span></span></param>
        <summary>
            <span data-ttu-id="afed8-115">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="afed8-115">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.BaiduTemplateRegistrationDescription" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BodyTemplate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afed8-116">Ruft ab oder legt die Textvorlage.</span><span class="sxs-lookup"><span data-stu-id="afed8-116">Gets or sets the body template.</span></span>
            </summary>
        <value>
            <span data-ttu-id="afed8-117">Die Textvorlage.</span><span class="sxs-lookup"><span data-stu-id="afed8-117">The body template.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TemplateName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="afed8-118">Ruft ab oder legt den Namen der Vorlage.</span><span class="sxs-lookup"><span data-stu-id="afed8-118">Gets or sets the name of the template.</span></span>
            </summary>
        <value>
            <span data-ttu-id="afed8-119">Der Name der Vorlage.</span><span class="sxs-lookup"><span data-stu-id="afed8-119">The name of the template.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
