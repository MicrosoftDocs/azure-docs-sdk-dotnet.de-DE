<Type Name="BaiduNotification" FullName="Microsoft.Azure.NotificationHubs.BaiduNotification">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7121a-101">Stellt eine Baidu Notification Hub-Benachrichtigung, einschließlich der Zieltag</span><span class="sxs-lookup"><span data-stu-id="7121a-101">Represents a Baidu notification hub notification, including the target tag</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="7121a-102">Die Meldung.</span><span class="sxs-lookup"><span data-stu-id="7121a-102">The message.</span></span></param>
        <summary>
            <span data-ttu-id="7121a-103">Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.BaiduNotification" />-Klasse.</span><span class="sxs-lookup"><span data-stu-id="7121a-103">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.BaiduNotification" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnValidateAndPopulateHeaders">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7121a-104">Überprüfen und füllt die Header.</span><span class="sxs-lookup"><span data-stu-id="7121a-104">Validate and populates the headers.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PlatformType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7121a-105">Ruft den Typ der Plattform ab.</span><span class="sxs-lookup"><span data-stu-id="7121a-105">Gets the type of the platform.</span></span>
            </summary>
        <value>
            <span data-ttu-id="7121a-106">Der Typ der Plattform.</span><span class="sxs-lookup"><span data-stu-id="7121a-106">The type of the platform.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
