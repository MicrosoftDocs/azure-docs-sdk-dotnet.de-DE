<Type Name="WindowsTokenProvider" FullName="Microsoft.Azure.NotificationHubs.WindowsTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary>Stellt den Tokenanbieter für Servicebus dar.</summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <Docs>
        ...
        <returns>Ein generierter Schlüssel.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NormalizeAppliesTo">
      ...
      <Docs>
        <param name="appliesTo">Der URI, der die Normalisierung gilt.</param>
        <summary>Gibt den URI-Form die Zieladresse normalisieren.</summary>
        <returns>Das Normalisieren URI-Format für die Zieladresse.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        <param name="appliesTo">Das Objekt, in dem das Token angewendet wird.</param>
        <param name="action">Die Aktion.</param>
        <param name="timeout">Die Dauer des Vorgangs.</param>
        <param name="callback">Das Argument Fir des Anbieters.</param>
        <param name="state">Der Status des Anbieters.</param>
        <summary>Ruft ein Token ab, wenn der Provider-Dienst gestartet wurde.</summary>
    ...
    <Member MemberName="OnBeginGetWebToken">
      ...
      <Docs>
        ...
        <param name="callback">Das Argument Fir des Anbieters.</param>
        <param name="state">Der Status des Anbieters.</param>
        <summary>Ruft eine webtoken ab, wenn der Provider-Dienst gestartet wurde.</summary>
        <returns>Das Ergebnis des Vorgangs.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        ...
        <param name="cacheUntil">Die angegebene Zeitspanne für den Anbieter zum Speichern von Daten.</param>
        <summary>Ruft ein Token ab, wenn der Provider-Dienst beendet wurde.</summary>
        <returns>Das abgerufene-Token.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetWebToken">
      ...
      <Docs>
        <param name="result">Das Ergebnis des Vorgangs.</param>
        <param name="cacheUntil">Die angegebene Zeitspanne für den Anbieter zum Speichern von Daten.</param>
        <summary>Ruft eine webtoken ab, wenn der Provider-Dienst beendet wurde.</summary>
        <returns>Das abgerufene webtoken.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
