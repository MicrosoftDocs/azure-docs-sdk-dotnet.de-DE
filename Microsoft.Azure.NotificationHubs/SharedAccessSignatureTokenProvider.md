  ...
  <Members>
    ...
    <Member MemberName="GetSharedAccessSignature">
      ...
      <Docs>
        ...
        <param name="resource">Die Ressource unscaped</param>
        <param name="tokenTimeToLive">Die Zeit Tolen Gültigkeitsdauer</param>
        <summary>
             Generiert eine shared Access signature
            </summary>
        <returns>Zurückgeben einer SAS</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
