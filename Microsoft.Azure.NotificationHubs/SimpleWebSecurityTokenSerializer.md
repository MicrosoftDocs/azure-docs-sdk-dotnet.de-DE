<Type Name="SimpleWebSecurityTokenSerializer" FullName="Microsoft.Azure.NotificationHubs.SimpleWebSecurityTokenSerializer">
  ...
  <Interfaces />
  <Docs>
    <summary>Stellt eine Klasse, die zum Lesen und Schreiben verwendet <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityToken" />, <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifierClause" />, und <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifier" /> Objekte als XML.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityTokenSerializer" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="innerSerializer">Der Sicherheitstoken-Serialisierungsprogramm, das als das innere Serialisierungsprogramm verwendet.</param>
        <summary>Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityTokenSerializer" /> Klasse mit dem angegebenen Sicherheitstoken-Serialisierungsprogramm.</summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">Die <paramref name="innerSerializer" /> -Parameter ist null.</exception>
      </Docs>
    </Member>
    <Member MemberName="CanReadKeyIdentifierClauseCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" />, um die Schlüsselbezeichnerklausel zu lesen.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm lesen kann die &lt;KeyIdentifier&gt; Element durch den angegebenen XML-Reader verwiesen wird.</summary>
        <returns>True, wenn das angegebene &lt;KeyIdentifier&gt; Element kann gelesen werden soll, andernfalls "false" sein.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanReadKeyIdentifierCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" />, um den Schlüsselbezeichner zu lesen.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm lesen kann die &lt;KeyIdentifier&gt; Element durch den angegebenen XML-Reader verwiesen wird.</summary>
        <returns>True, wenn das angegebene &lt;KeyIdentifier&gt; Element kann gelesen werden soll, andernfalls "false" sein.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CanReadTokenCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" /> zum Lesen des Sicherheitstokens.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm das Sicherheitstoken lesen kann, auf das der angegebene XML-Reader zeigt.</summary>
        <returns>"true", wenn das Sicherheitstoken gelesen werden kann; andernfalls "false".</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanWriteKeyIdentifierClauseCore">
      ...
      <Docs>
        <param name="keyIdentifierClause">Eine <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifierClause" />, die die Schlüsselbezeichnerklausel darstellt, die geschrieben werden soll.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm die angegebene Schlüsselbezeichnerklausel schreiben kann.</summary>
        <returns>"true", wenn dieses Serialisierungsprogramm die angegebene schlüsselbezeichnerklausel schreiben kann; andernfalls "false".</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanWriteKeyIdentifierCore">
      ...
      <Docs>
        <param name="keyIdentifier">Ein <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifier" />, der den Schlüsselbezeichner darstellt, der geschrieben werden soll.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm den angegebenen Schlüsselbezeichner schreiben kann.</summary>
        <returns>"true", wenn dieses Serialisierungsprogramm den angegebenen Schlüsselbezeichner schreiben kann; andernfalls "false".</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanWriteTokenCore">
      ...
      <Docs>
        <param name="token">Das <see cref="T:System.IdentityModel.Tokens.SecurityToken" />-Sicherheitstoken, das in XML konvertiert werden soll.</param>
        <summary>Bestimmt, ob dieses Serialisierungsprogramm das angegebene Sicherheitstoken in XML schreiben kann.</summary>
        <returns>"true", wenn das Sicherheitstoken geschrieben werden kann; andernfalls "false".</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultInstance">
      ...
      <Docs>
        <summary>Gibt eine Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityTokenSerializer" /> Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadKeyIdentifierClauseCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" />, um die Schlüsselbezeichnerklausel zu lesen.</param>
        <summary>Liest die schlüsselbezeichnerklausel mit dem angegebenen XML-Reader.</summary>
        <returns>Ein <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifierClause" />, der den Schlüsselbezeichner darstellt, der gelesen wird.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadKeyIdentifierCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" />, um den Schlüsselbezeichner zu lesen.</param>
        <summary>Liest den Schlüsselbezeichner mit dem angegebenen XML-Reader.</summary>
        <returns>Ein <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifier" />, der den Schlüsselbezeichner darstellt, der gelesen wird.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadTokenCore">
      ...
      <Docs>
        <param name="reader">Ein <see cref="T:System.Xml.XmlReader" /> zum Lesen der SimpleWebSecurityToken oder das Sicherheitstoken.</param>
        <param name="tokenResolver">Ein <see cref="T:System.IdentityModel.Selectors.SecurityTokenResolver" />, der den Typ des Sicherheitstokens bestimmt.</param>
        <summary>Liest die <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityToken" /> oder das Sicherheitstoken, die an die angegebene XML-Reader zeigt.</summary>
        <returns>Ein <see cref="T:System.IdentityModel.Tokens.SecurityToken" /> , darstellt, die SimpleWebSecurityToken oder das Sicherheitstoken, das gelesen wird.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:System.NotSupportedException">Die Codierung des XML-Elements ist nicht base64Binary.</exception>
      </Docs>
    </Member>
    <Member MemberName="WriteKeyIdentifierClauseCore">
      ...
      <Docs>
        <param name="writer">Ein <see cref="T:System.Xml.XmlWriter" /> verwendet, um die dazugehörige schlüsselbezeichnerklausel zu schreiben.</param>
        <param name="keyIdentifierClause">Eine <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifierClause" />, die die Schlüsselbezeichnerklausel darstellt, die geschrieben werden soll.</param>
        <summary>Schreibt die angegebene Schlüsselbezeichnerklausel mit dem angegebenen XML-Writer.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteKeyIdentifierCore">
      ...
      <Docs>
        <param name="writer">Ein <see cref="T:System.Xml.XmlWriter" /> verwendet, um den Schlüsselbezeichner schreiben.</param>
        <param name="keyIdentifier">Ein <see cref="T:System.IdentityModel.Tokens.SecurityKeyIdentifier" />, der den Schlüsselbezeichner darstellt, der geschrieben werden soll.</param>
        <summary>Schreibt den angegebenen Schlüsselbezeichner mit dem angegebenen XML-Writer.</summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.InvalidOperationException">Der Inhalt im Binärformat token ist null.</exception>
      </Docs>
    </Member>
    <Member MemberName="WriteTokenCore">
      ...
      <Docs>
        <param name="writer">Ein <see cref="T:System.Xml.XmlWriter" /> verwendet, um das Schreiben des SimpleWebSecurityToken oder Sicherheit token.</param>
        <param name="token">Der SimpleWebSecurityToken oder Sicherheit token um zu schreiben.</param>
        <summary>Schreibt das angegebene <see cref="T:Microsoft.Azure.NotificationHubs.SimpleWebSecurityToken" /> oder Sicherheitstoken, die mit dem angegebenen XML-Writer.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
