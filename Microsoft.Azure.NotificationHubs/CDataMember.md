<Type Name="CDataMember" FullName="Microsoft.Azure.NotificationHubs.CDataMember">
  ...
  <Docs>
    <summary>Stellt die Benachrichtigungen von der <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" />.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">Der angegebene Wert.</param>
        <summary>Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" /> Klasse mit dem angegebenen Wert.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GenerateSchema">
      ...
      <Docs>
        <param name="xs">Das XML-Schema.</param>
        <summary>Generiert die schemendarstellung für die Konvertierung der XML-Schema.</summary>
        <returns>Die schemendarstellung für die Konvertierung der XML-Schema.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSchema">
      ...
      <Parameters />
      <Docs>
        <summary>Gibt die schemendarstellung für die XML-Schemas zurück.</summary>
        <returns>Die schemendarstellung für die XML-Schemas.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="op_Implicit">
      ...
      <Docs>
        ...
        <summary>Konvertiert den angegebenen Wert in eine <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" /> Objekt.</summary>
        <returns>Konvertiert den Wert der <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" /> Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="op_Implicit">
      ...
      <Docs>
        <param name="value">Der zu konvertierende Wert.</param>
        <summary>Konvertiert die <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" /> Objekt auf einen angegebenen Wert.</summary>
        <returns>Das konvertierte <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" /> Objekt auf einen angegebenen Wert.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadXml">
      ...
      <Docs>
        <param name="reader">Der XML-Reader zum Lesen der Daten.</param>
        <summary>Liest XML-Schema aus seiner XML-Darstellung.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>Ruft ab oder legt den Wert für die <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" />.</summary>
        <value>Der Wert von <see cref="T:Microsoft.Azure.NotificationHubs.CDataMember" />.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteXml">
      ...
      <Docs>
        <param name="writer">Der XML-Writer zum Schreiben.</param>
        <summary>Schreibt XML-Daten in seine XML-Darstellung.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
