  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.Azure.Management.BackupServices.ICSMProtectionPolicyOperations.
            </param>
        ...
        <param name="policyName">
            Erforderlich. Die Schutzrichtlinie Namen aktualisiert werden.
            </param>
        <param name="cSMAddProtectionPolicyRequest">
            Erforderlich. Die erstellungsanforderung für den Schutz-Richtlinie.
            </param>
        <param name="customRequestHeaders">
            Optional. Header Anforderungsparameter.
            </param>
        <summary>
            Erstellen Sie neue Schutzrichtlinie.
            </summary>
        <returns>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        ...
        <param name="policyName">
            Erforderlich. Die Schutzrichtlinie Name gelöscht werden soll.
            </param>
        <param name="customRequestHeaders">
            Optional. Header Anforderungsparameter.
            </param>
        <summary>
            Löschen Sie eine Schutzrichtlinie.
            </summary>
        <returns>
            Eine standarddienstantwort einschließlich ein HTTP-Statuscodes und einer Anforderungs-ID.
            </returns>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            Ruft die Liste der alle Protection-Richtlinie.
            </summary>
        <returns>
    ...
    <Member MemberName="Update">
      ...
      <Docs>
        ...
        <summary>
            Aktualisieren Sie die Schutzrichtlinie.
            </summary>
        <returns>
