<Type Name="WebhookNotification" FullName="Microsoft.Azure.Management.Monitor.Management.Models.WebhookNotification">
  ...
  <Docs>
    <summary>
            Webhook-Benachrichtigung über ein Ereignis für die automatische Skalierung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WebhookNotification-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceUri">die Adresse des Diensts auf die Benachrichtigung erhalten.</param>
        <param name="properties">eine Eigenschaftensammlung von Einstellungen. Dieser Wert kann leer sein.</param>
        <summary>
            Initialisiert eine neue Instanz der WebhookNotification-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Eigenschaftenbehälter, der Einstellungen. Dieser Wert kann leer sein.
            </summary>
    ...
    <Member MemberName="ServiceUri">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Adresse des Diensts auf die Benachrichtigung erhalten.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
