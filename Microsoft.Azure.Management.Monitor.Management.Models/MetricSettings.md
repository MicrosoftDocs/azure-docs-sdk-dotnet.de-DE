<Type Name="MetricSettings" FullName="Microsoft.Azure.Management.Monitor.Management.Models.MetricSettings">
  ...
  <Docs>
    <summary>
            Teil des MultiTenantDiagnosticSettings. Gibt die Einstellungen für eine bestimmte Metrik.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der MetricSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled">ein Wert, der angibt, ob diese Kategorie aktiviert ist.</param>
        <param name="timeGrain">der timegrain-Wert der Metrik im ISO8601-Format.</param>
        <param name="category">Namen einer Kategorie diagnostische Metrik wird für eine Ressource geben Sie diese Einstellung auf angewendet. Um die Liste der Metrik-Diagnosekategorien für eine Ressource zu erhalten, führen Sie zuerst einen Abrufvorgang-diagnoseeinstellungen.</param>
        <param name="retentionPolicy">die Aufbewahrungsrichtlinie für diese Kategorie.</param>
        <summary>
            Initialisiert eine neue Instanz der MetricSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Namen einer Kategorie diagnostische Metrik für einen Ressourcentyp, dem diese Einstellung angewendet wird. Um die Liste der Metrik-Diagnosekategorien für eine Ressource zu erhalten, führen Sie zuerst einen Abrufvorgang-diagnoseeinstellungen.
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob diese Kategorie aktiviert ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetentionPolicy">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Aufbewahrungsrichtlinie für diese Kategorie.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der timegrain-Wert der Metrik im ISO8601-Format.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
