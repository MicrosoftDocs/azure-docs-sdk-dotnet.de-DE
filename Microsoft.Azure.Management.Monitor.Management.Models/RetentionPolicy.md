<Type Name="RetentionPolicy" FullName="Microsoft.Azure.Management.Monitor.Management.Models.RetentionPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3a969-101">Gibt die Aufbewahrungsrichtlinie für das Protokoll an.</span><span class="sxs-lookup"><span data-stu-id="3a969-101">Specifies the retention policy for the log.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a969-102">Initialisiert eine neue Instanz der RetentionPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3a969-102">Initializes a new instance of the RetentionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="3a969-103">ein Wert, der angibt, ob der Aufbewahrungsrichtlinie aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="3a969-103">a value indicating whether the retention policy is enabled.</span></span></param>
        <param name="days"><span data-ttu-id="3a969-104">die Anzahl der Tage für die Beibehaltungsdauer in Tagen.</span><span class="sxs-lookup"><span data-stu-id="3a969-104">the number of days for the retention in days.</span></span> <span data-ttu-id="3a969-105">Der Wert 0 wird die Ereignisse jedoch praktisch unbegrenzt beibehalten.</span><span class="sxs-lookup"><span data-stu-id="3a969-105">A value of 0 will retain the events indefinitely.</span></span></param>
        <summary>
            <span data-ttu-id="3a969-106">Initialisiert eine neue Instanz der RetentionPolicy-Klasse.</span><span class="sxs-lookup"><span data-stu-id="3a969-106">Initializes a new instance of the RetentionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Days">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a969-107">Ruft ab oder legt die Anzahl der Tage für die Beibehaltungsdauer in Tagen fest.</span><span class="sxs-lookup"><span data-stu-id="3a969-107">Gets or sets the number of days for the retention in days.</span></span> <span data-ttu-id="3a969-108">Der Wert 0 wird die Ereignisse jedoch praktisch unbegrenzt beibehalten.</span><span class="sxs-lookup"><span data-stu-id="3a969-108">A value of 0 will retain the events indefinitely.</span></span>
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a969-109">Ruft ab oder legt einen Wert, der angibt, ob der Aufbewahrungsrichtlinie aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="3a969-109">Gets or sets a value indicating whether the retention policy is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3a969-110">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="3a969-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="3a969-111">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="3a969-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
