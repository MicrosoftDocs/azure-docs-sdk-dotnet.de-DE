<Type Name="WebhookReceiver" FullName="Microsoft.Azure.Management.Monitor.Management.Models.WebhookReceiver">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der WebhookReceiver-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name des Empfängers Webhook. Namen müssen über alle Empfänger innerhalb einer Aktivitätsgruppe eindeutig sein.</param>
        <param name="serviceUri">Der URI, auf dem Webhooks gesendet werden soll.</param>
        <summary>
            Initialisiert eine neue Instanz der WebhookReceiver-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Empfängers Webhook. Namen müssen über alle Empfänger innerhalb einer Aktivitätsgruppe eindeutig sein.
            </summary>
    ...
    <Member MemberName="ServiceUri">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den URI, auf dem Webhooks gesendet werden soll.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
