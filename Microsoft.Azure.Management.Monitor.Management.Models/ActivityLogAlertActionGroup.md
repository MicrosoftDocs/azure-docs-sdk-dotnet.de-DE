<Type Name="ActivityLogAlertActionGroup" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ActivityLogAlertActionGroup">
  ...
  <Docs>
    <summary>
            Ein Zeiger auf ein Azure-Aktionsgruppe.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ActivityLogAlertActionGroup-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="actionGroupId">Die Ressourcen-ID der Gruppe "Aktion".
            Dies darf nicht null oder leer sein.</param>
        <param name="webhookProperties">das Wörterbuch mit benutzerdefinierten Eigenschaften mit dem Post-Vorgang einbezogen. Diese Daten werden an die Webhook-Nutzlast angefügt.</param>
        <summary>
            Initialisiert eine neue Instanz der ActivityLogAlertActionGroup-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ActionGroupId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Ressourcen-ID der Gruppe "Aktion". Dies darf nicht null oder leer sein.
            </summary>
