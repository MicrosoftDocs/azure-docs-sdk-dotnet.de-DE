<Type Name="LogSettings" FullName="Microsoft.Azure.Management.Monitor.Management.Models.LogSettings">
  ...
  <Docs>
    <summary>
            Teil des MultiTenantDiagnosticSettings. Gibt die Einstellungen für ein bestimmtes Protokoll.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der LogSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled">ein Wert, der angibt, ob dieses Protokoll aktiviert ist.</param>
        <param name="category">Namen einer Kategorie Diagnoseprotokolls wird für eine Ressource geben Sie diese Einstellung auf angewendet. Um die Liste der Diagnoseprotokollkategorien für eine Ressource zu erhalten, führen Sie zuerst einen GET-Vorgang zum Abrufen von Diagnoseeinstellungen aus.</param>
        <param name="retentionPolicy">die Aufbewahrungsrichtlinie für dieses Protokoll.</param>
        <summary>
            Initialisiert eine neue Instanz der LogSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt Namen einer Kategorie Diagnoseprotokolls für einen Ressourcentyp, dem diese Einstellung angewendet wird. Um die Liste der Diagnoseprotokollkategorien für eine Ressource zu erhalten, führen Sie zuerst einen GET-Vorgang zum Abrufen von Diagnoseeinstellungen aus.
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob dieses Protokoll aktiviert ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetentionPolicy">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Aufbewahrungsrichtlinie für dieses Protokoll.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
