<Type Name="ActivityLogAlertAllOfCondition" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ActivityLogAlertAllOfCondition">
  ...
  <Docs>
    <summary>
            Eine warnungsbedingung Aktivitätsprotokoll erfüllt wird, wenn alle seine Member Bedingungen erfüllt sind.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ActivityLogAlertAllOfCondition-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allOf">Die Liste der Protokoll-warnungsbedingungen Aktivität.</param>
        <summary>
            Initialisiert eine neue Instanz der ActivityLogAlertAllOfCondition-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AllOf">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der Aktivität warnungsbedingungen Protokoll.
            </summary>
