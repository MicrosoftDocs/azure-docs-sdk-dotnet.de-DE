<Type Name="IMobileServiceTableOperation" FullName="Microsoft.WindowsAzure.MobileServices.Sync.IMobileServiceTableOperation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dc7af-101">Ein Objekt, das Table-Vorgang für die Remotetabelle darstellt</span><span class="sxs-lookup"><span data-stu-id="dc7af-101">An object representing table operation against remote table</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AbortPush">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-102">Brechen Sie den übergeordneten Push-Vorgang.</span><span class="sxs-lookup"><span data-stu-id="dc7af-102">Abort the parent push operation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ExecuteAsync">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-103">Führt den Vorgang für die Remotetabelle.</span><span class="sxs-lookup"><span data-stu-id="dc7af-103">Executes the operation against remote table.</span></span>
            </summary>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-104">Das Element, das dem Vorgang zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="dc7af-104">The item associated with the operation.</span></span>
            </summary>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-105">Die Art des Vorgangs</span><span class="sxs-lookup"><span data-stu-id="dc7af-105">The kind of operation</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-106">Der Status des Vorgangs</span><span class="sxs-lookup"><span data-stu-id="dc7af-106">The state of the operation</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Table">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dc7af-107">Die Tabelle, der der Vorgang ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="dc7af-107">The table that the operation will be executed against.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
