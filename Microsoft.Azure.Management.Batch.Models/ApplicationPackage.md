<Type Name="ApplicationPackage" FullName="Microsoft.Azure.Management.Batch.Models.ApplicationPackage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationPackage-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="version">Die Version des Anwendungspakets.</param>
        <param name="state">Der aktuelle Status des Anwendungspakets.
            Folgende Werte sind möglich: "Ausstehend", "Active", "Nicht zugeordnet"</param>
        <param name="format">Das Format des Anwendungspakets, wenn das Paket aktiv ist.</param>
        <param name="storageUrl">Die URL für das Anwendungspaket in Azure-Speicher.</param>
        <param name="storageUrlExpiry">Die UTC-Zeit, zu der die Azure-Speicher-URL abläuft.</param>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            Ruft das Format des Anwendungspakets, ab, wenn das Paket aktiv ist.
            </summary>
    ...
    <Member MemberName="LastActivationTime">
      ...
      <Docs>
        <summary>
            Ruft die Zeit, zu der das Paket zuletzt aktiviert wurde, ab, wenn das Paket aktiv ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft den aktuellen Status des Anwendungspakets an. Folgende Werte sind möglich: "Ausstehend", "Active", "Nicht zugeordnet"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrl">
      ...
      <Docs>
        <summary>
            Ruft die URL für das Anwendungspaket in Azure-Speicher.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrlExpiry">
      ...
      <Docs>
        <summary>
            Ruft die UTC-Zeit, zu der die Azure-Speicher-URL abläuft.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft die Version des Anwendungspakets.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
