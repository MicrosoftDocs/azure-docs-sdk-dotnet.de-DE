<Type Name="BatchAccountRegenerateKeyParameters" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccountRegenerateKeyParameters">
  ...
  <Docs>
    <summary>
            Parameter für die RegenerateKey zur Verfügung gestellt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BatchAccountRegenerateKeyParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyName">Der Typ des kontoschlüssel erneut generiert.
            Folgende Werte sind möglich: 'Primary', 'Sekundären'</param>
        <summary>
            Initialisiert eine neue Instanz der BatchAccountRegenerateKeyParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Typ des kontoschlüssel erneut generiert. Folgende Werte sind möglich: 'Primary', 'Sekundären'
            </summary>
