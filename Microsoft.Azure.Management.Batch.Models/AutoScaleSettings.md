<Type Name="AutoScaleSettings" FullName="Microsoft.Azure.Management.Batch.Models.AutoScaleSettings">
  ...
  <Docs>
    <summary>
            Einstellungen für automatische Skalierung für den Pool.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="formula">Eine Formel für die gewünschte Anzahl von Serverknoten im Pool.</param>
        <param name="evaluationInterval">Das Zeitintervall, an dem die Poolgröße gemäß Formel für automatische Skalierung automatisch angepasst werden soll.</param>
        <summary>
            Initialisiert eine neue Instanz der AutoScaleSettings-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EvaluationInterval">
      ...
      <Docs>
        ...
        <remarks>
            Wenn nicht angegeben, ist der Standardwert 15 Minuten (PT15M).
            </remarks>
      </Docs>
    </Member>
