<Type Name="ApplicationUpdateParameters" FullName="Microsoft.Azure.Management.Batch.Models.ApplicationUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cdf64-101">Parameter für eine Update-anwendungsanforderung.</span><span class="sxs-lookup"><span data-stu-id="cdf64-101">Parameters for an update application request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cdf64-102">Initialisiert eine neue Instanz der ApplicationUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cdf64-102">Initializes a new instance of the ApplicationUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allowUpdates"><span data-ttu-id="cdf64-103">Ein Wert, der angibt, ob die Pakete in der Anwendung unter Verwendung der gleichen Versionszeichenfolge überschrieben werden können.</span><span class="sxs-lookup"><span data-stu-id="cdf64-103">A value indicating whether packages within the application may be overwritten using the same version string.</span></span></param>
        <param name="defaultVersion"><span data-ttu-id="cdf64-104">Das Paket verwenden, wenn ein Client die Anwendung fordert jedoch eine Version nicht angegeben.</span><span class="sxs-lookup"><span data-stu-id="cdf64-104">The package to use if a client requests the application but does not specify a version.</span></span></param>
        <param name="displayName"><span data-ttu-id="cdf64-105">Der Anzeigename für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="cdf64-105">The display name for the application.</span></span></param>
        <summary>
            <span data-ttu-id="cdf64-106">Initialisiert eine neue Instanz der ApplicationUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="cdf64-106">Initializes a new instance of the ApplicationUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AllowUpdates">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cdf64-107">Ruft ab oder legt einen Wert, der angibt, ob die Pakete in der Anwendung unter Verwendung der gleichen Versionszeichenfolge überschrieben werden können.</span><span class="sxs-lookup"><span data-stu-id="cdf64-107">Gets or sets a value indicating whether packages within the application may be overwritten using the same version string.</span></span>
            </summary>
    ...
    <Member MemberName="DefaultVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cdf64-108">Abrufen oder Festlegen des Pakets verwenden, wenn ein Client die Anwendung fordert jedoch eine Version nicht angegeben.</span><span class="sxs-lookup"><span data-stu-id="cdf64-108">Gets or sets the package to use if a client requests the application but does not specify a version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cdf64-109">Ruft ab oder legt den Anzeigenamen für die Anwendung.</span><span class="sxs-lookup"><span data-stu-id="cdf64-109">Gets or sets the display name for the application.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
