<Type Name="ErrorResponse" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.ErrorResponse">
  ...
  <Docs>
    <summary>
            Beschreibt den Fehler, der aufgetreten sind.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">Der Fehlercode des Fehlers, der aufgetreten ist.</param>
        <param name="message">Beschreibt den Fehler im Detail.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse ErrorResponse an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            Ruft den aufgetretenen zugeordneten Fehlercode ab.
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            Ruft die den Fehler im Detail beschreibt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
