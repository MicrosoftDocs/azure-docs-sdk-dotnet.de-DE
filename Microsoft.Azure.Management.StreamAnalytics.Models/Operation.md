  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">Enthält die lokalisierten Anzeigeinformationen für diesen Vorgang / Aktion.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Vorgang an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            Ruft enthält die lokalisierten Anzeigeinformationen für diesen Vorgang / Aktion.
            </summary>
