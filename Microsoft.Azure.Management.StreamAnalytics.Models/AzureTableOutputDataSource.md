<Type Name="AzureTableOutputDataSource" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.AzureTableOutputDataSource">
  ...
  <Docs>
    <summary>
            Beschreibt eine Datenquelle für Azure Table-Ausgabe.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AzureTableOutputDataSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accountName">Der Name des Azure-Speicherkontos an.
            Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <param name="accountKey">Der kontoschlüssel für das Azure-Speicherkonto an. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <param name="table">Der Name der Azure-Tabelle. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <param name="partitionKey">Dieses Element gibt den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Partitionsschlüssel verwendet werden. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <param name="rowKey">Dieses Element gibt den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Zeilenschlüssel verwendet werden. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <param name="columnsToRemove">Wenn angegeben, wird jedes Element im Array der Name einer Spalte (falls vorhanden) aus den ausgabeereignisentitäten entfernt.</param>
        <param name="batchSize">Die Anzahl der Zeilen in der Azure-Tabellenspeicher blockweise zu schreiben.</param>
        <summary>
            Initialisiert eine neue Instanz der AzureTableOutputDataSource-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AccountKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den kontoschlüssel für das Azure-Speicherkonto an.
    ...
    <Member MemberName="AccountName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen des Azure-Speicherkontos an. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BatchSize">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der Zeilen in der Azure-Tabellenspeicher blockweise zu schreiben.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ColumnsToRemove">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest, wenn angegeben, jedes Element im Array ist der Name einer Spalte (falls vorhanden) aus den ausgabeereignisentitäten entfernt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartitionKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt dieses Element den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Partitionsschlüssel verwendet werden. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RowKey">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt dieses Element den Namen einer Spalte aus der SELECT-Anweisung in der Abfrage, die für die Azure-Tabelle als Zeilenschlüssel verwendet werden. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Table">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Azure-Tabelle. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
