<Type Name="AvroSerialization" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.AvroSerialization">
  ...
  <Docs>
    <summary>
            Beschreibt, wie Daten aus einer Eingabe serialisiert werden, oder wie die Daten beim Schreiben in eine Ausgabe im Avro-Format serialisiert werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AvroSerialization-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="properties">Die Eigenschaften, die die Avro-Serialisierungstyp zugeordnet sind. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
        <summary>
            Initialisiert eine neue Instanz der AvroSerialization-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Eigenschaften, die die Avro-Serialisierungstyp zugeordnet sind. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
