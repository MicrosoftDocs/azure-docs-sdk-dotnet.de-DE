<Type Name="CsvSerialization" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.CsvSerialization">
  ...
  <Docs>
    <summary>
            Beschreibt, wie Daten aus einer Eingabe serialisiert werden, oder wie die Daten beim Schreiben in eine Ausgabe im CSV-Format serialisiert werden.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der CsvSerialization-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="fieldDelimiter">Gibt das Trennzeichen an, das zum Trennen von Datensätzen durch Trennzeichen getrennte Werten (CSV) verwendet werden. Finden Sie unter https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-input oder https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-output eine Liste der unterstützten Werte. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.</param>
    ...
    <Member MemberName="FieldDelimiter">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt gibt das Trennzeichen an, das zum Trennen von Datensätzen durch Trennzeichen getrennte Werten (CSV) verwendet werden. Finden Sie unter https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-input oder https://docs.microsoft.com/en-us/rest/api/streamanalytics/stream-analytics-output eine Liste der unterstützten Werte. Auf (CreateOrReplace)-PUT-Anforderungen erforderlich.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
