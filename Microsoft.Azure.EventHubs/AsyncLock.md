<Type Name="AsyncLock" FullName="Microsoft.Azure.EventHubs.AsyncLock">
  ...
  <Docs>
    <summary>
            Als ein asynchrones Semaphor verwendet für interne Event Hubs-Vorgänge.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Gibt eine neue AsyncLock zurück.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            Wird geschlossen, und alle der AsyncLock zugeordneten Ressourcen frei.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LockAsync">
      ...
      <Docs>
        <param name="cancellationToken">Die <see cref="T:System.Threading.CancellationToken" /> die verwendet werden können, um die Sperre "Abbrechen"</param>
        <summary>
            Legt eine Sperre, die nach einem Abbruch ermöglicht, mithilfe einer <see cref="T:System.Threading.CancellationToken" />.
            </summary>
        <returns>Ein asynchroner Vorgang</returns>
        <remarks>To be added.</remarks>
      </Docs>
