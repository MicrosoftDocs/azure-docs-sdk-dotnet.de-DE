<Type Name="SetRouteConstraint&lt;TSet&gt;" FullName="Microsoft.Azure.Mobile.Server.Config.SetRouteConstraint&lt;TSet&gt;">
  ...
  <Docs>
    <typeparam name="TSet">Typ der Satz von Werten zum ein- bzw. ausschließen.</typeparam>
    <summary>
            Eine routeneinschränkung, die schränkt einen Route Parameterwert eingeschlossen bzw. aus einem Satz von Werten des Typs ausgeschlossen werden sollen <typeparamref name="TSet" />.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="set">Der Satz von Werten mit dem verglichen werden soll.</param>
        <param name="matchOnExcluded">Gibt an, dass der Wert des Parameters eingeschlossen oder aus der Gruppe ausgeschlossen werden soll.</param>
        <summary>
            Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.Mobile.Server.Config.SetRouteConstraint`1" />-Klasse. Mithilfe der <paramref name="matchOnExcluded" /> an, ob die Einschränkung muss den Wert des Parameters, eingeschlossen bzw. aus dem angegebenen Satz von Werten ausgeschlossen werden sollen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Excluded">
      ...
      <Docs>
        <summary>
            Gibt an, ob der Name des entsprechenden Parameters eingeschlossen oder, die in den Wert festlegen ausgeschlossen, um als übereinstimmend angesehen werden soll.
            </summary>
    ...
    <Member MemberName="Set">
      ...
      <Docs>
        <summary>
            Ruft den Satz von Werten für aus- oder eingeschlossen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
