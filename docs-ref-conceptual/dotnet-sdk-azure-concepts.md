...
Ressourcensammlungsmethoden, deren Name ein Verb enthält, haben eine umgehende Aktion in Azure zur Folge. Diese Methoden werden synchron ausgeführt und blockieren bis zu ihrem Abschluss die Ausführung im aktuellen Thread. 
