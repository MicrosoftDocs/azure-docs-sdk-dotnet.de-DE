  ...
  <Members>
    <Member MemberName="GetJob">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.Azure.Management.HDInsight.Job.IJobOperations.
            </param>
        <param name="jobId">
    ...
    <Member MemberName="ListJobsAfterJobId">
      ...
      <Docs>
        ...
        <param name="jobId">
            Optional. "JobID"-Wert von wo Aufträge aufgelistet werden.
            </param>
        <param name="numOfJobs">
            Erforderlich. Anzahl der Aufträge abgerufen. Verwenden Sie-1. um alle.
            </param>
        <summary>
