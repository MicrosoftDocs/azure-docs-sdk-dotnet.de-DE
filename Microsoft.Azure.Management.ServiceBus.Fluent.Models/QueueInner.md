<Type Name="QueueInner" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Models.QueueInner">
  ...
  <Docs>
    <summary>
            Beschreibung der Warteschlange für Ressource.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der QueueInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="lockDuration">Die Dauer einer vorschausperre; d. h. die Zeitspanne, die die Nachricht für andere Empfänger gesperrt ist.
            Der maximale Wert für die LockDuration ist 5 Minuten. Der Standardwert beträgt 1 Minute. Der Dienst akzeptiert ein C#-TimeSpan Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286 (v=vs.110).aspx</param>
        <param name="accessedAt">Letzte Uhrzeit, an eine Nachricht gesendet wurde, bzw. des letzten gab es eine Receive-Anforderung an diese Warteschlange.</param>
        <param name="autoDeleteOnIdle">die TimeSpan-leerlaufintervalls nach dem die Warteschlange automatisch gelöscht wird. Die Mindestdauer ist fünf Minuten. Der Dienst akzeptiert eine C#-TimeSpan-Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286(v=vs.110).aspx.
            Format ist "TT. Hh und Standardwert ist dieser Eigenschaft 10675199 Tage.</param>
        <param name="createdAt">Die genaue Uhrzeit der Erstellung der Warteschlangenobjekts.</param>
        <param name="defaultMessageTimeToLive">Die Nachricht Standardzeit TTL-Wert. Hierbei handelt es sich um den Zeitraum, nach dem die Nachricht beginnend ab dem Zeitpunkt der Nachricht, um Service Bus gesendet wird abläuft. Dies ist der Standardwert verwendet, wenn TimeToLive nicht für eine Nachricht selbst festgelegt ist.
            Format ist "TT. Hh und Standardwert ist dieser Eigenschaft 10675199 Tage. Der Dienst akzeptiert ein C#-TimeSpan Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286 (v=vs.110).aspx
            </param>
        <param name="duplicateDetectionHistoryTimeWindow">TimeSpan-Struktur, die die Zeitspanne des duplikaterkennungsverlaufs definiert. Der Standardwert ist 10 Minuten. Der Dienst akzeptiert eine C#-TimeSpan-Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286(v=vs.110).aspx.
            Format ist "TT. Hh und Standardwert ist dieser Eigenschaft 10675199 Tage</param>
        <param name="enableBatchedOperations">Ein Wert, der angibt, ob serverseitige Batchvorgänge aktiviert werden.</param>
        <param name="deadLetteringOnMessageExpiration">Ein Wert, der angibt, ob dieser Warteschlange für unzustellbare Unterstützung verfügt, wenn eine Nachricht abläuft.</param>
        <param name="enableExpress">Ein Wert, der angibt, ob die Express-Entitäten aktiviert sind. Eine express-Warteschlange speichert eine Nachricht im Arbeitsspeicher vorübergehend, bevor sie in den persistenten Speicher geschrieben.</param>
        <param name="enablePartitioning">Ein Wert, der angibt, ob die Warteschlange über mehrere nachrichtenbroker partitioniert werden.</param>
        <param name="maxDeliveryCount">Die Anzahl maximaler Zustellungen. Eine Nachricht wird automatisch als unzustellbar gekennzeichnet nach dieser Anzahl von Übermittlungen.</param>
        <param name="maxSizeInMegabytes">Die maximale Größe der Warteschlange in Megabyte an, die die Größe des Arbeitsspeichers für die Warteschlange zugeordnet ist.</param>
        <param name="messageCount">Die Anzahl der Nachrichten in der Warteschlange.</param>
        <param name="countDetails">To be added.</param>
        <param name="requiresDuplicateDetection">Ein Wert, der angibt, wenn diese Warteschlange Erkennung doppelten Nachrichten erforderlich sind.</param>
        <param name="requiresSession">Ein Wert, der angibt, ob die Warteschlange das Konzept der Sitzungen unterstützt.</param>
        <param name="sizeInBytes">Die Größe der Warteschlange, in Bytes.</param>
        ...
        <param name="supportOrdering">Ein Wert, der angibt, ob die Warteschlange Sortierung unterstützt.</param>
        <param name="updatedAt">Der genaue Zeitpunkt, zu die Warteschlange aktualisiert wurde.</param>
        <summary>
            Initialisiert eine neue Instanz der QueueInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AutoDeleteOnIdle">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Intervall der TimeSpan im Leerlauf nach dem die Warteschlange automatisch gelöscht wird. Die Mindestdauer ist fünf Minuten. Der Dienst akzeptiert eine C#-TimeSpan-Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286(v=vs.110).aspx.
    ...
    <Member MemberName="DeadLetteringOnMessageExpiration">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob dieser Warteschlange für unzustellbare Unterstützung verfügt, wenn eine Nachricht abläuft.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultMessageTimeToLive">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Standardzeit für die Nachricht TTL-Wert. Hierbei handelt es sich um den Zeitraum, nach dem die Nachricht beginnend ab dem Zeitpunkt der Nachricht, um Service Bus gesendet wird abläuft. Dies ist der Standardwert verwendet, wenn TimeToLive nicht für eine Nachricht selbst festgelegt ist. Format ist "TT. Hh und Standardwert ist dieser Eigenschaft 10675199 Tage. Der Dienst akzeptiert ein C#-TimeSpan Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286 (v=vs.110).aspx
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DuplicateDetectionHistoryTimeWindow">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt TimeSpan-Struktur, die die Zeitspanne des duplikaterkennungsverlaufs definiert. Der Standardwert ist 10 Minuten. Der Dienst akzeptiert eine C#-TimeSpan-Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286(v=vs.110).aspx.
            Format ist "TT. Hh und Standardwert ist dieser Eigenschaft 10675199 Tage
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EnableBatchedOperations">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob serverseitige Batchvorgänge aktiviert werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableExpress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Express-Entitäten aktiviert sind. Eine express-Warteschlange speichert eine Nachricht im Arbeitsspeicher vorübergehend, bevor sie in den persistenten Speicher geschrieben.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnablePartitioning">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Warteschlange über mehrere nachrichtenbroker partitioniert werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LockDuration">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Dauer einer vorschausperre; d. h. die Zeitspanne, die die Nachricht für andere Empfänger gesperrt ist. Der maximale Wert für die LockDuration ist 5 Minuten. Der Standardwert beträgt 1 Minute.
            Der Dienst akzeptiert ein C#-TimeSpan Standardformat für Lokalisierung Dauer https://msdn.microsoft.com/en-us/library/ee372286 (v=vs.110).aspx
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxDeliveryCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl maximaler Zustellungen. Eine Nachricht wird automatisch als unzustellbar gekennzeichnet nach dieser Anzahl von Übermittlungen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxSizeInMegabytes">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die maximale Größe der Warteschlange in Megabyte an, die Größe des Arbeitsspeichers für die Warteschlange ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequiresDuplicateDetection">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, wenn diese Warteschlange Erkennung doppelten Nachrichten erforderlich sind.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequiresSession">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Warteschlange das Konzept der Sitzungen unterstützt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Ruft Listet die möglichen Werte für den Status einer messaging-Entität. Folgende Werte sind möglich: "Active", "Erstellen", "Löschen", "Deaktiviert", "ReceiveDisabled", "Umbenennen", "Wiederherstellen", "SendDisabled", "Unknown"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportOrdering">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Warteschlange Sortierung unterstützt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
