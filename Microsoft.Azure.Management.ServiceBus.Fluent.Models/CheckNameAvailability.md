<Type Name="CheckNameAvailability" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Models.CheckNameAvailability">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name, überprüfen Sie die Verfügbarkeit des Namespacenamens und des Namespacenamens können nur Buchstaben, Zahlen und Bindestriche enthalten. Der Namespace muss mit einem Buchstaben beginnen und mit einem Buchstaben oder einer Ziffer enden.</param>
        <summary>
            Initialisiert eine neue Instanz der CheckNameAvailability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
