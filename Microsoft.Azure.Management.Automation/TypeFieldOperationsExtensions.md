    ...
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            Verweis auf die Microsoft.Azure.Management.Automation.ITypeFieldOperations.
            </param>
        ...
        <summary>
            Abgerufen Sie eine Liste der Felder eines bestimmten Typs Modulname identifizierte werden.  (siehe http://aka.ms/azureautomationsdk/typefieldoperations für Weitere Informationen)
            </summary>
        <returns>
