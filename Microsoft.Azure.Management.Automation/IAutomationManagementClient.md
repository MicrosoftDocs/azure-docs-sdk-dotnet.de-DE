    ...
    <Member MemberName="GetOperationStatusAsync">
      ...
      <Docs>
        <param name="requestId">
            Die Anforderungs-ID für die Anforderung, die Sie verfolgen möchten. Die Anforderungs-ID wird in der X-ms-Request-Id-Antwort-Header für jede Anforderung zurückgegeben.
            </param>
        <param name="cancellationToken">
            Abbruchtoken.
            </param>
