<Type Name="IAgentRegistrationOperation" FullName="Microsoft.Azure.Management.Automation.IAgentRegistrationOperation">
  ...
  <Docs>
    <summary>
            Der Dienstvorgang für Automation agentregistrierungsinformationen.  (siehe http://aka.ms/azureautomationsdk/agentregistrationoperations für Weitere Informationen)
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="RegenerateKeyAsync">
      ...
      <Docs>
        ...
        <param name="keyName">
            Der Name des Registrierungsschlüssels Agent neu generiert werden
            </param>
        <param name="cancellationToken">
            Abbruchtoken.
            </param>
