<Type Name="IUpdateCombined" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateCombined.IUpdateCombined">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c7d07-101">Die gesamte eines Datensatzes legt Update als Teil der übergeordneten DNS-Zone Updates fest.</span><span class="sxs-lookup"><span data-stu-id="c7d07-101">The entirety of a record sets update as a part of parent DNS zone update.</span></span>
            </summary>
