<Type Name="IWithClientCertEnabled&lt;FluentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppBase.Definition.IWithClientCertEnabled&lt;FluentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="FluentT"><span data-ttu-id="aa53b-101">Der Typ der Ressource.</span><span class="sxs-lookup"><span data-stu-id="aa53b-101">The type of the resource.</span></span></typeparam>
    <summary>
            <span data-ttu-id="aa53b-102">Eine Web-app Definition Phase Einstellung zulassen, wenn Clientzertifikats aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="aa53b-102">A web app definition stage allowing setting if client cert is enabled.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithClientCertEnabled">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="aa53b-103">"True", wenn Clientzertifikats aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="aa53b-103">True if client cert is enabled.</span></span></param>
        <summary>
            <span data-ttu-id="aa53b-104">Gibt an, ob Clientzertifikats aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="aa53b-104">Specifies if client cert is enabled.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="aa53b-105">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="aa53b-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>