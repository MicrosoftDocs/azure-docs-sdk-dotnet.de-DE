<Type Name="IWithPrimaryInternetFacingLoadBalancerNatPool" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternetFacingLoadBalancerNatPool">
  ...
  <Docs>
    <summary>
            Legen Sie die Phase der eine virtuelle Maschine Skalierung Gruppe Update mit der primären Netzwerkschnittstelle der virtuellen Computer in die Skalierung einen eingehenden NAT-Pool des Lastenausgleichs ausgewählten Internetzugriff zugeordnet werden soll.
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrimaryInternetFacingLoadBalancerInboundNatPools">
      ...
      <Docs>
        <param name="natPoolNames">Die Namen der vorhandenen eingehenden NAT-Pools auf der ausgewählten Load Balancer.</param>
        <summary>
            Ordnet eingehende NAT-Pools des ausgewählten Internetzugriff Load Balancers mit der primären Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.
            </summary>
