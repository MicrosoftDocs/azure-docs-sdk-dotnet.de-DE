<Type Name="IWithPrimaryInternalLoadBalancer" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternalLoadBalancer">
  ...
  <Docs>
    <summary>
            Virtuelle Computer festlegen des Status der eine virtuelle Maschine Skalierung Gruppe Update mit einem internen Lastenausgleich für die primäre Netzwerkschnittstelle der Skala an.
            </summary>
