<Type Name="IWithPrimaryInternetFacingLoadBalancerBackendOrNatPool" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IWithPrimaryInternetFacingLoadBalancerBackendOrNatPool">
  ...
  <Docs>
    <summary>
            Festlegen des Status der VM-Skalierungsgruppe, Updates zulassen, Zuordnen einer Back-End-Pool und/oder eingehenden NAT-Pool des ausgewählten Internetzugriff zum Lastenausgleich mit der primären Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.
            </summary>
  ...
  <Members>
    <Member MemberName="WithPrimaryInternetFacingLoadBalancerBackends">
      ...
      <Docs>
        <param name="backendNames">Die Back-End-Namen.</param>
        <summary>
            Ordnet die angegebene Internetzugriff Laden des Lastenausgleichsmoduls-Back-Ends mit der primären Netzwerkschnittstelle der virtuellen Computer in der Menge der Skala.
            </summary>
