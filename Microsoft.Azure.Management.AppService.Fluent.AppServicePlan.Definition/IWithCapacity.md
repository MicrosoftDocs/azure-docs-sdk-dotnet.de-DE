<Type Name="IWithCapacity" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Definition.IWithCapacity">
  ...
  <Docs>
    <summary>
            Eine app Plan Dienstdefinition Instanz Kapazität festgelegt werden können.
            </summary>
  ...
  <Members>
    <Member MemberName="WithCapacity">
      ...
      <Docs>
        <param name="capacity">Die maximale Anzahl von Instanzen.</param>
        <summary>
            Gibt die maximale Anzahl von Instanzen, die für diese app Service-Plan ausgeführt.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>Die nächste Phase der Definition einer app Service-Plan.</return>
      </Docs>
    </Member>
  </Members>
</Type>