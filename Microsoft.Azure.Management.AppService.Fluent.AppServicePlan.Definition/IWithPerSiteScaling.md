<Type Name="IWithPerSiteScaling" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Definition.IWithPerSiteScaling">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8ca02-101">Ein app Service-plan Definition ermöglicht pro Website, die Skalierung der Konfiguration festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="8ca02-101">An app service plan definition allowing per site scaling configuration to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPerSiteScaling">
      ...
      <Docs>
        <param name="perSiteScaling"><span data-ttu-id="8ca02-102">Wenn Sie jeden Standort einzeln skaliert werden kann.</span><span class="sxs-lookup"><span data-stu-id="8ca02-102">If each site can be scaled individually.</span></span></param>
        <summary>
            <span data-ttu-id="8ca02-103">Gibt an, ob Skalierung pro Website aktiviert.</span><span class="sxs-lookup"><span data-stu-id="8ca02-103">Specifies whether per-site scaling will be turned on.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="8ca02-104">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="8ca02-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>