<Type Name="IDefinitionShared" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.DefinitionShared.IDefinitionShared">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="36980-101">Die VM-Skalierungsgruppe Phasen zwischen verwaltetem und nicht verwaltetem Basis VM Skalierung Definitionen freigegeben.</span><span class="sxs-lookup"><span data-stu-id="36980-101">The virtual machine scale set stages shared between managed and unmanaged based virtual machine scale set definitions.</span></span>
            </summary>
