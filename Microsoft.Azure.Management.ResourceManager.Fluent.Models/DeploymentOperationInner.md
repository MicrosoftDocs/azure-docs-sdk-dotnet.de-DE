<Type Name="DeploymentOperationInner" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.DeploymentOperationInner">
  ...
  <Docs>
    <summary>
            Bereitstellungsvorgangsinformationen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DeploymentOperationInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Vollständige Bereitstellungsvorgangs-Id.</param>
        <param name="operationId">Bereitstellungsvorgangs-Id.</param>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt die vollständige Bereitstellungsvorgangs-Id fest.
            </summary>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt die Bereitstellungsvorgangs-Id fest.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
