  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="displayName">Ruft ab oder legt den Anzeigenamen des Abonnements</param>
        <param name="state">Ruft ab oder legt den Status des Abonnements</param>
        <param name="subscriptionPolicies">Ruft ab oder legt die Richtlinien Abonnement fest.</param>
        <summary>
            Initialisiert eine neue Instanz der SubscriptionInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Status des Abonnements
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
