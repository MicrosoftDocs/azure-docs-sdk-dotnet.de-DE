<Type Name="ExportTemplateRequestInner" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.ExportTemplateRequestInner">
  ...
  <Docs>
    <summary>
            Exportieren Sie die Gruppe Anforderung ressourcenvorlagenparameter.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ExportTemplateRequestInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resources">Die Ressourcen-Ids. Derzeit ist die einzige unterstützte Zeichenfolge "*" (alle Ressourcen). Exportieren von bestimmten Ressourcen unterstützt zukünftige api-Updates.</param>
        <param name="options">Der Export Vorlagenoptionen auswählen. Unterstützte Werte sind "IncludeParameterDefaultValue", "IncludeComments" oder "IncludeParameterDefaultValue, IncludeComments</param>
        <summary>
            Initialisiert eine neue Instanz der ExportTemplateRequestInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Options">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Export Vorlagenoptionen auswählen. Unterstützte Werte sind "IncludeParameterDefaultValue", "IncludeComments" oder "IncludeParameterDefaultValue, IncludeComments
            </summary>
    ...
    <Member MemberName="Resources">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Ressourcen-Ids. Derzeit ist die einzige unterstützte Zeichenfolge "*" (alle Ressourcen). Exportieren von bestimmten Ressourcen unterstützt zukünftige api-Updates.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
