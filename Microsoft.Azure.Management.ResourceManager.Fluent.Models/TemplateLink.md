<Type Name="TemplateLink" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.TemplateLink">
  ...
  <Docs>
    <summary>
            Die Entität, die den Verweis auf die Vorlage darstellt.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der TemplateLink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="uri">Der URI, auf die Vorlage verweist.</param>
        <param name="contentVersion">Wenn enthalten mit ContentVersion in der Vorlage übereinstimmen muss.</param>
        <summary>
            Initialisiert eine neue Instanz der TemplateLink-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ContentVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt fest, ob es enthalten müssen die ContentVersion in der Vorlage übereinstimmen.
            </summary>
    ...
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest URI auf die Vorlage verweist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
