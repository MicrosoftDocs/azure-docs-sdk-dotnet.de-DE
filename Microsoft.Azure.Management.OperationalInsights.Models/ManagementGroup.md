<Type Name="ManagementGroup" FullName="Microsoft.Azure.Management.OperationalInsights.Models.ManagementGroup">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der Klasse ManagementGroup wird aufgerufen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serverCount">Die Anzahl der Server, die mit der Verwaltungsgruppe verbunden werden.</param>
        <param name="isGateway">Ruft ab oder legt einen Wert, der angibt, ob die Verwaltungsgruppe ein Gateway ist.</param>
        <param name="name">Der Name der Verwaltungsgruppe.</param>
        <param name="id">Die eindeutige ID der Verwaltungsgruppe.</param>
        <param name="created">Der DateTime-Wert, dass die Verwaltungsgruppe erstellt wurde.</param>
        <param name="dataReceived">Die letzte "DateTime", dass die Verwaltungsgruppe Daten empfangen.</param>
        <param name="version">Die Version von System Center, die die Verwaltungsgruppe verwaltet wird.</param>
        <param name="sku">Die SKU von System Center, die die Verwaltungsgruppe verwaltet wird.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse ManagementGroup wird aufgerufen.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Created">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der "DateTime", dass die Verwaltungsgruppe erstellt wurde.
            </summary>
    ...
    <Member MemberName="DataReceived">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den letzten DateTime-Wert, dass die Verwaltungsgruppe Daten empfangen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die eindeutige ID der Verwaltungsgruppe.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsGateway">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Wert, der angibt, ob die Verwaltungsgruppe ein Gateway ist.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Namen der Verwaltungsgruppe.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerCount">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl der Server mit der Verwaltungsgruppe verbunden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest-SKU von System Center, die die Verwaltungsgruppe verwaltet wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version von System Center, die die Verwaltungsgruppe verwaltet wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
