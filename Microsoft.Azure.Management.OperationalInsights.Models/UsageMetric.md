<Type Name="UsageMetric" FullName="Microsoft.Azure.Management.OperationalInsights.Models.UsageMetric">
  ...
  <Docs>
    <summary>
            Eine Metrik, beschreibt die Verwendung einer Ressource.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="unit">Die Einheiten für die Metrik verwendet werden.</param>
        <param name="currentValue">Der aktuelle Wert der Metrik.</param>
        <param name="limit">Die Kontingentgrenze für die Metrik.</param>
        <param name="nextResetTime">Die Zeit, die die Metrik Wert zurückgesetzt wird.</param>
        <param name="quotaPeriod">Das Kontingentszeitraum, der die Zeitdauer zwischen dem Wert bestimmt wird zurückgesetzt.</param>
        <summary>
            Initialisiert eine neue Instanz der UsageMetric-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CurrentValue">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den aktuellen Wert der Metrik.
            </summary>
    ...
    <Member MemberName="Limit">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Kontingentgrenze für die Metrik.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NextResetTime">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Zeit, die die Metrik Wert zurückgesetzt wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QuotaPeriod">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Kontingentszeitraum, der bestimmt, die Länge der Zeit zwischen den Wert zurückgesetzt.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Einheiten für die Metrik verwendet werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
