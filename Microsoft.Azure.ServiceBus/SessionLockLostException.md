<Type Name="SessionLockLostException" FullName="Microsoft.Azure.ServiceBus.SessionLockLostException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a5fe3-101">Die Ausnahme, die ausgelöst wird, wenn die Sperre für die Sitzung ist abgelaufen.</span><span class="sxs-lookup"><span data-stu-id="a5fe3-101">The exception that is thrown when the lock on the Session has expired.</span></span>  <span data-ttu-id="a5fe3-102">Aufrufer sollten die Sitzung wieder erhalten.</span><span class="sxs-lookup"><span data-stu-id="a5fe3-102">Callers should receive the Session again.</span></span>
            </summary>
