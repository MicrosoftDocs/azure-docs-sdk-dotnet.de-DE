<Type Name="QuotaExceededException" FullName="Microsoft.Azure.ServiceBus.QuotaExceededException">
  ...
  <Docs>
    <summary>
            Die Ausnahme, die ausgelöst wird, wenn der Entität zugewiesene Kontingent (Entität Max Size oder anderen Verbindung usw.) überschritten hat.  Aufrufer sollten überprüfen, die Fehlermeldung, um festzustellen, welche das Kontingent überschritten, und ergreifen Sie entsprechende Maßnahmen.
            </summary>
