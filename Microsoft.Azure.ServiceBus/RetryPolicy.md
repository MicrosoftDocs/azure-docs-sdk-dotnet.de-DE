<Type Name="RetryPolicy" FullName="Microsoft.Azure.ServiceBus.RetryPolicy">
  ...
  <Members>
    ...
    <Member MemberName="Default">
      ...
      <Docs>
        <summary>
            Gibt die standardmäßige wiederholungsrichtlinie <see cref="T:Microsoft.Azure.ServiceBus.RetryExponential" />.
            </summary>
    ...
    <Member MemberName="IsServerBusy">
      ...
      <Docs>
        <summary>
            Legt fest, ob der Server ein ausgelastet Fehler zurückgegeben.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunOperation">
      ...
      <Docs>
        <param name="operation">Ein <see cref="T:System.Func`2" /> ausgeführt werden.</param>
        <param name="operationTimeout">Das Timeout für den gesamten Vorgang.</param>
        <summary>
            Führt eine <see cref="T:System.Func`2" />, mit der aktuellen RetryPolicy.
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerBusyExceptionMessage">
      ...
      <Docs>
        <summary>
            Ruft die Ausnahmemeldung ab, wenn ein Server ausgelastet-Fehler zurückgegeben wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
