<Type Name="ActorReentrancyMode" FullName="Microsoft.ServiceFabric.Actors.Runtime.ActorReentrancyMode">
  ...
  <Docs>
    <summary>
            Gibt den Reentranz Modus für Akteur Methodenaufrufe.
            </summary>
  ...
  <Members>
    <Member MemberName="Disallowed">
      ...
      <Docs>
        <summary>
            Lässt keine Akteure um wiedereintrittsfähig sein. In diesem Fall, wenn ein Akteur eine reentrant-Nachricht an einen anderen Akteur, eine Ausnahme vom Typ sendet <see cref="T:System.Fabric.FabricException" /> ausgelöst.
            </summary>
      </Docs>
    </Member>
    <Member MemberName="LogicalCallContext">
      ...
      <Docs>
        <summary>
            Ermöglicht die Akteure wiedereintrittsfähig, wenn sie in der gleichen Kontext Aufrufkette sind. Dies ist die Standardoption für Akteure.
            </summary>
      </Docs>
    </Member>
  </Members>
