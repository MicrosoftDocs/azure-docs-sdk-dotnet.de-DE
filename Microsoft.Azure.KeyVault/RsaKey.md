<Type Name="RsaKey" FullName="Microsoft.Azure.KeyVault.RsaKey">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Konstruktor erstellt einen 2048-Bit-Schlüssel mit einem GUID-Bezeichner.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            Konstruktor erstellt einen 2048-Bit-RSA-Schlüssel.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">Der Schlüsselbezeichner verwenden</param>
        <param name="keySize">Die Größe des Schlüssels</param>
        <summary>
            Konstruktor.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">Der Schlüsselbezeichner verwenden</param>
        <param name="csp">Die RSA-Objekt für den Schlüssel</param>
        <summary>
            Konstruktor.
            </summary>
        <remarks>RSA-Objekt ist IDisposable, diese Klasse wird einen Verweis auf den RSA-Objekt enthalten, aber wird nicht freigegeben, der Aufrufer dieses Konstruktors ist verantwortlich für die Lebensdauer dieses Parameters.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">Der Schlüsselbezeichner verwenden</param>
        <param name="keyParameters">Die RSA-Parameter für den Schlüssel</param>
        <summary>
            Konstruktor
            </summary>
        <remarks>To be added.</remarks>
