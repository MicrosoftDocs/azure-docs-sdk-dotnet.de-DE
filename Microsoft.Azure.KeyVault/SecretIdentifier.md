<Type Name="SecretIdentifier" FullName="Microsoft.Azure.KeyVault.SecretIdentifier">
  ...
  <Docs>
    <summary>
            Der geheime Key Vault-Bezeichner.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="identifier">Der Bezeichner für den geheimen Schlüssel.</param>
        <summary>
            Konstruktor.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="version">die Version des geheimen Schlüssels.</param>
        <summary>
            Konstruktor.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IsSecretIdentifier">
      ...
      <Docs>
        ...
        <summary>
            Überprüft, ob der Bezeichner für einen schlüsseltresor geheimen Schlüssel gehört.
            </summary>
        <returns>"true", wenn der Bezeichner für einen schlüsseltresor geheimen Schlüssel gehört. "False" andernfalls.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
