<Type Name="DeletedVault" FullName="Microsoft.Azure.Management.KeyVault.Models.DeletedVault">
  ...
  <Docs>
    <summary>
            Gelöschte tresorinformationen mit nähere Einzelheiten.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DeletedVault-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Die Ressourcen-ID für die gelöschten den schlüsseltresor verwendet werden soll.</param>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Ruft die Ressourcen-ID für den gelöschten schlüsseltresor.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft den Namen des schlüsseltresors.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
