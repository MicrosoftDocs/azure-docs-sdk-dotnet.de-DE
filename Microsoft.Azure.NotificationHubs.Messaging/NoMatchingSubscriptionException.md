<Type Name="NoMatchingSubscriptionException" FullName="Microsoft.Azure.NotificationHubs.Messaging.NoMatchingSubscriptionException">
  ...
  <Interfaces />
  <Docs>
    <summary>Die Ausnahme, die ausgelöst wird, wenn Abonnements zugeordnet keine Übereinstimmung geführt hat.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message">Die Fehlermeldung zur Ausnahme.</param>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.NoMatchingSubscriptionException" />-Klasse mit einer Fehlermeldung.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.NoMatchingSubscriptionException" />-Klasse mit einer Fehlermeldung und inneren </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Parameters />
      <Docs>
        <summary>Gibt die Zeichenfolgendarstellung der <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.NoMatchingSubscriptionException" /> zurück.</summary>
        <returns>Die Zeichenfolgendarstellung des <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.NoMatchingSubscriptionException" />.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
