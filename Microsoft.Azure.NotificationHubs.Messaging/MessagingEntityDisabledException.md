<Type Name="MessagingEntityDisabledException" FullName="Microsoft.Azure.NotificationHubs.Messaging.MessagingEntityDisabledException">
  ...
  <Interfaces />
  <Docs>
    <summary>Ausnahme für eine anzeigenden messaging-Entität deaktiviert Fehler.</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="entityName">Der Name der Entität, die verantwortlich für die Ausnahme.</param>
        <summary>Initialisiert eine neue Instanz der <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.MessagingEntityDisabledException" />-Klasse.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
