<Type Name="AuthorizationRule" FullName="Microsoft.Azure.NotificationHubs.Messaging.AuthorizationRule">
  ...
  <Docs>
    <summary><span data-ttu-id="2851e-101">Definiert die Azure Service Bus-Autorisierungsregel, die verwendet wird, um zu bestimmen, ob ein Vorgang zulässig ist.</span><span class="sxs-lookup"><span data-stu-id="2851e-101">Defines the Azure Service Bus authorization rule that is used to determine whether an operation is permissible or not.</span></span></summary>
  ...
  <Members>
    <Member MemberName="ClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-102">Ruft den Anspruchstyp ab oder legt ihn fest.</span><span class="sxs-lookup"><span data-stu-id="2851e-102">Gets or sets the claim type.</span></span></summary>
        <value><span data-ttu-id="2851e-103">Der Anspruchstyp.</span><span class="sxs-lookup"><span data-stu-id="2851e-103">The claim type.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClaimValue">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-104">Ruft ab oder legt den Wert des Anspruchs also entweder "Senden", "Überwachen" oder "Verwalten".</span><span class="sxs-lookup"><span data-stu-id="2851e-104">Gets or sets the claim value which is either ‘Send’, ‘Listen’, or ‘Manage’.</span></span></summary>
        <value><span data-ttu-id="2851e-105">Der Wert des Anspruchs also entweder "Senden", "Überwachen" oder "Verwalten".</span><span class="sxs-lookup"><span data-stu-id="2851e-105">The claim value which is either ‘Send’, ‘Listen’, or ‘Manage’.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clone">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="2851e-106">Erstellt eine Kopie des <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.AuthorizationRule" />.</span><span class="sxs-lookup"><span data-stu-id="2851e-106">Creates a copy of <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.AuthorizationRule" />.</span></span></summary>
        <returns><span data-ttu-id="2851e-107">Eine erstellte Kopie des <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.AuthorizationRule" />.</span><span class="sxs-lookup"><span data-stu-id="2851e-107">A created copy of <see cref="T:Microsoft.Azure.NotificationHubs.Messaging.AuthorizationRule" />.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreatedTime">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-108">Ruft ab oder legt das Datum und Uhrzeit der Erstellung der Autorisierungsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-108">Gets or sets the date and time when the authorization rule was created.</span></span></summary>
        <value><span data-ttu-id="2851e-109">Das Datum und Uhrzeit der Erstellung der Autorisierungsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-109">The date and time when the authorization rule was created.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Equals">
      ...
      <Docs>
        <param name="obj"><span data-ttu-id="2851e-110">Das Objekt, das mit dem aktuellen Objekt verglichen werden soll.</span><span class="sxs-lookup"><span data-stu-id="2851e-110">The object to compare with the current object.</span></span></param>
        <summary><span data-ttu-id="2851e-111">Bestimmt, ob das angegebene Objekt mit dem aktuellen Objekt identisch ist.</span><span class="sxs-lookup"><span data-stu-id="2851e-111">Determines whether the specified object is equal to the current object.</span></span></summary>
        <returns><span data-ttu-id="2851e-112">True, wenn das angegebene Objekt mit dem aktuellen Objekt identisch ist. andernfalls "false".</span><span class="sxs-lookup"><span data-stu-id="2851e-112">true if the specified object is equal to the current object; otherwise, false.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetHashCode">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="2851e-113">Gibt den Hashcode für diese Instanz zurück.</span><span class="sxs-lookup"><span data-stu-id="2851e-113">Returns the hash code for this instance.</span></span></summary>
        <returns><span data-ttu-id="2851e-114">Der Hashcode für diese Instanz.</span><span class="sxs-lookup"><span data-stu-id="2851e-114">The hash code for this instance.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IssuerName">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-115">Abrufen oder festlegen den Namensbezeichner des Ausstellers.</span><span class="sxs-lookup"><span data-stu-id="2851e-115">Gets or sets the name identifier of the issuer.</span></span></summary>
        <value><span data-ttu-id="2851e-116">Der Namensbezeichner des Ausstellers.</span><span class="sxs-lookup"><span data-stu-id="2851e-116">The name identifier of the issuer.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-117">Ruft ab oder legt den Schlüsselnamen für die Autorisierung Regel.</span><span class="sxs-lookup"><span data-stu-id="2851e-117">Gets or sets the authorization rule key name.</span></span></summary>
        <value><span data-ttu-id="2851e-118">Die Autorisierung Key Regelname.</span><span class="sxs-lookup"><span data-stu-id="2851e-118">The authorization rule key name.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ModifiedTime">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-119">Ruft ab oder legt das Datum und Uhrzeit der Änderung der Autorisierungsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-119">Gets or sets the date and time when the authorization rule was modified.</span></span></summary>
        <value><span data-ttu-id="2851e-120">Das Datum und Uhrzeit der Änderung der Autorisierungsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-120">The date and time when the authorization rule was modified.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NameIdentifierClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-121">Die Name-ID-Anspruchsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-121">The name identifier claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Revision">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-123">Ruft ab oder legt die Revisionsnummer der Änderung.</span><span class="sxs-lookup"><span data-stu-id="2851e-123">Gets or sets the modification revision number.</span></span></summary>
        <value><span data-ttu-id="2851e-124">Die Revisionsnummer der Änderung.</span><span class="sxs-lookup"><span data-stu-id="2851e-124">The modification revision number.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Rights">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-125">Ruft ab oder legt die Liste der Rechte.</span><span class="sxs-lookup"><span data-stu-id="2851e-125">Gets or sets the list of rights.</span></span></summary>
        <value><span data-ttu-id="2851e-126">Die Liste der Rechte.</span><span class="sxs-lookup"><span data-stu-id="2851e-126">The list of rights.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RoleClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-127">Die Anspruchsregel Rolle.</span><span class="sxs-lookup"><span data-stu-id="2851e-127">The role claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RoleRoleClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-128">Die Rolle Rolle Anspruchsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-128">The role role claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SharedAccessKeyClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-129">Der gemeinsame Zugriffsschlüssel anspruchsregelvorlagen.</span><span class="sxs-lookup"><span data-stu-id="2851e-129">The shared access key claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ShortNameIdentifierClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-130">Der Bezeichner der Kurzname anspruchsregelvorlagen.</span><span class="sxs-lookup"><span data-stu-id="2851e-130">The short name identifier claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ShortUpnClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-131">Die kurzen UPN-Anspruchsregel.</span><span class="sxs-lookup"><span data-stu-id="2851e-131">The short UPN claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpnClaimType">
      ...
      <Docs>
        <summary><span data-ttu-id="2851e-132">Die Regel für den UPN-Anspruch.</span><span class="sxs-lookup"><span data-stu-id="2851e-132">The UPN claim rule.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ValidateRights">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="2851e-133">Die Zugriffsrechte, um zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="2851e-133">The access rights to check.</span></span></param>
        <summary><span data-ttu-id="2851e-134">Überprüft die Gültigkeit der angegebenen Zugriffsrechte.</span><span class="sxs-lookup"><span data-stu-id="2851e-134">Checks the validity of the specified access rights.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
