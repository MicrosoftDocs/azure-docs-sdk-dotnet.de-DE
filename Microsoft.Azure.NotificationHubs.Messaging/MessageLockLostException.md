<Type Name="MessageLockLostException" FullName="Microsoft.Azure.NotificationHubs.Messaging.MessageLockLostException">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="5e4f4-101">Die Ausnahme, die ausgelöst wird, um die Nachricht zu signalisieren Sperren verloren Fehler.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-101">The exception that is thrown to signal message lock lost errors.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="5e4f4-102">Die Fehlermeldung, in der die Ursache der Ausnahme erklärt wird.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-102">The error message that explains the reason for the exception.</span></span></param>
        <summary><span data-ttu-id="5e4f4-103">Initialisiert eine neue Instanz der Klasse MessageLockLostException mit einer angegebenen Fehlermeldung.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-103">Initializes a new instance of the MessageLockLostException class with a specified error message.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="5e4f4-104">Die Fehlermeldung, in der die Ursache der Ausnahme erklärt wird.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-104">The error message that explains the reason for the exception.</span></span></param>
        <param name="innerException"><span data-ttu-id="5e4f4-105">Die Ausnahme, die die Ursache der aktuellen Ausnahme ist.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-105">The exception that is the cause of the current exception.</span></span></param>
        <summary><span data-ttu-id="5e4f4-106">Initialisiert eine neue Instanz der Klasse MessageLockLostException mit einer angegebenen Fehlermeldung und einem Verweis auf die innere Ausnahme, die diese Ausnahme ausgelöst hat.</span><span class="sxs-lookup"><span data-stu-id="5e4f4-106">Initializes a new instance of the MessageLockLostException class with a specified error message and a reference to the inner exception that is the cause of this exception.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
