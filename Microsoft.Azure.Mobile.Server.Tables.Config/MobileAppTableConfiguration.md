<Type Name="MobileAppTableConfiguration" FullName="Microsoft.Azure.Mobile.Server.Tables.Config.MobileAppTableConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9b72a-101">Bietet Konfigurationsmethoden für die Mobile App-Domänencontroller, auf denen Ableitung <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableController" />.</span><span class="sxs-lookup"><span data-stu-id="9b72a-101">Provides configuration methods for Mobile App controllers that derive from <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableController" />.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="MapTableControllers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9b72a-102">Ordnet alle Domänencontroller, auf denen Ableitung <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableController" /> auf die routenvorlage "Tabellen / {Controller} / {Id}".</span><span class="sxs-lookup"><span data-stu-id="9b72a-102">Maps all controllers that derive from <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableController" /> to the route template "tables/{controller}/{id}".</span></span>
            </summary>
        <returns><span data-ttu-id="9b72a-103">Der aktuelle <see cref="T:Microsoft.Azure.Mobile.Server.Tables.Config.MobileAppTableConfiguration" />.</span><span class="sxs-lookup"><span data-stu-id="9b72a-103">The current <see cref="T:Microsoft.Azure.Mobile.Server.Tables.Config.MobileAppTableConfiguration" />.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
