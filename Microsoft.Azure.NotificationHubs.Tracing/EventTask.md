<Type Name="EventTask" FullName="Microsoft.Azure.NotificationHubs.Tracing.EventTask">
  ...
  <Docs>
    <summary><span data-ttu-id="1cdf5-101">Gibt eine Enumeration, die mit einem Ereignisaufgabe, die in einem Ereignisanbieter definiert ist.</span><span class="sxs-lookup"><span data-stu-id="1cdf5-101">Specifies an enumeration containing an event task that is defined in an event provider.</span></span></summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary><span data-ttu-id="1cdf5-102">Aufgabe ist "None".</span><span class="sxs-lookup"><span data-stu-id="1cdf5-102">Task is None.</span></span></summary>
      </Docs>
    </Member>
  </Members>
</Type>