<Type Name="SharedAccessAccountResourceTypes" FullName="Microsoft.WindowsAzure.Storage.SharedAccessAccountResourceTypes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ef51c-101">Gibt den Satz von möglichen signierte Ressource-Typen für eine Richtlinie für freigegebenen Zugriff Konto.</span><span class="sxs-lookup"><span data-stu-id="ef51c-101">Specifies the set of possible signed resource types for a shared access account policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Container">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef51c-102">Berechtigung auf Containerebene APIs (Blob-Containern, Tabellen, Warteschlangen, Dateifreigaben) erteilt.</span><span class="sxs-lookup"><span data-stu-id="ef51c-102">Permission to access container level APIs (Blob Containers, Tables, Queues, File Shares) granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef51c-103">Kein gemeinsamer Zugriff gewährt wird.</span><span class="sxs-lookup"><span data-stu-id="ef51c-103">No shared access granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Object">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef51c-104">Berechtigung auf Objektebene erteilt APIs (Blobs, Tabellenentitäten, Warteschlangennachrichten, Dateien) zugreifen.</span><span class="sxs-lookup"><span data-stu-id="ef51c-104">Permission to access object level APIs (Blobs, Table Entities, Queue Messages, Files) granted</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Service">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef51c-105">Berechtigung zum Servicelevel gewährt APIs zuzugreifen.</span><span class="sxs-lookup"><span data-stu-id="ef51c-105">Permission to access service level APIs granted.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
