<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.QueueAuthorizationRule.Definition.IBlank">
  ...
  <TypeSignature Language="DocId" Value="T:Microsoft.Azure.Management.ServiceBus.Fluent.QueueAuthorizationRule.Definition.IBlank" />
  ...
  <Docs>
    <summary>
            <span data-ttu-id="58fb2-101">Die erste Phase der Warteschlange Autorisierung Regeldefinition.</span><span class="sxs-lookup"><span data-stu-id="58fb2-101">The first stage of queue authorization rule definition.</span></span>
            </summary>
