<Type Name="CertificateDescription" FullName="Microsoft.Azure.Management.ServiceFabric.Models.CertificateDescription">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="thumbprint">Fingerabdruck des primären Zertifikats</param>
        <param name="thumbprintSecondary">Fingerabdruck des sekundären Zertifikats</param>
        <param name="x509StoreName">Speicherort des lokalen Zertifikatspeichers.
            Folgende Werte sind möglich: "AddressBook", "AuthRoot", "CertificateAuthority", "Nicht zugelassen", "My", "Root", "TrustedPeople", "TrustedPublisher"</param>
        <summary>
            Initialisiert eine neue Instanz der CertificateDescription-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Fingerabdruck des primären Zertifikats
            </summary>
    ...
    <Member MemberName="ThumbprintSecondary">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt ihn fest Fingerabdruck des sekundären Zertifikats
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="X509StoreName">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Speicherort des lokalen Zertifikatspeichers. Folgende Werte sind möglich: "AddressBook", "AuthRoot", "CertificateAuthority", "Nicht zugelassen", "My", "Root", "TrustedPeople", "TrustedPublisher"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
