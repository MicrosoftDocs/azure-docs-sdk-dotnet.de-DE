<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="11ac6-101">Die Phase der Definition einer Anwendung-Gateway ermöglicht die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="11ac6-101">The stage of an application gateway definition allowing to specify the resource group.</span></span>
            </summary>
