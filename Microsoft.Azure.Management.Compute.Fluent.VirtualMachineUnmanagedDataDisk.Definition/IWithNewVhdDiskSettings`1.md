<Type Name="IWithNewVhdDiskSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineUnmanagedDataDisk.Definition.IWithNewVhdDiskSettings&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="9096f-101">die Phase der Definition des übergeordneten wieder nach dem Anfügen dieser Definition.</span><span class="sxs-lookup"><span data-stu-id="9096f-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="9096f-102">Die Stufe, die ermöglicht konfigurieren Sie den Datenträger basierend auf neuen virtuellen Festplatte.</span><span class="sxs-lookup"><span data-stu-id="9096f-102">The stage that allows configure the disk based on new VHD.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="StoreAt">
      ...
      <Docs>
        <param name="storageAccountName"><span data-ttu-id="9096f-103">Der Name des Speicherkontos.</span><span class="sxs-lookup"><span data-stu-id="9096f-103">The storage account name.</span></span></param>
        <param name="containerName"><span data-ttu-id="9096f-104">Der Name des Containers zum Speichern der neuen VHD-Datei.</span><span class="sxs-lookup"><span data-stu-id="9096f-104">The name of the container to hold the new VHD file.</span></span></param>
        <param name="vhdName"><span data-ttu-id="9096f-105">Der Name für die neue VHD-Datei.</span><span class="sxs-lookup"><span data-stu-id="9096f-105">The name for the new VHD file.</span></span></param>
        <summary>
            <span data-ttu-id="9096f-106">Gibt an, in denen die neuer leerer Datenträger zugeordnete VHD-Datei gespeichert werden muss.</span><span class="sxs-lookup"><span data-stu-id="9096f-106">Specifies where the VHD associated with the new blank data disk needs to be stored.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9096f-107">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="9096f-107">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="9096f-108">der Datenträger, die caching-Typ.</span><span class="sxs-lookup"><span data-stu-id="9096f-108">The disk caching type.</span></span> <span data-ttu-id="9096f-109">Folgende Werte sind möglich: "None", "ReadOnly", "ReadWrite".</span><span class="sxs-lookup"><span data-stu-id="9096f-109">Possible values include: 'None', 'ReadOnly', 'ReadWrite'.</span></span></param>
        <summary>
            <span data-ttu-id="9096f-110">Gibt an, welche Zwischenspeichern für den Datenträger.</span><span class="sxs-lookup"><span data-stu-id="9096f-110">Specifies the caching type for the data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9096f-111">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="9096f-111">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithLun">
      ...
      <Docs>
        <param name="lun"><span data-ttu-id="9096f-112">Die logische Gerätenummer.</span><span class="sxs-lookup"><span data-stu-id="9096f-112">The logical unit number.</span></span></param>
        <summary>
            <span data-ttu-id="9096f-113">Gibt die logische Gerätenummer für den Datenträger an.</span><span class="sxs-lookup"><span data-stu-id="9096f-113">Specifies the logical unit number for the data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9096f-114">Die nächste Phase der Datendefinition der Datenträger.</span><span class="sxs-lookup"><span data-stu-id="9096f-114">The next stage of data disk definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>