<Type Name="NextHopParametersInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.NextHopParametersInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der NextHopParametersInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetResourceId">Der Ressourcenbezeichner der Zielressource für die ist die Aktion ausgeführt werden.</param>
        <param name="sourceIPAddress">Die Quell-IP-Adresse.</param>
        <param name="destinationIPAddress">Die Ziel-IP-Adresse.</param>
        <param name="targetNicResourceId">Der NIC-ID. (Wenn der virtuelle Computer mehrere NICs hat und IP-Weiterleitung für ein beliebiges der Nics aktiviert ist, muss dann dieser Parameter angegeben werden. Andernfalls optional).</param>
        <summary>
            Initialisiert eine neue Instanz der NextHopParametersInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DestinationIPAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die IP-Zieladresse.
            </summary>
    ...
    <Member MemberName="SourceIPAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Quell-IP-Adresse.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetNicResourceId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die NIC ID. (Wenn der virtuelle Computer mehrere NICs hat und IP-Weiterleitung für ein beliebiges der Nics aktiviert ist, muss dann dieser Parameter angegeben werden. Andernfalls optional).
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetResourceId">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Ressourcenbezeichner der Zielressource für die ist die Aktion ausgeführt werden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
