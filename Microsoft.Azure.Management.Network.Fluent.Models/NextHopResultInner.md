<Type Name="NextHopResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.NextHopResultInner">
  ...
  <Docs>
    <summary>
            Die Informationen zum nächsten Hop von den angegebenen virtuellen Computer.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der NextHopResultInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nextHopType">Typ des nächsten Hops. Folgende Werte sind möglich: "Internet", "virtualappliance" "", "VirtualNetworkGateway", "VnetLocal", "HyperNetGateway", "None"</param>
        <param name="nextHopIpAddress">IP-Adresse des nächsten Abschnitts</param>
        <param name="routeTableId">Der Ressourcenbezeichner für die Routentabelle verknüpft sind, mit der Route, die zurückgegeben wird. Wenn die Route, die zurückgegeben wird nicht für jeden Benutzer, Routen erstellt wird, wird dieses Feld die Zeichenfolge 'System Route' sein.</param>
        <summary>
            Initialisiert eine neue Instanz der NextHopResultInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NextHopIpAddress">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die nächsten Hop IP-Adresse
            </summary>
    ...
    <Member MemberName="NextHopType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt der Typ des nächsten Hops. Folgende Werte sind möglich: "Internet", "virtualappliance" "", "VirtualNetworkGateway", "VnetLocal", "HyperNetGateway", "None"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTableId">
      ...
      <Docs>
        <summary>
            Abrufen oder festlegen den Ressourcenbezeichner für die Routentabelle verknüpft sind, mit der Route, die zurückgegeben wird. Wenn die Route, die zurückgegeben wird nicht für jeden Benutzer, Routen erstellt wird, wird dieses Feld die Zeichenfolge 'System Route' sein.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
