<Type Name="BackendAddressPoolInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.BackendAddressPoolInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der BackendAddressPoolInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="backendIPConfigurations">Ruft die Auflistung von Verweisen auf die IP-Adressen im Netzwerkschnittstellen definiert.</param>
        <param name="loadBalancingRules">Ruft den Regeln Lastenausgleich, die diesen Back-End-Adresspool verwenden.</param>
        <param name="outboundNatRule">Ruft die ausgehende Regeln, die diesen Back-End-Adresspool verwenden.</param>
        <param name="provisioningState">Abrufen der Bereitstellungsstatus der öffentlichen IP-Adressressource. Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</param>
    ...
    <Member MemberName="BackendIPConfigurations">
      ...
      <Docs>
        <summary>
            Ruft die Auflistung von Verweisen auf die IP-Adressen im Netzwerkschnittstellen definiert.
            </summary>
    ...
    <Member MemberName="LoadBalancingRules">
      ...
      <Docs>
        <summary>
            Ruft den Regeln Lastenausgleich, die diesen Back-End-Adresspool verwenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutboundNatRule">
      ...
      <Docs>
        <summary>
            Ruft die ausgehende Regeln, die diesen Back-End-Adresspool verwenden.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            Abrufen oder Festlegen der Bereitstellungsstatus der öffentlichen IP-Adressressource Get.
