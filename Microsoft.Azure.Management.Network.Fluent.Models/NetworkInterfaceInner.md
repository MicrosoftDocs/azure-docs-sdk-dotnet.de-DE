<Type Name="NetworkInterfaceInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.NetworkInterfaceInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="87ac2-101">Eine Netzwerkschnittstelle in einer Ressourcengruppe.</span><span class="sxs-lookup"><span data-stu-id="87ac2-101">A network interface in a resource group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-102">Initialisiert eine neue Instanz der NetworkInterfaceInner-Klasse.</span><span class="sxs-lookup"><span data-stu-id="87ac2-102">Initializes a new instance of the NetworkInterfaceInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DnsSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-103">Ruft ab oder legt die DNS-Einstellungen in die Netzwerkschnittstelle fest.</span><span class="sxs-lookup"><span data-stu-id="87ac2-103">Gets or sets the DNS settings in network interface.</span></span>
            </summary>
    ...
    <Member MemberName="EnableAcceleratedNetworking">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-104">Ruft ab oder legt fest, ob die Netzwerkschnittstelle wird beschleunigt Networking aktiviert.</span><span class="sxs-lookup"><span data-stu-id="87ac2-104">Gets or sets if the network interface is accelerated networking enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableIPForwarding">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-105">Gibt an, ob die IP-Weiterleitung für diese Netzwerkschnittstelle aktiviert ist, ruft ab oder legt ihn fest.</span><span class="sxs-lookup"><span data-stu-id="87ac2-105">Gets or sets indicates whether IP forwarding is enabled on this network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-106">Ruft ab oder legt eine eindeutige Zeichenfolge ohne Schreibzugriff, die geändert werden, wenn die Ressource aktualisiert wird.</span><span class="sxs-lookup"><span data-stu-id="87ac2-106">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-107">Ruft ab oder legt eine Liste der IP-Konfiguration der Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="87ac2-107">Gets or sets a list of IPConfigurations of the network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MacAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-108">Ruft ab oder legt die MAC-Adresse der Netzwerkschnittstelle.</span><span class="sxs-lookup"><span data-stu-id="87ac2-108">Gets or sets the MAC address of the network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroup">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-109">Ruft ab oder legt den Verweis der NetworkSecurityGroup Ressource.</span><span class="sxs-lookup"><span data-stu-id="87ac2-109">Gets or sets the reference of the NetworkSecurityGroup resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Primary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-110">Ruft ab, ob es sich um eine primäre Netzwerkschnittstelle auf einem virtuellen Computer handelt.</span><span class="sxs-lookup"><span data-stu-id="87ac2-110">Gets whether this is a primary network interface on a virtual machine.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-111">Ruft ab oder legt den Bereitstellungsstatus der öffentlichen IP-Adressressource.</span><span class="sxs-lookup"><span data-stu-id="87ac2-111">Gets or sets the provisioning state of the public IP resource.</span></span>
            <span data-ttu-id="87ac2-112">Mögliche Werte sind: "Aktualisieren", "Löschen" und "Fehler".</span><span class="sxs-lookup"><span data-stu-id="87ac2-112">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-113">Ruft ab oder legt die GUID-Eigenschaft, der die Schnittstelle Netzwerkressource "Ressource".</span><span class="sxs-lookup"><span data-stu-id="87ac2-113">Gets or sets the resource GUID property of the network interface resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualMachine">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="87ac2-114">Ruft ab oder legt den Verweis einer virtuellen Maschine.</span><span class="sxs-lookup"><span data-stu-id="87ac2-114">Gets or sets the reference of a virtual machine.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
