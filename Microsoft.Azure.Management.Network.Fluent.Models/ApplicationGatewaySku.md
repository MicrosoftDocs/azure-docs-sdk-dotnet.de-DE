<Type Name="ApplicationGatewaySku" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewaySku">
  ...
  <Docs>
    <summary>
            SKU des ein vorhandenes Anwendungsgateway
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewaySku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Name des einen Anwendungsgateway SKU. Mögliche Werte sind: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium" und "WAF_Large". Folgende Werte sind möglich: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium", "WAF_Large"</param>
        <param name="tier">Ein vorhandenes Anwendungsgateway-Ebene: Mögliche Werte sind: "Standard" und "WAF". Folgende Werte sind möglich: "Standard", "WAF"</param>
        <param name="capacity">Kapazität (instanzenanzahl) einen Anwendungsgateway.</param>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewaySku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway Kapazität (instanzenanzahl).
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Name, der ein vorhandenes Anwendungsgateway SKU. Mögliche Werte sind: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium" und "WAF_Large". Folgende Werte sind möglich: "Standard_Small", "Standard_Medium", "Standard_Large", "WAF_Medium", "WAF_Large"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ermittelt oder definiert einen Anwendungsgateway Ebene. Mögliche Werte sind: "Standard" und "WAF". Folgende Werte sind möglich: "Standard", "WAF"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
