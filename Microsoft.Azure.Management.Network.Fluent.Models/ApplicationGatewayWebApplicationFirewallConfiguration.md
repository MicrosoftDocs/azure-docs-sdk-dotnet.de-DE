<Type Name="ApplicationGatewayWebApplicationFirewallConfiguration" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayWebApplicationFirewallConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f503a-101">Application Gateway Web Application-Firewallkonfiguration.</span><span class="sxs-lookup"><span data-stu-id="f503a-101">Application gateway web application firewall configuration.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f503a-102">Initialisiert eine neue Instanz der ApplicationGatewayWebApplicationFirewallConfiguration-Klasse.</span><span class="sxs-lookup"><span data-stu-id="f503a-102">Initializes a new instance of the ApplicationGatewayWebApplicationFirewallConfiguration class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f503a-103">Ruft ab oder legt fest, ob die Web-Anwendung-Firewall oder nicht aktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="f503a-103">Gets or sets whether the web application firewall is enabled or not.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FirewallMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f503a-104">Ruft ab, oder legt ihn fest Firewallmodus für Web-Anwendung.</span><span class="sxs-lookup"><span data-stu-id="f503a-104">Gets or sets web application firewall mode.</span></span> <span data-ttu-id="f503a-105">Mögliche Werte sind: "Erkennung" und "Unterbindung".</span><span class="sxs-lookup"><span data-stu-id="f503a-105">Possible values are: 'Detection' and 'Prevention'.</span></span> <span data-ttu-id="f503a-106">Folgende Werte sind möglich: "Erkennung", "Prevention"</span><span class="sxs-lookup"><span data-stu-id="f503a-106">Possible values include: 'Detection', 'Prevention'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f503a-107">Überprüfen Sie das Objekt.</span><span class="sxs-lookup"><span data-stu-id="f503a-107">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="f503a-108">Wird ausgelöst, wenn die Validierung fehlschlägt</span><span class="sxs-lookup"><span data-stu-id="f503a-108">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
