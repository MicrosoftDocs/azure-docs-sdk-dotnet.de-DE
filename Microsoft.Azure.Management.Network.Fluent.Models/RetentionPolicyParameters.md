<Type Name="RetentionPolicyParameters" FullName="Microsoft.Azure.Management.Network.Fluent.Models.RetentionPolicyParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="89fbe-101">Parameter, mit die die Aufbewahrungsrichtlinie für Datenfluss-Protokolls definiert.</span><span class="sxs-lookup"><span data-stu-id="89fbe-101">Parameters that define the retention policy for flow log.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="89fbe-102">Initialisiert eine neue Instanz der RetentionPolicyParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="89fbe-102">Initializes a new instance of the RetentionPolicyParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="days"><span data-ttu-id="89fbe-103">Anzahl der Tage Fluss Protokolleinträge beibehalten werden sollen.</span><span class="sxs-lookup"><span data-stu-id="89fbe-103">Number of days to retain flow log records.</span></span></param>
        <param name="enabled"><span data-ttu-id="89fbe-104">Kennzeichen, das aktiviert bzw. deaktiviert die Beibehaltungsdauer.</span><span class="sxs-lookup"><span data-stu-id="89fbe-104">Flag to enable/disable retention.</span></span></param>
        <summary>
            <span data-ttu-id="89fbe-105">Initialisiert eine neue Instanz der RetentionPolicyParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="89fbe-105">Initializes a new instance of the RetentionPolicyParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Days">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="89fbe-106">Ruft ab oder legt die Anzahl von Tagen Fluss Protokolleinträge beibehalten werden sollen.</span><span class="sxs-lookup"><span data-stu-id="89fbe-106">Gets or sets number of days to retain flow log records.</span></span>
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="89fbe-107">Ruft ab, oder legt ihn fest-Flag aktiviert bzw. deaktiviert die Beibehaltungsdauer.</span><span class="sxs-lookup"><span data-stu-id="89fbe-107">Gets or sets flag to enable/disable retention.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
