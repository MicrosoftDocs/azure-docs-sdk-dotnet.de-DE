<Type Name="RetentionPolicyParameters" FullName="Microsoft.Azure.Management.Network.Fluent.Models.RetentionPolicyParameters">
  ...
  <Docs>
    <summary>
            Parameter, mit die die Aufbewahrungsrichtlinie für Datenfluss-Protokolls definiert.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RetentionPolicyParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="days">Anzahl der Tage Fluss Protokolleinträge beibehalten werden sollen.</param>
        <param name="enabled">Kennzeichen, das aktiviert bzw. deaktiviert die Beibehaltungsdauer.</param>
        <summary>
            Initialisiert eine neue Instanz der RetentionPolicyParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Days">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Anzahl von Tagen Fluss Protokolleinträge beibehalten werden sollen.
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest-Flag aktiviert bzw. deaktiviert die Beibehaltungsdauer.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
