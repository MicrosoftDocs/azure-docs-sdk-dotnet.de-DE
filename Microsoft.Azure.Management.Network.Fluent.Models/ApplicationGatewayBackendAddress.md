<Type Name="ApplicationGatewayBackendAddress" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayBackendAddress">
  ...
  <Docs>
    <summary>
            Back-End-Adresse eines Gateways für die Anwendung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der ApplicationGatewayBackendAddress-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="fqdn">Vollständig qualifizierten Domänennamen (FQDN).</param>
    ...
    <Member MemberName="Fqdn">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den vollqualifizierten Domänennamen (FQDN).
            </summary>
