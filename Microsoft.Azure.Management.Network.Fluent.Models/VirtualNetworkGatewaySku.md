<Type Name="VirtualNetworkGatewaySku" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VirtualNetworkGatewaySku">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der VirtualNetworkGatewaySku-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Gateway-SKU-Name. Mögliche Werte sind: 'Basic', 'HighPerformance', 'Standard' und 'UltraPerformance'. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance"</param>
        <param name="tier">Gateway-SKU-Tarif. Mögliche Werte sind: 'Basic', 'HighPerformance', 'Standard' und 'UltraPerformance'. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance"</param>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Kapazität fest.
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Gateway-SKU-Name. Mögliche Werte sind: 'Basic', 'HighPerformance', 'Standard' und 'UltraPerformance'. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest Gateway-SKU-Tarif. Mögliche Werte sind: 'Basic', 'HighPerformance', 'Standard' und 'UltraPerformance'. Folgende Werte sind möglich: "Basic", "HighPerformance", "Standard", "UltraPerformance"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
