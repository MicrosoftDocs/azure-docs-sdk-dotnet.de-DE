<Type Name="SecurityGroupViewParameters" FullName="Microsoft.Azure.Management.Network.Fluent.Models.SecurityGroupViewParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SecurityGroupViewParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetResourceId">Die ID des Ziels VM.</param>
        <summary>
            Initialisiert eine neue Instanz der SecurityGroupViewParameters-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TargetResourceId">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die ID des Ziels VM.
            </summary>
