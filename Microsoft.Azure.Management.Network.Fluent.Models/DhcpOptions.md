<Type Name="DhcpOptions" FullName="Microsoft.Azure.Management.Network.Fluent.Models.DhcpOptions">
  ...
  <Docs>
    <summary>
            DhcpOptions enthält ein Array von DNS-Server im virtuellen Netzwerk bereitgestellten virtuellen Maschinen zur Verfügung. Standard-DHCP-Option für ein Subnetz überschreibt VNET DHCP-Optionen.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der DhcpOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dnsServers">Die Liste der IP-Adressen von DNS-Server.</param>
        <summary>
            Initialisiert eine neue Instanz der DhcpOptions-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DnsServers">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Liste der DNS-Server IP-Adressen.
            </summary>
