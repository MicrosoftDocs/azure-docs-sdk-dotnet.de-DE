<Type Name="InboundNatRulesOperationsExtensions" FullName="Microsoft.Azure.Management.Network.InboundNatRulesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für InboundNatRulesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="inboundNatRuleName">
            Der Name der eingehenden Nat-Regel.
            </param>
        <param name="inboundNatRuleParameters">
            So erstellen Sie den angegebenen Parametern oder Aktualisierungsvorgang für eingehende Nat-Regel.
            </param>
        <summary>
            Erstellt oder aktualisiert eine eingehende Nat-Regel für Load Balancers.
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <summary>
            Löscht das angegebene Lastenausgleichsmodul eingehende Nat-Regel an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            Ruft ab, die das angegebene Lastenausgleichsmodul eingehenden Nat-Regel.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            Ruft die eingehende Nat-Regeln in einen Load Balancer ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
