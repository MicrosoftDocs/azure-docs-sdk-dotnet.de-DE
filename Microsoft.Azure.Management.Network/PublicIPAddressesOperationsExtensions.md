<Type Name="PublicIPAddressesOperationsExtensions" FullName="Microsoft.Azure.Management.Network.PublicIPAddressesOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für PublicIPAddressesOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="parameters">
            Parameter zum Erstellen oder aktualisieren öffentliche IP-Adresse Vorgang angegeben.
            </param>
        <summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <summary>
            Löscht die angegebene öffentliche IP-Adresse an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginUpdateTags">
      ...
      <Docs>
        ...
        <param name="parameters">
            Parameter, die zum Aktualisieren der öffentlichen IP-adresstags angegeben werden.
            </param>
        <summary>
            Öffentliche IP-adresstags wird aktualisiert.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            Ruft die angegebene öffentliche IP-Adresse in einer angegebenen Ressourcengruppe.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetVirtualMachineScaleSetPublicIPAddress">
      ...
      <Docs>
        ...
        <summary>
            Erhalten Sie die angegebene öffentliche IP-Adresse in einem VM-Skalierungsgruppe.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            Ruft alle öffentliche IP-Adressen in einer Ressourcengruppe.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListAll">
      ...
      <Docs>
        ...
        <summary>
            Ruft den öffentlichen IP-Adressen in einem Abonnement ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListVirtualMachineScaleSetPublicIPAddresses">
      ...
      <Docs>
        ...
        <summary>
            Ruft Informationen über alle öffentlichen IP-Adressen auf einer VM-Skalierungsgruppe Ebene festzulegen.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListVirtualMachineScaleSetVMPublicIPAddresses">
      ...
      <Docs>
        ...
        <param name="networkInterfaceName">
            Der Name des Netzwerk-Schnittstelle.
            </param>
        <param name="ipConfigurationName">
            Der Name des IP-Konfiguration.
            </param>
        <summary>
            Ruft Informationen über alle öffentlichen IP-Adressen in eine IP-Konfiguration des virtuellen Computers in einem VM-Skalierungsgruppe ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
