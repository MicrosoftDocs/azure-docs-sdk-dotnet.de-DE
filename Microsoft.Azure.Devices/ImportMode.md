<Type Name="ImportMode" FullName="Microsoft.Azure.Devices.ImportMode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5ec55-101">Identifiziert das Verhalten, wenn Sie ein Gerät an der Registrierung während Importaktionen zusammenführen.</span><span class="sxs-lookup"><span data-stu-id="5ec55-101">Identifies the behavior when merging a device to the registry during import actions.</span></span>
            </summary>
