<Type Name="IWithFrontend&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasFrontend.Definition.IWithFrontend&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="0d76f-101">die nächste Phase der Definition.</span><span class="sxs-lookup"><span data-stu-id="0d76f-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="0d76f-102">Die Phase der Definition eines an eine Load Balancer Front-End-ermöglicht.</span><span class="sxs-lookup"><span data-stu-id="0d76f-102">The stage of a definition allowing to specify a load balancer frontend.</span></span>
            </summary>
