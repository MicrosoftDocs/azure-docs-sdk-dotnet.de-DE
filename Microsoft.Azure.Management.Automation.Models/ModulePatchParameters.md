<Type Name="ModulePatchParameters" FullName="Microsoft.Azure.Management.Automation.Models.ModulePatchParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a43db-101">Die Parameter für die Patch-Modul zur Verfügung gestellt.</span><span class="sxs-lookup"><span data-stu-id="a43db-101">The parameters supplied to the patch module operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a43db-102">Initialisiert eine neue Instanz der ModulePatchParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="a43db-102">Initializes a new instance of the ModulePatchParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="a43db-103">Initialisiert eine neue Instanz der ModulePatchParameters-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="a43db-103">Initializes a new instance of the ModulePatchParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a43db-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="a43db-104">Required.</span></span> <span data-ttu-id="a43db-105">Ruft ab oder legt das Modul Patch-Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="a43db-105">Gets or sets the module patch properties.</span></span>
            </summary>
