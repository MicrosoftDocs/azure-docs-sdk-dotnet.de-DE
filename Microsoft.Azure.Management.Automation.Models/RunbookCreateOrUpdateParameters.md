<Type Name="RunbookCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.Automation.Models.RunbookCreateOrUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="85d0b-101">Die Parameter für das Runbook erstellen oder Aktualisieren zur Verfügung gestellt.</span><span class="sxs-lookup"><span data-stu-id="85d0b-101">The parameters supplied to the create or update runbook operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="85d0b-102">Initialisiert eine neue Instanz der RunbookCreateOrUpdateParameters-Klasse.</span><span class="sxs-lookup"><span data-stu-id="85d0b-102">Initializes a new instance of the RunbookCreateOrUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="85d0b-103">Initialisiert eine neue Instanz der RunbookCreateOrUpdateParameters-Klasse mit erforderlichen Argumenten.</span><span class="sxs-lookup"><span data-stu-id="85d0b-103">Initializes a new instance of the RunbookCreateOrUpdateParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="85d0b-104">Erforderlich.</span><span class="sxs-lookup"><span data-stu-id="85d0b-104">Required.</span></span> <span data-ttu-id="85d0b-105">Ruft ab oder legt ihn fest Runbook erstellen oder Aktualisieren von Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="85d0b-105">Gets or sets runbook create or update properties.</span></span>
            </summary>
