<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.Network.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9d848-101">Die Stufe der Definition des virtuellen Netzwerks, die festlegen, dass die Ressourcengruppe angeben.</span><span class="sxs-lookup"><span data-stu-id="9d848-101">The stage of the virtual network definition allowing to specify the resource group.</span></span>
            </summary>
