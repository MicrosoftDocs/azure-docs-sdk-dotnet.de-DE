  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="parameters">
            Parameter für das Erstellen oder Aktualisieren angegebene redis-Firewall-Regel-Vorgang.
            </param>
        <summary>
            Erstellen oder Aktualisieren einer Firewallregel für Redis-cache
            </summary>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            Ruft eine einzelne Firewallregel in einem angegebenen Redis-Cache.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByRedisResource">
      ...
      <Docs>
        ...
        <summary>
            Ruft alle Firewallregeln in den angegebenen Redis Cache ab.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
