<Type Name="AdminKeyResult" FullName="Microsoft.Azure.Management.Search.Models.AdminKeyResult">
  ...
  <Docs>
    <summary>
            Antwort mit der primären und sekundären Admin-API-Schlüssel für einen bestimmten Azure Search-Dienst.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der AdminKeyResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="primaryKey">Der primäre API Administratorschlüssel des Suchdiensts.</param>
        <param name="secondaryKey">Der sekundäre Admin-API-Schlüssel des Suchdiensts.</param>
        <summary>
            Initialisiert eine neue Instanz der AdminKeyResult-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PrimaryKey">
      ...
      <Docs>
        <summary>
            Ruft den primären Admin-API-Schlüssel des Suchdiensts ab.
            </summary>
    ...
    <Member MemberName="SecondaryKey">
      ...
      <Docs>
        <summary>
            Ruft den sekundären Admin-API-Schlüssel des Suchdiensts ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
