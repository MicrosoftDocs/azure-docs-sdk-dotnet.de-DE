  ...
  <Members>
    ...
    <Member MemberName="ShouldRetryAsync">
      ...
      <Docs>
        ...
        <summary>
            Bestimmt, ob der Vorgang wiederholt werden und wie lange bis zum nächsten Versuch gewartet werden soll. Diese Implementierung gibt immer <see cref="F:Microsoft.Azure.Batch.Common.RetryDecision.NoRetry" />.
            </summary>
        <returns>Ein <see cref="T:Microsoft.Azure.Batch.Common.RetryDecision" /> Objekt, das angibt, ob ein erneuter Versuch ausgeführt werden soll. Diese Implementierung gibt immer <see cref="F:Microsoft.Azure.Batch.Common.RetryDecision.NoRetry" />.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
