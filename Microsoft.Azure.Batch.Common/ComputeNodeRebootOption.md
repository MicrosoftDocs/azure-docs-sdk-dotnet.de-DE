<Type Name="ComputeNodeRebootOption" FullName="Microsoft.Azure.Batch.Common.ComputeNodeRebootOption">
  ...
  <Docs>
    <summary>
            Gibt an, wann neu starten, einen Serverknoten und was mit den derzeit ausgeführten Tasks geschehen.
            </summary>
  ...
  <Members>
    <Member MemberName="Requeue">
      ...
      <Docs>
        <summary>
            Beenden Sie derzeit ausgeführte Tasks, und sie requeue. Die Tasks werden erneut ausgeführt, sobald der Auftrag aktiviert ist. Starten Sie den Compute-Knoten als Tasks abgeschlossen wurden.
            </summary>
      </Docs>
    </Member>
    <Member MemberName="RetainedData">
      ...
      <Docs>
        <summary>
            Ermöglichen Sie die aktuell ausgeführter Aufgaben abgeschlossen ist, und warten Sie, bis alle Aufgabe Beibehaltungsdauer abläuft. Planen Sie beim Warten keine neuen Tasks. Neustart Serverknoten Aufbewahrungsdauer für alle Tasks abgelaufen sind.
            </summary>
      </Docs>
    </Member>
    <Member MemberName="TaskCompletion">
      ...
      <Docs>
        <summary>
            Ermöglichen Sie die derzeit ausgeführten Tasks ab. Planen Sie beim Warten keine neuen Tasks. Starten Sie den Compute-Knoten neu, wenn alle Aufgaben abgeschlossen wurden.
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Terminate">
      ...
      <Docs>
        <summary>
            Ausführen von Aufgaben zu beenden. Die Tasks werden nicht erneut ausgeführt. Starten Sie den Compute-Knoten als Tasks abgeschlossen wurden.
            </summary>
      </Docs>
    </Member>
  </Members>
