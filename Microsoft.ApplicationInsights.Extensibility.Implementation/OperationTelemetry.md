<Type Name="OperationTelemetry" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.OperationTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6e087-101">Die Basisklasse für Telemetrie-Typen, die Dauer der einzelnen Zeitpunkt darstellt.</span><span class="sxs-lookup"><span data-stu-id="6e087-101">Base class for telemetry types representing duration in time.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-102">Ruft das Objekt, das Kontextinformationen über die Anwendung zum Zeitpunkt enthält, wenn sie die Anforderung verarbeitet.</span><span class="sxs-lookup"><span data-stu-id="6e087-102">Gets the object that contains contextual information about the application at the time when it handled the request.</span></span>
            </summary>
    ...
    <Member MemberName="Duration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-103">Ruft ab oder legt die Dauer des Vorgangs fest.</span><span class="sxs-lookup"><span data-stu-id="6e087-103">Gets or sets the duration of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>  
            <span data-ttu-id="6e087-104">Ruft ab oder legt sie fest, Vorgang-ID auf.</span><span class="sxs-lookup"><span data-stu-id="6e087-104">Gets or sets Operation ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-105">Ruft die Auflistung benutzerdefinierter Metriken ab.</span><span class="sxs-lookup"><span data-stu-id="6e087-105">Gets the custom metrics collection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-106">Bereinigt die Eigenschaften, die auf Einschränkungen basieren.</span><span class="sxs-lookup"><span data-stu-id="6e087-106">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-107">Ruft den Namen des Vorgangs ab oder legt diesen fest.</span><span class="sxs-lookup"><span data-stu-id="6e087-107">Gets or sets the name of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-108">Ruft die Auflistung benutzerdefinierter Eigenschaften ab.</span><span class="sxs-lookup"><span data-stu-id="6e087-108">Gets the custom properties collection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-109">Ermöglichen von untergeordneten Klassen OperationTelemetry.Sanitize-Methode aufgerufen.</span><span class="sxs-lookup"><span data-stu-id="6e087-109">Allow to call OperationTelemetry.Sanitize method from child classes.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-110">Ruft ab oder legt den Wert an, der absolute Reihenfolge der Telemetrie-Elements definiert.</span><span class="sxs-lookup"><span data-stu-id="6e087-110">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-111">Ruft ab oder legt die Startzeit des Vorgangs fest.</span><span class="sxs-lookup"><span data-stu-id="6e087-111">Gets or sets the start time of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Success">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-112">Ruft ab oder legt fest, ob der Vorgang erfolgreich abgeschlossen wurde.</span><span class="sxs-lookup"><span data-stu-id="6e087-112">Gets or sets whether operation has finished successfully.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6e087-113">Ruft ab oder legt den Zeitstempel für den Vorgang.</span><span class="sxs-lookup"><span data-stu-id="6e087-113">Gets or sets the timestamp for the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
