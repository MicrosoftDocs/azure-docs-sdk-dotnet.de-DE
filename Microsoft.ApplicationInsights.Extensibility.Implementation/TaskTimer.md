<Type Name="TaskTimer" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.TaskTimer">
  ...
  <Docs>
    <summary>
            Führt eine Aufgabe aus, nachdem eine bestimmte verzögert, und melden Sie alle Fehler.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Delay">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Verzögerung, bevor der Task beginnt. 
            </summary>
    ...
    <Member MemberName="InfiniteTimeSpan">
      ...
      <Docs>
        <summary>
            Stellt eine unendliche Zeitspanne dar.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsStarted">
      ...
      <Docs>
        <summary>
            Ruft einen Wert, der angibt, ob der Wert, der angibt, ob eine Aufgabe bereits begonnen wurde.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Start">
      ...
      <Docs>
        <param name="elapsed">Der Task ausgeführt werden soll.</param>
        <summary>
