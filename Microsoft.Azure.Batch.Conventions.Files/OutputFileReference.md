<Type Name="OutputFileReference" FullName="Microsoft.Azure.Batch.Conventions.Files.OutputFileReference">
  ...
  <Docs>
    <summary>
            Ein Verweis auf eine Ausgabedatei-Task oder-Auftrag im dauerhaften Speicher.
            </summary>
  ...
  <Members>
    <Member MemberName="CloudBlob">
      ...
      <Docs>
        <summary>
            Ruft einen Verweis auf die zugrunde liegende <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ICloudBlob" /> Objekt, das die Datei im permanenten Speicher darstellt. Dies kann verwendet werden, um Blob-Methoden "oder" Overloads Diagnoseinformationen werden nicht durch Aufrufen der <see cref="T:Microsoft.Azure.Batch.Conventions.Files.OutputFileReference" /> Abstraktion.
            </summary>
    ...
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <summary>
            Löscht die Datei aus dem permanenten Speicher.
            </summary>
    ...
    <Member MemberName="DownloadToFileAsync">
      ...
      <Docs>
        <param name="path">Der Pfad, der zum Herunterladen der Datei.</param>
        <param name="mode">Gibt an, wie die Datei geöffnet oder erstellt.</param>
        <param name="cancellationToken">Ein <see cref="T:System.Threading.CancellationToken" /> für die Steuerung der Lebensdauer eines asynchronen Vorgangs.</param>
        <summary>
            Lädt den Inhalt der Datei in einem angegebenen Pfad.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task" />-Element, das den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DownloadToStreamAsync">
      ...
      <Docs>
        ...
        <param name="cancellationToken">Ein <see cref="T:System.Threading.CancellationToken" /> für die Steuerung der Lebensdauer eines asynchronen Vorgangs.</param>
        <summary>
            Lädt den Inhalt der Datei in einen Datenstrom herunter.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task" />-Element, das den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="FilePath">
      ...
      <Docs>
        <summary>
            Ruft den Pfad, unter dem die Datei gespeichert wurde.
            </summary>
        <value>To be added.</value>
        <remarks>Wenn die Datei unter einem Verzeichnispfad gespeichert wurde, wird die FilePath-Eigenschaft der Verzeichnistrennzeichen des zugrunde liegenden Blob-Speichers (z. B. mydirectory/myfile.txt) verwendet. Diese Pfade möglicherweise nicht direkt als Windows-Pfade verwendet werden kann.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OpenReadAsync">
      ...
      <Docs>
        <param name="cancellationToken">Ein <see cref="T:System.Threading.CancellationToken" /> für die Steuerung der Lebensdauer eines asynchronen Vorgangs.</param>
        <summary>
            Öffnet einen Stream zum Lesen aus der Datei im dauerhaften Speicher.
            </summary>
    ...
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            Ruft den URI der Datei im dauerhaften Speicher ab.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
