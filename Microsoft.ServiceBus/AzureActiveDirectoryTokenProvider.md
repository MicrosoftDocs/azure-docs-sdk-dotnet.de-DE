<Type Name="AzureActiveDirectoryTokenProvider" FullName="Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider">
  <TypeSignature Language="C#" Value="public class AzureActiveDirectoryTokenProvider : Microsoft.ServiceBus.TokenProvider" />
  <TypeSignature Language="ILAsm" Value=".class public auto ansi beforefieldinit AzureActiveDirectoryTokenProvider extends Microsoft.ServiceBus.TokenProvider" />
  <TypeSignature Language="DocId" Value="T:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider" />
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="33917-101">Stellt die Azure Active Directory-Tokenanbieter für den Service Bus und Event Hubs dar.</span><span class="sxs-lookup"><span data-stu-id="33917-101">Represents the Azure Active Directory token provider for the Service Bus and Event Hubs.</span></span></summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <MemberSignature Language="DocId" Value="M:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider.BuildKey(System.String,System.String)" />
      ...
      <MemberSignature Language="F#" Value="override this.BuildKey : string * string -&gt; Microsoft.ServiceBus.TokenProvider.Key" Usage="azureActiveDirectoryTokenProvider.BuildKey (appliesTo, action)" />
      ...
      <Docs>
        <param name="appliesTo">To be added.</param>
    ...
    <Member MemberName="OnBeginGetToken">
      ...
      <MemberSignature Language="DocId" Value="M:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider.OnBeginGetToken(System.String,System.String,System.TimeSpan,System.AsyncCallback,System.Object)" />
      ...
      <MemberSignature Language="F#" Value="override this.OnBeginGetToken : string * string * TimeSpan * AsyncCallback * obj -&gt; IAsyncResult" Usage="azureActiveDirectoryTokenProvider.OnBeginGetToken (appliesTo, action, timeout, callback, state)" />
      <MemberType>Method</MemberType>
      <AssemblyInfo>
        <AssemblyName>Microsoft.ServiceBus</AssemblyName>
        <AssemblyVersion>3.0.0.0</AssemblyVersion>
    ...
    <Member MemberName="OnBeginGetWebToken">
      ...
      <MemberSignature Language="DocId" Value="M:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider.OnBeginGetWebToken(System.String,System.String,System.TimeSpan,System.AsyncCallback,System.Object)" />
      ...
      <MemberSignature Language="F#" Value="override this.OnBeginGetWebToken : string * string * TimeSpan * AsyncCallback * obj -&gt; IAsyncResult" Usage="azureActiveDirectoryTokenProvider.OnBeginGetWebToken (appliesTo, action, timeout, callback, state)" />
      <MemberType>Method</MemberType>
      <AssemblyInfo>
        <AssemblyName>Microsoft.ServiceBus</AssemblyName>
        <AssemblyVersion>3.0.0.0</AssemblyVersion>
    ...
    <Member MemberName="OnEndGetToken">
      ...
      <MemberSignature Language="DocId" Value="M:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider.OnEndGetToken(System.IAsyncResult,System.DateTime@)" />
      ...
      <MemberSignature Language="F#" Value="override this.OnEndGetToken : IAsyncResult *  -&gt; System.IdentityModel.Tokens.SecurityToken" Usage="azureActiveDirectoryTokenProvider.OnEndGetToken (result, cacheUntil)" />
      <MemberType>Method</MemberType>
      <AssemblyInfo>
        <AssemblyName>Microsoft.ServiceBus</AssemblyName>
        <AssemblyVersion>3.0.0.0</AssemblyVersion>
      ...
      <Docs>
        ...
        <param name="cacheUntil">To be added.</param>
        <summary>To be added.</summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OnEndGetWebToken">
      ...
      <MemberSignature Language="DocId" Value="M:Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider.OnEndGetWebToken(System.IAsyncResult,System.DateTime@)" />
      ...
      <MemberSignature Language="F#" Value="override this.OnEndGetWebToken : IAsyncResult *  -&gt; string" Usage="azureActiveDirectoryTokenProvider.OnEndGetWebToken (result, cacheUntil)" />
      <MemberType>Method</MemberType>
      <AssemblyInfo>
        <AssemblyName>Microsoft.ServiceBus</AssemblyName>
        <AssemblyVersion>3.0.0.0</AssemblyVersion>
