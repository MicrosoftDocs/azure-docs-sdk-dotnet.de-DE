<Type Name="OAuthTokenProvider" FullName="Microsoft.ServiceBus.OAuthTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary>Servicebus bereit-Authentifizierungstokens.</summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <Docs>
        <param name="appliesTo">Der Anbieter, den der Schlüssel angewendet werden.</param>
        <param name="action">Die Aktion.</param>
        <summary>Erstellt einen Schlüssel für den Anbieter an.</summary>
        <returns>Ein Schlüssel.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NormalizeAppliesTo">
      ...
      <Docs>
        <param name="appliesTo">Der Tokenanbieter, in dem die Normalisierung angewendet wird.</param>
        <summary>Wendet die Normalisierung in der Tokenanbieter.</summary>
        <returns>Der normalisierte Tokenanbieter.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        <param name="appliesTo">Der Anbieter in dem das Token angewendet wird.</param>
        <param name="action">Die Aktion.</param>
        <param name="timeout">Die Dauer.</param>
        <param name="callback">Der Rückruf.</param>
        <param name="state">Der Zustand des Vorgangs.</param>
        <summary>Ruft ein Token ab, wenn der Anbieter beginnt.</summary>
    ...
    <Member MemberName="OnBeginGetWebToken">
      ...
      <Docs>
        <param name="appliesTo">Der Anbieter in dem das webtoken angewendet wird.</param>
        <param name="action">Die Aktion.</param>
        <param name="timeout">Die Dauer.</param>
        <param name="callback">Der Rückruf.</param>
        <param name="state">Der Zustand des Vorgangs.</param>
        <summary>Ruft ein webtoken ab, wenn der Anbieter beginnt.</summary>
        <returns>Das asynchrone Ergebnis des Vorgangs.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        ...
        <param name="cacheUntil">Die Dauer für den Anbieter zum Speichern von Daten.</param>
        <summary>Ruft ein Token ab, wenn der Anbieter endet.</summary>
    ...
    <Member MemberName="OnEndGetWebToken">
      ...
      <Docs>
        <param name="result">Das Ergebnis des Vorgangs.</param>
        <param name="cacheUntil">Die Dauer für den Anbieter zum Speichern von Daten.</param>
        <summary>Ruft ein webtoken ab, wenn der Anbieter endet.</summary>
        <returns>Das abgerufene-Token.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
