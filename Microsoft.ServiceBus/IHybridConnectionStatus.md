<Type Name="IHybridConnectionStatus" FullName="Microsoft.ServiceBus.IHybridConnectionStatus">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="d03d5-101">Bietet Zugriff auf den aktuellen Verbindungsstatus eines Hybrid-Connection-Kanals.</span><span class="sxs-lookup"><span data-stu-id="d03d5-101">Provides access to the current connection state of a hybrid connection channel.</span></span></summary>
  ...
  <Members>
    <Member MemberName="ConnectionState">
      ...
      <Docs>
        <summary><span data-ttu-id="d03d5-102">Ruft den aktuellen Verbindungsstatus der hybridverbindung ab.</span><span class="sxs-lookup"><span data-stu-id="d03d5-102">Gets the current connection state of the hybrid connection.</span></span> </summary>
        <value><span data-ttu-id="d03d5-103">Gibt <see cref="T:Microsoft.ServiceBus.HybridConnectionState" />. Enthält den Verbindungsstatus.</span><span class="sxs-lookup"><span data-stu-id="d03d5-103">Returns <see cref="T:Microsoft.ServiceBus.HybridConnectionState" />.Contains the connection state.</span></span> </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionStateChanged">
      ...
      <Docs>
        <summary><span data-ttu-id="d03d5-104">Tritt auf, wenn der Verbindungsstatus ändert.</span><span class="sxs-lookup"><span data-stu-id="d03d5-104">Occurs when the connection state changes.</span></span> </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
