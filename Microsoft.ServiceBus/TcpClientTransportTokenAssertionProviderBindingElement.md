<Type Name="TcpClientTransportTokenAssertionProviderBindingElement" FullName="Microsoft.ServiceBus.TcpClientTransportTokenAssertionProviderBindingElement">
  ...
  <Docs>
    <summary>Stellt das Transportbindungselement, das Sicherheit für Kanal über einen SSL-Datenstroms für die Verwendung in richtlinienexporten unterstützt.</summary>
  ...
  <Members>
    ...
    <Member MemberName="Clone">
      ...
      <Parameters />
      <Docs>
        <summary>Gibt eine Kopie dieser Instanz des Bindungselements zurück.</summary>
        <returns>Eine Kopie dieser Instanz des Bindungselements.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetTransportTokenAssertion">
      ...
      <Parameters />
      <Docs>
        <summary>Ruft das <see cref="T:System.Xml.XmlElement" /> ab, das das Transporttoken darstellt, das in der Sicherheitsbindung verwendet wird.</summary>
        <returns>Ein <see cref="T:System.Xml.XmlElement" />, das das Transporttoken darstellt, das in der Sicherheitsbindung verwendet wird.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
