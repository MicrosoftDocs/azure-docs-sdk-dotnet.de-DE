<Type Name="SharedAccessSignatureTokenProvider" FullName="Microsoft.ServiceBus.SharedAccessSignatureTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary>Repräsentiert die SAS-Signatur der Tokenanbieter zugeordnet.</summary>
  ...
  <Members>
    ...
    <Member MemberName="EpochTime">
      ...
      <Docs>
        <summary>Die epochenzeit.</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetPublisherSharedAccessSignature">
      ...
      <Docs>
        ...
        <summary />
        <returns>To be added.</returns>
        <remarks>Diese Methode wird davon ausgegangen, dass die UTF8-Codierung verwendet wird.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSharedAccessSignature">
      ...
      <Docs>
        ...
        <param name="sharedAccessKey">Der SAS-Schlüsselname.</param>
        <param name="resource">die Ressource.</param>
        <param name="tokenTimeToLive">Der TTL-Wert für das Token.</param>
        <summary>Gibt die SAS, die verknüpft sind, mit dem angegebenen Schlüsselnamen, SAS-Schlüssel, Ressourcen und Time-to-live-Token.</summary>
    ...
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        ...
        <param name="callback">Ein AsyncCallback-Delegat, der auf die Methode verweist, die aufgerufen wird, wenn der Vorgang abgeschlossen ist.</param>
    ...
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        <param name="result">Ein "IAsyncResult"-Objekt, das den asynchronen Vorgang zum Abrufen eines Tokens verweist.</param>
    ...
    <Member MemberName="OnEndGetWebToken">
      ...
      <Docs>
        <param name="result">Ein "IAsyncResult"-Objekt, das den asynchronen Vorgang, um eine Web-Zugriffstoken zu erhalten verweist.</param>
        <param name="cacheUntil">Wenn diese Methode zurückgibt, enthält das Ablaufdatum und die Uhrzeit der token Informationen im Cache.</param>
        <summary>Führt beim Aufrufen der EndGetWebToken-Methode.</summary>
        <returns>Die Zeichenfolge, die das webtoken darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
