<Type Name="DocumentClientException" FullName="Microsoft.Azure.Documents.DocumentClientException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e0ceb-101">Die Basisklasse für Ausnahmen, die Clients in der Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-101">The base class for client exceptions in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ActivityId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-102">Ruft die Aktivitäts-ID, die die Anforderung aus dem Azure-Cosmos-DB-Dienst zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-102">Gets the activity ID associated with the request from the Azure Cosmos DB service.</span></span>
            </summary>
    ...
    <Member MemberName="Error">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-103">Ruft die Ausnahme im Azure-Cosmos-DB-Dienst zugeordneten Fehlercode ab.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-103">Gets the error code associated with the exception in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-104">Ruft eine Meldung, die aus dem Azure-Cosmos-DB-Dienst die aktuelle Ausnahme beschreibt.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-104">Gets a message that describes the current exception from the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestCharge">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-105">Die Kosten der Anforderung in der Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-105">Cost of the request in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResponseHeaders">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-106">Ruft die Header der Antwort vom Dienst Azure-Cosmos-Datenbank zugeordnet.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-106">Gets the headers associated with the response from the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetryAfter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-107">Ruft das empfohlene Zeitintervall, nach dem fehlerhafte Anforderungen aus dem Azure-Cosmos-DB-Dienst der Client wiederholt werden kann</span><span class="sxs-lookup"><span data-stu-id="e0ceb-107">Gets the recommended time interval after which the client can retry failed requests from the Azure Cosmos DB service</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StatusCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0ceb-108">Ruft ab oder legt den Statuscode der Anforderung im Azure-Cosmos-DB-Dienst.</span><span class="sxs-lookup"><span data-stu-id="e0ceb-108">Gets or sets the request status code in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
