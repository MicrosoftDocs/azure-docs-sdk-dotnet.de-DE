<Type Name="Offer" FullName="Microsoft.Azure.Documents.Offer">
  ...
  <Docs>
    <summary>
            Stellt das Angebot für eine Ressource (Auflistung) im Azure-Cosmos-DB-Dienst dar.
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert ein Angebot Ressource für den Azure-Cosmos-DB-Dienst an.
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            Initialisiert ein Angebot Ressourcen aus einem anderen angebotsobjekt für den Azure-Cosmos-DB-Dienst an.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OfferType">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die "offertype" für das Angebot an Ressourcen im Azure-Cosmos-DB-Dienst.
            </summary>
    ...
    <Member MemberName="OfferVersion">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die Version dieser Ressource Angebot im Azure-Cosmos-DB-Dienst.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceLink">
      ...
      <Docs>
        <summary>
            Ruft ab, oder legt ihn fest der Self-link einer Ressource, auf die das Angebot Ressource gilt, in der Azure-Cosmos-DB-Dienst.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
