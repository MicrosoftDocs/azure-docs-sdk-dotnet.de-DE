<Type Name="UniqueKey" FullName="Microsoft.Azure.Documents.UniqueKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3ed35-101">Stellt ein eindeutiger, die Schlüssel auf, die auf Dokumente in der Auflistung in der Azure-Cosmos-DB-Dienst eine Unique-Einschränkung erzwingt.</span><span class="sxs-lookup"><span data-stu-id="3ed35-101">Represents a unique key on that enforces uniqueness constraint on documents in the collection in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Paths">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ed35-102">Ruft ab oder legt die Pfade, die ein die Satz von denen für jedes Dokument in der Azure-Cosmos-DB-Dienst eindeutig sein muss.</span><span class="sxs-lookup"><span data-stu-id="3ed35-102">Gets or sets the paths, a set of which must be unique for each document in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>
            <span data-ttu-id="3ed35-103">Die Pfade zum Erzwingen der Eindeutigkeit auf.</span><span class="sxs-lookup"><span data-stu-id="3ed35-103">The paths to enforce uniqueness on.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
