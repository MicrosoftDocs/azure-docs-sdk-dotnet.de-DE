<Type Name="SqlQuerySpec" FullName="Microsoft.Azure.Documents.SqlQuerySpec">
  ...
  <Docs>
    <summary>
            Stellt eine SQL-Abfrage in der Azure-Cosmos-DB-Dienst dar.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Documents.SqlQuerySpec" /> Klasse für den Azure-Cosmos-DB-Dienst.</summary>
        <remarks> 
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="queryText">Der Text der Abfrage.</param>
        <summary>
            Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Documents.SqlQuerySpec" /> Klasse für den Azure-Cosmos-DB-Dienst.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="queryText">Der Text der Datenbankabfrage.</param>
        <param name="parameters">Die <see cref="T:Microsoft.Azure.Documents.SqlParameterCollection" /> -Instanz, die die Auflistung von Abfrageparametern darstellt.</param>
        <summary>
            Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.Azure.Documents.SqlQuerySpec" /> Klasse für den Azure-Cosmos-DB-Dienst.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die <see cref="T:Microsoft.Azure.Documents.SqlParameterCollection" /> -Instanz, die die Auflistung von Abfrageparametern Azure Cosmos-Datenbank darstellt.
            </summary>
        <value>Die <see cref="T:Microsoft.Azure.Documents.SqlParameterCollection" />-Instanz.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="QueryText">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Text der Datenbankabfrage Azure Cosmos-Datenbank fest.
            </summary>
        <value>Der Text der Datenbankabfrage.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ShouldSerializeParameters">
      ...
      <Docs>
        <summary>
            Gibt einen Wert, der angibt, ob der Azure-Cosmos-DB-Datenbank <see cref="P:Microsoft.Azure.Documents.SqlQuerySpec.Parameters" /> Eigenschaft serialisiert werden soll.
            </summary>
