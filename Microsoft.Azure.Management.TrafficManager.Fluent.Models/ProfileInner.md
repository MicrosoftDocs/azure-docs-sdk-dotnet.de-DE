  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="trafficRoutingMethod">Ruft ab oder legt die datenverkehrrouting-Methode des Traffic Manager-Profils.  Mögliche Werte sind "Leistung", 'Weighted' oder 'Priority' an.</param>
    ...
    <Member MemberName="TrafficRoutingMethod">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die datenverkehrrouting-Methode des Traffic Manager-Profils.  Mögliche Werte sind "Leistung", 'Weighted' oder 'Priority' an.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
