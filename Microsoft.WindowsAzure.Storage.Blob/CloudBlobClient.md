<Type Name="CloudBlobClient" FullName="Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient">
  ...
  <Docs>
    <summary>
            Bietet eine clientseitige logische Darstellung des Microsoft Azure Blob-Speichers.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="baseUri">Ein <see cref="T:System.Uri" /> Objekt, das den Blob-Dienstendpunkt, mit der Erstellung des Clients enthält.</param>
        <summary>
            Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient" /> -Klasse unter Verwendung der angegebenen Blob-Dienstendpunkts und der anonymer Anmeldeinformationen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="storageUri">Ein <see cref="P:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient.StorageUri" /> Objekt, das den Blob-Dienstendpunkt, mit der Erstellung des Clients enthält.</param>
        <param name="credentials">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Auth.StorageCredentials" />-Objekt.</param>
        <summary>
            Initialisiert eine neue Instanz der dem <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient" /> -Klasse unter Verwendung der angegebenen Blob-Endpunkt und der Kontoanmeldeinformationen.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            Ruft den Basis-URI für den Blob-Dienstclient am primären Speicherort ab.
            </summary>
        <value>Ein <see cref="T:System.Uri" /> Objekt mit dem Basis-URI verwendet, um den Blob-Dienstclient am primären Standort erstellen.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BeginGetBlobReferenceFromServer">
      ...
      <Docs>
        <param name="blobUri">Ein <see cref="T:System.Uri" /> mit dem URI des BLOBs. Der Dienst wird davon ausgegangen, dass dies der URI für das Blob am primären Standort ist.</param>
        ...
        <summary>
            Startet einen asynchronen Vorgang zum Abrufen eines Verweises auf ein Blob.
            </summary>
    ...
    <Member MemberName="BeginGetBlobReferenceFromServer">
      ...
      <Docs>
        <param name="blobUri">Ein <see cref="P:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient.StorageUri" /> mit dem URI des BLOBs.</param>
        ...
        <param name="options">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobRequestOptions" /> Objekt, das zusätzlichen Optionen für die Anforderung angibt.</param>
    ...
    <Member MemberName="BeginGetServiceProperties">
      ...
      <Docs>
        ...
        <summary>
            Startet einen asynchronen Vorgang zum Abrufen der Diensteigenschaften für den Blob-Dienst.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" /> , das auf den asynchronen Vorgang verweist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginGetServiceStats">
      ...
      <Docs>
        ...
        <param name="state">Ein benutzerdefiniertes Objekt an den Rückrufdelegaten übergeben werden.</param>
        <summary>
            Startet einen asynchronen Vorgang zum Abrufen von Statistiken zum Dienst für den sekundären Blob-Dienstendpunkt.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" /> , das auf den asynchronen Vorgang verweist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginListBlobsSegmented">
      ...
      <Docs>
        <param name="prefix">Eine Zeichenfolge, die das Präfix des Blob, einschließlich des Namens des Entitätencontainers enthält.</param>
    ...
    <Member MemberName="BeginListContainersSegmented">
      ...
      <Docs>
        <param name="continuationToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <param name="callback">Ein <see cref="T:System.AsyncCallback" /> Delegat, der Benachrichtigung erhalten sollen, wenn der asynchrone Vorgang abgeschlossen ist.</param>
        <param name="state">Ein benutzerdefiniertes Objekt, die an dem Rückrufdelegaten übergeben werden.</param>
        <summary>
            Beginnt eine asynchrone Anforderung zum Zurückgeben eines ergebnissegments, das eine Auflistung von Containern enthält.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" /> , das auf den asynchronen Vorgang verweist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginListContainersSegmented">
      ...
      <Docs>
        <param name="prefix">Eine Zeichenfolge, enthält das Präfix des containernamens.</param>
        <param name="continuationToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <param name="callback">Ein <see cref="T:System.AsyncCallback" /> Delegat, der Benachrichtigung erhalten sollen, wenn der asynchrone Vorgang abgeschlossen ist.</param>
        <param name="state">Ein benutzerdefiniertes Objekt, die an dem Rückrufdelegaten übergeben werden.</param>
        <summary>
    ...
    <Member MemberName="BeginListContainersSegmented">
      ...
      <Docs>
        ...
        <param name="maxResults">Ein nicht negativer ganzzahliger Wert, der die maximale Anzahl von im ergebnissegment pro Vorgang gilt ein Grenzwert von 5000 zurückzugebenden Ergebnisse angibt. Wenn dieser Wert ist <c>null</c>, die maximale zulässige Anzahl von Ergebnissen wird sein (bis 5.000) zurückgegeben.</param>
        <param name="continuationToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <param name="options">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobRequestOptions" /> -Objekt, das zusätzliche Optionen für die Anforderung angibt.</param>
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <param name="callback">Ein <see cref="T:System.AsyncCallback" /> Delegat, der Benachrichtigung erhalten sollen, wenn der asynchrone Vorgang abgeschlossen ist.</param>
        <param name="state">Ein benutzerdefiniertes Objekt, die an dem Rückrufdelegaten übergeben werden.</param>
        <summary>
            Beginnt eine asynchrone Anforderung zurückzugebenden ein ergebnissegment mit einer Auflistung von Containern, deren Namen mit dem angegebenen Präfix beginnen.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" /> , das auf den asynchronen Vorgang verweist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginSetServiceProperties">
      ...
      <Docs>
        ...
        <param name="state">Ein benutzerdefiniertes Objekt an den Rückrufdelegaten übergeben werden.</param>
        <summary>
            Startet einen asynchronen Vorgang zum Festlegen der Diensteigenschaften für den Blob-Dienst an.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" /> , das auf den asynchronen Vorgang verweist.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BufferManager">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt einen Puffer-Manager, die implementiert die <see cref="T:Microsoft.WindowsAzure.Storage.IBufferManager" /> -Schnittstelle, einen zu verwendender Pufferpool mit Vorgängen für den Blob-Dienstclient angeben.
            </summary>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            Ruft die Kontoanmeldeinformationen verwendet, um den Blob-Dienstclient erstellen.
            </summary>
    ...
    <Member MemberName="DefaultDelimiter">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt das Standardtrennzeichen, das zum Erstellen einer virtuellen Verzeichnisstruktur von Blobs verwendet werden kann.
            </summary>
        <value>Eine Zeichenfolge mit dem Standardtrennzeichen für den Blob-Dienst.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DefaultRequestOptions">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Standardwert Anforderungsoptionen für über den Blob-Dienstclient vorgenommene Anforderungen.
            </summary>
        <value>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobRequestOptions" />-Objekt.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndGetBlobReferenceFromServer">
      ...
      <Docs>
        ...
        <summary>
            Beendet einen asynchronen Vorgang zum Abrufen eines Verweises auf ein Blob.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ICloudBlob" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndGetServiceProperties">
      ...
      <Docs>
        <param name="asyncResult">Eine <see cref="T:System.IAsyncResult" /> , die auf den ausstehenden asynchronen Vorgang verweist.</param>
        <summary>
            Beendet einen asynchronen Vorgang zum Abrufen der Diensteigenschaften für den Blob-Dienst an.
            </summary>
    ...
    <Member MemberName="EndGetServiceStats">
      ...
      <Docs>
        <param name="asyncResult">Eine <see cref="T:System.IAsyncResult" /> , die auf den ausstehenden asynchronen Vorgang verweist.</param>
        <summary>
            Beendet einen asynchronen Vorgang zum Abrufen von Statistiken zum Dienst für den sekundären Blob-Dienstendpunkt.
            </summary>
    ...
    <Member MemberName="EndListContainersSegmented">
      ...
      <Docs>
        <param name="asyncResult">Eine <see cref="T:System.IAsyncResult" /> , die auf den ausstehenden asynchronen Vorgang verweist.</param>
        <summary>
            Beendet einen asynchronen Vorgang zum Zurückgeben eines ergebnissegments, das eine Auflistung von Containern enthält.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ContainerResultSegment" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetBlobReferenceFromServer">
      ...
      <Docs>
        <param name="blobUri">Ein <see cref="P:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient.StorageUri" /> mit dem URI des BLOBs.</param>
        <param name="accessCondition">Ein <see cref="T:Microsoft.WindowsAzure.Storage.AccessCondition" /> -Objekt, das die Bedingung, die erfüllt sein müssen, damit die Anforderung darstellt, um den Vorgang fortzusetzen. Wenn <c>null</c>, keine Bedingung verwendet.</param>
        <param name="options">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobRequestOptions" /> Objekt, das zusätzlichen Optionen für die Anforderung angibt. Wenn <c>null</c>, Standardoptionen gelten für die Anforderung.</param>
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
    ...
    <Member MemberName="GetBlobReferenceFromServerAsync">
      ...
      <Docs>
        ...
        <returns>Ein <see cref="T:System.Threading.Tasks.Task`1" /> Objekt des Typs <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ICloudBlob" /> , die den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetBlobReferenceFromServerAsync">
    ...
    <Member MemberName="GetBlobReferenceFromServerAsync">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Gibt eine <see cref="T:System.Threading.Tasks.Task`1" /> Objekt, das einen Verweis auf ein Blob abruft.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task`1" /> Objekt des Typs <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ICloudBlob" /> , die den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetContainerReference">
      ...
      <Docs>
        <param name="containerName">Eine Zeichenfolge, die den Namen des Containers enthält.</param>
        <summary>
            Gibt einen Verweis auf ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" /> Objekt mit dem angegebenen Namen.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetRootContainerReference">
      ...
      <Docs>
        ...
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" />-Objekt.</returns>
        <remarks>Beachten Sie, dass der Stammcontainer muss explizit erstellt werden, ist es nicht bereits vorhanden, bevor Sie daraus zu lesen oder schreiben können.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetServiceProperties">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Ruft die Diensteigenschaften für den Blob-Dienst ab.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Shared.Protocol.ServiceProperties" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetServicePropertiesAsync">
      ...
      <Docs>
        <summary>
            Initiiert einen asynchronen Vorgang zum Abrufen der Diensteigenschaften für den Blob-Dienst an.
            </summary>
    ...
    <Member MemberName="GetServiceStats">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Ruft die dienststatistik für den sekundären Blob-Dienstendpunkt ab.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Shared.Protocol.ServiceStats" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetServiceStatsAsync">
      ...
      <Docs>
        <summary>
            Initiiert einen asynchronen Vorgang zum Abrufen von Statistiken zum Dienst für den sekundären Blob-Dienstendpunkt.
            </summary>
    ...
    <Member MemberName="ListBlobs">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Gibt eine aufzählbare Auflistung von Blobs im Container verzögert abgerufen.
            </summary>
    ...
    <Member MemberName="ListBlobsSegmentedAsync">
      ...
      <Docs>
        ...
        <param name="currentToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <summary>
            Initiiert einen asynchronen Vorgang zum Zurückgeben eines ergebnissegments, das eine Auflistung von Blob-Elemente im Container enthält.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task`1" /> Objekt des Typs <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobResultSegment" /> , die den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListBlobsSegmentedAsync">
    ...
    <Member MemberName="ListContainers">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Gibt eine aufzählbare Auflistung von Containern, deren Namen mit dem angegebenen Präfix beginnen und verzögert werden abgerufen.
            </summary>
        <returns>Eine aufzählbare Auflistung von <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" /> Objekte, die verzögert abgerufen werden.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListContainersSegmented">
      ...
      <Docs>
        <param name="currentToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <summary>
            Gibt ein ergebnissegment mit einer Auflistung von <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" /> Objekte.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ContainerResultSegment" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListContainersSegmented">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Gibt ein ergebnissegment mit einer Auflistung von Containern, deren Namen mit dem angegebenen Präfix beginnen.
            </summary>
        <returns>Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ContainerResultSegment" />-Objekt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListContainersSegmentedAsync">
      ...
      <Docs>
        <param name="continuationToken">Ein <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" /> einem vorherigen Auflistungsvorgang zurückgegebenes Objekt.</param>
        <summary>
            Initiiert einen asynchronen Vorgang zum Zurückgeben eines ergebnissegments, das eine Auflistung von Containern enthält.
            </summary>
        <returns>Ein <see cref="T:System.Threading.Tasks.Task`1" /> Objekt des Typs <see cref="T:Microsoft.WindowsAzure.Storage.Blob.ContainerResultSegment" /> , die den asynchronen Vorgang darstellt.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListContainersSegmentedAsync">
    ...
    <Member MemberName="RetryPolicy">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt die standardmäßige wiederholungsrichtlinie für über den Blob-Dienstclient vorgenommene Anforderungen.
            </summary>
    ...
    <Member MemberName="SetServiceProperties">
      ...
      <Docs>
        ...
        <param name="operationContext">Ein <see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" /> -Objekt, das den Kontext für den aktuellen Vorgang darstellt.</param>
        <summary>
            Legt die Diensteigenschaften für den Blob-Dienst.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="StorageUri">
      ...
      <Docs>
        ...
        <value>Ein Objekt des Typs <see cref="P:Microsoft.WindowsAzure.Storage.Blob.CloudBlobClient.StorageUri" /> mit Blob-Dienst-URIs für die primären und sekundären Speicherorte.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
