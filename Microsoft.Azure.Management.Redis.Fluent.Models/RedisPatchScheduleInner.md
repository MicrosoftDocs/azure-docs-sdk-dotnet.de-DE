<Type Name="RedisPatchScheduleInner" FullName="Microsoft.Azure.Management.Redis.Fluent.Models.RedisPatchScheduleInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der RedisPatchScheduleInner-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="scheduleEntriesProperty">Liste der Patch-Zeitpläne für einen Redis Cache.</param>
