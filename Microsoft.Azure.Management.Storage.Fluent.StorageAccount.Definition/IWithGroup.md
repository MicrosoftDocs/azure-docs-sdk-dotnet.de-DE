<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="437b0-101">Eine speicherkontendefinition, sodass Ressourcengruppe festgelegt werden.</span><span class="sxs-lookup"><span data-stu-id="437b0-101">A storage account definition allowing resource group to be set.</span></span>
            </summary>
