<Type Name="ILoadBalancer" FullName="Microsoft.Azure.Management.Network.Fluent.ILoadBalancer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7527e-101">Der Einstiegspunkt für die Verwaltung des Lastenausgleichsmoduls API in Azure.</span><span class="sxs-lookup"><span data-stu-id="7527e-101">Entry point for load balancer management API in Azure.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="7527e-102">(Beta: Diese Funktionalität ist in der Vorschau und als solche in nicht-abwärtskompatibel Möglichkeiten, die in zukünftigen Versionen, einschließlich Entfernung, unabhängig von der alle Anforderungen an die Kompatibilität, die Versionsnummer der enthaltenden Bibliothek festgelegt sind vorbehalten.).</span><span class="sxs-lookup"><span data-stu-id="7527e-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="Backends">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-103">Ruft Back-Ends für dieses Lastenausgleichsmodul für den Lastenausgleich bei den eingehenden Datenverkehr auf, nach Namen indiziert.</span><span class="sxs-lookup"><span data-stu-id="7527e-103">Gets backends for this load balancer to load balance the incoming traffic among, indexed by name.</span></span>
            </summary>
    ...
    <Member MemberName="Frontends">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-104">Ruft ab die Front-Ends für dieses Lastenausgleichsmodul, für den eingehenden Datenverkehr stammen aus.</span><span class="sxs-lookup"><span data-stu-id="7527e-104">Gets frontends for this load balancer, for the incoming traffic to come from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpProbes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-105">Ruft die HTTP-Tests von dieses Lastenausgleichsmodul mit dem Namen indiziert.</span><span class="sxs-lookup"><span data-stu-id="7527e-105">Gets HTTP probes of this load balancer, indexed by the name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InboundNatPools">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-106">Ruft den eingehenden NAT-Pools, die nach Namen indiziert.</span><span class="sxs-lookup"><span data-stu-id="7527e-106">Gets inbound NAT pools, indexed by name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InboundNatRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-107">Ruft den eingehenden NAT-Regeln für dieses Lastenausgleichsmodul.</span><span class="sxs-lookup"><span data-stu-id="7527e-107">Gets inbound NAT rules for this balancer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddressIds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-108">Ruft die Ressourcen-IDs der öffentlichen IP-Adressen an den Front-Ends für dieses Lastenausgleichsmodul zugewiesen.</span><span class="sxs-lookup"><span data-stu-id="7527e-108">Gets resource IDs of the public IP addresses assigned to the frontends of this load balancer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TcpProbes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7527e-109">Ruft die TCP-Prüfpunkte für dieses Lastenausgleichsmodul mit dem Namen indiziert.</span><span class="sxs-lookup"><span data-stu-id="7527e-109">Gets TCP probes of this load balancer, indexed by the name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
