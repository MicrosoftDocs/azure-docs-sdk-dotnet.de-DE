<Type Name="IHasPort" FullName="Microsoft.Azure.Management.Network.Fluent.IHasPort">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c48cc-101">Eine Schnittstelle, die ein Modell die Möglichkeit, eine Portnummer darstellt.</span><span class="sxs-lookup"><span data-stu-id="c48cc-101">An interface representing a model's ability to have a port number.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c48cc-102">Ruft die Nummer des Ports ab.</span><span class="sxs-lookup"><span data-stu-id="c48cc-102">Gets the port number.</span></span>
            </summary>
