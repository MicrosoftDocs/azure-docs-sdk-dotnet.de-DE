<Type Name="IApplicationGatewayBackendHttpConfiguration" FullName="Microsoft.Azure.Management.Network.Fluent.IApplicationGatewayBackendHttpConfiguration">
  ...
  <Docs>
    <summary>
            Eine unveränderliche clientseitige Darstellung von einem Anwendungsgateway-Back-End-HTTP-Konfiguration.
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="CookieBasedAffinity">
      ...
      <Docs>
        <summary>
            Ruft "true" zurück, wenn das Cookie Affinity (sticky Sessions) basierte ist aktiviert, andernfalls "false".
            </summary>
    ...
    <Member MemberName="RequestTimeout">
      ...
      <Docs>
        <summary>
            Ruft den HTTP-Anforderungstimeout in Sekunden ab. Anforderungen schlagen fehl, wenn keine Antwort innerhalb der angegebenen Zeit empfangen wird.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
