<Type Name="INetworks" FullName="Microsoft.Azure.Management.Network.Fluent.INetworks">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1dacd-101">Einstiegspunkt für einen virtuellen Netzwerk in Azure-Verwaltungs-API.</span><span class="sxs-lookup"><span data-stu-id="1dacd-101">Entry point to virtual network management API in Azure.</span></span>
            </summary>
