<Type Name="VirtualMachineRunCommandsOperationsExtensions" FullName="Microsoft.Azure.Management.Compute.VirtualMachineRunCommandsOperationsExtensions">
  ...
  <Docs>
    <summary>
            Erweiterungsmethoden für VirtualMachineRunCommandsOperations.
            </summary>
  ...
  <Members>
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="location">
            Der Speicherort der führen Sie Befehle abgefragt wird.
            </param>
        <param name="commandId">
            Die Befehls-Id.
            </param>
        <summary>
            Ruft bestimmte ausgeführten Befehls für ein Abonnement an einem Ort.
            </summary>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            Listet alle verfügbaren Ausführen von Befehlen für ein Abonnement in einen Speicherort an.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
