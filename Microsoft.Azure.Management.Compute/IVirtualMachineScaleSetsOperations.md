  ...
  <Members>
    ...
    <Member MemberName="BeginPowerOffWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            Ausschalten (Beenden) eine oder mehrere virtuelle Computer in einer VM-Skalierungsgruppe.
            Beachten Sie, dass Ressourcen immer noch angeschlossen sind, und Sie für die Ressourcen in Rechnung gestellt abrufen werden. Stattdessen verwenden freigeben, um Ressourcen freizugeben und Gebühren zu vermeiden.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
