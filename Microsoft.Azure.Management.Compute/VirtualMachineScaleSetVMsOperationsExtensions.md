  ...
  <Members>
    ...
    <Member MemberName="BeginReimageAll">
      ...
      <Docs>
        ...
        <summary>
            Können Sie alle Datenträger (Datenträger einschließlich) ein image in der Instanz von einer VM Scale set. Dieser Vorgang wird nur für verwaltete Datenträger unterstützt.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
