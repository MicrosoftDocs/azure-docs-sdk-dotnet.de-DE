<Type Name="TwinJsonConverter" FullName="Microsoft.Azure.Devices.Shared.TwinJsonConverter">
  ...
  <Docs>
    <summary>
            Konvertiert <see cref="T:Microsoft.Azure.Devices.Shared.Twin" /> in Json
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CanConvert">
      ...
      <Docs>
        ...
        <summary>
            Wert, der angibt, ob diese TwinJsonConverter JSON schreiben kann
            </summary>
    ...
    <Member MemberName="CanWrite">
      ...
      <Docs>
        <summary>
            Wert, der angibt, ob diese TwinJsonConverter JSON gelesen werden kann
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadJson">
      ...
      <Docs>
        ...
        <param name="existingValue">vorhandene Wert</param>
        <param name="serializer">Das Json-Serialisierungsprogramm.</param>
        <summary>
            Konvertiert Json in die entsprechende <see cref="T:Microsoft.Azure.Devices.Shared.Twin" /> Darstellung.
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WriteJson">
      ...
      <Docs>
        ...
        <param name="value">Die <see cref="T:Microsoft.Azure.Devices.Shared.Twin" /> konvertieren.</param>
        <param name="serializer">Das Json-Serialisierungsprogramm.</param>
        <summary>
            Konvertiert <see cref="T:Microsoft.Azure.Devices.Shared.Twin" /> in die entsprechende Json-Darstellung.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
