<Type Name="NotificationSecondaryTile" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8fce1-101">Die <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile" /> enthält Informationen zum Registrieren einer WNS sekundären Kachel mit einer <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />.</span><span class="sxs-lookup"><span data-stu-id="8fce1-101">The <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile" /> contains information for registering a WNS secondary tile with a <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="PushChannel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8fce1-102">Der Kanal-URI mit der Kachel zu registrieren.</span><span class="sxs-lookup"><span data-stu-id="8fce1-102">The channel URI to register with the tile.</span></span>
            </summary>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8fce1-103">Ein Satz von Tags, um mit der Kachel zu registrieren.</span><span class="sxs-lookup"><span data-stu-id="8fce1-103">A set of tags to register with the tile.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Templates">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8fce1-104">Ein Wörterbuch mit Namen der Zertifikatvorlagen zu <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" /> Objekte mit der Kachel zu registrieren.</span><span class="sxs-lookup"><span data-stu-id="8fce1-104">A dictionary of template names to <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" /> objects to register with the tile.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
