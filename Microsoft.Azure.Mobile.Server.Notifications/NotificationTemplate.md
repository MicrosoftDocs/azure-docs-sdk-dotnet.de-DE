<Type Name="NotificationTemplate" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate">
  ...
  <Docs>
    <summary>
            Ein <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" /> enthält Informationen zum Registrieren einer Vorlage mit einem <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Body">
      ...
      <Docs>
        <summary>
            Die benachrichtigungsnutzlast für diesen <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />.
            </summary>
    ...
    <Member MemberName="Headers">
      ...
      <Docs>
        <summary>
            Für WNS geben ein Wörterbuch mit Namen von Spaltenüberschriften auf Werte, die die Benachrichtigung angeben (Beispiel:) "X-WNS-TYPE": "Wns/Toast").
            Diese Eigenschaft ist für alle anderen Plattformen bedeutungslos.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
