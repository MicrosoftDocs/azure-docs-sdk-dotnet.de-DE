<Type Name="SKUCapability" FullName="Microsoft.Azure.Management.Storage.Models.SKUCapability">
  ...
  <Docs>
    <summary>
            Informationen über die Funktionen in der angegebenen Sku, einschließlich Verschlüsselung, Netzwerk-Acls, die Benachrichtigung.
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Initialisiert eine neue Instanz der SKUCapability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Der Name der Funktion, die Informationen über die Funktionen in der angegebenen Sku, einschließlich Verschlüsselung, Netzwerk-Acls, die Benachrichtigung.</param>
        <param name="value">Ein Zeichenfolgenwert, um anzugeben, gibt der angegebenen Funktion. Möglicherweise 'true' oder 'false'.</param>
        <summary>
            Initialisiert eine neue Instanz der SKUCapability-Klasse.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            Ruft den Namen der Funktionen, die Informationen über die Funktionen in der angegebenen Sku, einschließlich Verschlüsselung, Netzwerk-Acls, die Benachrichtigung ab.
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            Ruft gibt ein Zeichenfolgenwert an, dass der angegebenen Funktion.
            Möglicherweise 'true' oder 'false'.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
