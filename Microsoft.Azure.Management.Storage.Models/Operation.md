<Type Name="Operation" FullName="Microsoft.Azure.Management.Storage.Models.Operation">
  ...
  <Docs>
    <summary>
            Vorgangsdefinition Speicher-REST-API.
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="origin">Der Ursprung der Vorgänge.</param>
        <param name="serviceSpecification">Eine Eigenschaft des Vorgangs enthalten metrische Spezifikationen.</param>
        <summary>
            Initialisiert eine neue Instanz der Klasse Vorgang an.
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Origin">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt den Ursprung der Vorgänge.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceSpecification">
      ...
      <Docs>
        <summary>
            Ruft ab oder legt eine Eigenschaft des Vorgangs, enthalten Sie metrische Spezifikationen.
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
